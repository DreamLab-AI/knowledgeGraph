...
```json-ld
{
  ...
  "vc:plainGloss": "Chopping long documents into smaller, self-contained passages before an AI stores and searches them. Getting the size right matters: each piece needs to be big enough to make sense on its own yet small enough to match a question precisely.",
  "domain": "ai",
...
- ### In Plain Terms
  - Chopping long documents into smaller, self-contained passages before an AI stores and searches them. Getting the size right matters: each piece needs to be big enough to make sense on its own yet small enough to match a question precisely.
