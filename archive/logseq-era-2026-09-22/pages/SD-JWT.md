...
```json-ld
{
  ...
  "relations": {
    ...
    "enables": [
      ...
      {
        "@id": "urn:ngm:class:minimal-disclosure",
    ...
    "implements": [
      ...
      {
        "@id": "urn:ngm:class:oauth-working-group-specification",
        "label": "OAuth Working Group Specification"
      }
    ],
    "requires": [
      {
    ...
    "supports": [
      {
        "@id": "urn:ngm:class:eidas-2-digital-identity-wallet",
        "label": "eIDAS 2 Digital Identity Wallet"
      },
      {
    ...
    "relatedTo": [
      ...
      },
      {
        ...
        "label": "W3C Verifiable Credential Data Model"
      },
      {
    ...
    "bridgesTo": [
      {
        "@id": "urn:ngm:class:digital-identity-governance",
        "label": "Digital Identity Governance"
      },
      {
  ...
  "sameAs": [
    {
      "@id": "urn:ngm:class:selective-disclosure-json-web-token",
      "label": "Selective Disclosure JSON Web Token"
    }
  ],
  "quality": 0.72,
  "provenance": {
