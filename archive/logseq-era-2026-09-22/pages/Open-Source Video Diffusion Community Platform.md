...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "open-source-video-diffusion-community-platform",
...
```json-ld
{
  ...
  "@id": "urn:ngm:class:open-source-video-diffusion-community-platform",
  "@type": "Class",
  "label": "Open-Source Video Diffusion Community Platform",
...
- ### Content
  - Here, we aim to bring **architects and fine-tuners** who are creating open source video models, together with **engineers and tinkerers** who are expanding what these technologies can do, and **ambitious artists** who want push the bounds of creative expression with AI. [[Stable Diffusion Image Model]]
