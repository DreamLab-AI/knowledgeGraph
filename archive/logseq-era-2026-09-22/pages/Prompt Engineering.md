...
```json-ld
{
  ...
  "vc:plainGloss": "The craft of wording your instructions to an AI so it gives you what you actually want: being clear about the task, offering examples, and setting the format. Small changes in how you ask can make a large difference to the answer you get back.",
