...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "computational-image-relighting-technique",
...
```json-ld
{
  ...
  "@id": "urn:ngm:class:computational-image-relighting-technique",
  "@type": "Class",
  "label": "Computational Image Relighting Technique",
...
- ### Content
  - [[Global lighting | Image Based Lighting]] [[Node-Based Diffusion Pipeline Interface]] [lllyasviel/IC-Light: More relighting! (github.com)](https://github.com/lllyasviel/IC-Light)
  ...
  - [Magnific AI Relight is Worse than Open Source - YouTube](https://www.youtube.com/watch?v=GsJaqesboTo) [[Computational Image Relighting Technique]]
  - https://zju3dv.github.io/IntrinsicAnything/ relighting model
  - [[Apple Inc Technology Corporation]] [facial relighting](https://machinelearning.apple.com/research/neural-3d-relightable)
