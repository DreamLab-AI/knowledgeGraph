...
```json-ld
{
  ...
  "relations": {
    "relatedTo": [{"@id": "urn:ngm:class:logistics-optimisation", "label": "Logistics Optimization"}, {"@id": "urn:ngm:class:pharmaceutical-supply-chain", "label": "Pharmaceutical Supply Chain"}]
  },
  "quality": 0.72
}
```
...
- ### Definition
  - Pharmaceutical logistics manages the regulated, temperature-controlled movement of medicines, supported by [[Logistics Optimisation]] and operating within the [[Pharmaceutical Supply Chain]].
- ### Content
