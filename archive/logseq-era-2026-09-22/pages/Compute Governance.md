...
```json-ld
{
  ...
  "relations": {
    ...
    "implements": [
      ...
      {
        "@id": "urn:ngm:class:export-controls",
        "label": "Technology Export Regulation"
      }
    ],
    "uses": [
      {
  ...
  "sameAs": [
    {
      "@id": "urn:ngm:class:ai-compute-oversight",
      "label": "AI Compute Oversight"
    },
    {
      "@id": "urn:ngm:class:hardware-governance",
      "label": "Hardware Governance"
    }
  ],
  "provenance": {
