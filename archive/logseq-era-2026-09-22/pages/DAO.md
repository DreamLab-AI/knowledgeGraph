...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    {
      "@id": "urn:visionflow:linked:blockchain-based-records",
      "vc:label": "Blockchain-Based Records"
    },
    {
      "@id": "urn:visionflow:linked:consensus-voting",
      "vc:label": "Consensus Voting"
    },
    {
...
```json-ld
{
  ...
  "sameAs": [
    ...
    {
      "@id": "urn:ngm:class:on-chain-organisation",
      "label": "On-Chain Organisation"
    },
    {
      "@id": "urn:ngm:class:blockchain-cooperative",
      "label": "Blockchain Cooperative"
    }
  ]
}
```
...
- ### Content
  ...
  Perhaps more interesting is the use of the DAO concept to crowd fund global projects, currently especially for the acquisition of important art or cultural items. DAOs are also emerging as a way to fund promising technology projects, though this is reminiscent of the 2017 ICO craze which ended badly and is likely to [fall foul of regulations](https://www.cftc.gov/PressRoom/PressReleases/8590-22).
  ...
  - Prominent platforms supporting DAOs include Ethereum and Layer 2 networks such as Arbitrum, Optimism, and Base which improve scalability and reduce transaction costs.
  - Major active DAOs as of 2026 include Uniswap DAO (controlling fee structures and cross-chain deployment since Uniswap v4), Aave DAO, and MakerDAO which rebranded to Sky and restructured into a system of SubDAOs managing specific protocol aspects.
  ...
  - Governance tokens confer voting power, often proportional to holdings, though alternative models exist to mitigate plutocracy. Revenue sharing has become common, with major DAOs including Uniswap, Aave, and Sky now providing direct financial returns to governance participants.
