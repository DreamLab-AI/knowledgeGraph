...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "blockchain-document-trail-infrastructure",
...
```json-ld
{
  ...
  "@id": "urn:ngm:class:blockchain-document-trail-infrastructure",
  "@type": "Class",
  "label": "Blockchain Document Trail Infrastructure",
