...
```json-ld
{
  ...
  "relations": {
    ...
    "contrastsWith": [
      ...
      {
        "@id": "urn:ngm:class:on-chain-data-feed",
        "label": "On-Chain Data Feed"
      }
    ],
    "relatedTo": [
      {
      ...
      {
        "@id": "urn:ngm:class:oracle-extractable-value",
  ...
  "sameAs": [
    ...
    {
      "@id": "urn:ngm:class:smart-contract-oracle",
      "label": "Smart Contract Oracle"
    }
  ],
  "quality": 0.8,
  "provenance": {
