...
```json-ld
{
  ...
  "sameAs": [
    {
      "@id": "urn:ngm:class:object-serialization",
      "label": "Object Serialization"
    },
    {
      "@id": "urn:ngm:class:data-marshalling",
...
- ### Definition
  - [[Data Serialization]] is the engineering process of translating structured in-memory data objects into a storable or transmissible byte or character stream — using formats ranging from human-readable [[JSON Data Interchange Format]] and XML to compact [[Binary Encoding]] via [[Protocol Buffer]] — and reconstructing equivalent objects on the receiving side, with [[Data Schema]] and [[Schema Registry]] systems governing forward and backward compatibility across versions.
