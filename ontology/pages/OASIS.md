...
```json-ld
{
  ...
  "sameAs": [
    {
      "@id": "urn:ngm:class:organisation-for-the-advancement-of-structured-information-standards",
      "label": "Organisation for the Advancement of Structured Information Standards"
    }
  ],
  "quality": 0.8,
  "provenance": {
