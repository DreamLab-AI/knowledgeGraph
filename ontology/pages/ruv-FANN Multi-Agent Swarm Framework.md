...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "ruv-fann-multi-agent-swarm-framework",
...
```json-ld
{
  ...
  "@id": "urn:ngm:class:ruv-fann-multi-agent-swarm-framework",
  "@type": "Class",
  "label": "ruv-FANN Multi-Agent Swarm Framework",
