...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:membership-inference",
      "vc:label": "Membership Inference"
    },
    {
      "@id": "urn:visionflow:linked:model-inversion",
    ...
    {
      "@id": "urn:visionflow:linked:adversarial-attack",
    ...
    {
      "@id": "urn:visionflow:linked:data-poisoning",
      "vc:label": "Data Poisoning"
    },
    {
      "@id": "urn:visionflow:linked:model-extraction",
      "vc:label": "Model Extraction"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:insider-threat",
      "vc:label": "Insider Threat"
    },
    {
      "@id": "urn:visionflow:linked:vulnerability",
