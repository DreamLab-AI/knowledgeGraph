...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:value-learning",
      "vc:label": "Value Learning"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:adversarial-examples",
      "vc:label": "Adversarial Examples"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:specification-gaming",
      "vc:label": "Specification Gaming"
    },
    {
...
- ### Definition
  - AI Safety Research is an interdisciplinary scientific and engineering programme that develops theoretical frameworks, empirical methodologies, and deployable techniques to ensure that [[AI Systems]] of all capability levels behave safely, reliably, and in accordance with human values and intentions throughout their entire operational lifecycle. The field spans two interconnected time horizons: the near-term domain addresses practical engineering concerns relevant to currently deployed systems — including [[Robustness]] to distributional shift, resistance to [[Adversarial Examples]] and [[Prompt Injection]], calibrated [[Uncertainty Quantification]], fairness and bias mitigation under [[Fairness in Machine Learning]], and explainability via [[Mechanistic Interpretability]] and post-hoc attribution methods; the longer-term domain addresses challenges that become critical as systems approach and potentially surpass human-level capability in broad domains, including [[Scalable Oversight]] of systems whose outputs humans cannot directly evaluate, [[Corrigibility]] and shutdown safety for systems that may develop instrumental resistance to correction, [[Value Learning]] via cooperative inverse reinforcement learning, and the prevention of [[Specification Gaming]] and [[Reward Hacking]] in systems that optimise powerful proxy objectives. The research programme draws on [[Machine Learning]], [[Decision Theory]], [[Formal Verification]], logic, philosophy of mind, and [[Cognitive Science]], uniting them around a central commitment to ensuring that [[AI Alignment]] — the property that AI objectives faithfully represent the full complexity of human intentions — is achieved alongside capability development rather than sacrificed to it. The field increasingly interfaces with regulatory science, producing evaluation methodologies adopted by the UK AI Security Institute (renamed from AI Safety Institute in February 2025), the US AI Safety Institute, and the network of national AI safety evaluation bodies formed at the Seoul AI Safety Summit (May 2024), generating outputs that inform [[AI Regulation]], [[AI Policy]], and [[AI Risk Management]] globally.

- ### Semantic Classification
  - owl-class:: ai-governance-and-ethics:AISafetyResearch
  - owl-role:: ResearchField | ScientificDiscipline | EngineeringPractice
  - owl-inferred:: ai-governance-and-ethics:AIGovernanceResearch, ai-governance-and-ethics:TrustResearch
  - belongs-to-domain:: [[AI Governance and Ethics]]
  - implemented-in-layer:: [[ConceptualLayer]]

- ### Relationships
  - is-subclass-of:: [[AI Governance and Ethics]]
  - enables:: [[Responsible AI]], [[AI Alignment]], [[Trustworthy AI]], [[Corrigibility]], [[AI Safety]]
  - uses:: [[Interpretability]], [[Mechanistic Interpretability]], [[Red Teaming]], [[Reinforcement Learning from Human Feedback]], [[Formal Verification]], [[Uncertainty Quantification]], [[Adversarial Machine Learning]], [[Value Learning]], [[Constitutional AI]]
  - requires:: [[Machine Learning]], [[Decision Theory]], [[Robustness]], [[Neural Network]]
  - supports:: [[AI Policy]], [[AI Regulation]], [[Model Evaluation]], [[AI Risk Management]], [[AI Governance]]
  - related-to:: [[AI Risk]], [[Existential Risk]], [[Fairness in Machine Learning]], [[Scalable Oversight]], [[Large Language Models]], [[Reward Hacking]], [[Specification Gaming]], [[Prompt Injection]]
  - depends-on:: [[Deep Learning]], [[Autonomous Systems]], [[AI Agents]]
  - contrasts-with:: [[AI Capabilities Research]]
  - bridges-to:: [[AI Governance and Ethics]], [[Cognitive Science]], [[Autonomous Systems]]
  - related-to:: [[NIST AI Risk Management Framework]], [[EU AI Act]], [[ISO/IEC 42001]]
...
- ### Provenance
  - sources:: NIST AI RMF 1.0 (2023), EU AI Act 2024, Anthropic Constitutional AI (2022), UK AISI Frontier AI Trends Report (2025), Bletchley Declaration (2023), Seoul AI Safety Summit Outcomes (2024), Paris AI Action Summit (2025), UK AISI Alignment Evaluation Case-Study arXiv:2604.00788, Future of Life Institute AI Safety Index Summer 2025, Zylos Research AI Safety 2026 report, CHAI publications, MIRI agent foundations papers, Palisade Research chess hacking study (2025), Buolamwini and Gebru Gender Shades (2018), Bricken et al. Sparse Autoencoders (2023), Apollo Research deceptive alignment evaluations (2024)
