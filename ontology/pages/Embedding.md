...
```json-ld
{
  ...
  "vc:plainGloss": "A way of turning a word, image or document into a list of numbers that captures its meaning, so a computer can judge how similar two things are. Items about the same topic end up with near-identical number-lists — which is how AI-powered search and \"find me related documents\" features actually work.",
  "domain": "ai",
  "maturity": "mature",
  "subClassOf": [
    {
...
- ### In Plain Terms
  - A way of turning a word, image or document into a list of numbers that captures its meaning, so a computer can judge how similar two things are. Items about the same topic end up with near-identical number-lists — which is how AI-powered search and "find me related documents" features actually work.
