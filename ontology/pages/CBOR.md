...
```json-ld
{
  ...
  "relations": {
    ...
    "implements": [
      {
        ...
        "label": "CBOR Object Signing and Encryption"
      },
      {
    ...
    "standardizedBy": [
      ...
      },
      {
        ...
        "label": "ISO 18013-5 mDL Standard"
      }
    ],
    "requires": [
      {
  ...
  "sameAs": [
    {
      "@id": "urn:ngm:class:concise-binary-object-representation",
      "label": "Concise Binary Object Representation"
    }
  ],
  "quality": 0.72,
  "provenance": {
