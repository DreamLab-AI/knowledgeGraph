...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "stable-diffusion-image-model",
...
```json-ld
{
  ...
  "subClassOf": [{"@id": "urn:ngm:class:diffusion-model", "label": "Diffusion Model"}, {"@id": "urn:ngm:class:text-to-image", "label": "Text-to-Image"}],
  "relations": {
    "relatedTo": [
