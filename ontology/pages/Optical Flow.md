...
```json-ld
{
  ...
  "relations": {
    ...
    "uses": [
      ...
      },
      {
        ...
        "label": "Brightness Constancy Constraint"
      }
    ],
    "partOf": [
      {
  ...
  "sameAs": [
    {
      "@id": "urn:ngm:class:motion-vector-field",
      "label": "Motion Vector Field"
    },
    {
      "@id": "urn:ngm:class:apparent-motion-field",
      "label": "Apparent Motion Field"
    }
  ],
  "quality": 0.75,
  "provenance": {
