...
```json-ld
{
  ...
  "@id": "urn:visionflow:page:autonomous-vehicle-testing",
  "@type": "Page",
  "title": "Autonomous Vehicle Testing",
  "vc:slug": "autonomous-vehicle-testing",
  "vc:public": true,
  "vc:schemaVersion": 2,
...
```json-ld
{
  ...
  "sameAs": [
    {
      "@id": "urn:ngm:class:self-driving-validation",
      "label": "Self-Driving Validation"
    }
  ],
  "quality": 0.62,
  "provenance": {
