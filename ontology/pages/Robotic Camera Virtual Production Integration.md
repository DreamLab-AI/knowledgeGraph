...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "robotic-camera-virtual-production-integration",
...
```json-ld
{
  ...
  "@id": "urn:ngm:class:robotic-camera-virtual-production-integration",
  "@type": "Class",
  "label": "Robotic Camera Virtual Production Integration",
...
- ### Relationships
  - **uses**: [[Robotics]], [[Machine Learning Discipline]] — robotic camera systems are directed by ML-derived motion paths from scene analysis
