...
```json-ld
{ "@context":"https://narrativegoldmine.com/ns/v1", "@id":"urn:visionflow:page:rdf-xml", "@type":"Page", "title":"Rdf Xml", "vc:slug":"rdf-xml", "vc:public":true, "vc:schemaVersion":2, "vc:outboundWikilinks":[] }
```
...
```json-ld
{
  ...
  "subClassOf":[{"@id":"urn:ngm:class:rdf","label":"RDF"}],
  "relations":{
    "partOf":[{"@id":"urn:ngm:class:rdf","label":"RDF"}],
    "hasPart":[{"@id":"urn:ngm:class:xml","label":"XML"}],
    "uses":[{"@id":"urn:ngm:class:xml","label":"XML"},{"@id":"urn:ngm:class:data-format","label":"Data Format"}],
    "implements":[{"@id":"urn:ngm:class:rdf","label":"RDF"}],
    "enables":[{"@id":"urn:ngm:class:interoperability","label":"Interoperability"},{"@id":"urn:ngm:class:linked-data","label":"Linked Data"}],
    "supports":[{"@id":"urn:ngm:class:semantic-web","label":"Semantic Web"},{"@id":"urn:ngm:class:knowledge-graph","label":"Knowledge Graph"}],
    "requires":[{"@id":"urn:ngm:class:xml","label":"XML"}],
    "standardizedBy":[{"@id":"urn:ngm:class:standards","label":"Standards"}],
    "relatedTo":[{"@id":"urn:ngm:class:ontology","label":"Ontology"},{"@id":"urn:ngm:class:metadata","label":"Metadata"},{"@id":"urn:ngm:class:sparql","label":"SPARQL"}],
    "contrastsWith":[{"@id":"urn:ngm:class:turtle","label":"Turtle"},{"@id":"urn:ngm:class:n-triples","label":"N-Triples"}],
    "bridgesTo":[{"@id":"urn:ngm:class:structured-data","label":"Structured Data"}]
  },
  "sameAs":[],
  "quality":0.62,
