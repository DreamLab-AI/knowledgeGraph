...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:carbon-aware-computing",
      "vc:label": "Carbon-Aware Computing"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:environmental-sustainability",
    ...
    {
      "@id": "urn:visionflow:linked:sparse-attention",
      "vc:label": "Sparse Attention"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:power-usage-effectiveness",
      "vc:label": "Power Usage Effectiveness"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:workload-scheduling",
      "vc:label": "Workload Scheduling"
    },
    {
...
- ### Semantic Classification
  ...
  - owl-inferred:: artificial-intelligence:GreenAI, artificial-intelligence:EfficientAI, artificial-intelligence:ModelCompression
  - belongs-to-domain:: [[AI-GroundedDomain]]
  - implemented-in-layer:: [[AlgorithmLayer]], [[ApplicationLayer]]

- ### Relationships
  - is-subclass-of:: [[Artificial Intelligence]], [[Model Compression]], [[Green AI]]
  - has-part:: [[Model Quantisation]], [[Model Pruning]], [[Knowledge Distillation]], [[Neural Architecture Search]], [[Mixed Precision Training]], [[Gradient Checkpointing]], [[Flash Attention]], [[Speculative Decoding]], [[Workload Scheduling]], [[Sparse Attention]], [[Parameter-Efficient Fine-Tuning]]
  - requires:: [[Hardware Acceleration]], [[GPU Computing]], [[Deep Learning]], [[Power Usage Effectiveness]]
  - enables:: [[Edge AI]], [[On-Device Inference]], [[Environmental Sustainability]], [[Carbon-Aware Computing]], [[Edge Computing]], [[Federated Learning]]
  - implements:: [[Green AI]], [[Efficient Transformers]], [[Parameter-Efficient Fine-Tuning]], [[Model Compression]]
  - depends-on:: [[Deep Learning]], [[Carbon-Aware Computing]], [[GPU Computing]], [[Neuromorphic Computing]], [[Hardware Acceleration]]
  - supports:: [[AI Governance]], [[Regulatory Compliance]], [[AI Ethics Checklist]], [[Renewable Energy]], [[Environmental Sustainability]]
  - uses:: [[Mixed Precision Training]], [[Edge Computing]], [[Transfer Learning]], [[Federated Learning]], [[Renewable Energy]], [[Carbon-Aware Computing]]
  - contrasts-with:: [[Large Language Model]], [[High-Performance Computing]]
  - related-to:: [[Federated Learning]], [[Efficient Transformers]], [[Power Usage Effectiveness]], [[Neuromorphic Computing]], [[On-Device Inference]], [[Flash Attention]], [[Speculative Decoding]], [[Knowledge Distillation]]
  - bridges-to:: [[Data Centre]], [[Renewable Energy]], [[Environmental Sustainability]], [[AI Ethics Checklist]]
  - standardized-by:: [[ISO/IEC 42001]], [[EU AI Act Regulatory Instrument]]
...
- ### Content
  ...
  **Post-Training Quantisation Beyond INT4:** Research into 2-bit and 1.58-bit quantisation (BitNet b1.58, Ma et al., 2024) suggests the theoretical possibility of near-binary weight models maintaining competitive language modelling performance when trained from scratch at appropriate scale. The energy implications are substantial: binary weight inference requires only bit-wise operations (XNOR for multiply, popcount for accumulate), reducing energy per multiply-accumulate by approximately 2 orders of magnitude versus FP16. While the accuracy-efficiency frontier at sub-4-bit is not yet competitive with INT4 for arbitrary task-specific fine-tuning, BitNet architectures demonstrate the existence of capable binary weight models, and the trajectory of post-training quantisation research (from FP32→INT8 in 2020, to INT4 in 2022, to INT2 in 2024) suggests that practical sub-4-bit deployment may be achievable within the 2026–2028 period. This would transform the energy economics of inference for smaller organisations, enabling capable AI on CPU-only hardware with power draws under 5 watts.
  ...
  1. Strubell, E., Ganesh, A., & McCallum, A. (2019). Energy and policy considerations for deep learning in NLP. *ACL 2019*. https://arxiv.org/abs/1906.02629
  ...
  4. Dao, T., Fu, D. Y., Ermon, S., Rudra, A., & Ré, C. (2022). FlashAttention: Fast and memory-efficient exact attention with IO-awareness. *NeurIPS 2022*. https://arxiv.org/abs/2205.14135

  5. Frantar, E., Ashkboos, S., Hoefler, T., & Alistarh, D. (2022). GPTQ: Accurate post-training quantization for generative pre-trained transformers. *arXiv:2210.17323*. https://arxiv.org/abs/2210.17323

  6. Hinton, G., Vanhoucke, V., & Dean, J. (2015). Distilling the knowledge in a neural network. *arXiv:1503.02531*. https://arxiv.org/abs/1503.02531

  7. Tan, M., & Le, Q. V. (2019). EfficientNet: Rethinking model scaling for convolutional neural networks. *ICML 2019*. https://arxiv.org/abs/1905.11946

  8. Howard, A., et al. (2019). Searching for MobileNetV3. *ICCV 2019*. https://arxiv.org/abs/1905.02244

  9. Lannelongue, L., Grealey, J., & Inouye, M. (2021). Green algorithms: Quantifying the carbon footprint of computation. *Advanced Science, 8*(12), 2100707. https://doi.org/10.1002/advs.202100707

  10. International Energy Agency. (2025). *Energy and AI: World Energy Outlook Special Report*. IEA, Paris. https://www.iea.org/reports/key-questions-on-energy-and-ai

  11. Patterson, D., et al. (2021). Carbon considerations for large model development. *arXiv:2104.10350*. https://arxiv.org/abs/2104.10350

  12. Dettmers, T., Pagnoni, A., Holtzman, A., & Zettlemoyer, L. (2023). QLoRA: Efficient finetuning of quantized LLMs. *NeurIPS 2023*. https://arxiv.org/abs/2305.14314

  13. Ma, S., et al. (2024). The era of 1-bit LLMs: All large language models are in 1.58 bits. *arXiv:2402.17764*. https://arxiv.org/abs/2402.17764

  14. Kim, S., et al. (2023). SqueezeLLM: Dense-and-sparse quantization. *ICML 2023*. https://arxiv.org/abs/2306.07629

  15. Chen, T., Xu, B., Zhang, C., & Guestrin, C. (2016). Training deep nets with sublinear memory cost (gradient checkpointing). *arXiv:1604.06174*. https://arxiv.org/abs/1604.06174

  16. Hu, E., et al. (2021). LoRA: Low-rank adaptation of large language models. *ICLR 2022*. https://arxiv.org/abs/2106.09685

  17. CE-NAS: Carbon-Efficient Neural Architecture Search. *OpenReview, NeurIPS 2024 Workshop*. https://openreview.net/forum?id=v6W55lCkhN

  18. An exploration of the effect of quantisation on energy consumption and inference time of StarCoder2. (2024). *arXiv:2411.12758*. https://arxiv.org/abs/2411.12758

  19. How hungry is AI? Benchmarking energy, water, and carbon footprint of LLM inference. (2025). *arXiv:2505.09598*. https://arxiv.org/abs/2505.09598

  20. Leviathan, Y., Kalman, M., & Matias, Y. (2023). Fast inference from transformers via speculative decoding. *ICML 2023*. https://arxiv.org/abs/2211.17192

  21. Child, R., et al. (2019). Generating long sequences with sparse transformers. *arXiv:1904.10509*. https://arxiv.org/abs/1904.10509

  22. Promwad. (2025). AI model compression: Pruning and quantization strategies for real-time devices. https://promwad.com/news/ai-model-compression-real-time-devices-2025

  23. Green AI techniques for reducing energy consumption in AI systems. (2025). *ScienceDirect / Energy and AI*. https://www.sciencedirect.com/science/article/pii/S2590005625002796

  24. Green AI: A systematic review and meta-analysis of its definitions, lifecycle models, hardware and measurement attempts. (2025). *arXiv:2511.07090*. https://arxiv.org/abs/2511.07090

  25. MIT Sloan Management Review. (2025). AI has high data center energy costs — but there are solutions. https://mitsloan.mit.edu/ideas-made-to-matter/ai-has-high-data-center-energy-costs-there-are-solutions

  26. Presenc AI. (2026). AI Data Center Energy Consumption Statistics 2026. https://presenc.ai/research/ai-data-center-energy-consumption-2026

  27. TTMS. (2026). AI data centers energy consumption 2024–2026: Trends, projections, environmental impact. https://ttms.com/growing-energy-demand-of-ai-data-centers-2024-2026/

  28. University of Edinburgh. (2025). AI-driven discovery of quantum materials for neuromorphic and energy-efficient computing. https://www.ph.ed.ac.uk/phd-projects/ai-driven-discovery-of-quantum-materials-for-neuromorphic-and-energy-efficient-computing

- ### Provenance
  - sources:: https://www.iea.org/reports/key-questions-on-energy-and-ai, https://arxiv.org/abs/1906.02629, https://arxiv.org/abs/2511.07090, https://arxiv.org/abs/2505.09598, https://arxiv.org/abs/2411.12758, https://openreview.net/forum?id=v6W55lCkhN, https://presenc.ai/research/ai-data-center-energy-consumption-2026, https://mitsloan.mit.edu/ideas-made-to-matter/ai-has-high-data-center-energy-costs-there-are-solutions
