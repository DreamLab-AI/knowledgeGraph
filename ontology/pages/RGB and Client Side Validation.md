...
```json-ld
{
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[Instruction-Following Conversational AI System|GPT-4o]]",
...
- ### Relationships
  - is-subclass-of:: [[Bitcoin Proof-of-Work Protocol]], [[Smart Contracts]], [[Layer 3]], [[Off-Chain Protocol]], [[Client-Side Validation Theory]], [[UTXO Model]]
  ...
  - depends-on:: [[Bitcoin Proof-of-Work Protocol]], [[Lightning Network]], [[Taproot]], [[UTXO Model]], [[Cryptographic Hash Functions]], [[Merkle Tree Commitments]], [[Schnorr Signatures]]
...
- ### Content
  ...
  - The **[[RGB32]]** interface and [[Lightning Network]] integration create the infrastructure for [[AI agent]]s — autonomous software processes with their own [[Bitcoin Proof-of-Work Protocol]] [[private key]]s — to participate fully in the [[RGB Protocol]] economic ecosystem. An [[AI agent]] holding a [[Bitcoin Proof-of-Work Protocol]] private key can derive [[UTXO]]s deterministically, receive [[RGB20]] fungible tokens and [[RGB21]] NFTs as [[owned state]] assignments to those UTXOs, verify received [[consignment]]s independently using the [[RGB Core Library]] Rust bindings, and execute state transitions (transfers, swaps, contract operations) by signing [[Bitcoin Proof-of-Work Protocol]] transactions spending the sealing UTXOs.
