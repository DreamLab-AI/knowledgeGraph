...
- ### Semantic Classification
  - owl-class:: distributed-collaboration:Telecollaboration
  - owl-role:: Process
- ### Relationships
  - is-subclass-of:: [[DistributedWork]]
  - has-part:: [[Synchronous Collaboration]], [[Asynchronous Collaboration]], [[Telepresence]], [[Virtual Workspaces]], [[Real-Time Communication]]
  - enables:: [[Remote Team Productivity]], [[Distributed Knowledge Work]], [[Global Research Collaboration]], [[Cross-Cultural Teamwork]]
  - requires:: [[CoordinationMechanisms]], [[Communication Infrastructure]], [[Real-Time Protocols]]
  - bridges-to:: [[Artificial Intelligence]] (domain: ai), [[Digital Twin]] (domain: ngm), [[Blockchain]] (domain: bc)
- ### Content
  ## Definition
