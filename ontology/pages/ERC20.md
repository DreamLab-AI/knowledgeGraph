...
- ### Content
  ...
  - Cross-chain protocols such as LayerZero, Axelar, and Chainlink CCIP enable ERC20 tokens to operate across multiple blockchains; Kraken adopted Chainlink CCIP as its exclusive cross-chain infrastructure in May 2026, replacing LayerZero for wrapped tokens  
  - ERC-7802, ratified in 2025–2026, provides a transport-agnostic cross-chain token standard adopted by the Optimism Superchain (Base, Mode, Zora, and others); LayerZero's OFT standard remains dominant for projects wanting integrated bridge functionality  
  ...
  - Standards and frameworks continue to evolve with extensions like ERC-4337 (account abstraction), ERC-7802 (cross-chain), and Permit2 (gasless approvals) enhancing user experience and security  
  ...
  4. Ethereum.org. (2026). *ERC-20 Token Standard*. ethereum.org/developers/docs/standards/tokens/erc-20/  
  5. Blockchain App Factory. (2025). *ERC-20 Token Development in 2025 – Multi-Chain, Staking and Compliance*.
  6. Eco. (2026). *ERC-7802 Cross-Chain Token Standard*. eco.com/support/en/articles/14796368-erc-7802-cross-chain-token-standard
