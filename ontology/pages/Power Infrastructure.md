...
```json-ld
{
  ...
  "relations":{
    "hasPart":[{"@id":"urn:ngm:class:electrical-power","label":"Electrical Power"},{"@id":"urn:ngm:class:power-supply","label":"Power Supply"}],
    "partOf":[{"@id":"urn:ngm:class:cloud-infrastructure","label":"Cloud Infrastructure"}],
    "requires":[{"@id":"urn:ngm:class:redundancy","label":"Redundancy"},{"@id":"urn:ngm:class:capacity-planning","label":"Capacity Planning"}],
    "dependsOn":[{"@id":"urn:ngm:class:electrical-power","label":"Electrical Power"},{"@id":"urn:ngm:class:renewable-energy","label":"Renewable Energy"}],
    "enables":[{"@id":"urn:ngm:class:high-availability","label":"High Availability"}],
    "supports":[{"@id":"urn:ngm:class:cooling-system","label":"Cooling System"},{"@id":"urn:ngm:class:cloud-infrastructure","label":"Cloud Infrastructure"}],
    "uses":[{"@id":"urn:ngm:class:energy-efficiency","label":"Energy Efficiency"}],
    "relatedTo":[{"@id":"urn:ngm:class:carbon-footprint","label":"Carbon Footprint"},{"@id":"urn:ngm:class:renewable-energy","label":"Renewable Energy"}],
    "contrastsWith":[{"@id":"urn:ngm:class:cooling-system","label":"Cooling System"}]
  },
  "sameAs":[],
  "quality":0.62,
