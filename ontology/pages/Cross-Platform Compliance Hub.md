...
```json-ld
{
  ...
  "relations": {
    ...
    "requires": [
      ...
      {
        "@id": "urn:ngm:class:platform-integration-api",
        "label": "Platform Integration API"
      },
      {
      ...
      {
        "@id": "urn:ngm:class:data-classification-system",
    ...
    "dependsOn": [
      {
        "@id": "urn:ngm:class:legal-framework-database",
        "label": "Legal Framework Database"
      },
      {
