schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#ConsensusRule
legacy_uri:: urn:visionclaw:concept:blockchain:consensus-rule
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-426823dbcd59"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#ConsensusRule"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:consensus-rule"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:bce7b1ba5debe47b0a811951f921a58db53642db5105c03b78eb0efe40835ff0@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:consensus-rule",
  "@type": "OntologyClass",
