...
- ### Content
  ...
  - Terra's algorithmic mechanism used an on-chain arbitrage relationship: when UST traded above $1, users [private] burn $1-equivalent LUNA to mint 1 UST, profiting from the premium; when UST traded below $1, users [private] burn 1 UST to receive $1-equivalent LUNA.
