schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#StableCoins
legacy_uri:: urn:visionclaw:concept:blockchain:stable-coins
public:: true
...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:financial-services-domain",
      "vc:label": "FinancialServicesDomain"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:payments-domain",
  ...
  "vc:legacyProperties": [
    {
      ...
      "vc:value": "Stablecoins, Stable Digital Currencies, Pegged Digital Assets, Synthetic Dollars"
    },
    {
    ...
    {
      "vc:key": "bridges-to",
      "vc:value": "[[CBDCs]], [[DeFi]], [[Digital Asset]], [[Payments Infrastructure]]"
    },
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-9f3e1a7c2b5d"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#StableCoins"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:stable-coins"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:stable-coins:776c802a9fc9",
  ...
  "vc:resolutions": [
    {
      "raw": "[[Algorithmic Stabilisation]]",
      "resolved": "urn:visionflow:linked:algorithmic-stabilisation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Attestation Report]]",
      "resolved": "urn:visionflow:linked:attestation-report",
      "kind": "StubLink"
    },
    {
      "raw": "[[Avalanche]]",
    ...
    {
      "raw": "[[Base Network]]",
      "resolved": "urn:visionflow:linked:base-network",
      "kind": "StubLink"
    },
    {
      "raw": "[[Basel III Crypto Exposure Rules]]",
      "resolved": "urn:visionflow:linked:basel-iii-crypto-exposure-rules",
      "kind": "StubLink"
    },
    {
      "raw": "[[BlackRock]]",
    ...
    {
      "raw": "[[BlackRock|BlackRock]]",
      "resolved": "urn:visionflow:linked:black-rock",
      "kind": "StubLink"
    },
    {
      "raw": "[[Central Bank Policy]]",
      "resolved": "urn:visionflow:linked:central-bank-policy",
      "kind": "StubLink"
    },
    {
      "raw": "[[Commercial Bank Money]]",
      "resolved": "urn:visionflow:linked:commercial-bank-money",
      "kind": "StubLink"
    },
    {
      "raw": "[[Corporate Treasury Management]]",
      "resolved": "urn:visionflow:linked:corporate-treasury-management",
      "kind": "StubLink"
    },
    {
      "raw": "[[Cross-Border Remittances]]",
      "resolved": "urn:visionflow:linked:cross-border-remittances",
      "kind": "StubLink"
    },
    {
      "raw": "[[Cross-Border Remittances|cross-border payments]]",
      "resolved": "urn:visionflow:linked:cross-border-remittances",
      "kind": "StubLink"
    },
    {
      "raw": "[[Custodian]]",
      "resolved": "urn:visionflow:linked:custodian",
      "kind": "StubLink"
    },
    {
      "raw": "[[DeFi]]",
    ...
    {
      "raw": "[[DeFi|decentralised finance]]",
      "resolved": "urn:visionflow:linked:de-fi",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Dollar Peg Mechanism]]",
      "resolved": "urn:visionflow:linked:dollar-peg-mechanism",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Emerging Market Finance]]",
      "resolved": "urn:visionflow:linked:emerging-market-finance",
      "kind": "StubLink"
    },
    {
      "raw": "[[Eurodollar]]",
    ...
    {
      "raw": "[[FASB ASC 350-60]]",
      "resolved": "urn:visionflow:linked:fasb-asc-350-60",
      "kind": "StubLink"
    },
    {
      "raw": "[[FCA Stablecoin Rules]]",
      "resolved": "urn:visionflow:linked:fca-stablecoin-rules",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[FinancialServicesDomain]]",
      "resolved": "urn:visionflow:linked:financial-services-domain",
      "kind": "StubLink"
    },
    {
      "raw": "[[Fractional Reserve Model]]",
      "resolved": "urn:visionflow:linked:fractional-reserve-model",
      "kind": "StubLink"
    },
    {
      "raw": "[[GENIUS Act 2025]]",
    ...
    {
      "raw": "[[Interest Rate Environment]]",
      "resolved": "urn:visionflow:linked:interest-rate-environment",
      "kind": "StubLink"
    },
    {
      "raw": "[[Liquidation Engine]]",
      "resolved": "urn:visionflow:linked:liquidation-engine",
      "kind": "StubLink"
    },
    {
      "raw": "[[Metaverse Payments]]",
      "resolved": "urn:visionflow:linked:metaverse-payments",
      "kind": "StubLink"
    },
    {
      "raw": "[[MiCA Regulation]]",
    ...
    {
      "raw": "[[Mint Burn Mechanism]]",
      "resolved": "urn:visionflow:linked:mint-burn-mechanism",
      "kind": "StubLink"
    },
    {
      "raw": "[[Multi-Party Computation Custody]]",
      "resolved": "urn:visionflow:linked:multi-party-computation-custody",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Oracle Network|oracle layer]]",
      "resolved": "urn:visionflow:linked:oracle-network",
      "kind": "StubLink"
    },
    {
      "raw": "[[Overcollateralisation]]",
      "resolved": "urn:visionflow:linked:overcollateralisation",
      "kind": "StubLink"
    },
    {
      "raw": "[[PaymentsDomain]]",
      "resolved": "urn:visionflow:linked:payments-domain",
      "kind": "StubLink"
    },
    {
      "raw": "[[Payments Infrastructure]]",
      "resolved": "urn:visionflow:linked:payments-infrastructure",
      "kind": "StubLink"
    },
    {
      "raw": "[[Payments Infrastructure|payment processor]]",
      "resolved": "urn:visionflow:linked:payments-infrastructure",
      "kind": "StubLink"
    },
    {
      "raw": "[[Payments Infrastructure|payments infrastructure]]",
      "resolved": "urn:visionflow:linked:payments-infrastructure",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Reserve Assets]]",
      "resolved": "urn:visionflow:linked:reserve-assets",
      "kind": "StubLink"
    },
    {
      "raw": "[[Reserve Audit]]",
      "resolved": "urn:visionflow:linked:reserve-audit",
      "kind": "StubLink"
    },
    {
      "raw": "[[SettlementLayer]]",
    ...
    {
      "raw": "[[Smart Contract Infrastructure]]",
      "resolved": "urn:visionflow:linked:smart-contract-infrastructure",
      "kind": "StubLink"
    },
    {
      "raw": "[[Smart Contract Vault]]",
      "resolved": "urn:visionflow:linked:smart-contract-vault",
      "kind": "StubLink"
    },
    {
      "raw": "[[Tokenised Asset]]",
      "resolved": "urn:visionflow:linked:tokenised-asset",
      "kind": "StubLink"
    },
    {
      "raw": "[[Trade Finance]]",
    ...
    {
      "raw": "[[Traditional Bank Deposits]]",
      "resolved": "urn:visionflow:linked:traditional-bank-deposits",
      "kind": "StubLink"
    },
    {
      "raw": "[[Tron Network]]",
      "resolved": "urn:visionflow:linked:tron-network",
      "kind": "StubLink"
    },
    {
      "raw": "[[Tron Network|Tron]]",
      "resolved": "urn:visionflow:linked:tron-network",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Agentic Internet|programmable]]",
      "resolved": "urn:visionflow:owl:class:agentic-internet",
      "kind": "ResolvedLink"
    },
    {
    ...
    {
      "raw": "[[AML KYC Compliance|AML/CFT compliance]]",
      "resolved": "urn:visionflow:owl:class:aml-kyc-compliance",
      "kind": "ResolvedLink"
    },
    {
      "raw": "[[AML KYC Compliance|AML/KYC]]",
      "resolved": "urn:visionflow:owl:class:aml-kyc-compliance",
      "kind": "ResolvedLink"
    },
    {
      "raw": "[[AML KYC Compliance|compliance layer]]",
      "resolved": "urn:visionflow:owl:class:aml-kyc-compliance",
      "kind": "ResolvedLink"
    },
    {
    ...
    {
      "raw": "[[Bitcoin Technical Overview|Bitcoin]]",
      "resolved": "urn:visionflow:owl:class:bitcoin-technical-overview",
      "kind": "ResolvedLink"
    },
    {
    ...
    {
      "raw": "[[Blockchain Interoperability|Interoperability]]",
      "resolved": "urn:visionflow:owl:class:blockchain-interoperability",
      "kind": "ResolvedLink"
    },
    {
    ...
    {
      "raw": "[[Blockchain Network|blockchain technology]]",
      "resolved": "urn:visionflow:owl:class:blockchain-network",
      "kind": "ResolvedLink"
    },
    {
    ...
    {
      "raw": "[[Digital Asset|digital asset]]",
      "resolved": "urn:visionflow:owl:class:digital-asset",
      "kind": "ResolvedLink"
    },
    {
...
- ### Semantic Classification
  ...
  - owl-role:: PaymentInstrument
  - owl-inferred:: blockchain:DigitalCurrency, blockchain:TokenisedAsset, blockchain:SettlementLayer, finance:SyntheticDollar
  - belongs-to-domain:: [[BlockchainDomain]], [[FinancialServicesDomain]], [[PaymentsDomain]], [[RegulatoryDomain]]
  - implemented-in-layer:: [[ProtocolLayer]], [[ApplicationLayer]], [[SettlementLayer]]

- ### Relationships
  - is-subclass-of:: [[Digital Asset]], [[Blockchain Network]], [[Payments Infrastructure]], [[Tokenised Asset]], [[Financial Instrument]]
  - has-part:: [[Reserve Assets]], [[Smart Contract Vault]], [[Oracle Network]], [[Liquidation Engine]], [[Attestation Report]], [[Mint Burn Mechanism]], [[Governance Token]]
  - requires:: [[Blockchain Network]], [[Custodian]], [[Price Oracle]], [[Regulatory Licence]], [[Reserve Audit]], [[Smart Contract Infrastructure]]
  - enables:: [[DeFi]], [[Cross-Border Remittances]], [[On-Chain Settlement]], [[Yield Generation]], [[Payments Infrastructure]], [[Corporate Treasury Management]]
...
- ### Content
  ...
  ## Compositional Relationships (Components)
	  ...
	  FunctionalDataProperty(blockchain:totalMarketCapUSD)
	  FunctionalDataProperty(blockchain:stabilisingMechanism)
	  ```

  - ## About Stable Coins
  - **Stable Coins** (stablecoins) constitute the single most commercially impactful application of [[Blockchain Network|blockchain technology]], providing the critical interface between legacy financial infrastructure and open, permissionless distributed ledger networks.
  - Unlike cryptocurrencies such as [[Bitcoin Technical Overview|Bitcoin]] or Ether, which derive value entirely from market dynamics and exhibit extreme price volatility (Bitcoin annual volatility 50-80%, Ether 70-90%), stablecoins are engineered to track an external price anchor — most commonly one US dollar — through systematic reserve management or algorithmic mechanisms.
  ...
  - **Fiat-collateralised models** transfer systemic risk to the quality and liquidity of reserve assets and the trustworthiness of custodians.
    - This risk materialised dramatically in March 2023 when USDC temporarily depegged to approximately $0.87 following the collapse of Silicon Valley Bank, where Circle held $3.3 billion of USDC reserves.
  ...
  - **Crypto-overcollateralised models** achieve censorship resistance and custodian-independence but introduce three structural costs:
    - Capital inefficiency: requiring $150-200 of collateral for each $100 of stablecoins issued, locking productive capital.
    - [[Price Oracle|Oracle risk]]: smart contracts depend on external price feeds from Chainlink, Pyth, or Chronicle; a manipulated oracle can trigger erroneous liquidations or allow undercollateralised minting.
  ...
  - With over $110 billion in circulation as of mid-2026 and daily transaction volumes exceeding $50 billion, USDT functions as an offshore synthetic [[Eurodollar]] for [[DeFi|decentralised finance]] and emerging markets.
  ...
  - Tether's Q1 2024 attestation showed net profits of approximately $4.5 billion — exceeding Goldman Sachs's Q1 2024 profitability — primarily from T-bill holdings, with excess reserves of $6.3 billion above circulating supply.
  ...
  - Paolo Ardoino (Tether CTO, later CEO) described USDT usage as approximately 40% genuine commerce and remittances, 60% crypto trading, with [[Tron Network|Tron]] emerging as the dominant settlement network by transaction count for low-value consumer transfers in emerging markets.
  ...
  - USDC reserves are held exclusively in cash and short-dated US government securities within the Circle Reserve Fund (a government money market fund managed by [[BlackRock|BlackRock]] on Circle's behalf), with monthly attestation by Deloitte.
  ...
  - This episode illustrates the inherent tension between decentralised governance philosophy and compliance with sovereign financial law that all stablecoin protocols navigating [[AML KYC Compliance|AML/KYC]] obligations must resolve.
  ...
  - Terra's algorithmic mechanism used an on-chain arbitrage relationship: when UST traded above $1, users could burn $1-equivalent LUNA to mint 1 UST, profiting from the premium; when UST traded below $1, users could burn 1 UST to receive $1-equivalent LUNA.
  ...
  - In early May 2022, large-scale UST withdrawals from Anchor Protocol triggered depegging pressure, with the Luna Foundation Guard attempting to deploy approximately $3.5 billion of [[Bitcoin Technical Overview|Bitcoin]] reserves as a last-resort backstop.
  ...
  - The Iron Finance collapse (June 2021) provided a prophetic rehearsal: IRON stablecoin (partially collateralised by TITAN governance token) experienced a bank run collapsing TITAN from $64 to effectively $0 within hours — 11 months before TerraUSD repeated the dynamic at $50B scale.

  - ## Components / Architecture
  - Stablecoin architecture comprises interdependent layers that collectively determine stability, compliance posture, and systemic resilience across the [[Blockchain Network|blockchain]] ecosystem.
  ...
  - The **[[Oracle Network|oracle layer]]** provides external price feeds that overcollateralised protocols use to monitor collateral ratios and trigger liquidations.
  ...
  - The **[[AML KYC Compliance|compliance layer]]** encompasses KYC/AML controls (USDC and USDT maintain OFAC sanctions screening and can freeze or seize addresses), attestation and audit functions, regulatory reporting, and licensing obligations.
  ...
  - The **distribution layer** includes on-ramp/off-ramp infrastructure (Coinbase, Kraken) and [[Payments Infrastructure|payment processor]] integrations (Stripe, Checkout.com, PayPal, MoneyGram) connecting stablecoins to traditional commerce and [[Cross-Border Remittances|cross-border payments]].
  ...
  - Bridge hacks represented the largest source of [[DeFi]] losses in 2022-2023: Ronin Bridge ($625M), Wormhole ($320M), Nomad ($190M), Horizon Bridge ($100M).
  ...
  - Network distribution of stablecoin supply as of 2025-2026:
    ...
    - Noble (Cosmos ecosystem): USDC native issuance hub for the Cosmos [[Blockchain Interoperability|Interoperability]] ecosystem via IBC (Inter-Blockchain Communication) protocol.
  ...
  - **Tether USDT** ($110B+ supply; primary networks: Tron 48%, Ethereum 42%, remainder distributed across Solana, Avalanche, TON blockchain, others):
    ...
    - Profitability model: approximately $4.5B Q1 2024 profit from T-bill holdings on $110B reserve base, with no yield distributed to token holders.
  ...
  - **Market structure** (May 2026):
    - Aggregate stablecoin market cap exceeded $230 billion, approximately doubling from $115 billion in January 2024.
  ...
  - ## Metadata
  - **Domain correction applied**: Original stub had `domain:: infrastructure`. Corrected to `domain:: blockchain` with corresponding updates to `iri::`, `uri::`, `same-as::`, and `owl-class::`. Stablecoins are a [[Blockchain Network|blockchain]]-native [[Digital Asset|digital asset]] and finance concept; the `infrastructure` domain in this knowledge graph refers to compute, networking, and platform layers — not financial instruments. The `iri::` prefix updated from `infrastructure#` to `blockchain#`.
  ...
  - **Key related concepts in this knowledge graph**:
    ...
    - [[Artificial General Intelligence|AGI]] and [[Agent Frameworks]] — AI agent payment rails using stablecoins represent a significant 2025-2030 growth vector.
...
- ### Provenance
  - sources::
    - Klages-Mundt, A., Moin, A., Gudgeon, L., & Sherrat, D. (2022). Stablecoins 2.0: Economic Foundations and Risk-based Models. Financial Cryptography and Data Security 2022. https://doi.org/10.1007/978-3-031-18283-9_33
    - Gorton, G., & Zhang, J. (2021). Taming Wildcat Stablecoins. NBER Working Paper 29100. https://www.nber.org/papers/w29100
    - Catalini, C., & de Gortari, A. (2021). On the Economic Design of Stablecoins. MIT Digital Currency Initiative Working Paper.
    - Clements, R. (2021). Built to Fail: The Inherent Fragility of Algorithmic Stablecoins. Wake Forest Law Review Online.
    - Uhlig, H. (2022). A Luna-tic Stablecoin Crash. NBER Working Paper 30464. https://www.nber.org/papers/w30464
    - Adachi, M. et al. (2022). Stablecoins: risks, potential and regulation. BIS Working Paper No. 1016. https://www.bis.org/publ/work1016.htm
    - Charoenwong, B. et al. (2024). Decomposing stablecoin activity. BIS Working Paper No. 1194. https://www.bis.org/publ/work1194.htm
    - IMF. (2025). Stablecoin proliferation and monetary sovereignty. IMF Working Paper. International Monetary Fund.
    - European Parliament and Council. (2023). Regulation (EU) 2023/1114 on Markets in Crypto-Assets (MiCA). Official Journal of the European Union. https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32023R1114
    - US Senate Banking Committee. (2025). Guiding and Establishing National Innovation for US Stablecoins (GENIUS) Act. 119th Congress.
    - Financial Conduct Authority. (2024). Discussion Paper DP23/4: Regulating Cryptoassets — Stablecoins. FCA. https://www.fca.org.uk/publications/discussion-papers/dp23-4-regulating-cryptoassets-stablecoins
    - HM Treasury. (2022). UK regulatory approach to cryptoassets and stablecoins: consultation and call for evidence response. https://www.gov.uk/government/consultations/uk-regulatory-approach-to-cryptoassets-and-stablecoins
    - Circle Internet Financial. (2024). SEC Form S-1 Registration Statement. US Securities and Exchange Commission.
    - Circle Internet Financial. (2024). Circle is First Global Stablecoin Issuer to Comply with MiCA. Circle Press Release. https://www.circle.com/en/pressroom/circle-is-first-global-stablecoin-issuer-to-comply-with-mica-eus-landmark-crypto-law
    - Tether Operations Limited. (2024). Quarterly Attestation Reports. BDO Italia. https://tether.to/en/transparency/
    - CFTC. (2021). CFTC Orders Tether and Bitfinex to Pay Fines Totaling $42.5 Million. CFTC Press Release 8450-21. https://www.cftc.gov/PressRoom/PressReleases/8450-21
    - BlackRock / Securitize. (2024). BlackRock and Securitize Launch BUIDL — The BlackRock USD Institutional Digital Liquidity Fund. March 2024.
    - Ondo Finance. (2024). USDY and OUSG Product Documentation. https://ondo.finance/
    - MakerDAO / Sky Protocol. (2022-2025). The Endgame Plan. Governance Forum. https://forum.makerdao.com/
    - Carter, N. (2024). Five Perspectives on Stablecoins. Castle Island Ventures / Medium. https://medium.com/@nic__carter/five-perspectives-on-stablecoins-5bc20076270a
    - Allaire, J. (2024). Twitter/X post on stablecoin adoption trajectory. https://x.com/jerallaire/status/1803432989113593890
    - Stripe / Bridge. (2024). Stripe acquires Bridge for $1.1 billion. Stripe Blog.
    - Mastercard. (2022). New Payments Index 2022. https://www.mastercard.com/news/insights/2022/new-payments-index-2022/
    - Bank for International Settlements. (2024). Annual Economic Report, Chapter III: Crypto's Achilles heel. https://www.bis.org/publ/arpdf/ar2024e3.htm
    - Brookings Institution. (2022). Stablecoins and national security: Learning the lessons of Eurodollars. https://www.brookings.edu/articles/stablecoins-and-national-security-learning-the-lessons-of-eurodollars/
    - DefiLlama. (2024-2026). Stablecoins market data. https://defillama.com/stablecoins
    - Paxos. (2024). Monthly Attestation Reports. https://paxos.com/attestations/
    - Ethena Labs. (2024). The Internet Bond — USDe Protocol Documentation. https://ethena.fi/
    - Liquity Protocol. (2024). Liquity v2: Stability Without Governance. https://www.liquity.org/
    - Zetzsche, D., Arner, D., & Buckley, R. (2022). DeFi: Data, Governance, Competence. European Business Organisation Law Review 23(2), 415-446.
    - Avgouleas, E., & Kiayias, A. (2019). The Promise of Blockchain Technology for Global Securities and Derivatives Markets. European Business Organisation Law Review 20, 81-110.
    - Stellar Development Foundation. (2024). Stellar Development Foundation Annual Report. https://stellar.org/
    - World Food Programme. (2024). Building Blocks Programme Report. United Nations World Food Programme. https://innovation.wfp.org/project/building-blocks
