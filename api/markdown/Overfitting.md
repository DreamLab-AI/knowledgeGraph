schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#Overfitting
legacy_uri:: urn:visionclaw:concept:spatial-computing:overfitting
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-b4d7cb2f139d"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#Overfitting"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:overfitting"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:ed09aab9dadee82ee15e3449fb1e01eb14c4d5c440d94bd9ccfbb8ff8e4ee078@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
