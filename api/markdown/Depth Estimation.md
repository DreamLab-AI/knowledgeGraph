schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#DepthEstimation
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:depth-estimation
public:: true
...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:3-dreconstruction-domain",
      "vc:label": "3DReconstructionDomain"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:arcore-depth-api-documentation",
      "vc:label": "ARCore Depth API Documentation"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:arkit-depth-api-documentation",
      "vc:label": "ARKit Depth API Documentation"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:bhat-et-al-2023-zoe-depth",
      "vc:label": "Bhat et al. 2023 ZoeDepth"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:chang-and-chen-2018-psmnet",
      "vc:label": "Chang & Chen 2018 PSMNet"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:dai-et-al-2017-scan-net",
      "vc:label": "Dai et al. 2017 ScanNet"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:eigen-et-al-2014-multi-scale-depth-cnn",
      "vc:label": "Eigen et al. 2014 Multi-Scale Depth CNN"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:geiger-et-al-2012-kitti-benchmark",
      "vc:label": "Geiger et al. 2012 KITTI Benchmark"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:godard-et-al-2017-mono-depth-left-right-consistency",
      "vc:label": "Godard et al. 2017 MonoDepth Left-Right Consistency"
    },
    {
      "@id": "urn:visionflow:linked:godard-et-al-2019-mono-depth2",
      "vc:label": "Godard et al. 2019 MonoDepth2"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:hartley-and-zisserman-2003-multiple-view-geometry",
      "vc:label": "Hartley & Zisserman 2003 Multiple View Geometry"
    },
    {
      "@id": "urn:visionflow:linked:hirschm-ller-2008-semi-global-matching",
      "vc:label": "Hirschmüller 2008 Semi-Global Matching"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:ke-et-al-2024-marigold",
      "vc:label": "Ke et al. 2024 Marigold"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:laga-et-al-2022-stereo-survey",
      "vc:label": "Laga et al. 2022 Stereo Survey"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:lipson-et-al-2021-raft-stereo",
      "vc:label": "Lipson et al. 2021 RAFT-Stereo"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:mayer-et-al-2016-disp-net-scene-flow",
      "vc:label": "Mayer et al. 2016 DispNet SceneFlow"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:mildenhall-et-al-2020-ne-rf",
      "vc:label": "Mildenhall et al. 2020 NeRF"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:piccinelli-et-al-2024-uni-depth",
      "vc:label": "Piccinelli et al. 2024 UniDepth"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:ranftl-et-al-2021-dpt",
      "vc:label": "Ranftl et al. 2021 DPT"
    },
    {
      "@id": "urn:visionflow:linked:ranftl-et-al-2022-mi-da-s",
      "vc:label": "Ranftl et al. 2022 MiDaS"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:robotic-perception-domain",
      "vc:label": "RoboticPerceptionDomain"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:sch-nberger-and-frahm-2016-colmap",
      "vc:label": "Schönberger & Frahm 2016 COLMAP"
    },
    {
      "@id": "urn:visionflow:linked:scharstein-and-szeliski-2002-stereo-taxonomy",
      "vc:label": "Scharstein & Szeliski 2002 Stereo Taxonomy"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:silberman-et-al-2012-nyu-depth-v2",
      "vc:label": "Silberman et al. 2012 NYU Depth v2"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:wang-et-al-2021-neu-s",
      "vc:label": "Wang et al. 2021 NeuS"
    },
    {
      "@id": "urn:visionflow:linked:yang-et-al-2024-depth-anything",
      "vc:label": "Yang et al. 2024 Depth Anything"
    },
    {
      "@id": "urn:visionflow:linked:yang-et-al-2024-depth-anything-v2-da-2-k",
      "vc:label": "Yang et al. 2024 Depth Anything V2 DA-2K"
    },
    {
      "@id": "urn:visionflow:linked:yin-et-al-2024-metric3-d-v2",
      "vc:label": "Yin et al. 2024 Metric3D v2"
    },
    {
      "@id": "urn:visionflow:linked:zhao-et-al-2020-monocular-depth-survey",
      "vc:label": "Zhao et al. 2020 Monocular Depth Survey"
    },
    {
      "@id": "urn:visionflow:linked:zhou-et-al-2017-sf-mlearner",
      "vc:label": "Zhou et al. 2017 SfMLearner"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-85525ddd9d04"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#DepthEstimation"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:depth-estimation"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:depth-estimation:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[3DReconstructionDomain]]",
      "resolved": "urn:visionflow:linked:3-dreconstruction-domain",
      "kind": "StubLink"
    },
    {
      "raw": "[[AlgorithmLayer]]",
    ...
    {
      "raw": "[[ARCore]]",
      "resolved": "urn:visionflow:linked:arcore",
      "kind": "StubLink"
    },
    {
      "raw": "[[ARCore Depth API Documentation]]",
      "resolved": "urn:visionflow:linked:arcore-depth-api-documentation",
      "kind": "StubLink"
    },
    {
      "raw": "[[ARKit]]",
    ...
    {
      "raw": "[[ARKit Depth API Documentation]]",
      "resolved": "urn:visionflow:linked:arkit-depth-api-documentation",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Bhat et al. 2023 ZoeDepth]]",
      "resolved": "urn:visionflow:linked:bhat-et-al-2023-zoe-depth",
      "kind": "StubLink"
    },
    {
      "raw": "[[Block Matching]]",
      "resolved": "urn:visionflow:linked:block-matching",
      "kind": "StubLink"
    },
    {
      "raw": "[[Bokeh Rendering]]",
      "resolved": "urn:visionflow:linked:bokeh-rendering",
      "kind": "StubLink"
    },
    {
    ...
    },
    {
      ...
      "resolved": "urn:visionflow:linked:camera-extrinsics",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Chang & Chen 2018 PSMNet]]",
      "resolved": "urn:visionflow:linked:chang-and-chen-2018-psmnet",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Cost Volume]]",
      "resolved": "urn:visionflow:linked:cost-volume",
      "kind": "StubLink"
    },
    {
      "raw": "[[DA-2K]]",
      "resolved": "urn:visionflow:linked:da-2-k",
      "kind": "StubLink"
    },
    {
      "raw": "[[Dai et al. 2017 ScanNet]]",
      "resolved": "urn:visionflow:linked:dai-et-al-2017-scan-net",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Depth Anything]]",
      "resolved": "urn:visionflow:linked:depth-anything",
      "kind": "StubLink"
    },
    {
      "raw": "[[Depth Completion]]",
      "resolved": "urn:visionflow:linked:depth-completion",
      "kind": "StubLink"
    },
    {
      "raw": "[[Depth Map]]",
      "resolved": "urn:visionflow:linked:depth-map",
      "kind": "StubLink"
    },
    {
      "raw": "[[Disparity Map]]",
      "resolved": "urn:visionflow:linked:disparity-map",
      "kind": "StubLink"
    },
    {
      "raw": "[[DPT]]",
      "resolved": "urn:visionflow:linked:dpt",
      "kind": "StubLink"
    },
    {
      "raw": "[[Eigen et al. 2014 Multi-Scale Depth CNN]]",
      "resolved": "urn:visionflow:linked:eigen-et-al-2014-multi-scale-depth-cnn",
      "kind": "StubLink"
    },
    {
      "raw": "[[Epipolar Geometry]]",
      "resolved": "urn:visionflow:linked:epipolar-geometry",
      "kind": "StubLink"
    },
    {
      "raw": "[[ETH3D]]",
      "resolved": "urn:visionflow:linked:eth3-d",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Free-Space Estimation]]",
      "resolved": "urn:visionflow:linked:free-space-estimation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Geiger et al. 2012 KITTI Benchmark]]",
      "resolved": "urn:visionflow:linked:geiger-et-al-2012-kitti-benchmark",
      "kind": "StubLink"
    },
    {
      "raw": "[[Geometric Vision]]",
      "resolved": "urn:visionflow:linked:geometric-vision",
      "kind": "StubLink"
    },
    {
      "raw": "[[Godard et al. 2017 MonoDepth Left-Right Consistency]]",
      "resolved": "urn:visionflow:linked:godard-et-al-2017-mono-depth-left-right-consistency",
      "kind": "StubLink"
    },
    {
      "raw": "[[Godard et al. 2019 MonoDepth2]]",
      "resolved": "urn:visionflow:linked:godard-et-al-2019-mono-depth2",
      "kind": "StubLink"
    },
    {
      "raw": "[[Grasp Planning]]",
    ...
    },
    {
      ...
      "resolved": "urn:visionflow:linked:hartley-and-zisserman-2003-multiple-view-geometry",
      "kind": "StubLink"
    },
    {
      "raw": "[[Hirschmüller 2008 Semi-Global Matching]]",
      "resolved": "urn:visionflow:linked:hirschm-ller-2008-semi-global-matching",
      "kind": "StubLink"
    },
    {
      "raw": "[[Image Pair]]",
      "resolved": "urn:visionflow:linked:image-pair",
      "kind": "StubLink"
    },
    {
      "raw": "[[Ke et al. 2024 Marigold]]",
      "resolved": "urn:visionflow:linked:ke-et-al-2024-marigold",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Kinect]]",
      "resolved": "urn:visionflow:linked:kinect",
      "kind": "StubLink"
    },
    {
      "raw": "[[KITTI Benchmark]]",
      "resolved": "urn:visionflow:linked:kitti-benchmark",
      "kind": "StubLink"
    },
    {
      "raw": "[[Laga et al. 2022 Stereo Survey]]",
      "resolved": "urn:visionflow:linked:laga-et-al-2022-stereo-survey",
      "kind": "StubLink"
    },
    {
      "raw": "[[LiDAR]]",
    ...
    {
      "raw": "[[Lipson et al. 2021 RAFT-Stereo]]",
      "resolved": "urn:visionflow:linked:lipson-et-al-2021-raft-stereo",
      "kind": "StubLink"
    },
    {
      "raw": "[[Marigold]]",
      "resolved": "urn:visionflow:linked:marigold",
      "kind": "StubLink"
    },
    {
      "raw": "[[Mayer et al. 2016 DispNet SceneFlow]]",
      "resolved": "urn:visionflow:linked:mayer-et-al-2016-disp-net-scene-flow",
      "kind": "StubLink"
    },
    {
      "raw": "[[MiDaS]]",
      "resolved": "urn:visionflow:linked:mi-da-s",
      "kind": "StubLink"
    },
    {
      "raw": "[[Middlebury Stereo]]",
      "resolved": "urn:visionflow:linked:middlebury-stereo",
      "kind": "StubLink"
    },
    {
      "raw": "[[Mildenhall et al. 2020 NeRF]]",
      "resolved": "urn:visionflow:linked:mildenhall-et-al-2020-ne-rf",
      "kind": "StubLink"
    },
    {
      "raw": "[[MonoDepth]]",
      "resolved": "urn:visionflow:linked:mono-depth",
      "kind": "StubLink"
    },
    {
      "raw": "[[Monocular 3D Object Detection]]",
      "resolved": "urn:visionflow:linked:monocular-3-d-object-detection",
      "kind": "StubLink"
    },
    {
      "raw": "[[Multi-View Stereo]]",
      "resolved": "urn:visionflow:linked:multi-view-stereo",
      "kind": "StubLink"
    },
    {
      "raw": "[[NeRF]]",
    ...
    {
      "raw": "[[NYU Depth v2]]",
      "resolved": "urn:visionflow:linked:nyu-depth-v2",
      "kind": "StubLink"
    },
    {
      "raw": "[[Optical Flow]]",
    ...
    {
      "raw": "[[Photometric Consistency]]",
      "resolved": "urn:visionflow:linked:photometric-consistency",
      "kind": "StubLink"
    },
    {
      "raw": "[[Photometric Loss]]",
      "resolved": "urn:visionflow:linked:photometric-loss",
      "kind": "StubLink"
    },
    {
      "raw": "[[Piccinelli et al. 2024 UniDepth]]",
      "resolved": "urn:visionflow:linked:piccinelli-et-al-2024-uni-depth",
      "kind": "StubLink"
    },
    {
      "raw": "[[PSMNet]]",
      "resolved": "urn:visionflow:linked:psmnet",
      "kind": "StubLink"
    },
    {
      "raw": "[[RAFT-Stereo]]",
      "resolved": "urn:visionflow:linked:raft-stereo",
      "kind": "StubLink"
    },
    {
      "raw": "[[Ranftl et al. 2021 DPT]]",
      "resolved": "urn:visionflow:linked:ranftl-et-al-2021-dpt",
      "kind": "StubLink"
    },
    {
      "raw": "[[Ranftl et al. 2022 MiDaS]]",
      "resolved": "urn:visionflow:linked:ranftl-et-al-2022-mi-da-s",
      "kind": "StubLink"
    },
    {
      "raw": "[[RealSense]]",
      "resolved": "urn:visionflow:linked:real-sense",
      "kind": "StubLink"
    },
    {
      "raw": "[[RGB-D Camera]]",
      "resolved": "urn:visionflow:linked:rgb-d-camera",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[RoboticPerceptionDomain]]",
      "resolved": "urn:visionflow:linked:robotic-perception-domain",
      "kind": "StubLink"
    },
    {
      "raw": "[[ScanNet]]",
      "resolved": "urn:visionflow:linked:scan-net",
      "kind": "StubLink"
    },
    {
      "raw": "[[Schönberger & Frahm 2016 COLMAP]]",
      "resolved": "urn:visionflow:linked:sch-nberger-and-frahm-2016-colmap",
      "kind": "StubLink"
    },
    {
      "raw": "[[Scharstein & Szeliski 2002 Stereo Taxonomy]]",
      "resolved": "urn:visionflow:linked:scharstein-and-szeliski-2002-stereo-taxonomy",
      "kind": "StubLink"
    },
    {
      "raw": "[[Semi-Global Matching]]",
      "resolved": "urn:visionflow:linked:semi-global-matching",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Silberman et al. 2012 NYU Depth v2]]",
      "resolved": "urn:visionflow:linked:silberman-et-al-2012-nyu-depth-v2",
      "kind": "StubLink"
    },
    {
      "raw": "[[Sintel]]",
      "resolved": "urn:visionflow:linked:sintel",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Structured Light]]",
      "resolved": "urn:visionflow:linked:structured-light",
      "kind": "StubLink"
    },
    {
      "raw": "[[Surface Normal Estimation]]",
      "resolved": "urn:visionflow:linked:surface-normal-estimation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Time-of-Flight Camera]]",
      "resolved": "urn:visionflow:linked:time-of-flight-camera",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Wang et al. 2021 NeuS]]",
      "resolved": "urn:visionflow:linked:wang-et-al-2021-neu-s",
      "kind": "StubLink"
    },
    {
      "raw": "[[Yang et al. 2024 Depth Anything]]",
      "resolved": "urn:visionflow:linked:yang-et-al-2024-depth-anything",
      "kind": "StubLink"
    },
    {
      "raw": "[[Yang et al. 2024 Depth Anything V2 DA-2K]]",
      "resolved": "urn:visionflow:linked:yang-et-al-2024-depth-anything-v2-da-2-k",
      "kind": "StubLink"
    },
    {
      "raw": "[[Yin et al. 2024 Metric3D v2]]",
      "resolved": "urn:visionflow:linked:yin-et-al-2024-metric3-d-v2",
      "kind": "StubLink"
    },
    {
      "raw": "[[Zhao et al. 2020 Monocular Depth Survey]]",
      "resolved": "urn:visionflow:linked:zhao-et-al-2020-monocular-depth-survey",
      "kind": "StubLink"
    },
    {
      "raw": "[[Zhou et al. 2017 SfMLearner]]",
      "resolved": "urn:visionflow:linked:zhou-et-al-2017-sf-mlearner",
      "kind": "StubLink"
    },
    {
      "raw": "[[ZoeDepth]]",
      "resolved": "urn:visionflow:linked:zoe-depth",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Stereo Camera]]",
      "resolved": "urn:visionflow:owl:class:stereo-camera",
      "kind": "ResolvedLink"
    },
    {
      "raw": "[[Telepresence]]",
...
- ### Definition
  - Depth Estimation is the computer vision task of recovering per-pixel distance from a camera (or a virtual viewpoint) to the surfaces of a 3D scene, producing a depth map D(u,v) ∈ ℝ⁺ aligned to an image I(u,v) that encodes scene geometry needed for 3D reconstruction, robotic perception, augmented-reality occlusion, autonomous-vehicle obstacle avoidance, and view synthesis, addressed through three classical paradigms — passive multi-view stereo correspondence solving the disparity inverse-depth relation d = fB/Z under epipolar geometry (block matching, Semi-Global Matching SGM via Hirschmüller 2005-2008 still dominant in embedded ADAS, learned PSMNet/AANet/RAFT-Stereo end-to-end disparity networks achieving sub-pixel D1-all error <2% on KITTI 2015), structure-from-motion (SfM) bundle adjustment recovering sparse 3D points and camera poses from feature tracks (COLMAP de-facto open-source pipeline, OpenMVG, Bundler, Theia powering Google Street View, photogrammetry, Apple Object Capture), and monocular depth estimation learning a single-image depth prior from data — split between supervised regression on RGB-D ground truth (Eigen 2014 first CNN multi-scale, DORN ordinal regression CVPR 2018, BTS 2019), self-supervised photometric reconstruction across stereo pairs or temporal video frames (MonoDepth Godard CVPR 2017 left-right consistency, MonoDepth2 Godard ICCV 2019 minimum reprojection masking, SfMLearner Zhou CVPR 2017), and the 2020-2025 foundation-model wave establishing zero-shot affine-invariant relative depth as a solved problem (MiDaS Ranftl 2020 mixed-dataset training 10 RGB-D corpora δ<1.25 >85%, DPT Dense Prediction Transformer 2021 ViT backbone, ZoeDepth 2023 metric depth via bin classification, Depth Anything Yang TikTok+HKUST CVPR 2024 trained on 1.5M labelled + 62M unlabelled images zero-shot SOTA on NYU/KITTI/ScanNet, Depth Anything V2 2024 distilled from synthetic-data teacher, Marigold Ke ETH Zurich CVPR 2024 repurposed Stable Diffusion v2 latent diffusion for depth ranking #1 on DA-2K benchmark, Lotus 2024 and Genpercept 2024 follow-on diffusion variants) — complemented by active depth sensing (time-of-flight ToF cameras measuring round-trip light at 30-60 fps in iPhone 12-15 Pro and Magic Leap 2, structured-light triangulation in original Kinect v1 / Apple TrueDepth Face ID dot projector / Intel RealSense F200, scanning and flash LiDAR in iPhone Pro and iPad Pro 5th gen+ with VCSEL arrays and SPAD detectors at 5-15m range, and automotive long-range LiDAR Velodyne/Luminar/Innoviz/Hesai providing 200m point clouds for Waymo/Cruise/Zoox autonomous stacks while Tesla famously pursues vision-only Hydra-Net occupancy networks since 2021) — and by neural implicit and explicit volumetric representations (NeRF Mildenhall 2020, NeuS Wang 2021, 3D Gaussian Splatting Kerbl SIGGRAPH 2023 rasterising 1-4M Gaussians at 100+ fps with depth as a free by-product of α-blended z-values), evaluated on KITTI Stereo/Eigen split (outdoor driving, abs-rel <0.08 SOTA 2024), NYU Depth v2 (indoor Kinect, RMSE <0.30m), Sintel (synthetic), ScanNet (indoor RGB-D), Middlebury 2014/2021, ETH3D, and the new DA-2K 2024 zero-shot relative-depth benchmark (1K image pairs, 8 scene categories), deployed at scale in 3 billion+ smartphone cameras with portrait/cinematic depth-of-field (Apple Portrait mode, Google Pixel dual-pixel autofocus depth, Samsung Live Focus), 800M+ AR-enabled devices via ARKit Depth API (LiDAR sensor on iPhone 12 Pro 2020+) / ARCore Depth API (cross-device monocular ToF 2020+) / Meta Quest 3 stereo depth / Apple Vision Pro 2024 dual TrueDepth + scene LiDAR, 50M+ robotics platforms (RealSense D435/D455, Azure Kinect, ZED 2i stereo, Ouster digital LiDAR in warehouse AMRs Locus Robotics/Geek+/Fetch), and 20M+ autonomous and ADAS vehicles (Mobileye EyeQ stereo-on-mono, Tesla 8-camera Hydra-Net, Waymo 5th-gen sensor suite, Cruise Gen2, BMW/Mercedes/GM Super Cruise stereo+LiDAR fusion), with the field's contemporary frontier defined by zero-shot foundation depth models replacing per-dataset trained networks, diffusion priors enabling crisp boundaries on transparent and reflective surfaces previously catastrophic for regression CNNs, and Gaussian-splatting-based depth offering real-time photorealistic novel-view geometry for VR telepresence and digital-twin pipelines.

- ### Semantic Classification
  - owl-class:: artificial-intelligence:DepthEstimation
  - owl-role:: PerceptionTask
  - owl-inferred:: ai:ComputerVision, ai:GeometricVision, ai:DensePrediction, ai:SceneUnderstanding
  - belongs-to-domain:: [[AI-GroundedDomain]], [[ComputerVisionDomain]], [[3DReconstructionDomain]], [[RoboticPerceptionDomain]]
  - implemented-in-layer:: [[PerceptionLayer]], [[AlgorithmLayer]], [[SensorFusionLayer]]

- ### Relationships
  - is-subclass-of:: [[Computer Vision]], [[Dense Prediction]], [[Geometric Vision]], [[Scene Understanding]], [[3D Perception]]
  - has-part:: [[Disparity Map]], [[Depth Map]], [[Cost Volume]], [[Epipolar Geometry]], [[Camera Intrinsics]], [[Camera Extrinsics]], [[Photometric Loss]], [[Point Cloud]]
  - requires:: [[Camera Calibration]], [[Image Pair]], [[Feature Matching]], [[Optimization]], [[Loss Function]], [[Training Data]]
  - enables:: [[3D Reconstruction]], [[Obstacle Avoidance]], [[AR Occlusion]], [[Bokeh Rendering]], [[Visual SLAM]], [[Novel View Synthesis]], [[Grasp Planning]], [[Free-Space Estimation]]
  - implements:: [[Block Matching]], [[Semi-Global Matching]], [[PSMNet]], [[RAFT-Stereo]], [[MonoDepth]], [[MiDaS]], [[DPT]], [[ZoeDepth]], [[Depth Anything]], [[Marigold]], [[Structure-from-Motion]], [[Multi-View Stereo]]
  - depends-on:: [[Convolutional Neural Networks]], [[Vision Transformers]], [[Diffusion Models]], [[Epipolar Geometry]], [[Photometric Consistency]], [[Bundle Adjustment]]
  - supports:: [[SLAM]], [[Visual Odometry]], [[ARKit]], [[ARCore]], [[Autonomous Driving]], [[Robotic Manipulation]], [[Telepresence]], [[Digital Twin]]
  - uses:: [[LiDAR]], [[Time-of-Flight Camera]], [[Structured Light]], [[Stereo Camera]], [[RGB-D Camera]], [[Kinect]], [[RealSense]]
  - contrasts-with:: [[Surface Normal Estimation]], [[Optical Flow]], [[3D Reconstruction]], [[Pose Estimation]], [[Semantic Segmentation]]
  - related-to:: [[NeRF]], [[3D Gaussian Splatting]], [[Visual SLAM]], [[Photogrammetry]], [[Monocular 3D Object Detection]], [[Depth Completion]]
  - standardized-by:: [[KITTI Benchmark]], [[NYU Depth v2]], [[ScanNet]], [[Middlebury Stereo]], [[DA-2K]], [[Sintel]], [[ETH3D]]
...
- ### Content
  ...
  ## Compositional Relationships (Components)
	  ...
	  FunctionalDataProperty(ai:kittiAbsRelError)
	  FunctionalDataProperty(ai:zeroShotDeltaAccuracy)
	  ```
  ...
  - ### Core Geometric Framework
	  Depth estimation is grounded in **projective geometry** and the pinhole camera model. For a calibrated camera with intrinsic matrix K = [[f_x, 0, c_x], [0, f_y, c_y], [0, 0, 1]] and extrinsic [R | t], a 3D point X_world projects to pixel x via x ~ K [R | t] X_world. The unknown is the per-pixel depth Z; recovering it from one or more views is the core problem.
	  **Stereo triangulation** is the simplest exact solution. Given a rectified stereo pair with baseline B and focal length f, the disparity d = u_L - u_R between corresponding pixels yields depth via the inverse-depth relation:
	  Z = fB / d
	  Sub-pixel disparity at d=1 px on a 720p sensor with f=900 px and B=12 cm gives Z ≈ 108 m, while d=100 px gives Z ≈ 1.08 m — disparity precision dominates depth precision, motivating sub-pixel matching algorithms. The Middlebury 2014 dataset standardises evaluation across baseline geometries and texture conditions.
	  **Epipolar geometry** constrains correspondence search to a 1D line: given a point in image L, its match in image R must lie on the epipolar line defined by the fundamental matrix F satisfying x_R^T F x_L = 0. Rectification warps both images so epipolar lines align with image rows, reducing matching to a 1D search amenable to dynamic programming, semi-global aggregation, or 3D cost-volume CNNs.
	  **Multi-view stereo (MVS)** generalises this to N views via plane-sweep volumes or PatchMatch propagation (COLMAP), exploiting redundancy to filter outliers. **Bundle adjustment** jointly refines camera poses and 3D points by minimising reprojection error ∑ ‖x_i - π(K, R_i, t_i, X_j)‖², solved with sparse Levenberg-Marquardt (Ceres Solver, g2o, GTSAM).
	  **Monocular depth as inverse problem**: a single image admits an entire family of consistent 3D scenes (the "Ames room" illusion makes this physical). Monocular methods learn a posterior p(D | I) from data, regressing **affine-invariant relative depth** (depth up to scale and shift, easy and dataset-portable) or **metric depth** (calibrated Z in metres, harder, requires camera-aware conditioning as in ZoeDepth/Metric3D).
  ...
  - ### Use Cases / Major Families
	  ...
	  **Classical algorithms**:
	  - **Block Matching (BM)** — exhaustive SAD/SSD/NCC over disparity range. OpenCV `StereoBM` runs at 100+ fps on 720p but is fragile to texture-less regions and lighting differences.
	  ...
	  **Deployment**: 20M+ ADAS vehicles, automotive Tier-1 stereo modules (Mobileye EyeQ, Bosch SMPC, Continental MFC500), industrial machine vision (Cognex, Keyence stereo bin-picking), Intel RealSense D435/D455 ($200-$500 consumer stereo).
	  ...
	  **LiDAR**: pulsed laser scanning measuring round-trip time-of-flight. Consumer: iPhone 12-15 Pro + iPad Pro (Sony VCSEL array + SPAD detector, ~5 m, 1 cm precision). Automotive: spinning Velodyne HDL-64, Luminar Iris, Innoviz One, Hesai Pandar — 100-300 m range, 0.1° resolution, 360°×40° FOV, $500-$8K BOM. Aerial: Riegl, Optech (200-1000 m).
  ...
  - ### Application Domains and Deployment Economics
	  ...
	  **ROI logic**: smartphone bokeh added $30-$80 ASP premium to "Pro" tiers, generating ~$15-25B annual additional revenue across Apple/Samsung/Google, with marginal depth-stack cost <$5/unit.
	  ...
	  **ROI logic**: warehouse AMRs typically pay back in 12-18 months by replacing 2-3 human pickers at $35-50K loaded cost; depth-vision stack adds $2-4K BOM but enables the safety case for unmanned operation.
	  ...
	  **Chinese OEMs**: XPeng (LiDAR + cameras, XNGP), Li Auto (LiDAR + cameras, NOA), NIO (Aquila sensor suite with 33 sensors including 1 LiDAR), BYD (eyes-of-god, no LiDAR base). Chinese automotive LiDAR (Hesai, RoboSense, Innovusion) drove unit prices from $1000+ in 2020 to $300-500 in 2024.
	  ...
	  **ROI logic**: ADAS depth modules add $300-1500 BOM and command $2-5K MSRP option pricing on premium vehicles. Estimated $20-40B annual depth-sensing component revenue across automotive.
  ...
  - ### Current Landscape (2026)
	  ...
	  - **OpenCV `cv2.StereoSGBM`, libelas, libsgm** — classical stereo.
	  ...
	  This matrix drives system design: AR-glasses budgets <2W and <$100 BOM → monocular foundation + ToF; robotaxi budgets >$1000 BOM and >100m range → multi-LiDAR + stereo fusion; mid-range smartphone → dual-pixel + on-device foundation depth; warehouse AMR → stereo + 360° LiDAR.
  ...
  - ### UK Context: Academic Leadership and Industrial Innovation
	  ...
	  **Wayve** (London, founded 2017 by Cipolla students Kendall, Hawke): end-to-end vision-first autonomous driving foundation models. Series-C $1B raise May 2024 (SoftBank, NVIDIA, Microsoft), $1.05B Series-C extension. Uses monocular and stereo depth implicitly within a video foundation model rather than as a separate module.
  ...
  - ### Research & Literature
	  ...
	  **Foundational Geometry and Stereo**:
	  1. Hartley, R., & Zisserman, A. (2003). *Multiple View Geometry in Computer Vision* (2nd ed.). Cambridge University Press. ISBN 978-0521540513. [25,000+ citations, canonical reference]
	  2. Scharstein, D., & Szeliski, R. (2002). A taxonomy and evaluation of dense two-frame stereo correspondence algorithms. *International Journal of Computer Vision*, 47(1-3), 7-42. DOI: 10.1023/A:1014573219977. [Middlebury benchmark origin]
	  3. Hirschmüller, H. (2008). Stereo processing by semi-global matching and mutual information. *IEEE TPAMI*, 30(2), 328-341. DOI: 10.1109/TPAMI.2007.1166. [SGM, 3,500+ citations]
	  4. Schönberger, J.L., & Frahm, J.-M. (2016). Structure-from-motion revisited. *Proceedings of CVPR*, 4104-4113. DOI: 10.1109/CVPR.2016.445. [COLMAP]

	  **Deep Stereo and Monocular Depth**:
	  5. Eigen, D., Puhrsch, C., & Fergus, R. (2014). Depth map prediction from a single image using a multi-scale deep network. *NeurIPS*, 2366-2374. [First monocular CNN depth]
	  6. Mayer, N., Ilg, E., Häusser, P., et al. (2016). A large dataset to train convolutional networks for disparity, optical flow, and scene flow estimation. *CVPR*, 4040-4048. DOI: 10.1109/CVPR.2016.438. [DispNet, SceneFlow]
	  7. Godard, C., Mac Aodha, O., & Brostow, G.J. (2017). Unsupervised monocular depth estimation with left-right consistency. *CVPR*, 270-279. [MonoDepth, UCL]
	  8. Zhou, T., Brown, M., Snavely, N., & Lowe, D.G. (2017). Unsupervised learning of depth and ego-motion from video. *CVPR*, 1851-1858. [SfMLearner]
	  9. Chang, J.-R., & Chen, Y.-S. (2018). Pyramid stereo matching network. *CVPR*, 5410-5418. [PSMNet]
	  10. Godard, C., Mac Aodha, O., Firman, M., & Brostow, G.J. (2019). Digging into self-supervised monocular depth estimation. *ICCV*, 3828-3838. [MonoDepth2]
	  11. Lipson, L., Teed, Z., & Deng, J. (2021). RAFT-Stereo: Multilevel recurrent field transforms for stereo matching. *3DV*, 218-227. [RAFT-Stereo]

	  **Foundation Models and Diffusion**:
	  12. Ranftl, R., Lasinger, K., Hafner, D., Schindler, K., & Koltun, V. (2022). Towards robust monocular depth estimation: Mixing datasets for zero-shot cross-dataset transfer. *IEEE TPAMI*, 44(3), 1623-1637. DOI: 10.1109/TPAMI.2020.3019967. [MiDaS]
	  13. Ranftl, R., Bochkovskiy, A., & Koltun, V. (2021). Vision transformers for dense prediction. *ICCV*, 12179-12188. [DPT]
	  14. Bhat, S.F., Birkl, R., Wofk, D., Wonka, P., & Müller, M. (2023). ZoeDepth: Zero-shot transfer by combining relative and metric depth. *arXiv:2302.12288*.
	  15. Yang, L., Kang, B., Huang, Z., Xu, X., Feng, J., & Zhao, H. (2024). Depth Anything: Unleashing the power of large-scale unlabeled data. *CVPR*, 10371-10381. [Depth Anything V1]
	  16. Yang, L., Kang, B., Huang, Z., Zhao, Z., Xu, X., Feng, J., & Zhao, H. (2024). Depth Anything V2. *arXiv:2406.09414*. [DA-V2 + DA-2K benchmark]
	  17. Ke, B., Obukhov, A., Huang, S., Metzger, N., Daudt, R.C., & Schindler, K. (2024). Repurposing diffusion-based image generators for monocular depth estimation. *CVPR*, 9492-9502. [Marigold]
	  18. Piccinelli, L., Yang, Y.-H., Sakaridis, C., Segu, M., Li, S., Van Gool, L., & Yu, F. (2024). UniDepth: Universal monocular metric depth estimation. *CVPR*, 10106-10116.
	  19. Yin, W., Zhang, C., Chen, H., et al. (2024). Metric3D v2: A versatile monocular geometric foundation model. *arXiv:2404.15506*.

	  **Multi-View and Volumetric**:
	  20. Mildenhall, B., Srinivasan, P.P., Tancik, M., Barron, J.T., Ramamoorthi, R., & Ng, R. (2020). NeRF: Representing scenes as neural radiance fields for view synthesis. *ECCV*, 405-421. DOI: 10.1007/978-3-030-58452-8_24.
	  21. Wang, P., Liu, L., Liu, Y., Theobalt, C., Komura, T., & Wang, W. (2021). NeuS: Learning neural implicit surfaces by volume rendering for multi-view reconstruction. *NeurIPS*, 27171-27183.
	  22. Kerbl, B., Kopanas, G., Leimkühler, T., & Drettakis, G. (2023). 3D Gaussian Splatting for real-time radiance field rendering. *ACM Transactions on Graphics (SIGGRAPH)*, 42(4), 139:1-139:14. DOI: 10.1145/3592433.

	  **SLAM and Robotics Depth**:
	  23. Davison, A.J., Reid, I.D., Molton, N.D., & Stasse, O. (2007). MonoSLAM: Real-time single camera SLAM. *IEEE TPAMI*, 29(6), 1052-1067. DOI: 10.1109/TPAMI.2007.1049. [Imperial College]
	  24. Newcombe, R.A., Izadi, S., Hilliges, O., et al. (2011). KinectFusion: Real-time dense surface mapping and tracking. *ISMAR*, 127-136. DOI: 10.1109/ISMAR.2011.6092378. [Imperial + Microsoft]
	  25. Mur-Artal, R., Montiel, J.M.M., & Tardós, J.D. (2015). ORB-SLAM: A versatile and accurate monocular SLAM system. *IEEE T-RO*, 31(5), 1147-1163. DOI: 10.1109/TRO.2015.2463671.

	  **Benchmarks**:
	  26. Geiger, A., Lenz, P., & Urtasun, R. (2012). Are we ready for autonomous driving? The KITTI vision benchmark suite. *CVPR*, 3354-3361. DOI: 10.1109/CVPR.2012.6248074.
	  27. Silberman, N., Hoiem, D., Kohli, P., & Fergus, R. (2012). Indoor segmentation and support inference from RGBD images. *ECCV*, 746-760. [NYU Depth v2]
	  28. Dai, A., Chang, A.X., Savva, M., Halber, M., Funkhouser, T., & Nießner, M. (2017). ScanNet: Richly-annotated 3D reconstructions of indoor scenes. *CVPR*, 5828-5839. DOI: 10.1109/CVPR.2017.261.

	  **Surveys and References**:
	  29. Laga, H., Jospin, L.V., Boussaid, F., & Bennamoun, M. (2022). A survey on deep learning techniques for stereo-based depth estimation. *IEEE TPAMI*, 44(4), 1738-1764. DOI: 10.1109/TPAMI.2020.3032602.
	  30. Zhao, C., Sun, Q., Zhang, C., Tang, Y., & Qian, F. (2020). Monocular depth estimation based on deep learning: An overview. *Science China Technological Sciences*, 63, 1612-1627. DOI: 10.1007/s11431-020-1582-8.
...
- ### Provenance
  - sources:: [[Hartley & Zisserman 2003 Multiple View Geometry]], [[Scharstein & Szeliski 2002 Stereo Taxonomy]], [[Hirschmüller 2008 Semi-Global Matching]], [[Schönberger & Frahm 2016 COLMAP]], [[Eigen et al. 2014 Multi-Scale Depth CNN]], [[Mayer et al. 2016 DispNet SceneFlow]], [[Godard et al. 2017 MonoDepth Left-Right Consistency]], [[Zhou et al. 2017 SfMLearner]], [[Chang & Chen 2018 PSMNet]], [[Godard et al. 2019 MonoDepth2]], [[Lipson et al. 2021 RAFT-Stereo]], [[Ranftl et al. 2022 MiDaS]], [[Ranftl et al. 2021 DPT]], [[Bhat et al. 2023 ZoeDepth]], [[Yang et al. 2024 Depth Anything]], [[Yang et al. 2024 Depth Anything V2 DA-2K]], [[Ke et al. 2024 Marigold]], [[Piccinelli et al. 2024 UniDepth]], [[Yin et al. 2024 Metric3D v2]], [[Mildenhall et al. 2020 NeRF]], [[Wang et al. 2021 NeuS]], [[Kerbl et al. 2023 3D Gaussian Splatting]], [[Davison et al. 2007 MonoSLAM]], [[Newcombe et al. 2011 KinectFusion]], [[Geiger et al. 2012 KITTI Benchmark]], [[Silberman et al. 2012 NYU Depth v2]], [[Dai et al. 2017 ScanNet]], [[Laga et al. 2022 Stereo Survey]], [[Zhao et al. 2020 Monocular Depth Survey]], [[ARKit Depth API Documentation]], [[ARCore Depth API Documentation]]
