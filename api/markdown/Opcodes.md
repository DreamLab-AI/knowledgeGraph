schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#Opcodes
legacy_uri:: urn:visionclaw:concept:blockchain:opcodes
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-5e7972f31f3a"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#Opcodes"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:opcodes"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:82b2bc35863a155800c1247a470dde790a3db0d3b9f57559892de0a12bd42ab0@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:opcodes",
  "@type": "OntologyClass",
  "label": "Opcodes",
  "subClassOf": [
    {
