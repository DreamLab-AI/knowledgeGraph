schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/distributed-collaboration#RoboticsTelepresenceBridge
legacy_uri:: urn:visionclaw:concept:distributed-collaboration:robotics-telepresence-bridge
public:: true
...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "robotics-telepresence-bridge",
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:tele-205-surgical-telepresence",
      "vc:label": "TELE-205-surgical-telepresence"
    },
    {
    ...
    {
      "@id": "urn:visionflow:owl:class:convergence-concept",
      "vc:label": "ConvergenceConcept"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-537f63449934"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/distributed-collaboration#RoboticsTelepresenceBridge"
    },
    {
    ...
    },
    {
      ...
      "vc:value": "Robotics-Telepresence Bridge"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:distributed-collaboration:robotics-telepresence-bridge"
    },
    {
      "vc:key": "status",
      "vc:value": "active"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:robotics-telepresence-bridge:776c802a9fc9",
  ...
  "vc:resolutions": [
    {
      "raw": "[[HazardousEnvironmentAccess]]",
      "resolved": "urn:visionflow:linked:hazardous-environment-access",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[TELE-205-surgical-telepresence]]",
      "resolved": "urn:visionflow:linked:tele-205-surgical-telepresence",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[ConvergenceConcept]]",
      "resolved": "urn:visionflow:owl:class:convergence-concept",
      "kind": "ResolvedLink"
    },
    {
