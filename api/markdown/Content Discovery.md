```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:digital-curation-platform",
      "vc:label": "Digital Curation Platform"
    },
    {
      "@id": "urn:visionflow:linked:discovery-layer",
    ...
    {
      "@id": "urn:visionflow:linked:digital-services-act",
    ...
    {
      "@id": "urn:visionflow:linked:decentralised-content-network",
      "vc:label": "Decentralised Content Network"
    },
    {
      "@id": "urn:visionflow:linked:nostr-protocol",
      "vc:label": "Nostr Protocol"
    },
    {
      "@id": "urn:visionflow:linked:federated-social-web",
      "vc:label": "Federated Social Web"
    },
    {
      "@id": "urn:visionflow:linked:engagement-maximisation",
      "vc:label": "Engagement Maximisation"
    },
    {
...
```json-ld
{
  ...
  "relations": {
    ...
    "relatedTo": [
      ...
      {
        "@id": "urn:ngm:class:engagement-maximisation",
        "label": "Engagement Maximisation"
      },
      {
...
- ### Content
  ...
  - ## Formal Analysis
    ...
    - **Retrieval Pipeline Stages**
      - Stage 1 — Candidate Generation: Given corpus |C| ≈ 10⁹, approximate methods (ANN search over dense embeddings, inverted [private] lookup for sparse queries) reduce candidates to |C₁| ≈ 10³–10⁴ with sub-second latency.
  ...
  - ## Mathematical Foundations
    ...
    - **Dense Bi-Encoder Retrieval**
      ...
      - Retrieval proceeds by approximate nearest-neighbour search over pre-computed document embeddings stored in a HNSW [private] (Malkov and Yashunin, 2018), enabling sub-millisecond k-NN retrieval over billions of documents.
    ...
    - **Two-Tower Neural Recommendation**
      ...
      - Trained on click/engagement implicit feedback with in-batch negatives or hard negative mining; at serving time, item tower embeddings are pre-computed and user tower is evaluated online at query time, enabling approximate nearest-neighbour retrieval from the item [private].
  ...
  - ## Components / Architecture
    ...
    - **Decentralised Discovery**
      - DHT-based routing (Kademlia): nodes locate content without centralised [private]; used in IPFS/BitTorrent-derived stacks.
