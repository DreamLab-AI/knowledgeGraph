schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#DistributedLedgerTechnologyDLT
legacy_uri:: urn:visionclaw:concept:infrastructure:distributed-ledger-technology-dlt
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-d1539391da16"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#DistributedLedgerTechnologyDLT"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:distributed-ledger-technology-dlt"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
