schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/security#IdentityManagementSystem
legacy_uri:: urn:visionclaw:concept:security:identity-management-system
public:: true
...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "identity-management-system",
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:entra-id",
      "vc:label": "Entra ID"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:keycloak",
      "vc:label": "Keycloak"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-a4e7f2b9c031"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/security#IdentityManagementSystem"
    },
    {
    ...
    },
    {
      ...
      "vc:value": "Identity Management System"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:security:identity-management-system"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:identity-management-system:776c802a9fc9",
  ...
  "vc:resolutions": [
    {
      "raw": "[[Authorisation Engine]]",
      "resolved": "urn:visionflow:linked:authorisation-engine",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Entra ID]]",
      "resolved": "urn:visionflow:linked:entra-id",
      "kind": "StubLink"
    },
    {
      "raw": "[[FAPI 2.0]]",
      "resolved": "urn:visionflow:linked:fapi-2-0",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Keycloak]]",
      "resolved": "urn:visionflow:linked:keycloak",
      "kind": "StubLink"
    },
    {
      "raw": "[[LDAP]]",
    ...
    {
      "raw": "[[MFA Service]]",
      "resolved": "urn:visionflow:linked:mfa-service",
      "kind": "StubLink"
    },
    {
      "raw": "[[NIST]]",
    ...
    {
      "raw": "[[Privilege Access Management]]",
      "resolved": "urn:visionflow:linked:privilege-access-management",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Provisioning Engine]]",
      "resolved": "urn:visionflow:linked:provisioning-engine",
      "kind": "StubLink"
    },
    {
      "raw": "[[SAML 2.0]]",
    ...
    {
      "raw": "[[SCIM 2.0]]",
      "resolved": "urn:visionflow:linked:scim-2-0",
      "kind": "StubLink"
    },
    {
      "raw": "[[SecurityDomain]]",
    ...
    {
      "raw": "[[User Lifecycle Management]]",
      "resolved": "urn:visionflow:linked:user-lifecycle-management",
      "kind": "StubLink"
    },
    {
      "raw": "[[W3C]]",
...
- ### Definition
  - An [[Identity Management System]] (IdM/IAM — Identity and Access Management) is a comprehensive technology framework that governs the full lifecycle of digital identities—creation, provisioning, authentication, authorisation, federation, delegation, and decommissioning—across enterprise, cloud, customer-facing, and sovereign digital ecosystems. IAM platforms integrate multiple protocol layers working in concert: [[SAML 2.0]] (Security Assertion Markup Language, OASIS 2005) for enterprise SSO federation via XML-based assertions exchanged between Identity Providers (IdPs) and Service Providers (SPs), enabling the browser-redirect federation flows that replaced costly per-application credential stores across the enterprise SaaS landscape 2010-2020; [[OpenID Connect]] (OIDC 1.0, OpenID Foundation 2014) layering JSON-based identity semantics atop [[OAuth 2.0]] (RFC 6749/6750, IETF 2012) for delegated authorisation, where OAuth 2.0 governs resource access delegation and OIDC adds the standardised ID token (JWT, RFC 7519) conveying authenticated user attributes; [[SCIM 2.0]] (System for Cross-domain Identity Management, RFC 7642-7644, IETF 2015) providing a REST+JSON API for automated provisioning and deprovisioning across domain boundaries, eliminating the manual joiner-mover-leaver workflows that historically created shadow accounts and orphaned entitlements; [[FAPI 2.0]] (Financial-grade API Security Profile, OpenID Foundation, Final Specification June 2024) defining a high-assurance OAuth 2.0 profile binding tokens to client keys via DPoP (Demonstrating Proof of Possession, RFC 9449) or mutual TLS (RFC 8705), mandatory for regulated financial API ecosystems; and [[FIDO2]] / [[WebAuthn]] (W3C Recommendation 2019, Level 2 2021, CTAP2.1 2022) providing phishing-resistant cryptographic authentication via hardware-bound passkeys that eliminate password credentials at the authentication layer entirely.
...
- ### Semantic Classification
  ...
  - owl-role:: SecurityInfrastructure
  - owl-inferred:: security:AccessControlSystem, security:AuthenticationSystem, security:DirectoryService, security:GovernanceFramework
  - belongs-to-domain:: [[SecurityDomain]], [[InfrastructureDomain]], [[GovernanceDomain]]
  - implemented-in-layer:: [[InfrastructureLayer]], [[ApplicationLayer]], [[PolicyLayer]]

- ### Relationships
  - is-subclass-of:: [[Access Control System]], [[Governance Framework]], [[Security Architecture]], [[Zero Trust Architecture]], [[Digital Infrastructure]]
  - has-part:: [[Identity Provider]], [[Authentication Service]], [[Authorisation Engine]], [[Directory Service]], [[Provisioning Engine]], [[Audit Trail]], [[Policy Decision Point]], [[Session Manager]], [[MFA Service]], [[Privilege Access Management]]
  - requires:: [[Public Key Infrastructure]], [[Directory Service]], [[API Gateway]], [[Hardware Security Module]], [[Cryptographic Protocol]], [[Risk Assessment]]
  - enables:: [[Single Sign-On]], [[Federated Identity]], [[Zero Trust Architecture]], [[Passwordless Authentication]], [[Privileged Access Management]], [[Regulatory Compliance]], [[Audit Trail]], [[User Lifecycle Management]]
...
- ### Content
  ...
  - The 2024-2026 IAM market is defined by consolidation, AI integration, and government identity infrastructure buildout. **Market consolidation**: Thoma Bravo's portfolio (Ping Identity + ForgeRock + SailPoint + Sailpoint IPO June 2024 at $6.9B valuation) creates a vertically integrated IAM+IGA stack with combined 5B+ managed identities and $2.5B+ combined ARR; Microsoft Entra suite expansion beyond identity into SSE (Security Service Edge) integrating Entra Internet Access and Entra Private Access with Entra ID creates a unified Zero Trust platform covering identity, network access, and endpoint compliance; Okta's recovery post-breach with Customer Identity Cloud (Auth0) growing at 20%+ ARR and Okta AI (2024) deploying ML-powered Identity Threat Protection.
  ...
  - **IAM market sizing 2024-2028** (MarketsandMarkets): Total IAM $21.8B (2023) → $34.5B (2028), CAGR 9.6%; CIAM segment $12.3B → $22.1B; PAM $3.9B → $7.8B; IGA $5.6B → $9.4B. Identity Security Platform (converged IAM+PAM+IGA) emerging as category: CyberArk Identity Security Platform, SailPoint Identity Security Cloud, Saviynt Cloud PAM + IGA combined.
