schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#AnimationSoftware
legacy_uri:: urn:visionclaw:concept:spatial-computing:animation-software
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-8297afe9e83b"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#AnimationSoftware"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:animation-software"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
