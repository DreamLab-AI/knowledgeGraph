schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#EyeTracking
legacy_uri:: urn:visionclaw:concept:spatial-computing:eye-tracking
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-58e3613d1c13"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#EyeTracking"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:eye-tracking"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
