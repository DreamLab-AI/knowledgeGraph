schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#TechnicalArchitectureFramework
legacy_uri:: urn:visionclaw:concept:spatial-computing:technical-architecture-framework
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-da9a8c50895b"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#TechnicalArchitectureFramework"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:technical-architecture-framework"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:beb34c79cc579d1ad8c933aace2288fabb854c5f950642a82a9ea50154c1b63e@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
```json-ld
{
  ...
  "definition": "Technical Architecture Framework is a concept within the metaverse domain. Further enrichment pending.",
  "vc:qualityScore": {
    "@value": "0.35",
    "@type": "xsd:float"
  },
