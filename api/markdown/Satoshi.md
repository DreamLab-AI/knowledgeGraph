...
```json-ld
{ "@context":"https://narrativegoldmine.com/ns/v1", "@id":"urn:visionflow:page:satoshi", "@type":"Page", "title":"Satoshi", "vc:slug":"satoshi", "vc:public":true, "vc:schemaVersion":2, "vc:outboundWikilinks":[] }
```
...
```json-ld
{
  ...
  "domain":"blockchain",
  "maturity":"draft",
  "subClassOf":[{"@id":"urn:ngm:class:bitcoin","label":"Bitcoin"}],
  "relations":{},
  "sameAs":[],
  "quality":0.55,
