- ### OntologyBlock
  ...
  collapsed:: true
	...
	- source-domain:: ai
	- owl:class:: ai:PlacingOnTheMarket
	- status:: active
	- public-access:: true
...
Placing on the Market refers to the first making available of an ai system on the union market.
...
2. Veale, M., & Borgesius, F. Z. (2021). Demystifying the Draught EU Artificial Intelligence Act. *Computer Law & Security Review*, 41, 105567. https://doi.org/10.1016/j.clsr.2021.105567
