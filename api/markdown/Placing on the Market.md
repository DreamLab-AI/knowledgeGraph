...
(Declaration (Class :PlacingOnTheMarket))

;; Annotations
(AnnotationAssertion rdfs:label :PlacingOnTheMarket "Placing on the Market"@en)
(AnnotationAssertion rdfs:comment :PlacingOnTheMarket "The first making available of an AI system on the Union market."@en)

;; Data Properties
(AnnotationAssertion dcterms:identifier :PlacingOnTheMarket "mv-1761742247952"^^xsd:string)
```
