schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#XRAccessibilityGuideline
legacy_uri:: urn:visionclaw:concept:spatial-computing:xr-accessibility-guideline
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-331b0bfa9fa3"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#XRAccessibilityGuideline"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:xr-accessibility-guideline"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
