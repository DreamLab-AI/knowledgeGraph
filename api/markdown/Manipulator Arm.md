schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#ManipulatorArm
legacy_uri:: urn:visionclaw:concept:spatial-computing:manipulator-arm
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-6a9eaa61ccde"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#ManipulatorArm"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:manipulator-arm"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
