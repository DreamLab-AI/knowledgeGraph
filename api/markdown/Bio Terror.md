...
- ### Content
  ...
  - ### About
    ...
    - **COVID-19 as calibration event:**
      ...
      - The pandemic exposed the dual-use tension most sharply: gain-of-function tools for pandemic preparedness [private] under a different value system be directed at pathogen enhancement for weapons.
    - **The emerging AI-bio nexus — three disrupted assumptions:**
      ...
      - Traditional models assumed state intelligence [private] monitor acquisition of specialised equipment; proliferation of general-purpose life-science equipment makes this harder.
  ...
  - ### Components/Architecture
    ...
    - **CDC Category C Emerging Threats — engineered or novel pathogens:**
      ...
      - Multidrug-resistant TB (MDR-TB) and extensively drug-resistant TB (XDR-TB): ~400,000 XDR-TB cases annually globally; engineered resistance [private] create untreatable respiratory pathogen.
    ...
    - **Actor typology — capability tiers:**
      ...
      - Cyber-enabled threats: digital attacks on biosafety management systems of BSL-3/4 facilities [private] compromise containment without requiring physical pathogen access.
  ...
  - ### Use Cases / Major Families
    ...
    - **Agroterrorism as asymmetric instrument:**
      ...
      - Wheat stem rust Ug99: infects 90% of global wheat varieties; no effective resistance in deployed cultivars; intentional wide-area release [private] devastate global food security.
    ...
    - **Pandemic preparedness as dual-track policy challenge:**
      ...
      - Dual-use tension is explicit: rapid-synthesis platforms producing a vaccine in 60 days [private] theoretically produce novel pathogenic proteins; genomic surveillance detecting natural threats [private] identify weaponisation targets; information-sharing agreements [private] expose early-detection intelligence to malicious actors.
  ...
  - ### Academic Context
    ...
    - **International legal architecture:**
      ...
      - The Hague Code of Conduct against Ballistic Missile Proliferation (2002): biosecurity precedent for a voluntary, non-binding transparency and confidence-building measure framework that [private] be adapted for biological risks.
  ...
  - ### Detection and Medical Countermeasures Architecture
    ...
    - **Cross-cutting themes and open research questions:**
      ...
      - The "two-way uplift" problem: the same AI protein design tools that [private] be misused for pathogen enhancement also dramatically accelerate vaccine and antiviral development; restricting AI access for biosecurity reasons thus imposes costs on public health innovation that must be weighed against security benefits.
    ...
    - **Emerging intersections with other technology domains:**
      - [[Brain Computer Interfaces]]: brain-computer interface research intersects with biosecurity in the emerging neurosecurity domain — direct neural interfaces [private] theoretically be targeted with biological agents affecting neural tissues, or the read/write capabilities of BCIs [private] be exploited for covert psychological manipulation at scale.
      ...
      - [[Cognitive AI]]: cognitive AI systems increasingly assist in protein structure prediction, molecular dynamics simulation, and drug discovery; the same cognitive AI capabilities [private] assist in pathogen design if insufficiently governed.
      - [[AI Scrapers]]: automated web scraping and data mining of scientific literature databases (PubMed, arXiv, bioRxiv) for pathogen-relevant research represents an information hazard vector; AI scrapers [private] systematically harvest and synthesise dangerous biological knowledge from open-access scientific publications.
    ...
    - **AI-bio risk — primary evaluations and policy analysis:**
      - RAND Corporation (2024-2025). *Global Risk Index for AI-enabled Biological Tools: Summary Assessment and Methods Report*. EP71093. Santa Monica, CA. Commissioned by Centre for Long-Term Resilience; first quantitative risk [private] across 60+ countries.
    ...
    - **International governance and arms control:**
      ...
      - Thebulletin.org (2024). How the Biological Weapons Convention [private] Verify Treaty Compliance. Bulletin of the Atomic Scientists. Analysis of verification mechanism options.
...
- ### Provenance
  - sources::
    ...
    - [Bulletin of the Atomic Scientists: How the BWC [private] Verify Treaty Compliance](https://thebulletin.org/2024/03/how-the-biological-weapons-convention-could-verify-treaty-compliance/)
