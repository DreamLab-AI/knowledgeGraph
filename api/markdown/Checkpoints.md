schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#Checkpoints
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:checkpoints
public:: true
...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:mlops-domain",
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "bridges-to",
      "vc:value": "[[Blockchain]] (bc), [[Distributed Training]] (ai), [[MLOps]] (ai)"
    },
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-42be75796b6d"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#Checkpoints"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:checkpoints"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:checkpoints:776c802a9fc9",
  ...
  "vc:resolutions": [
    {
      ...
      "resolved": "urn:visionflow:linked:checkpoint-averaging",
      "kind": "StubLink"
    },
    {
      "raw": "[[Checkpoint Frequency Policy]]",
      "resolved": "urn:visionflow:linked:checkpoint-frequency-policy",
      "kind": "StubLink"
    },
    {
      "raw": "[[Checkpoint Index]]",
      "resolved": "urn:visionflow:linked:checkpoint-index",
      "kind": "StubLink"
    },
    {
      "raw": "[[DeepSpeed]]",
    ...
    {
      "raw": "[[Distributed Training Recovery]]",
      "resolved": "urn:visionflow:linked:distributed-training-recovery",
      "kind": "StubLink"
    },
    {
      "raw": "[[DVC]]",
    ...
    {
      "raw": "[[EMA Shadow Weights]]",
      "resolved": "urn:visionflow:linked:ema-shadow-weights",
      "kind": "StubLink"
    },
    {
      "raw": "[[Experiment Reproducibility]]",
      "resolved": "urn:visionflow:linked:experiment-reproducibility",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[FSDP]]",
      "resolved": "urn:visionflow:linked:fsdp",
      "kind": "StubLink"
    },
    {
      "raw": "[[GGUF]]",
      "resolved": "urn:visionflow:linked:gguf",
      "kind": "StubLink"
    },
    {
      "raw": "[[Hugging Face]]",
    ...
    {
      "raw": "[[MLflow]]",
      "resolved": "urn:visionflow:linked:mlflow",
      "kind": "StubLink"
    },
    {
      "raw": "[[MLOps]]",
    ...
    {
      "raw": "[[MLOpsDomain]]",
      "resolved": "urn:visionflow:linked:mlops-domain",
      "kind": "StubLink"
    },
    {
      "raw": "[[Model Distillation]]",
      "resolved": "urn:visionflow:linked:model-distillation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Model Registry]]",
    ...
    },
    {
      ...
      "resolved": "urn:visionflow:linked:model-serialisation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Model Serving]]",
    ...
    {
      "raw": "[[On-the-fly Training]]",
      "resolved": "urn:visionflow:linked:on-the-fly-training",
      "kind": "StubLink"
    },
    {
      "raw": "[[ONNX]]",
    ...
    {
      "raw": "[[Optimiser State]]",
      "resolved": "urn:visionflow:linked:optimiser-state",
      "kind": "StubLink"
    },
    {
      "raw": "[[PEFT]]",
      "resolved": "urn:visionflow:linked:peft",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Pickle]]",
      "resolved": "urn:visionflow:linked:pickle",
      "kind": "StubLink"
    },
    {
      "raw": "[[PyTorch]]",
    ...
    {
      "raw": "[[PyTorch Foundation]]",
      "resolved": "urn:visionflow:linked:py-torch-foundation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Quantisation]]",
    ...
    {
      "raw": "[[RNG State]]",
      "resolved": "urn:visionflow:linked:rng-state",
      "kind": "StubLink"
    },
    {
      "raw": "[[Safetensors]]",
    ...
    {
      "raw": "[[SavedModel]]",
      "resolved": "urn:visionflow:linked:saved-model",
      "kind": "StubLink"
    },
    {
      "raw": "[[Serialisation]]",
      "resolved": "urn:visionflow:linked:serialisation",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Shard Metadata]]",
      "resolved": "urn:visionflow:linked:shard-metadata",
      "kind": "StubLink"
    },
    {
      "raw": "[[Stateless Execution]]",
      "resolved": "urn:visionflow:linked:stateless-execution",
      "kind": "StubLink"
    },
    {
      "raw": "[[Step Counter]]",
      "resolved": "urn:visionflow:linked:step-counter",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[TorchScript]]",
      "resolved": "urn:visionflow:linked:torch-script",
      "kind": "StubLink"
    },
    {
      "raw": "[[TrainingLayer]]",
    ...
    {
      "raw": "[[Training Loop]]",
      "resolved": "urn:visionflow:linked:training-loop",
      "kind": "StubLink"
    },
    {
      "raw": "[[Training Resumption]]",
      "resolved": "urn:visionflow:linked:training-resumption",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Weight Tensor]]",
      "resolved": "urn:visionflow:linked:weight-tensor",
      "kind": "StubLink"
    },
    {
      "raw": "[[Weights and Biases]]",
      "resolved": "urn:visionflow:linked:weights-and-biases",
      "kind": "StubLink"
    },
    {
      "raw": "[[ZeRO]]",
      "resolved": "urn:visionflow:linked:ze-ro",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Learning Rate Schedule]]",
      "resolved": "urn:visionflow:owl:class:learning-rate-schedule",
      "kind": "ResolvedLink"
    },
    {
      "raw": "[[LoRA]]",
...
- ### Definition
  - Checkpoints are serialised snapshots of a machine-learning model's complete trainable state — weight tensors, optimiser moment accumulators, learning-rate schedules, gradient scalers, random-number-generator seeds, and epoch/step counters — persisted to durable storage at regular intervals during training so that: (a) training can resume after hardware failure or preemption without replaying all prior computation; (b) intermediate weight versions can be evaluated and compared before committing to a final release; (c) the best-performing weight configuration identified during a hyperparameter sweep can be recovered independently of the final training step; and (d) pre-trained representations can be shared and reused for downstream [[Transfer Learning]] and [[Fine-tuning]] tasks without distributing training code or data.
  - **PyTorch serialisation**: The dominant mechanism in [[PyTorch]] is `torch.save` / `torch.load` applied to the dictionary returned by `model.state_dict()` and `optimizer.state_dict()`, yielding `.pt` or `.pth` files that embed Python pickle objects. This approach is ergonomic but carries an arbitrary code-execution risk because pickle deserialisation is inherently unsafe — a vulnerability exploited in multiple documented supply-chain attacks against shared model repositories on [[Hugging Face]] Hub and CivitAI.
  - **TensorFlow serialisation**: [[TensorFlow]] offers two distinct checkpoint mechanisms: the legacy `.ckpt` format comprising `.data-?????-of-?????`, `.index`, and `.meta` triplets managed by `tf.train.Checkpoint`; and the higher-level `SavedModel` directory format bundling weights with the full computation graph and serving signatures, enabling language-agnostic serving via TensorFlow Serving, TFLite conversion, and TensorFlow.js export.
  - **Safetensors**: The [[Safetensors]] format, originally released by [[Hugging Face]] in September 2022 and donated to the PyTorch Foundation / Linux Foundation in April 2026, eliminates the arbitrary-code-execution vector by replacing pickle with a flat binary layout preceded by a JSON header describing tensor names, dtypes, shapes, and byte offsets, enabling zero-copy memory-mapped loading via `mmap` with verified bounds. Load times are 5-10× faster than pickle for large models because tensor bytes can be loaded directly without Python object construction overhead. By mid-2025 the majority of models on [[Hugging Face]] Hub — including LLaMA-4, Qwen-3, Deepseek-R1, Stable Diffusion XL, and every major encoder-decoder — ship `.safetensors` shards as the primary download artifact.
  - **Distributed training checkpoints**: For [[Distributed Training]] spanning hundreds to thousands of GPUs under [[DeepSpeed]] ZeRO-1/2/3 or [[FSDP]] (Fully Sharded Data Parallel), monolithic single-rank checkpointing is infeasible because no single node holds the full parameter tensor. [[PyTorch]]'s `torch.distributed.checkpoint` (DCP) API, introduced in PyTorch 2.0 and stabilised in 2.3-2.5, allows each rank to write its local shard independently in parallel to a shared filesystem (Lustre, GPFS, or object storage via fsspec), with resharding metadata sufficient to reconstruct the full model at load time even when the target cluster topology differs from the save topology — enabling scale-up from 64 to 256 GPUs or scale-down for inference serving without manually concatenating shards.
...
- ### Semantic Classification
  ...
  - owl-role:: TrainingArtifact
  - owl-inferred:: ai:ModelSerialisation, ai:FaultTolerance, ai:ModelVersioning
  - belongs-to-domain:: [[AI-GroundedDomain]], [[MachineLearningDomain]], [[MLOpsDomain]]
  - implemented-in-layer:: [[StorageLayer]], [[TrainingLayer]], [[InfrastructureLayer]]
...
- ### Relationships
  ...
  - standardized-by:: [[PyTorch Foundation]], [[Linux Foundation]], [[Hugging Face]], [[TensorFlow]], [[DeepSpeed]]
...
- ### Content
  ...
  - **Checkpoint storage economics** at scale (2025-2026):
    - A frontier LLM checkpoint (70B params, BF16): ~140 GB per checkpoint; at $0.02/GB/month on cloud object storage, keeping 10 checkpoints costs ~$28/month per training run
    - Checkpointing every 500 steps for a 500,000-step training run generates 1,000 checkpoints; with keep-last-5 policy the live storage footprint stays at ~700 GB ($14/month) but the total bytes written are 140 TB (at $0.01/GB transfer: $1,400 egress cost for distributed reads)
