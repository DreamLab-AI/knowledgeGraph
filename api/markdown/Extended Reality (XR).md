schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#ExtendedRealityXR
legacy_uri:: urn:visionclaw:concept:spatial-computing:extended-reality-xr
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-65d42b346c53"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#ExtendedRealityXR"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:extended-reality-xr"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
