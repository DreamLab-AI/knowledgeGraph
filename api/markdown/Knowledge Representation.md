schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#KnowledgeRepresentation
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:knowledge-representation
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-bee701914abf"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#KnowledgeRepresentation"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:knowledge-representation"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
