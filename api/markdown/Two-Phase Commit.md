...
```json-ld
{
  ...
  "relations": {
    "hasPart": [
      ...
      {"@id": "urn:ngm:class:transaction-coordinator", "label": "Transaction Coordinator"}
    ],
    "partOf": [
      {"@id": "urn:ngm:class:xa-protocol", "label": "XA Protocol"},
    ...
    "implements": [
      {"@id": "urn:ngm:class:atomic-commitment-protocol", "label": "Atomic Commitment Protocol"}
    ],
    "uses": [
    ...
    "standardizedBy": [
      {"@id": "urn:ngm:class:iso-iec-standard", "label": "ISO/IEC Standard"}
    ],
    "contrastsWith": [
      {"@id": "urn:ngm:class:raft-consensus", "label": "RAFT Consensus"},
      {"@id": "urn:ngm:class:three-phase-commit", "label": "Three-Phase Commit"},
      {"@id": "urn:ngm:class:saga-pattern", "label": "Saga Pattern"},
      {"@id": "urn:ngm:class:paxos", "label": "Paxos"}
    ],
    "bridgesTo": [
      {"@id": "urn:ngm:class:blockchain", "label": "Blockchain"},
      {"@id": "urn:ngm:class:cross-chain-atomic-swap", "label": "Cross-Chain Atomic Swap"}
    ],
    "relatedTo": [
  ...
  "sameAs": [
    {"@id": "urn:ngm:class:2pc", "label": "2PC"},
    {"@id": "urn:ngm:class:two-phase-commit-protocol", "label": "Two-Phase Commit Protocol"}
  ],
  "quality": 0.75,
  "provenance": {
