schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#SemanticWebStandards
legacy_uri:: urn:visionclaw:concept:spatial-computing:semantic-web-standards
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-3d2615746f5c"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#SemanticWebStandards"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:semantic-web-standards"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
