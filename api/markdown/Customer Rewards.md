schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#CustomerRewards
legacy_uri:: urn:visionclaw:concept:spatial-computing:customer-rewards
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-3cdc07f9d0a9"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#CustomerRewards"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:customer-rewards"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
