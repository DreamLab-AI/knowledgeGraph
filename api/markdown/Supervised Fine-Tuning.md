...
```clojure
(Declaration (Class :SupervisedFineTuning))
(SubClassOf :SupervisedFineTuning :FineTuning)
(SubClassOf :SupervisedFineTuning
  (ObjectSomeValuesFrom :requiresData :LabelledInputOutputPairs))
(SubClassOf :SupervisedFineTuning
  (ObjectSomeValuesFrom :optimizesVia :SupervisedLoss))
(SubClassOf :SupervisedFineTuning
  (ObjectSomeValuesFrom :establishesBaseline :TaskPerformance))
(SubClassOf :SupervisedFineTuning
  (ObjectSomeValuesFrom :precedesPhase :RLHF))
(SubClassOf :SupervisedFineTuning
  (ObjectSomeValuesFrom :formsStage :AlignmentPipeline))

(AnnotationAssertion rdfs:comment :SupervisedFineTuning
  "Fine-tuning approach using labelled training data to adapt pre-trained models, forming the first stage in multi-stage alignment pipelines"@en)
(AnnotationAssertion :hasAcademicSource :SupervisedFineTuning
  "Ouyang et al., arXiv:2203.02155 (2022); Bai et al., arXiv:2212.08073 (2022)")
```
