...
- ### Content
  ...
  - ### Future Directions (2026-2030)
	  ...
	  **Open Research Questions (2026-2030)**:
	  ...
	  - **Cost-Aware Tool Selection**: When multiple tools [private] fulfil a query (cheap web search vs expensive LLM-as-judge), how should agents reason about budget vs quality? Production frameworks add cost annotations to tool schemas; principled multi-objective optimisation is open.
