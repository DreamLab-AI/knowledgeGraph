schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/distributed-collaboration#MeetingAIAssistant
legacy_uri:: urn:visionclaw:concept:distributed-collaboration:meeting-ai-assistant
public:: true
...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:digital-provenance",
      "vc:label": "Digital Provenance"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:meeting-platform",
      "vc:label": "Meeting Platform"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:relationships",
      "vc:label": "Relationships"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "bridges-to",
      "vc:value": "[[Natural Language Processing]], [[Knowledge Management]]"
    },
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-14-a3f7c912b088"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/distributed-collaboration#MeetingAIAssistant"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:distributed-collaboration:meeting-ai-assistant"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:meeting-ai-assistant:776c802a9fc9",
  ...
  "vc:resolutions": [
    {
      "raw": "[[Abstractive Summarisation]]",
      "resolved": "urn:visionflow:linked:abstractive-summarisation",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Asynchronous Meeting Access]]",
      "resolved": "urn:visionflow:linked:asynchronous-meeting-access",
      "kind": "StubLink"
    },
    {
      "raw": "[[Audio Stream]]",
      "resolved": "urn:visionflow:linked:audio-stream",
      "kind": "StubLink"
    },
    {
      "raw": "[[Automated Transcription]]",
      "resolved": "urn:visionflow:linked:automated-transcription",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[BERT-based NLP]]",
      "resolved": "urn:visionflow:linked:bert-based-nlp",
      "kind": "StubLink"
    },
    {
      "raw": "[[Calendar Integration]]",
      "resolved": "urn:visionflow:linked:calendar-integration",
      "kind": "StubLink"
    },
    {
      "raw": "[[CCPA]]",
    ...
    {
      "raw": "[[Collaboration Software]]",
      "resolved": "urn:visionflow:linked:collaboration-software",
      "kind": "StubLink"
    },
    {
      "raw": "[[Conformer Architecture]]",
      "resolved": "urn:visionflow:linked:conformer-architecture",
      "kind": "StubLink"
    },
    {
      "raw": "[[CRM Systems]]",
      "resolved": "urn:visionflow:linked:crm-systems",
      "kind": "StubLink"
    },
    {
      "raw": "[[Customer Success]]",
      "resolved": "urn:visionflow:linked:customer-success",
      "kind": "StubLink"
    },
    {
      "raw": "[[Decision Audit Trail]]",
      "resolved": "urn:visionflow:linked:decision-audit-trail",
      "kind": "StubLink"
    },
    {
      "raw": "[[Diarisation Models]]",
      "resolved": "urn:visionflow:linked:diarisation-models",
      "kind": "StubLink"
    },
    {
      "raw": "[[Digital Provenance]]",
      "resolved": "urn:visionflow:linked:digital-provenance",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Distributed Team Coordination]]",
      "resolved": "urn:visionflow:linked:distributed-team-coordination",
      "kind": "StubLink"
    },
    {
      "raw": "[[Distributed Teams]]",
      "resolved": "urn:visionflow:linked:distributed-teams",
      "kind": "StubLink"
    },
    {
      "raw": "[[Email Thread Summaries]]",
      "resolved": "urn:visionflow:linked:email-thread-summaries",
      "kind": "StubLink"
    },
    {
      "raw": "[[Employee Monitoring]]",
      "resolved": "urn:visionflow:linked:employee-monitoring",
      "kind": "StubLink"
    },
    {
      "raw": "[[Extractive Summarisation]]",
      "resolved": "urn:visionflow:linked:extractive-summarisation",
      "kind": "StubLink"
    },
    {
      "raw": "[[GDPR]]",
    ...
    {
      "raw": "[[HR Performance Review]]",
      "resolved": "urn:visionflow:linked:hr-performance-review",
      "kind": "StubLink"
    },
    {
      "raw": "[[Human Minute Taker]]",
      "resolved": "urn:visionflow:linked:human-minute-taker",
      "kind": "StubLink"
    },
    {
      "raw": "[[ICO Guidance on Workplace Monitoring 2024]]",
      "resolved": "urn:visionflow:linked:ico-guidance-on-workplace-monitoring-2024",
      "kind": "StubLink"
    },
    {
      "raw": "[[Integration Connector]]",
      "resolved": "urn:visionflow:linked:integration-connector",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Intent Detection]]",
      "resolved": "urn:visionflow:linked:intent-detection",
      "kind": "StubLink"
    },
    {
      "raw": "[[ISO/IEC 27001]]",
    ...
    {
      "raw": "[[LLM-based Text Generation]]",
      "resolved": "urn:visionflow:linked:llm-based-text-generation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Manual Note Taking]]",
      "resolved": "urn:visionflow:linked:manual-note-taking",
      "kind": "StubLink"
    },
    {
      "raw": "[[Meeting Automation]]",
      "resolved": "urn:visionflow:linked:meeting-automation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Meeting Minutes Generation]]",
      "resolved": "urn:visionflow:linked:meeting-minutes-generation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Meeting Platform]]",
      "resolved": "urn:visionflow:linked:meeting-platform",
      "kind": "StubLink"
    },
    {
      "raw": "[[Meeting Platform Access]]",
      "resolved": "urn:visionflow:linked:meeting-platform-access",
      "kind": "StubLink"
    },
    {
      "raw": "[[Meeting Summarisation]]",
      "resolved": "urn:visionflow:linked:meeting-summarisation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Meeting Support Tools]]",
      "resolved": "urn:visionflow:linked:meeting-support-tools",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Post-hoc Recording Review]]",
      "resolved": "urn:visionflow:linked:post-hoc-recording-review",
      "kind": "StubLink"
    },
    {
      "raw": "[[Post-Meeting Workflow]]",
      "resolved": "urn:visionflow:linked:post-meeting-workflow",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Relationships]]",
      "resolved": "urn:visionflow:linked:relationships",
      "kind": "StubLink"
    },
    {
      "raw": "[[Remote Work]]",
    ...
    {
      "raw": "[[Sales Enablement]]",
      "resolved": "urn:visionflow:linked:sales-enablement",
      "kind": "StubLink"
    },
    {
      "raw": "[[Slot Filling]]",
      "resolved": "urn:visionflow:linked:slot-filling",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Speaker Identity Model]]",
      "resolved": "urn:visionflow:linked:speaker-identity-model",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Summarisation]]",
      "resolved": "urn:visionflow:linked:summarisation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Summarisation Models]]",
      "resolved": "urn:visionflow:linked:summarisation-models",
      "kind": "StubLink"
    },
    {
      "raw": "[[Transcription Engine]]",
      "resolved": "urn:visionflow:linked:transcription-engine",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Virtual Meeting Platforms]]",
      "resolved": "urn:visionflow:linked:virtual-meeting-platforms",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Whisper ASR]]",
      "resolved": "urn:visionflow:linked:whisper-asr",
      "kind": "StubLink"
    },
    {
      "raw": "[[Workplace Privacy]]",
      "resolved": "urn:visionflow:linked:workplace-privacy",
      "kind": "StubLink"
    },
    {
...
- ### Definition
  - An AI-powered software agent that attends synchronous and asynchronous [[Virtual Meetings]] either as an autonomous bot participant or as capability embedded within a [[Meeting Platform]], providing continuous [[Automated Transcription]] via large-vocabulary [[Automatic Speech Recognition]] (ASR) engines at word-error rates of 3–12% on clean English business audio (rising to 18–35% on far-field multi-speaker recordings with overlapping speech or heavy accent variation), [[Speaker Diarisation]] that segments the audio timeline and assigns utterances to named participant identities using voiceprint clustering (d-vector / x-vector architectures) or authentication-linked platform identity, [[Summarisation]] compressing hours of meeting dialogue into structured artefacts including executive summary, narrative thread, decision log, and open-questions register through abstractive LLM-based generation achieving ROUGE-L 0.42–0.58 on the AMI Meeting Corpus benchmark, [[Action Item Extraction]] identifying verbal commitments and populating owner, deadline, and task-description fields via slot-filling or generative NLP models achieving F1 0.72–0.85 on annotated meeting corpora, [[Sentiment Analysis]] tracking participant engagement, speaking-time balance, and emotional valence across conversation turns, and real-time [[Meeting Minutes Generation]] integrating all pipeline outputs into version-controlled structured documents that synchronise to [[Project Management]], [[CRM Systems]], and [[Knowledge Base]] platforms via integration connectors. The function of the Meeting AI Assistant is threefold: (a) reduction of cognitive overhead on meeting participants who no longer need to simultaneously engage and take notes; (b) institutional memory preservation ensuring decisions, commitments, and discussion context are durably recorded and searchable across distributed team boundaries; and (c) asynchronous access democratisation enabling colleagues absent from a live meeting to access full structured context without replaying recordings. As of 2026, Meeting AI Assistants process an estimated 15–25 million meeting-hours of audio daily across enterprise deployments, generating structured knowledge artefacts from over 100 million scheduled meetings per month globally. The market includes standalone cloud services (Otter.ai 20M+ users, Fireflies.ai 500K+ organisations, Avoma, Fathom, tl;dv, Chorus.ai, Gong.io $7.25B valuation 2021) and platform-native assistants (Microsoft Copilot in Teams, Zoom AI Companion, Google Gemini in Meet) backed by $2.4B (2024) → $9.8B (2030) market projections (Grand View Research 2025). Consent and privacy governance under [[GDPR]] Article 6/9, [[UK Data Protection Act 2018]] / UK GDPR, the [[CCPA]] (California), and multi-party consent recording statutes across eleven US states and most EU member states impose strict obligations on operators; the UK Information Commissioner's Office (ICO) issued updated workplace monitoring guidance (October 2023, updated 2024) and generative AI data protection guidance (March 2024) specifically addressing lawful basis, transparency obligations, and Data Protection Impact Assessment requirements for AI meeting recording systems in employment contexts. The agentic extension of meeting AI in 2025–2026 transcends passive capture: pre-meeting briefing agents synthesise CRM, calendar, and prior meeting history into advance briefing documents; real-time participant assistance agents surface relevant documents and answer factual questions within the meeting; post-meeting automation agents draft follow-up emails, create task tickets in Jira/Linear/Asana, and update CRM fields autonomously — representing a Gartner-identified inflection from meeting *capture* (Peak of Inflated Expectations, 2025 Hype Cycle for Collaboration Technologies) toward meeting *automation* (mainstream enterprise adoption forecast 2026–2027).

- ### Semantic Classification
  - owl-class:: distributed-collaboration:MeetingAIAssistant
  - owl-role:: MeetingParticipant, KnowledgeCapture, WorkflowAutomation
  - owl-inferred:: dc:CollaborationTool, ai:ConversationalAI, ai:SpeechProcessingSystem
  - belongs-to-domain:: [[DistributedCollaborationDomain]], [[NaturalLanguageProcessingDomain]], [[KnowledgeManagementDomain]]
  - implemented-in-layer:: [[ApplicationLayer]], [[ServiceLayer]], [[IntegrationLayer]]

- ### Relationships
  - is-subclass-of:: [[Collaboration Software]], [[AI Agent]], [[Distributed Collaboration Technology]], [[Conversational AI]], [[Meeting Support Tools]]
  - has-part:: [[Automatic Speech Recognition]], [[Speaker Diarisation]], [[Meeting Summarisation]], [[Action Item Extraction]], [[Sentiment Analysis]], [[Meeting Minutes Generation]], [[Consent Management]], [[Integration Connector]]
  - requires:: [[Audio Stream]], [[Natural Language Processing]], [[Meeting Platform Access]], [[Speaker Identity Model]], [[Transcription Engine]], [[LLM-based Text Generation]]
  - enables:: [[Asynchronous Meeting Access]], [[Decision Audit Trail]], [[Knowledge Preservation]], [[Distributed Team Coordination]], [[Meeting Automation]], [[Post-Meeting Workflow]]
  - implements:: [[Automatic Speech Recognition]], [[Speaker Diarisation]], [[Extractive Summarisation]], [[Abstractive Summarisation]], [[Named Entity Recognition]], [[Intent Detection]], [[Slot Filling]]
  - depends-on:: [[Cloud Infrastructure]], [[Large Language Models]], [[Conformer Architecture]], [[Whisper ASR]], [[BERT-based NLP]], [[Vector Database]], [[Calendar Integration]]
  - supports:: [[Remote Work]], [[Distributed Teams]], [[Asynchronous Collaboration]], [[Sales Enablement]], [[Customer Success]], [[Regulatory Compliance]], [[HR Performance Review]]
  - uses:: [[Natural Language Processing]], [[Transformer Models]], [[Speech Processing]], [[Knowledge Graph]], [[Real-time Transcription]], [[Diarisation Models]], [[Summarisation Models]]
  - contrasts-with:: [[Manual Note Taking]], [[Human Minute Taker]], [[Post-hoc Recording Review]], [[Email Thread Summaries]]
  - related-to:: [[Virtual Meeting Platforms]], [[Project Management]], [[Knowledge Management]], [[CRM Systems]], [[GDPR]], [[UK GDPR]], [[Employee Monitoring]], [[Workplace Privacy]]
  - standardized-by:: [[GDPR]], [[UK Data Protection Act 2018]], [[CCPA]], [[ICO Guidance on Workplace Monitoring 2024]], [[ISO/IEC 27001]]
...
- ### Content
  ...
  ## Compositional Relationships (Components)
	  ...
	  FunctionalDataProperty(dc:asrWordErrorRate)
	  FunctionalDataProperty(dc:dailyMeetingHoursProcessed)
	  ```
  ...
  - **Market size**: Grand View Research (2025) values the global intelligent meeting software market at $2.4B (2024), projecting $9.8B by 2030 at 26.5% CAGR, driven by remote-work entrenchment, enterprise AI budget expansion, and agentic workflow depth.

  - **Competitive funding activity**: Otter.ai raised $90M Series B (2023). Avoma raised $12M Series B (2023). Competition has driven rapid feature parity, shifting differentiation toward enterprise security certifications (SOC 2 Type II, ISO 27001, HIPAA BAA), vertical domain expertise, and agentic workflow depth.
  ...
  - **Domain correction**: None required. The `distributed-collaboration` domain is correct; Meeting AI Assistants are fundamentally [[Distributed Collaboration Technology]] infrastructure tools drawing on AI/NLP techniques. Cross-domain bridges to `artificial-intelligence` and `knowledge-management` are captured in the `bridges-to` property and [[Relationships]] section.

  - **Legacy term ID**: DC-1041 assigned (distributed-collaboration prefix, four-digit sequence).
...
- ### Provenance
  - 1. McCowan, I. et al. (2005). "The AMI Meeting Corpus." MLMI 2005, Edinburgh. https://corpus.amiproject.org/
  - 2. Janin, A. et al. (2003). "The ICSI Meeting Corpus." ICASSP 2003, Hong Kong. https://groups.inf.ed.ac.uk/ami/icsi/
  ...
  - 4. Radford, A. et al. (2022). "Robust Speech Recognition via Large-Scale Weak Supervision." OpenAI Technical Report. https://arxiv.org/abs/2212.04356
  - 5. Fujita, Y. et al. (2019). "End-to-End Neural Speaker Diarization with Permutation-Free Objectives." Interspeech 2019. https://arxiv.org/abs/1909.05952
  - 6. Horiguchi, S. et al. (2022). "Encoder-Decoder Based Attractor Calculation for End-to-End Neural Diarization (EEND-EDA)." IEEE/ACM TASLP. https://arxiv.org/abs/2106.10654
  - 7. Watanabe, S. et al. (2020). "CHiME-6 Challenge: Tackling Multispeaker Speech Recognition for Unsegmented Recordings." CHiME-6 Workshop. https://arxiv.org/abs/2004.09249
  - 8. Ryant, N. et al. (2021). "Third DIHARD Challenge: System Description and Results." Interspeech 2021. https://arxiv.org/abs/2012.01477
  - 9. Purver, M. et al. (2006). "Detecting Action Items in Multi-party Meetings: Annotation and Initial Experiments." MLMI 2006.
  - 10. Gruenstein, A. et al. (2008). "Meeting Transcription Using Virtual Microphones." ICASSP 2008.
  - 11. Tur, G. et al. (2010). "The CALO Meeting Speech Recognition and Understanding System." IEEE TASLP 18(6).
  - 12. Rennard, E. et al. (2023). "Meeting Action Item Detection with LLMs: Benchmark and Analysis." EMNLP 2023. https://arxiv.org/abs/2310.00281
  - 13. Zhong, M. et al. (2021). "QMSum: A New Benchmark for Query-based Multi-domain Meeting Summarization." NAACL 2021. https://arxiv.org/abs/2104.05938
  - 14. Shang, G. et al. (2018). "Unsupervised Abstractive Meeting Summarization with Multi-Sentence Compression and Budgeted Submodular Maximization." ACL 2018. https://arxiv.org/abs/1805.05271
  - 15. Gillick, D. et al. (2009). "A Global Optimization Framework for Meeting Summarization." ICASSP 2009.
  - 16. Riedhammer, K. et al. (2010). "Long Story Short — Global Unsupervised Models for Keyphrase-Based Meeting Summarization." Speech Communication 52(10).
  - 17. Hinton, G. et al. (2012). "Deep Neural Networks for Acoustic Modeling in Speech Recognition." IEEE Signal Processing Magazine 29(6).
  - 18. Landini, F. et al. (2022). "Bayesian HMM Clustering of x-vector Sequences (VBx) in Speaker Diarization." Computer Speech & Language 71.
  - 19. ICO (2023). "Guidance on Employee Monitoring." UK Information Commissioner's Office. https://ico.org.uk/for-organisations/uk-gdpr-guidance-and-resources/employment/monitoring-workers/
  - 20. ICO (2024). "Guidance on Generative AI and Data Protection." UK Information Commissioner's Office. https://ico.org.uk/for-organisations/uk-gdpr-guidance-and-resources/artificial-intelligence/guidance-on-ai-and-data-protection/
  - 21. European Parliament (2024). "Regulation (EU) 2024/1689 (EU AI Act)." Official Journal of the EU. https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=OJ:L_202401689
  - 22. UK Government (2018). "Data Protection Act 2018." legislation.gov.uk. https://www.legislation.gov.uk/ukpga/2018/12/contents
  - 23. Gong.io Research (2024). "State of Conversation Intelligence 2024." https://www.gong.io/resources/reports/state-of-conversation-intelligence/
  - 24. Gartner (2025). "Hype Cycle for Collaboration Technologies, 2025." Gartner Research G00787251.
  - 25. Grand View Research (2025). "Intelligent Meeting Management Software Market Report 2025–2030." https://www.grandviewresearch.com/industry-analysis/intelligent-meeting-management-software-market
  - 26. Qi, P. et al. (2023). "A Survey on Dialogue Summarization: Recent Advances and New Frontiers." IJCAI 2023. https://arxiv.org/abs/2107.03175
  - 27. Zuboff, S. (2019). "The Age of Surveillance Capitalism." PublicAffairs, New York. ISBN 978-1610395694.
  - 28. Zhong, M. et al. (2022). "Unsupervised Summarization with Customized Granularities." EMNLP 2022. https://arxiv.org/abs/2210.13059
