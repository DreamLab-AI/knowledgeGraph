...
```json-ld
{
  ...
  "vc:plainGloss": "Standard tests that AI models are all put through so their results can be compared fairly. Like a common exam, they give each model a score on the same tasks, letting you see which is stronger at reasoning, coding and so on.",
  "domain": "ai",
