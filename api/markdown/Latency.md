schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#Latency
legacy_uri:: urn:visionclaw:concept:spatial-computing:latency
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-7395d5fa26c1"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#Latency"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:latency"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
