schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#SpatialAudioSceneDescription
legacy_uri:: urn:visionclaw:concept:spatial-computing:spatial-audio-scene-description
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-208750031b0b"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#SpatialAudioSceneDescription"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:spatial-audio-scene-description"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
