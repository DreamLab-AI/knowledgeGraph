schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#DisplayMetrology
legacy_uri:: urn:visionclaw:concept:spatial-computing:display-metrology
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-7fc96102dd11"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#DisplayMetrology"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:display-metrology"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
