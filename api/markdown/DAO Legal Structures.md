iri:: http://narrativegoldmine.com/blockchain#DaoLegalStructures
uri:: urn:visionclaw:concept:blockchain:dao-legal-structures
rdf-type:: owl:Class
same-as:: urn:visionclaw:concept:blockchain:dao-legal-structures
type:: owl:Class
context:: https://visionclaw.dreamlab-ai.systems/ns/v2
domain:: blockchain
preferred-term:: DAO Legal Structures
content-hash:: sha256-12-bbc8e271ebe0
legacy-term-id:: BC-0470
...
- ### Definition
  - Organisational and jurisdictional frameworks establishing legal entity status, liability limits, and regulatory recognition for [[Decentralised Autonomous Organisations]] operating under various governance models. These [[Legal Frameworks]] address [[Liability Protection]], [[Tax Treatment]], and [[Regulatory Compliance]].
...
- ### Content
  ...
  - ### Legal Frameworks by Jurisdiction
		...
		- - **Algorithmic management**: DAOs may be "algorithmically managed" via smart contracts, removing requirement for human managers. The smart contract addresses must be disclosed in formation documents
