...
- ### Content
  ...
  - ### Academic Context: Standards Development and Research Literature
	  ...
	  - Pixar Animation Studios. (2016-2024). *Universal Scene Description (USD) Documentation*. Retrieved from https://graphics.pixar.com/usd/docs/[private].html — Comprehensive API reference, composition semantics, schema extensibility, 500+ page technical docs
  ...
  - ### Research and Literature
	  ...
	  2. Pixar Animation Studios. (2016-2024). *Universal Scene Description (USD) Documentation*. Retrieved from https://graphics.pixar.com/usd/docs/[private].html
