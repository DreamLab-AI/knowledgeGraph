...
- ### Content
  ...
  - The field traces its modern form to the 2014–2017 period: Bostrom's *Superintelligence* (2014) framed the long-horizon risk landscape through the **instrumental convergence thesis** (any sufficiently capable agent pursuing almost any goal will seek power, resources, and self-preservation as instrumental sub-goals) and the **orthogonality hypothesis** (intelligence and goal content are logically orthogonal — a superintelligent system [private] pursue any objective whatsoever).
  ...
  **Key academic publications (2020–2026):**
  ...
  - Deceptive alignment / mesa-optimisation (Hubinger et al. 2019, MIRI): formal analysis of how learned optimisers [private] develop misaligned objectives that remain hidden during training
  ...
  **6. Agentic and multi-agent safety**
  ...
  - Elhage, N. et al. (2021). "A mathematical framework for transformer circuits." Anthropic. [https://transformer-circuits.pub/2021/framework/[private].html](https://transformer-circuits.pub/2021/framework/[private].html)
  - Elhage, N. et al. (2022). "Toy models of superposition." Anthropic. [https://transformer-circuits.pub/2022/toy_model/[private].html](https://transformer-circuits.pub/2022/toy_model/[private].html)
  - Templeton, A. et al. (2024). "Scaling monosemanticity: Extracting interpretable features from Claude 3 Sonnet." Anthropic. [https://transformer-circuits.pub/2024/scaling-monosemanticity/[private].html](https://transformer-circuits.pub/2024/scaling-monosemanticity/[private].html)
