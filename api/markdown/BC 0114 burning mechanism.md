...
- **Burn Address Mechanism**
	- Special blockchain addresses designed to be *provably unspendable*, meaning no private key exists to access funds sent to them
...
- **Quantitative Impact (2024-2025)**
	...
	- **Annualized Burn Rate (2025):** **1.32%** of total ETH supply
	- **2025 Burns:** Approximately **870,000 ETH** burned in first three quarters of 2025
	- **Average Daily Burn Rate (2025):** ~**10,200 ETH** (highly variable based on network activity)
...
- **Use Cases in Blockchain Systems (2024-2025)**
	- **Token Creation:**
		...
		- Modern protocols (OLGA Stamps, SRC-20, SRC-721): Use burn addresses for Bitcoin-native token issuance
	- **Consensus Mechanisms:** Some blockchains use PoB as alternative to [[Proof of Work]] or [[Proof of Stake]]
...
- **MakerDAO Smart Burn Engine** [Updated 2025]
	...
	- **Burn Rate:** Initial 24 hours repurchased ~$230,000 MKR; scaled to ~$7 million monthly buyback capacity
	- **Supply Reduction:** Approximately 0.7% of MKR supply burned monthly (with MKR market cap ~$1 billion)
...
- **Uniswap Token Buyback Program** [Updated 2025]
	...
	- **Funding:** Activates dormant protocol fees, channeling them through on-chain treasury engine
...
- **Lido DAO Buyback Proposal** [Updated 2025]
	...
	- **Safety Caps:**
		...
		- No single transaction moves LDO price >2% (market impact minimization)
...
- **2024-2025 Industry Trends**
	...
	- **Maturation Signal:** Shift from pure reinvestment toward shareholder value return indicates DeFi ecosystem maturity
...
- **Security Best Practices (2024-2025)**
	...
	- **Proxy Patterns:** Consider upgradable contracts (UUPS proxy) for post-deployment burn mechanism modifications
...
- **Critical Security Risks:**
	...
	- **Integer Overflows/Underflows:** Can allow attackers to burn more than intended or bypass restrictions
