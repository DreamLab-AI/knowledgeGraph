...
- ### Content
  ...
  ## Key Terminology
    ...
    - **DDL (Data Definition Language)** — the subset of [[SQL]] used to create, modify, and drop schema objects: CREATE TABLE, ALTER TABLE, CREATE [private], DROP COLUMN, ADD CONSTRAINT, etc. DDL statements are the executable form of the database schema definition, and their history constitutes the schema's change log.
