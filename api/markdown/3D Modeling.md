schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#3dModeling
legacy_uri:: urn:visionclaw:concept:spatial-computing:3d-modeling
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-80ad8bdd3665"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#3dModeling"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:3d-modeling"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
