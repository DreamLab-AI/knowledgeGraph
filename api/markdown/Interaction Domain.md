schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#InteractionDomain
legacy_uri:: urn:visionclaw:concept:spatial-computing:interaction-domain
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-3351da1c271d"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#InteractionDomain"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:interaction-domain"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:0f52be949335c0f83487f01498449488bc634653cecc40ea9288ce27031d7238@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
