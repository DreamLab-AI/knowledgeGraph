...
```json-ld
{
  ...
  "relations": {
    ...
    "requires": [
      ...
      {
        "@id": "urn:ngm:class:causality-tracking",
    ...
    "uses": [
      ...
      {
        "@id": "urn:ngm:class:operation-log",
        "label": "Operation Log"
      },
      {
        "@id": "urn:ngm:class:transformation-function",
    ...
    "contrastsWith": [
      ...
      {
        "@id": "urn:ngm:class:pessimistic-locking",
        "label": "Pessimistic Locking"
      },
      {
        "@id": "urn:ngm:class:differential-synchronisation",
        "label": "Differential Synchronisation"
      }
    ],
    "relatedTo": [
      {
      ...
      {
        "@id": "urn:ngm:class:distributed-consistency",
      ...
      {
        "@id": "urn:ngm:class:merge-algorithm",
