schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#CarbonFootprintIndicator
legacy_uri:: urn:visionclaw:concept:spatial-computing:carbon-footprint-indicator
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-52e3a3f8509e"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#CarbonFootprintIndicator"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:carbon-footprint-indicator"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
