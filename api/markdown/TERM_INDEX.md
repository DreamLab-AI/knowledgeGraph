...
uri:: urn:visionclaw:concept:spatial-computing:termindex
rdf-type:: owl:Class
same-as:: urn:visionclaw:concept:spatial-computing:termindex
type:: owl:Class
context:: https://visionclaw.dreamlab-ai.systems/ns/v2
domain:: spatial-computing
preferred-term:: TERM_INDEX
content-hash:: sha256-12-27a8ec95f60d
legacy-term-id:: MV-3027
status:: draft
maturity:: draft
quality-score:: 0.50
...
- ### Definition
  - A comprehensive, semantically organised catalogue mapping domain-specific terminology, concepts, and their definitions across [[Metaverse]], [[Blockchain]], [[ArtificialIntelligence]], and [[Robotics]] domains. This index enables rapid concept discovery and cross-domain terminology alignment.
- ### Semantic Classification
  - owl-class:: spatial-computing:TERM_INDEX
  - owl-role:: Concept
  - belongs-to-domain:: [[MetaverseDomain]]
- ### Relationships
  - <!-- No relationships defined -->
- ### Content
  - Term indices map domain terminology and conceptual relationships systematically, enabling cross-domain terminology alignment and concept discovery.
  - ### Original Content
		- ```
