schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#ContentDeliveryNetworkCDN
legacy_uri:: urn:visionclaw:concept:infrastructure:content-delivery-network-cdn
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-510c6f3971df"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#ContentDeliveryNetworkCDN"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:content-delivery-network-cdn"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
