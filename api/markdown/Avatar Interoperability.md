schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#AvatarInteroperability
legacy_uri:: urn:visionclaw:concept:infrastructure:avatar-interoperability
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-3600963e6aac"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#AvatarInteroperability"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:avatar-interoperability"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
