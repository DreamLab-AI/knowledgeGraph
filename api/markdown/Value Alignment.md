...
(Declaration (Class :ValueAlignment))

;; Annotations
(AnnotationAssertion rdfs:label :ValueAlignment "Value Alignment"@en)
(AnnotationAssertion rdfs:comment :ValueAlignment "The challenge and process of ensuring AI systems pursue objectives that align with human values, even as those systems become more capable and autonomous. Value alignment addresses both technical and philosophical questions about encoding human preferences into AI behaviour."@en)

;; Data Properties
(AnnotationAssertion dcterms:identifier :ValueAlignment "AI-0269"^^xsd:string)
(DataPropertyAssertion :isAITechnology :ValueAlignment "true"^^xsd:boolean)
```
...
- Aligns system goals with human values
- Technical and philosophical challenge
- Critical for beneficial AI
- Addresses capability-safety gap
- Long-term AI safety concern

## Related Concepts

- **AI Alignment**: Technical implementation
- **RLHF**: Practical alignment method
