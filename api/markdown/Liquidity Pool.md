schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#LiquidityPool
legacy_uri:: urn:visionclaw:concept:spatial-computing:liquidity-pool
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-91601a80bd50"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#LiquidityPool"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:liquidity-pool"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
