schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/robotics#CommunicationProtocol
legacy_uri:: urn:visionclaw:concept:robotics:communication-protocol
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-e7e7ca306961"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/robotics#CommunicationProtocol"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:robotics:communication-protocol"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
