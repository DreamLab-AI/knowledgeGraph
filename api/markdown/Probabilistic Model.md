schema_version:: 1
legacy_iri:: https://visionclaw.dreamlab-ai.systems/ns/v2/artificial-intelligence#ProbabilisticModel
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:probabilistic-model
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-38aa254d6c33"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "https://visionclaw.dreamlab-ai.systems/ns/v2/artificial-intelligence#ProbabilisticModel"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:probabilistic-model"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:probabilistic-model:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[AISTATS]]",
      "resolved": "urn:visionflow:linked:aistats",
      "kind": "StubLink"
    },
    {
      "raw": "[[AlgorithmLayer]]",
    ...
    {
      "raw": "[[Bayes Theorem]]",
      "resolved": "urn:visionflow:linked:bayes-theorem",
      "kind": "StubLink"
    },
    {
      "raw": "[[Bayesian Analysis Journal]]",
      "resolved": "urn:visionflow:linked:bayesian-analysis-journal",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Belief Propagation]]",
      "resolved": "urn:visionflow:linked:belief-propagation",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Causal Model]]",
      "resolved": "urn:visionflow:linked:causal-model",
      "kind": "StubLink"
    },
    {
    ...
    },
    {
      ...
      "resolved": "urn:visionflow:linked:computational-graph",
      "kind": "StubLink"
    },
    {
      "raw": "[[Computational Statistics]]",
      "resolved": "urn:visionflow:linked:computational-statistics",
      "kind": "StubLink"
    },
    {
      "raw": "[[Conformal Prediction]]",
      "resolved": "urn:visionflow:linked:conformal-prediction",
      "kind": "StubLink"
    },
    {
      "raw": "[[Deterministic Model]]",
      "resolved": "urn:visionflow:linked:deterministic-model",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Financial Risk Modelling]]",
      "resolved": "urn:visionflow:linked:financial-risk-modelling",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Graphical Model]]",
      "resolved": "urn:visionflow:linked:graphical-model",
      "kind": "StubLink"
    },
    {
      "raw": "[[Graphical Model Theory]]",
      "resolved": "urn:visionflow:linked:graphical-model-theory",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Inference Algorithm]]",
      "resolved": "urn:visionflow:linked:inference-algorithm",
      "kind": "StubLink"
    },
    {
      "raw": "[[InferenceLayer]]",
    ...
    {
      "raw": "[[Journal of the American Statistical Association]]",
      "resolved": "urn:visionflow:linked:journal-of-the-american-statistical-association",
      "kind": "StubLink"
    },
    {
      "raw": "[[Latent Variable]]",
      "resolved": "urn:visionflow:linked:latent-variable",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[NeurIPS Probabilistic Track]]",
      "resolved": "urn:visionflow:linked:neur-ips-probabilistic-track",
      "kind": "StubLink"
    },
    {
      "raw": "[[Nonconformity Score]]",
      "resolved": "urn:visionflow:linked:nonconformity-score",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Point Estimate]]",
      "resolved": "urn:visionflow:linked:point-estimate",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Probabilistic Programming Language]]",
      "resolved": "urn:visionflow:linked:probabilistic-programming-language",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Score-Based Diffusion]]",
      "resolved": "urn:visionflow:linked:score-based-diffusion",
      "kind": "StubLink"
    },
    {
      "raw": "[[Score Matching]]",
    ...
    {
      "raw": "[[Statistical Learning]]",
      "resolved": "urn:visionflow:linked:statistical-learning",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[UAI Conference]]",
      "resolved": "urn:visionflow:linked:uai-conference",
      "kind": "StubLink"
    },
    {
