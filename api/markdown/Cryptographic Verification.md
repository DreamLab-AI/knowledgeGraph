schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#CryptographicVerification
legacy_uri:: urn:visionclaw:concept:infrastructure:cryptographic-verification
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-c9554550b1bb"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#CryptographicVerification"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:cryptographic-verification"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:c8789668e83d27d54856f6a8cc403c5713b88d360f59592a8738bf431c6f274b@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
