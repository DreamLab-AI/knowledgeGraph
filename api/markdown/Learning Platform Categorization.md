schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#LearningPlatformCategorization
legacy_uri:: urn:visionclaw:concept:spatial-computing:learning-platform-categorization
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-4421ba62e3cf"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#LearningPlatformCategorization"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:learning-platform-categorization"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:7aea0f03249714127ccbbe9fdf3c04891c5448d81d4648a6be803b084c39264f@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
```json-ld
{
  ...
  "definition": "A learning platform categorization component in the Metaverse domain that enables EtsiDomainApplicationEducation.",
...
- ### Content
  LearningPlatformCategorization — content pending enrichment.
