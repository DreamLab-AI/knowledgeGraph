schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#51Attack
legacy_uri:: urn:visionclaw:concept:blockchain:51-attack
public:: true
...
```json-ld
{
  ...
  "@id": "urn:visionflow:page:61986621941769792830c59c2be66e9fd4019ea25ed77ea19408e21d59fa621e",
  "@type": "Page",
  "vc:slug": "51-attack",
  "title": "51% Attack",
  "vc:public": true,
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:altcoins",
      "vc:label": "altcoins"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:bitcoin-gold",
      "vc:label": "Bitcoin Gold"
    },
    {
      "@id": "urn:visionflow:linked:blockchain-reorganization",
      "vc:label": "blockchain reorganization"
    },
    {
      "@id": "urn:visionflow:linked:blockchain-reorganization",
      "vc:label": "Blockchain Reorganization"
    ...
    {
      "@id": "urn:visionflow:linked:consensus-attack",
      "vc:label": "Consensus Attack"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:ddo-s-attack",
      "vc:label": "DDoS attack"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:majority-attack",
      "vc:label": "Majority attack"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:mining-pools",
      "vc:label": "mining pools"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:nice-hash",
      "vc:label": "NiceHash"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:nist-nistir-8202",
      "vc:label": "NIST NISTIR 8202"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:quantum-resistant",
      "vc:label": "quantum-resistant"
    },
    {
      "@id": "urn:visionflow:linked:qubic",
      "vc:label": "Qubic"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-cd7bcc466ab0"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#51Attack"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:51-attack"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:61986621941769792830c59c2be66e9fd4019ea25ed77ea19408e21d59fa621e@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
```json-ld
{
  ...
  "@type": "Class",
  "label": "51% Attack",
  "definition": "Attack is a blockchain and distributed systems concept and a type of blockchain.",
  "domain": "blockchain",
  "maturity": "draft",
  "subClassOf": [
    {
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:51-attack:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[altcoins]]",
      "resolved": "urn:visionflow:linked:altcoins",
      "kind": "StubLink"
    },
    {
      "raw": "[[ASIC]]",
    ...
    {
      "raw": "[[Bitcoin Gold]]",
      "resolved": "urn:visionflow:linked:bitcoin-gold",
      "kind": "StubLink"
    },
    {
      "raw": "[[Blockchain Reorganization]]",
      "resolved": "urn:visionflow:linked:blockchain-reorganization",
      "kind": "StubLink"
    },
    {
      "raw": "[[blockchain reorganization]]",
    ...
    {
      "raw": "[[Consensus Attack]]",
      "resolved": "urn:visionflow:linked:consensus-attack",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[DDoS attack]]",
      "resolved": "urn:visionflow:linked:ddo-s-attack",
      "kind": "StubLink"
    },
    {
      "raw": "[[Decred]]",
    ...
    {
      "raw": "[[Majority attack]]",
      "resolved": "urn:visionflow:linked:majority-attack",
      "kind": "StubLink"
    },
    {
      "raw": "[[mining hardware]]",
    ...
    {
      "raw": "[[mining pools]]",
      "resolved": "urn:visionflow:linked:mining-pools",
      "kind": "StubLink"
    },
    {
      "raw": "[[Monero]]",
    ...
    {
      "raw": "[[NiceHash]]",
      "resolved": "urn:visionflow:linked:nice-hash",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[NIST NISTIR 8202]]",
      "resolved": "urn:visionflow:linked:nist-nistir-8202",
      "kind": "StubLink"
    },
    {
      "raw": "[[Polkadot]]",
    ...
    {
      "raw": "[[quantum-resistant]]",
      "resolved": "urn:visionflow:linked:quantum-resistant",
      "kind": "StubLink"
    },
    {
      "raw": "[[Qubic]]",
      "resolved": "urn:visionflow:linked:qubic",
      "kind": "StubLink"
    },
    {
...
- ### Provenance
  - sources:: [[ISO/IEC 23257:2021]], [[IEEE 2418.1]], [[NIST NISTIR 8202]], [[NIST Cybersecurity Framework]]
