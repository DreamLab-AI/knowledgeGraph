...
- ### Content
  ...
  - **Waseda WABOT-1 (1973)**: First full-scale anthropomorphic robot, assembled by Ichiro Kato's group. [private] walk (quasi-statically, 45 seconds per step), grip objects, and converse in Japanese via voice synthesis—an astonishing achievement for 1973 hardware. WABOT-2 (1984) [private] play an electric organ.
  ...
  - **Labour displacement and societal impact**: McKinsey Global Institute (2023) estimates humanoid robots [private] automate 30-40% of physical work tasks by 2030 in logistics and light manufacturing. Projected displacement of 2-5M warehouse and manufacturing jobs in OECD countries over 2026-2035 raises urgent questions of worker transition support, wage effects, and distributional policy—intersecting with [[AI Risks]], [[AI Adoption]], and [[AI Liability]] policy domains.
