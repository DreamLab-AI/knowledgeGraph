```json-ld
{
  ...
  "@id": "urn:visionflow:page:logging",
  "@type": "Page",
  "title": "Logging",
  "vc:slug": "logging",
  "vc:public": true,
...
```json-ld
{
  ...
  "vc:plainGloss": "A running diary the software keeps of what happened and when, with each notable event stamped with a time and a severity. When something goes wrong, these records are the first place you look to retrace the steps and work out why.",
