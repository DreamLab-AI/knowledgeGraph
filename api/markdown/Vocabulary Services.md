schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#VocabularyServices
legacy_uri:: urn:visionclaw:concept:spatial-computing:vocabulary-services
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-8993f31819db"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#VocabularyServices"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:vocabulary-services"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
