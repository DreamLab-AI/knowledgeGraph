schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#SpatialComputingSystem
legacy_uri:: urn:visionclaw:concept:spatial-computing:spatial-computing-system
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-774e39d6612e"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#SpatialComputingSystem"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:spatial-computing-system"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
