schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#DataAnonymizationPipeline
legacy_uri:: urn:visionclaw:concept:spatial-computing:data-anonymization-pipeline
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-a18368f2eeab"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#DataAnonymizationPipeline"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:data-anonymization-pipeline"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
