```json-ld
{
  ...
  "@id": "urn:visionflow:page:interpolation",
  "@type": "Page",
  "title": "Interpolation",
  "vc:slug": "interpolation",
  "vc:public": true,
  "vc:schemaVersion": 2,
...
```json-ld
{
  ...
  "relations": {
    ...
    "hasPart": [
      {
        "@id": "urn:ngm:class:linear-interpolation",
        "label": "Linear Interpolation"
      },
      {
        "@id": "urn:ngm:class:spline",
        "label": "Spline"
      }
    ],
    "uses": [
      ...
      {
        "@id": "urn:ngm:class:approximation",
        "label": "Approximation"
      }
    ],
    "requires": [
    ...
    "implements": [
      {
        "@id": "urn:ngm:class:curve-fitting",
        "label": "Curve Fitting"
      }
    ],
    "relatedTo": [
