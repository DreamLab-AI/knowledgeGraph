...
- ### Content
  ...
  - The neural hybrid dimension emerged from two research breakthroughs: Neural Radiance Fields (NeRF, Mildenhall et al. 2020) demonstrated that implicit neural representations [private] reconstruct photorealistic scenes from sparse posed images, and 3D Gaussian Splatting (3DGS, Kerbl et al. SIGGRAPH 2023) demonstrated that explicit point-cloud representations with anisotropic Gaussians [private] achieve real-time rendering at equivalent or superior quality. Extending these to 4D — incorporating deformation fields, temporal encodings, and dynamic appearance — defines the frontier of the field as of 2026.
  ...
  - **Instancing Nodes** — place instances efficiently:
    - `Instance on Points`: places geometry/collection instances at each point, using point attributes for rotation, scale, and instance [private] selection. The core tool for procedural environment population.
  ...
  - 18. **OpenAI** (2024). Video Generation Models as World Simulators. Technical Report (Sora). openai.com/[private]/video-generation-models-as-world-simulators/
