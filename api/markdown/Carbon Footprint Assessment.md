schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#CarbonFootprintAssessment
legacy_uri:: urn:visionclaw:concept:spatial-computing:carbon-footprint-assessment
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-0964ef0800af"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#CarbonFootprintAssessment"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:carbon-footprint-assessment"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
