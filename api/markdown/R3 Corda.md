schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#R3Corda
legacy_uri:: urn:visionclaw:concept:blockchain:r3-corda
public:: true
...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:enterprise-distributed-systems-domain",
      "vc:label": "EnterpriseDistributedSystemsDomain"
    },
    {
  ...
  "vc:legacyProperties": [
    {
      ...
      "vc:value": "Corda, Corda DLT, Corda 5, CorDapp Platform, R3 Corda Enterprise, Corda Community Edition"
    },
    {
    ...
    {
      "vc:key": "bridges-to",
      "vc:value": "[[Distributed Ledger]], [[Central Bank Digital Currency]], [[Enterprise Smart Contracts]]"
    },
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-939fa04ea1be"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#R3Corda"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:r3-corda"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:r3-corda:776c802a9fc9",
  ...
  "vc:resolutions": [
    {
      "raw": "[[AMQP]]",
      "resolved": "urn:visionflow:linked:amqp",
      "kind": "StubLink"
    },
    {
      "raw": "[[Apache Kafka]]",
    ...
    {
      "raw": "[[BIS CPMI]]",
      "resolved": "urn:visionflow:linked:bis-cpmi",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Corda Node]]",
      "resolved": "urn:visionflow:linked:corda-node",
      "kind": "StubLink"
    },
    {
      "raw": "[[Corda Vault]]",
      "resolved": "urn:visionflow:linked:corda-vault",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Database Technology]]",
      "resolved": "urn:visionflow:linked:database-technology",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Deterministic JVM]]",
      "resolved": "urn:visionflow:linked:deterministic-jvm",
      "kind": "StubLink"
    },
    {
      "raw": "[[Digital Securities]]",
      "resolved": "urn:visionflow:linked:digital-securities",
      "kind": "StubLink"
    },
    {
      "raw": "[[Doorman]]",
      "resolved": "urn:visionflow:linked:doorman",
      "kind": "StubLink"
    },
    {
      "raw": "[[DTCC]]",
    ...
    {
      "raw": "[[EnterpriseDistributedSystemsDomain]]",
      "resolved": "urn:visionflow:linked:enterprise-distributed-systems-domain",
      "kind": "StubLink"
    },
    {
      "raw": "[[FCA]]",
    ...
    {
      "raw": "[[Financial Services Technology]]",
      "resolved": "urn:visionflow:linked:financial-services-technology",
      "kind": "StubLink"
    },
    {
      "raw": "[[Flow Coroutine]]",
      "resolved": "urn:visionflow:linked:flow-coroutine",
      "kind": "StubLink"
    },
    {
      "raw": "[[Flow Framework]]",
      "resolved": "urn:visionflow:linked:flow-framework",
      "kind": "StubLink"
    },
    {
      "raw": "[[Fnality]]",
    ...
    {
      "raw": "[[Gradle]]",
      "resolved": "urn:visionflow:linked:gradle",
      "kind": "StubLink"
    },
    {
      "raw": "[[HTTP REST API]]",
      "resolved": "urn:visionflow:linked:http-rest-api",
      "kind": "StubLink"
    },
    {
      "raw": "[[Insurance Processing]]",
      "resolved": "urn:visionflow:linked:insurance-processing",
      "kind": "StubLink"
    },
    {
      "raw": "[[Interbank Reconciliation]]",
      "resolved": "urn:visionflow:linked:interbank-reconciliation",
      "kind": "StubLink"
    },
    {
      "raw": "[[ISDA]]",
    ...
    {
      "raw": "[[ISO TC307]]",
      "resolved": "urn:visionflow:linked:iso-tc307",
      "kind": "StubLink"
    },
    {
      "raw": "[[JVM Runtime]]",
      "resolved": "urn:visionflow:linked:jvm-runtime",
      "kind": "StubLink"
    },
    {
      "raw": "[[Kotlin]]",
    ...
    {
      "raw": "[[Legal Agreement Automation]]",
      "resolved": "urn:visionflow:linked:legal-agreement-automation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Network Map Service]]",
      "resolved": "urn:visionflow:linked:network-map-service",
      "kind": "StubLink"
    },
    {
      "raw": "[[Notary]]",
      "resolved": "urn:visionflow:linked:notary",
      "kind": "StubLink"
    },
    {
      "raw": "[[Notary Consensus]]",
      "resolved": "urn:visionflow:linked:notary-consensus",
      "kind": "StubLink"
    },
    {
      "raw": "[[Oracle DB]]",
      "resolved": "urn:visionflow:linked:oracle-db",
      "kind": "StubLink"
    },
    {
      "raw": "[[Point-to-Point Messaging]]",
      "resolved": "urn:visionflow:linked:point-to-point-messaging",
      "kind": "StubLink"
    },
    {
      "raw": "[[PostgreSQL]]",
    ...
    {
      "raw": "[[Privacy-Preserving Ledger]]",
      "resolved": "urn:visionflow:linked:privacy-preserving-ledger",
      "kind": "StubLink"
    },
    {
      "raw": "[[Raft Consensus]]",
    ...
    {
      "raw": "[[SQL Server]]",
      "resolved": "urn:visionflow:linked:sql-server",
      "kind": "StubLink"
    },
    {
      "raw": "[[State Object]]",
      "resolved": "urn:visionflow:linked:state-object",
      "kind": "StubLink"
    },
    {
      "raw": "[[Syndicated Lending]]",
      "resolved": "urn:visionflow:linked:syndicated-lending",
      "kind": "StubLink"
    },
    {
      "raw": "[[TLS Encryption]]",
    ...
    {
      "raw": "[[Tokenised Asset Issuance]]",
      "resolved": "urn:visionflow:linked:tokenised-asset-issuance",
      "kind": "StubLink"
    },
    {
      "raw": "[[Trade Finance]]",
    ...
    {
      "raw": "[[X.509 Identity]]",
      "resolved": "urn:visionflow:linked:x-509-identity",
      "kind": "StubLink"
    },
    {
...
- ### Definition
  - R3 Corda is a purpose-built permissioned distributed ledger platform designed exclusively for regulated financial services, implementing a "need-to-know" peer-to-peer architecture in which transaction data is shared solely amongst parties with legitimate business interest, eliminating global state replication in favour of individual cryptographically-assured facts (state objects) whose uniqueness is assured by dedicated [[Notary]] services without exposing transaction contents to the wider network. Corda models [[Smart Contracts]] as legally enforceable agreements between identified parties, expressed in Kotlin or Java running on the JVM, pairing executable contract code with optional Ricardian legal prose to produce agreements that are simultaneously machine-verifiable and court-admissible. The platform implements a UTXO-like state model akin to [[Bitcoin]] but with rich typed states—states carry arbitrary Kotlin/Java objects, carry reference to their governing contract, are consumed atomically in transactions, and are replaced by successor states—providing clear provenance chains for regulatory audit without global ledger visibility. Transaction flows, expressed as coroutines via the Corda Flow framework, orchestrate multi-party signature collection, notarisation, and ledger finalisation, abstracting the distributed-systems complexity of two-phase commit across institutional counterparties. Validity consensus is achieved by parties to a transaction running the same deterministic contract code (via the Deterministic JVM, DJVM), verifying that proposed state transitions satisfy all business rules; uniqueness consensus—preventing double-spending—is delegated to the Notary, which sees only cryptographic state references, not transaction contents. This separation of validity from uniqueness is the architectural innovation that enables Corda's privacy guarantees.
  - Corda was conceived in 2015 by R3, a consortium founded by nine banks (Barclays, BBVA, Credit Suisse, Goldman Sachs, JPMorgan, Royal Bank of Scotland, State Street, UBS, UniCredit) that grew to over 200 institutional members, and has been open-sourced under Apache 2.0 (Corda Community Edition) alongside a commercially supported Corda Enterprise distribution. The platform's design emerged from the recognition—documented in Mike Hearn's foundational 2016 white paper—that global consensus is the wrong primitive for financial markets: a bilateral trade between two banks does not require the network's other participants to validate, store, or observe it, and exposing transaction details to competitors on the same network is commercially and legally unacceptable. Corda therefore eliminates the global ordered ledger entirely, replacing it with a directed acyclic graph of per-state lineage chains, each cryptographically attested, collectively forming the distributed ledger through the union of participants' individually held state records rather than through a replicated global append-only log.
  - Corda 5, the major re-architecture released in stages from late 2023 through September 2024, introduced a fundamentally different operational model: a modular stateless worker-pool architecture deployable in Kubernetes, replacing the earlier monolithic node. Corda 5 disaggregates node functions into independently scalable worker types—flow workers executing business logic, crypto workers handling key management and signing operations, persistence workers managing vault database I/O, and P2P link manager workers handling inter-node communication. A Kafka-backed flow event bus decouples these workers, enabling horizontal scaling. Multi-tenant virtual nodes (vNodes) allow a single Corda 5 deployment to host hundreds of independent network participants, each with their own vault, identity, and CorDapp instances, dramatically reducing infrastructure overhead for financial institutions participating in many networks simultaneously. The AMQP-over-TLS RPC interface of Corda 4 is replaced by an HTTP/REST API, enabling CorDapp invocation from any language and integrating naturally with cloud-native microservice architectures.
  - As of 2025–2026, Corda networks host over £10 billion in live tokenised real-world assets and process over one million transactions daily across production deployments spanning payments (Fnality's Sterling Fnality Payment System, live Q1 2024, regulated by the Bank of England), securities settlement (DTCC Project Ion, SIX Digital Exchange), trade finance (Contour, formerly Voltron), insurance (Insurwave marine platform), banking reconciliation (ABI Spunta, connecting over 100 Italian banks), and central bank digital currency research infrastructure (BIS Project Helvetia Phases I–III, BIS Project Mariana). The UK Regulated Liability Network (RLN) pilot involving twelve major financial institutions and the Bank of England used R3 technology to explore programmable sterling on shared ledger infrastructure. R3's London office and the concentration of Corda deployments in UK-regulated institutions make the platform deeply embedded in British financial market infrastructure development.

- ### Semantic Classification
  - owl-class:: blockchain:R3Corda
  - owl-role:: PermissionedDLTPlatform
  - owl-inferred:: blockchain:EnterpriseBlockchain, blockchain:UTXOLedger, blockchain:JVMSmartContractPlatform, blockchain:FinancialServicesBlockchain, blockchain:RegulatedLedger
  - belongs-to-domain:: [[BlockchainDomain]], [[FinancialInfrastructureDomain]], [[EnterpriseDistributedSystemsDomain]]
  - implemented-in-layer:: [[InfrastructureLayer]], [[ApplicationLayer]], [[ConsensusLayer]]

- ### Relationships
  - is-subclass-of:: [[Distributed Ledger]], [[Permissioned Blockchain]], [[Enterprise Blockchain]], [[Financial Services Technology]], [[Smart Contract Platform]]
  - has-part:: [[Notary]], [[Flow Framework]], [[CorDapp]], [[Corda Vault]], [[Network Map Service]], [[Doorman]], [[State Object]], [[Contract Code]], [[Corda Node]], [[Deterministic JVM]]
  - requires:: [[JVM Runtime]], [[X.509 Identity]], [[Relational Database]], [[TLS Encryption]], [[Kotlin]], [[Public Key Infrastructure]], [[Certificate Authority]]
  - enables:: [[Atomic Settlement]], [[Privacy-Preserving Ledger]], [[Legal Agreement Automation]], [[Tokenised Asset Issuance]], [[Cross-Border Payment]], [[Regulatory Reporting]], [[Delivery Versus Payment]]
  - implements:: [[UTXO Model]], [[Point-to-Point Messaging]], [[Ricardian Contract]], [[Two-Phase Commit]], [[Notary Consensus]], [[Flow Coroutine]], [[Raft Consensus]], [[Byzantine Fault Tolerance]]
  - depends-on:: [[Cryptographic Hash Function]], [[Digital Signature]], [[Merkle Tree]], [[Identity Management]], [[Database Technology]], [[Apache Kafka]], [[Kubernetes]]
  - supports:: [[Securities Settlement]], [[Trade Finance]], [[Syndicated Lending]], [[Insurance Processing]], [[Central Bank Digital Currency]], [[Asset Tokenisation]], [[Interbank Reconciliation]], [[Carbon Credit Tracking]]
  - uses:: [[Apache Kafka]], [[PostgreSQL]], [[SQL Server]], [[Oracle DB]], [[AMQP]], [[HTTP REST API]], [[Gradle]], [[Docker]], [[Kotlin]]
  - contrasts-with:: [[Hyperledger Fabric]], [[Ethereum]], [[Quorum Blockchain]], [[Hyperledger Besu]], [[DAML Ledger]], [[Hyperledger Iroha]]
  - related-to:: [[Blockchain Network]], [[Fnality]], [[Digital Securities]], [[CBDCs]], [[Regulated Liability Network]], [[BIS Innovation Hub]], [[Tokenisation]]
  - standardized-by:: [[ISDA]], [[ISO TC307]], [[BIS Innovation Hub]], [[FCA]], [[Bank of England]], [[DTCC]], [[BIS CPMI]]
