schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#PhysicsEngine
legacy_uri:: urn:visionclaw:concept:spatial-computing:physics-engine
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-02ca02293a27"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#PhysicsEngine"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:physics-engine"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
