schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#NFTRenting
legacy_uri:: urn:visionclaw:concept:spatial-computing:nft-renting
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-a3a44d6f7aba"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#NFTRenting"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:nft-renting"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
