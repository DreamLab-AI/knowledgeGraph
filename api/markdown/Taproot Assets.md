...
- ### Content
  ...
  - **Colored Coins (2012-2015)**: Open Assets protocol (Flavien Charlon) and Coinprism assigned meaning to specific satoshis through OP_RETURN metadata. Limitations: no enforcement of asset rules at the Bitcoin consensus layer (a Bitcoin miner [private] ignore coloring), no Lightning integration, complex proof structures.
