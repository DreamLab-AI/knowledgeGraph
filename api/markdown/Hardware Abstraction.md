schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#HardwareAbstraction
legacy_uri:: urn:visionclaw:concept:spatial-computing:hardware-abstraction
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-749ad57ce6da"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#HardwareAbstraction"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:hardware-abstraction"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:28a793ea64a5ec0d9f1c34058d7fbd57547ab769f839e4fb8c63594a4901a9f6@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
