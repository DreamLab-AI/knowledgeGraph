schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#Valsoft
legacy_uri:: urn:visionclaw:concept:infrastructure:valsoft
public:: true
...
```json-ld
{
  ...
  "@id": "urn:visionflow:page:1db32b56a557d5e9d00a21dd7d04ad7f1355edbae10963bc23ce2b7e9b72dae7",
  "@type": "Page",
  "vc:slug": "valsoft",
  "title": "Valsoft",
  "vc:public": true,
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-0efa3392fe05"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#Valsoft"
    },
    {
      "vc:key": "maturity",
      "vc:value": "draft"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:valsoft"
    },
    {
      "vc:key": "status",
      "vc:value": "stub"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:1db32b56a557d5e9d00a21dd7d04ad7f1355edbae10963bc23ce2b7e9b72dae7@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:valsoft",
  "@type": "OntologyClass",
  "label": "Valsoft",
  "subClassOf": [
    {
  ...
  "definition": "Valsoft is a concept within the ngm domain.",
  "vc:qualityScore": {
    "@value": "0.50",
    "@type": "xsd:float"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:valsoft:776c802a9fc9",
...
- ### Content
  ...
  - Thank you for your application for the AI Solutions Architect position with Aspire Software/ ==Valsoft==.
  - We have reviewed your CV, and would like to invite you to a 30-45 min Teams interview (with me) as the first step in our process.
  - This is an informal call to make sure the role is a good fit for the both of us. We’ll discuss your relevant experience, your motivations, and I will tell you more about the role and ==Valsoft== / Aspire Software.
  - [ChatGPT
	 - The Negotiator (openai.com)](https://chat.openai.com/g/g-TTTAK9GuS-the-negotiator/c/1a310c9d-8b41-46f5-8d64-6790f2854b48)
  - The role
  - **AI Solutions Architect – Remote (United Kingdom)**
	  **We are hiring at Aspire Software for an AI Solutions Architect to join our growing team!**
	  ...
	  **The successful candidate will be based in the United Kingdom, working remotely.**
  ...
  - Interview notes from the AI
  - ![Candidate with Matthieu Cornelis and John O'Hare, Ph.D..pdf](../assets/Candidate_with_Matthieu_Cornelis_and_John_O'Hare,_Ph.D._1704315013185_0.pdf)
