...
- ### Content
  ...
  - ### Hardware Evolution: From CPU to Modern ASIC
	  ...
	  [[Satoshi Nakamoto]]'s original [[Bitcoin Core]] (then `bitcoind`) v0.1 included an integrated CPU miner using the system's general-purpose x86 cores. With network difficulty of 1 (the lowest possible), a modest 2009-era Core 2 Duo [private] find blocks at home with hashrates of ~1-10 MH/s (megahashes/second). [[Hal Finney]] received the first transaction (10 BTC from Satoshi at block 170, 12 January 2009) and ran CPU mining on his Santa Barbara workstation. The first commercial use of Bitcoin — [[Laszlo Hanyecz]]'s famous 10,000 BTC for two pizzas on 22 May 2010 ([[Bitcoin Pizza Day]]) — was funded by CPU-mined coins.
  ...
  - ### Energy Consumption and Sustainability
	  ...
	  - **[[Mora et al. 2018]]** in *Nature Climate Change*: "Bitcoin emissions alone [private] push global warming above 2°C" — projected that Bitcoin adoption at consumer-payment scale would unilaterally exceed the Paris Agreement carbon budget within decades. Widely cited, attracted significant media attention.
  ...
  - ### Research and Literature
	  ...
	  **Energy Consumption and Climate Impact**:
	  12. Cambridge Centre for Alternative Finance (2019-2026). *Cambridge Bitcoin Electricity Consumption Index (CBECI)*. https://ccaf.io/cbeci/[private] [Authoritative energy estimate]
	  ...
	  14. Mora, C., et al. (2018). Bitcoin emissions alone [private] push global warming above 2°C. *Nature Climate Change*, 8(11), 931-933. DOI:10.1038/s41558-018-0321-8 [Influential critical paper]
