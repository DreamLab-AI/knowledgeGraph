schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#DiffusionModels
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:diffusion-models
public:: true
...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:abramson-et-al-2024-alpha-fold-3",
      "vc:label": "Abramson et al. 2024 AlphaFold 3"
    },
    {
      "@id": "urn:visionflow:linked:albergo-and-vanden-eijnden-2023-stochastic-interpolants",
      "vc:label": "Albergo & Vanden-Eijnden 2023 Stochastic Interpolants"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:croitoru-et-al-2023-diffusion-models-vision-survey",
      "vc:label": "Croitoru et al. 2023 Diffusion Models Vision Survey"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:dhariwal-and-nichol-2021-diffusion-beats-gans",
      "vc:label": "Dhariwal & Nichol 2021 Diffusion Beats GANs"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:esser-et-al-2024-sd3-mmdi-t-rectified-flow",
      "vc:label": "Esser et al. 2024 SD3 MMDiT Rectified Flow"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:liu-et-al-2022-rectified-flow",
      "vc:label": "Liu et al. 2022 Rectified Flow"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:luo-et-al-2023-lcm",
      "vc:label": "Luo et al. 2023 LCM"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:nichol-and-dhariwal-2021-improved-ddpm",
      "vc:label": "Nichol & Dhariwal 2021 Improved DDPM"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:poole-et-al-2022-dream-fusion",
      "vc:label": "Poole et al. 2022 DreamFusion"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:ramesh-et-al-2022-dall-e-2-un-clip",
      "vc:label": "Ramesh et al. 2022 DALL-E 2 unCLIP"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:saharia-et-al-2022-imagen",
      "vc:label": "Saharia et al. 2022 Imagen"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:sohl-dickstein-et-al-2015-deep-unsupervised-learning-nonequilibrium-thermodynamics",
      "vc:label": "Sohl-Dickstein et al. 2015 Deep Unsupervised Learning Nonequilibrium Thermodynamics"
    },
    {
      "@id": "urn:visionflow:linked:song-and-ermon-2019-ncsn",
      "vc:label": "Song & Ermon 2019 NCSN"
    },
    {
      "@id": "urn:visionflow:linked:song-et-al-2021-score-based-sde",
      "vc:label": "Song et al. 2021 Score-Based SDE"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:yang-et-al-2023-diffusion-models-survey",
      "vc:label": "Yang et al. 2023 Diffusion Models Survey"
    },
    {
  ...
  "vc:legacyProperties": [
    {
      ...
      "vc:value": "Denoising Diffusion Models, Score-Based Generative Models, Diffusion Probabilistic Models, DDPM, Score-Based SDE, Flow Matching Models"
    },
    {
    ...
    {
      "vc:key": "bridges-to",
      "vc:value": "[[Digital Asset]], [[Synthetic Media]]"
    },
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-ef22a61db422"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#DiffusionModels"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:diffusion-models"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:diffusion-models:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[Abramson et al. 2024 AlphaFold 3]]",
      "resolved": "urn:visionflow:linked:abramson-et-al-2024-alpha-fold-3",
      "kind": "StubLink"
    },
    {
      "raw": "[[Albergo & Vanden-Eijnden 2023 Stochastic Interpolants]]",
      "resolved": "urn:visionflow:linked:albergo-and-vanden-eijnden-2023-stochastic-interpolants",
      "kind": "StubLink"
    },
    {
      "raw": "[[AlgorithmLayer]]",
    ...
    {
      "raw": "[[Croitoru et al. 2023 Diffusion Models Vision Survey]]",
      "resolved": "urn:visionflow:linked:croitoru-et-al-2023-diffusion-models-vision-survey",
      "kind": "StubLink"
    },
    {
      "raw": "[[CVPR]]",
    ...
    {
      "raw": "[[Denoising Score Matching]]",
      "resolved": "urn:visionflow:linked:denoising-score-matching",
      "kind": "StubLink"
    },
    {
      "raw": "[[Dhariwal & Nichol 2021 Diffusion Beats GANs]]",
      "resolved": "urn:visionflow:linked:dhariwal-and-nichol-2021-diffusion-beats-gans",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Energy-Based Model]]",
      "resolved": "urn:visionflow:linked:energy-based-model",
      "kind": "StubLink"
    },
    {
      "raw": "[[Esser et al. 2024 SD3 MMDiT Rectified Flow]]",
      "resolved": "urn:visionflow:linked:esser-et-al-2024-sd3-mmdi-t-rectified-flow",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Forward Noising Process]]",
      "resolved": "urn:visionflow:linked:forward-noising-process",
      "kind": "StubLink"
    },
    {
      "raw": "[[Game Asset Generation]]",
      "resolved": "urn:visionflow:linked:game-asset-generation",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Latent Variable Model]]",
      "resolved": "urn:visionflow:linked:latent-variable-model",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Liu et al. 2022 Rectified Flow]]",
      "resolved": "urn:visionflow:linked:liu-et-al-2022-rectified-flow",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Luo et al. 2023 LCM]]",
      "resolved": "urn:visionflow:linked:luo-et-al-2023-lcm",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Markov Chain Model]]",
      "resolved": "urn:visionflow:linked:markov-chain-model",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Nichol & Dhariwal 2021 Improved DDPM]]",
      "resolved": "urn:visionflow:linked:nichol-and-dhariwal-2021-improved-ddpm",
      "kind": "StubLink"
    },
    {
      "raw": "[[Noise Schedule]]",
      "resolved": "urn:visionflow:linked:noise-schedule",
      "kind": "StubLink"
    },
    {
      "raw": "[[Nonequilibrium Thermodynamics]]",
      "resolved": "urn:visionflow:linked:nonequilibrium-thermodynamics",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Poole et al. 2022 DreamFusion]]",
      "resolved": "urn:visionflow:linked:poole-et-al-2022-dream-fusion",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Ramesh et al. 2022 DALL-E 2 unCLIP]]",
      "resolved": "urn:visionflow:linked:ramesh-et-al-2022-dall-e-2-un-clip",
      "kind": "StubLink"
    },
    {
      "raw": "[[Rectified Flow]]",
    ...
    {
      "raw": "[[Reverse Denoising Process]]",
      "resolved": "urn:visionflow:linked:reverse-denoising-process",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Saharia et al. 2022 Imagen]]",
      "resolved": "urn:visionflow:linked:saharia-et-al-2022-imagen",
      "kind": "StubLink"
    },
    {
      "raw": "[[Sampler]]",
    ...
    {
      "raw": "[[Score-Based Model]]",
      "resolved": "urn:visionflow:linked:score-based-model",
      "kind": "StubLink"
    },
    {
      "raw": "[[Score Network]]",
      "resolved": "urn:visionflow:linked:score-network",
      "kind": "StubLink"
    },
    {
      "raw": "[[Sohl-Dickstein et al. 2015 Deep Unsupervised Learning Nonequilibrium Thermodynamics]]",
      "resolved": "urn:visionflow:linked:sohl-dickstein-et-al-2015-deep-unsupervised-learning-nonequilibrium-thermodynamics",
      "kind": "StubLink"
    },
    {
      "raw": "[[Song & Ermon 2019 NCSN]]",
      "resolved": "urn:visionflow:linked:song-and-ermon-2019-ncsn",
      "kind": "StubLink"
    },
    {
      "raw": "[[Song et al. 2021 Score-Based SDE]]",
      "resolved": "urn:visionflow:linked:song-et-al-2021-score-based-sde",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[T5 Encoder]]",
      "resolved": "urn:visionflow:linked:t5-encoder",
      "kind": "StubLink"
    },
    {
      "raw": "[[Text Encoder]]",
    ...
    {
      "raw": "[[Variational Lower Bound]]",
      "resolved": "urn:visionflow:linked:variational-lower-bound",
      "kind": "StubLink"
    },
    {
      "raw": "[[Variational Lower Bound Maximisation]]",
      "resolved": "urn:visionflow:linked:variational-lower-bound-maximisation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Video Synthesis]]",
      "resolved": "urn:visionflow:linked:video-synthesis",
      "kind": "StubLink"
    },
    {
      "raw": "[[World Models]]",
    ...
    {
      "raw": "[[Yang et al. 2023 Diffusion Models Survey]]",
      "resolved": "urn:visionflow:linked:yang-et-al-2023-diffusion-models-survey",
      "kind": "StubLink"
    },
    {
...
- ### Definition
  - Diffusion Models are a class of deep generative models that learn the data distribution p_data(x) by reversing a fixed forward Markov noising process q(x_t | x_{t-1}) that progressively corrupts data x_0 with Gaussian noise across T timesteps until x_T ≈ N(0,I), then training a neural denoiser ε_θ(x_t, t) (or equivalently a score network s_θ(x_t, t) ≈ ∇_{x_t} log p_t(x_t)) to predict the noise (or score) at each level so that ancestral sampling from x_T back to x_0 produces samples from p_data — introduced in nascent form by Sohl-Dickstein, Weiss, Maheswaranathan and Ganguli at Stanford and Janelia in their 2015 ICML paper "Deep Unsupervised Learning using Nonequilibrium Thermodynamics" connecting variational inference with non-equilibrium statistical physics, made practically viable for high-fidelity image synthesis by Ho, Jain and Abbeel (UC Berkeley) in their 2020 NeurIPS paper "Denoising Diffusion Probabilistic Models" (DDPM) which simplified the variational training objective to a weighted noise-prediction MSE L_simple = E_{t,x_0,ε}[‖ε − ε_θ(√(ᾱ_t)x_0 + √(1−ᾱ_t)ε, t)‖²] under a cosine or linear β-schedule with T=1000 steps, paralleled by Song and Ermon (Stanford) whose 2019 NeurIPS paper "Generative Modeling by Estimating Gradients of the Data Distribution" introduced Noise-Conditional Score Networks (NCSN) trained via denoising score matching and sampled via annealed Langevin dynamics, unified by Song, Sohl-Dickstein, Kingma, Kumar, Ermon and Poole (Stanford / Google Brain) in their 2021 ICLR paper "Score-Based Generative Modeling through Stochastic Differential Equations" recasting both DDPM and NCSN as discretisations of a single continuous-time SDE dx = f(x,t)dt + g(t)dw whose reverse-time equation dx = [f(x,t) − g(t)² ∇_x log p_t(x)]dt + g(t)dw̄ admits both stochastic (Euler-Maruyama, predictor-corrector) and deterministic (probability-flow ODE) integrators — accelerated through advanced numerical samplers (DDIM Song-Meng-Ermon 2021 ICLR providing deterministic non-Markovian sampling at 20-50 steps versus 1000; DPM-Solver and DPM-Solver++ Lu et al. 2022 NeurIPS achieving 10-20 step sampling via semi-linear ODE structure; UniPC; Restart Sampling; Heun's 2nd-order method) and distillation techniques (Consistency Models Song et al. 2023 ICML enabling 1-4 step sampling; Latent Consistency Models LCM Luo et al. 2023; TCD Trajectory Consistency Distillation; SDXL Turbo and SDXL Lightning via Adversarial Diffusion Distillation Sauer et al. 2024 ECCV; Hyper-SD ByteDance 2024), made commercially tractable by Latent Diffusion Models (Rombach, Blattmann, Lorenz, Esser and Ommer 2022 CVPR "High-Resolution Image Synthesis with Latent Diffusion Models") which operate in the compressed latent space of a pretrained VAE (typical 8× spatial downsampling, 4-channel latents) reducing training/inference cost by 60-80× and forming the basis of Stable Diffusion 1.x/2.x/XL/3 (Stability AI 2022-2024) — conditioned through cross-attention on textual embeddings from frozen CLIP text encoders (Stable Diffusion 1/2, SDXL) or T5-XXL (Imagen Saharia et al. 2022, DeepFloyd IF, Stable Diffusion 3 MMDiT Esser et al. 2024 ICML "Scaling Rectified Flow Transformers for High-Resolution Image Synthesis") and steered via Classifier-Free Guidance (Ho and Salimans 2022 NeurIPS workshop) replacing classifier gradients with the difference ε_θ(x_t, c) + w·(ε_θ(x_t, c) − ε_θ(x_t, ∅)) at guidance scale w typically 3-12, extended via ControlNet (Zhang, Rao and Agrawala 2023 ICCV) for pose/depth/edge/segmentation conditioning, IP-Adapter (Ye et al. 2023 cubiq Tencent) for image-prompt conditioning, and LoRA / DoRA / LoCon parameter-efficient fine-tuning adapters — architecturally implemented either as the original DDPM U-Net (Ronneberger-style encoder-decoder with residual blocks, self-attention at mid resolutions, time embedding via sinusoidal positional encoding modulating GroupNorm via FiLM) used in Stable Diffusion 1/2/XL, Imagen, DALL-E 2 unCLIP (Ramesh et al. 2022 OpenAI), or as Diffusion Transformers (DiT Peebles and Xie 2023 ICCV "Scalable Diffusion Models with Transformers") replacing U-Net convolutions with patch-tokenised transformer blocks conditioned via AdaLN-Zero, scaled in Sora (OpenAI February 2024) for video, Stable Diffusion 3 MMDiT (multi-modal joint text-image transformer) and Flux.1 (Black Forest Labs August 2024, founded by ex-Stability researchers Robin Rombach / Andreas Blattmann / Dominik Lorenz after Sequoia / Sean Parker reset of Stability AI following the 2024 Emad Mostaque resignation and near-bankruptcy) which uses Rectified Flow (Liu et al. 2022 ICLR best paper) and Flow Matching (Lipman et al. 2023) formulations training a velocity field v_θ(x_t, t) on straight-line interpolations between data and noise rather than curved diffusion paths — having displaced GANs as the SOTA paradigm for high-fidelity image synthesis from 2022 onward (Stable Diffusion FID 2.27 ImageNet 256², Imagen FID 1.51 surpassing StyleGAN-XL 2.30) and powering the 2024-2026 generative AI economy spanning text-to-image (Stable Diffusion 3.5 / Flux.1 dev/schnell/pro / Midjourney v6-v7 / Ideogram 2.0 / DALL-E 3 / Adobe Firefly Image 4), text-to-video (Sora / Sora 2 2025, Google Veo 2/Veo 3, Kuaishou Kling 1.6, MiniMax Hailuo, Alibaba Wan 2.1, Tencent HunyuanVideo, Genmo Mochi-1, Lightricks LTX-Video, Open-Sora, Runway Gen-3/Gen-4, Pika 2.0), audio (AudioLDM, Stable Audio 2.0, Suno V3/V4, Udio), 3D generation (DreamFusion Poole et al. 2022 ICLR best paper, Magic3D, Wonder3D, Stable Video 3D, Direct3D, NVIDIA Edify), and avatar/world models (Wayve GAIA-1, NVIDIA Cosmos January 2025), with the global generative AI image market reaching ≈$5.5B in 2025 (Grand View Research) and projected $17B by 2030 — confronting persistent challenges of multi-step inference latency (20-1000× slower than GAN single-step), prohibitive training cost (Stable Diffusion 3 training estimated $10-30M), opaque latent spaces resisting clean attribute editing, copyright contention (Andersen v Stability, Getty v Stability ongoing 2024-2025 UK/US suits) and computationally demanding video extension (Sora estimated 1+ hour H100 time per minute of generated video at launch).

- ### Semantic Classification
  - owl-class:: artificial-intelligence:DiffusionModels
  - owl-role:: GenerativeModelFamily
  - owl-inferred:: ai:DeepGenerativeModel, ai:ScoreBasedModel, ai:LatentVariableModel, ai:IterativeDenoisingModel
...
- ### Relationships
  - is-subclass-of:: [[Deep Generative Model]], [[Neural Network]], [[Score-Based Model]], [[Latent Variable Model]], [[Markov Chain Model]]
  - has-part:: [[Forward Noising Process]], [[Reverse Denoising Process]], [[Noise Schedule]], [[Score Network]], [[Sampler]], [[Variational Lower Bound]], [[Text Encoder]]
  - requires:: [[Training Data Distribution]], [[Differentiable Architecture]], [[Stochastic Gradient Descent]], [[GPU Compute]], [[Variational Inference]]
  - enables:: [[Image Synthesis]], [[Video Synthesis]], [[Audio Synthesis]], [[3D Generation]], [[Inpainting]], [[Super Resolution]], [[Image Editing]]
  - implements:: [[Denoising Score Matching]], [[Variational Lower Bound Maximisation]], [[Stochastic Differential Equation]], [[Flow Matching]], [[Rectified Flow]]
  - depends-on:: [[Nonequilibrium Thermodynamics]], [[Stochastic Calculus]], [[Variational Inference]], [[Information Theory]], [[Probability Theory]], [[Deep Learning]]
  - supports:: [[Creative Tools]], [[Drug Discovery]], [[Medical Image Synthesis]], [[Synthetic Data Generation]], [[World Models]], [[Game Asset Generation]]
  - uses:: [[U-Net]], [[Diffusion Transformer]], [[Cross Attention]], [[Variational Autoencoder]], [[CLIP Encoder]], [[T5 Encoder]], [[Classifier-Free Guidance]], [[ControlNet]]
  - contrasts-with:: [[Generative Adversarial Networks]], [[Variational Autoencoder]], [[Autoregressive Model]], [[Normalising Flow]], [[Energy-Based Model]]
  - related-to:: [[Generative AI]], [[Synthetic Media]], [[Text-to-Image]], [[Text-to-Video]], [[Representation Learning]]
  - standardized-by:: [[NeurIPS]], [[ICML]], [[ICLR]], [[CVPR]], [[FID Benchmark Protocol]]
...
- ### Content
  ...
  ## Compositional Relationships (Components)
	  ...
	  FunctionalDataProperty(ai:imageSOTAFID)
	  ```
  ...
  - ### Major Families and Variants
	  ...
	  - **Flux.1 (Black Forest Labs August 2024)**: Founded by ex-Stability researchers Robin Rombach, Andreas Blattmann, Dominik Lorenz after the Stability AI near-bankruptcy and Sequoia / Sean Parker reset. **Flux.1 pro** (closed API), **Flux.1 dev** (12B parameter, non-commercial open weights), **Flux.1 schnell** (4-step distilled, Apache 2.0). Uses rectified flow + DiT. Raised $300M+ from Andreessen Horowitz at $1B+ valuation. Widely regarded as the open-weights SOTA as of late 2024 / mid 2025
	  ...
	  - **Suno V3 / V4 (Suno 2024-2025)**: Commercial AI music generation, $125M Series B at $500M valuation. Sued by RIAA/major labels June 2024
  ...
  - ### Use Cases and Major Application Families
	  ...
	  #### Consumer and Professional Creative Tools (≈ $3.2B 2025 image, $1.8B emerging video)
	  ...
	  - **Synthetic product photography**: Replacing $300-$2000 per-image studio shoots with $0.05 generated equivalents. Deployed at Amazon, Walmart, Mercari, eBay
	  ...
	  Global generative AI **image market**: $5.5B 2025, projected $17B 2030 (Grand View Research, IDC). Generative AI **video market**: emerging, $1.2B 2025, projected $7B+ 2030 driven by Sora, Veo, Kling commercialisation. **Drug discovery + materials + scientific applications**: $1B+ aggregate spend on diffusion-based platforms in 2025.
  ...
  - ### Future Directions (2026-2030)
	  ...
	  - **Cost trajectory**: Sora-class video generation estimated >$1/minute generated in 2024 → projected <$0.10/minute by 2027 via distillation + hardware
	  ...
	  - **Funding concentration**: Black Forest Labs $300M+ a16z, Runway $500M+ Series D, Synthesia $2.1B valuation, ElevenLabs $3.3B, Stability AI restructured under Sean Parker / Sequoia
	  ...
	  **2030 Projections**:
	  ...
	  - **Aggregate**: ≈$30-37B annual diffusion-model market, ≈1M+ deployments, ~$120B+ cumulative spend 2022-2030
  ...
  - ### Research and Literature
	  ...
	  **Sampling and Acceleration**:
	  5. Song, J., Meng, C., & Ermon, S. (2021). Denoising Diffusion Implicit Models (DDIM). *International Conference on Learning Representations (ICLR 2021)*. arXiv:2010.02502 [Deterministic non-Markovian sampling]
	  6. Nichol, A.Q., & Dhariwal, P. (2021). Improved Denoising Diffusion Probabilistic Models. *International Conference on Machine Learning (ICML 2021)*. arXiv:2102.09672 [Cosine schedule, learned variances]
	  7. Lu, C., Zhou, Y., Bao, F., Chen, J., Li, C., & Zhu, J. (2022). DPM-Solver: A Fast ODE Solver for Diffusion Probabilistic Model Sampling in Around 10 Steps. *Advances in Neural Information Processing Systems 35 (NeurIPS 2022)*. arXiv:2206.00927 [10-20 step sampling]
	  8. Karras, T., Aittala, M., Aila, T., & Laine, S. (2022). Elucidating the Design Space of Diffusion-Based Generative Models. *Advances in Neural Information Processing Systems 35 (NeurIPS 2022)*. arXiv:2206.00364 [EDM framework]
	  9. Song, Y., Dhariwal, P., Chen, M., & Sutskever, I. (2023). Consistency Models. *International Conference on Machine Learning (ICML 2023)*. arXiv:2303.01469 [1-4 step distillation]
	  10. Luo, S., Tan, Y., Huang, L., Li, J., & Zhao, H. (2023). Latent Consistency Models. arXiv:2310.04378 [LCM]
	  11. Sauer, A., Lorenz, D., Blattmann, A., & Rombach, R. (2024). Adversarial Diffusion Distillation. *European Conference on Computer Vision (ECCV 2024)*. arXiv:2311.17042 [SDXL Turbo basis]

	  **Guidance and Conditioning**:
	  12. Dhariwal, P., & Nichol, A. (2021). Diffusion Models Beat GANs on Image Synthesis. *Advances in Neural Information Processing Systems 34 (NeurIPS 2021)*. arXiv:2105.05233 [Classifier guidance]
	  13. Ho, J., & Salimans, T. (2022). Classifier-Free Diffusion Guidance. *NeurIPS 2021 Workshop on Deep Generative Models*. arXiv:2207.12598 [CFG]
	  14. Zhang, L., Rao, A., & Agrawala, M. (2023). Adding Conditional Control to Text-to-Image Diffusion Models (ControlNet). *IEEE International Conference on Computer Vision (ICCV 2023)*. arXiv:2302.05543 [Spatial conditioning]
	  15. Ye, H., Zhang, J., Liu, S., Han, X., & Yang, W. (2023). IP-Adapter: Text Compatible Image Prompt Adapter for Text-to-Image Diffusion Models. arXiv:2308.06721 [Image prompting]

	  **Image Generation Systems**:
	  16. Rombach, R., Blattmann, A., Lorenz, D., Esser, P., & Ommer, B. (2022). High-Resolution Image Synthesis with Latent Diffusion Models. *IEEE Conference on Computer Vision and Pattern Recognition (CVPR 2022)*, 10684-10695. arXiv:2112.10752 [Latent Diffusion / Stable Diffusion]
	  17. Saharia, C., Chan, W., Saxena, S., Li, L., Whang, J., Denton, E., et al. (2022). Photorealistic Text-to-Image Diffusion Models with Deep Language Understanding (Imagen). *Advances in Neural Information Processing Systems 35 (NeurIPS 2022)*. arXiv:2205.11487 [Imagen, T5-XXL]
	  18. Ramesh, A., Dhariwal, P., Nichol, A., Chu, C., & Chen, M. (2022). Hierarchical Text-Conditional Image Generation with CLIP Latents (DALL-E 2 / unCLIP). arXiv:2204.06125 [DALL-E 2]
	  19. Podell, D., English, Z., Lacey, K., Blattmann, A., Dockhorn, T., Müller, J., Penna, J., & Rombach, R. (2023). SDXL: Improving Latent Diffusion Models for High-Resolution Image Synthesis. arXiv:2307.01952 [SDXL]
	  20. Esser, P., Kulal, S., Blattmann, A., Entezari, R., Müller, J., Saini, H., Levi, Y., et al. (2024). Scaling Rectified Flow Transformers for High-Resolution Image Synthesis. *International Conference on Machine Learning (ICML 2024)*. arXiv:2403.03206 [SD3, MMDiT]

	  **Architectures and Flow Matching**:
	  21. Peebles, W., & Xie, S. (2023). Scalable Diffusion Models with Transformers (DiT). *IEEE International Conference on Computer Vision (ICCV 2023)*. arXiv:2212.09748 [Diffusion Transformer]
	  22. Liu, X., Gong, C., & Liu, Q. (2022). Flow Straight and Fast: Learning to Generate and Transfer Data with Rectified Flow. *International Conference on Learning Representations (ICLR 2023, best paper)*. arXiv:2209.03003 [Rectified Flow]
	  23. Lipman, Y., Chen, R.T.Q., Ben-Hamu, H., Nickel, M., & Le, M. (2023). Flow Matching for Generative Modeling. *International Conference on Learning Representations (ICLR 2023)*. arXiv:2210.02747 [Flow Matching]
	  24. Albergo, M.S., & Vanden-Eijnden, E. (2023). Building Normalizing Flows with Stochastic Interpolants. *International Conference on Learning Representations (ICLR 2023)*. arXiv:2209.15571 [Stochastic Interpolants]

	  **Video, Audio, 3D Extensions**:
	  25. Ho, J., Salimans, T., Gritsenko, A., Chan, W., Norouzi, M., & Fleet, D.J. (2022). Video Diffusion Models. *Advances in Neural Information Processing Systems 35 (NeurIPS 2022)*. arXiv:2204.03458 [Video diffusion foundations]
	  26. Blattmann, A., Dockhorn, T., Kulal, S., Mendelevitch, D., Kilian, M., Lorenz, D., et al. (2023). Stable Video Diffusion: Scaling Latent Video Diffusion Models to Large Datasets. arXiv:2311.15127 [Stable Video Diffusion]
	  27. Poole, B., Jain, A., Barron, J.T., & Mildenhall, B. (2023). DreamFusion: Text-to-3D using 2D Diffusion. *International Conference on Learning Representations (ICLR 2023, best paper)*. arXiv:2209.14988 [Score Distillation Sampling, 3D]
	  28. Abramson, J., Adler, J., Dunger, J., Evans, R., Green, T., Pritzel, A., et al. (2024). Accurate structure prediction of biomolecular interactions with AlphaFold 3. *Nature*, 630, 493-500. DOI:10.1038/s41586-024-07487-w [Diffusion in protein structure]

	  **Surveys and Reviews**:
	  29. Yang, L., Zhang, Z., Song, Y., Hong, S., Xu, R., Zhao, Y., Zhang, W., Cui, B., & Yang, M.H. (2023). Diffusion Models: A Comprehensive Survey of Methods and Applications. *ACM Computing Surveys*, 56(4), 1-39. DOI:10.1145/3626235 [Comprehensive 2023 review, 200+ pages arXiv version]
	  30. Croitoru, F.A., Hondru, V., Ionescu, R.T., & Shah, M. (2023). Diffusion Models in Vision: A Survey. *IEEE Transactions on Pattern Analysis and Machine Intelligence*, 45(9), 10850-10869. DOI:10.1109/TPAMI.2023.3261988 [Vision-focused survey]
...
- ### Provenance
  - sources:: [[Sohl-Dickstein et al. 2015 Deep Unsupervised Learning Nonequilibrium Thermodynamics]], [[Song & Ermon 2019 NCSN]], [[Ho et al. 2020 DDPM]], [[Song et al. 2021 Score-Based SDE]], [[Song Meng Ermon 2021 DDIM]], [[Nichol & Dhariwal 2021 Improved DDPM]], [[Lu et al. 2022 DPM-Solver]], [[Karras et al. 2022 EDM]], [[Song et al. 2023 Consistency Models]], [[Luo et al. 2023 LCM]], [[Sauer et al. 2024 Adversarial Diffusion Distillation]], [[Dhariwal & Nichol 2021 Diffusion Beats GANs]], [[Ho & Salimans 2022 Classifier-Free Guidance]], [[Zhang et al. 2023 ControlNet]], [[Ye et al. 2023 IP-Adapter]], [[Rombach et al. 2022 Latent Diffusion Stable Diffusion]], [[Saharia et al. 2022 Imagen]], [[Ramesh et al. 2022 DALL-E 2 unCLIP]], [[Podell et al. 2023 SDXL]], [[Esser et al. 2024 SD3 MMDiT Rectified Flow]], [[Peebles & Xie 2023 DiT]], [[Liu et al. 2022 Rectified Flow]], [[Lipman et al. 2023 Flow Matching]], [[Albergo & Vanden-Eijnden 2023 Stochastic Interpolants]], [[Ho et al. 2022 Video Diffusion Models]], [[Blattmann et al. 2023 Stable Video Diffusion]], [[Poole et al. 2022 DreamFusion]], [[Abramson et al. 2024 AlphaFold 3]], [[Yang et al. 2023 Diffusion Models Survey]], [[Croitoru et al. 2023 Diffusion Models Vision Survey]]
  - research-cache:: _enrich/research-cache/Diffusion Models.json
