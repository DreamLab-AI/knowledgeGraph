schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#FutureBernard
legacy_uri:: urn:visionclaw:concept:infrastructure:future-bernard
public:: true
...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "future-bernard",
  "title": "Future Bernard",
  "vc:public": true,
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-2c60f4086e0e"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#FutureBernard"
    },
    {
      "vc:key": "maturity",
      "vc:value": "draft"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:future-bernard"
    },
    {
      "vc:key": "status",
      "vc:value": "stub"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:429c166ad7b9bbbeb3595005e176be13b33d7f3a78aa3e8ecc726caf8359781d@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:future-bernard",
  "@type": "OntologyClass",
