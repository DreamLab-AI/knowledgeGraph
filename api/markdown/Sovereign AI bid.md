schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/ontology#SovereignAIBid
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:sovereign-ai-bid
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-15ee464c70b8"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/ontology#SovereignAIBid"
    },
    {
      "vc:key": "maturity",
      "vc:value": "draft"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:sovereign-ai-bid"
    },
    {
      "vc:key": "status",
      "vc:value": "stub"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:6b0e1da21fcf1f592effbae40a4245786c188014e00fe0da660597a2b91bb5ec@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:sovereign-ai-bid",
  "@type": "OntologyClass",
  ...
  "definition": "Sovereign AI bid is a concept within the ngm domain.",
  "vc:qualityScore": {
    "@value": "0.50",
    "@type": "xsd:float"
  },
