schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#NonFungibleTokenNFT
legacy_uri:: urn:visionclaw:concept:spatial-computing:non-fungible-token-nft
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-caa9bf155141"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#NonFungibleTokenNFT"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:non-fungible-token-nft"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
