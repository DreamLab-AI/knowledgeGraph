schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#ContextAwareResponse
legacy_uri:: urn:visionclaw:concept:spatial-computing:context-aware-response
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-3c3a50f357df"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#ContextAwareResponse"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:context-aware-response"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
