...
- ### Content
  - In retrieval-augmented generation systems, candidates from a sparse [private] and a dense vector store are merged and re-ranked, balancing exact-match precision against semantic recall. Tuning the fusion weights and applying a cross-encoder re-ranker further sharpens result quality for downstream language-model grounding.
