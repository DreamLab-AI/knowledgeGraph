```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "knowledge-graph-diagnostic-node",
...
```json-ld
{
  ...
  "@id": "urn:ngm:class:knowledge-graph-diagnostic-node",
  "@type": "Class",
  "label": "Knowledge Graph Diagnostic Node",
...
- ### Content
  - This is a node linked to [[[private]]]
