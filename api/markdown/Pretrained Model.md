schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#PretrainedModel
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:pretrained-model
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-821b921bca8a"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#PretrainedModel"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:pretrained-model"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
