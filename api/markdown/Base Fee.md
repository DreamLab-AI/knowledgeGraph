schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#BaseFee
legacy_uri:: urn:visionclaw:concept:blockchain:base-fee
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-4e03f487d733"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#BaseFee"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:base-fee"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:2964c56d21c498a903a8c79e5fa06ce41c7ff66f96e47b8e73c6313c9b089ec3@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:base-fee",
  "@type": "OntologyClass",
  "label": "Base Fee",
  "subClassOf": [
    {
