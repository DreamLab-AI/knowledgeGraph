schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#ContentModeration
legacy_uri:: urn:visionclaw:concept:spatial-computing:content-moderation
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-e851f1c2ced9"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#ContentModeration"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:content-moderation"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
