...
# RB-0015: Agricultural Robot
		  ...
		  **Agricultural Robot** - Agricultural Robot in robotics systems
		  ...
		  ```clojure
		  (Declaration (Class :AgriculturalRobot))
		  (SubClassOf :AgriculturalRobot :ServiceRobot)
		  
		  (AnnotationAssertion rdfs:label :AgriculturalRobot "Agricultural Robot"@en)
		  (AnnotationAssertion rdfs:comment :AgriculturalRobot
		    "Agricultural Robot - Foundational robotics concept"@en)
		  (AnnotationAssertion :termID :AgriculturalRobot "RB-0015"^^xsd:string)
		  
		  (Declaration (ObjectProperty :relates To))
		  (ObjectPropertyDomain :relatesTo :AgriculturalRobot)
		  
		  (Declaration (DataProperty :hasProperty))
		  (DataPropertyDomain :hasProperty :AgriculturalRobot)
		  ...
		  ### Primary Standards
		  1. **ISO 18497:2018**: Primary reference standard
		  ...
		  1. ✓ Meets ISO 18497:2018 requirements
		  ...
		  **License**: CC BY 4.0
		  **Namespace**: `https://metaverse-ontology.org/robotics/RB-0015`
