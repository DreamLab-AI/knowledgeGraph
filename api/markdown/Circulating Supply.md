schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#CirculatingSupply
legacy_uri:: urn:visionclaw:concept:blockchain:circulating-supply
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-dc69f0a974ea"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#CirculatingSupply"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:circulating-supply"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:a04d893c82db3b923aa7a468ce54a082a782bed6e46083cdf6dd8614bcbd1258@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:circulating-supply",
  "@type": "OntologyClass",
