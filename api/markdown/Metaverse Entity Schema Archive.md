...
elevatedFrom:: [[Some legacy Linked-JSON]]
...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "metaverse-entity-schema-archive",
...
```json-ld
{
  ...
  "@id": "urn:ngm:class:metaverse-entity-schema-archive",
  "@type": "Class",
  "label": "Metaverse Entity Schema Archive",
