schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#SpatialComputing
legacy_uri:: urn:visionclaw:concept:spatial-computing:spatial-computing
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-83331999fc71"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#SpatialComputing"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:spatial-computing"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:692be20334215e671bdeed4f1c746b0689204f09de9082ba5d5e180ed74eb4cb@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
