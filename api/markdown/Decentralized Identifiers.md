schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#DecentralizedIdentifiers
legacy_uri:: urn:visionclaw:concept:blockchain:decentralized-identifiers
public:: true
...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "decentralized-identifiers",
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:animo-solutions",
      "vc:label": "Animo Solutions"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:aries-cloudagent-python-aca-py",
      "vc:label": "Aries-Cloudagent-Python (ACA-Py)"
    },
    {
      "@id": "urn:visionflow:linked:aries-framework-java-script",
      "vc:label": "Aries Framework JavaScript"
    },
    {
      "@id": "urn:visionflow:linked:aries-framework-net",
      "vc:label": "Aries Framework .NET"
    },
    {
      "@id": "urn:visionflow:linked:avast",
      "vc:label": "Avast"
    },
    {
      "@id": "urn:visionflow:linked:bank-id",
      "vc:label": "BankID"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:block-chain-hyperledger-belfast",
      "vc:label": "BlockChain Hyperledger Belfast"
    },
    {
      "@id": "urn:visionflow:linked:bloom",
      "vc:label": "Bloom"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:british-columbia-government",
      "vc:label": "British Columbia Government"
    },
    {
      "@id": "urn:visionflow:linked:cabinet-office-gds",
      "vc:label": "Cabinet Office GDS"
    },
    {
      "@id": "urn:visionflow:linked:cbor-ld",
      "vc:label": "CBOR-LD"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:cheqd",
      "vc:label": "cheqd"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:connect-me",
      "vc:label": "ConnectMe"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:credo-ts",
      "vc:label": "Credo-TS"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:cyacomb",
      "vc:label": "Cyacomb"
    },
    {
      "@id": "urn:visionflow:linked:danube-tech",
      "vc:label": "Danube Tech"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:department-for-science-innovation-and-technology",
      "vc:label": "Department for Science, Innovation and Technology"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:did-elem",
      "vc:label": "did:elem"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:did-ethr-specification",
      "vc:label": "did:ethr Specification"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:did-indy-specification",
      "vc:label": "did:indy Specification"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:did-nostr",
      "vc:label": "did:nostr"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:did-plc-specification",
      "vc:label": "did:plc Specification"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:did-sov",
      "vc:label": "did:sov"
    },
    {
      "@id": "urn:visionflow:linked:did-tdw",
      "vc:label": "did:tdw"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:did-webvh-specification",
      "vc:label": "did:webvh Specification"
    },
    {
      "@id": "urn:visionflow:linked:didcomm-messaging-libraries",
      "vc:label": "DIDComm Messaging libraries"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:dif-sidetree-specification",
      "vc:label": "DIF Sidetree Specification"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:digi-locker",
      "vc:label": "DigiLocker"
    },
    {
      "@id": "urn:visionflow:linked:digital-catapult",
      "vc:label": "Digital Catapult"
    },
    {
      "@id": "urn:visionflow:linked:digital-catapult-north-east",
      "vc:label": "Digital Catapult North East"
    },
    {
      "@id": "urn:visionflow:linked:digital-catapult-nw",
      "vc:label": "Digital Catapult NW"
    },
    {
      "@id": "urn:visionflow:linked:digital-credentials-consortium",
      "vc:label": "Digital Credentials Consortium"
    },
    {
      "@id": "urn:visionflow:linked:digital-identity-and-attributes-trust-framework",
      "vc:label": "Digital Identity and Attributes Trust Framework"
    },
    {
      "@id": "urn:visionflow:linked:dock-labs",
      "vc:label": "Dock Labs"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:encompass",
      "vc:label": "Encompass"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:esatus",
      "vc:label": "esatus"
    },
    {
      "@id": "urn:visionflow:linked:essif",
      "vc:label": "ESSIF"
    },
    {
      "@id": "urn:visionflow:linked:estonia-m-id",
      "vc:label": "Estonia mID"
    },
    {
      "@id": "urn:visionflow:linked:eudi-wallet-arf-v1-4",
      "vc:label": "EUDI Wallet ARF v1.4"
    },
    {
      "@id": "urn:visionflow:linked:europass-digital-credentials-infrastructure",
      "vc:label": "Europass Digital Credentials Infrastructure"
    },
    {
      "@id": "urn:visionflow:linked:europass-edc",
      "vc:label": "Europass EDC"
    },
    {
      "@id": "urn:visionflow:linked:european-blockchain-services-infrastructure",
      "vc:label": "European Blockchain Services Infrastructure"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:gen-digital",
      "vc:label": "Gen Digital"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:gleif-v-lei",
      "vc:label": "GLEIF vLEI"
    },
    {
      "@id": "urn:visionflow:linked:gleif-v-lei-governance-framework",
      "vc:label": "GLEIF vLEI Governance Framework"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:iata-one-id",
      "vc:label": "IATA One ID"
    },
    {
      "@id": "urn:visionflow:linked:icao-dtc",
      "vc:label": "ICAO DTC"
    },
    {
      "@id": "urn:visionflow:linked:id4-d",
      "vc:label": "ID4D"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:information-commissioner-s-office",
    ...
    {
      "@id": "urn:visionflow:linked:italy-it-wallet",
      "vc:label": "Italy IT Wallet"
    },
    {
      "@id": "urn:visionflow:linked:jroc",
      "vc:label": "JROC"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:kuppinger-cole-leadership-compass-did-wallets-2025",
      "vc:label": "KuppingerCole Leadership Compass DID Wallets 2025"
    },
    {
      "@id": "urn:visionflow:linked:lissi",
      "vc:label": "Lissi"
    },
    {
      "@id": "urn:visionflow:linked:m-hle-et-al-2018-ssi-components-survey",
      "vc:label": "Mühle et al 2018 SSI Components Survey"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:mimecast",
      "vc:label": "Mimecast"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:nsw-digital-id",
      "vc:label": "NSW Digital ID"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:office-for-digital-identities-and-attributes",
      "vc:label": "Office for Digital Identities and Attributes"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:open-badges-3-0",
      "vc:label": "Open Badges 3.0"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:p-hn-hommel-2024-iam-survey",
      "vc:label": "Pöhn Hommel 2024 IAM Survey"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:procivis",
      "vc:label": "Procivis"
    },
    {
      "@id": "urn:visionflow:linked:rebooting-the-web-of-trust",
      "vc:label": "Rebooting the Web of Trust"
    },
    {
      "@id": "urn:visionflow:linked:rfc-3986",
      "vc:label": "RFC 3986"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:schardong-custodio-2024-ssi-systematic-map",
      "vc:label": "Schardong Custodio 2024 SSI Systematic Map"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:sedlmeir-et-al-2024-digital-identities-vc",
      "vc:label": "Sedlmeir et al 2024 Digital Identities VC"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:singpass",
      "vc:label": "Singpass"
    },
    {
      "@id": "urn:visionflow:linked:smarsh",
      "vc:label": "Smarsh"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:sphereon-ssi-sdk",
      "vc:label": "Sphereon SSI-SDK"
    },
    {
      "@id": "urn:visionflow:linked:spruce-didkit",
      "vc:label": "Spruce DIDKit"
    },
    {
      "@id": "urn:visionflow:linked:spruce-id",
      "vc:label": "Spruce ID"
    },
    {
      "@id": "urn:visionflow:linked:spruce-systems",
      "vc:label": "Spruce Systems"
    },
    {
      "@id": "urn:visionflow:linked:surrey-centre-for-cyber-security",
      "vc:label": "Surrey Centre for Cyber Security"
    },
    {
      "@id": "urn:visionflow:linked:tessian",
      "vc:label": "Tessian"
    },
    {
      "@id": "urn:visionflow:linked:tobin-reed-2017-inevitable-rise-of-ssi",
      "vc:label": "Tobin Reed 2017 Inevitable Rise of SSI"
    },
    {
      "@id": "urn:visionflow:linked:travel-pass",
      "vc:label": "Travel Pass"
    },
    {
      "@id": "urn:visionflow:linked:trinsic",
      "vc:label": "Trinsic"
    },
    {
      "@id": "urn:visionflow:linked:trinsic-sdk",
      "vc:label": "Trinsic SDK"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:truu",
      "vc:label": "Truu"
    },
    {
      "@id": "urn:visionflow:linked:ucl-cbt-state-of-digital-identity-europe",
      "vc:label": "UCL CBT State of Digital Identity Europe"
    },
    {
      "@id": "urn:visionflow:linked:ucl-centre-for-blockchain-technologies",
      "vc:label": "UCL Centre for Blockchain Technologies"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:uk-diatf-v0-4",
      "vc:label": "UK DIATF v0.4"
    },
    {
      "@id": "urn:visionflow:linked:uk-digital-identity-and-attributes-trust-framework",
      "vc:label": "UK Digital Identity and Attributes Trust Framework"
    },
    {
      "@id": "urn:visionflow:linked:universal-resolver",
      "vc:label": "Universal Resolver"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:veramo",
      "vc:label": "Veramo"
    },
    {
      "@id": "urn:visionflow:linked:veridian",
      "vc:label": "Veridian"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:w3-c-bbs-cryptosuites",
      "vc:label": "W3C BBS+ Cryptosuites"
    },
    {
      "@id": "urn:visionflow:linked:w3-c-data-integrity-1-0",
      "vc:label": "W3C Data Integrity 1.0"
    },
    {
      "@id": "urn:visionflow:linked:w3-c-did-1-1-working-draft",
      "vc:label": "W3C DID 1.1 Working Draft"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:w3-c-did-method-registry",
      "vc:label": "W3C DID Method Registry"
    },
    {
      "@id": "urn:visionflow:linked:w3-c-did-resolution",
      "vc:label": "W3C DID Resolution"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:w3-c-vc-data-model-v2-0",
      "vc:label": "W3C VC Data Model v2.0"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:waci-didcomm",
      "vc:label": "WACI-DIDComm"
    },
    {
      "@id": "urn:visionflow:linked:walt-id",
      "vc:label": "walt.id"
    },
    {
      "@id": "urn:visionflow:linked:walt-id-issuer-verifier-wallet",
      "vc:label": "walt.id Issuer / Verifier / Wallet"
    },
    {
      "@id": "urn:visionflow:linked:web-standards-domain",
      "vc:label": "WebStandardsDomain"
    },
    {
      "@id": "urn:visionflow:linked:worldline-uk",
      "vc:label": "Worldline UK"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "bridges-to",
      "vc:value": "[[Self-Sovereign Identity]]"
    },
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-4ffcd763a8e4"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#DecentralizedIdentifiers"
    },
    {
    ...
    },
    {
      ...
      "vc:value": "Decentralized Identifiers"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:decentralized-identifiers"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:decentralized-identifiers:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[Animo Solutions]]",
      "resolved": "urn:visionflow:linked:animo-solutions",
      "kind": "StubLink"
    },
    {
      "raw": "[[AnonCreds]]",
    ...
    {
      "raw": "[[Aries-Cloudagent-Python (ACA-Py)]]",
      "resolved": "urn:visionflow:linked:aries-cloudagent-python-aca-py",
      "kind": "StubLink"
    },
    {
      "raw": "[[Aries Framework JavaScript]]",
      "resolved": "urn:visionflow:linked:aries-framework-java-script",
      "kind": "StubLink"
    },
    {
      "raw": "[[Aries Framework .NET]]",
      "resolved": "urn:visionflow:linked:aries-framework-net",
      "kind": "StubLink"
    },
    {
      "raw": "[[Avast]]",
      "resolved": "urn:visionflow:linked:avast",
      "kind": "StubLink"
    },
    {
      "raw": "[[BankID]]",
      "resolved": "urn:visionflow:linked:bank-id",
      "kind": "StubLink"
    },
    {
      "raw": "[[BBS+ Signatures]]",
      "resolved": "urn:visionflow:linked:bbs-signatures",
      "kind": "StubLink"
    },
    {
      "raw": "[[BC Wallet]]",
    ...
    {
      "raw": "[[BlockChain Hyperledger Belfast]]",
      "resolved": "urn:visionflow:linked:block-chain-hyperledger-belfast",
      "kind": "StubLink"
    },
    {
      "raw": "[[Bloom]]",
      "resolved": "urn:visionflow:linked:bloom",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[British Columbia Government]]",
      "resolved": "urn:visionflow:linked:british-columbia-government",
      "kind": "StubLink"
    },
    {
      "raw": "[[Cabinet Office GDS]]",
      "resolved": "urn:visionflow:linked:cabinet-office-gds",
      "kind": "StubLink"
    },
    {
      "raw": "[[CBOR-LD]]",
      "resolved": "urn:visionflow:linked:cbor-ld",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[cheqd]]",
      "resolved": "urn:visionflow:linked:cheqd",
      "kind": "StubLink"
    },
    {
      "raw": "[[Civic]]",
    ...
    {
      "raw": "[[ConnectMe]]",
      "resolved": "urn:visionflow:linked:connect-me",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Credo-TS]]",
      "resolved": "urn:visionflow:linked:credo-ts",
      "kind": "StubLink"
    },
    {
      "raw": "[[Cryptographic Identifier]]",
      "resolved": "urn:visionflow:linked:cryptographic-identifier",
      "kind": "StubLink"
    },
    {
      "raw": "[[Cryptographic Suites]]",
      "resolved": "urn:visionflow:linked:cryptographic-suites",
      "kind": "StubLink"
    },
    {
      "raw": "[[Cyacomb]]",
      "resolved": "urn:visionflow:linked:cyacomb",
      "kind": "StubLink"
    },
    {
      "raw": "[[Danube Tech]]",
      "resolved": "urn:visionflow:linked:danube-tech",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Department for Science, Innovation and Technology]]",
      "resolved": "urn:visionflow:linked:department-for-science-innovation-and-technology",
      "kind": "StubLink"
    },
    {
      "raw": "[[did:cheqd]]",
      "resolved": "urn:visionflow:linked:did-cheqd",
      "kind": "StubLink"
    },
    {
      "raw": "[[DID Controller]]",
      "resolved": "urn:visionflow:linked:did-controller",
      "kind": "StubLink"
    },
    {
      "raw": "[[DID Document]]",
    ...
    {
      "raw": "[[did:elem]]",
      "resolved": "urn:visionflow:linked:did-elem",
      "kind": "StubLink"
    },
    {
      "raw": "[[did:ethr]]",
    ...
    {
      "raw": "[[did:ethr Specification]]",
      "resolved": "urn:visionflow:linked:did-ethr-specification",
      "kind": "StubLink"
    },
    {
      "raw": "[[did:indy]]",
      "resolved": "urn:visionflow:linked:did-indy",
      "kind": "StubLink"
    },
    {
      "raw": "[[did:indy Specification]]",
      "resolved": "urn:visionflow:linked:did-indy-specification",
      "kind": "StubLink"
    },
    {
      "raw": "[[did:ion]]",
    ...
    {
      "raw": "[[did:jwk]]",
      "resolved": "urn:visionflow:linked:did-jwk",
      "kind": "StubLink"
    },
    {
      "raw": "[[did:key]]",
    ...
    {
      "raw": "[[did:nostr]]",
      "resolved": "urn:visionflow:linked:did-nostr",
      "kind": "StubLink"
    },
    {
      "raw": "[[did:peer]]",
    ...
    {
      "raw": "[[did:plc Specification]]",
      "resolved": "urn:visionflow:linked:did-plc-specification",
      "kind": "StubLink"
    },
    {
      "raw": "[[DID Resolution Protocol]]",
      "resolved": "urn:visionflow:linked:did-resolution-protocol",
      "kind": "StubLink"
    },
    {
      "raw": "[[DID Resolver]]",
    ...
    {
      "raw": "[[did:sov]]",
      "resolved": "urn:visionflow:linked:did-sov",
      "kind": "StubLink"
    },
    {
      "raw": "[[did:tdw]]",
      "resolved": "urn:visionflow:linked:did-tdw",
      "kind": "StubLink"
    },
    {
      "raw": "[[DID URL]]",
      "resolved": "urn:visionflow:linked:did-url",
      "kind": "StubLink"
    },
    {
      "raw": "[[did:web]]",
    ...
    {
      "raw": "[[did:webvh Specification]]",
      "resolved": "urn:visionflow:linked:did-webvh-specification",
      "kind": "StubLink"
    },
    {
      "raw": "[[DIDComm Messaging libraries]]",
      "resolved": "urn:visionflow:linked:didcomm-messaging-libraries",
      "kind": "StubLink"
    },
    {
      "raw": "[[DIDComm v2]]",
      "resolved": "urn:visionflow:linked:didcomm-v2",
      "kind": "StubLink"
    },
    {
      "raw": "[[DIF Sidetree Specification]]",
      "resolved": "urn:visionflow:linked:dif-sidetree-specification",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[DigiLocker]]",
      "resolved": "urn:visionflow:linked:digi-locker",
      "kind": "StubLink"
    },
    {
      "raw": "[[Digital Catapult]]",
      "resolved": "urn:visionflow:linked:digital-catapult",
      "kind": "StubLink"
    },
    {
      "raw": "[[Digital Catapult North East]]",
      "resolved": "urn:visionflow:linked:digital-catapult-north-east",
      "kind": "StubLink"
    },
    {
      "raw": "[[Digital Catapult NW]]",
      "resolved": "urn:visionflow:linked:digital-catapult-nw",
      "kind": "StubLink"
    },
    {
      "raw": "[[Digital Credentials Consortium]]",
      "resolved": "urn:visionflow:linked:digital-credentials-consortium",
      "kind": "StubLink"
    },
    {
      "raw": "[[Digital Identity and Attributes Trust Framework]]",
      "resolved": "urn:visionflow:linked:digital-identity-and-attributes-trust-framework",
      "kind": "StubLink"
    },
    {
      "raw": "[[Dock Labs]]",
      "resolved": "urn:visionflow:linked:dock-labs",
      "kind": "StubLink"
    },
    {
      "raw": "[[eIDAS 2.0]]",
    ...
    {
      "raw": "[[Encompass]]",
      "resolved": "urn:visionflow:linked:encompass",
      "kind": "StubLink"
    },
    {
      "raw": "[[ENS]]",
    ...
    {
      "raw": "[[esatus]]",
      "resolved": "urn:visionflow:linked:esatus",
      "kind": "StubLink"
    },
    {
      "raw": "[[ESSIF]]",
      "resolved": "urn:visionflow:linked:essif",
      "kind": "StubLink"
    },
    {
      "raw": "[[Estonia mID]]",
      "resolved": "urn:visionflow:linked:estonia-m-id",
      "kind": "StubLink"
    },
    {
      "raw": "[[EUDI Wallet ARF v1.4]]",
      "resolved": "urn:visionflow:linked:eudi-wallet-arf-v1-4",
      "kind": "StubLink"
    },
    {
      "raw": "[[Europass Digital Credentials Infrastructure]]",
      "resolved": "urn:visionflow:linked:europass-digital-credentials-infrastructure",
      "kind": "StubLink"
    },
    {
      "raw": "[[Europass EDC]]",
      "resolved": "urn:visionflow:linked:europass-edc",
      "kind": "StubLink"
    },
    {
      "raw": "[[European Blockchain Services Infrastructure]]",
      "resolved": "urn:visionflow:linked:european-blockchain-services-infrastructure",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[European Digital Identity Wallet]]",
      "resolved": "urn:visionflow:linked:european-digital-identity-wallet",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Gen Digital]]",
      "resolved": "urn:visionflow:linked:gen-digital",
      "kind": "StubLink"
    },
    {
      "raw": "[[GLEIF]]",
      "resolved": "urn:visionflow:linked:gleif",
      "kind": "StubLink"
    },
    {
      "raw": "[[GLEIF vLEI]]",
      "resolved": "urn:visionflow:linked:gleif-v-lei",
      "kind": "StubLink"
    },
    {
      "raw": "[[GLEIF vLEI Governance Framework]]",
      "resolved": "urn:visionflow:linked:gleif-v-lei-governance-framework",
      "kind": "StubLink"
    },
    {
      "raw": "[[GOV.UK One Login]]",
      "resolved": "urn:visionflow:linked:gov-uk-one-login",
      "kind": "StubLink"
    },
    {
      "raw": "[[GS1]]",
    ...
    {
      "raw": "[[IATA One ID]]",
      "resolved": "urn:visionflow:linked:iata-one-id",
      "kind": "StubLink"
    },
    {
      "raw": "[[ICAO DTC]]",
      "resolved": "urn:visionflow:linked:icao-dtc",
      "kind": "StubLink"
    },
    {
      "raw": "[[ID4D]]",
      "resolved": "urn:visionflow:linked:id4-d",
      "kind": "StubLink"
    },
    {
      "raw": "[[Identifier]]",
      "resolved": "urn:visionflow:linked:identifier",
      "kind": "StubLink"
    },
    {
      "raw": "[[IdentifierLayer]]",
    ...
    {
      "raw": "[[IETF OAuth Working Group]]",
      "resolved": "urn:visionflow:linked:ietf-oauth-working-group",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Information Commissioner's Office]]",
      "resolved": "urn:visionflow:linked:information-commissioner-s-office",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[ISO/IEC JTC 1/SC 27]]",
      "resolved": "urn:visionflow:linked:iso-iec-jtc-1-sc-27",
      "kind": "StubLink"
    },
    {
      "raw": "[[Italy IT Wallet]]",
      "resolved": "urn:visionflow:linked:italy-it-wallet",
      "kind": "StubLink"
    },
    {
      "raw": "[[JROC]]",
      "resolved": "urn:visionflow:linked:jroc",
      "kind": "StubLink"
    },
    {
      "raw": "[[JSON-LD]]",
    ...
    {
      "raw": "[[JSON-LD Contexts]]",
      "resolved": "urn:visionflow:linked:json-ld-contexts",
      "kind": "StubLink"
    },
    {
      "raw": "[[Key Management System]]",
      "resolved": "urn:visionflow:linked:key-management-system",
      "kind": "StubLink"
    },
    {
      "raw": "[[Keybase]]",
    ...
    {
      "raw": "[[KuppingerCole Leadership Compass DID Wallets 2025]]",
      "resolved": "urn:visionflow:linked:kuppinger-cole-leadership-compass-did-wallets-2025",
      "kind": "StubLink"
    },
    {
      "raw": "[[Lissi]]",
      "resolved": "urn:visionflow:linked:lissi",
      "kind": "StubLink"
    },
    {
      "raw": "[[Mühle et al 2018 SSI Components Survey]]",
      "resolved": "urn:visionflow:linked:m-hle-et-al-2018-ssi-components-survey",
      "kind": "StubLink"
    },
    {
      "raw": "[[Manchester]]",
    ...
    {
      "raw": "[[Merkle Logs]]",
      "resolved": "urn:visionflow:linked:merkle-logs",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Mimecast]]",
      "resolved": "urn:visionflow:linked:mimecast",
      "kind": "StubLink"
    },
    {
      "raw": "[[Multibase Encoding]]",
      "resolved": "urn:visionflow:linked:multibase-encoding",
      "kind": "StubLink"
    },
    {
      "raw": "[[Multicodec]]",
      "resolved": "urn:visionflow:linked:multicodec",
      "kind": "StubLink"
    },
    {
      "raw": "[[Multihash]]",
    ...
    {
      "raw": "[[NSW Digital ID]]",
      "resolved": "urn:visionflow:linked:nsw-digital-id",
      "kind": "StubLink"
    },
    {
      "raw": "[[OAuth 2.0]]",
    ...
    {
      "raw": "[[Office for Digital Identities and Attributes]]",
      "resolved": "urn:visionflow:linked:office-for-digital-identities-and-attributes",
      "kind": "StubLink"
    },
    {
      "raw": "[[OneID]]",
    ...
    {
      "raw": "[[Open Badges 3.0]]",
      "resolved": "urn:visionflow:linked:open-badges-3-0",
      "kind": "StubLink"
    },
    {
      "raw": "[[OpenID Connect]]",
    ...
    {
      "raw": "[[OpenID4VC]]",
      "resolved": "urn:visionflow:linked:open-id4-vc",
      "kind": "StubLink"
    },
    {
      "raw": "[[OpenID4VCI]]",
    ...
    {
      "raw": "[[Pöhn Hommel 2024 IAM Survey]]",
      "resolved": "urn:visionflow:linked:p-hn-hommel-2024-iam-survey",
      "kind": "StubLink"
    },
    {
      "raw": "[[Pairwise Pseudonymous Identifiers]]",
      "resolved": "urn:visionflow:linked:pairwise-pseudonymous-identifiers",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Portable Identity]]",
      "resolved": "urn:visionflow:linked:portable-identity",
      "kind": "StubLink"
    },
    {
      "raw": "[[Procivis]]",
      "resolved": "urn:visionflow:linked:procivis",
      "kind": "StubLink"
    },
    {
      "raw": "[[Rebooting the Web of Trust]]",
      "resolved": "urn:visionflow:linked:rebooting-the-web-of-trust",
      "kind": "StubLink"
    },
    {
      "raw": "[[RFC 3986]]",
      "resolved": "urn:visionflow:linked:rfc-3986",
      "kind": "StubLink"
    },
    {
      "raw": "[[SAML 2.0]]",
    ...
    {
      "raw": "[[Schardong Custodio 2024 SSI Systematic Map]]",
      "resolved": "urn:visionflow:linked:schardong-custodio-2024-ssi-systematic-map",
      "kind": "StubLink"
    },
    {
      "raw": "[[SD-JWT]]",
      "resolved": "urn:visionflow:linked:sd-jwt",
      "kind": "StubLink"
    },
    {
      "raw": "[[secp256k1]]",
    ...
    {
      "raw": "[[Sedlmeir et al 2024 Digital Identities VC]]",
      "resolved": "urn:visionflow:linked:sedlmeir-et-al-2024-digital-identities-vc",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Self-Sovereign Identifier]]",
      "resolved": "urn:visionflow:linked:self-sovereign-identifier",
      "kind": "StubLink"
    },
    {
      "raw": "[[Service Endpoint]]",
      "resolved": "urn:visionflow:linked:service-endpoint",
      "kind": "StubLink"
    },
    {
      "raw": "[[Singpass]]",
      "resolved": "urn:visionflow:linked:singpass",
      "kind": "StubLink"
    },
    {
      "raw": "[[Smarsh]]",
      "resolved": "urn:visionflow:linked:smarsh",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Sovrin Network]]",
      "resolved": "urn:visionflow:linked:sovrin-network",
      "kind": "StubLink"
    },
    {
      "raw": "[[Sphereon SSI-SDK]]",
      "resolved": "urn:visionflow:linked:sphereon-ssi-sdk",
      "kind": "StubLink"
    },
    {
      "raw": "[[Spruce DIDKit]]",
      "resolved": "urn:visionflow:linked:spruce-didkit",
      "kind": "StubLink"
    },
    {
      "raw": "[[Spruce ID]]",
      "resolved": "urn:visionflow:linked:spruce-id",
      "kind": "StubLink"
    },
    {
      "raw": "[[Spruce Systems]]",
      "resolved": "urn:visionflow:linked:spruce-systems",
      "kind": "StubLink"
    },
    {
      "raw": "[[Surrey Centre for Cyber Security]]",
      "resolved": "urn:visionflow:linked:surrey-centre-for-cyber-security",
      "kind": "StubLink"
    },
    {
      "raw": "[[Tessian]]",
      "resolved": "urn:visionflow:linked:tessian",
      "kind": "StubLink"
    },
    {
      "raw": "[[Tobin Reed 2017 Inevitable Rise of SSI]]",
      "resolved": "urn:visionflow:linked:tobin-reed-2017-inevitable-rise-of-ssi",
      "kind": "StubLink"
    },
    {
      "raw": "[[Travel Pass]]",
      "resolved": "urn:visionflow:linked:travel-pass",
      "kind": "StubLink"
    },
    {
      "raw": "[[Trinsic]]",
      "resolved": "urn:visionflow:linked:trinsic",
      "kind": "StubLink"
    },
    {
      "raw": "[[Trinsic SDK]]",
      "resolved": "urn:visionflow:linked:trinsic-sdk",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Truu]]",
      "resolved": "urn:visionflow:linked:truu",
      "kind": "StubLink"
    },
    {
      "raw": "[[UCL CBT State of Digital Identity Europe]]",
      "resolved": "urn:visionflow:linked:ucl-cbt-state-of-digital-identity-europe",
      "kind": "StubLink"
    },
    {
      "raw": "[[UCL Centre for Blockchain Technologies]]",
      "resolved": "urn:visionflow:linked:ucl-centre-for-blockchain-technologies",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[UK DIATF v0.4]]",
      "resolved": "urn:visionflow:linked:uk-diatf-v0-4",
      "kind": "StubLink"
    },
    {
      "raw": "[[UK Digital Identity and Attributes Trust Framework]]",
      "resolved": "urn:visionflow:linked:uk-digital-identity-and-attributes-trust-framework",
      "kind": "StubLink"
    },
    {
      "raw": "[[Universal Resolver]]",
      "resolved": "urn:visionflow:linked:universal-resolver",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[URI Scheme]]",
      "resolved": "urn:visionflow:linked:uri-scheme",
      "kind": "StubLink"
    },
    {
      "raw": "[[Veramo]]",
      "resolved": "urn:visionflow:linked:veramo",
      "kind": "StubLink"
    },
    {
      "raw": "[[Veridian]]",
      "resolved": "urn:visionflow:linked:veridian",
      "kind": "StubLink"
    },
    {
      "raw": "[[Verification Method]]",
      "resolved": "urn:visionflow:linked:verification-method",
      "kind": "StubLink"
    },
    {
      "raw": "[[W3C]]",
    ...
    {
      "raw": "[[W3C BBS+ Cryptosuites]]",
      "resolved": "urn:visionflow:linked:w3-c-bbs-cryptosuites",
      "kind": "StubLink"
    },
    {
      "raw": "[[W3C Data Integrity 1.0]]",
      "resolved": "urn:visionflow:linked:w3-c-data-integrity-1-0",
      "kind": "StubLink"
    },
    {
      "raw": "[[W3C DID 1.1 Working Draft]]",
      "resolved": "urn:visionflow:linked:w3-c-did-1-1-working-draft",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[W3C DID Method Registry]]",
      "resolved": "urn:visionflow:linked:w3-c-did-method-registry",
      "kind": "StubLink"
    },
    {
      "raw": "[[W3C DID Resolution]]",
      "resolved": "urn:visionflow:linked:w3-c-did-resolution",
      "kind": "StubLink"
    },
    {
      "raw": "[[W3C DID Working Group]]",
      "resolved": "urn:visionflow:linked:w3-c-did-working-group",
      "kind": "StubLink"
    },
    {
      "raw": "[[W3C VC Data Model v2.0]]",
      "resolved": "urn:visionflow:linked:w3-c-vc-data-model-v2-0",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[W3C Verifiable Credentials Working Group]]",
      "resolved": "urn:visionflow:linked:w3-c-verifiable-credentials-working-group",
      "kind": "StubLink"
    },
    {
      "raw": "[[WACI-DIDComm]]",
      "resolved": "urn:visionflow:linked:waci-didcomm",
      "kind": "StubLink"
    },
    {
      "raw": "[[walt.id]]",
      "resolved": "urn:visionflow:linked:walt-id",
      "kind": "StubLink"
    },
    {
      "raw": "[[walt.id Issuer / Verifier / Wallet]]",
      "resolved": "urn:visionflow:linked:walt-id-issuer-verifier-wallet",
      "kind": "StubLink"
    },
    {
      "raw": "[[WebStandardsDomain]]",
      "resolved": "urn:visionflow:linked:web-standards-domain",
      "kind": "StubLink"
    },
    {
      "raw": "[[Worldline UK]]",
      "resolved": "urn:visionflow:linked:worldline-uk",
      "kind": "StubLink"
    },
    {
      "raw": "[[X.509 Public Key Infrastructure]]",
      "resolved": "urn:visionflow:linked:x-509-public-key-infrastructure",
      "kind": "StubLink"
    },
    {
      "raw": "[[Yoti]]",
