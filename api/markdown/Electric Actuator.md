schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/robotics#ElectricActuator
legacy_uri:: urn:visionclaw:concept:robotics:electric-actuator
public:: true
...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "electric-actuator",
  "title": "Electric Actuator",
  "vc:public": true,
  "vc:outboundWikilinks": [
    {
      "@id": "urn:visionflow:linked:ac-induction-motors",
      "vc:label": "AC Induction Motors"
    },
    {
      "@id": "urn:visionflow:linked:brush-dc-motors",
      "vc:label": "Brush DC Motors"
    },
    {
      "@id": "urn:visionflow:linked:brushless-dc-motors",
      "vc:label": "Brushless DC Motors"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:electroactive-polymers",
      "vc:label": "Electroactive Polymers"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:energy-constrained-robots",
      "vc:label": "Energy-Constrained Robots"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:gearboxes",
      "vc:label": "Gearboxes"
    },
    {
      "@id": "urn:visionflow:linked:linear-actuators",
      "vc:label": "Linear Actuators"
    },
    {
      "@id": "urn:visionflow:linked:linear-servo",
      "vc:label": "Linear Servo"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:pwm",
      "vc:label": "PWM"
    },
    {
      "@id": "urn:visionflow:linked:servo-amplifiers",
      "vc:label": "Servo Amplifiers"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:spring-loaded-mechanisms",
      "vc:label": "Spring-Loaded Mechanisms"
    },
    {
      "@id": "urn:visionflow:linked:stepper-motors",
      "vc:label": "Stepper Motors"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-15d93da68f8e"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/robotics#ElectricActuator"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:robotics:electric-actuator"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:electric-actuator:776c802a9fc9",
  ...
  "vc:resolutions": [
    {
      "raw": "[[AC Induction Motors]]",
      "resolved": "urn:visionflow:linked:ac-induction-motors",
      "kind": "StubLink"
    },
    {
      "raw": "[[Brush DC Motors]]",
      "resolved": "urn:visionflow:linked:brush-dc-motors",
      "kind": "StubLink"
    },
    {
      "raw": "[[Brushless DC Motors]]",
      "resolved": "urn:visionflow:linked:brushless-dc-motors",
      "kind": "StubLink"
    },
    {
      "raw": "[[Control Signal]]",
    ...
    {
      "raw": "[[Dynamic Responsiveness]]",
      "resolved": "urn:visionflow:linked:dynamic-responsiveness",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Electroactive Polymers]]",
      "resolved": "urn:visionflow:linked:electroactive-polymers",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Energy-Constrained Robots]]",
      "resolved": "urn:visionflow:linked:energy-constrained-robots",
      "kind": "StubLink"
    },
    {
      "raw": "[[Force Exertion]]",
      "resolved": "urn:visionflow:linked:force-exertion",
      "kind": "StubLink"
    },
    {
      "raw": "[[Gearboxes]]",
      "resolved": "urn:visionflow:linked:gearboxes",
      "kind": "StubLink"
    },
    {
      "raw": "[[Linear Actuators]]",
      "resolved": "urn:visionflow:linked:linear-actuators",
      "kind": "StubLink"
    },
    {
      "raw": "[[Linear Servo]]",
      "resolved": "urn:visionflow:linked:linear-servo",
      "kind": "StubLink"
    },
    {
      "raw": "[[Load Support]]",
      "resolved": "urn:visionflow:linked:load-support",
      "kind": "StubLink"
    },
    {
      "raw": "[[Mechanical Coupling]]",
      "resolved": "urn:visionflow:linked:mechanical-coupling",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Motion Generation]]",
      "resolved": "urn:visionflow:linked:motion-generation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Motor Driver]]",
    ...
    {
      "raw": "[[Motor Winding]]",
      "resolved": "urn:visionflow:linked:motor-winding",
      "kind": "StubLink"
    },
    {
      "raw": "[[Output Transmission]]",
      "resolved": "urn:visionflow:linked:output-transmission",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Precise Control]]",
      "resolved": "urn:visionflow:linked:precise-control",
      "kind": "StubLink"
    },
    {
      "raw": "[[PWM]]",
      "resolved": "urn:visionflow:linked:pwm",
      "kind": "StubLink"
    },
    {
      "raw": "[[Servo Amplifiers]]",
      "resolved": "urn:visionflow:linked:servo-amplifiers",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Spring-Loaded Mechanisms]]",
      "resolved": "urn:visionflow:linked:spring-loaded-mechanisms",
      "kind": "StubLink"
    },
    {
      "raw": "[[Stepper Motors]]",
      "resolved": "urn:visionflow:linked:stepper-motors",
      "kind": "StubLink"
    },
    {
      "raw": "[[Thermal Dissipation]]",
      "resolved": "urn:visionflow:linked:thermal-dissipation",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Robot Actuator]]",
      "resolved": "urn:visionflow:owl:class:robot-actuator",
      "kind": "ResolvedLink"
    },
    {
      "raw": "[[Robotics]]",
