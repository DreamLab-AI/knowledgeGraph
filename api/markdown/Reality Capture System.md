schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#RealityCaptureSystem
legacy_uri:: urn:visionclaw:concept:spatial-computing:reality-capture-system
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-07e4722846bb"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#RealityCaptureSystem"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:reality-capture-system"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
