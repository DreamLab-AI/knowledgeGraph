...
```json-ld
{ "@context":"https://narrativegoldmine.com/ns/v1", "@id":"urn:visionflow:page:climate-risk-assessment", "@type":"Page", "title":"Climate Risk Assessment", "vc:slug":"climate-risk-assessment", "vc:public":true, "vc:schemaVersion":2, "vc:outboundWikilinks":[] }
```
...
```json-ld
{
  ...
  "subClassOf":[{"@id":"urn:ngm:class:climate-risk","label":"Climate Risk"}],
  "relations":{}
}
```
