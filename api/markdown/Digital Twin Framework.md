schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#DigitalTwinFramework
legacy_uri:: urn:visionclaw:concept:spatial-computing:digital-twin-framework
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-b4ab46340251"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#DigitalTwinFramework"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:digital-twin-framework"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
