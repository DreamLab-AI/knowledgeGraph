- ### OntologyBlock
  id:: digital-twin-framework-ontology
  collapsed:: true
	- ontology:: true
	- public-access:: true
	- term-id:: MV-9878
	...
	- status:: active
	- owl:class:: mv:DigitalTwinFramework
	- belongsToDomain:: [[metaverse]]
	- #### Relationships
	  id:: digital-twin-framework-relationships
	  collapsed:: true
		...
		- related-to:: [[RAMI 4.0]], [[IEEE Standards]], [[Industrial IoT]]
- ## Technical Details
	- **Architecture Layers**:
