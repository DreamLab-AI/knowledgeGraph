schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#CivilServiceJob
legacy_uri:: urn:visionclaw:concept:infrastructure:civil-service-job
public:: true
...
```json-ld
{
  ...
  "@id": "urn:visionflow:page:cf896ddeb92dd3246fa9a4122d6022bee354e3dcc382733cec02acf55d9c47d4",
  "@type": "Page",
  "vc:slug": "civil-service-job",
  "title": "civil service job",
  "vc:public": true,
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-31291e16884b"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#CivilServiceJob"
    },
    {
      "vc:key": "maturity",
      "vc:value": "draft"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:civil-service-job"
    },
    {
      "vc:key": "status",
      "vc:value": "stub"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:cf896ddeb92dd3246fa9a4122d6022bee354e3dcc382733cec02acf55d9c47d4@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:civil-service-job",
  "@type": "OntologyClass",
  ...
  "definition": "civil service job is a concept within the ngm domain.",
  "vc:qualityScore": {
    "@value": "0.50",
    "@type": "xsd:float"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:civil-service-job:776c802a9fc9",
...
- ### Content
  ...
  Home Applications View applicationJob descriptionBooked InterviewsSign out
  Table of Contents - Advert
  Advert
  ​
  Principal Technologist - OCTO  
  ...
  103924
  Salary details
  £76,420 - £103,924 (London) / £69,523 - £91,453 (National) Based on capability. The base salary of this grade is £71,370 for London and £67,126 for other locations. Offers made above this will be made up with a specialist pay allowance.
  - Grade
  Grade 6
  - Contract type
  Permanent
  ...
  - Working pattern
  Full-time, Part-time, Flexible working, Job share, Compressed Hours
  - Number of posts
  3
  - Location
  - City / Town
  ...
  In order to assist candidates with this role, we will be holding a virtual recruitment event on Friday 19th September at 9:30am - 10:30am to go through the role in more detail. To attend the virtual recruitment event please use the link below and use the following details to join:
  - Join the meeting now
  - Meeting ID: 362 486 792 924 7
  - Passcode: cA9Cz3vD
  ...
  Virtual recruitment event: Friday 19th September 2025 at 9:30am - 10:30am
  - Sift completion: Monday 29th September 2025
  - Panel interviews: starting Friday 17th October 2025
  ...
  Selection process details
  This vacancy is using Success Profiles (opens in a new window) and will assess the following areas: Experience.
  ...
  - Attachments
  Supporting linksHelp Terms and conditions Privacy Notice Cookies Careers
  Built by Cabinet Office
  Open Government Licence
  All content is available under the Open Government Licence v3.0, except where otherwise stated
  - © Crown copyright
  - Menu
  - HomeGovernmentSuccess Profiles
  Cabinet Office
  Guidance
  ...
  - Experience
  Experience is the knowledge or mastery of an activity or subject by involvement in or exposure to it.
  - In the Civil Service experience is most often needed when we recruit to:
  - senior roles
  roles in the Civil Service Professions
  Why we assess experience
  When looking at your experience, we are looking for:
  previous examples of things you have achieved
  your knowledge in a particular field which is relevant to the job role
  How you performed in a particular field - not how long you served
  Sometimes experience from outside work can be transferable from a non-work context. Skills gained through voluntary work or a hobby can show the experience you may need for a role. For example, teamwork or communication.
  - How we assess experience
  We will look at your experience, career history and achievements, relevant to the job role.
  - Some of the assessment methods we may use to understand your experience include:
  - application form
  CV
  interview
  Consider using the STAR method which allows you to set the scene, show what and how you did and the overall outcome.
  - We may assess your experience along with other elements of the Success Profile. This is to get a more rounded picture of your suitability for the role.
  - The job advert will describe the elements you need for a role and the selection method(s) that we will use.
  - Reasonable adjustments
  ...
  Updated 29 January 2025
  - Contents
  Why we assess technical skills, knowledge and qualifications
  How we assess technical skills, knowledge and qualifications
  Reasonable adjustments
  Print this page
  The Civil Service recruits using Success Profiles. They help give us the best possible chance of finding the right person for the job. For each role we advertise, we consider what you will need to demonstrate to be successful.
  - Our Success Profiles are made of five elements:
  ...
  Strengths - the things we do regularly, do well and that motivate us
  Experience - the knowledge or mastery of an activity or subject gained through involvement in or exposure to it
  Not all elements are relevant to every role. The makeup of the Success Profile should be different for different types of job. This helps to improve the chances of getting the best person for the job.
  - Why we assess technical skills, knowledge and qualifications
  ...
  - The head of each Profession defines the specific skills, knowledge and qualifications we may ask you to demonstrate to be successful in these roles.
  - For example, a specialised role in Government Finance may need candidates to have:
  ...
  - The job advert will list any technical requirements you may need for the role. It will also explain which assessment methods we will use. Some of the assessment methods to assess your technical skills may include:
  - application form
  CV
  interview
  ...
  written analysis/exercise
  assessment centre
  If there is a need for a particular qualification or membership of a professional body, we may ask you to provide evidence of your qualification(s) or membership.
  - We may assess your technical/professional skills along with other elements of the Success Profile. This will help to get a more rounded picture of your suitability for the role.
  - Reasonable adjustments 
  The Civil Service is a diverse and inclusive workplace. We want to help you show your full potential whatever type of assessment we use.
  - Examples of adjustments can include:
  - providing documents in large print or braille
