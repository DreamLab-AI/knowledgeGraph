schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#ScaledDotProductAttention
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:scaled-dot-product-attention
public:: true
...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "scaled-dot-product-attention",
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-91834cc9d8ef"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#ScaledDotProductAttention"
    },
    {
    ...
    },
    {
      ...
      "vc:value": "Scaled Dot Product Attention"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:scaled-dot-product-attention"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
...
- ### Semantic Classification
  - owl-class:: artificial-intelligence:ScaledDotProductAttention
  - owl-role:: Concept
