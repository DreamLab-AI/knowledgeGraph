...
```json-ld
{
  ...
  "relations": {
    "partOf": [
      ...
      {"@id": "urn:ngm:class:london-hard-fork", "label": "London Hard Fork"}
    ],
    "hasPart": [
      {"@id": "urn:ngm:class:base-fee", "label": "Base Fee"},
      {"@id": "urn:ngm:class:priority-fee", "label": "Priority Fee"},
      {"@id": "urn:ngm:class:max-fee-per-gas", "label": "Max Fee Per Gas"}
    ],
    "requires": [
    ...
    "enables": [
      ...
      {"@id": "urn:ngm:class:fee-predictability", "label": "Fee Predictability"},
      {"@id": "urn:ngm:class:ether-burn", "label": "Ether Burn"}
    ],
    "dependsOn": [
      {"@id": "urn:ngm:class:gas-fee-market", "label": "Gas Fee Market"},
      {"@id": "urn:ngm:class:block-gas-limit", "label": "Block Gas Limit"}
    ],
    "implements": [
    ...
    "supports": [
      {"@id": "urn:ngm:class:ethereum-tokenomics", "label": "Ethereum Tokenomics"},
      {"@id": "urn:ngm:class:proof-of-stake", "label": "Proof of Stake"}
    ],
    "contrastsWith": [
      {"@id": "urn:ngm:class:first-price-auction", "label": "First-Price Auction"},
    ...
    "relatedTo": [
      ...
      {"@id": "urn:ngm:class:ethereum-2", "label": "Ethereum 2.0"},
  ...
  "sameAs": [
    {"@id": "urn:ngm:class:ethereum-fee-reform", "label": "Ethereum Fee Reform"},
    {"@id": "urn:ngm:class:type-2-transaction", "label": "Type 2 Transaction Format"}
  ],
  "quality": 0.74,
  "provenance": {
