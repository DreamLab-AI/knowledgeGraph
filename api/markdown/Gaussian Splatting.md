schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#GaussianSplatting
legacy_uri:: urn:visionclaw:concept:spatial-computing:gaussian-splatting
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "bridges-to",
      "vc:value": "[[Neural Radiance Field]], [[3D Gaussian Splatting]], [[Spatial Computing]], [[Computer Vision]], [[Real-Time Rendering]]"
    },
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-d12f5a5feedd"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#GaussianSplatting"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:gaussian-splatting"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:gaussian-splatting:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[ACM SIGGRAPH]]",
      "resolved": "urn:visionflow:linked:acm-siggraph",
      "kind": "StubLink"
    },
    {
      "raw": "[[Adam Optimiser]]",
    ...
    {
      "raw": "[[Adaptive Densification]]",
      "resolved": "urn:visionflow:linked:adaptive-densification",
      "kind": "StubLink"
    },
    {
      "raw": "[[AlgorithmLayer]]",
    ...
    {
      "raw": "[[Alpha Blending]]",
      "resolved": "urn:visionflow:linked:alpha-blending",
      "kind": "StubLink"
    },
    {
      "raw": "[[Alpha Compositing]]",
      "resolved": "urn:visionflow:linked:alpha-compositing",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Covariance Decomposition]]",
      "resolved": "urn:visionflow:linked:covariance-decomposition",
      "kind": "StubLink"
    },
    {
      "raw": "[[CUDA]]",
    ...
    {
      "raw": "[[Depth Sorting]]",
      "resolved": "urn:visionflow:linked:depth-sorting",
      "kind": "StubLink"
    },
    {
      "raw": "[[Differentiable Rasterizer]]",
      "resolved": "urn:visionflow:linked:differentiable-rasterizer",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[EWA Splatting]]",
      "resolved": "urn:visionflow:linked:ewa-splatting",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Gaussian Primitive]]",
      "resolved": "urn:visionflow:linked:gaussian-primitive",
      "kind": "StubLink"
    },
    {
      "raw": "[[GPU Compute]]",
    ...
    {
      "raw": "[[IEEE CVPR]]",
      "resolved": "urn:visionflow:linked:ieee-cvpr",
      "kind": "StubLink"
    },
    {
      "raw": "[[IEEE ICCV]]",
      "resolved": "urn:visionflow:linked:ieee-iccv",
      "kind": "StubLink"
    },
    {
      "raw": "[[Linear Algebra]]",
    ...
    {
      "raw": "[[Mesh-Based Rendering]]",
      "resolved": "urn:visionflow:linked:mesh-based-rendering",
      "kind": "StubLink"
    },
    {
      "raw": "[[Meta]]",
    ...
    {
      "raw": "[[Multi-View Photography]]",
      "resolved": "urn:visionflow:linked:multi-view-photography",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[SfM Point Cloud]]",
      "resolved": "urn:visionflow:linked:sf-m-point-cloud",
      "kind": "StubLink"
    },
    {
      "raw": "[[Spherical Harmonics]]",
      "resolved": "urn:visionflow:linked:spherical-harmonics",
      "kind": "StubLink"
    },
    {
      "raw": "[[SSIM Loss]]",
      "resolved": "urn:visionflow:linked:ssim-loss",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Tile-Based Renderer]]",
      "resolved": "urn:visionflow:linked:tile-based-renderer",
      "kind": "StubLink"
    },
    {
      "raw": "[[Tile Rasterisation]]",
      "resolved": "urn:visionflow:linked:tile-rasterisation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Voxel Grid Representation]]",
      "resolved": "urn:visionflow:linked:voxel-grid-representation",
      "kind": "StubLink"
    },
    {
...
- ### Definition
  - Novel view synthesis and 3D scene representation technique introduced by Kerbl, Kopanas, Leimkühler and Drettakis at SIGGRAPH 2023 (INRIA Sophia Antipolis), representing scenes as explicit collections of millions of anisotropic 3D Gaussian primitives — each defined by a 3D mean position μ ∈ ℝ³, a 3×3 covariance matrix Σ encoding ellipsoidal shape and orientation, a set of spherical harmonic coefficients for view-dependent colour (up to degree 3, 48 coefficients per Gaussian), and a learned opacity α ∈ [0,1] — which are rendered onto an image plane through differentiable rasterisation ("splatting": projecting each 3D Gaussian to a 2D Gaussian footprint, depth-sorting, and alpha-compositing front-to-back via GPU tile-based rasteriser), trained by gradient descent from 50–200 calibrated photographs initialised from a sparse Structure-from-Motion (SfM / COLMAP) point cloud using an adaptive densification strategy that splits under-reconstructed regions (gradient magnitude threshold) and prunes transparent or oversized Gaussians, achieving photorealistic quality (PSNR 30–35 dB on standard benchmarks: Tanks and Temples, Mip-NeRF 360, Deep Blending) at rendering speeds of 100–300 FPS at 1080p on a single RTX 4090 GPU — over 100× faster than vanilla Neural Radiance Fields whilst matching or exceeding reconstruction fidelity — with training completing in 20–40 minutes per scene versus 12–48 hours for NeRF, enabling real-time immersive deployment in augmented and virtual reality headsets, digital twin workflows, robotics scene mapping, and consumer smartphone capture applications (Luma AI, Polycam) across the full spatial-computing stack, with the official INRIA GitHub repository accumulating 14,000+ stars within twelve months of publication, making it the most-cited graphics paper of 2023 and catalysing over 400 follow-on publications within eighteen months including 4D Gaussian Splatting for dynamic scenes, GaussianAvatars for photorealistic head capture, SuGaR for mesh extraction, 2D Gaussian Splatting for surface-aligned representation, Gaussian Opacity Fields, compact 3DGS, and EAGLES entropy-aware compression, and directly informing production deployment at Apple Vision Pro content pipelines, Meta Quest 3 immersive experiences, Microsoft Mesh volumetric avatars, and industrial digital twin platforms operated by firms including Bentley Systems, Trimble, and Leica Geosystems.
...
- ### Provenance
  - sources:: Kerbl et al. SIGGRAPH 2023 (INRIA); Zwicker et al. IEEE VIS 2001, TVCG 2002 (EWA Splatting); Mildenhall et al. ECCV 2020 (NeRF); Müller et al. SIGGRAPH 2022 (Instant-NGP); Wu et al. CVPR 2024 (4D Gaussian); Qian et al. CVPR 2024 (GaussianAvatars); Guédon & Lepetit CVPR 2024 (SuGaR); Huang et al. SIGGRAPH 2024 (2D GS); Fan et al. NeurIPS 2024 (LightGaussian); Keetha et al. CVPR 2024 (SplaTAM); Girish et al. ICLR 2024 (EAGLES); Lu et al. CVPR 2024 (Scaffold-GS); Luma AI technical blog; Polycam product docs; Apple visionOS Developer Documentation; NVIDIA GTC 2025 announcements; Innovate UK Smart Grant summaries 2024; Open3DGS working group draft spec; Khronos glTF GSPLIT extension draft 2025
