```json-ld
{
  ...
  "@id": "urn:visionflow:page:rdf-xml",
  "@type": "Page",
  "title": "Rdf Xml",
  "vc:slug": "rdf-xml",
  "vc:public": true,
...
- ### Overview
- RDF/XML was the first standard concrete syntax for the Resource Description Framework, defined so that the abstract graph of subject-predicate-object triples [private] be written down, stored, and exchanged. By mapping RDF onto XML, it allowed early semantic-web systems to reuse the mature ecosystem of XML parsers and validators.
