schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#UserInterfaceArchitecture
legacy_uri:: urn:visionclaw:concept:spatial-computing:user-interface-architecture
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-ceb2265e8a52"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#UserInterfaceArchitecture"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:user-interface-architecture"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:acf6bc89960ff4cf9cc7f2200648f23089ba4db404511200c7093081166706b8@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
