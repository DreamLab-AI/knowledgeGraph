...
```json-ld
{ "@context":"https://narrativegoldmine.com/ns/v1", "@id":"urn:visionflow:page:hazop", "@type":"Page", "title":"HAZOP", "vc:slug":"hazop", "vc:public":true, "vc:schemaVersion":2, "vc:outboundWikilinks":[] }
```
...
```json-ld
{
  ...
  "subClassOf":[{"@id":"urn:ngm:class:hazard-analysis","label":"Hazard Analysis"}],
  "relations":{
    "partOf":[{"@id":"urn:ngm:class:hazard-analysis","label":"Hazard Analysis"}]
  },
  "sameAs":[],
  "quality":0.6,
