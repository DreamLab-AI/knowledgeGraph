...
(Declaration (Class :ModelDepth))

;; Annotations
(AnnotationAssertion rdfs:label :ModelDepth "Model Depth"@en)
(AnnotationAssertion rdfs:comment :ModelDepth "The number of transformer layers (encoder and/or decoder) stacked in a model, determining the number of sequential transformations applied to representations."@en)

;; Data Properties
(AnnotationAssertion dcterms:identifier :ModelDepth "AI-0243"^^xsd:string)
(DataPropertyAssertion :isAITechnology :ModelDepth "true"^^xsd:boolean)
```
