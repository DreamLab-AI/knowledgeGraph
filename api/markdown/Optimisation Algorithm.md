```json-ld
{
  ...
  "@id": "urn:visionflow:page:optimisation-algorithm",
  "@type": "Page",
  "title": "Optimisation Algorithm",
  "vc:slug": "optimisation-algorithm",
  "vc:public": true,
  "vc:schemaVersion": 2,
...
```json-ld
{
  ...
  "sameAs": [
    {
      "@id": "urn:ngm:class:numerical-optimiser",
      "label": "Numerical Optimiser"
    },
    {
      "@id": "urn:ngm:class:training-algorithm",
