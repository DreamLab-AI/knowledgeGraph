schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#ETLPipeline
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:etl-pipeline
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-c8422b3ee949"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#ETLPipeline"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:etl-pipeline"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:6a77b42244c30a8246b76f67625531df6f518b71856ab2a1165edf2aa57135a1@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:etl-pipeline",
  "@type": "OntologyClass",
  "label": "ETL Pipeline",
  "subClassOf": [
    {
