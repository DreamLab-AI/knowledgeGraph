schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#ETSIDomainAIHumanInterface
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:etsi-domain-ai-human-interface
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-df8e03f8cc44"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#ETSIDomainAIHumanInterface"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:etsi-domain-ai-human-interface"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
...
- ### Content
  ETSI Domain AI + Human Interface — content pending enrichment.
