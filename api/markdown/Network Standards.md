schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#NetworkStandards
legacy_uri:: urn:visionclaw:concept:spatial-computing:network-standards
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-323a697a20a3"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#NetworkStandards"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:network-standards"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
