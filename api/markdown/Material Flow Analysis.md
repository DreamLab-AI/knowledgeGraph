...
- ### Content
  - MFA constructs balanced flow networks that expose where materials are lost, dissipated, or [private] be cycled back as feedstock. Results inform policy targets, eco-design, and the identification of by-product exchange opportunities between co-located industries.
