schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#CarbonNeutralityPlanning
legacy_uri:: urn:visionclaw:concept:spatial-computing:carbon-neutrality-planning
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-d1dbc2d5ab06"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#CarbonNeutralityPlanning"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:carbon-neutrality-planning"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
