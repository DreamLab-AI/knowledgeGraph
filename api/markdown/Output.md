schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#Output
legacy_uri:: urn:visionclaw:concept:blockchain:output
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-be95976c45e0"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#Output"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:output"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:b0661aa1ca7a812bbae34928750c041be9ec9865f7b74af95c61ecf77ca0e284@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:output",
  "@type": "OntologyClass",
  "label": "Output",
  "subClassOf": [
    {
