schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#CompatibilityProcess
legacy_uri:: urn:visionclaw:concept:spatial-computing:compatibility-process
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-8a700e3df08a"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#CompatibilityProcess"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:compatibility-process"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
