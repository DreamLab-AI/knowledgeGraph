schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#SemanticSearch
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:semantic-search
public:: true
  ...
  "vc:legacyProperties": [
    {
      ...
      "vc:value": "Neural Information Retrieval, Dense Retrieval, Vector Search, Meaning-Based Search, Semantic Information Retrieval, Neural IR"
    },
    {
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-d0fb657d5329"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#SemanticSearch"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:semantic-search"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
- ### Semantic Classification
  - owl-class:: artificial-intelligence:SemanticSearch
  - owl-role:: RetrievalParadigm
  - owl-inferred:: ai:InformationRetrieval, ai:NeuralInformationRetrieval, ai:VectorSearch, ai:KnowledgeRetrieval
...
- ### Relationships
  - is-subclass-of:: [[Information Retrieval]], [[Natural Language Processing]], [[Neural Information Retrieval]], [[Knowledge Retrieval]], [[Search Technology]]
  - has-part:: [[Embedding Model]], [[Vector Index]], [[Query Encoder]], [[Document Encoder]], [[Reranker]], [[Approximate Nearest Neighbour]], [[Inverted Index]], [[Hybrid Retrieval]]
  - requires:: [[Text Embeddings]], [[Vector Database]], [[Language Model]], [[Evaluation Benchmark]], [[Query Understanding]]
  - enables:: [[Retrieval-Augmented Generation]], [[Question Answering]], [[Document Retrieval]], [[Knowledge Graph Query]], [[Conversational Search]], [[Enterprise Search]]
  - implements:: [[Dense Retrieval]], [[Bi-Encoder Architecture]], [[Cross-Encoder Reranking]], [[ColBERT Late Interaction]], [[BM25]], [[Reciprocal Rank Fusion]], [[HNSW Index]]
  - depends-on:: [[Transformer Architecture]], [[BERT]], [[Contrastive Learning]], [[Sentence Embeddings]], [[Approximate Nearest Neighbour]]
  - supports:: [[Retrieval-Augmented Generation]], [[Question Answering]], [[Enterprise Search]], [[E-Commerce Search]], [[Biomedical Information Retrieval]], [[Legal Document Retrieval]]
  - uses:: [[Cosine Similarity]], [[Inner Product]], [[Faiss]], [[Pinecone]], [[Weaviate]], [[Qdrant]], [[pgvector]], [[Chroma]]
  - contrasts-with:: [[Keyword Search]], [[BM25]], [[TF-IDF Retrieval]], [[Boolean Retrieval]], [[Inverted Index Search]]
  - related-to:: [[Knowledge Graphs]], [[Question Answering]], [[Large Language Models]], [[Multimodal AI]], [[Knowledge Base]], [[Ontology]]
  - standardized-by:: [[TREC]], [[BEIR Benchmark]], [[MTEB Benchmark]], [[MS MARCO]], [[NIST IR Evaluation]]
...
- ### Content
  ...
  ## Compositional Relationships (Components)
	  ...
	  FunctionalDataProperty(ai:embeddingDimension)
	  FunctionalDataProperty(ai:SBERTSTSBenchmark)
	  FunctionalDataProperty(ai:VectorDBMarket2025)
	  ```
  ...
  - ### Benchmark Leadership (MTEB Retrieval English, 2026)
	  ...
	  | Model | MTEB Retrieval nDCG@10 | Provider |
	  |---|---|---|
	  | NV-Embed-v2 | 69.3 | Nvidia |
	  | voyage-3-large | 68.3 | Voyage AI / Anthropic |
	  | E5-mistral-7b-instruct | 66.6 | Microsoft |
	  | text-embedding-3-large | 64.6 | OpenAI |
	  | BGE-M3 | 62.8 | BAAI |
	  | jina-embeddings-v3 | 61.4 | Jina AI |
	  | GTE-large-en-v1.5 | 61.0 | Alibaba |
  ...
  - **Foundational IR Theory**:
    - Salton, G. & McGill, M.J. (1983). *Introduction to Modern Information Retrieval*. McGraw-Hill.
    - van Rijsbergen, C.J. (1979). *Information Retrieval* (2nd ed.). Butterworths. Open access: https://www.dcs.gla.ac.uk/Keith/Preface.html
    - Robertson, S. & Walker, S. (1994). Some simple effective approximations to the 2-Poisson model for probabilistic weighted retrieval (BM25). *TREC-3 Proceedings*. NIST.
    - Ponte, J. & Croft, W.B. (1998). A language modeling approach to information retrieval. *SIGIR 1998*.
    - Deerwester, S. et al. (1990). Indexing by Latent Semantic Analysis. *JASIS 41(6)*. https://doi.org/10.1002/(SICI)1097-4571(199009)41:6<391::AID-ASI1>3.0.CO;2-9

  - **Neural IR Foundations**:
    - Huang, P.-S. et al. (2013). Learning Deep Structured Semantic Models for Web Search using Clickthrough Data. *KDD 2013*. https://dl.acm.org/doi/10.1145/2505515.2505665
    ...
    - Karpukhin, V. et al. (2020). Dense Passage Retrieval for Open-Domain Question Answering. *ACL 2020*. https://arxiv.org/abs/2004.04906
  ...
  - **Benchmarks and Evaluation**:
    - Thakur, N. et al. (2021). BEIR: A Heterogeneous Benchmark for Zero-shot Evaluation of Information Retrieval Models. *NeurIPS Datasets & Benchmarks 2021*. https://arxiv.org/abs/2104.08663
    - Muennighoff, N. et al. (2022). MTEB: Massive Text Embedding Benchmark. *EACL 2023*. https://arxiv.org/abs/2210.07316
  ...
  - **Advanced Architectures**:
    ...
    - Xiong, L. et al. (2021). Approximate Nearest Neighbor Negative Contrastive Estimation for Dense Text Retrieval. *ICLR 2021*. https://arxiv.org/abs/2007.00808
    - Ma, X. et al. (2022). Pre-train a Discriminative Text Encoder for Dense Retrieval via Contrastive Learning (DRAGON). *ACL Findings 2022*. https://arxiv.org/abs/2212.07841
    - Su, H. et al. (2023). One Embedder, Any Task: Instruction-Finetuned Text Embeddings (INSTRUCTOR). *ACL 2023*. https://arxiv.org/abs/2212.09561
    - Wang, L. et al. (2022, 2024). Text Embeddings by Weakly-Supervised Contrastive Pre-training (E5). *arXiv:2212.03533*. https://arxiv.org/abs/2212.03533
    - Xiao, S. et al. (2024). BGE M3-Embedding: Multi-Lingual, Multi-Functionality, Multi-Granularity Text Embeddings. *arXiv:2402.03216*. https://arxiv.org/abs/2402.03216
    - Malkov, Y. & Yashunin, D. (2018). Efficient and robust approximate nearest neighbor search using HNSW. *IEEE TPAMI 2020*. https://arxiv.org/abs/1603.09320
    - Lee, J. et al. (2023). Rethinking the Role of Token Retrieval in Multi-Vector Retrieval (XTR). *NeurIPS 2023*. https://arxiv.org/abs/2304.01982

  - **LLM-Based and Advanced Embedding**:
    - Gao, L. et al. (2022). Precise Zero-Shot Dense Retrieval without Relevance Labels (HyDE). *ACL 2023*. https://arxiv.org/abs/2212.10496
    - Gao, L. et al. (2022). Tevatron: An Efficient and Flexible Toolkit for Dense Retrieval. *arXiv:2203.05765*.
    - Borgeaud, S. et al. (2022). Improving Language Models by Retrieving from Trillions of Tokens (RETRO). *ICML 2022*. https://arxiv.org/abs/2112.04426
    ...
    - Radford, A. et al. (2021). Learning Transferable Visual Models from Natural Language Supervision (CLIP). *ICML 2021*. https://arxiv.org/abs/2103.00020

  - **UK Contributions**:
    - Macdonald, C. & Ounis, I. (2021). PyTerrier: Declarative Experimentation in Python from BM25 to Dense Retrieval. *CIKM 2021*. https://arxiv.org/abs/2007.14271
    - van Rijsbergen, C.J. (1977). A theoretical basis for the use of co-occurrence data in information retrieval. *Journal of Documentation 33(2)*.

  - **Industry and Specification**:
    - Cohere Rerank 3 Technical Report (2024). https://cohere.com/blog/rerank-3
    - BEIR Benchmark GitHub Repository (2021–2026). https://github.com/beir-cellar/beir
    - MTEB Leaderboard (2022–2026). https://huggingface.co/spaces/mteb/leaderboard
    - MS MARCO Passage Ranking Leaderboard. https://microsoft.github.io/msmarco/
    - TREC Deep Learning Track (2019–2024). https://trec-deeplearning.github.io/
    - MarketsandMarkets Vector Database Report (2024). Vector Database Market $4.3B by 2028.
...
- ### Provenance
  - **Primary Academic Sources**:
    ...
    - Nogueira, R. & Cho, K. (2019). Passage Re-ranking with BERT. *arXiv:1901.04085*.
    - Borgeaud, S. et al. (2022). Improving Language Models by Retrieving from Trillions of Tokens (RETRO). *ICML 2022*. https://arxiv.org/abs/2112.04426
    - Xiong, L. et al. (2021). Approximate Nearest Neighbor Negative Contrastive Estimation for Dense Text Retrieval (ANCE). *ICLR 2021*. https://arxiv.org/abs/2007.00808
    - Ma, X. et al. (2022). Pre-train a Discriminative Text Encoder for Dense Retrieval via Contrastive Learning (DRAGON). *ACL Findings 2022*. https://arxiv.org/abs/2212.07841
    - Su, H. et al. (2023). One Embedder, Any Task: Instruction-Finetuned Text Embeddings (INSTRUCTOR). *ACL 2023*. https://arxiv.org/abs/2212.09561
    - Wang, L. et al. (2022, 2024). Text Embeddings by Weakly-Supervised Contrastive Pre-training (E5). *arXiv:2212.03533*. https://arxiv.org/abs/2212.03533
    - Xiao, S. et al. (2024). BGE M3-Embedding: Multi-Lingual, Multi-Functionality, Multi-Granularity Text Embeddings. *arXiv:2402.03216*. https://arxiv.org/abs/2402.03216
    ...
    - Deerwester, S. et al. (1990). Indexing by Latent Semantic Analysis. *JASIS 41(6)*. https://doi.org/10.1002/(SICI)1097-4571(199009)41:6<391::AID-ASI1>3.0.CO;2-9
    - Huang, P.-S. et al. (2013). Learning Deep Structured Semantic Models for Web Search using Clickthrough Data. *KDD 2013*.
  - **Industry Sources**:
    - Cohere Rerank 3 Technical Report (2024). https://cohere.com/blog/rerank-3
    - BEIR Benchmark GitHub Repository (2021–2026). https://github.com/beir-cellar/beir
    - MTEB Leaderboard (2022–2026). https://huggingface.co/spaces/mteb/leaderboard
    - MS MARCO Passage Ranking Leaderboard. https://microsoft.github.io/msmarco/
    - TREC Deep Learning Track (2019–2024). https://trec-deeplearning.github.io/
    - MarketsandMarkets Vector Database Market Report (2024). $1.5B (2025) → $4.3B (2028) projection.
    - Microsoft Azure AI Search Hybrid Documentation (2024). https://learn.microsoft.com/azure/search/vector-search-overview
    - OpenAI text-embedding-3 Model Card (2024). https://platform.openai.com/docs/guides/embeddings
  - **Migration Notes**:
    - Source stub (36 lines): stub-level content with single is-subclass-of relationship and placeholder content.
    - Enrichment 2026-05-17: full Phase 6 production-ready rewrite; legacy-term-id corrected from MV-1004 (wrong domain prefix) to AI-1042 (artificial-intelligence domain); domain itself was already artificial-intelligence (no domain correction); authority-score raised from 0.00 to 0.87; status/maturity raised to production-ready.
