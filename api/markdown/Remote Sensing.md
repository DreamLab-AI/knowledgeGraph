...
```json-ld
{
  ...
  "relations": {
    "hasPart": [
      ...
      {
        "@id": "urn:ngm:class:hyperspectral-imaging",
      ...
      },
      {
        ...
        "label": "Thermal Infrared Sensing"
      }
    ],
    "partOf": [
      {
        "@id": "urn:ngm:class:earth-observation",
...
- ### Content
  ...
  - Remote sensing instruments span several modalities. Multispectral and hyperspectral sensors measure reflectance in tens to hundreds of discrete wavelength bands, enabling vegetation [private] (NDVI), mineral mapping, and water quality assessment. Synthetic Aperture Radar (SAR) penetrates clouds and operates day or night, making it essential for flood mapping and deforestation monitoring. LiDAR emits laser pulses and measures return times to produce dense three-dimensional point clouds of terrain, buildings, and vegetation canopy structure. Thermal infrared sensors detect land surface temperature, supporting urban heat island analysis and wildfire detection.
