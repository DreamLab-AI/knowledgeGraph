...
(Declaration (Class :AiIncident))

;; Annotations
(AnnotationAssertion rdfs:label :AiIncident "AI Incident"@en)
(AnnotationAssertion rdfs:comment :AiIncident "An event involving an AI system that causes or has the potential to cause harm to individuals, property, environment, or fundamental rights, including malfunctions, security breaches, bias-driven discrimination, privacy violations, or unintended consequences requiring investigation and remediation."@en)

;; Data Properties
(AnnotationAssertion dcterms:identifier :AiIncident "AI-0082"^^xsd:string)
(DataPropertyAssertion :isAITechnology :AiIncident "true"^^xsd:boolean)
```
