schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#ReplicationSystem
legacy_uri:: urn:visionclaw:concept:infrastructure:replication-system
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-a10c9b1f42d1"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#ReplicationSystem"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:replication-system"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:60751b0b70dada97d41620130d34db9031b0dca47c56f85302d01310e70a8edd@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
```json-ld
{
  ...
  "definition": "Replication System is a technology infrastructure concept and a type of infrastructure.",
