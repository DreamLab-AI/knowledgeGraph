schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#QueryKeyValue
legacy_uri:: urn:visionclaw:concept:spatial-computing:query-key-value
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-8c1466af1b3f"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#QueryKeyValue"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:query-key-value"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:027ec19e8e512f1c3726310a948510e46aa1d6d753be25cf2460fe134d8e4616@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:query-key-value",
  "@type": "OntologyClass",
...
- ### Semantic Classification
  - owl-class:: spatial-computing:QueryKeyValue
  - owl-role:: Concept
