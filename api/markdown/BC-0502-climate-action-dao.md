- ### OntologyBlock
  ...
  collapsed:: true
	- ontology:: true
	- term-id:: BC-0502
	- preferred-term:: ClimateActionDAO
	- alternative-terms:: Climate DAO, Environmental DAO, Regenerative Finance DAO, ReFi DAO, Carbon DAO
	- source-domain:: bc
	...
	- source:: [[ReFi DAO]], [[KlimaDAO]], [[Gitcoin]], [[Regen Network]], [[Celo Climate Collective]]
	...
	- belongsToDomain:: [[BlockchainDomain]], [[EnvironmentalDomain]], [[DAOGovernance]], [[RegenerativeFinance]]
	...
	- implemented-by:: [[KlimaDAO]], [[Toucan Protocol]], [[Gitcoin]], [[Celo Climate Collective]], [[RegenerativeFinance Alliance]]
	- related-to:: [[CarbonOffset]], [[ImpactInvesting]], [[Quadratic Funding]], [[Regenerative Economics]], [[Web3 For Good]]
...
;; Annotations
(AnnotationAssertion rdfs:label :ClimateActionDAO "ClimateActionDAO"@en)
(AnnotationAssertion rdfs:comment :ClimateActionDAO "A decentralized autonomous organization governed by blockchain-based smart contracts and token-weighted voting that coordinates collective action toward climate change mitigation, adaptation, and environmental sustainability through transparent, democratic mechanisms for funding climate projects, purchasing and retiring carbon credits, managing regenerative finance portfolios, and distributing climate impact rewards."@en)

;; Data Properties
(AnnotationAssertion dcterms:identifier :ClimateActionDAO "BC-0502"^^xsd:string)

;; SubClass relationships
(SubClassOf :ClimateActionDAO :DecentralizedAutonomousOrganization)
(SubClassOf :ClimateActionDAO :ClimateFinance)
(SubClassOf :ClimateActionDAO :CollectiveGovernanceStructure)
(SubClassOf :ClimateActionDAO :ImpactInvestmentVehicle)

;; Object properties
(SubClassOf :ClimateActionDAO
  (ObjectSomeValuesFrom :hasPart :GovernanceToken))
(SubClassOf :ClimateActionDAO
  (ObjectSomeValuesFrom :hasPart :TreasuryManagement))
(SubClassOf :ClimateActionDAO
  (ObjectSomeValuesFrom :enables :CarbonCreditRetirement))
(SubClassOf :ClimateActionDAO
  (ObjectSomeValuesFrom :requires :SmartContracts))
(SubClassOf :ClimateActionDAO
  (ObjectSomeValuesFrom :implementedBy :KlimaDAO))
```

- ## About ClimateActionDAO
