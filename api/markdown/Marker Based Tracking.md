schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#MarkerBasedTracking
legacy_uri:: urn:visionclaw:concept:spatial-computing:marker-based-tracking
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-1a566a8436a9"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#MarkerBasedTracking"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:marker-based-tracking"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
