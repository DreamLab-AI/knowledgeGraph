...
- ### Content
  ...
  - ### Academic Context
	  ...
	  **Apostolaki et al. (2017)**: Showed that BGP routing attacks [private] isolate 47% of Bitcoin mining power by hijacking a single AS, motivating encrypted transport (BIP 324) and Tor integration.
