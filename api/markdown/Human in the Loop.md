schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#HumanInTheLoop
legacy_uri:: urn:visionclaw:concept:spatial-computing:human-in-the-loop
public:: true
...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:human-on-the-loop",
      "vc:label": "Human-on-the-Loop"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-f07195e2ddf8"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#HumanInTheLoop"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:human-in-the-loop"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
