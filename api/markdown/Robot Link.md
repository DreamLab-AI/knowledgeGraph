- ### OntologyBlock
  ...
  collapsed:: true
	- ontology:: true
	- term-id:: RB-0114
	- preferred-term:: RobotLink
	- alternative-terms:: Robot Segment, Manipulator Link, Kinematic Link, Rigid Link, Arm Segment, Mechanical Link, Robot Limb Segment, Link Element
	- source-domain:: rb
	...
	- source:: [[ISO 8373 Robotics Vocabulary]], [[Denavit & Hartenberg (1955) Kinematic Notation]], [[Craig, J.J. Introduction to Robotics (2005)]], [[Shabana, A.A. Dynamics of Multibody Systems (2013)]], [[ISO 9283 Manipulating Industrial Robots Performance Criteria]]

- #### Relationships
  id:: robot-link-relationships
	...
	- connects-to:: [[RevoluteJoint]], [[PrismaticJoint]], [[SphericalJoint]], [[UniversalJoint]], [[EndEffector]]
	- characterized-by:: [[DenavitHartenbergParameters]], [[LinkLength]], [[LinkTwist]], [[LinkOffset]], [[MassDistribution]], [[CenterOfMass]], [[InertiaTensor]]
	- used-in:: [[SerialManipulator]], [[ParallelManipulator]], [[ArticulatedArm]], [[DeltaRobot]], [[SCARARobot]], [[HumanoidRobot]], [[Exoskeleton]]
	...
	- measured-by:: [[StrainGauge]], [[Accelerometer]], [[Gyroscope]], [[TemperatureSensor]], [[DeflectionSensor]]

- #### OWL Formal Semantics
  id:: robot-link-owl-axioms
  collapsed:: true
	- ```clojure
	  ...
	  Ontology(<http://purl.org/robotics/ontology/RB-0114>
