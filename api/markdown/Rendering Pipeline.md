...
```json-ld
{
  ...
  "definition": "The Rendering Pipeline is the ordered computational sequence by which a GPU transforms three-dimensional scene representations — vertex buffers, [private] buffers, textures, uniform data, and acceleration structures — into a two-dimensional raster image suitable for display or further processing.",
...
- ### Content
  ...
  - ### Rendering Paradigm Comparison: [[Forward Rendering]], [[Deferred Rendering]], [[Clustered Shading]], [[Visibility Buffer Rendering]]
    ...
    - **[[Clustered Shading]] (Clustered Deferred / Clustered Forward+)**:
      ...
      - [[Fragment Shader]] lookup: screen-position + [[Depth Buffer]] value → cluster [private] → iterate only that cluster's light list. Average 8-32 lights/cluster for 1024+ scene lights → near-constant shading cost.
    ...
    - **[[Visibility Buffer Rendering]] (V-Buffer / Triangle ID Buffer)**:
      ...
      - Pass 2 [[Compute Shader]]: reads triangle ID → [private] buffer → [[Vertex Buffer]] attributes → reconstructs interpolated position/normal/UV → [[Texture Sampler]] fetch → [[Physically Based Rendering]] BRDF.
