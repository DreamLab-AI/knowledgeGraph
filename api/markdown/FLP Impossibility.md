...
```json-ld
{
  ...
  "sameAs": [
    {
      "@id": "urn:ngm:class:fischer-lynch-paterson-theorem",
      "label": "Fischer-Lynch-Paterson Theorem"
    },
    {
      "@id": "urn:ngm:class:consensus-impossibility",
      "label": "Consensus Impossibility"
    }
  ],
  "quality": 0.74,
  "provenance": {
