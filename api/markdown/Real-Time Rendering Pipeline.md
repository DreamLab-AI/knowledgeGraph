schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#RealTimeRenderingPipeline
legacy_uri:: urn:visionclaw:concept:spatial-computing:real-time-rendering-pipeline
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-3452727e25e8"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#RealTimeRenderingPipeline"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:real-time-rendering-pipeline"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
