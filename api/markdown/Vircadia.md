schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#Vircadia
legacy_uri:: urn:visionclaw:concept:spatial-computing:vircadia
public:: true
...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:scripting-engine",
      "vc:label": "Scripting Engine"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-1504c2889710"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#Vircadia"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:vircadia"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:vircadia:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[Assignment Client]]",
      "resolved": "urn:visionflow:linked:assignment-client",
      "kind": "StubLink"
    },
    {
      "raw": "[[Assignment Client Architecture]]",
      "resolved": "urn:visionflow:linked:assignment-client-architecture",
      "kind": "StubLink"
    },
    {
      "raw": "[[Audio Mixer]]",
      "resolved": "urn:visionflow:linked:audio-mixer",
      "kind": "StubLink"
    },
    {
      "raw": "[[Avatar Customisation]]",
      "resolved": "urn:visionflow:linked:avatar-customisation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Avatar Physics]]",
      "resolved": "urn:visionflow:linked:avatar-physics",
      "kind": "StubLink"
    },
    {
      "raw": "[[Bullet Physics]]",
    ...
    {
      "raw": "[[Cloud Hosting]]",
      "resolved": "urn:visionflow:linked:cloud-hosting",
      "kind": "StubLink"
    },
    {
      "raw": "[[Desktop Clients]]",
      "resolved": "urn:visionflow:linked:desktop-clients",
      "kind": "StubLink"
    },
    {
      "raw": "[[Domain Access Control]]",
      "resolved": "urn:visionflow:linked:domain-access-control",
      "kind": "StubLink"
    },
    {
      "raw": "[[Domain Federation]]",
      "resolved": "urn:visionflow:linked:domain-federation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Domain Server]]",
      "resolved": "urn:visionflow:linked:domain-server",
      "kind": "StubLink"
    },
    {
      "raw": "[[Entity Server]]",
      "resolved": "urn:visionflow:linked:entity-server",
      "kind": "StubLink"
    },
    {
      "raw": "[[Federated Virtual Worlds]]",
      "resolved": "urn:visionflow:linked:federated-virtual-worlds",
      "kind": "StubLink"
    },
    {
      "raw": "[[Frustum Culling]]",
    ...
    {
      "raw": "[[glTF Format]]",
      "resolved": "urn:visionflow:linked:gl-tf-format",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[JavaScript Scripting]]",
      "resolved": "urn:visionflow:linked:java-script-scripting",
      "kind": "StubLink"
    },
    {
      "raw": "[[JavaScript Scripting Engine]]",
      "resolved": "urn:visionflow:linked:java-script-scripting-engine",
      "kind": "StubLink"
    },
    {
      "raw": "[[Khronos Group]]",
    ...
    {
      "raw": "[[Octree Spatial Index]]",
      "resolved": "urn:visionflow:linked:octree-spatial-index",
      "kind": "StubLink"
    },
    {
      "raw": "[[OpenGL]]",
    ...
    {
      "raw": "[[Open Metaverse Interoperability]]",
      "resolved": "urn:visionflow:linked:open-metaverse-interoperability",
      "kind": "StubLink"
    },
    {
      "raw": "[[Open Metaverse Interoperability Group]]",
      "resolved": "urn:visionflow:linked:open-metaverse-interoperability-group",
      "kind": "StubLink"
    },
    {
      "raw": "[[OpenSimulator]]",
      "resolved": "urn:visionflow:linked:open-simulator",
      "kind": "StubLink"
    },
    {
      "raw": "[[Open Source Infrastructure]]",
      "resolved": "urn:visionflow:linked:open-source-infrastructure",
      "kind": "StubLink"
    },
    {
      "raw": "[[Open Source Licensing]]",
      "resolved": "urn:visionflow:linked:open-source-licensing",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[OpenVR]]",
      "resolved": "urn:visionflow:linked:open-vr",
      "kind": "StubLink"
    },
    {
      "raw": "[[Overte]]",
      "resolved": "urn:visionflow:linked:overte",
      "kind": "StubLink"
    },
    {
      "raw": "[[Philip Rosedale]]",
      "resolved": "urn:visionflow:linked:philip-rosedale",
      "kind": "StubLink"
    },
    {
      "raw": "[[Qt Framework]]",
      "resolved": "urn:visionflow:linked:qt-framework",
      "kind": "StubLink"
    },
    {
      "raw": "[[Rec Room]]",
      "resolved": "urn:visionflow:linked:rec-room",
      "kind": "StubLink"
    },
    {
      "raw": "[[Scripting Engine]]",
      "resolved": "urn:visionflow:linked:scripting-engine",
      "kind": "StubLink"
    },
    {
      "raw": "[[Second Life]]",
      "resolved": "urn:visionflow:linked:second-life",
      "kind": "StubLink"
    },
    {
      "raw": "[[Self-Hosted Metaverse]]",
      "resolved": "urn:visionflow:linked:self-hosted-metaverse",
      "kind": "StubLink"
    },
    {
      "raw": "[[Three.js]]",
    ...
    {
      "raw": "[[UDP Networking]]",
      "resolved": "urn:visionflow:linked:udp-networking",
      "kind": "StubLink"
    },
    {
      "raw": "[[V8 JavaScript Engine]]",
      "resolved": "urn:visionflow:linked:v8-java-script-engine",
      "kind": "StubLink"
    },
    {
      "raw": "[[Virtual Events]]",
      "resolved": "urn:visionflow:linked:virtual-events",
      "kind": "StubLink"
    },
    {
      "raw": "[[VR Client]]",
      "resolved": "urn:visionflow:linked:vr-client",
      "kind": "StubLink"
    },
    {
      "raw": "[[VR Hardware]]",
      "resolved": "urn:visionflow:linked:vr-hardware",
      "kind": "StubLink"
    },
    {
      "raw": "[[VR Headsets]]",
    ...
    {
      "raw": "[[WebXR Device API]]",
      "resolved": "urn:visionflow:linked:web-xr-device-api",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Distributed Identity|W3C DIDs]]",
    ...
    {
      "raw": "[[Positional Audio]]",
      "resolved": "urn:visionflow:owl:class:positional-audio",
      "kind": "ResolvedLink"
    },
    {
      "raw": "[[Social Presence]]",
...
- ### Definition
  - Vircadia is an open-source, community-governed, self-hostable [[Metaverse]] platform forked from [[High Fidelity]]'s codebase in 2020 under the Apache 2.0 licence, providing a federated architecture for persistent, spatially-aware virtual worlds with support for desktop and [[VR Headsets]] clients, positional voice audio, [[Avatar Physics]], domain-level [[Domain Access Control]], and a JavaScript-based [[Scripting Engine]] that enables collaborative experiences spanning [[Social Presence]], [[Virtual Events]], education, and immersive simulation without dependency on centralised commercial infrastructure. Vircadia inherits the technical lineage of [[Philip Rosedale]]'s [[High Fidelity]] Inc., which between 2013 and 2019 built one of the most technically ambitious real-time 3D networking stacks outside commercial gaming engines—featuring distributed simulation across multiple "assignment clients" for audio mixing, entity hosting, avatar collision, and scene management—before pivoting away from the general consumer [[Metaverse]] market toward enterprise [[Spatial Audio]] and eventually ceasing public platform operations in 2023. The fork was initiated by Brad Davis and community contributors when [[High Fidelity]]'s open-source codebase became effectively unmaintained; the project renamed itself from "Project Athena" to Vircadia in 2021 to establish a distinct community identity. The platform's core technical innovations include spatially-encoded audio channels processed by a dedicated mixer [[Assignment Client]] achieving sub-100ms latency at typical inter-user distances, [[Avatar]] articulation with [[Inverse Kinematics]] supporting full-body tracking through HMDs and controllers, [[Entity Server]] architecture managing scene state through an octree spatial-index allowing efficient frustum-culled updates to connected clients, and [[Domain Server]] federation permitting independent operators to host virtual spaces that users can navigate between without central authority, analogous to DNS-resolved web browsing. Built on C++ with [[Qt Framework]] for cross-platform rendering and networking, Vircadia targets Windows, macOS, and Linux, and produces distributable desktop and [[VR Client]] binaries as well as server-side domain and assignment-client daemons deployable on commodity cloud infrastructure. The project occupies a specific position in the open [[Metaverse]] ecosystem: technically richer than browser-based alternatives such as [[Mozilla Hubs]] (which runs fully in WebGL without native VR performance parity) and more federable than community-governed virtual worlds like [[OpenSimulator]] (which lacks native HMD support and uses a different avatar/content pipeline), yet substantially smaller in active user base than commercial [[Social VR]] platforms including [[VRChat]] (30M+ registered accounts), Rec Room, or AltspaceVR (before its 2023 closure). By 2022 Vircadia's contributor activity had declined significantly as community momentum shifted toward [[Overte]]—a second fork of the same upstream [[High Fidelity]] codebase that emerged in late 2021 with an overlapping but distinct contributor base and governance model—creating a bifurcation that diluted both projects' development capacity. The Vircadia project reached a point of minimal activity by late 2023; the [[Overte]] fork continued receiving commits into 2024-2025, becoming the de facto living continuation of the [[High Fidelity]] technical lineage for open-source metaverse infrastructure. Notwithstanding its limited commercial adoption, Vircadia demonstrated the technical feasibility of fully open, self-hosted [[Spatial Computing]] infrastructure and contributed to emerging discourse around open metaverse standards, including the [[Open Metaverse Interoperability Group]] (OMI) standards work covering avatar format interchange, identity portability, and cross-world object metadata, areas now also addressed by the [[Metaverse Standards Forum]] (founded 2022, endorsed by Apple, Meta, Microsoft, Nvidia, and others) and the [[Universal Scene Description]] (USD) / OpenUSD ecosystem. The platform's legacy is therefore more architectural than commercial: it proved that the full stack of a metaverse platform—from [[Physics Simulation]] and [[Audio Mixer]] to [[Avatar]] rendering and [[Domain Server]] management—could be disaggregated, open-sourced, and self-hosted, an existence proof that informs current decentralised virtual-world design even as the specific Vircadia codebase has largely yielded to its [[Overte]] successor and to newer [[WebXR]]-native approaches.

- ### Semantic Classification
  - owl-class:: spatial-computing:Vircadia
  - owl-role:: OpenSourceMetaversePlatform
  - owl-inferred:: sc:VirtualWorldPlatform, sc:SocialVRPlatform, sc:FederatedSpatialInfrastructure
  - belongs-to-domain:: [[Spatial Computing]], [[Open Source Software]], [[Distributed Systems]], [[Virtual Reality]]
  - implemented-in-layer:: [[Application Layer]], [[Infrastructure Layer]], [[Network Layer]]

- ### Relationships
  - is-subclass-of:: [[Metaverse]], [[Virtual World]], [[Social VR]], [[Spatial Computing]], [[Open Source Software]], [[Distributed Systems]]
  - has-part:: [[Domain Server]], [[Assignment Client]], [[Avatar System]], [[Entity Server]], [[Audio Mixer]], [[JavaScript Scripting Engine]], [[VR Client]], [[Octree Spatial Index]], [[Physics Simulation]], [[Domain Access Control]]
  - requires:: [[C++ Runtime]], [[Qt Framework]], [[WebRTC]], [[UDP Networking]], [[Positional Audio]], [[3D Rendering Engine]], [[VR Hardware]], [[Open Source Infrastructure]]
  - enables:: [[Federated Virtual Worlds]], [[Self-Hosted Metaverse]], [[Social Presence]], [[Virtual Events]], [[Immersive Education]], [[Open Metaverse Interoperability]], [[Digital Twin]], [[Avatar Portability]]
  - implements:: [[Apache 2.0 Licence]], [[Octree Spatial Index]], [[Inverse Kinematics]], [[Avatar Physics]], [[Domain Federation]], [[Assignment Client Architecture]], [[Spatial Audio]], [[Frustum Culling]]
  - depends-on:: [[High Fidelity]], [[Community Governance]], [[Cloud Hosting]], [[VR Hardware]], [[Open Source Licensing]], [[Bullet Physics]]
  - supports:: [[VR Headsets]], [[Desktop Clients]], [[JavaScript Scripting]], [[Spatial Audio]], [[Avatar Customisation]], [[Domain Access Control]], [[Full-Body Tracking]], [[OpenVR]]
  - uses:: [[OpenGL]], [[Bullet Physics]], [[OpenVR]], [[WebRTC]], [[glTF Format]], [[Qt Framework]], [[V8 JavaScript Engine]]
  - contrasts-with:: [[VRChat]], [[Mozilla Hubs]], [[AltspaceVR]], [[Rec Room]], [[Second Life]], [[Overte]], [[OpenSimulator]], [[NVIDIA Omniverse]]
  - related-to:: [[Open Metaverse Interoperability Group]], [[Metaverse Standards Forum]], [[Universal Scene Description]], [[Philip Rosedale]], [[High Fidelity]], [[WebXR]], [[Metaverse]], [[Social VR]], [[Mixed Reality]]
  - standardized-by:: [[Open Metaverse Interoperability Group]], [[Metaverse Standards Forum]], [[Khronos Group]], [[glTF Specification]], [[WebXR Device API]]

- ### Content

  - ## Compositional Relationships (Components)
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:hasPart sc:DomainServer))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:hasPart sc:AssignmentClient))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:hasPart sc:AvatarSystem))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:hasPart sc:EntityServer))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:hasPart sc:AudioMixer))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:hasPart sc:JavaScriptScriptingEngine))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:hasPart sc:VRClient))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:hasPart sc:OctreeSpatialIndex))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:hasPart sc:PhysicsSimulation))

	    ## Dependency Relationships
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:requires sc:CppRuntime))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:requires sc:QtFramework))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:requires sc:WebRTC))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:requires sc:UDPNetworking))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:requires sc:PositionalAudio))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:requires sc:VRHardware))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:dependsOn sc:HighFidelityCodebase))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:dependsOn sc:OpenSourceInfrastructure))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:dependsOn sc:CommunityGovernance))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:dependsOn sc:BulletPhysics))

	    ## Capability Relationships
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:enables sc:FederatedVirtualWorlds))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:enables sc:SelfHostedMetaverse))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:enables sc:SocialPresence))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:enables sc:VirtualEvents))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:enables sc:ImmersiveEducation))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:enables sc:OpenMetaverseInteroperability))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:enables sc:AvatarPortability))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:supports sc:VRHeadsets))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:supports sc:SpatialAudio))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:supports sc:AvatarCustomisation))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:supports sc:DomainAccessControl))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:supports sc:FullBodyTracking))

	    ## Implementation Relationships
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:implements sc:ApacheLicence))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:implements sc:OctreeSpatialIndex))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:implements sc:InverseKinematics))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:implements sc:AvatarPhysics))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:implements sc:DomainFederation))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:implements sc:AssignmentClientArchitecture))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:implements sc:FrustumCulling))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:uses sc:BulletPhysics))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:uses sc:glTFFormat))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:uses sc:OpenVR))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:uses sc:V8JavaScriptEngine))

	    ## Reduction Relationships
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:reduces sc:MetaversePlatformLockIn))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:reduces sc:CentralisedHostingDependency))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:reduces sc:CommercialVRBarriers))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:reduces sc:ProprietaryAvatarDependency))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:reduces sc:VirtualWorldAccessCost))

	    ## Association Relationships
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:relatedTo sc:OpenMetaverseInteroperability))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:relatedTo sc:MetaverseStandardsForum))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:relatedTo sc:WebXR))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:relatedTo sc:UniversalSceneDescription))
	    SubClassOf(sc:Vircadia
	      ObjectSomeValuesFrom(sc:relatedTo sc:Overte))

	    ## Data Properties (Characteristics)
	    DataPropertyAssertion(sc:hasIdentifier sc:Vircadia "SC-0042"^^xsd:string)
	    DataPropertyAssertion(sc:authorityScore sc:Vircadia "0.87"^^xsd:decimal)
	    DataPropertyAssertion(sc:licenceType sc:Vircadia "Apache-2.0"^^xsd:string)
	    DataPropertyAssertion(sc:forkYear sc:Vircadia "2020"^^xsd:integer)
	    DataPropertyAssertion(sc:primaryLanguage sc:Vircadia "C++"^^xsd:string)
	    DataPropertyAssertion(sc:upstreamProject sc:Vircadia "High Fidelity"^^xsd:string)
	    DataPropertyAssertion(sc:renameYear sc:Vircadia "2021"^^xsd:integer)
	    DataPropertyAssertion(sc:successorProject sc:Vircadia "Overte"^^xsd:string)

	    ## Property Constraints
	    SubClassOf(sc:Vircadia
	      DataAllValuesFrom(sc:isOpenSource xsd:boolean))
	    SubClassOf(sc:Vircadia
	      DataSomeValuesFrom(sc:domainFederationProtocol xsd:string))
	    SubClassOf(sc:Vircadia
	      DataMinCardinality(1 sc:hasAssignmentClientType xsd:string))

	    ## Annotations
	    AnnotationAssertion(rdfs:label sc:Vircadia "Vircadia"@en)
	    AnnotationAssertion(rdfs:comment sc:Vircadia "Open-source metaverse platform forked from High Fidelity in 2020 under Apache 2.0, providing federated self-hostable virtual worlds with spatial audio, avatar physics, VR support, and JavaScript scripting; community-maintained 2020-2023 then succeeded by the Overte fork."@en)
	    AnnotationAssertion(dcterms:identifier sc:Vircadia "SC-0042"^^xsd:string)
	    AnnotationAssertion(dcterms:subject sc:Vircadia "Spatial Computing, Virtual Reality, Open Source, Metaverse, Federated Systems, Social VR"@en)
	  )
	  ...
	  FunctionalDataProperty(sc:licenceType)
	  FunctionalDataProperty(sc:forkYear)
	  ```

  - ## About Vircadia
  - **Vircadia** is an open-source [[Metaverse]] platform that emerged from the voluntary community continuation of [[High Fidelity]]'s [[Spatial Computing]] research.
  ...
  - Vircadia and its successor [[Overte]] thus occupy the same ideological niche in [[Spatial Computing]] that Mastodon/ActivityPub occupies in social media: technically functional, substantially less polished than commercial alternatives, but representing a normative claim about decentralised governance and open standards.
  ...
  - Vircadia [[Domain Server]]s could theoretically support hundreds of concurrent users in a single domain space given sufficient [[Assignment Client]] compute resources, though real-world deployments were typically much smaller due to the small community size.
  ...
  - **[[Universal Scene Description]] (USD)**:
    ...
    - USD is actively used in film/VFX (Pixar, ILM, Weta), automotive design (BMW, Toyota use Omniverse+USD for digital twin workflows), and is the native format for [[NVIDIA Omniverse]] and the basis for Apple Vision Pro's RealityKit/USDZ spatial content pipeline
  ...
  - **Art and Creative Installations**:
    ...
    - The freely available content creation tools ([[Blender]] for mesh creation, [[glTF Format]] for export) lowered barriers to populating virtual gallery spaces without requiring expensive proprietary content creation workflows
  ...
  - **Broader market context**:
    ...
    - The 2024-2026 period has seen investment refocus from social [[Metaverse]] toward industrial/enterprise XR use cases where ROI is more defensible—a direction more aligned with [[NVIDIA Omniverse]] and enterprise [[Digital Twin]] platforms than with Vircadia's social VR heritage
    ...
    - Open [[Metaverse]] infrastructure in 2026 is best understood as a research/community resource and a technical archive of proven patterns for federated [[Spatial Computing]], rather than a commercially competitive landscape
  ...
  - ## UK Context
  - United Kingdom engagement with open [[Metaverse]] platforms and [[Spatial Computing]] research spans academic and industrial dimensions:
  ...
  - **[[Avatar]] Portability and Identity**:
    ...
    - Decentralised identity standards ([[Distributed Identity|W3C DIDs]], [[Verifiable Credentials]]) could enable avatar identity that is not tied to any single platform's authentication server, addressing the partial-centralisation problem in Vircadia's metaverse server architecture
  ...
  - **Industrial and Enterprise XR**:
    ...
    - This shifts the relevant comparison set from [[VRChat]]/Horizon Worlds to platforms like [[NVIDIA Omniverse]], Varjo Teleport, and enterprise-oriented XR frameworks
