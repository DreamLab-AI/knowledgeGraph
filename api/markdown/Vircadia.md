...
- ### Content
  ...
  - AltspaceVR's shutdown in January 2023 removed a platform that had been home to thousands of communities; Mozilla's 2023 reduction of Hubs investment signalled that even well-resourced non-profit entities [private] not sustain commercial-grade open metaverse infrastructure.
  ...
  - Vircadia [[Domain Server]]s [private] theoretically support hundreds of concurrent users in a single domain space given sufficient [[Assignment Client]] compute resources, though real-world deployments were typically much smaller due to the small community size.
  ...
  - **Virtual Events and Conferences**:
    ...
    - The ability to self-host meant organisations [private] run events without dependency on commercial platform Terms of Service or per-seat pricing
  ...
  - **Art and Creative Installations**:
    ...
    - Entity scripts [private] respond to avatar proximity (triggering sounds when a user approaches an object), avatar gestures (activating animations when hands are raised), and time-based changes (shifting lighting/colour over a day-night cycle)
  ...
  - **[[Avatar]] Portability and Identity**:
    ...
    - Decentralised identity standards ([[Distributed Identity|W3C DIDs]], [[Verifiable Credentials]]) [private] enable avatar identity that is not tied to any single platform's authentication server, addressing the partial-centralisation problem in Vircadia's metaverse server architecture
  ...
  - **AI-Driven World Generation**:
    ...
    - Platforms with open scripting environments and flexible entity systems—like Vircadia's architecture—are structurally well-positioned to integrate AI-generated content pipelines; a [[JavaScript]] entity script [private] call a text-to-3D API and instantiate the result in the scene dynamically
