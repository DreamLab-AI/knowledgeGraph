schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#CarbonAccounting
legacy_uri:: urn:visionclaw:concept:spatial-computing:carbon-accounting
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-670d36d0d4c7"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#CarbonAccounting"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:carbon-accounting"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
