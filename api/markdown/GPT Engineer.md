schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#GPTEngineer
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:gpt-engineer
public:: true
...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:agentic-aidomain",
      "vc:label": "AgenticAIDomain"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:tool-use-layer",
      "vc:label": "ToolUseLayer"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-759a8fbff835"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#GPTEngineer"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:gpt-engineer"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
- ### Semantic Classification
  - owl-class:: artificial-intelligence:GPTEngineer
  - owl-role:: AgenticSoftwareDevelopmentSystem
  - owl-inferred:: ai:CodeGenerationAgent, ai:AutonomousSoftwareEngineer, ai:LLMApplication, ai:ScaffoldingTool
  - belongs-to-domain:: [[AI-GroundedDomain]], [[SoftwareEngineeringDomain]], [[AgenticAIDomain]]
  - implemented-in-layer:: [[ApplicationLayer]], [[AgentLayer]], [[ToolUseLayer]]

- ### Relationships
  - is-subclass-of:: [[Agent Frameworks]], [[Agents]], [[Agentic Internet]], [[CLI Multi-Agent Systems]], [[AI Adoption]], [[Cognitive AI]]
  - has-part:: [[Prompt Engineering]], [[Code Generation]], [[Sandbox Execution]], [[Self-Repair Loop]], [[Specification Elicitation]], [[File Planning Agent]], [[Context Window]]
...
- ### Content
  ...
  - ### Competitive Positioning Against Adjacent Tools
	  ...
	  **Devin** (Cognition Labs, $175M Series-A 2024) occupies the autonomous-agent / expert-task quadrant: it operates a dedicated computer environment and handles entire engineering tasks — understanding requirements, writing code, writing tests, debugging failures, submitting pull requests — with minimal human supervision. The $500/month enterprise price point reflects the compute cost of extended autonomous operation with frontier models.

	  **GPT Engineer / Lovable.dev** occupies the non-engineer / greenfield quadrant: maximum speed to working demo, minimum required technical expertise, explicitly scaffold-quality output. The Lovable.dev commercial success demonstrates this quadrant has substantial willingness to pay at the $20–$100/month price tier.
  ...
  - ### Tool Ecosystem: Open-Source and Commercial Landscape
	  ...
	  **Lovable.dev (commercial)**:
	  - Pricing: Free tier (5 generations/month); Pro $20/month (150 generations); Teams $40/user/month (unlimited)
	  ...
	  **Cursor (Anysphere)**:
	  ...
	  - Pricing: Free (2000 completions); Pro $20/month; Business $40/user/month
  ...
  - Lovable AB (2024). "Lovable.dev Product Launch and Series-A Announcement." lovable.dev. $15M Series-A mid-2024; $100M+ ARR trajectory Q1 2026; 50,000+ paying users.
  ...
  - ## Metadata
  - lines-source:: 35 (original stub)
  - lines-target:: 600+
  - words-target:: 8500-12000
  - owl-axioms-count:: 40
  - wikilinks-count:: 68
  - references-count:: 27
  ...
  - legacy-term-id-assigned:: AI-3091
  - axiom-families:: Compositional (7), Dependency (8), Capability (10), Implementation (7), Reduction (8) — 40 total SubClassOf axioms
  - wikilink-types-covered:: is-subclass-of, has-part, requires, enables, implements, depends-on, supports, uses, contrasts-with, related-to, standardized-by (all 11 required types)
  - references-count:: 27
  - enrichment-phase:: 6
...
- ### Provenance
  - sources::
    ...
    - lovable.dev — commercial derivative; Lovable AB Sweden; Series-A $15M mid-2024; $100M+ ARR Q1 2026; 50,000+ paying users
