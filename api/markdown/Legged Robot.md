schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/robotics#LeggedRobot
legacy_uri:: urn:visionclaw:concept:robotics:legged-robot
public:: true
...
```json-ld
{
  ...
  "@id": "urn:visionflow:page:53c80e719520ac49967f815052fb42608c38a165f46f983e8f39193dfcc5648f",
  "@type": "Page",
  "vc:slug": "legged-robot",
  "title": "Legged Robot",
  "vc:public": true,
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-6daf31d8b418"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/robotics#LeggedRobot"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:robotics:legged-robot"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:53c80e719520ac49967f815052fb42608c38a165f46f983e8f39193dfcc5648f@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:legged-robot:776c802a9fc9",
...
- ### Content
  ...
  **Legged Robot** - Legged Robot in robotics systems
  ...
  ### Emerging Trends
		  ...
		  **License**: CC BY 4.0
		  **Namespace**: `https://metaverse-ontology.org/robotics/RB-0013`
