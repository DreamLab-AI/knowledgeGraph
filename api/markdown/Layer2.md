...
;; Annotations
(AnnotationAssertion rdfs:label :Layer2 "Layer2"@en)
(AnnotationAssertion rdfs:comment :Layer2 "Secondary protocols built on top of Layer 1 blockchains that process transactions off-chain or in parallel batches, then periodically commit state changes to the main chain, achieving higher throughput (10-10000x), lower fees (90-99.9% reduction), and improved user experience while inheriting base layer security guarantees."@en)

;; Data Properties
(AnnotationAssertion dcterms:identifier :Layer2 "BC-4001"^^xsd:string)
