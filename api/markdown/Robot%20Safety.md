...
# RB-0086: Robot Safety
		  ...
		  **Robot Safety** - Robot Safety in robotics systems
		  ...
		  ```clojure
		  (Declaration (Class :RobotSafety))
		  (SubClassOf :RobotSafety :Robot)
		  
		  (AnnotationAssertion rdfs:label :RobotSafety "Robot Safety"@en)
		  (AnnotationAssertion rdfs:comment :RobotSafety
		    "Robot Safety - Foundational robotics concept"@en)
		  (AnnotationAssertion :termID :RobotSafety "RB-0086"^^xsd:string)
		  
		  (Declaration (ObjectProperty :relates To))
		  (ObjectPropertyDomain :relatesTo :RobotSafety)
		  
		  (Declaration (DataProperty :hasProperty))
		  (DataPropertyDomain :hasProperty :RobotSafety)
