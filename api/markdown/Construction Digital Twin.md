schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#ConstructionDigitalTwin
legacy_uri:: urn:visionclaw:concept:spatial-computing:construction-digital-twin
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-f7132120dcd9"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#ConstructionDigitalTwin"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:construction-digital-twin"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
