...
- public-access:: true
	...
	- maturity:: draft
	- owl:class:: mv:COMPLETION_REPORT
...
(Declaration (Class :Completionreport))

;; Annotations
(AnnotationAssertion rdfs:label :Completionreport "COMPLETION_REPORT"@en)
(AnnotationAssertion rdfs:comment :Completionreport "A component of the metaverse ecosystem."@en)

;; Data Properties
(AnnotationAssertion dcterms:identifier :Completionreport "mv-1761742247902"^^xsd:string)
```

- ## About COMPLETION_REPORT
