...
```json-ld
{
  ...
  "relations": {
    ...
    "relatedTo": [
      ...
      {"@id": "urn:ngm:class:cryptopunks", "label": "CryptoPunks"},
      {"@id": "urn:ngm:class:decentralised-storage", "label": "Decentralised Storage"},
      {"@id": "urn:ngm:class:royalty-enforcement", "label": "Royalty Enforcement"},
      {"@id": "urn:ngm:class:eip-2981", "label": "EIP-2981"}
    ],
    "standardizedBy": [
  ...
  "sameAs": [
    {"@id": "urn:ngm:class:eip-721", "label": "EIP-721"}
  ],
  "quality": 0.72,
  "provenance": {
