schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#SparseMixtureOfExperts
legacy_uri:: urn:visionclaw:concept:spatial-computing:sparse-mixture-of-experts
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-c1541e83dce5"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#SparseMixtureOfExperts"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:sparse-mixture-of-experts"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
