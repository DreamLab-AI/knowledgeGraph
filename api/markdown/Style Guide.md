schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#StyleGuide
legacy_uri:: urn:visionclaw:concept:infrastructure:style-guide
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-c00f277fd240"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#StyleGuide"
    },
    {
      "vc:key": "maturity",
      "vc:value": "draft"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:style-guide"
    },
    {
      "vc:key": "status",
      "vc:value": "stub"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:ab69c9ecdf8e3bf571d0badcf4ffa2322fbea86f00dc5ec717f38588d1baf6af@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:style-guide",
  "@type": "OntologyClass",
  "label": "Style Guide",
  "subClassOf": [
    {
  ...
  "definition": "Style Guide is a concept within the ngm domain.",
  "vc:qualityScore": {
    "@value": "0.50",
    "@type": "xsd:float"
  },
