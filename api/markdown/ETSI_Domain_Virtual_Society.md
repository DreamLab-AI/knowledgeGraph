schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#ETSIDomainVirtualSociety
legacy_uri:: urn:visionclaw:concept:spatial-computing:etsidomainvirtualsociety
public:: true
...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "etsi-domain-virtual-society",
  "title": "ETSI_Domain_Virtual_Society",
  "vc:public": true,
  "vc:outboundWikilinks": [
    {
      "@id": "urn:visionflow:linked:3-d-assets",
      "vc:label": "3D assets"
    },
    {
      "@id": "urn:visionflow:linked:3-d-audio",
      "vc:label": "3D Audio"
    },
    {
      "@id": "urn:visionflow:linked:3-d-web-interoperability",
      "vc:label": "3D Web Interoperability"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:5-g-6-g",
      "vc:label": "5G/6G"
    },
    {
      "@id": "urn:visionflow:linked:advanced-audio-coding-aac",
      "vc:label": "advanced audio coding (AAC)"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:ai-enhanced-ar-vr",
      "vc:label": "AI-enhanced AR/VR"
    },
    {
      "@id": "urn:visionflow:linked:ar-vr-interfaces",
      "vc:label": "AR/VR interfaces"
    },
    {
      "@id": "urn:visionflow:linked:avatar-standards",
      "vc:label": "avatar standards"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:blockchain-based-solutions",
      "vc:label": "Blockchain-based solutions"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:cloud-streaming",
      "vc:label": "cloud streaming"
    },
    {
      "@id": "urn:visionflow:linked:cyber-resilience-act",
      "vc:label": "Cyber Resilience Act"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:digital-rights-management-drm",
      "vc:label": "digital rights management (DRM)"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:etsi-arf",
      "vc:label": "ETSI ARF"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:etsi-gr-arf-007-v1-1-1",
      "vc:label": "ETSI GR ARF 007 V1.1.1"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:etsi-gr-arf-010-v1-1-1",
      "vc:label": "ETSI GR ARF 010 V1.1.1"
    },
    {
      "@id": "urn:visionflow:linked:etsi-work-programme-2024-2025",
      "vc:label": "ETSI Work Programme 2024-2025"
    },
    {
      "@id": "urn:visionflow:linked:eu-digital-identity",
      "vc:label": "EU Digital Identity"
    },
    {
      "@id": "urn:visionflow:linked:eu-digital-identity-initiative",
      "vc:label": "EU Digital Identity Initiative"
    },
    {
      "@id": "urn:visionflow:linked:eu-standardisation-strategy",
      "vc:label": "EU Standardisation Strategy"
    },
    {
      "@id": "urn:visionflow:linked:european-digital-strategy",
      "vc:label": "European Digital Strategy"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:immersive-training-simulations",
      "vc:label": "immersive training simulations"
    },
    {
      "@id": "urn:visionflow:linked:interoperable-anchoring",
      "vc:label": "Interoperable Anchoring"
    },
    {
      "@id": "urn:visionflow:linked:ipsme",
      "vc:label": "IPSME"
    },
    {
      "@id": "urn:visionflow:linked:ipsme-inter-platform-semantic-messaging-environment",
      "vc:label": "IPSME (Inter-Platform Semantic Messaging Environment)"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:itu-t-focus-group-on-metaverse",
      "vc:label": "ITU-T Focus Group on Metaverse"
    },
    {
      "@id": "urn:visionflow:linked:itu-t-focus-group-on-metaverse-fg-mv",
      "vc:label": "ITU-T Focus Group on Metaverse (FG-MV)"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:medical-training-simulations",
      "vc:label": "medical training simulations"
    },
    {
      "@id": "urn:visionflow:linked:meta-horizon-worlds",
      "vc:label": "Meta Horizon Worlds"
    },
    {
      "@id": "urn:visionflow:linked:metaverse-events",
      "vc:label": "metaverse events"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:metaverse-standards-forum-msf",
      "vc:label": "Metaverse Standards Forum (MSF)"
    },
    {
      "@id": "urn:visionflow:linked:mpeg-h-3-d-audio",
      "vc:label": "MPEG-H 3D audio"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:open-metaverse-interoperability-group-omi",
      "vc:label": "Open Metaverse Interoperability Group (OMI)"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:privacy-preserving-identity-frameworks",
      "vc:label": "privacy-preserving identity frameworks"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:virtual-economies",
      "vc:label": "virtual economies"
    },
    {
      "@id": "urn:visionflow:linked:virtual-economies",
      "vc:label": "Virtual Economies"
    ...
    {
      "@id": "urn:visionflow:linked:virtual-worlds",
      "vc:label": "virtual worlds"
    },
    {
      "@id": "urn:visionflow:linked:virtual-worlds",
      "vc:label": "Virtual worlds"
    ...
    {
      "@id": "urn:visionflow:linked:web-4-0",
      "vc:label": "Web 4.0"
    },
    {
      "@id": "urn:visionflow:linked:world-graph",
      "vc:label": "world graph"
    },
    {
      "@id": "urn:visionflow:linked:world-graph",
      "vc:label": "World Graph"
    ...
    {
      "@id": "urn:visionflow:linked:xr-accessibility-guidelines",
      "vc:label": "XR accessibility guidelines"
    },
    {
      "@id": "urn:visionflow:linked:xr-extended-reality",
      "vc:label": "XR (Extended Reality)"
    },
    {
    ...
    },
    {
      ...
      "vc:label": "Collective Intelligence System"
    },
    {
    ...
    },
    {
      ...
      "vc:label": "Digital Twin of Society (DToS)"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-3e0d1e19b802"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#ETSIDomainVirtualSociety"
    },
    {
    ...
    },
    {
      ...
      "vc:value": "ETSI_Domain_Virtual_Society"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:etsidomainvirtualsociety"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:7f11ca5983d4911b202c0d3ad93fc393b84588692e6d44e7e7837fb8dcce4bed@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:etsi-domain-virtual-society",
  "@type": "OntologyClass",
...
- ### Provenance
  - sources:: [[ETSI GR ARF 007]], [[ETSI GR ARF 010]], [[ETSI ARF]], [[ITU-T Focus Group on Metaverse]], [[Metaverse Standards Forum]], [[OpenXR]], [[ISO/IEC]], [[Khronos Group]]
