schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#HumanComputerInteraction
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:human-computer-interaction
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-75849319eefe"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#HumanComputerInteraction"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:human-computer-interaction"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
