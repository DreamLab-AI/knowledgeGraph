schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#ETSIDomainDataManagementEthics
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:etsi-domain-data-management-ethics
public:: true
...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "etsi-domain-data-management-ethics",
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-a2682602f7c3"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#ETSIDomainDataManagementEthics"
    },
    {
    ...
    },
    {
      ...
      "vc:value": "ETSI Domain: Data Management + Ethics"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:etsi-domain-data-management-ethics"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:etsi-domain-data-management-ethics:776c802a9fc9",
  ...
  "vc:resolutions": [
    {
      "raw": "[[Anonymization]]",
      "resolved": "urn:visionflow:linked:anonymization",
      "kind": "StubLink"
    },
    {
      "raw": "[[Audit Logging]]",
    ...
    {
      "raw": "[[Privacy Regulations]]",
      "resolved": "urn:visionflow:linked:privacy-regulations",
      "kind": "StubLink"
    },
    {
      "raw": "[[User Control]]",
...
- ### Definition
  - Crossover domain for ETSI metaverse categorisation addressing ethical data handling, privacy-preserving storage, consent management, and responsible data governance.
...
- ### Content
  ETSI Domain: Data Management + Ethics — content pending enrichment.
