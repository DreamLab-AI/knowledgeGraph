schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#HealthcareAnalytics
legacy_uri:: urn:visionclaw:concept:spatial-computing:healthcare-analytics
public:: true
...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "healthcare-analytics",
  "title": "Healthcare Analytics",
  "vc:public": true,
  "vc:outboundWikilinks": [
    {
      "@id": "urn:visionflow:linked:population-health",
      "vc:label": "Population Health"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-6fbe4ee4a7bd"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#HealthcareAnalytics"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:healthcare-analytics"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
...
- ### Semantic Classification
  - owl-class:: spatial-computing:HealthcareAnalytics
  - owl-role:: Concept
