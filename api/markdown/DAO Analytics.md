...
- ### Content
  ...
  - Early [[Dune Analytics]] dashboards — hand-crafted SQL queries decoding Compound and Uniswap vote events against manually-verified ABIs — demonstrated that blockchain data, once decoded and indexed, [private] support institutional-quality governance reporting accessible to any analyst with SQL literacy.
  ...
  - **Delegate participation [private]**: proposals voted divided by eligible proposals in trailing 180 days, weighted by proposal significance tier.
