...
- ### Definition
  - AI Safety is the interdisciplinary field of research and engineering practice dedicated to ensuring that [[Artificial Intelligence]] systems behave reliably, predictably, and in alignment with human values and intentions across their full operational lifecycle. It encompasses both near-term engineering concerns — including [[Robustness]] against [[Distributional Shift]] and adversarial perturbation, output consistency, fairness, and transparency — and longer-horizon concerns about advanced [[AI System]] deployments whose learned objectives may diverge from human welfare in undetectable or irrecoverable ways. The field is founded on the insight that [[AI Alignment]] (ensuring systems pursue the goals humans actually intend) and controllability are necessary complements to capability development: a highly capable but misaligned system poses greater risk than a weaker, well-understood one. AI Safety draws on [[Formal Verification]], [[Interpretability]], [[Adversarial Machine Learning]], and [[AI Governance]] frameworks to produce principled safety guarantees across the spectrum of [[AI Model]] architectures and deployment contexts, from narrow classifiers in medical imaging to [[Large Language Model]] assistants handling sensitive decisions. Empirically, the field has demonstrated that safety and capability need not be in fundamental tension: well-aligned systems exhibit more consistent, predictable, and commercially valuable behaviour, whereas unsafe deployments carry reputational, regulatory, and liability risks that erode competitive advantage. Regulatory codification — through the [[EU AI Act]], [[NIST AI RMF]], [[ISO IEC 42001]], and the [[Bletchley Declaration]] — has elevated AI Safety from a niche research discipline into a mandatory component of responsible AI development and deployment practice, with [[Model Evaluation]] requirements now embedded in pre-deployment checklists at major AI laboratories and standards-based conformity assessments for high-risk AI applications.

- ### Semantic Classification
  - owl-class:: ai:AISafety
  - owl-role:: Concept | ResearchDiscipline | EngineeringPractice
  - owl-inferred:: ai:GovernanceMechanism, ai:RiskMitigationStrategy, ai:QualityAssuranceDomain
  - belongs-to-domain:: [[AI Governance and Ethics]]
  - implemented-in-layer:: [[AI System]]

- ### Relationships
  - is-subclass-of:: [[AI Governance and Ethics]]
  - partOf:: [[AI Governance]]
  - has-part:: [[AI Alignment]], [[Interpretability]], [[Formal Verification]], [[Red Teaming]], [[Scalable Oversight]], [[Corrigibility]], [[Mechanistic Interpretability]]
  - requires:: [[AI Alignment]], [[Interpretability]], [[Formal Verification]], [[Human Oversight]], [[Robustness]]
  - enables:: [[Responsible AI]], [[Trustworthy AI]], [[Human-AI Collaboration]], [[Model Evaluation]]
  - implements:: [[Constitutional AI]], [[Reinforcement Learning from Human Feedback]], [[Direct Preference Optimisation]]
  - depends-on:: [[AI System]], [[Deep Learning]], [[Value Alignment]]
  - supports:: [[Explainable AI]], [[AI Ethics]], [[Risk Management]], [[AI Regulation]]
  - uses:: [[Red Teaming]], [[Adversarial Machine Learning]], [[Reinforcement Learning from Human Feedback]], [[Sparse Autoencoder]]
  - contrasts-with:: [[AI Capabilities Research]], [[Mesa-Optimisation]], [[Reward Hacking]]
  - related-to:: [[Corrigibility]], [[Robustness]], [[AI Regulation]], [[Existential Risk]], [[Scalable Oversight]], [[Distributional Shift]], [[Cyber Security]], [[Large Language Model]], [[Smart Contract]], [[Autonomous Robot]], [[Apollo Research]], [[AI Security Institute]]
  - standardized-by:: [[EU AI Act]], [[NIST AI RMF]], [[ISO IEC 42001]], [[Bletchley Declaration]]
...
- ### Provenance
  - sources:: NIST AI RMF (2023); EU AI Act (2024); ISO/IEC 42001 (2023); Bletchley Declaration (2023); Anthropic Constitutional AI (arXiv:2212.08073); Amodei et al. Concrete Problems (arXiv:1606.06565); Hubinger et al. Mesa-Optimisation (arXiv:1906.01820); AISI Frontier AI Trends Report (December 2025); CETaS International AI Safety Report 2026; SAS AI Cities 2026 Index; Schlatter et al. Shutdown Resistance (arXiv:2509.14260)
