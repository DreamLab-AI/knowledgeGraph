...
```json-ld
{
  ...
  "sameAs": [
    {
      "@id": "urn:ngm:class:service-to-service-communication-layer",
      "label": "Service-to-Service Communication Layer"
    }
  ],
  "quality": 0.8,
  "provenance": {
