...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "ai-existential-risk-probability-estimate",
  "title": "AI Existential Risk Probability Estimate",
  "vc:public": true,
...
```json-ld
{
  ...
  "@id": "urn:ngm:class:ai-existential-risk-probability-estimate",
  "@type": "Class",
  "label": "AI Existential Risk Probability Estimate",
