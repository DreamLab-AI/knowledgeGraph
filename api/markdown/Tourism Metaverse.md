schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#TourismMetaverse
legacy_uri:: urn:visionclaw:concept:spatial-computing:tourism-metaverse
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-b9d6e5df9bdd"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#TourismMetaverse"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:tourism-metaverse"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
