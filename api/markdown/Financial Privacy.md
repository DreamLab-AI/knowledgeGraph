...
```json-ld
{
  ...
  "relations": {
    ...
    "uses": [
      ...
      {"@id": "urn:ngm:class:stealth-address", "label": "Stealth Address"},
    ...
    "contrastsWith": [
      ...
      {"@id": "urn:ngm:class:financial-surveillance", "label": "Financial Surveillance"}
    ],
    "requires": [
    ...
    "enables": [
      ...
      {"@id": "urn:ngm:class:fungibility", "label": "Fungibility"},
      {"@id": "urn:ngm:class:personal-autonomy", "label": "Personal Autonomy"}
    ],
    "bridgesTo": [
  ...
  "sameAs": [
    {"@id": "urn:ngm:class:financial-data-privacy", "label": "Financial Data Privacy"},
    {"@id": "urn:ngm:class:transactional-privacy", "label": "Transactional Privacy"}
  ],
  "quality": 0.8,
  "provenance": {
