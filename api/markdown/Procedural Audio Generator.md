schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#ProceduralAudioGenerator
legacy_uri:: urn:visionclaw:concept:spatial-computing:procedural-audio-generator
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-1363b093eb74"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#ProceduralAudioGenerator"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:procedural-audio-generator"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
