schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#UserAuthenticationMechanism
legacy_uri:: urn:visionclaw:concept:infrastructure:user-authentication-mechanism
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-865e97a6ec42"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#UserAuthenticationMechanism"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:user-authentication-mechanism"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:3ffe9801caf45ef56498eaea3dda848abf4483f8528e27ef927dffb3e9de281d@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:user-authentication-mechanism",
  "@type": "OntologyClass",
  ...
  "definition": "UserAuthenticationMechanism is a concept within the ngm domain.",
  "vc:qualityScore": {
    "@value": "0.35",
    "@type": "xsd:float"
  },
