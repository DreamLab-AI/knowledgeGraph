schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#DecentralizedFinanceDeFi
legacy_uri:: urn:visionclaw:concept:blockchain:decentralized-finance-defi
public:: true
...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "decentralized-finance-de-fi",
  ...
  "vc:outboundWikilinks": [
    ...
    },
    {
      ...
      "vc:label": "CryptographicProtocols"
    },
    {
      "@id": "urn:visionflow:linked:cryptographic-protocols",
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-7463db94f86b"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#DecentralizedFinanceDeFi"
    },
    {
    ...
    },
    {
      ...
      "vc:value": "Decentralized Finance (DeFi)"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:decentralized-finance-defi"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:decentralized-finance-de-fi:776c802a9fc9",
  ...
  "vc:resolutions": [
    {
      "raw": "[[Algorithmic Stablecoin]]",
      "resolved": "urn:visionflow:linked:algorithmic-stablecoin",
      "kind": "StubLink"
    },
    {
      "raw": "[[Atomic Composability]]",
      "resolved": "urn:visionflow:linked:atomic-composability",
      "kind": "StubLink"
    },
    {
      "raw": "[[CeFi]]",
      "resolved": "urn:visionflow:linked:ce-fi",
      "kind": "StubLink"
    },
    {
      "raw": "[[Central Bank]]",
    ...
    {
      "raw": "[[Collateral]]",
      "resolved": "urn:visionflow:linked:collateral",
      "kind": "StubLink"
    },
    {
      "raw": "[[Commercial Banking]]",
      "resolved": "urn:visionflow:linked:commercial-banking",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Cryptographic Oracle]]",
      "resolved": "urn:visionflow:linked:cryptographic-oracle",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Flash Loan Arbitrage]]",
      "resolved": "urn:visionflow:linked:flash-loan-arbitrage",
      "kind": "StubLink"
    },
    {
      "raw": "[[Flash Loans]]",
      "resolved": "urn:visionflow:linked:flash-loans",
      "kind": "StubLink"
    },
    {
      "raw": "[[Gas Fee Mechanisms]]",
      "resolved": "urn:visionflow:linked:gas-fee-mechanisms",
      "kind": "StubLink"
    },
    {
      "raw": "[[Gas Fees]]",
    ...
    {
      "raw": "[[IOSCO DeFi Report 2023]]",
      "resolved": "urn:visionflow:linked:iosco-de-fi-report-2023",
      "kind": "StubLink"
    },
    {
      "raw": "[[IPFS]]",
    ...
    {
      "raw": "[[Liquidity Mining Incentives]]",
      "resolved": "urn:visionflow:linked:liquidity-mining-incentives",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Overcollateralised Lending]]",
      "resolved": "urn:visionflow:linked:overcollateralised-lending",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[RWA Tokenisation]]",
      "resolved": "urn:visionflow:linked:rwa-tokenisation",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Token Standards (ERC-20)]]",
      "resolved": "urn:visionflow:linked:token-standards-erc-20",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Trustless Trading]]",
      "resolved": "urn:visionflow:linked:trustless-trading",
      "kind": "StubLink"
    },
    {
      "raw": "[[Yield Farming]]",
    ...
    {
      "raw": "[[Yield Optimisation]]",
      "resolved": "urn:visionflow:linked:yield-optimisation",
      "kind": "StubLink"
    },
    {
...
- ### Semantic Classification
  ...
  - owl-role:: FinancialProtocolEcosystem
  - owl-inferred:: blockchain:SmartContractApplication, blockchain:TokenEconomy, blockchain:OpenFinancialInfrastructure
  - belongs-to-domain:: [[Blockchain]], [[FinancialTechnology]], [[CryptographicProtocols]]
  - implemented-in-layer:: [[ApplicationLayer]], [[ProtocolLayer]], [[SmartContractLayer]]
...
- ### Relationships
  ...
  - related-to:: [[Bitcoin Technical Overview]], [[Blockchain Network]], [[Asset Registry]], [[Carbon Neutral Blockchain]], [[CBDC Frameworks]], [[BTC Layer 3]]
  - standardized-by:: [[ERC-20 Token Standard]], [[EIP-1559]], [[MiCA Regulation]], [[IOSCO DeFi Report 2023]], [[FATF Guidance on Virtual Assets]]
...
- ### Content
  ...
  ## Compositional Relationships (Components)
	  ...
	  FunctionalDataProperty(bc:tvlPeakBillions)

  - ## About Decentralized Finance (DeFi)
  - **Decentralized Finance (DeFi)** represents a paradigm shift in the organisation of financial services: replacing licensed institutional intermediaries (banks, brokers, custodians, clearinghouses) with open, self-executing [[Smart Contracts]] deployed on permissionless [[Blockchain Network]]s.
  ...
  - **MakerDAO/Sky** (2017–2026): DAI stablecoin ~$5B outstanding. Rebranded to "Sky Protocol" August 2024 with USDS replacing DAI and SKY replacing MKR in a controversial community governance pivot. Notable milestones:
    ...
    - $1B+ RWA allocation to US Treasuries via SPV structures generating $70M+ annual revenue
  ...
  - ### Stablecoins
  - **USDC (Circle)**: Regulated fiat-collateralised stablecoin. $30–35B circulating 2024. Monthly third-party attestations of reserves held in cash and short-duration US Treasuries at FDIC-insured institutions. Briefly depegged to $0.87 during Silicon Valley Bank collapse (March 2023, $3.3B trapped at SVB); restored to $1.00 within 48 hours post-Fed backstop.
  ...
  - **Yearn Finance**: v2/v3 vaults auto-compound yield across Aave/Compound/Curve/Convex. $500M–$1B TVL. yVaults abstract protocol complexity; depositing USDC deploys capital to highest-risk-adjusted yield, rebalancing automatically. v3 introduced modular strategy architecture and multi-strategy vaults with independent risk managers.
  ...
  - **Ondo Finance**: USDY (tokenised yield-bearing stablecoin backed by US Treasuries + bank deposits, $300M+ 2024); OUSG (tokenised short-term Treasury fund); OMMF (tokenised money market fund). Institutional-grade KYC onboarding via Coinbase. Partner: MakerDAO deploying $500M OUSG as DAI collateral.
  - **Maple Finance**: Institutional undercollateralised lending to crypto-native firms (market makers, Bitcoin miners, hedge funds). $2B+ cumulative loans. Survived $50M bad debt from Orthogonal Trading default (December 2022). Cash Management pool ($200M+) in US Treasuries for conservative institutions. 2024 expansion into structured RWA credit.
  - **Centrifuge**: Tinlake protocol tokenising trade receivables, structured credit, revenue-based financing. $500M+ financed. MakerDAO integration: $220M DAI against Centrifuge collateral (New Silver real estate, BlockTower credit). Centrifuge Chain (Substrate parachain) as native RWA settlement layer.
  ...
  - **Basis Trade**: Borrow USDC at 3%, deploy in 5% T-bill tokenisation protocol (Ondo USDY), capture 2% net spread at minimal risk. At $1B deployed, generates $20M annual risk-adjusted return—attracting hedge fund treasury management capital.
  ...
  - **RWA Growth**: RWA TVL grew from <$1B (2022) to $10–15B Q2 2026. Drivers: (1) 4.5–5.5% US Treasury yields incentivising tokenisation; (2) BlackRock, Franklin Templeton, Fidelity, UBS tokenised money market products on Ethereum; (3) Ondo Finance USDY $600M+; (4) Maple Finance $3B+ cumulative institutional credit; (5) MakerDAO/Sky $1B+ US Treasury allocation generating $70M+ annual yield.
  - **Security Landscape**: Cumulative DeFi exploit losses reached $8.5B through Q1 2026 (DeFiLlama hack database). Bridge exploits account for ~60% of value lost (Ronin $625M March 2022, Wormhole $320M February 2022, Nomad $190M August 2022). Formal verification (Certora Prover, Halmos) and continuous monitoring (Forta, OpenZeppelin Defender) now standard. Immunefi paid $100M+ bug bounties through 2025, with individual bounties reaching $10M.
  ...
  - **Logic Errors and Access Control**: Missing access modifiers on privileged functions. Poly Network $611M exploit (August 2021) exposed due to missing access control on `putCurEpochConPubKeyBytes`. Harvest Finance $34M (October 2020) via flash loan price oracle manipulation in USDC/USDT pool.
  ...
  - **Bridge Vulnerabilities**: Cross-chain message authentication failures. Ronin Network $625M (March 2022): attacker compromised 5 of 9 validator private keys (Sky Mavis controlled 4 + 1 from Axie DAO given permission without revocation). Wormhole $320M (February 2022): signature verification bypass in Solana contract allowed minting uncollateralised wETH. Bridge security remains DeFi's largest systemic attack surface.
  ...
  - **Bug Bounty Programs**: Immunefi paid $100M+ in aggregate through 2025. Tier-1 bounties: Uniswap $15.5M max, LayerZero $15M max, MakerDAO $10M max, Aave $5M max. Total crypto bug bounty payouts exceeded $200M 2022–2025 as protocols recognised white-hat disclosure is cheaper than exploits.
  ...
  - 2023 March: Euler Finance — $197M flash loan reentrancy; ~$177M returned by hacker after negotiation
  ...
  - **DeFi Summer (June–September 2020)**: Compound's COMP distribution (June 15, 2020) to lenders and borrowers triggered the first liquidity mining frenzy. $1B TVL reached within days as yield farmers borrowed and supplied simultaneously to earn COMP. Total DeFi TVL grew 10× from $1B (June 2020) to $14B (October 2020). Spawned Yearn Finance, SushiSwap (Uniswap vampire attack) and the broader yield farming ecosystem.
  - **Vampire Attacks**: SushiSwap migrated $1.3B of Uniswap liquidity (September 2020) by offering higher SUSHI token rewards to Uniswap LPs who migrated positions. Demonstrates protocol composability enabling aggressive competitive liquidity acquisition. Uniswap responded by distributing 400 UNI retroactively to all historical users ($1,200+ per address at peak).
  ...
  - **Liquidity Depth Measurement**: TVL is a poor measure of exchange quality; relevant metric is price impact at specific trade size. Uniswap v3 USDC/ETH 0.05% pool: $1M trade causes ~0.1% price impact; $10M trade causes ~1% price impact. Comparison: Binance spot BTC/USDT at same sizes: 0.01% and 0.05% price impact respectively—centralized exchanges retain liquidity advantage for large trades.
  ...
  - **MEV Taxonomy and Measurement (Flashbots MEV-Explore data)**:
    - 2021 total MEV extracted: $689M (arbitrage $326M, liquidations $103M, sandwiching $258M)
  ...
  - **June 2020**: Compound distributes COMP governance tokens to lenders/borrowers—triggers "DeFi Summer." $1B → $10B TVL growth in 90 days.
  ...
  - **April 2021**: COMP price peak ($850), UNI peak ($44)—governance token speculation drives DeFi valuation surge.
  ...
  - **May 2022**: Terra/LUNA $40B collapse. UST algorithmic stablecoin death spiral. $200B+ total DeFi market cap contagion. Sets off cascading institutional failures (Three Arrows Capital, Celsius, Voyager, BlockFi).
  ...
  - **November 2022**: FTX collapse ($8B+ customer fund shortfall). Centralised exchange contagion. DeFi TVL falls to $40B nadir. Ironically demonstrates DeFi's non-custodial advantage.
  - **March 2023**: Euler Finance $197M reentrancy exploit; $177M returned. USDC depeg to $0.87 (SVB exposure). DAI/USDC PSM and Curve 3pool stress-tested.
  - **May 2023**: crvUSD launches with novel LLAMMA soft-liquidation mechanism.
  - **July 2023**: Curve Finance 3CRV pool exploit via Vyper reentrancy lock bug—$73M at risk, $52M extracted across multiple pools. CRV price collapse threatened founder Michael Egorov's $100M+ leveraged CRV position on Aave.
  ...
  - **Q1 2026**: RWA DeFi TVL exceeds $12B. DeFi total TVL $80–100B. EBA MiCA interpretive guidance triggers EU compliance programs for major protocols.
  ...
  - **Stablecoin Depegging Contagion**: USDT or USDC depeg would trigger catastrophic DeFi liquidations as stablecoin-denominated debt becomes undercollateralised simultaneously. March 2023 USDC depeg (to $0.87) triggered $1.6B in stablecoin redemptions within 48 hours and demonstrated cascading effects on DAI (PSM exposure), Curve 3pool (pool composition shifted 80% USDC), and Aave (USDC borrowing paused).
  ...
  - **Gnosis Safe (Safe{Wallet})**: Multi-signature smart contract wallet, $100B+ in assets under management across 4M+ deployed Safes. Standard for DAO treasuries (Uniswap $2B+, Compound $400M+), protocol emergency multisigs, and institutional digital asset custody. ERC-4337 native support in Safe v1.4 (2024).
