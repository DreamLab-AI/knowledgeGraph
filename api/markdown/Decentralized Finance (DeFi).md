...
- ### Content
  ...
  - **Balancer**: Weighted pool AMMs generalising Uniswap to N-asset pools with arbitrary weights (e.g., 80/20 BAL/ETH pools enabling price-weighted [private] exposure with fee generation). Composable stable pools used for MakerDAO/Aave collateral management.
