schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#MiningReward
legacy_uri:: urn:visionclaw:concept:blockchain:mining-reward
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-3be59d8bf172"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#MiningReward"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:mining-reward"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:751e139c632d3833fcb44b5253cc713ad29b0293c825739e02aaeec4689d4349@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:mining-reward",
  "@type": "OntologyClass",
  "label": "Mining Reward",
  "subClassOf": [
    {
