```json-ld
{
  ...
  "@id": "urn:visionflow:page:nat-traversal",
  "@type": "Page",
  "title": "NAT Traversal",
  "vc:slug": "nat-traversal",
  "vc:public": true,
  "vc:schemaVersion": 2,
...
- ### Definition
  ...
  - Without it, peers behind NAT [private] only connect through a central server, undermining [[Decentralisation]].
- ### Overview
