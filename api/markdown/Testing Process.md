schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#TestingProcess
legacy_uri:: urn:visionclaw:concept:spatial-computing:testing-process
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-f26cc575060f"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#TestingProcess"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:testing-process"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
