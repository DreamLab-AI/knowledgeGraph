schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#PrivateChannels
legacy_uri:: urn:visionclaw:concept:blockchain:private-channels
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-31018df3538e"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#PrivateChannels"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:private-channels"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
