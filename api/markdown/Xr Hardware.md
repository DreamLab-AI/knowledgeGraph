- ### OntologyBlock
  ...
  collapsed:: true
	...
	- status:: active
	- definition:: The physical computing infrastructure and peripheral devices required for extended reality experiences, including head-mounted displays, processing units, tracking systems, input controllers, haptic feedback devices, and supporting equipment for virtual, augmented, and mixed reality applications.
