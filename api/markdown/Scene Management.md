schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#SceneManagement
legacy_uri:: urn:visionclaw:concept:spatial-computing:scene-management
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-0501ab96e75c"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#SceneManagement"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:scene-management"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:18f8091fa7ceb1741aca9cf83dba6e0da80f75b042048cda453b724b9fbf963d@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:scene-management",
  "@type": "OntologyClass",
