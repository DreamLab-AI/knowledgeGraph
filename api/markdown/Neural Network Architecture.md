schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#NeuralNetworkArchitecture
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:neural-network-architecture
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-be6f269926f6"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#NeuralNetworkArchitecture"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:neural-network-architecture"
    },
    {
      "vc:key": "status",
      "vc:value": "active"
