schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#StandardizationBodies
legacy_uri:: urn:visionclaw:concept:spatial-computing:standardization-bodies
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-eaa847e1f840"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#StandardizationBodies"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:standardization-bodies"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
