schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#EdgeComputingArchitecture
legacy_uri:: urn:visionclaw:concept:spatial-computing:edge-computing-architecture
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-009a25a7a744"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#EdgeComputingArchitecture"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:edge-computing-architecture"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
