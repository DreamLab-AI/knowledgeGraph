schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/robotics#Rb0068VisionSystem
legacy_uri:: urn:visionclaw:concept:robotics:rb-0068-vision-system
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-4540e8fcf25b"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/robotics#Rb0068VisionSystem"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:robotics:rb-0068-vision-system"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:2e2d8560bd18b033e4240e57ff873c96a9b83f669e35b981cbff810ec79e40d7@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:rb-0068-vision-system",
  "@type": "OntologyClass",
  ...
  "vc:inferenceRule": "R3CategorySpecialization",
  "prov:wasAttributedTo": {
