- ### OntologyBlock
  ...
  collapsed:: true
	...
	- source-domain:: ai
	- owl:class:: ai:AISystemEUDefinition
	- status:: active
	- public-access:: true
...
AI System (EU Definition) refers to a machine-based system that can operate autonomously and adapt after deployment, generating outputs like predictions or decisions.
