schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#ETSIDomainApplicationCreative
legacy_uri:: urn:visionclaw:concept:spatial-computing:etsi-domain-application-creative
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-20e2a6398cf1"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#ETSIDomainApplicationCreative"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:etsi-domain-application-creative"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
