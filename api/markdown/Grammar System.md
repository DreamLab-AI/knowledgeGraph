schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#GrammarSystem
legacy_uri:: urn:visionclaw:concept:spatial-computing:grammar-system
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-370870d00cf6"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#GrammarSystem"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:grammar-system"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
