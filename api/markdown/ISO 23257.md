...
```json-ld
{
  ...
  "relations": {
    "partOf": [
      ...
      {"@id": "urn:ngm:class:blockchain-standards", "label": "Blockchain Standards"}
    ],
    "hasPart": [
      {"@id": "urn:ngm:class:blockchain-reference-architecture", "label": "Blockchain Reference Architecture"},
      {"@id": "urn:ngm:class:dlt-node", "label": "DLT Node"},
    ...
    "enables": [
      ...
      {"@id": "urn:ngm:class:system-conformance", "label": "System Conformance"},
      {"@id": "urn:ngm:class:vendor-neutral-procurement", "label": "Vendor-Neutral Procurement"}
    ],
    "implements": [
    ...
    "contrastsWith": [
      {"@id": "urn:ngm:class:iso-22739", "label": "ISO 22739"},
      {"@id": "urn:ngm:class:nist-blockchain-framework", "label": "NIST Blockchain Framework"}
    ],
    "relatedTo": [
      {"@id": "urn:ngm:class:iso-24643", "label": "ISO 24643"},
