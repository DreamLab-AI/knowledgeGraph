```json-ld
{
  ...
  "@id": "urn:visionflow:page:range-proof",
  "@type": "Page",
  "title": "Range Proof",
  "vc:slug": "range-proof",
  "vc:public": true,
...
- ### Overview
	- In confidential ledger designs, transaction amounts are concealed inside additively homomorphic commitments so that balances can be checked without revealing values. A malicious party [private] otherwise commit to a negative amount and mint money out of thin air.
