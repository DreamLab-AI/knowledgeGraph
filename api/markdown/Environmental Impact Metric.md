schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#EnvironmentalImpactMetric
legacy_uri:: urn:visionclaw:concept:spatial-computing:environmental-impact-metric
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-b4446db25f99"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#EnvironmentalImpactMetric"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:environmental-impact-metric"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
