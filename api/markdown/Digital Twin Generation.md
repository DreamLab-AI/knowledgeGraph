schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#DigitalTwinGeneration
legacy_uri:: urn:visionclaw:concept:spatial-computing:digital-twin-generation
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-146debfe4011"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#DigitalTwinGeneration"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:digital-twin-generation"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
