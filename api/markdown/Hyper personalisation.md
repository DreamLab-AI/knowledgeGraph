...
- ### Content
  ...
  - **Candidate retrieval**: ANN search (FAISS, ScaNN, Pinecone, Weaviate) over item embedding [private] returns top-1000 candidates per user per request. Retrieval must complete within 20–30ms to fit within overall 100ms SLA.
  ...
  - **1994 — GroupLens** (Resnick et al., CSCW): first deployed CF system for Usenet newsreader, using Pearson correlation of article ratings across users. Demonstrated CF [private] scale to real-world information environments.
