schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#GraphNeuralNetwork
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:graph-neural-network
public:: true
...
```json-ld
{
  ...
  "@id": "urn:visionflow:page:8a4f7a8b83dbc1b4b695358c5f09bd64086f412a48d7dcd8230f8e874fec7a80",
  "@type": "Page",
  "vc:slug": "graph-neural-network",
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:fleeting",
      "vc:label": "fleeting 🪴"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:tom-smoker",
      "vc:label": "Tom Smoker"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-81ff843126dd"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#GraphNeuralNetwork"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:graph-neural-network"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:8a4f7a8b83dbc1b4b695358c5f09bd64086f412a48d7dcd8230f8e874fec7a80@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:graph-neural-network:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[fleeting 🪴]]",
      "resolved": "urn:visionflow:linked:fleeting",
      "kind": "StubLink"
    },
    {
      "raw": "[[github]]",
    ...
    {
      "raw": "[[Tom Smoker]]",
      "resolved": "urn:visionflow:linked:tom-smoker",
      "kind": "StubLink"
    },
    {
...
- ### Semantic Classification
  - owl-class:: artificial-intelligence:GraphNeuralNetwork
  - owl-role:: Concept
