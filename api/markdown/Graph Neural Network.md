...
```json-ld
{
  ...
  "relations": {
    "uses": [
      ...
      {
        "@id": "urn:ngm:class:graph-attention-mechanism",
        "label": "Graph Attention Mechanism"
      },
      {
    ...
    "implements": [
      {
        "@id": "urn:ngm:class:message-passing-neural-network",
        "label": "Message-Passing Neural Network"
      },
      {
        "@id": "urn:ngm:class:spectral-graph-theory",
  ...
  "sameAs": [
    ...
    {
      "@id": "urn:ngm:class:graph-deep-learning",
      "label": "Graph Deep Learning"
    }
  ],
  "quality": 0.72,
  "provenance": {
...
```json-ld
{
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[Active Research Projects Registry]]",
