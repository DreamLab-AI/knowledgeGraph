schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#Transformers
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:transformers
public:: true
...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:aiarchitecture-domain",
      "vc:label": "AIArchitectureDomain"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:alpha-fold-2",
      "vc:label": "AlphaFold 2"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:de-berta",
      "vc:label": "DeBERTa"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:gemma",
      "vc:label": "Gemma"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:gpt-neo-x",
      "vc:label": "GPT-NeoX"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:lla-ma-2",
      "vc:label": "LLaMA 2"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:pa-lm",
      "vc:label": "PaLM"
    },
    {
      "@id": "urn:visionflow:linked:pa-lm-2",
      "vc:label": "PaLM 2"
    },
    {
      "@id": "urn:visionflow:linked:phi",
      "vc:label": "Phi"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:training-infrastructure-layer",
      "vc:label": "TrainingInfrastructureLayer"
    },
    {
    ...
    {
      "@id": "urn:visionflow:owl:class:m-t5",
      "vc:label": "mT5"
    },
    {
    ...
    {
      "@id": "urn:visionflow:owl:class:ro-berta",
      "vc:label": "RoBERTa"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-9b3e7c821f40"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#Transformers"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:transformers"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:transformers:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[AIArchitectureDomain]]",
      "resolved": "urn:visionflow:linked:aiarchitecture-domain",
      "kind": "StubLink"
    },
    {
      "raw": "[[AlphaFold]]",
    ...
    {
      "raw": "[[AlphaFold 2]]",
      "resolved": "urn:visionflow:linked:alpha-fold-2",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[DeBERTa]]",
      "resolved": "urn:visionflow:linked:de-berta",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Gemma]]",
      "resolved": "urn:visionflow:linked:gemma",
      "kind": "StubLink"
    },
    {
      "raw": "[[Google Brain]]",
    ...
    {
      "raw": "[[GPT-NeoX]]",
      "resolved": "urn:visionflow:linked:gpt-neo-x",
      "kind": "StubLink"
    },
    {
      "raw": "[[GPU Compute]]",
    ...
    },
    {
      ...
      "resolved": "urn:visionflow:linked:hugging-face-transformers",
      "kind": "StubLink"
    },
    {
      "raw": "[[InferenceLayer]]",
    ...
    {
      "raw": "[[LLaMA 2]]",
      "resolved": "urn:visionflow:linked:lla-ma-2",
      "kind": "StubLink"
    },
    {
      "raw": "[[LSTM]]",
    ...
    {
      "raw": "[[PaLM]]",
      "resolved": "urn:visionflow:linked:pa-lm",
      "kind": "StubLink"
    },
    {
      "raw": "[[PaLM 2]]",
      "resolved": "urn:visionflow:linked:pa-lm-2",
      "kind": "StubLink"
    },
    {
      "raw": "[[Phi]]",
      "resolved": "urn:visionflow:linked:phi",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[RoPE]]",
      "resolved": "urn:visionflow:linked:ro-pe",
      "kind": "StubLink"
    },
    {
      "raw": "[[RWKV]]",
    ...
    {
      "raw": "[[Sequence Modelling]]",
      "resolved": "urn:visionflow:linked:sequence-modelling",
      "kind": "StubLink"
    },
    {
      "raw": "[[Softmax]]",
    ...
    {
      "raw": "[[State Space Models]]",
      "resolved": "urn:visionflow:linked:state-space-models",
      "kind": "StubLink"
    },
    {
      "raw": "[[SwiGLU]]",
    ...
    {
      "raw": "[[TrainingInfrastructureLayer]]",
      "resolved": "urn:visionflow:linked:training-infrastructure-layer",
      "kind": "StubLink"
    },
    {
      "raw": "[[Transformer Training Infrastructure]]",
      "resolved": "urn:visionflow:linked:transformer-training-infrastructure",
      "kind": "StubLink"
    },
    {
      "raw": "[[ViT]]",
      "resolved": "urn:visionflow:linked:vi-t",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Feed-Forward Network]]",
      "resolved": "urn:visionflow:owl:class:feed-forward-network",
      "kind": "ResolvedLink"
    },
    {
    ...
    {
      "raw": "[[mT5]]",
      "resolved": "urn:visionflow:owl:class:m-t5",
      "kind": "ResolvedLink"
    },
    {
    ...
    {
      "raw": "[[Residual Connection]]",
      "resolved": "urn:visionflow:owl:class:residual-connection",
      "kind": "ResolvedLink"
    },
    {
      "raw": "[[RoBERTa]]",
      "resolved": "urn:visionflow:owl:class:ro-berta",
      "kind": "ResolvedLink"
    },
    {
    ...
    {
      "raw": "[[T5]]",
      "resolved": "urn:visionflow:owl:class:t5",
      "kind": "ResolvedLink"
    },
    {
      "raw": "[[Text Generation]]",
...
- ### Definition
  - Neural network architecture introduced by Vaswani et al. in "Attention Is All You Need" (NeurIPS 2017) that replaces recurrent and convolutional layers with stacked multi-head scaled dot-product self-attention and position-wise feed-forward networks, enabling fully parallel sequence processing and direct O(1)-path modelling of arbitrary-distance token dependencies; the architecture consists of encoder and/or decoder stacks, each comprising multi-head attention sub-layers, FFN sub-layers, residual connections, and layer normalisation, parameterised by model dimension d_model, number of heads h, and FFN expansion ratio (typically 4×), with sinusoidal or learned positional encodings injecting sequential order information; modern variants extend the baseline through rotary position embedding (RoPE, Su et al. 2021) eliminating absolute position tables, attention with linear biases (ALiBi, Press et al. 2021) biasing attention scores by distance, YaRN (Peng et al. 2023) and LongRoPE dynamically extending context beyond training length, grouped-query attention (GQA, Ainslie et al. 2023) sharing key-value heads across query groups to reduce KV-cache memory by up to 8×, multi-query attention (MQA) sharing a single KV pair across all heads, SwiGLU activation (Shazeer 2020) replacing ReLU in FFN with a gated variant achieving superior training efficiency, RMSNorm (Zhang & Sennrich 2019) replacing LayerNorm by removing mean-centring for faster normalisation, pre-norm placement (before rather than after each sub-layer) stabilising deep-model gradient flow, sparse mixture-of-experts (MoE) layers routing tokens to top-k of N feed-forward expert networks enabling trillion-parameter models with sub-proportional compute (Switch Transformer 2021, Mixtral 8x7B 2023), flash attention (Dao et al. 2022) reordering SRAM/HBM computation for IO-bound speedups without approximation; architectural families partition into encoder-only ([[BERT]], [[RoBERTa]], [[DeBERTa]]) for bidirectional language understanding, encoder-decoder ([[T5]], [[BART]], original machine translation) for conditional generation, and decoder-only (GPT series, [[LLaMA]], [[Mistral]], [[Claude]]) for autoregressive language modelling; beyond NLP the transformer backbone generalises to images via patch tokenisation (ViT, Dosovitskiy et al. 2021), audio via spectrogram or waveform patches ([[Whisper]], wav2vec 2.0), protein sequences (ESM, AlphaFold2 Evoformer), and time series (PatchTST, Informer), establishing transformers as the dominant general-purpose deep learning primitive across modalities as of 2026; state-space models ([[Mamba]], S4) have emerged as structurally distinct alternatives offering linear-time recurrence with selective state updates, challenging transformers specifically in long-context inference efficiency while not yet matching transformer quality at scale.

- ### Semantic Classification
  - owl-class:: artificial-intelligence:Transformers
  - owl-role:: NeuralArchitecture
  - owl-inferred:: ai:DeepLearningModel, ai:AttentionBasedModel, ai:SequenceModel, ai:FoundationModelBackbone
  - belongs-to-domain:: [[AIArchitectureDomain]], [[DeepLearningDomain]], [[NaturalLanguageProcessingDomain]]
  - implemented-in-layer:: [[ModelArchitectureLayer]], [[TrainingInfrastructureLayer]], [[InferenceLayer]]

- ### Relationships
  - is-subclass-of:: [[Deep Learning]], [[Neural Network]], [[Sequence Modelling]], [[Attention Mechanism]], [[Foundation Models]]
  - has-part:: [[Multi-Head Attention]], [[Self Attention]], [[Feed-Forward Network]], [[Positional Encoding]], [[Layer Normalization]], [[Residual Connection]], [[KV Cache]], [[Mixture of Experts]]
  - requires:: [[Tokenization]], [[Embedding Layer]], [[Training Data]], [[Gradient Descent]], [[Backpropagation]], [[GPU Compute]]
  - enables:: [[Large Language Model]], [[Vision Transformer]], [[Speech Recognition]], [[Protein Structure Prediction]], [[Code Generation]], [[Machine Translation]], [[Text Generation]], [[Multimodal Learning]]
  ...
  - related-to:: [[BERT]], [[GPT]], [[LLaMA]], [[Claude]], [[T5]], [[ViT]], [[Whisper]], [[AlphaFold]], [[Mistral]], [[Gemini]]
...
- ### Content
  ...
  - Since 2017, every major AI breakthrough — [[BERT]], [[GPT 3]], [[AlphaFold 2]], [[DALL-E]], [[Whisper]], [[LLaMA]], [[Gemini]], [[Claude]] — has been built on transformer foundations. The architecture has proven to be a general-purpose learner that scales smoothly with compute and data, conforming to power-law scaling laws across 10 orders of magnitude in parameter count.
  ...
  - The [[SwiGLU]] variant (Shazeer 2020, adopted by [[LLaMA]], [[PaLM]], [[Gemini]]) replaces ReLU with a gated linear unit: SwiGLU(x, W, V) = Swish(xW) ⊙ (xV), where Swish(x) = x·σ(x). SwiGLU is typically paired with a reduced expansion ratio of ~8/3 × d_model to maintain comparable parameter counts, consistently outperforming ReLU/GELU at matched compute budget. The FFN layers collectively store the model's factual knowledge — ablation studies show FFN layers encode entity-attribute associations that attention heads retrieve via key lookup.
  ...
  - **Rotary Position Embedding (RoPE)**: Encodes relative positions by rotating Q,K vectors in 2D subspaces. Q_m^T K_n = f(m-n) — relative position enters dot product naturally. Su et al. 2021. Adopted by [[LLaMA]], [[Mistral]], [[Gemini]], [[Phi]], [[Qwen]].
  ...
  - **SwiGLU**: Swish-Gated Linear Unit. FFN variant: SwiGLU(x,W,V) = Swish(xW) ⊙ (xV). Outperforms ReLU/GELU at matched compute. Shazeer 2020. Adopted by [[LLaMA]], [[PaLM]], [[Gemini]], [[T5]] v1.1.
  ...
  - 2. Devlin J, Chang MW, Lee K, Toutanova K (2019). "BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding." NAACL 2019. arXiv:1810.04805.
  ...
  - 4. Brown TB, Mann B, Ryder N et al. (2020). "Language Models are Few-Shot Learners." NeurIPS 2020. arXiv:2005.14165.
  - 5. Raffel C, Shazeer N, Roberts A et al. (2020). "Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer." JMLR 21(140). arXiv:1910.10683.
  - 6. Dosovitskiy A, Beyer L, Kolesnikov A et al. (2021). "An Image is Worth 16x16 Words: Transformers for Image Recognition at Scale." ICLR 2021. arXiv:2010.11929.
  ...
  - 8. Press O, Smith NA, Lewis M (2022). "Train Short, Test Long: Attention with Linear Biases Enables Input Length Extrapolation." ICLR 2022. arXiv:2108.12409.
  - 9. Dao T, Fu DY, Ermon S, Rudra A, Re C (2022). "FlashAttention: Fast and Memory-Efficient Exact Attention with IO-Awareness." NeurIPS 2022. arXiv:2205.14135.
  - 10. Fedus W, Zoph B, Shazeer N (2022). "Switch Transformers: Scaling to Trillion Parameter Models with Simple and Efficient Sparsity." JMLR 2022. arXiv:2101.03961.
  - 11. Kaplan J, McCandlish S, Henighan T et al. (2020). "Scaling Laws for Neural Language Models." arXiv:2001.08361.
  - 12. Hoffmann J, Borgeaud S, Mensch A et al. (2022). "Training Compute-Optimal Large Language Models." NeurIPS 2022. arXiv:2203.15556.
  - 13. Touvron H, Lavril T, Izacard G et al. (2023). "LLaMA: Open and Efficient Foundation Language Models." arXiv:2302.06825.
  - 14. Touvron H, Martin L, Stone K et al. (2023). "Llama 2: Open Foundation and Fine-Tuned Chat Models." arXiv:2307.09288.
  - 15. Jiang AQ, Sablayrolles A, Mensch A et al. (2023). "Mistral 7B." arXiv:2310.06825.
  - 16. Jiang AQ, Sablayrolles A, Roux A et al. (2024). "Mixtral of Experts." arXiv:2401.04088.
  - 17. Ainslie J, Lee-Thorp J, de Jong M et al. (2023). "GQA: Training Generalised Multi-Query Transformer Models from Multi-Head Checkpoints." EMNLP 2023. arXiv:2305.13245.
  - 18. Zhang B, Sennrich R (2019). "Root Mean Square Layer Normalization." NeurIPS 2019. arXiv:1910.07467.
  - 19. Ba JL, Kiros JR, Hinton GE (2016). "Layer Normalization." arXiv:1607.06450.
  - 20. Shazeer N (2020). "GLU Variants Improve Transformer." arXiv:2002.05202.
  - 21. Peng B, Quesnelle J, Fan H, Shippole E (2023). "YaRN: Efficient Context Window Extension of Large Language Models." arXiv:2309.00071.
  - 22. Gu A, Dao T (2023). "Mamba: Linear-Time Sequence Modeling with Selective State Spaces." arXiv:2312.00752.
  - 23. Jumper J, Evans R, Pritzel A et al. (2021). "Highly accurate protein structure prediction with AlphaFold." Nature 596, 583-589.
  - 24. Olsson C, Elhage N, Nanda N et al. (2022). "In-context Learning and Induction Heads." Anthropic Transformer Circuits Thread. arXiv:2209.11895.
  - 25. Radford A, Kim JW, Xu T et al. (2022). "Robust Speech Recognition via Large-Scale Weak Supervision." arXiv:2212.04356.
  - 26. Liu Y, Ott M, Goyal N et al. (2019). "RoBERTa: A Robustly Optimized BERT Pretraining Approach." arXiv:1907.11692.
  - 27. Sennrich R, Haddow B, Birch A (2016). "Neural Machine Translation of Rare Words with Subword Units." ACL 2016. arXiv:1508.07909.
  - 28. Dao T (2023). "FlashAttention-2: Faster Attention with Better Parallelism and Work Partitioning." ICLR 2024. arXiv:2307.08691.
  - 29. Elhage N, Nanda N, Olsson C et al. (2021). "A Mathematical Framework for Transformer Circuits." Anthropic Transformer Circuits Thread. transformercircuits.pub.
  - 30. Bai Y, Jones A, Ndousse K et al. (2022). "Training a Helpful and Harmless Assistant with Reinforcement Learning from Human Feedback." Anthropic. arXiv:2204.05862.
  - 31. Hu EJ, Shen Y, Wallis P et al. (2022). "LoRA: Low-Rank Adaptation of Large Language Models." ICLR 2022. arXiv:2106.09685.
  - 32. Dettmers T, Pagnoni A, Holtzman A, Zettlemoyer L (2023). "QLoRA: Efficient Finetuning of Quantized LLMs." NeurIPS 2023. arXiv:2305.14314.
  - 33. Ouyang L, Wu J, Jiang X et al. (2022). "Training language models to follow instructions with human feedback." NeurIPS 2022. arXiv:2203.02155.
  - 34. Rafailov R, Sharma A, Mitchell E et al. (2023). "Direct Preference Optimization: Your Language Model is Secretly a Reward Model." NeurIPS 2023. arXiv:2305.18290.
  - 35. Lin Z, Akin H, Rao R et al. (2023). "Evolutionary-scale prediction of atomic-level protein structure with a language model." Science 379(6637):1123-1130.
  ...
  - JAX (Google DeepMind): Functional framework with XLA (Accelerated Linear Algebra) compiler. jit() transforms pure Python functions to XLA computations; vmap() enables automatic vectorisation; grad() computes exact gradients. Used for [[Gemini]], Gemma, and most Google research models. TPU-native performance advantage over PyTorch due to XLA's whole-program optimisation and static shapes.
  ...
  - Google TPU v5p: 459 TFLOPS BF16 per chip; 4096-chip pods with 4.8TB/s inter-chip interconnect (ICI) per pod. Used for [[Gemini]] 1.5 and Gemma training. TPU v5e (efficient): lower-cost chips for inference.
  ...
  - Google Cloud Vertex AI Model Garden: [[Gemma]], LLaMA, Claude via Anthropic partnership, and PaLM API. Vertex AI Pipelines for fine-tuning workflows. Google AI Studio (free tier for experimentation with [[Gemini]] models).
  ...
  - **Version**: 2.1.0 (bumped from 2.0.0 pre-enrichment stub).

- ### Provenance
  - sources:: Vaswani et al. NeurIPS 2017 (arXiv:1706.03762); Brown et al. NeurIPS 2020 GPT-3 (arXiv:2005.14165); Devlin et al. NAACL 2019 BERT (arXiv:1810.04805); Raffel et al. JMLR 2020 T5 (arXiv:1910.10683); Su et al. 2021 RoPE (arXiv:2104.09864); Ainslie et al. EMNLP 2023 GQA (arXiv:2305.13245); Jiang et al. 2024 Mixtral (arXiv:2401.04088); Gu & Dao 2023 Mamba (arXiv:2312.00752); Jumper et al. Nature 2021 AlphaFold (596:583); Dao et al. NeurIPS 2022 FlashAttention (arXiv:2205.14135); Hoffmann et al. NeurIPS 2022 Chinchilla (arXiv:2203.15556); Kaplan et al. 2020 Scaling Laws (arXiv:2001.08361); Press et al. ICLR 2022 ALiBi (arXiv:2108.12409); Peng et al. 2023 YaRN (arXiv:2309.00071); Shazeer 2020 SwiGLU (arXiv:2002.05202); Zhang & Sennrich NeurIPS 2019 RMSNorm (arXiv:1910.07467); Fedus et al. JMLR 2022 Switch Transformer (arXiv:2101.03961); Dosovitskiy et al. ICLR 2021 ViT (arXiv:2010.11929); Touvron et al. 2023 LLaMA (arXiv:2302.06825); Touvron et al. 2023 LLaMA 2 (arXiv:2307.09288); Jiang et al. 2023 Mistral 7B (arXiv:2310.06825); Radford et al. 2022 Whisper (arXiv:2212.04356); Olsson et al. 2022 Induction Heads (arXiv:2209.11895); Sennrich et al. ACL 2016 BPE (arXiv:1508.07909); Liu et al. 2019 RoBERTa (arXiv:1907.11692); Ba et al. 2016 LayerNorm (arXiv:1607.06450); Dao 2023 FlashAttention-2 (arXiv:2307.08691); Radford et al. 2019 GPT-2 (OpenAI Blog)
