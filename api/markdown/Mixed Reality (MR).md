schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#MixedRealityMR
legacy_uri:: urn:visionclaw:concept:spatial-computing:mixed-reality-mr
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-5abadfb455e4"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#MixedRealityMR"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:mixed-reality-mr"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
