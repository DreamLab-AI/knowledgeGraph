schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#SeriousIncident
legacy_uri:: urn:visionclaw:concept:spatial-computing:serious-incident
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-bf528cf3f207"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#SeriousIncident"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:serious-incident"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
