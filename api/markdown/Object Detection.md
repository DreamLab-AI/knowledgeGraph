schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#ObjectDetection
legacy_uri:: urn:visionclaw:concept:spatial-computing:object-detection
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-23ce93cfe3ca"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#ObjectDetection"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:object-detection"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
