schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#Haptics
legacy_uri:: urn:visionclaw:concept:spatial-computing:haptics
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-0c97d4547f75"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#Haptics"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:haptics"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
