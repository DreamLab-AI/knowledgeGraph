schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#Mixtral
legacy_uri:: urn:visionclaw:concept:spatial-computing:mixtral
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-e4a63315bc1a"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#Mixtral"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:mixtral"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
