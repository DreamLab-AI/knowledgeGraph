schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#TelemetryAnalytics
legacy_uri:: urn:visionclaw:concept:spatial-computing:telemetry-analytics
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-c95995cf5018"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#TelemetryAnalytics"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:telemetry-analytics"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
