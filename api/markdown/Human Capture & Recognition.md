schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#HumanCaptureRecognition
legacy_uri:: urn:visionclaw:concept:spatial-computing:human-capture-recognition
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-878f69bbfc98"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#HumanCaptureRecognition"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:human-capture-recognition"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
