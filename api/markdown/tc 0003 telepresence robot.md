schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/distributed-collaboration#Tc0003TelepresenceRobot
legacy_uri:: urn:visionclaw:concept:distributed-collaboration:tc-0003-telepresence-robot
public:: true
...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "tc-0003-telepresence-robot",
  "title": "tc 0003 telepresence robot",
  "vc:public": true,
  "vc:outboundWikilinks": [
    {
      "@id": "urn:visionflow:linked:5-g-6-g-communication",
      "vc:label": "5G/6G Communication"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:agency-and-control",
      "vc:label": "Agency and Control"
    },
    {
      "@id": "urn:visionflow:linked:alternative-control-methods",
      "vc:label": "Alternative Control Methods"
    },
    {
      "@id": "urn:visionflow:linked:audio",
      "vc:label": "Audio"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:augmented-reality-overlay",
      "vc:label": "Augmented Reality Overlay"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:avatar-representation",
      "vc:label": "Avatar Representation"
    },
    {
      "@id": "urn:visionflow:linked:blended-environments",
      "vc:label": "Blended Environments"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:control-joystick",
      "vc:label": "Control Joystick"
    },
    {
      "@id": "urn:visionflow:linked:deliberate-practice",
      "vc:label": "Deliberate Practice"
    },
    {
      "@id": "urn:visionflow:linked:depth",
      "vc:label": "Depth"
    },
    {
      "@id": "urn:visionflow:linked:direct-teleoperation",
      "vc:label": "Direct Teleoperation"
    },
    {
      "@id": "urn:visionflow:linked:electric-motors",
      "vc:label": "Electric Motors"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:environmental-exploration",
      "vc:label": "Environmental Exploration"
    },
    {
      "@id": "urn:visionflow:linked:experiential-learning",
      "vc:label": "Experiential Learning"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:humanoid",
      "vc:label": "Humanoid"
    },
    {
      "@id": "urn:visionflow:linked:humanoid-platforms",
      "vc:label": "Humanoid Platforms"
    },
    {
      "@id": "urn:visionflow:linked:hybrid-presence",
      "vc:label": "Hybrid Presence"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:hydraulic",
      "vc:label": "Hydraulic"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:manipulation-control",
      "vc:label": "Manipulation Control"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:mentoring",
      "vc:label": "Mentoring"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:mobility",
      "vc:label": "Mobility"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:multi-camera-system",
      "vc:label": "Multi-Camera System"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:path-planning-for-telepresence",
      "vc:label": "Path Planning for Telepresence"
    },
    {
      "@id": "urn:visionflow:linked:physical-interaction",
      "vc:label": "Physical Interaction"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:pneumatic",
      "vc:label": "Pneumatic"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:proximity",
      "vc:label": "Proximity"
    },
    {
      "@id": "urn:visionflow:linked:real-time-video",
      "vc:label": "Real-Time Video"
    },
    {
      "@id": "urn:visionflow:linked:remote-collaboration-technology",
      "vc:label": "Remote Collaboration Technology"
    },
    {
      "@id": "urn:visionflow:linked:remote-manipulation",
      "vc:label": "Remote Manipulation"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:remote-operation-skills",
      "vc:label": "Remote Operation Skills"
    },
    {
      "@id": "urn:visionflow:linked:remote-problem-solving",
      "vc:label": "Remote Problem-Solving"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:semi-autonomous-navigation",
      "vc:label": "Semi-autonomous Navigation"
    },
    {
      "@id": "urn:visionflow:linked:sense-of-presence",
      "vc:label": "Sense of Presence"
    },
    {
      "@id": "urn:visionflow:linked:sensing",
      "vc:label": "Sensing"
    },
    {
      "@id": "urn:visionflow:linked:sensor-integration",
      "vc:label": "Sensor Integration"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:situational-display",
      "vc:label": "Situational Display"
    },
    {
      "@id": "urn:visionflow:linked:spatial-awareness",
      "vc:label": "Spatial Awareness"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:spatial-understanding",
      "vc:label": "Spatial Understanding"
    },
    {
      "@id": "urn:visionflow:linked:specialized",
      "vc:label": "Specialized"
    },
    {
      "@id": "urn:visionflow:linked:specialized-medical-robots",
      "vc:label": "Specialized Medical Robots"
    },
    {
      "@id": "urn:visionflow:linked:synchronous-telepresence",
      "vc:label": "Synchronous Telepresence"
    },
    {
      "@id": "urn:visionflow:linked:task-accomplishment",
      "vc:label": "Task Accomplishment"
    },
    {
      "@id": "urn:visionflow:linked:task-competency",
      "vc:label": "Task Competency"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:vision",
      "vc:label": "Vision"
    },
    {
      "@id": "urn:visionflow:linked:wheeled",
      "vc:label": "Wheeled"
    },
    {
      "@id": "urn:visionflow:linked:wheeled-telepresence-robots",
      "vc:label": "Wheeled Telepresence Robots"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-a13147678458"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/distributed-collaboration#Tc0003TelepresenceRobot"
    },
    {
    ...
    },
    {
      ...
      "vc:value": "tc 0003 telepresence robot"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:distributed-collaboration:tc-0003-telepresence-robot"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:tc-0003-telepresence-robot:776c802a9fc9",
  ...
  "vc:resolutions": [
    {
      "raw": "[[5G/6G Communication]]",
      "resolved": "urn:visionflow:linked:5-g-6-g-communication",
      "kind": "StubLink"
    },
    {
      "raw": "[[5G Low-Latency Networks]]",
      "resolved": "urn:visionflow:linked:5-g-low-latency-networks",
      "kind": "StubLink"
    },
    {
      "raw": "[[Agency and Control]]",
      "resolved": "urn:visionflow:linked:agency-and-control",
      "kind": "StubLink"
    },
    {
      "raw": "[[Alternative Control Methods]]",
      "resolved": "urn:visionflow:linked:alternative-control-methods",
      "kind": "StubLink"
    },
    {
      "raw": "[[Audio]]",
      "resolved": "urn:visionflow:linked:audio",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Augmented Reality Overlay]]",
      "resolved": "urn:visionflow:linked:augmented-reality-overlay",
      "kind": "StubLink"
    },
    {
      "raw": "[[Autonomous Navigation Support]]",
      "resolved": "urn:visionflow:linked:autonomous-navigation-support",
      "kind": "StubLink"
    },
    {
      "raw": "[[Avatar Representation]]",
      "resolved": "urn:visionflow:linked:avatar-representation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Blended Environments]]",
      "resolved": "urn:visionflow:linked:blended-environments",
      "kind": "StubLink"
    },
    {
      "raw": "[[Brain-Computer Interface]]",
      "resolved": "urn:visionflow:linked:brain-computer-interface",
      "kind": "StubLink"
    },
    {
      "raw": "[[Camera System]]",
      "resolved": "urn:visionflow:linked:camera-system",
      "kind": "StubLink"
    },
    {
      "raw": "[[Computer Vision Understanding]]",
      "resolved": "urn:visionflow:linked:computer-vision-understanding",
      "kind": "StubLink"
    },
    {
      "raw": "[[Control Joystick]]",
      "resolved": "urn:visionflow:linked:control-joystick",
      "kind": "StubLink"
    },
    {
      "raw": "[[Deliberate Practice]]",
      "resolved": "urn:visionflow:linked:deliberate-practice",
      "kind": "StubLink"
    },
    {
      "raw": "[[Depth]]",
      "resolved": "urn:visionflow:linked:depth",
      "kind": "StubLink"
    },
    {
      "raw": "[[Direct Teleoperation]]",
      "resolved": "urn:visionflow:linked:direct-teleoperation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Electric Motors]]",
      "resolved": "urn:visionflow:linked:electric-motors",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Embodied Collaboration]]",
      "resolved": "urn:visionflow:linked:embodied-collaboration",
      "kind": "StubLink"
    },
    {
      "raw": "[[Environmental Exploration]]",
      "resolved": "urn:visionflow:linked:environmental-exploration",
      "kind": "StubLink"
    },
    {
      "raw": "[[Experiential Learning]]",
      "resolved": "urn:visionflow:linked:experiential-learning",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Humanoid]]",
      "resolved": "urn:visionflow:linked:humanoid",
      "kind": "StubLink"
    },
    {
      "raw": "[[Humanoid Platforms]]",
      "resolved": "urn:visionflow:linked:humanoid-platforms",
      "kind": "StubLink"
    },
    {
      "raw": "[[Hybrid Presence]]",
      "resolved": "urn:visionflow:linked:hybrid-presence",
      "kind": "StubLink"
    },
    {
      "raw": "[[Hybrid Presence Avatar]]",
      "resolved": "urn:visionflow:linked:hybrid-presence-avatar",
      "kind": "StubLink"
    },
    {
      "raw": "[[Hydraulic]]",
      "resolved": "urn:visionflow:linked:hydraulic",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Manipulation Control]]",
      "resolved": "urn:visionflow:linked:manipulation-control",
      "kind": "StubLink"
    },
    {
      "raw": "[[Manipulation Mechanism]]",
      "resolved": "urn:visionflow:linked:manipulation-mechanism",
      "kind": "StubLink"
    },
    {
      "raw": "[[Mentoring]]",
      "resolved": "urn:visionflow:linked:mentoring",
      "kind": "StubLink"
    },
    {
      "raw": "[[Microphone]]",
    ...
    {
      "raw": "[[Mobility]]",
      "resolved": "urn:visionflow:linked:mobility",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Multi-Camera System]]",
      "resolved": "urn:visionflow:linked:multi-camera-system",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Path Planning for Telepresence]]",
      "resolved": "urn:visionflow:linked:path-planning-for-telepresence",
      "kind": "StubLink"
    },
    {
      "raw": "[[Physical Interaction]]",
      "resolved": "urn:visionflow:linked:physical-interaction",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Pneumatic]]",
      "resolved": "urn:visionflow:linked:pneumatic",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Proximity]]",
      "resolved": "urn:visionflow:linked:proximity",
      "kind": "StubLink"
    },
    {
      "raw": "[[Real-Time Video]]",
      "resolved": "urn:visionflow:linked:real-time-video",
      "kind": "StubLink"
    },
    {
      "raw": "[[Remote Collaboration Technology]]",
      "resolved": "urn:visionflow:linked:remote-collaboration-technology",
      "kind": "StubLink"
    },
    {
      "raw": "[[Remote Manipulation]]",
      "resolved": "urn:visionflow:linked:remote-manipulation",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Remote Operation Skills]]",
      "resolved": "urn:visionflow:linked:remote-operation-skills",
      "kind": "StubLink"
    },
    {
      "raw": "[[Remote Problem-Solving]]",
      "resolved": "urn:visionflow:linked:remote-problem-solving",
      "kind": "StubLink"
    },
    {
      "raw": "[[Remote Task Execution]]",
      "resolved": "urn:visionflow:linked:remote-task-execution",
      "kind": "StubLink"
    },
    {
      "raw": "[[Semi-autonomous Navigation]]",
      "resolved": "urn:visionflow:linked:semi-autonomous-navigation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Sense of Presence]]",
      "resolved": "urn:visionflow:linked:sense-of-presence",
      "kind": "StubLink"
    },
    {
      "raw": "[[Sensing]]",
      "resolved": "urn:visionflow:linked:sensing",
      "kind": "StubLink"
    },
    {
      "raw": "[[Sensor Integration]]",
      "resolved": "urn:visionflow:linked:sensor-integration",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Situational Display]]",
      "resolved": "urn:visionflow:linked:situational-display",
      "kind": "StubLink"
    },
    {
      "raw": "[[Spatial Awareness]]",
      "resolved": "urn:visionflow:linked:spatial-awareness",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Spatial Understanding]]",
      "resolved": "urn:visionflow:linked:spatial-understanding",
      "kind": "StubLink"
    },
    {
      "raw": "[[Specialized]]",
      "resolved": "urn:visionflow:linked:specialized",
      "kind": "StubLink"
    },
    {
      "raw": "[[Specialized Medical Robots]]",
      "resolved": "urn:visionflow:linked:specialized-medical-robots",
      "kind": "StubLink"
    },
    {
      "raw": "[[Synchronous Telepresence]]",
      "resolved": "urn:visionflow:linked:synchronous-telepresence",
      "kind": "StubLink"
    },
    {
      "raw": "[[Task Accomplishment]]",
      "resolved": "urn:visionflow:linked:task-accomplishment",
      "kind": "StubLink"
    },
    {
      "raw": "[[Task Competency]]",
      "resolved": "urn:visionflow:linked:task-competency",
      "kind": "StubLink"
    },
    {
      "raw": "[[Task Execution]]",
    ...
    {
      "raw": "[[Teleoperated System]]",
      "resolved": "urn:visionflow:linked:teleoperated-system",
      "kind": "StubLink"
    },
    {
      "raw": "[[Telepresence Technology]]",
      "resolved": "urn:visionflow:linked:telepresence-technology",
      "kind": "StubLink"
    },
    {
      "raw": "[[Vision]]",
      "resolved": "urn:visionflow:linked:vision",
      "kind": "StubLink"
    },
    {
      "raw": "[[Wheeled]]",
      "resolved": "urn:visionflow:linked:wheeled",
      "kind": "StubLink"
    },
    {
      "raw": "[[Wheeled Telepresence Robots]]",
      "resolved": "urn:visionflow:linked:wheeled-telepresence-robots",
      "kind": "StubLink"
    },
    {
      "raw": "[[Computer Vision]]",
