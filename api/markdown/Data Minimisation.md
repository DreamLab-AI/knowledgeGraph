...
- Data minimisation is a foundational principle in data protection law, mandating that personal data collected and processed must be strictly limited to what is necessary for a specified purpose.
  - Rooted in Article 5(1)(c) of the EU General Data Protection Regulation (GDPR), it requires data to be adequate, relevant, and limited in scope.
  - The principle is designed to reduce privacy risks by minimising unnecessary data collection and retention.
  - Academic discourse emphasises the balance between data utility and privacy, exploring frameworks for effective minimisation without compromising analytical value.
