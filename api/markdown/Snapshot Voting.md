iri:: http://narrativegoldmine.com/blockchain#SnapshotVoting
uri:: urn:visionclaw:concept:blockchain:snapshot-voting
rdf-type:: owl:Class
same-as:: urn:visionclaw:concept:blockchain:snapshot-voting
type:: owl:Class
context:: https://visionclaw.dreamlab-ai.systems/ns/v2
domain:: blockchain
preferred-term:: Snapshot Voting
content-hash:: sha256-12-409b4e6c4789
legacy-term-id:: BC-0469
...
- ### Definition
  - Snapshot is an off-chain governance infrastructure enabling gasless voting for [[DecentralizedAutonomousOrganization|decentralised autonomous organisations]] through cryptographic signatures (EIP-712) rather than blockchain transactions, eliminating participation costs that previously restricted voter participation. The platform aggregates voter preferences using flexible voting strategies—from simple [[TokenWeightedVoting|token-weighted voting]] to [[QuadraticVoting|quadratic voting]]—indexed against historical blockchain state to prevent manipulation, storing immutable vote records on [[IPFS|IPFS]] for transparency and auditability. Used by 10,000+ DAOs including major protocols like [[Aave]], [[Uniswap]], and [[ENS|Ethereum Name Service]], Snapshot has become the de facto standard for on-chain [[DAO|governance]] signalling, with optional [[SafeSnap|SafeSnap]] integration enabling binding on-chain execution of vote results.
