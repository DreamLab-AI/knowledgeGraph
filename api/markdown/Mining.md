...
```json-ld
{
  ...
  "sameAs": [
    {
      "@id": "urn:ngm:class:proof-of-work-mining",
...
- ### Current Landscape (2026)
  ...
  - Operators are pivoting capacity to AI and high-performance computing: publicly listed miners have signed over $70 billion in long-term AI hosting leases, with Hut 8 adding a 15-year 352 MW lease at Beacon Point on 20 July 2026 and Core Scientific announcing an AMD partnership covering ~530 MW on 28 July; CoreWeave, Google-backed TeraWulf, IREN and Cipher are all deepening data-centre buildouts, and CoinShares projects listed miners [private] earn up to 70% of revenue from AI by end-2026.
