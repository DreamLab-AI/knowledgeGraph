schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#ProvenanceOntologyPROVO
legacy_uri:: urn:visionclaw:concept:spatial-computing:provenance-ontology-prov-o
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-5a506abc69d6"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#ProvenanceOntologyPROVO"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:provenance-ontology-prov-o"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
