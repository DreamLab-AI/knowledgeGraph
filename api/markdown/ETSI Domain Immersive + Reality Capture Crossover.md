schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#ETSIDomainImmersiveRealityCaptureCrossover
legacy_uri:: urn:visionclaw:concept:spatial-computing:etsi-domain-immersive-reality-capture-crossover
public:: true
...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "etsi-domain-immersive-reality-capture-crossover",
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-fd98ebf87d55"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#ETSIDomainImmersiveRealityCaptureCrossover"
    },
    {
    ...
    },
    {
      ...
      "vc:value": "ETSI Domain Immersive + Reality Capture Crossover"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:etsi-domain-immersive-reality-capture-crossover"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:etsi-domain-immersive-reality-capture-crossover:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[Photorealistic Immersion]]",
      "resolved": "urn:visionflow:linked:photorealistic-immersion",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[ETSI Domain Immersive]]",
      "resolved": "urn:visionflow:owl:class:etsi-domain-immersive",
      "kind": "ResolvedLink"
    },
    {
      "raw": "[[ETSI Domain Reality Capture]]",
      "resolved": "urn:visionflow:owl:class:etsi-domain-reality-capture",
      "kind": "ResolvedLink"
    },
    {
