...
- ### Definition
  - Complex adaptive systems (CAS) are systems composed of large numbers of heterogeneous, interacting [[Autonomous Agent|autonomous agents]] whose collective behaviour emerges bottom-up from local rules and mutual [[Adaptation]] rather than from any top-down blueprint or central controller. Originating in the interdisciplinary programme of the [[Santa Fe Institute]] in the late 1980s under Murray Gell-Mann, Stuart Kauffman, John Holland, and W. Brian Arthur, the CAS framework formalises observations from [[Ecosystems|ecology]], immunology, economics, and social science that macro-scale order — the structure of ant colonies, price signals in markets, the spatial patterning of cities, the evolution of language, or the coordinated behaviour of immune cells — arises as a spontaneous property of populations of agents obeying far simpler rules than the global patterns they produce. Each agent in a CAS perceives only a local neighbourhood of its environment, responds to environmental signals and to the signals of neighbouring agents through [[Feedback Loop|feedback loops]], and updates its strategy through [[Adaptation|learning or evolutionary mechanisms]], creating a [[Non-Linear Dynamics|non-linear dynamical system]] that is exquisitely sensitive to initial conditions and to the precise structure of agent interaction topology as described by [[Network Science]]. The three canonical signatures of a CAS are: [[Emergence]] — global order arising unpredictably from micro-scale interaction; [[Self-Organisation]] — the spontaneous formation of structured patterns without external direction; and [[Resilience]] — the ability to absorb perturbation, reorganise, and continue functioning through distributed redundancy and adaptive reallocation. CAS differ fundamentally from [[Linear Systems]] and from classically designed engineered systems governed by [[Control Theory]]: they are not solvable by decomposition, their behaviour cannot be predicted analytically from first principles, and they exhibit [[Phase Transition|phase transitions]] between qualitatively distinct dynamic regimes triggered by crossing critical thresholds. The mathematical study of CAS draws on [[Statistical Mechanics]], [[Dynamical Systems Theory]], [[Information Theory]], [[Game Theory]], and [[Network Theory]], while the primary computational methodology is [[Agent-Based Modelling]] — the only technique that can faithfully preserve agent heterogeneity, stochastic variation, spatial locality, and [[Path Dependence]] simultaneously. Applications span virtually every complex natural and social domain: immune system function, neural computation, evolutionary biology, financial markets, urban growth, [[Epidemiology|epidemic dynamics]], social norm formation, [[Ecosystems|ecosystem management]], and — as of 2024-2026 — the architecture of large-scale AI systems built from interacting [[Large Language Models]], which exhibit emergent CAS-like dynamics including [[Self-Organised Criticality]], [[Phase Transition|phase transitions]] in capability, and [[Collective Behaviour|collective behaviour]] not specified in any individual component's design.

- ### Semantic Classification
  - owl-class:: ai:ComplexAdaptiveSystems
  - owl-role:: Concept | SystemsFramework | ComplexityParadigm
  - owl-inferred:: ai:EmergentSystem, ai:DistributedAdaptiveSystem, ai:SelfOrganisingSystem
  - belongs-to-domain:: [[Complexity Science]]
  - implemented-in-layer:: [[Agent-Based Modelling]]

- ### Relationships
  - is-subclass-of:: [[Complexity Science]], [[Systems Theory]], [[Dynamical Systems Theory]]
  - has-part:: [[Emergence]], [[Feedback Loop]], [[Self-Organisation]], [[Adaptation]], [[Autonomous Agent]], [[Non-Linear Dynamics]], [[Co-Evolution]], [[Resilience]]
  - part-of:: [[Complexity Science]]
  - requires:: [[Systems Theory]], [[Feedback Loop]], [[Information Theory]], [[Non-Linear Dynamics]]
  - enables:: [[Emergence]], [[Resilience]], [[Collective Intelligence]], [[Collective Behaviour]], [[Self-Organised Criticality]], [[Phase Transition]], [[Stigmergy]], [[Swarm Intelligence]]
  - implements:: [[Agent-Based Modelling]], [[Swarm Intelligence]], [[Artificial Life]], [[Evolutionary Computation]]
  - depends-on:: [[Feedback Loop]], [[Network Science]], [[Statistical Mechanics]], [[Dynamical Systems Theory]]
  - uses:: [[Feedback Loop]], [[Reinforcement Learning]], [[Evolutionary Computation]], [[Genetic Algorithm]], [[Cellular Automata]], [[Game Theory]]
  - supports:: [[Agent-Based Modelling]], [[Policy Simulation]], [[Urban Computing]], [[Epidemiology]], [[Digital Twin]], [[Multi-Agent Systems]], [[Multi-Agent Reinforcement Learning]]
  - contrasts-with:: [[Linear Systems]], [[Control Theory]]
  - bridges-to:: [[Control Theory]], [[Multi-Agent Systems]], [[Large Language Models]], [[Digital Twin]]
  - related-to:: [[Cybernetics]], [[Systems Theory]], [[Chaos Theory]], [[Dynamical Systems Theory]], [[Game Theory]], [[Statistical Mechanics]], [[Network Science]], [[Network Theory]], [[Scale-Free Network]], [[Power-Law Distributions]], [[Path Dependence]], [[Self-Organised Criticality]], [[Phase Transition]], [[Collective Intelligence]]
  - standardized-by:: [[Santa Fe Institute]]

- ### Content
  - ## Compositional Relationships (Components)
    ```
    SubClassOf(ai:ComplexAdaptiveSystems
    ...
    SubClassOf(ai:ComplexAdaptiveSystems
      ObjectSomeValuesFrom(ai:hasPart ai:Adaptation))
    SubClassOf(ai:ComplexAdaptiveSystems
      ObjectSomeValuesFrom(ai:hasPart ai:AutonomousAgent))
    SubClassOf(ai:ComplexAdaptiveSystems
      ObjectSomeValuesFrom(ai:hasPart ai:NonLinearDynamics))
    SubClassOf(ai:ComplexAdaptiveSystems
      ObjectSomeValuesFrom(ai:hasPart ai:CoEvolution))
    SubClassOf(ai:ComplexAdaptiveSystems
      ObjectSomeValuesFrom(ai:hasPart ai:Resilience))
    ```
  - ## Dependency Relationships
    ...
    SubClassOf(ai:ComplexAdaptiveSystems
      ObjectSomeValuesFrom(ai:dependsOn ai:StatisticalMechanics))
    SubClassOf(ai:ComplexAdaptiveSystems
  ...
  - ## Capability Relationships
    ...
    SubClassOf(ai:ComplexAdaptiveSystems
      ObjectSomeValuesFrom(ai:enables ai:Resilience))
    SubClassOf(ai:ComplexAdaptiveSystems
      ObjectSomeValuesFrom(ai:enables ai:CollectiveIntelligence))
    SubClassOf(ai:ComplexAdaptiveSystems
      ObjectSomeValuesFrom(ai:enables ai:SelfOrganisedCriticality))
    SubClassOf(ai:ComplexAdaptiveSystems
      ObjectSomeValuesFrom(ai:enables ai:PhaseTransition))
    SubClassOf(ai:ComplexAdaptiveSystems
      ObjectSomeValuesFrom(ai:enables ai:Stigmergy))
    SubClassOf(ai:ComplexAdaptiveSystems
  ...
  - ## Implementation Relationships
    ...
    SubClassOf(ai:ComplexAdaptiveSystems
      ObjectSomeValuesFrom(ai:uses ai:EvolutionaryComputation))
    SubClassOf(ai:ComplexAdaptiveSystems
  ...
  - ## Reduction Relationships
    ```
    SubClassOf(ai:ComplexAdaptiveSystems
      ObjectSomeValuesFrom(ai:reducesTo ai:LinearSystems))
    SubClassOf(ai:ComplexAdaptiveSystems
      ObjectSomeValuesFrom(ai:reducesTo ai:DynamicalSystemsTheory))
    SubClassOf(ai:ComplexAdaptiveSystems
      ObjectSomeValuesFrom(ai:reducesTo ai:SystemsTheory))
    ```
  ...
  - ## Components / Architecture
    ...
    - **Interaction topology**: The network structure governing which agents interact with which, at what strength, and in what direction. Interaction topology critically determines CAS dynamics: random, [[Scale-Free Network|scale-free]], small-world, and lattice topologies all produce qualitatively different emergent dynamics from identical agent rule sets. [[Network Science]] provides analytical tools for characterising topology and predicting its consequences for contagion dynamics, [[Resilience]], and [[Phase Transition|phase transitions]].
      - Random networks (Erdős-Rényi): uniform connectivity, Poisson degree distribution, sharp percolation threshold.
      - [[Scale-Free Network|Scale-free networks]] (Barabasi-Albert): power-law degree distribution, hub-and-spoke structure, ultra-small world diameter, robust to random failure but fragile to targeted hub attack.
    ...
    - **Feedback mechanisms**: Positive feedback (amplifying: autocatalysis, herding, preferential attachment) drives rapid reorganisation and [[Phase Transition|phase transitions]]; negative feedback (dampening: predator-prey regulation, price equilibration, immune response) maintains system viability within bounds. [[Feedback Loop|Feedback loops]] operating across scales constitute the primary mechanism of [[Emergence]] in CAS.
    ...
    - **Adaptation mechanisms**: The processes by which agents modify their strategies in response to experienced outcomes. Agent-level adaptation includes [[Reinforcement Learning]], [[Genetic Algorithm|evolutionary mechanisms]], imitation, and cultural transmission. System-level adaptation includes niche construction and [[Co-Evolution]]. The timescale of adaptation ranges from milliseconds (neural adaptation) to geological epochs (biological co-evolution), but the mathematical structure — selection among variants based on differential fitness — is common across all scales.
    ...
    - **Emergent structures**: The macro-level patterns arising from micro-level agent interactions without being specified in any agent's rules. Examples: ant trail networks from pheromone-following rules; price equilibria from trading rules; neuronal representations from synaptic modification rules; language grammars from communicative interaction rules. [[Agent-Based Modelling]] is the primary tool for generating and testing candidate micro-level mechanisms that produce observed macro-level patterns.
      ...
      - Temporal emergent structures: oscillations, synchronisation, chaos — CAS temporal dynamics from [[Feedback Loop|feedback]] interactions between adaptive agents.
  ...
  - ## Use Cases / Major Families
    - **Ecology and evolutionary biology**: The original domain of CAS theory, where the formalism was developed to describe [[Ecosystems|ecosystems]] as populations of co-evolving species interacting through predation, competition, mutualism, and environmental modification. Stuart Kauffman's NK model formalises fitness landscape adaptation for co-evolving gene networks. CAS models of ecosystems capture species co-evolution and arms-race dynamics; invasion dynamics and ecosystem regime shifts; food web structure as an emergent property of predator-prey interaction topology; and [[Self-Organised Criticality]] in extinction dynamics. [[Ecosystems|Ecosystem]] management informed by CAS theory emphasises adaptive management — iterative monitoring and intervention — rather than fixed-target control.
      - Regime shift detection: coral reef-to-algae transitions as CAS [[Phase Transition|phase transitions]] between alternative stable states with irreversible hysteresis.
      ...
      - Rewilding: wolf reintroduction in Yellowstone as CAS [[Co-Evolution|trophic cascade]] — emergent restructuring of vegetation and hydrology from predator [[Adaptation|adaptation]] effects.
    ...
    - **Economics and finance**: W. Brian Arthur at the [[Santa Fe Institute]] founded complexity economics in the 1980s, treating markets as evolving systems of boundedly rational, adaptive agents rather than optimising equilibrium machines. The Santa Fe artificial stock market (1990s) showed that heterogeneous trader agents produce fat-tailed return distributions, volatility clustering, and boom-bust cycles — dynamics matching real financial markets but absent from standard rational expectations models. The Bank of England and ECB maintain CAS-inspired agent-based macroeconomic models as complements to DSGE frameworks for systemic risk analysis.
      ...
      - Financial contagion: interbank network [[Scale-Free Network|scale-free structure]] making systemic risk a CAS cascade phenomenon (Basel III network stress tests).
    ...
    - **Social systems and urban dynamics**: Cities and societies exhibit canonical CAS signatures: [[Emergence]] of norms, languages, institutions, and markets without central design; [[Scale-Free Network|scale-free network]] structure in social connectivity distributions; [[Power-Law Distributions]] in city sizes (Zipf's law) and wealth distributions (Pareto's law); [[Phase Transition|phase transitions]] in collective behaviour (social tipping points, norm cascades); and [[Resilience]] through distributed redundancy. [[Urban Computing]] research applies CAS frameworks to smart city design. The DACAS Strategic Network at the University of Manchester contributes to UN SDGs through CAS-informed urban modelling.
      ...
      - [[Urban Computing]] CAS applications: traffic flow, energy demand, pollution, pedestrian crowd dynamics — all [[Agent-Based Modelling|agent-based modelled]] by CASA (UCL) and DACAS (Manchester).
      - Gentrification as CAS: neighbourhood socioeconomic transformation as [[Phase Transition|tipping point]] dynamics in housing market CAS.
    - **Immunology and neuroscience**: The immune system is a paradigmatic biological CAS: a distributed population of heterogeneous lymphocytes and antibodies that self-organises into a memory capable of recognising and responding to novel antigens without central direction. Farmer et al.'s immune network models (1986) were early [[Santa Fe Institute]] contributions to CAS immunology. Neural computation is increasingly analysed as a CAS: cortical columns as heterogeneous interacting agents, attention as an emergent selection mechanism, and learning as adaptation of synaptic weights through [[Reinforcement Learning]]-like Hebbian and predictive-coding mechanisms.
      ...
      - Predictive coding as CAS: hierarchical Bayesian inference in cortex as multi-level CAS with top-down and bottom-up [[Feedback Loop|feedback loops]] at each level.
    ...
    - **Epidemiology and public health**: Epidemic dynamics are inherently CAS phenomena: disease spreads through a heterogeneous population via a contact network, with individual-level infection decisions co-evolving with epidemic dynamics. CAS-informed [[Epidemiology]] models capture super-spreader effects from heavy-tailed contact degree distributions, spatial clustering, and non-linear effects of targeted interventions that aggregate SIR models cannot. The COVID-19 pandemic demonstrated the [[Policy Simulation]] value of CAS-based epidemic models — directly influencing UK lockdown timing in March 2020.
      - Super-spreader dynamics: 20% of cases causing 80% of transmission — [[Power-Law Distributions|power-law]] contact degree distribution producing CAS contagion heterogeneity.
    ...
    - **Artificial intelligence and LLM systems**: As of 2024-2026, large-scale AI systems built from interacting [[Large Language Models]] and [[Autonomous Agent|autonomous software agents]] are being recognised as novel CAS. [[Multi-Agent Systems]] built from LLM agents exhibit emergent [[Collective Behaviour]] not specified in any individual agent's training. The arXiv:2506.01839v2 (2026) explicitly frames multi-agent LLM systems as CAS, identifying emergence, non-linearity, and [[Adaptation]] as their defining features. Gartner projects over 80% of enterprise AI workloads will use multi-agent systems by 2026, with emergent CAS coordination properties being both their key capability and primary governance challenge.
      ...
      - Agentic AI as CAS governance challenge: emergent dangerous behaviours in multi-agent AI systems are CAS [[Phase Transition|phase transition]] phenomena requiring CAS analytical tools for prediction.
    ...
    - **Climate and environmental systems**: Climate change research increasingly frames the Earth system as a CAS exhibiting tipping points (permafrost thaw, ice sheet collapse, Amazon dieback), [[Path Dependence]] (hysteresis in climate system response), and emergent regime shifts. The "polycrises" concept has moved from academic complexity science into mainstream policy analysis (UN, WEF, EU). CAS-informed climate adaptation emphasises building system [[Resilience]] through diversity, redundancy, and adaptive capacity.
      - Earth system tipping cascade: crossing one tipping element (Greenland ice sheet) increases the probability of crossing others — [[Co-Evolution|co-evolutionary]] CAS destabilisation.
  ...
  - ## Academic Context
    - Complex adaptive systems theory emerged in the late 1980s from the multidisciplinary programme of the [[Santa Fe Institute]] (SFI, founded 1984), which brought together physicists, biologists, economists, computer scientists, and anthropologists around the common framework of complex adaptive systems. The SFI's non-disciplinary structure — no departments, rotating visitor programme, emphasis on cross-domain synthesis — has been essential to CAS's identity as a unifying framework crossing biological, social, physical, and computational sciences. Key theoretical contributions include:
      - **Holland's Echo and classifier systems** (John Holland, University of Michigan, 1975-1995): formal models of agent adaptation through rule-based classifier systems with [[Genetic Algorithm|genetic algorithm]] credit assignment, establishing the connection between machine learning and CAS adaptation. Holland's "Adaptation in Natural and Artificial Systems" (1975) and "Hidden Order" (1995) are foundational CAS texts.
      - **Kauffman's NK model and fitness landscapes** (Stuart Kauffman, SFI, 1987-1993): random Boolean networks and NK spin-glass models of genetic regulatory networks demonstrated that adaptation on rugged fitness landscapes produces CAS dynamics including [[Phase Transition|phase transitions]], [[Self-Organisation]], and the edge-of-chaos regime. "The Origins of Order" (1993) remains the definitive treatment of fitness landscape CAS theory.
      - **Langton's edge of chaos** (Chris Langton, SFI, 1990): computation and [[Emergence]] are maximised at the boundary between ordered and chaotic [[Cellular Automata|cellular automaton]] dynamics — the "edge of chaos" — which has become the heuristic for understanding where CAS self-organise in parameter space. Related to [[Self-Organised Criticality]] (Bak, Tang, Wiesenfeld, 1987) which proposes that many natural CAS self-tune to the critical point.
      ...
      - **Levin's ecological CAS** (Simon Levin, Princeton, 1992-present): application of CAS theory to [[Ecosystems|ecosystem]] dynamics, demonstrating that ecosystem resilience and pattern formation are emergent CAS properties. Levin's paper "The problem of pattern and scale in ecology" (Ecology, 1992) is the most cited ecological paper applying CAS principles. His "Fragile Dominion" (1999) extended the analysis to social-ecological CAS management.
      - **Epstein and Axtell's Sugarscape** (Brookings Institution, 1996): the most comprehensive early demonstration that complex social phenomena — trade, wealth inequality, [[Epidemiology|epidemics]], cultural transmission, conflict — can emerge from simple agent-environment interaction rules in an ABM, founding the "generative social science" programme.
      - **Grimm et al.'s ODD Protocol** (2006, updated 2010, 2020): standardised description format for CAS [[Agent-Based Modelling|agent-based models]] enabling reproducibility, comparison, and meta-analysis across disciplines — the methodological infrastructure that made CAS ABM a rigorous science rather than a collection of anecdotal simulations.
  ...
  - ## Canonical Simulations and Benchmark Models
    ...
    - **Schelling's Segregation Model (1971)**: A micro-to-macro CAS bridge model showing that strong residential racial segregation can [[Emergence|emerge]] from mild individual preferences for neighbours of similar type — no individual intends the macro pattern but it arises inevitably from local interaction rules.
    ...
    - **Axelrod's Spatial Prisoner's Dilemma (1984, extended 1997)**: Population of agents playing iterated Prisoner's Dilemma on a spatial grid, showing that cooperation can be evolutionarily stable through [[Co-Evolution|co-evolutionary]] cluster formation even when individually costly.
    - **Kauffman NK Model (1987-1993)**: Random Boolean networks with K neighbours per node, parameterised by K to explore ordered, critical ([[Self-Organised Criticality|edge-of-chaos]]), and chaotic regimes in genetic regulatory network dynamics — the standard fitness landscape CAS model for evolutionary [[Adaptation]].
    ...
    - **NetLogo Wolf-Sheep Predation Model**: Standard educational CAS ABM demonstrating [[Ecosystems|ecosystem]] predator-prey dynamics, [[Phase Transition|phase transitions]] between stable equilibrium and extinction states, and sensitivity to initial population ratios.
  ...
  - ## Policy and Governance Implications
    ...
    - **Feedback loop fidelity**: CAS governance requires that [[Feedback Loop|feedback loops]] carry accurate, timely, and actionable signals from system state to decision-makers. Information asymmetries, delayed reporting, and metric gaming (Goodhart's Law: when a measure becomes a target it ceases to be a good measure) degrade [[Feedback Loop|feedback loop]] quality and prevent adaptive governance from functioning. Designing feedback systems that resist gaming and maintain fidelity is a critical CAS governance challenge.
  ...
  - ## Cross-Domain Applications: Quick Reference
    ...
    - **Climate systems**: Permafrost thaw, ice sheet collapse, Amazon dieback, polycentric adaptation governance — framed as CAS [[Phase Transition|tipping point]] cascades in Earth System Boundaries framework.
...
- ### Provenance
  - sources:: Holland (1975, 1995); Kauffman (1993); Bak Tang Wiesenfeld (1987); Langton (1990); Barabasi Albert (1999); Mitchell (2009); Miller and Page (2007); Frontiers in Complex Systems (2024, 2026); Santa Fe Institute; arxiv:2506.01839v2; arxiv:2511.17332v2; University of Huddersfield (2024) pure.hud.ac.uk; UCL CASA arXiv:2411.08015; University of Manchester DACAS; University of St Andrews CAS group
