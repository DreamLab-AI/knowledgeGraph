schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/robotics#DeltaRobot
legacy_uri:: urn:visionclaw:concept:robotics:delta-robot
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-33a57b2828e0"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/robotics#DeltaRobot"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:robotics:delta-robot"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
