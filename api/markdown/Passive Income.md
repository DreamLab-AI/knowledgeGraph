...
```json-ld
{ "@context":"https://narrativegoldmine.com/ns/v1", "@id":"urn:visionflow:page:passive-income", "@type":"Page", "title":"Passive Income", "vc:slug":"passive-income", "vc:public":true, "vc:schemaVersion":2, "vc:outboundWikilinks":[] }
```
