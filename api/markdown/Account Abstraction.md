- ### OntologyBlock
  id:: bc-account-abstraction-ontology
  collapsed:: true
	- ontology:: true
	- term-id:: BC-0038-EXT
	- preferred-term:: Account Abstraction
	- alternative-terms:: Smart Contract Wallet Standard, ERC-4337, Programmable Account Model, User Operation Framework, Bundler Network, Account Recovery Standard, Gasless Transaction Framework, Social Recovery Wallet
	- source-domain:: bc
	...
	- source:: [[ERC-4337 Ethereum Improvement Proposal March 2023]], [[Vitalik Buterin Account Abstraction Roadmap]], [[Ethereum Foundation Account Abstraction Documentation]], [[Bundler Network Statistics]], [[Safe Wallet Documentation]], [[Argent Wallet Architecture]], [[Biconomy SDK]], [[Stackup Analytics]], [[Alchemy Account Kit]], [[ZeroDev Documentation]]
	- owl:class:: bc:AccountAbstraction
	- owl:role:: InfrastructureComponent
	- owl:inferred-class:: bc:EthereumStandard
	- belongsToDomain:: [[BlockchainDomain]], [[SmartContractDomain]], [[Web3Domain]]
	- implementedInLayer:: [[ApplicationLayer]], [[ProtocolLayer]]

- #### Relationships
  id:: bc-account-abstraction-relationships
	...
	- related-to:: [[Smart Contract Wallet]], [[Multi-Signature Wallet]], [[Externally Owned Account]], [[Contract Account]], [[Wallet Infrastructure]]
	- implements:: [[ERC-4337]], [[Account Model]], [[UserOperation Mempool]], [[Gas Sponsorship]]
	- supports:: [[DApp Integration]], [[Web2 Onboarding]], [[Automated Trading]], [[DAO Governance]], [[NFT Management]]

- #### OWL Axioms
  id:: bc-account-abstraction-owl-axioms
  collapsed:: true
	- ```clojure
	  Prefix(bc:=<http://purl.org/blockchain/core#>)
	  Prefix(owl:=<http://www.w3.org/2002/07/owl#>)
	  Prefix(rdfs:=<http://www.w3.org/2000/01/rdf-schema#>)
	  Prefix(xsd:=<http://www.w3.org/2001/XMLSchema#>)
	  Prefix(dcterms:=<http://purl.org/dc/terms/>)

	  Ontology(<http://purl.org/blockchain/core/BC-0038-EXT>

	    Declaration(Class(bc:AccountAbstraction))

	    ## Taxonomic Relationships
	    SubClassOf(bc:AccountAbstraction bc:EthereumStandard)
	    SubClassOf(bc:AccountAbstraction bc:SmartContractInfrastructure)
	    SubClassOf(bc:AccountAbstraction bc:WalletTechnology)
	    SubClassOf(bc:AccountAbstraction bc:UserExperienceLayer)

	    ## Compositional Relationships (ERC-4337 Architecture)
	    SubClassOf(bc:AccountAbstraction
	      ObjectSomeValuesFrom(bc:hasPart bc:UserOperation))
	    SubClassOf(bc:AccountAbstraction
	      ObjectSomeValuesFrom(bc:hasPart bc:EntryPointContract))
	    SubClassOf(bc:AccountAbstraction
	      ObjectSomeValuesFrom(bc:hasPart bc:Bundler))
	    SubClassOf(bc:AccountAbstraction
	      ObjectSomeValuesFrom(bc:hasPart bc:PaymasterContract))
	    SubClassOf(bc:AccountAbstraction
	      ObjectSomeValuesFrom(bc:hasPart bc:AccountFactory))
	    SubClassOf(bc:AccountAbstraction
	      ObjectSomeValuesFrom(bc:hasPart bc:SignatureAggregator))
	    SubClassOf(bc:AccountAbstraction
	      ObjectSomeValuesFrom(bc:hasPart bc:UserOperationMempool))

	    ## Dependency Relationships
	    SubClassOf(bc:AccountAbstraction
	      ObjectSomeValuesFrom(bc:requires bc:SmartContract))
	    SubClassOf(bc:AccountAbstraction
	      ObjectSomeValuesFrom(bc:requires bc:EVM))
	    SubClassOf(bc:AccountAbstraction
	      ObjectSomeValuesFrom(bc:requires bc:SignatureVerification))
	    SubClassOf(bc:AccountAbstraction
	      ObjectSomeValuesFrom(bc:requires bc:GasAbstraction))
	    SubClassOf(bc:AccountAbstraction
	      ObjectSomeValuesFrom(bc:dependsOn bc:ERC4337))
	    SubClassOf(bc:AccountAbstraction
	      ObjectSomeValuesFrom(bc:dependsOn bc:BundlerNetwork))
	    SubClassOf(bc:AccountAbstraction
	      ObjectSomeValuesFrom(bc:dependsOn bc:PaymasterInfrastructure))

	    ## Capability Relationships
	    SubClassOf(bc:AccountAbstraction
	      ObjectSomeValuesFrom(bc:enables bc:SocialRecovery))
	    SubClassOf(bc:AccountAbstraction
	      ObjectSomeValuesFrom(bc:enables bc:GaslessTransactions))
	    SubClassOf(bc:AccountAbstraction
	      ObjectSomeValuesFrom(bc:enables bc:BatchOperations))
	    SubClassOf(bc:AccountAbstraction
	      ObjectSomeValuesFrom(bc:enables bc:SessionKeys))
	    SubClassOf(bc:AccountAbstraction
	      ObjectSomeValuesFrom(bc:enables bc:ProgrammableValidation))
	    SubClassOf(bc:AccountAbstraction
	      ObjectSomeValuesFrom(bc:supports bc:DAppIntegration))
	    SubClassOf(bc:AccountAbstraction
	      ObjectSomeValuesFrom(bc:supports bc:Web2Onboarding))
	    SubClassOf(bc:AccountAbstraction
	      ObjectSomeValuesFrom(bc:supports bc:AutomatedTrading))

	    ## Association Relationships
	    SubClassOf(bc:AccountAbstraction
	      ObjectSomeValuesFrom(bc:relatedTo bc:SmartContractWallet))
	    SubClassOf(bc:AccountAbstraction
	      ObjectSomeValuesFrom(bc:relatedTo bc:MultiSignatureWallet))
	    SubClassOf(bc:AccountAbstraction
	      ObjectSomeValuesFrom(bc:relatedTo bc:ExternallyOwnedAccount))
	    SubClassOf(bc:AccountAbstraction
	      ObjectSomeValuesFrom(bc:implements bc:ERC4337))
	    SubClassOf(bc:AccountAbstraction
	      ObjectSomeValuesFrom(bc:implements bc:AccountModel))
	    SubClassOf(bc:AccountAbstraction
	      ObjectSomeValuesFrom(bc:implements bc:UserOperationMempool))

	    ## Data Properties (Statistics as of January 2025)
	    DataPropertyAssertion(bc:hasIdentifier bc:AccountAbstraction "BC-0038-EXT"^^xsd:string)
	    DataPropertyAssertion(bc:authorityScore bc:AccountAbstraction "0.87"^^xsd:decimal)
	    DataPropertyAssertion(bc:totalAccounts bc:AccountAbstraction "2400000"^^xsd:integer)
	    DataPropertyAssertion(bc:assetsUnderManagement bc:AccountAbstraction "840000000"^^xsd:decimal)
	    DataPropertyAssertion(bc:dailyActiveWallets bc:AccountAbstraction "18000"^^xsd:integer)
	    DataPropertyAssertion(bc:supportedChains bc:AccountAbstraction "30"^^xsd:integer)
	    DataPropertyAssertion(bc:gasSavingsPercentage bc:AccountAbstraction "40-60"^^xsd:string)
	    DataPropertyAssertion(bc:bundlerCount bc:AccountAbstraction "150"^^xsd:integer)
	    DataPropertyAssertion(bc:entrypointAddress bc:AccountAbstraction "0x5FF137D4b0FDCD49DcA30c7CF57E578a026d2789"^^xsd:string)

	    ## Annotations
	    AnnotationAssertion(rdfs:label bc:AccountAbstraction "Account Abstraction"@en)
	    AnnotationAssertion(rdfs:comment bc:AccountAbstraction "ERC-4337 standard enabling smart contract wallets with programmable validation, gas sponsorship, and social recovery through UserOperation mempool architecture, eliminating EOA limitations and supporting 2.4M accounts with $840M assets as of January 2025."@en)
	    AnnotationAssertion(dcterms:identifier bc:AccountAbstraction "BC-0038-EXT"^^xsd:string)
	  )
...
- ## About Account Abstraction
  id:: bc-account-abstraction-about
	...
	### ERC-4337 Architecture Components
	  id:: bc-account-abstraction-architecture
	...
	### Enabling Use Cases
	  id:: bc-account-abstraction-use-cases
	...
	### Current Adoption Statistics (January 2025)
	  id:: bc-account-abstraction-adoption
...
## Academic Context
  id:: bc-account-abstraction-academic
...
## Current Landscape (2025)
  id:: bc-account-abstraction-landscape
...
## Research & Literature
  id:: bc-account-abstraction-research
...
## Future Directions
  id:: bc-account-abstraction-future
