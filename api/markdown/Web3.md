schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/ontology#Web3
legacy_uri:: urn:visionclaw:concept:blockchain:web3
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-03fc4d5ff706"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/ontology#Web3"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:web3"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:web3:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[EIP-4361]]",
      "resolved": "urn:visionflow:linked:eip-4361",
      "kind": "StubLink"
    },
    {
      "raw": "[[EIP-7702]]",
    ...
    {
      "raw": "[[Phantom Wallet]]",
      "resolved": "urn:visionflow:linked:phantom-wallet",
      "kind": "StubLink"
    },
    {
      "raw": "[[Rainbow Wallet]]",
    ...
    {
      "raw": "[[Solid Project]]",
      "resolved": "urn:visionflow:linked:solid-project",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Web2]]",
      "resolved": "urn:visionflow:linked:web2",
      "kind": "StubLink"
    },
    {
...
- ### Definition
  - Web3 is a blockchain-anchored paradigm for the decentralised web, first coined by Ethereum co-founder Gavin Wood in his April 2014 essay "DApps: What Web 3.0 Looks Like", that reconceives the internet as a zero-trust interaction system eliminating the need to trust any individual institution or platform. It assembles four architectural primitives: (1) trustless static content publication via content-addressed storage (IPFS, Filecoin), (2) a pseudonymous low-level messaging layer (Whisper / Waku), (3) a consensus engine executing programmable smart contracts on public blockchains (primarily Ethereum), and (4) an integrated user interface bridging browser-native wallets to on-chain state—together enabling a "read-write-own" internet where users hold cryptographic keys to their own assets, identity, and data rather than delegating custody to centralised intermediaries. The dominant execution layer is Ethereum and its growing ecosystem of Layer 2 rollups (Arbitrum, Optimism, Base, zkSync); beyond the Ethereum stack, alternative ecosystems include Solana (high-throughput single-chain), Polkadot (Gavin Wood's substrate-based parachain relay), Cosmos (IBC interoperability), and Bitcoin's emerging L2/L3 layers. Account abstraction (ERC-4337, GA 2023; EIP-7702 Pectra upgrade May 2025) transforms externally owned accounts into programmable smart accounts capable of gas sponsorship, batch transactions, social recovery, and passkey authentication. Decentralised identity anchors on the Ethereum Name Service (ENS, 85%+ market share in on-chain naming), W3C Decentralised Identifiers (DIDs), and Sign-In with Ethereum (EIP-4361). Decentralised finance (DeFi) encompasses automated market-maker DEXs (Uniswap, Curve), lending protocols (Aave, Compound), and derivatives; non-fungible tokens (NFTs) encode verifiable digital ownership; decentralised autonomous organisations (DAOs) implement on-chain governance. Restaking protocols (EigenLayer, $18B+ TVL 2026) extend Ethereum's cryptoeconomic security to Actively Validated Services (AVS). Persistent critiques—notably Moxie Marlinspike's January 2022 essay documenting re-centralisation around API providers (Infura, Alchemy) and NFT metadata hosting (OpenSea)—challenge the degree to which Web3's decentralisation thesis is realised in practice. The 2024-2026 agentic turn intersects AI agents with on-chain identity, account abstraction, and smart-contract execution, producing an emerging "agentic Web3" layer.

- ### Semantic Classification
  - owl-class:: blockchain:Web3
  - owl-role:: ArchitecturalParadigm
  - owl-inferred:: blockchain:DecentralisedWeb, blockchain:SmartContractPlatform, blockchain:DigitalSovereignty
  - belongs-to-domain:: [[BlockchainDomain]], [[DistributedSystemsDomain]], [[DigitalIdentityDomain]]
  - implemented-in-layer:: [[ProtocolLayer]], [[ApplicationLayer]], [[InfrastructureLayer]]
...
- ### Relationships
  ...
  - related-to:: [[Bitcoin Technical Overview]], [[Blockchain As A Service]], [[Decentralised Identity]], [[Agent Frameworks]], [[Agentic Internet]]
  - standardized-by:: [[Ethereum Foundation]], [[W3C]], [[IETF]], [[OpenZeppelin]]
...
- ### Provenance
  - sources:: gavwood.com/dappsweb3.html (Gavin Wood 2014 original essay); moxie.org/2022/01/07/web3-first-impressions.html (Marlinspike 2022 critique); blog.ethereum.org/2025/04/23/pectra-mainnet (Ethereum Foundation Pectra announcement); eips.ethereum.org/EIPS/eip-4337 (ERC-4337 specification); eips.ethereum.org/EIPS/eip-7702 (EIP-7702 specification); ethereum.org/roadmap/account-abstraction/ (Ethereum account abstraction roadmap); alchemy.com/blog/erc-4337-statistics-q3-2023 (ERC-4337 adoption statistics); messari.io/report/state-of-filecoin-q1-2025 (Filecoin Q1 2025 state); fil.org/blog/filecoin-foundation-2024-annual-report (Filecoin 2024 annual report); blockeden.xyz/blog/2026/01/13/farcaster-vs-lens-socialfi-web3-social-graph/ (Farcaster vs Lens 2026); blockeden.xyz/blog/2026/03/20/eigenlayer-18b-tvl-vertical-avs-specialization-restaking-evolution/ (EigenLayer AVS 2026); outlierventures.io/research/outlier-ventures-imperial-colleges-blockchain-lab-ic3re-sign-3-year-agreement-to-explore-convergence-of-blockchain-deep-tech/ (Outlier Ventures × Imperial IC3RE partnership); esma.europa.eu/sites/default/files/2025-07/ESMA50-481369926-29744_Maximal_Extractable_Value_Implications_for_crypto_markets.pdf (ESMA MEV report 2025); wikipedia.org/wiki/Web3 (Web3 overview); chain.link/education/web3 (Chainlink Web3 definition)
  - migration-date:: 2026-04-26T00:00:00Z
  - enriched-date:: 2026-05-17T12:00:00Z
  - enrichment-model:: claude-sonnet-4-6
  - enrichment-phase:: 6
  - research-cache:: _enrich/research-cache/Web3.json
