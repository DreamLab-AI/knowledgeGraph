...
```json-ld
{
  ...
  "@id": "urn:visionflow:page:space-data-centers",
  "@type": "Page",
...
```json-ld
{
  ...
  "@id": "urn:ngm:class:space-data-centers",
  "@type": "Class",
  "label": "Space Data Centers",
  "definition": "Orbital infrastructure designed to host high-density AI compute clusters, leveraging space-based energy and thermal management to scale beyond terrestrial constraints.",
