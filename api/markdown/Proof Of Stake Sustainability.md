schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#ProofOfStakeSustainability
legacy_uri:: urn:visionclaw:concept:blockchain:proof-of-stake-sustainability
public:: true
...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "proof-of-stake-sustainability",
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:ieee-p2418-5",
      "vc:label": "IEEE P2418.5"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-8c6cdfd94aca"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#ProofOfStakeSustainability"
    },
    {
    ...
    },
    {
      ...
      "vc:value": "Proof Of Stake Sustainability"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:proof-of-stake-sustainability"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:proof-of-stake-sustainability:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[Delegation Protocol]]",
      "resolved": "urn:visionflow:linked:delegation-protocol",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[IEEE P2418.5]]",
      "resolved": "urn:visionflow:linked:ieee-p2418-5",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Staking Mechanism]]",
      "resolved": "urn:visionflow:linked:staking-mechanism",
      "kind": "StubLink"
    },
    {
      "raw": "[[Sustainable Virtual Infrastructure]]",
      "resolved": "urn:visionflow:linked:sustainable-virtual-infrastructure",
      "kind": "StubLink"
    },
    {
      "raw": "[[Validator]]",
    ...
    {
      "raw": "[[Validator Infrastructure]]",
      "resolved": "urn:visionflow:linked:validator-infrastructure",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Green Blockchain Initiatives]]",
      "resolved": "urn:visionflow:owl:class:green-blockchain-initiatives",
      "kind": "ResolvedLink"
    },
    {
      "raw": "[[Mining]]",
    ...
    },
    {
      ...
      "resolved": "urn:visionflow:owl:class:reward-distribution",
      "kind": "ResolvedLink"
    },
    {
      "raw": "[[Solana]]",
    ...
    {
      "raw": "[[Sustainable Consensus]]",
      "resolved": "urn:visionflow:owl:class:sustainable-consensus",
      "kind": "ResolvedLink"
    },
    {
      "raw": "[[Token Economics]]",
