...
- has-part:: [[Content Authoring System]]
- has-part:: [[Collaboration Tool]]
- has-part:: [[Learning Analytics]]
- has-part:: [[Assessment System]]
- requires:: [[Identity Management]]
- requires:: [[Network Infrastructure]]
- requires:: [[Avatar System]]
- requires:: [[3D Rendering Engine]]
- enables:: [[Remote Education]]
- enables:: [[Skills Training]]
- enables:: [[Immersive Learning]]
- enables:: [[Virtual Field Trip]]
- enables:: [[Collaborative Learning]]
- depends-on:: [[Spatial Audio]]
- depends-on:: [[XR Device]]
- depends-on:: [[Educational Content]]
- depends-on:: [[Gesture Recognition]]
