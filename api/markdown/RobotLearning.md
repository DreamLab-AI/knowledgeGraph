- ### OntologyBlock
  ...
  collapsed:: true
	...
	- alternative-terms:: Robot Learning, Machine Learning for Robotics, Robotic Machine Learning
	- source-domain:: rb
	...
	- source:: [[IEEE Robotics and Automation]], [[Association for the Advancement of Artificial Intelligence (AAAI)]], [[Conference on Robot Learning (CoRL)]], [[International Conference on Learning Representations (ICLR)]]
	- owl:class:: rb:RobotLearning
	- owl:role:: TechnicalDiscipline
	- is-subclass-of:: [[MachineLearning]], [[ArtificialIntelligence]], [[Robotics]]
	- belongsToDomain:: [[RoboticsDomain]], [[AIDomain]]
	...
	- related-to:: [[DeepLearning]], [[ComputerVision]], [[MotionPlanning]], [[HumanRobotInteraction]]
...
(AnnotationAssertion rdfs:comment :RobotLearning "The application of machine learning algorithms and artificial intelligence techniques to enable robots to acquire new skills, adapt to changing environments, and improve performance through experience, encompassing supervised learning, reinforcement learning, and self-supervised learning for perception, control, planning, and human-robot interaction."@en)

;; Data Properties
(AnnotationAssertion dcterms:identifier :RobotLearning "RB-3000"^^xsd:string)

;; SubClass relationships
(SubClassOf :RobotLearning :MachineLearning)
(SubClassOf :RobotLearning :ArtificialIntelligence)
(SubClassOf :RobotLearning :RoboticsTechnology)

;; Object properties
(SubClassOf :RobotLearning
  (ObjectSomeValuesFrom :hasPart :ImitationLearning))
(SubClassOf :RobotLearning
  (ObjectSomeValuesFrom :hasPart :ReinforcementLearning))
(SubClassOf :RobotLearning
  (ObjectSomeValuesFrom :enables :AdaptiveControl))
(SubClassOf :RobotLearning
...
- ## About RobotLearning
	...
	- ### References
	  ...
	  - **Verification**: Academic sources verified, 2026 state-of-the-art coverage
	  - **Regional Context**: UK/North England robot learning ecosystem
	  - **Authority Score**: 0.89 (IEEE, academic consensus, industry validation)
