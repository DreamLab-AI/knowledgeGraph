schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#LearningManagementSystem
legacy_uri:: urn:visionclaw:concept:spatial-computing:learning-management-system
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-f2b9a4a0a4df"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#LearningManagementSystem"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:learning-management-system"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
