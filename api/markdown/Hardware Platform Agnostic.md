schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#HardwarePlatformAgnostic
legacy_uri:: urn:visionclaw:concept:spatial-computing:hardware-platform-agnostic
public:: true
...
```json-ld
{
  ...
  "@id": "urn:visionflow:page:915431e8835894eb154595d8a83a7889bba5eab7409bcb2180c67ebd0820d1fb",
  "@type": "Page",
  "vc:slug": "hardware-platform-agnostic",
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-f0e4bdab068e"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#HardwarePlatformAgnostic"
    },
    {
    ...
    },
    {
      ...
      "vc:value": "Hardware Platform Agnostic"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:hardware-platform-agnostic"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:915431e8835894eb154595d8a83a7889bba5eab7409bcb2180c67ebd0820d1fb@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
```json-ld
{
  ...
  "@type": "Class",
  "label": "Hardware Platform Agnostic",
  "definition": "A design principle and architectural quality ensuring that software, systems, or protocols can operate independently of specific hardware architectures or platform implementations.",
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:hardware-platform-agnostic:776c802a9fc9",
