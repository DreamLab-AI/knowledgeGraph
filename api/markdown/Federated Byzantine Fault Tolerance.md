schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#FederatedByzantineFaultTolerance
legacy_uri:: urn:visionclaw:concept:blockchain:federated-byzantine-fault-tolerance
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-d54f09f6ac57"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#FederatedByzantineFaultTolerance"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:federated-byzantine-fault-tolerance"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
