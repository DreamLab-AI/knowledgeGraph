schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/robotics#IndustrialRobot
legacy_uri:: urn:visionclaw:concept:robotics:industrial-robot
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-c7f34a2e81b5"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/robotics#IndustrialRobot"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:robotics:industrial-robot"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:industrial-robot:776c802a9fc9",
  ...
  "vc:resolutions": [
    {
      "raw": "[[Automotive Manufacturing]]",
      "resolved": "urn:visionflow:linked:automotive-manufacturing",
      "kind": "StubLink"
    },
    {
      "raw": "[[Autonomous Mobile Robot]]",
      "resolved": "urn:visionflow:linked:autonomous-mobile-robot",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Collaborative Automation]]",
      "resolved": "urn:visionflow:linked:collaborative-automation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Computer Numerical Control]]",
      "resolved": "urn:visionflow:linked:computer-numerical-control",
      "kind": "StubLink"
    },
    {
      "raw": "[[ControlLayer]]",
    ...
    {
      "raw": "[[Electromechanical Systems]]",
      "resolved": "urn:visionflow:linked:electromechanical-systems",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[EN 60204]]",
      "resolved": "urn:visionflow:linked:en-60204",
      "kind": "StubLink"
    },
    {
      "raw": "[[EtherCAT]]",
    ...
    {
      "raw": "[[Fixed Automation]]",
      "resolved": "urn:visionflow:linked:fixed-automation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Flexible Manufacturing]]",
      "resolved": "urn:visionflow:linked:flexible-manufacturing",
      "kind": "StubLink"
    },
    {
      "raw": "[[Food Processing Automation]]",
      "resolved": "urn:visionflow:linked:food-processing-automation",
      "kind": "StubLink"
    },
    {
      "raw": "[[High Speed Assembly]]",
      "resolved": "urn:visionflow:linked:high-speed-assembly",
      "kind": "StubLink"
    },
    {
      "raw": "[[IEC 62061]]",
    ...
    {
      "raw": "[[Industrial Network]]",
      "resolved": "urn:visionflow:linked:industrial-network",
      "kind": "StubLink"
    },
    {
      "raw": "[[ISO 10218]]",
    ...
    {
      "raw": "[[Manual Assembly]]",
      "resolved": "urn:visionflow:linked:manual-assembly",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[MQTT Protocol]]",
      "resolved": "urn:visionflow:linked:mqtt-protocol",
      "kind": "StubLink"
    },
    {
      "raw": "[[OPC UA]]",
    ...
    {
      "raw": "[[Pharmaceutical Manufacturing]]",
      "resolved": "urn:visionflow:linked:pharmaceutical-manufacturing",
      "kind": "StubLink"
    },
    {
      "raw": "[[PROFINET]]",
    ...
    {
      "raw": "[[Programmable Logic Controller]]",
      "resolved": "urn:visionflow:linked:programmable-logic-controller",
      "kind": "StubLink"
    },
    {
      "raw": "[[Quality Inspection]]",
      "resolved": "urn:visionflow:linked:quality-inspection",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Robot Controller]]",
      "resolved": "urn:visionflow:linked:robot-controller",
      "kind": "StubLink"
    },
    {
      "raw": "[[ROS Industrial]]",
    ...
    {
      "raw": "[[Teleoperation Systems]]",
      "resolved": "urn:visionflow:owl:class:teleoperation-systems",
      "kind": "ResolvedLink"
    },
    {
...
- ### Definition
  - Industrial Robot is a reprogrammable, automatically controlled manipulator programmable in three or more axes, fixed in place or mobile, for use in industrial automation applications as defined by ISO 8373:2012. Industrial robots are electromechanical systems integrating articulated kinematic chains, servo-driven joints, and real-time motion controllers to perform high-precision manufacturing tasks — welding, assembly, material handling, painting, palletising, machining, inspection — with cycle repeatabilities of ±0.01–±0.05 mm at throughputs unattainable by human labour. Major kinematic families span six-axis articulated arms (KUKA KR series, ABB IRB series, FANUC M-series, Yaskawa Motoman GP/MA, Stäubli RX/TX), four-axis SCARA robots (Epson T-series, ABB IRB 910SC, Yamaha YK-XG) for high-speed horizontal assembly at ≤0.006 mm repeatability, Delta/parallel robots (FANUC M-1iA, ABB IRB 360 FlexPicker) for pick-and-place at 150+ picks/minute in food and pharmaceutical lines, Cartesian gantry systems for CNC machine loading and large-panel handling, and the rapidly growing collaborative robot (cobot) segment (Universal Robots UR3e/UR5e/UR10e/UR20, Doosan A-series, Techman TM12S, FANUC CRX-10iA) operating force-limited at ≤150 W under ISO/TS 15066 power-and-force-limiting (PFL) mode without hard guarding. The International Federation of Robotics (IFR) World Robotics 2024 report recorded 590,000 new industrial robot installations in 2023 — the second highest annual figure ever — with a global operational stock of 4.28 million units; Asia commands 74% of installations (China 276,000 alone, overtaking all other regions combined since 2013). Payload ranges span micro cobots (3 kg, UR3e) through mid-range welding robots (20–80 kg) to heavy-duty foundry and automotive press-transfer arms (1,300 kg, KUKA KR 1000 TITAN). Software ecosystems include ROS-Industrial (ROS 2 Humble/Iron, MoveIt 2, Nav2), OPC UA/MQTT-based connectivity for IIoT integration, NVIDIA Isaac Sim/GROOT N1 foundation model for robot learning from human demonstrations (released January 2026), and Covariant Brain (acquired by Amazon August 2024) for generalised pick-and-place intelligence in e-commerce fulfilment. Safety regulation is governed by ISO 10218-1/2 (robot hardware and integration) and ISO/TS 15066 (collaborative operation), with UK adoption via BS EN ISO 10218 and HSE PUWER 98 compliance enforced by the Health and Safety Executive.

- ### Semantic Classification
  - owl-class:: robotics:IndustrialRobot
  - owl-role:: ManufacturingSystem
  - owl-inferred:: robotics:AutomatedMachine, robotics:ReprogrammableMachine, robotics:ManipulatorSystem
  - belongs-to-domain:: [[RoboticsDomain]], [[ManufacturingDomain]], [[IndustrialAutomationDomain]]
  - implemented-in-layer:: [[PhysicalLayer]], [[ControlLayer]], [[ApplicationLayer]]

- ### Relationships
  - is-subclass-of:: [[Robotics Systems]], [[Manufacturing Automation]], [[Electromechanical Systems]], [[Cyber Physical Systems]], [[Programmable Logic Controller]]
  - has-part:: [[Robot Controller]], [[End Effector]], [[Servo Drive]], [[Joint Encoder]], [[Kinematic Chain]], [[Safety System]], [[Teach Pendant]], [[Force Torque Sensor]]
  ...
  - related-to:: [[Computer Numerical Control]], [[Teleoperation Systems]], [[Ground Robot]], [[Hydraulic Actuator]], [[Machine Vision]]
  - standardized-by:: [[ISO 10218]], [[ISO TS 15066]], [[IEC 62061]], [[ISO 9283]], [[EN 60204]]
...
- ### Content
  ...
  ## Compositional Relationships (Components)
	  ...
	  FunctionalDataProperty(rob:minRepeatabilityMm)
	  FunctionalDataProperty(rob:globalInstallations2023)
	  ```
  ...
  - ### Cobot vs Traditional Industrial Robot: Decision Framework
    ...
    | Factor | Traditional Robot (Caged) | Collaborative Robot (PFL mode) |
    |--------|--------------------------|-------------------------------|
    | Cycle time | Unlimited speed (2–4 m/s TCP) | ≤250 mm/s in human proximity |
    | Payload | 3 kg – 2,300 kg | 3 kg – 35 kg (typical) |
    | Repeatability | ±0.01–±0.05 mm | ±0.02–±0.05 mm |
    | Programming | Specialist required (KRL/RAPID/Karel) | Non-specialist capable (PolyScope, hand guiding) |
    | Workcell footprint | Large (safety fence 1–2 m perimeter) | Compact (table-top deployable) |
    | Capital cost | £30K–£500K+ installed | £15K–£80K installed |
    | ROI timeline | 18–36 months (automotive) | 12–24 months (SME general assembly) |
    | Changeover time | Hours (mechanical retooling) | Minutes (software + end-effector swap) |
    | Human access during operation | Prohibited (gate interlocks) | Permitted in PFL mode |
    | Applicable standard | ISO 10218-1/2 | ISO 10218 + ISO/TS 15066 |
  ...
  - ### UK Context
    ...
    **Industrial Deployment Examples**:
    ...
    - **Renishaw, Wotton-under-Edge**: uses own CMM probing technology with FANUC machine-tending robots for additive manufacturing (SLM) part inspection and post-processing automation
  ...
  - ### Future Directions (2026-2030)
    ...
    **Physical AI and Dexterous Manipulation**:
    ...
    - Projected commercial tactile gripper availability sub-$500/unit: 2027; sub-$200/unit: 2029
  ...
  - ## Controller Architecture and Programming Environments
    ...
    **Offline Programming (OLP)** platforms — RoboDK (Python-based, vendor-neutral, $1,500–$5,000/seat), Siemens Process Simulate (Tecnomatix), ABB RobotStudio, KUKA.Sim, FANUC Roboguide — enable programme development against imported CAD/CAM data (STEP, STL, DXF) without tying up physical robot assets. Typical commissioning time reduction from OLP: 30–50% versus on-robot teach-and-test methods. Post-2023 platforms integrate simulation-to-reality calibration using robot metrology (laser tracker Leica AT960, API Tracker3) to compensate for installation position errors and gravity-induced structural deflections.
