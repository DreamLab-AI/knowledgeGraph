...
```json-ld
{
  ...
  "vc:public": true,
  "vc:outboundWikilinks": ["Sanctions", "Scott Bessent", "US-China AI Policy"],
  "vc:schemaVersion": 2
}
```
...
```json-ld
{
  ...
  "relations": {
    "relatedTo": [{"@id": "urn:ngm:class:large-language-models", "label": "Large Language Models"}, {"@id": "urn:ngm:class:model-training", "label": "Model Training"}]
  },
  "provenance": {
