schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/ethics-society#TrustAndSafety
legacy_uri:: urn:visionclaw:concept:ethics-society:trust-and-safety
public:: true
...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:operations-layer",
      "vc:label": "OperationsLayer"
    },
    {
      "@id": "urn:visionflow:linked:platform-governance-domain",
      "vc:label": "PlatformGovernanceDomain"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:regulatory-compliance-layer",
      "vc:label": "RegulatoryComplianceLayer"
    },
    {
      "@id": "urn:visionflow:linked:technical-infrastructure-layer",
      "vc:label": "TechnicalInfrastructureLayer"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-b92e471a8fd3"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/ethics-society#TrustAndSafety"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:ethics-society:trust-and-safety"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:trust-and-safety:776c802a9fc9",
  ...
  "vc:resolutions": [
    {
      ...
      "resolved": "urn:visionflow:linked:classifier-model",
      "kind": "StubLink"
    },
    {
      "raw": "[[CSAM Detection]]",
      "resolved": "urn:visionflow:linked:csam-detection",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Hash Matching]]",
      "resolved": "urn:visionflow:linked:hash-matching",
      "kind": "StubLink"
    },
    {
      "raw": "[[Human Review Pipeline]]",
      "resolved": "urn:visionflow:linked:human-review-pipeline",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Online Safety]]",
      "resolved": "urn:visionflow:linked:online-safety",
      "kind": "StubLink"
    },
    {
      "raw": "[[OperationsLayer]]",
      "resolved": "urn:visionflow:linked:operations-layer",
      "kind": "StubLink"
    },
    {
      "raw": "[[PlatformGovernanceDomain]]",
      "resolved": "urn:visionflow:linked:platform-governance-domain",
      "kind": "StubLink"
    },
    {
      "raw": "[[Platform Integrity]]",
      "resolved": "urn:visionflow:linked:platform-integrity",
      "kind": "StubLink"
    },
    {
      "raw": "[[PolicyLayer]]",
    ...
    {
      "raw": "[[RegulatoryComplianceLayer]]",
      "resolved": "urn:visionflow:linked:regulatory-compliance-layer",
      "kind": "StubLink"
    },
    {
      "raw": "[[TechnicalInfrastructureLayer]]",
      "resolved": "urn:visionflow:linked:technical-infrastructure-layer",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Jailbreaking]]",
      "resolved": "urn:visionflow:owl:class:jailbreaking",
      "kind": "ResolvedLink"
    },
    {
...
- ### Definition
  - Trust and Safety (T&S) is the professional discipline, operational infrastructure, and regulatory framework that governs the detection, review, enforcement, and remediation of harmful content and abusive behaviour across digital platforms, encompassing the full spectrum from child sexual abuse material (CSAM) detection and terrorist content removal through election integrity protection, hate speech moderation, fraud prevention, and platform integrity operations, implemented through a layered architecture combining automated classifiers (PhotoDNA perceptual hashing for known CSAM matching generating robust 1152-bit signatures that survive image transformations via DCT-based processing, Hive Moderation VLM detecting 40+ policy violation classes through Moderation 11B fine-tuned on Llama 3.2 11B Vision, Sightengine covering 110+ moderation classes with 99.2% F1 on specific categories, large platform proprietary transformer-based classifiers, and LLM-based moderation emerging as the next-generation paradigm surpassing traditional NLP on nuanced policy violations per Springer 2025 review), human review pipelines (outsourced moderation operations in Philippines, Kenya, Colombia, and India processing hundreds of millions of items per day under documented extreme psychological duress — 140+ Kenyan Sama/Meta moderators sued for PTSD and psychological trauma in 2024, UNI Global Union launched Global Trade Union Alliance of Content Moderators in Nairobi with mental health protocol adoption across nine countries, over 81% of moderators reporting insufficient employer mental health support), content moderation operations at scale (Meta approximately 40,000 staff in safety and security, TikTok 40,000+ moderation staff globally with automated systems removing 96%+ of policy violations pre-view in 2024, X/Twitter approximately 2,000 T&S staff remaining from original ~7,500 after post-Musk acquisition cuts, YouTube 10,000+ human reviewers supplemented by ML), industry coordination coalitions (Global Internet Forum to Counter Terrorism GIFCT maintaining Hash-Sharing Database for terrorist and violent extremist content with Year 4 review 2024-2025 examining legacy hash format interoperability challenges, Tech Coalition managing Project Lantern cross-platform CSAM signal-sharing program with approximately 300,000 hashes shared by December 2023 representing 40% of program signal volume, NCMEC CyberTipline receiving 36.2 million reports from electronic service providers in 2023, Thorn SSVH Scene-Sensitive Video Hashing adopted by most Tech Coalition members as primary video perceptual hash by 2024), professional bodies (Trust and Safety Professional Association TSPA as 501(c)(6) non-partisan membership organisation adding 400+ new members from 55 countries in first seven months of 2024, hosting first India community event in Hyderabad, SXSW Austin meetup, and 300-person EMEA Summit in Dublin, with structured curriculum spanning content moderation operations/policy development/product trust/legal compliance), open-source tooling initiatives (ROOST non-profit launching February 2025 at Paris AI Action Summit with $27 million from Google, OpenAI, Discord, and Roblox, releasing Osprey investigation and incident response tool donated by Discord and Coop signal-sharing platform based on Cove acquired IP in July 2025, operationalising the DIRE framework: Detection, Investigation, Review, Enforcement, with Bluesky as inaugural Osprey adopter demonstrating democratisation of safety infrastructure beyond large-platform incumbents), and an accelerating regulatory landscape including UK Online Safety Act 2023 administered by Ofcom (illegal content risk assessments required by 16 December 2024 with compliance deadline 17 March 2025, fines up to 10% of global revenue or £18 million whichever greater, Protection of Children Codes entering Parliament April 2025 and coming into force 25 July 2025, full OSA implementation expected by 2026-2027), EU Digital Services Act with 23 Very Large Online Platforms and 2 Very Large Online Search Engines designated by mid-2024 including Shein, Pornhub, Stripchat, XVideos, and Temu newly designated April-May 2024 alongside existing Meta, X, TikTok, Google, YouTube designees, Commission enforcement authority carrying fines up to 6% of global annual turnover with preliminary X findings on dark patterns and advertising transparency issued July 2024, and national frameworks across 40+ jurisdictions, all operationalised through emerging professional standards, technical specifications, and welfare protections for the largely invisible human infrastructure sustaining platform safety at civilisational scale.

- ### Semantic Classification
  - owl-class:: ethics-society:TrustAndSafety
  - owl-role:: OperationalDiscipline
  - owl-inferred:: ethics-society:ContentModeration, ethics-society:PlatformGovernance, ethics-society:DigitalSafety, ethics-society:OnlineSafety
  - belongs-to-domain:: [[EthicsAndSocietyDomain]], [[PlatformGovernanceDomain]], [[DigitalRightsDomain]]
  - implemented-in-layer:: [[PolicyLayer]], [[OperationsLayer]], [[TechnicalInfrastructureLayer]], [[RegulatoryComplianceLayer]]

- ### Relationships
  - is-subclass-of:: [[Digital Society Harms]], [[Platform Governance]], [[Online Safety]], [[Content Moderation]], [[AI Ethics]], [[Data Protection]]
...
- ### Content
  ...
  - ### Tier 1: Automated Detection
    ...
    - **NLP and Vision Classifiers**: The primary tools for non-CSAM policy violation detection.
      ...
      - Content moderation API market valued $1,446 million in 2024, projected $2,687 million by 2032 at 10.5% CAGR
...
- ### Provenance
  - sources:: Klonick 2017 Harvard Law Review; Suzor 2019 Cambridge University Press; Roberts 2019 Yale University Press; Citron 2022 W.W. Norton; Gorwa et al. 2020 Big Data & Society; Tech Coalition Lantern Transparency Report 2023; Tech Coalition CSAM Update 2024; Tech Coalition VHIP 2024; GIFCT HSDB Year 4 Review 2025; Ofcom OSA Statement December 2024; Ofcom OSA Roadmap October 2024; Ofcom Protection of Children Codes 2025; EU DSA Enforcement Overview 2024; IWF Annual Report 2024; TSPA Leading the T&S Community 2024; ROOST Coop Osprey launch July 2025; Hive AI Moderation 11B 2024; Xu et al. arXiv 2024; Lun & Kumar Springer 2025; Brennan Center 2024; Equidem 2024; CNN Kenya litigation 2024; Atlantic Council T&S Landscape 2023; McQuade 2024 Seven Stories Press
