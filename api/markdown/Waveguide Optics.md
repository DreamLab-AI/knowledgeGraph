...
```json-ld
{
  ...
  "@id": "urn:visionflow:page:waveguide-optics",
  "@type": "Page",
  "vc:slug": "waveguide-optics",
...
```json-ld
{
  ...
  "relations": {
    "relatedTo": [{"@id": "urn:ngm:class:ar-frame", "label": "AR Frame"}, {"@id": "urn:ngm:class:mixed-reality", "label": "Mixed Reality"}]
  },
  "quality": 0.72
}
```
