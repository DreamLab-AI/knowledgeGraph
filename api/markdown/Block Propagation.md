schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#BlockPropagation
legacy_uri:: urn:visionclaw:concept:blockchain:block-propagation
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-3dc1a213391d"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#BlockPropagation"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:block-propagation"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
