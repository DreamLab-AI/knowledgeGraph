schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#Blake2
legacy_uri:: urn:visionclaw:concept:blockchain:blake2
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-f705812161c4"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#Blake2"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:blake2"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:fd3ca58621fe1804c6e79f179c4420714f2c490374382787a5af61dc7c299935@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:blake2",
  "@type": "OntologyClass",
  "label": "BLAKE2",
  "subClassOf": [
    {
