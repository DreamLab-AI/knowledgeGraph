schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#RESEARCHSUMMARY
legacy_uri:: urn:visionclaw:concept:spatial-computing:researchsummary
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-2ab0450b2b9a"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#RESEARCHSUMMARY"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:researchsummary"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:c9e86f541eda44ec5b12dadfd38556064721b45d1df7a28633ed3136b28f713b@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:research-summary",
  "@type": "OntologyClass",
  ...
  "definition": "A comprehensive synthesis document aggregating research findings, literature reviews, and academic insights across [[Metaverse]], [[Blockchain]], [[ArtificialIntelligence]], and [[Robotics]] domains. This summary distils empirical evidence, theoretical frameworks, and future research directions for stakeholders.",
  "vc:qualityScore": {
    "@value": "0.50",
    "@type": "xsd:float"
  },
