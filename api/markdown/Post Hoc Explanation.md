schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#PostHocExplanation
legacy_uri:: urn:visionclaw:concept:spatial-computing:post-hoc-explanation
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-ca8913a04f2f"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#PostHocExplanation"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:post-hoc-explanation"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
