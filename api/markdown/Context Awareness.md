schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#ContextAwareness
legacy_uri:: urn:visionclaw:concept:spatial-computing:context-awareness
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-479462f7142a"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#ContextAwareness"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:context-awareness"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
