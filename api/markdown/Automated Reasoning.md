...
```json-ld
{
  ...
  "relations": {
    ...
    "enables": [
      ...
      {"@id": "urn:ngm:class:ontology-inference", "label": "Ontology Inference"},
      {"@id": "urn:ngm:class:program-synthesis", "label": "Program Synthesis"}
    ],
    "uses": [
      {"@id": "urn:ngm:class:resolution-principle", "label": "Resolution Principle"},
    ...
    "bridgesTo": [
      {"@id": "urn:ngm:class:smart-contract-verification", "label": "Smart Contract Verification"},
