schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#ETSIDomainSecurityAndPrivacy
legacy_uri:: urn:visionclaw:concept:spatial-computing:etsi-domain-security-and-privacy
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-0fdbe3b0a003"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#ETSIDomainSecurityAndPrivacy"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:etsi-domain-security-and-privacy"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
