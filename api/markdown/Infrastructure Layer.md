schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#InfrastructureLayer
legacy_uri:: urn:visionclaw:concept:infrastructure:infrastructure-layer
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-6557c7880bf1"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#InfrastructureLayer"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:infrastructure-layer"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
