...
```json-ld
{
  ...
  "vc:public": true,
  "vc:outboundWikilinks": ["Bitter Lesson", "Bloomberg GPT"],
  "vc:schemaVersion": 2
}
```
...
```json-ld
{
  ...
  "relations": {
    "relatedTo": [{"@id": "urn:ngm:class:large-language-models", "label": "Large Language Models"}, {"@id": "urn:ngm:class:vertical-ai-models", "label": "Vertical AI Models"}]
  },
  "provenance": {
