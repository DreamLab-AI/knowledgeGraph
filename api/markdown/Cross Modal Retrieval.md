```json-ld
{
  ...
  "@id": "urn:visionflow:page:cross-modal-retrieval",
  "@type": "Page",
  "title": "Cross Modal Retrieval",
  "vc:slug": "cross-modal-retrieval",
  "vc:public": true,
  "vc:schemaVersion": 2,
...
- At inference, a query of either type is encoded once and matched against a precomputed [private] of the opposite modality.
- ### Mechanisms
