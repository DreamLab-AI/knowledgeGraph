schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#AdaptiveVirtualWorld
legacy_uri:: urn:visionclaw:concept:spatial-computing:adaptive-virtual-world
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-bff9b3e19101"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#AdaptiveVirtualWorld"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:adaptive-virtual-world"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
