schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#FastSpatialQueries
legacy_uri:: urn:visionclaw:concept:spatial-computing:fast-spatial-queries
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-337e99e5ca86"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#FastSpatialQueries"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:fast-spatial-queries"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
