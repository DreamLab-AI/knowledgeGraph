schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#NPCInteraction
legacy_uri:: urn:visionclaw:concept:spatial-computing:npc-interaction
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-4185bbc8e8ac"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#NPCInteraction"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:npc-interaction"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
