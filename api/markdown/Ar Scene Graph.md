schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#ArSceneGraph
legacy_uri:: urn:visionclaw:concept:spatial-computing:ar-scene-graph
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-a0fec42e7ce2"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#ArSceneGraph"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:ar-scene-graph"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
