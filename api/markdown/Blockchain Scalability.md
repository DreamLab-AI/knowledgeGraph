schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#BlockchainScalability
legacy_uri:: urn:visionclaw:concept:blockchain:blockchain-scalability
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-1a426a12f563"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#BlockchainScalability"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:blockchain-scalability"
    },
    {
      "vc:key": "status",
      "vc:value": "active"
