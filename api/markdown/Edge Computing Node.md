schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#EdgeComputingNode
legacy_uri:: urn:visionclaw:concept:spatial-computing:edge-computing-node
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-ce934961e9ce"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#EdgeComputingNode"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:edge-computing-node"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
