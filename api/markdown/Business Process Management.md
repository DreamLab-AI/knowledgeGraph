...
```json-ld
{
  ...
  "relations": {
    ...
    "uses": [{"@id": "urn:ngm:class:service-oriented-architecture", "label": "Service Oriented Architecture"}],
    "relatedTo": [{"@id": "urn:ngm:class:compliance-management", "label": "Compliance Management"}]
  },
  "quality": 0.8
}
```
