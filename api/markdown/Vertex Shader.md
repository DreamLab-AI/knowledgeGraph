schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#VertexShader
legacy_uri:: urn:visionclaw:concept:spatial-computing:vertex-shader
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-3f837f40fbde"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#VertexShader"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:vertex-shader"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:ae1e4f2db3c2ad50ad5f27e3fcb9554c2404811375041a77a3bbd96935c2ca71@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
```json-ld
{
  ...
  "definition": "Vertex Shader is a concept within the mv domain.",
  "vc:qualityScore": {
    "@value": "0.50",
    "@type": "xsd:float"
  },
