```json-ld
{
  ...
  "@id": "urn:visionflow:page:cypher-query-language",
  "@type": "Page",
  "title": "Cypher Query Language",
  "vc:slug": "cypher-query-language",
  "vc:public": true,
  "vc:schemaVersion": 2,
...
```json-ld
{
  ...
  "relations": {
    ...
    "implements": [
      ...
      {
        "@id": "urn:ngm:class:declarative-programming",
...
- ### Mechanisms
  - Query planning: execution engine decomposes MATCH patterns into [private] lookups, label scans, and expand operations.
