...
```clojure
;; Machine Learning Ontology (OWL Functional Syntax)
;; Term ID: AI-0002
...
(SubClassOf :MachineLearning :ComputationalStatistics)

;; Annotations
(AnnotationAssertion rdfs:label :MachineLearning "Machine Learning"@en)
(AnnotationAssertion rdfs:comment :MachineLearning
  "Process enabling computational systems to understand data and gain knowledge from experience without being explicitly programmed"@en)
(AnnotationAssertion :isoReference :MachineLearning "ISO/IEC 22989:2022, Clause 3.1.8")
(AnnotationAssertion :nistReference :MachineLearning "NIST AI 100-3, Glossary")
(AnnotationAssertion :authorityScore :MachineLearning "0.95"^^xsd:float)
(AnnotationAssertion :priorityLevel :MachineLearning "1"^^xsd:integer)

;; Object Properties
(SubClassOf :MachineLearning
  (ObjectSomeValuesFrom :requiresInput :TrainingData))
(SubClassOf :MachineLearning
  (ObjectSomeValuesFrom :produces :Model))
(SubClassOf :MachineLearning
  (ObjectSomeValuesFrom :employs :LearningAlgorithm))
(SubClassOf :MachineLearning
  (ObjectSomeValuesFrom :demonstrates :PerformanceImprovement))

;; Data Properties
(DataPropertyAssertion :learningApproach :MachineLearning "data_driven"^^xsd:string)
(DataPropertyAssertion :requiresExplicitProgramming :MachineLearning "false"^^xsd:boolean)
(DataPropertyAssertion :improvesWithExperience :MachineLearning "true"^^xsd:boolean)

;; Disjoint Classes
(DisjointClasses :MachineLearning :RuleBasedAI :ExpertSystem)

;; Property Declarations
(Declaration (ObjectProperty :requiresInput))
(ObjectPropertyDomain :requiresInput :MachineLearning)
(ObjectPropertyRange :requiresInput :TrainingData)

(Declaration (ObjectProperty :produces))
(ObjectPropertyDomain :produces :MachineLearning)
(ObjectPropertyRange :produces :Model)

(Declaration (DataProperty :learningApproach))
(DataPropertyDomain :learningApproach :MachineLearning)
(DataPropertyRange :learningApproach xsd:string)
```
</details>
...
id:: machine-learning-recent-developments
