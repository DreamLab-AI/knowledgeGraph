schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#SceneUnderstanding
legacy_uri:: urn:visionclaw:concept:spatial-computing:scene-understanding
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-cc83146f9f76"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#SceneUnderstanding"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:scene-understanding"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:23e8c6a7809c228cada34b05c2293c8a782ff93cce5b1cb4f2ce60e9e200fd27@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
```json-ld
{
  ...
  "definition": "Scene Understanding is the high-level semantic interpretation of visual and sensor data to comprehend the structure, context, objects, relationships, and dynamics of an environment.",
