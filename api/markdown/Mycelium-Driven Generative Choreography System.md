...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "mycelium-driven-generative-choreography-system",
...
```json-ld
{
  ...
  "@id": "urn:ngm:class:mycelium-driven-generative-choreography-system",
  "@type": "Class",
  "label": "Mycelium-Driven Generative Choreography System",
