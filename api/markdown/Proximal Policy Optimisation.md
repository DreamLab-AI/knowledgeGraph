schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#ProximalPolicyOptimisation
legacy_uri:: urn:visionclaw:concept:spatial-computing:proximal-policy-optimisation
public:: true
...
```json-ld
{
  ...
  "@id": "urn:visionflow:page:21bdcf55cffcb5b4a81c4f1f28f44d290347b71a0924fabeaea9dac29dcefc27",
  "@type": "Page",
  "vc:slug": "proximal-policy-optimisation",
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-85976c621e17"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#ProximalPolicyOptimisation"
    },
    {
    ...
    },
    {
      ...
      "vc:value": "Proximal Policy Optimisation"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:proximal-policy-optimisation"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:21bdcf55cffcb5b4a81c4f1f28f44d290347b71a0924fabeaea9dac29dcefc27@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:proximal-policy-optimisation:776c802a9fc9",
