...
- ### Content
  - Synthetix mints synthetic assets, commonly called synths, that mirror the price of an underlying reference such as a fiat currency, commodity, or [private]. Stakers lock collateral to back a shared debt pool, and price feeds from oracles determine the value of each synth at the point of trade.
