schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#PrivacyPreservingBlockchain
legacy_uri:: urn:visionclaw:concept:blockchain:privacy-preserving-blockchain
public:: true
...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "privacy-preserving-blockchain",
  "title": "Privacy Preserving Blockchain",
  "vc:public": true,
  "vc:outboundWikilinks": [
    {
      "@id": "urn:visionflow:linked:action-spending-authority",
      "vc:label": "Action Spending Authority"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:ariel-gabizon",
      "vc:label": "Ariel Gabizon"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:bae-systems-applied-intelligence",
      "vc:label": "BAE Systems Applied Intelligence"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:beam",
      "vc:label": "Beam"
    },
    {
      "@id": "urn:visionflow:linked:bisq",
      "vc:label": "Bisq"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:brakedown",
      "vc:label": "Brakedown"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:chainanalysis",
      "vc:label": "Chainanalysis"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:comit",
      "vc:label": "COMIT"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:crystal-dilithium",
      "vc:label": "CRYSTAL-Dilithium"
    },
    {
      "@id": "urn:visionflow:linked:dan-boneh",
      "vc:label": "Dan Boneh"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:digital-institute",
      "vc:label": "Digital Institute"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:eae-tor-integration",
      "vc:label": "EAE-Tor integration"
    },
    {
      "@id": "urn:visionflow:linked:eli-ben-sasson",
      "vc:label": "Eli Ben-Sasson"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:ernst-and-young",
      "vc:label": "Ernst & Young"
    },
    {
      "@id": "urn:visionflow:linked:eu-ebsi",
      "vc:label": "EU EBSI"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:european-central-bank",
      "vc:label": "European Central Bank"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:halo-2",
      "vc:label": "Halo 2"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:haveno-dex",
      "vc:label": "Haveno DEX"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:information-security-research-group",
      "vc:label": "Information Security Research Group"
    },
    {
      "@id": "urn:visionflow:linked:input-output",
      "vc:label": "Input Output"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:ivan-damg-rd",
      "vc:label": "Ivan Damgård"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:local-monero",
      "vc:label": "LocalMonero"
    },
    {
      "@id": "urn:visionflow:linked:lwe",
      "vc:label": "LWE"
    },
    {
      "@id": "urn:visionflow:linked:manchester-city-council",
      "vc:label": "Manchester City Council"
    },
    {
      "@id": "urn:visionflow:linked:merkle",
      "vc:label": "Merkle"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:nightfall",
      "vc:label": "Nightfall"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:northern-powerhouse-partnership",
      "vc:label": "Northern Powerhouse Partnership"
    },
    {
      "@id": "urn:visionflow:linked:ntru",
      "vc:label": "NTRU"
    },
    {
      "@id": "urn:visionflow:linked:nu-cypher",
      "vc:label": "NuCypher"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:office-of-foreign-assets-control",
      "vc:label": "Office of Foreign Assets Control"
    },
    {
      "@id": "urn:visionflow:linked:onyx",
      "vc:label": "Onyx"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:pedersen",
      "vc:label": "Pedersen"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:privacy-engineering-domain",
      "vc:label": "PrivacyEngineeringDomain"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:range-proofs",
    ...
    {
      "@id": "urn:visionflow:linked:ring-signatures",
      "vc:label": "Ring Signatures"
    },
    {
      "@id": "urn:visionflow:linked:sean-bowe",
      "vc:label": "Sean Bowe"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:seraphis",
      "vc:label": "Seraphis"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:ssi",
      "vc:label": "SSI"
    },
    {
      "@id": "urn:visionflow:linked:stark-ware",
      "vc:label": "StarkWare"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:stealth-addresses",
      "vc:label": "Stealth Addresses"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:triptych",
      "vc:label": "Triptych"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:universal-composability",
      "vc:label": "Universal Composability"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:zcash-community-grants",
      "vc:label": "Zcash Community Grants"
    },
    {
      "@id": "urn:visionflow:linked:zcashd",
      "vc:label": "zcashd"
    },
    {
      "@id": "urn:visionflow:linked:zebrad",
      "vc:label": "zebrad"
    },
    {
  ...
  "vc:legacyProperties": [
    {
      ...
      "vc:value": "Privacy Coins, Confidential Blockchain, Shielded Ledger, Anonymous Blockchain, Private DLT"
    },
    {
    ...
    {
      "vc:key": "bridges-to",
      "vc:value": "[[Zero-Knowledge Proofs]], [[Cryptography]], [[Regulatory Compliance]]"
    },
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-7cec4f156421"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#PrivacyPreservingBlockchain"
    },
    {
    ...
    },
    {
      ...
      "vc:value": "Privacy Preserving Blockchain"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:privacy-preserving-blockchain"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:privacy-preserving-blockchain:776c802a9fc9",
  ...
  "vc:resolutions": [
    {
      "raw": "[[Action Spending Authority]]",
      "resolved": "urn:visionflow:linked:action-spending-authority",
      "kind": "StubLink"
    },
    {
      "raw": "[[Aleo]]",
    ...
    {
      "raw": "[[Anonymous Transactions]]",
      "resolved": "urn:visionflow:linked:anonymous-transactions",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Ariel Gabizon]]",
      "resolved": "urn:visionflow:linked:ariel-gabizon",
      "kind": "StubLink"
    },
    {
      "raw": "[[Aztec]]",
    ...
    {
      "raw": "[[BAE Systems Applied Intelligence]]",
      "resolved": "urn:visionflow:linked:bae-systems-applied-intelligence",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Beam]]",
      "resolved": "urn:visionflow:linked:beam",
      "kind": "StubLink"
    },
    {
      "raw": "[[Bisq]]",
      "resolved": "urn:visionflow:linked:bisq",
      "kind": "StubLink"
    },
    {
      "raw": "[[BLAKE3]]",
    ...
    {
      "raw": "[[Brakedown]]",
      "resolved": "urn:visionflow:linked:brakedown",
      "kind": "StubLink"
    },
    {
      "raw": "[[Bulletproofs+]]",
    ...
    {
      "raw": "[[Bulletproofs Range Proof]]",
      "resolved": "urn:visionflow:linked:bulletproofs-range-proof",
      "kind": "StubLink"
    },
    {
      "raw": "[[Celestia]]",
    ...
    {
      "raw": "[[Chainanalysis]]",
      "resolved": "urn:visionflow:linked:chainanalysis",
      "kind": "StubLink"
    },
    {
      "raw": "[[CipherTrace]]",
    ...
    {
      "raw": "[[COMIT]]",
      "resolved": "urn:visionflow:linked:comit",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Compliance Proofs]]",
      "resolved": "urn:visionflow:linked:compliance-proofs",
      "kind": "StubLink"
    },
    {
      "raw": "[[Confidential Assets]]",
      "resolved": "urn:visionflow:linked:confidential-assets",
      "kind": "StubLink"
    },
    {
      "raw": "[[Confidential DeFi]]",
      "resolved": "urn:visionflow:linked:confidential-de-fi",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[CRYSTAL-Dilithium]]",
      "resolved": "urn:visionflow:linked:crystal-dilithium",
      "kind": "StubLink"
    },
    {
      "raw": "[[Dan Boneh]]",
      "resolved": "urn:visionflow:linked:dan-boneh",
      "kind": "StubLink"
    },
    {
      "raw": "[[Dash]]",
    ...
    {
      "raw": "[[Decoy Outputs]]",
      "resolved": "urn:visionflow:linked:decoy-outputs",
      "kind": "StubLink"
    },
    {
      "raw": "[[Digital Institute]]",
      "resolved": "urn:visionflow:linked:digital-institute",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[EAE-Tor integration]]",
      "resolved": "urn:visionflow:linked:eae-tor-integration",
      "kind": "StubLink"
    },
    {
      "raw": "[[Eli Ben-Sasson]]",
      "resolved": "urn:visionflow:linked:eli-ben-sasson",
      "kind": "StubLink"
    },
    {
      "raw": "[[Elliptic]]",
    ...
    {
      "raw": "[[Elliptic Curve Discrete Logarithm Problem]]",
      "resolved": "urn:visionflow:linked:elliptic-curve-discrete-logarithm-problem",
      "kind": "StubLink"
    },
    {
      "raw": "[[Ernst & Young]]",
      "resolved": "urn:visionflow:linked:ernst-and-young",
      "kind": "StubLink"
    },
    {
      "raw": "[[EU EBSI]]",
      "resolved": "urn:visionflow:linked:eu-ebsi",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[European Central Bank]]",
      "resolved": "urn:visionflow:linked:european-central-bank",
      "kind": "StubLink"
    },
    {
      "raw": "[[EZKL]]",
    ...
    {
      "raw": "[[FRI]]",
      "resolved": "urn:visionflow:linked:fri",
      "kind": "StubLink"
    },
    {
      "raw": "[[GDPR]]",
    ...
    {
      "raw": "[[Grin]]",
      "resolved": "urn:visionflow:linked:grin",
      "kind": "StubLink"
    },
    {
      "raw": "[[Groth16]]",
    ...
    {
      "raw": "[[Groth16 zk-SNARK]]",
      "resolved": "urn:visionflow:linked:groth16-zk-snark",
      "kind": "StubLink"
    },
    {
      "raw": "[[Halo 2]]",
      "resolved": "urn:visionflow:linked:halo-2",
      "kind": "StubLink"
    },
    {
      "raw": "[[Halo 2 Recursive Proof]]",
      "resolved": "urn:visionflow:linked:halo-2-recursive-proof",
      "kind": "StubLink"
    },
    {
      "raw": "[[Haveno DEX]]",
      "resolved": "urn:visionflow:linked:haveno-dex",
      "kind": "StubLink"
    },
    {
      "raw": "[[Healthcare Data Privacy]]",
      "resolved": "urn:visionflow:linked:healthcare-data-privacy",
      "kind": "StubLink"
    },
    {
      "raw": "[[HIPAA]]",
    ...
    {
      "raw": "[[IEEE P2418.1]]",
      "resolved": "urn:visionflow:linked:ieee-p2418-1",
      "kind": "StubLink"
    },
    {
      "raw": "[[Information Security Research Group]]",
      "resolved": "urn:visionflow:linked:information-security-research-group",
      "kind": "StubLink"
    },
    {
      "raw": "[[Input Output]]",
      "resolved": "urn:visionflow:linked:input-output",
      "kind": "StubLink"
    },
    {
      "raw": "[[Iron Fish]]",
      "resolved": "urn:visionflow:linked:iron-fish",
      "kind": "StubLink"
    },
    {
      "raw": "[[Ivan Damgård]]",
      "resolved": "urn:visionflow:linked:ivan-damg-rd",
      "kind": "StubLink"
    },
    {
      "raw": "[[Jens Groth]]",
    ...
    {
      "raw": "[[Knowledge-of-Exponent Assumption]]",
      "resolved": "urn:visionflow:linked:knowledge-of-exponent-assumption",
      "kind": "StubLink"
    },
    {
      "raw": "[[LocalMonero]]",
      "resolved": "urn:visionflow:linked:local-monero",
      "kind": "StubLink"
    },
    {
      "raw": "[[LWE]]",
      "resolved": "urn:visionflow:linked:lwe",
      "kind": "StubLink"
    },
    {
      "raw": "[[Manchester City Council]]",
      "resolved": "urn:visionflow:linked:manchester-city-council",
      "kind": "StubLink"
    },
    {
      "raw": "[[Merkle]]",
      "resolved": "urn:visionflow:linked:merkle",
      "kind": "StubLink"
    },
    {
      "raw": "[[Merkle Tree Accumulator]]",
      "resolved": "urn:visionflow:linked:merkle-tree-accumulator",
      "kind": "StubLink"
    },
    {
      "raw": "[[MimbleWimble]]",
    ...
    {
      "raw": "[[MimbleWimble Protocol]]",
      "resolved": "urn:visionflow:linked:mimble-wimble-protocol",
      "kind": "StubLink"
    },
    {
      "raw": "[[Mina Protocol]]",
    ...
    {
      "raw": "[[MWEB]]",
      "resolved": "urn:visionflow:linked:mweb",
      "kind": "StubLink"
    },
    {
      "raw": "[[Namada]]",
      "resolved": "urn:visionflow:linked:namada",
      "kind": "StubLink"
    },
    {
      "raw": "[[Nightfall]]",
      "resolved": "urn:visionflow:linked:nightfall",
      "kind": "StubLink"
    },
    {
      "raw": "[[NIST Post-Quantum Standards]]",
      "resolved": "urn:visionflow:linked:nist-post-quantum-standards",
      "kind": "StubLink"
    },
    {
      "raw": "[[Noir]]",
    ...
    {
      "raw": "[[Northern Powerhouse Partnership]]",
      "resolved": "urn:visionflow:linked:northern-powerhouse-partnership",
      "kind": "StubLink"
    },
    {
      "raw": "[[NTRU]]",
      "resolved": "urn:visionflow:linked:ntru",
      "kind": "StubLink"
    },
    {
      "raw": "[[NuCypher]]",
      "resolved": "urn:visionflow:linked:nu-cypher",
      "kind": "StubLink"
    },
    {
      "raw": "[[Nullifier Set]]",
      "resolved": "urn:visionflow:linked:nullifier-set",
      "kind": "StubLink"
    },
    {
      "raw": "[[Oasis Network]]",
    ...
    {
      "raw": "[[OFAC SDN Designations]]",
      "resolved": "urn:visionflow:linked:ofac-sdn-designations",
      "kind": "StubLink"
    },
    {
      "raw": "[[Office of Foreign Assets Control]]",
      "resolved": "urn:visionflow:linked:office-of-foreign-assets-control",
      "kind": "StubLink"
    },
    {
      "raw": "[[Onyx]]",
      "resolved": "urn:visionflow:linked:onyx",
      "kind": "StubLink"
    },
    {
      "raw": "[[Osmosis]]",
    ...
    {
      "raw": "[[Pedersen]]",
      "resolved": "urn:visionflow:linked:pedersen",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Pedersen Commitment Scheme]]",
      "resolved": "urn:visionflow:linked:pedersen-commitment-scheme",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Permissioned Blockchain Without Privacy]]",
      "resolved": "urn:visionflow:linked:permissioned-blockchain-without-privacy",
      "kind": "StubLink"
    },
    {
      "raw": "[[PLONK Proof System]]",
      "resolved": "urn:visionflow:linked:plonk-proof-system",
      "kind": "StubLink"
    },
    {
      "raw": "[[PrivacyEngineeringDomain]]",
      "resolved": "urn:visionflow:linked:privacy-engineering-domain",
      "kind": "StubLink"
    },
    {
      "raw": "[[Privacy Technology]]",
      "resolved": "urn:visionflow:linked:privacy-technology",
      "kind": "StubLink"
    },
    {
      "raw": "[[Proof System]]",
      "resolved": "urn:visionflow:linked:proof-system",
      "kind": "StubLink"
    },
    {
      "raw": "[[Public Transparent Blockchain]]",
      "resolved": "urn:visionflow:linked:public-transparent-blockchain",
      "kind": "StubLink"
    },
    {
      "raw": "[[Quorum]]",
    ...
    {
      "raw": "[[Railgun]]",
      "resolved": "urn:visionflow:linked:railgun",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Range Proofs]]",
      "resolved": "urn:visionflow:linked:range-proofs",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[RingCT Protocol]]",
      "resolved": "urn:visionflow:linked:ring-ct-protocol",
      "kind": "StubLink"
    },
    {
      "raw": "[[Ring Signature]]",
    ...
    {
      "raw": "[[Ring Signatures]]",
      "resolved": "urn:visionflow:linked:ring-signatures",
      "kind": "StubLink"
    },
    {
      "raw": "[[Sean Bowe]]",
      "resolved": "urn:visionflow:linked:sean-bowe",
      "kind": "StubLink"
    },
    {
      "raw": "[[Secret Network]]",
    ...
    {
      "raw": "[[Secure Enclaves]]",
      "resolved": "urn:visionflow:linked:secure-enclaves",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Seraphis]]",
      "resolved": "urn:visionflow:linked:seraphis",
      "kind": "StubLink"
    },
    {
      "raw": "[[Shielded Pool]]",
      "resolved": "urn:visionflow:linked:shielded-pool",
      "kind": "StubLink"
    },
    {
      "raw": "[[Spend Key]]",
      "resolved": "urn:visionflow:linked:spend-key",
      "kind": "StubLink"
    },
    {
      "raw": "[[SSI]]",
      "resolved": "urn:visionflow:linked:ssi",
      "kind": "StubLink"
    },
    {
      "raw": "[[StarkWare]]",
      "resolved": "urn:visionflow:linked:stark-ware",
      "kind": "StubLink"
    },
    {
      "raw": "[[Stealth Address]]",
      "resolved": "urn:visionflow:linked:stealth-address",
      "kind": "StubLink"
    },
    {
      "raw": "[[Stealth Addresses]]",
      "resolved": "urn:visionflow:linked:stealth-addresses",
      "kind": "StubLink"
    },
    {
      "raw": "[[Supply Chain Confidentiality]]",
      "resolved": "urn:visionflow:linked:supply-chain-confidentiality",
      "kind": "StubLink"
    },
    {
      "raw": "[[Tornado Cash]]",
    ...
    {
      "raw": "[[Triptych]]",
      "resolved": "urn:visionflow:linked:triptych",
      "kind": "StubLink"
    },
    {
      "raw": "[[TRM Labs]]",
    ...
    {
      "raw": "[[Trusted Setup Ceremony]]",
      "resolved": "urn:visionflow:linked:trusted-setup-ceremony",
      "kind": "StubLink"
    },
    {
      "raw": "[[Universal Composability]]",
      "resolved": "urn:visionflow:linked:universal-composability",
      "kind": "StubLink"
    },
    {
      "raw": "[[Viewing Key]]",
      "resolved": "urn:visionflow:linked:viewing-key",
      "kind": "StubLink"
    },
    {
      "raw": "[[Viewing Keys]]",
      "resolved": "urn:visionflow:linked:viewing-keys",
      "kind": "StubLink"
    },
    {
      "raw": "[[W3C DID]]",
    ...
    {
      "raw": "[[Zcash Community Grants]]",
      "resolved": "urn:visionflow:linked:zcash-community-grants",
      "kind": "StubLink"
    },
    {
      "raw": "[[zcashd]]",
      "resolved": "urn:visionflow:linked:zcashd",
      "kind": "StubLink"
    },
    {
      "raw": "[[zebrad]]",
      "resolved": "urn:visionflow:linked:zebrad",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Zero-Knowledge System]]",
      "resolved": "urn:visionflow:linked:zero-knowledge-system",
      "kind": "StubLink"
    },
    {
...
- ### Relationships
  ...
  - contrasts-with:: [[Bitcoin]], [[Ethereum]], [[Public Transparent Blockchain]], [[Permissioned Blockchain Without Privacy]], [[Central Bank Digital Currency]]
