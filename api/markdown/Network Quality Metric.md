schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#NetworkQualityMetric
legacy_uri:: urn:visionclaw:concept:spatial-computing:network-quality-metric
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-5691ec709ed1"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#NetworkQualityMetric"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:network-quality-metric"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:66650a8ac39b9e531a74218a30d60754334eea98a68d13c185f262ac737979d9@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
