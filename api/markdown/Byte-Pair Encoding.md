...
```clojure
(Declaration (Class :BytePairEncoding))
(AnnotationAssertion rdfs:label :BytePairEncoding "Byte-Pair Encoding"@en)
(AnnotationAssertion rdfs:comment :BytePairEncoding
  "A subword tokenisation algorithm that iteratively merges most frequent pairs to build vocabulary."@en)
(AnnotationAssertion :hasSource :BytePairEncoding
  "Sennrich et al., 'Neural Machine Translation of Rare Words', arXiv:1508.07909 (2015)"@en)

;; Taxonomic relationships
(SubClassOf :BytePairEncoding :SubwordTokenisation)
(SubClassOf :BytePairEncoding :TokenisationAlgorithm)

;; Process characteristics
(SubClassOf :BytePairEncoding
  (ObjectSomeValuesFrom :uses :FrequencyBasedMerging))
(SubClassOf :BytePairEncoding
  (ObjectSomeValuesFrom :produces :Vocabulary))
(SubClassOf :BytePairEncoding
  (ObjectSomeValuesFrom :creates :VariableLengthTokens))

;; Used in models
(SubClassOf :GPT
  (ObjectSomeValuesFrom :usesTokenisation :BytePairEncoding))
(SubClassOf :RoBERTa
  (ObjectSomeValuesFrom :usesTokenisation :BytePairEncoding))

;; Properties
(DataPropertyAssertion :isIterative :BytePairEncoding "true"^^xsd:boolean)
(DataPropertyAssertion :isDataDriven :BytePairEncoding "true"^^xsd:boolean)
(DataPropertyAssertion :handlesRareWords :BytePairEncoding "true"^^xsd:boolean)
(DataPropertyAssertion :originallyFor :BytePairEncoding "data compression"^^xsd:string)

;; Related algorithms
(DisjointClasses :BytePairEncoding :WordPiece)
(DisjointClasses :BytePairEncoding :SentencePiece)
```
