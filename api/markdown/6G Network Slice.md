schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#6GNetworkSlice
legacy_uri:: urn:visionclaw:concept:infrastructure:6g-network-slice
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-4d1a23526107"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#6GNetworkSlice"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:6g-network-slice"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
