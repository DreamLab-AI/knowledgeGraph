...
- ### Content
  ...
  - Early deep inpainting used **context encoders** (Pathak et al. CVPR 2016) with an adversarial loss to predict centre regions from surrounding context — the first demonstration that a network [private] generate semantically plausible content rather than blurring.
