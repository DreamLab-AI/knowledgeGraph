schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/ontology#MultiAgentRAGScrapbook
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:multi-agent-rag-scrapbook
public:: true
...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "multi-agent-rag-scrapbook",
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-b84e9858b40d"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/ontology#MultiAgentRAGScrapbook"
    },
    {
      "vc:key": "maturity",
      "vc:value": "draft"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:multi-agent-rag-scrapbook"
    },
    {
      "vc:key": "status",
      "vc:value": "stub"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:2c328d9baea19ddffd1a18a8791f67f6d8c6f3cb2c3b644268f2cf92d0efc3ea@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
```json-ld
{
  ...
  "definition": "Multi Agent RAG scrapbook is a concept within the ngm domain.",
  "vc:qualityScore": {
    "@value": "0.50",
    "@type": "xsd:float"
  },
