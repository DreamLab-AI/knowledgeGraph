...
# RB-0043: Torque
		  ...
		  **Torque** - Rotational force about an axis
		  ...
		  ```clojure
		  (Declaration (Class :Torque))
		  (SubClassOf :Torque :Robot)
		  
		  (AnnotationAssertion rdfs:label :Torque "Torque"@en)
		  (AnnotationAssertion rdfs:comment :Torque
		    "Torque - Foundational robotics concept"@en)
		  (AnnotationAssertion :termID :Torque "RB-0043"^^xsd:string)
		  
		  (Declaration (ObjectProperty :relates To))
		  (ObjectPropertyDomain :relatesTo :Torque)
		  
		  (Declaration (DataProperty :hasProperty))
		  (DataPropertyDomain :hasProperty :Torque)
