schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#ConsentManagement
legacy_uri:: urn:visionclaw:concept:infrastructure:consent-management
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-f59b40612d8a"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#ConsentManagement"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:consent-management"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
