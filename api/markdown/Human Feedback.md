...
```clojure
(Declaration (Class :HumanFeedback))
(SubClassOf :HumanFeedback :TrainingSignal)
(SubClassOf :HumanFeedback
  (ObjectSomeValuesFrom :providedBy :HumanEvaluators))
(SubClassOf :HumanFeedback
  (ObjectSomeValuesFrom :captures :HumanPreferences))
(SubClassOf :HumanFeedback
  (ObjectSomeValuesFrom :enables :AlignmentTraining))
(SubClassOf :HumanFeedback
  (ObjectSomeValuesFrom :formsTrainingSignalFor :RLHF))
(SubClassOf :HumanFeedback
  (ObjectSomeValuesFrom :hasModalities :Rankings))
(SubClassOf :HumanFeedback
  (ObjectSomeValuesFrom :hasModalities :Demonstrations))

(AnnotationAssertion rdfs:comment :HumanFeedback
  "Information provided by human evaluators about model outputs enabling alignment of AI systems with human preferences and values"@en)
(AnnotationAssertion :hasAcademicSource :HumanFeedback
  "RLHF and alignment literature; Ouyang et al., arXiv:2203.02155 (2022)")
```
