schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#DigitalTwinInteropProtocol
legacy_uri:: urn:visionclaw:concept:spatial-computing:digital-twin-interop-protocol
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-6736cfcc85ae"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#DigitalTwinInteropProtocol"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:digital-twin-interop-protocol"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
