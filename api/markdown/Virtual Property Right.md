...
- has-part:: [[Ownership Claim]]
- has-part:: [[Usage Permission]]
- has-part:: [[Exclusion Right]]
- has-part:: [[Enforcement System]]
- has-part:: [[Transfer Mechanism]]
...
- enables:: [[Virtual Asset Trading]]
- enables:: [[IP Protection]]
- enables:: [[Virtual Land Rights]]
- depends-on:: [[SmartContract]]
- depends-on:: [[Digital Signature]]
...
- Smart contracts enabling automated transfer and licencing conditions
