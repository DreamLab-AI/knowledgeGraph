schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#DigitalPerformanceCapture
legacy_uri:: urn:visionclaw:concept:spatial-computing:digital-performance-capture
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-90b9cb671344"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#DigitalPerformanceCapture"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:digital-performance-capture"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
