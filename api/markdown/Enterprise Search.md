...
- ### Content
  ...
  **Hybrid Retrieval (BM25 + Dense)**
  The current production standard. Combines BM25 and dense retrieval candidate sets via reciprocal rank fusion or learned aggregation. Consistently outperforms either method alone by 2–5 percent on NDCG@10 across diverse corpora. Requires maintenance of both inverted [private] and vector [private], with synchronised update pipelines.
