schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#SafetyFineTuning
legacy_uri:: urn:visionclaw:concept:spatial-computing:safety-fine-tuning
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-b7e00967414b"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#SafetyFineTuning"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:safety-fine-tuning"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
