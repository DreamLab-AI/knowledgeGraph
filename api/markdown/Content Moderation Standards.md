schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#ContentModerationStandards
legacy_uri:: urn:visionclaw:concept:spatial-computing:content-moderation-standards
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-56e52134a8e4"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#ContentModerationStandards"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:content-moderation-standards"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
