schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#HumanComputerInterface
legacy_uri:: urn:visionclaw:concept:spatial-computing:human-computer-interface
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-3bcc1a3b1d0f"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#HumanComputerInterface"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:human-computer-interface"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:947ca5e4bc6def01e7924ce2bdde15f8e6f9148809fe91932c44ddb05f019a68@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
