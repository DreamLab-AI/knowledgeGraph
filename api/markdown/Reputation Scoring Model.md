schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#ReputationScoringModel
legacy_uri:: urn:visionclaw:concept:spatial-computing:reputation-scoring-model
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-e66268f7c8c3"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#ReputationScoringModel"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:reputation-scoring-model"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
