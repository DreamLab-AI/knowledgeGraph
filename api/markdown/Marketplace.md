schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#Marketplace
legacy_uri:: urn:visionclaw:concept:spatial-computing:marketplace
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-b4e8fd3dcc29"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#Marketplace"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:marketplace"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
