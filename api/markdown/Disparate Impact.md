schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#DisparateImpact
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:disparate-impact
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-b7d18aaa0ecf"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#DisparateImpact"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:disparate-impact"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
