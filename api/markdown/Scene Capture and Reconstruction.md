schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/computer-vision#SceneCaptureAndReconstruction
legacy_uri:: urn:visionclaw:concept:computer-vision:scene-capture-and-reconstruction
public:: true
...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "scene-capture-and-reconstruction",
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:barron-et-al-2022-mip-ne-rf-360-cvpr",
      "vc:label": "Barron et al. 2022 Mip-NeRF-360 CVPR"
    },
    {
      "@id": "urn:visionflow:linked:barron-et-al-2023-zip-ne-rf-iccv",
      "vc:label": "Barron et al. 2023 Zip-NeRF ICCV"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:chen-et-al-2022-tenso-rf-eccv",
      "vc:label": "Chen et al. 2022 TensoRF ECCV"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:fei-et-al-2024-3-dgs-survey-ieee-tvcg",
      "vc:label": "Fei et al. 2024 3DGS Survey IEEE TVCG"
    },
    {
      "@id": "urn:visionflow:linked:gao-et-al-2024-ne-rf-survey-ieee-tpami",
      "vc:label": "Gao et al. 2024 NeRF Survey IEEE TPAMI"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:iso-19157-geographic-information-data-quality",
      "vc:label": "ISO 19157 Geographic Information Data Quality"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:keetha-et-al-2024-spla-tam-cvpr",
      "vc:label": "Keetha et al. 2024 SplaTAM CVPR"
    },
    {
      "@id": "urn:visionflow:linked:kerbl-2023-reality-capture-epic-games",
      "vc:label": "Kerbl 2023 RealityCapture Epic Games"
    },
    {
      "@id": "urn:visionflow:linked:kerbl-et-al-2023-3-d-gaussian-splatting-siggraph",
      "vc:label": "Kerbl et al. 2023 3D Gaussian Splatting SIGGRAPH"
    },
    {
      "@id": "urn:visionflow:linked:kerr-et-al-2023-lerf-iccv",
      "vc:label": "Kerr et al. 2023 LERF ICCV"
    },
    {
      "@id": "urn:visionflow:linked:leroy-et-al-2024-mast3-r-eccv",
      "vc:label": "Leroy et al. 2024 MASt3R ECCV"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:lorensen-and-cline-1987-marching-cubes-siggraph",
      "vc:label": "Lorensen & Cline 1987 Marching Cubes SIGGRAPH"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:luma-ai-2024-genie",
      "vc:label": "Luma AI 2024 Genie"
    },
    {
      "@id": "urn:visionflow:linked:m-ller-et-al-2022-instant-ngp-siggraph",
      "vc:label": "Müller et al. 2022 Instant-NGP SIGGRAPH"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:mildenhall-et-al-2020-ne-rf-eccv",
      "vc:label": "Mildenhall et al. 2020 NeRF ECCV"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:neural-rendering-domain",
      "vc:label": "Neural Rendering Domain"
    },
    {
      "@id": "urn:visionflow:linked:newcombe-et-al-2011-kinect-fusion-ismar",
      "vc:label": "Newcombe et al. 2011 KinectFusion ISMAR"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:salas-moreno-et-al-2013-slam-cvpr",
      "vc:label": "Salas-Moreno et al. 2013 SLAM++ CVPR"
    },
    {
      "@id": "urn:visionflow:linked:sch-nberger-and-frahm-2016-colmap-cvpr",
      "vc:label": "Schönberger & Frahm 2016 COLMAP CVPR"
    },
    {
      "@id": "urn:visionflow:linked:sch-nberger-et-al-2016-colmap-mvs-eccv",
      "vc:label": "Schönberger et al. 2016 COLMAP MVS ECCV"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:sucar-et-al-2021-i-map-iccv",
      "vc:label": "Sucar et al. 2021 iMAP ICCV"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:tancik-et-al-2023-ne-rfstudio-siggraph",
      "vc:label": "Tancik et al. 2023 NeRFstudio SIGGRAPH"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:wang-et-al-2021-neu-s-neur-ips",
      "vc:label": "Wang et al. 2021 NeuS NeurIPS"
    },
    {
      "@id": "urn:visionflow:linked:wang-et-al-2024-dust3-r-cvpr",
      "vc:label": "Wang et al. 2024 DUSt3R CVPR"
    },
    {
      "@id": "urn:visionflow:linked:wu-et-al-2024-4-dgs-cvpr",
      "vc:label": "Wu et al. 2024 4DGS CVPR"
    },
    {
      "@id": "urn:visionflow:linked:xie-et-al-2024-phys-gaussian-cvpr",
      "vc:label": "Xie et al. 2024 PhysGaussian CVPR"
    },
    {
      "@id": "urn:visionflow:linked:yariv-et-al-2021-vol-sdf-neur-ips",
      "vc:label": "Yariv et al. 2021 VolSDF NeurIPS"
    },
    {
      "@id": "urn:visionflow:linked:yariv-et-al-2023-baked-sdf-siggraph",
      "vc:label": "Yariv et al. 2023 BakedSDF SIGGRAPH"
    },
    {
  ...
  "vc:legacyProperties": [
    {
      ...
      "vc:value": "3D Reconstruction, Neural Scene Representation, Photogrammetric Reconstruction, Neural Radiance Field Reconstruction"
    },
    {
    ...
    {
      "vc:key": "bridges-to",
      "vc:value": "[[3D Gaussian Splatting]], [[Photogrammetry]], [[SLAM]], [[Computer Vision]]"
    },
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-7c4a3b1e9f20"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/computer-vision#SceneCaptureAndReconstruction"
    },
    {
    ...
    },
    {
      ...
      "vc:value": "Scene Capture and Reconstruction"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:computer-vision:scene-capture-and-reconstruction"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:scene-capture-and-reconstruction:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[Barron et al. 2022 Mip-NeRF-360 CVPR]]",
      "resolved": "urn:visionflow:linked:barron-et-al-2022-mip-ne-rf-360-cvpr",
      "kind": "StubLink"
    },
    {
      "raw": "[[Barron et al. 2023 Zip-NeRF ICCV]]",
      "resolved": "urn:visionflow:linked:barron-et-al-2023-zip-ne-rf-iccv",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Chen et al. 2022 TensoRF ECCV]]",
      "resolved": "urn:visionflow:linked:chen-et-al-2022-tenso-rf-eccv",
      "kind": "StubLink"
    },
    {
      "raw": "[[COLMAP]]",
    ...
    {
      "raw": "[[Differentiable Renderer]]",
      "resolved": "urn:visionflow:linked:differentiable-renderer",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Fei et al. 2024 3DGS Survey IEEE TVCG]]",
      "resolved": "urn:visionflow:linked:fei-et-al-2024-3-dgs-survey-ieee-tvcg",
      "kind": "StubLink"
    },
    {
      "raw": "[[Gao et al. 2024 NeRF Survey IEEE TPAMI]]",
      "resolved": "urn:visionflow:linked:gao-et-al-2024-ne-rf-survey-ieee-tpami",
      "kind": "StubLink"
    },
    {
      "raw": "[[Gaussian Splatting Rasterisation]]",
      "resolved": "urn:visionflow:linked:gaussian-splatting-rasterisation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Generative AI 3D]]",
      "resolved": "urn:visionflow:linked:generative-ai-3-d",
      "kind": "StubLink"
    },
    {
      "raw": "[[GPU Compute]]",
    ...
    {
      "raw": "[[ISO 19157 Geographic Information Data Quality]]",
      "resolved": "urn:visionflow:linked:iso-19157-geographic-information-data-quality",
      "kind": "StubLink"
    },
    {
      "raw": "[[ISO 19157 Geospatial Data Quality]]",
      "resolved": "urn:visionflow:linked:iso-19157-geospatial-data-quality",
      "kind": "StubLink"
    },
    {
      "raw": "[[Keetha et al. 2024 SplaTAM CVPR]]",
      "resolved": "urn:visionflow:linked:keetha-et-al-2024-spla-tam-cvpr",
      "kind": "StubLink"
    },
    {
      "raw": "[[Kerbl 2023 RealityCapture Epic Games]]",
      "resolved": "urn:visionflow:linked:kerbl-2023-reality-capture-epic-games",
      "kind": "StubLink"
    },
    {
      "raw": "[[Kerbl et al. 2023 3D Gaussian Splatting SIGGRAPH]]",
      "resolved": "urn:visionflow:linked:kerbl-et-al-2023-3-d-gaussian-splatting-siggraph",
      "kind": "StubLink"
    },
    {
      "raw": "[[Kerr et al. 2023 LERF ICCV]]",
      "resolved": "urn:visionflow:linked:kerr-et-al-2023-lerf-iccv",
      "kind": "StubLink"
    },
    {
      "raw": "[[Leroy et al. 2024 MASt3R ECCV]]",
      "resolved": "urn:visionflow:linked:leroy-et-al-2024-mast3-r-eccv",
      "kind": "StubLink"
    },
    {
      "raw": "[[LiDAR-Only Mapping]]",
      "resolved": "urn:visionflow:linked:li-dar-only-mapping",
      "kind": "StubLink"
    },
    {
      "raw": "[[Linear Algebra]]",
    ...
    {
      "raw": "[[Lorensen & Cline 1987 Marching Cubes SIGGRAPH]]",
      "resolved": "urn:visionflow:linked:lorensen-and-cline-1987-marching-cubes-siggraph",
      "kind": "StubLink"
    },
    {
      "raw": "[[Luma AI]]",
    ...
    {
      "raw": "[[Luma AI 2024 Genie]]",
      "resolved": "urn:visionflow:linked:luma-ai-2024-genie",
      "kind": "StubLink"
    },
    {
      "raw": "[[Müller et al. 2022 Instant-NGP SIGGRAPH]]",
      "resolved": "urn:visionflow:linked:m-ller-et-al-2022-instant-ngp-siggraph",
      "kind": "StubLink"
    },
    {
      "raw": "[[Manual 3D Modelling]]",
      "resolved": "urn:visionflow:linked:manual-3-d-modelling",
      "kind": "StubLink"
    },
    {
      "raw": "[[Marching Cubes]]",
      "resolved": "urn:visionflow:linked:marching-cubes",
      "kind": "StubLink"
    },
    {
      "raw": "[[Mesh Extraction]]",
      "resolved": "urn:visionflow:linked:mesh-extraction",
      "kind": "StubLink"
    },
    {
      "raw": "[[Mildenhall et al. 2020 NeRF ECCV]]",
      "resolved": "urn:visionflow:linked:mildenhall-et-al-2020-ne-rf-eccv",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Multi-View Images]]",
      "resolved": "urn:visionflow:linked:multi-view-images",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[NeRFstudio]]",
      "resolved": "urn:visionflow:linked:ne-rfstudio",
      "kind": "StubLink"
    },
    {
      "raw": "[[NeurIPS]]",
    ...
    {
      "raw": "[[Neural Rendering Domain]]",
      "resolved": "urn:visionflow:linked:neural-rendering-domain",
      "kind": "StubLink"
    },
    {
      "raw": "[[Newcombe et al. 2011 KinectFusion ISMAR]]",
      "resolved": "urn:visionflow:linked:newcombe-et-al-2011-kinect-fusion-ismar",
      "kind": "StubLink"
    },
    {
      "raw": "[[Numerical Optimisation]]",
      "resolved": "urn:visionflow:linked:numerical-optimisation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Polycam]]",
      "resolved": "urn:visionflow:linked:polycam",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Salas-Moreno et al. 2013 SLAM++ CVPR]]",
      "resolved": "urn:visionflow:linked:salas-moreno-et-al-2013-slam-cvpr",
      "kind": "StubLink"
    },
    {
      "raw": "[[Schönberger & Frahm 2016 COLMAP CVPR]]",
      "resolved": "urn:visionflow:linked:sch-nberger-and-frahm-2016-colmap-cvpr",
      "kind": "StubLink"
    },
    {
      "raw": "[[Schönberger et al. 2016 COLMAP MVS ECCV]]",
      "resolved": "urn:visionflow:linked:sch-nberger-et-al-2016-colmap-mvs-eccv",
      "kind": "StubLink"
    },
    {
      "raw": "[[SIGGRAPH]]",
    ...
    {
      "raw": "[[Sucar et al. 2021 iMAP ICCV]]",
      "resolved": "urn:visionflow:linked:sucar-et-al-2021-i-map-iccv",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Tancik et al. 2023 NeRFstudio SIGGRAPH]]",
      "resolved": "urn:visionflow:linked:tancik-et-al-2023-ne-rfstudio-siggraph",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Volume Rendering Integral]]",
      "resolved": "urn:visionflow:linked:volume-rendering-integral",
      "kind": "StubLink"
    },
    {
      "raw": "[[Wang et al. 2021 NeuS NeurIPS]]",
      "resolved": "urn:visionflow:linked:wang-et-al-2021-neu-s-neur-ips",
      "kind": "StubLink"
    },
    {
      "raw": "[[Wang et al. 2024 DUSt3R CVPR]]",
      "resolved": "urn:visionflow:linked:wang-et-al-2024-dust3-r-cvpr",
      "kind": "StubLink"
    },
    {
      "raw": "[[Wu et al. 2024 4DGS CVPR]]",
      "resolved": "urn:visionflow:linked:wu-et-al-2024-4-dgs-cvpr",
      "kind": "StubLink"
    },
    {
      "raw": "[[Xie et al. 2024 PhysGaussian CVPR]]",
      "resolved": "urn:visionflow:linked:xie-et-al-2024-phys-gaussian-cvpr",
      "kind": "StubLink"
    },
    {
      "raw": "[[Yariv et al. 2021 VolSDF NeurIPS]]",
      "resolved": "urn:visionflow:linked:yariv-et-al-2021-vol-sdf-neur-ips",
      "kind": "StubLink"
    },
    {
      "raw": "[[Yariv et al. 2023 BakedSDF SIGGRAPH]]",
      "resolved": "urn:visionflow:linked:yariv-et-al-2023-baked-sdf-siggraph",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[ETSI Domain Immersive + Reality Capture Crossover]]",
      "resolved": "urn:visionflow:owl:class:etsi-domain-immersive-reality-capture-crossover",
      "kind": "ResolvedLink"
    },
    {
...
- ### Definition
  - Scene Capture and Reconstruction is a fundamental computer-vision and spatial-computing discipline concerned with recovering complete geometric, radiometric, and semantic representations of physical environments from sensor observations — primarily calibrated multi-view photographs, RGB-D frames, LiDAR point clouds, or combinations thereof — spanning a spectrum of algorithmic families: classical photogrammetric Structure-from-Motion (SfM) pipelines (COLMAP Schönberger & Frahm 2016 applying exhaustive SIFT feature matching, incremental bundle adjustment, and dense Multi-View Stereo to produce textured mesh models deployed at survey, archaeological, and forensic scale); commercial photogrammetry platforms (RealityCapture — acquired by Epic Games in 2023 — achieving photorealistic mesh-and-texture output from thousands of images in under an hour on consumer GPU hardware with LiDAR fusion capability; Agisoft Metashape used across 15,000+ surveying, cultural-heritage, and AEC installations globally; Polycam iPhone/iPad LiDAR app with 5M+ downloads offering one-tap NeRF and Gaussian Splat export; Luma AI Genie offering browser-based NeRF capture and the world's first commercially available 3D generative model); implicit neural scene representations learning continuous signed distance functions (SDF) or occupancy fields from multi-view images without explicit geometry (NeRF — Neural Radiance Fields, Mildenhall et al. ECCV 2020 — representing scene as a 5D function mapping spatial position (x,y,z) and viewing direction (θ,φ) to colour (r,g,b) and volume density σ, optimised via photometric consistency loss through differentiable volume rendering ∫σ(r(t))·c(r(t),d)·e^{-∫σ(r(s))ds} dt along camera rays, accumulating 25,000+ citations by 2026; Instant Neural Graphics Primitives (Instant-NGP) Müller et al. SIGGRAPH 2022 replacing MLP with a multiresolution hash-table of feature vectors queried at spatial coordinates and decoded by a compact two-layer MLP, reducing training time from hours to seconds on a single NVIDIA A100 GPU whilst matching or exceeding NeRF quality; NeuS Wang et al. NeurIPS 2021 and NeuS2 Wang et al. ICCV 2023 reformulating NeRF with an unbiased SDF-to-opacity mapping S(f) = max(sign(f)·∇f, 0)/∥∇f∥ enabling watertight mesh extraction competitive with classical MVS; Zip-NeRF Barron et al. 2023 combining mip-NeRF 360 anti-aliasing with Instant-NGP hash grids, reducing error 8-77% versus prior methods with 24× training speedup); explicit differentiable primitives learning scene geometry as collections of 3D Gaussians (3D Gaussian Splatting — 3DGS — Kerbl et al. SIGGRAPH 2023 representing scenes as millions of oriented 3D Gaussian ellipsoids {μ_k, Σ_k, α_k, c_k} with mean μ_k, covariance Σ_k defining shape, opacity α_k, and spherical harmonic colour coefficients c_k, trained via differentiable tile-based rasterisation projecting Gaussians to 2D splats and compositing front-to-back, achieving real-time 60+ fps rendering at 1080p with training in 20-40 minutes — the most significant 3D representation advance of the 2020s, 12,000+ citations within 18 months of publication; 4D Gaussian Splatting Wu et al. 2024 extending static 3DGS to dynamic scenes via deformation fields Δμ(t), ΔΣ(t) enabling temporal sequences; Scaffold-GS Lu et al. 2024 structuring Gaussians on neural voxel scaffolds for improved geometry consistency); neural surface reconstruction methods (NeuS SDF-based volumetric rendering; VolSDF Yariv et al. 2021; BakedSDF Yariv et al. 2023 distilling NeRF into a textured mesh for real-time deployment; NSVF Liu et al. 2020 sparse voxel fields; MonoSDF Yu et al. 2022 from single-view monocular priors); mesh extraction from implicit fields (Marching Cubes Lorensen & Cline SIGGRAPH 1987 extracting iso-surfaces at threshold density from a sampled volumetric grid via edge-table lookup across 256 cube configurations, producing triangulated meshes from NeRF/SDF fields at controlled resolution-quality tradeoffs; Dual Contouring and variants handling sharp features); classical depth fusion and SLAM (KinectFusion Newcombe et al. ISMAR 2011; TSDF truncated signed distance fields; ElasticFusion; NeRF-SLAM integrating neural rendering with real-time pose tracking), deployed across digital twin creation, cultural heritage documentation, virtual production, autonomous vehicle HD mapping, surgical navigation, e-commerce product photogrammetry, and XR content pipelines — powered by the NeRFstudio framework (Tancik et al. 2023, 2024 providing a modular training library supporting NeRF, 3DGS, splatfacto, and nerfacto model families with standardised data pipelines, viewer, and export tooling, exceeding 10,000 GitHub stars), and constituting the core enabling technology for the emerging spatial computing economy valued at $250B+ by 2030.

- ### Semantic Classification
  - owl-class:: computer-vision:SceneCaptureAndReconstruction
  - owl-role:: ReconstructionParadigm
  - owl-inferred:: cv:3DReconstruction, cv:NeuralRendering, cv:ImplicitNeuralRepresentation, cv:DifferentiableRendering, cv:PhotogrammetricMapping
  - belongs-to-domain:: [[Computer Vision]], [[Spatial Computing Domain]], [[3D Reconstruction]], [[Neural Rendering Domain]]
...
- ### Relationships
  ...
  - implements:: [[Volume Rendering Integral]], [[Signed Distance Function]], [[Gaussian Splatting Rasterisation]], [[Marching Cubes]], [[Structure-from-Motion]], [[Bundle Adjustment]], [[Differentiable Rendering]]
  - depends-on:: [[Deep Learning]], [[Convolutional Neural Network]], [[Computer Vision]], [[Numerical Optimisation]], [[Linear Algebra]], [[Projective Geometry]]
...
- ### Content
  ...
  ## Compositional Relationships (Components)
	  ...
	  AsymmetricObjectProperty(cv:contrastsWith)
	  TransitiveObjectProperty(cv:dependsOn)
	  FunctionalDataProperty(cv:foundationalYear)
	  ```
  ...
  - ### Core Mathematical Framework
	  ...
	  C(p) = Σ_k c_k · α'_k · Π_{j<k}(1 − α'_j)
  ...
  - ### Research and Literature
	  ...
	  **Neural Surface Reconstruction**:
	  4. Wang, P., Liu, L., Liu, Y., Theobalt, C., Komura, T., & Wang, W. (2021). NeuS: Learning Neural Implicit Surfaces by Volume Rendering for Multi-view Reconstruction. *Advances in Neural Information Processing Systems 34 (NeurIPS 2021)*. arXiv:2106.10689 [SDF-based NeRF surface extraction]
	  5. Yariv, L., Gu, J., Kasten, Y., & Lipman, Y. (2021). Volume Rendering of Neural Implicit Surfaces. *Advances in Neural Information Processing Systems 34 (NeurIPS 2021)*. arXiv:2106.12052 [VolSDF, implicit surface rendering]
	  6. Yariv, L., Hedman, P., Reiser, C., Verbin, D., Srinivasan, P.P., Hedman, P., Barron, J.T., & Mildenhall, B. (2023). BakedSDF: Meshing Neural SDFs for Real-Time View Synthesis. *ACM SIGGRAPH 2023*. arXiv:2302.14859 [NeRF to mesh pipeline]

	  **NeRF Variants and Efficiency**:
	  7. Barron, J.T., Mildenhall, B., Verbin, D., Srinivasan, P.P., & Hedman, P. (2023). Zip-NeRF: Anti-Aliased Grid-Based Neural Radiance Fields. *International Conference on Computer Vision (ICCV 2023)*. arXiv:2304.06706 [Anti-aliased hash-grid NeRF]
	  8. Barron, J.T., Mildenhall, B., Tancik, M., Hedman, P., Martin-Brualla, R., & Srinivasan, P.P. (2022). Mip-NeRF 360: Unbounded Anti-Aliased Neural Radiance Fields. *IEEE Conference on Computer Vision and Pattern Recognition (CVPR 2022)*, 5460-5469. arXiv:2111.12077 [Unbounded NeRF with anti-aliasing]
	  9. Chen, A., Xu, Z., Geiger, A., Yu, J., & Su, H. (2022). TensoRF: Tensorial Radiance Fields. *European Conference on Computer Vision (ECCV 2022)*. arXiv:2203.09517 [Tensor decomposition for fast NeRF]

	  **Classical Photogrammetry and SfM**:
	  10. Schönberger, J.L., & Frahm, J.M. (2016). Structure-from-Motion Revisited. *IEEE Conference on Computer Vision and Pattern Recognition (CVPR 2016)*, 4104-4113. [COLMAP SfM, 10,000+ citations]
	  11. Schönberger, J.L., Zheng, E., Frahm, J.M., & Pollefeys, M. (2016). Pixelwise View Selection for Unstructured Multi-View Stereo. *European Conference on Computer Vision (ECCV 2016)*, 501-518. [COLMAP MVS]
	  12. Lorensen, W.E., & Cline, H.E. (1987). Marching Cubes: A High Resolution 3D Surface Construction Algorithm. *ACM SIGGRAPH Computer Graphics*, 21(4), 163-169. [Marching Cubes, mesh extraction from implicit fields]

	  **4D and Dynamic Scenes**:
	  13. Wu, G., Yi, T., Fang, J., Xie, L., Zhang, X., Wei, W., Liu, W., Tian, Q., & Wang, X. (2024). 4D Gaussian Splatting for Real-Time Dynamic Scene Rendering. *IEEE Conference on Computer Vision and Pattern Recognition (CVPR 2024)*. arXiv:2310.08528 [4DGS temporal Gaussians]

	  **Feed-Forward Generalisation**:
	  14. Wang, S., Leroy, V., Cabon, Y., Chidlovskii, B., & Revaud, J. (2024). DUSt3R: Geometric 3D Vision Made Easy. *IEEE Conference on Computer Vision and Pattern Recognition (CVPR 2024)*. arXiv:2312.14132 [Feed-forward multi-view reconstruction]
	  15. Leroy, V., Cabon, Y., & Revaud, J. (2024). Grounding Image Matching in 3D with MASt3R. *European Conference on Computer Vision (ECCV 2024)*. arXiv:2406.09756 [Dense 3D matching without pose prior]

	  **Semantic and Language-Embedded Reconstruction**:
	  16. Kerr, J., Kim, C.M., Goldberg, K., Kanazawa, A., & Tancik, M. (2023). LERF: Language Embedded Radiance Fields. *International Conference on Computer Vision (ICCV 2023)*. arXiv:2303.09553 [Open-vocabulary 3D scene queries with CLIP+NeRF]

	  **SLAM and Real-Time Reconstruction**:
	  17. Sucar, E., Liu, S., Ortiz, J., & Davison, A.J. (2021). iMAP: Implicit Mapping and Positioning in Real-Time. *International Conference on Computer Vision (ICCV 2021)*. arXiv:2103.12352 [First NeRF-SLAM, Imperial College]
	  18. Keetha, N., Karhade, J., Jatavallabhula, K.M., Yang, G., Scherer, S., Ramanan, D., & Patrikar, J. (2024). SplaTAM: Splat, Track & Map 3D Gaussians for Dense RGB-D SLAM. *IEEE Conference on Computer Vision and Pattern Recognition (CVPR 2024)*. arXiv:2312.02126 [3DGS-based SLAM, Imperial College collaboration]

	  **NeRFstudio Framework**:
	  19. Tancik, M., Weber, E., Ng, E., Li, R., Yi, B., Wang, T., Kristoffersen, A., Austin, J., Salahi, K., Ahuja, A., McAllister, D., Kerr, J., & Kanazawa, A. (2023). Nerfstudio: A Modular Framework for Neural Radiance Field Development. *ACM SIGGRAPH 2023*. arXiv:2302.04264 [NeRFstudio, modular NeRF research platform]

	  **Commercial Platforms**:
	  20. Kerbl, B. (2023). RealityCapture. Epic Games. https://www.capturingreality.com/ [Industry photogrammetry platform, Epic Games acquisition 2023]
	  21. Luma AI (2024). Genie: Generative 3D Scenes from Text and Images. https://lumalabs.ai/genie [First commercial generative 3D model]

	  **UK Academic Contributions**:
	  22. Salas-Moreno, R.F., Newcombe, R.A., Strasdat, H., Kelly, P.H.J., & Davison, A.J. (2013). SLAM++: Simultaneous Localisation and Mapping at the Level of Objects. *IEEE Conference on Computer Vision and Pattern Recognition (CVPR 2013)*, 1352-1359. [Object-level SLAM, Imperial College]
	  23. Newcombe, R.A., Izadi, S., Hilliges, O., Molyneaux, D., Kim, D., Davison, A.J., Kohli, P., Shotton, J., Hodges, S., & Fitzgibbon, A. (2011). KinectFusion: Real-Time Dense Surface Mapping and Tracking. *International Symposium on Mixed and Augmented Reality (ISMAR 2011)*, 127-136. [KinectFusion TSDF, real-time depth fusion]

	  **Physics-Aware Reconstruction**:
	  24. Xie, T., Zong, Z., Qiu, Y., Li, X., Feng, Y., Yang, Y., & Jiang, C. (2024). PhysGaussian: Physics-Integrated 3D Gaussians for Generative Dynamics. *IEEE Conference on Computer Vision and Pattern Recognition (CVPR 2024)*. arXiv:2311.12198 [MPM physics simulation in 3DGS]

	  **Surveys**:
	  25. Gao, K., Gao, Y., He, H., Lu, D., Xu, L., Li, J., Chen, M., Chen, C., & Liao, X. (2024). NeRF: Neural Radiance Field in 3D Vision, A Comprehensive Review. *IEEE Transactions on Pattern Analysis and Machine Intelligence*, 46(8), 5472-5495. DOI: 10.1109/TPAMI.2024.3366219 [Comprehensive 2024 NeRF survey]
	  26. Fei, B., Xu, J., Zhang, R., Zhou, Q., Yang, W., & He, Y. (2024). 3D Gaussian Splatting as New Era: A Survey. *IEEE Transactions on Visualization and Computer Graphics*. arXiv:2402.07181 [Comprehensive 3DGS survey, 2024]

	  **ISO/Standards**:
	  27. ISO 19157:2013 Geographic Information — Data Quality. [Accuracy standards for geospatial reconstruction outputs]
...
- ### Provenance
  - sources:: [[Mildenhall et al. 2020 NeRF ECCV]], [[Müller et al. 2022 Instant-NGP SIGGRAPH]], [[Kerbl et al. 2023 3D Gaussian Splatting SIGGRAPH]], [[Wang et al. 2021 NeuS NeurIPS]], [[Yariv et al. 2021 VolSDF NeurIPS]], [[Yariv et al. 2023 BakedSDF SIGGRAPH]], [[Barron et al. 2023 Zip-NeRF ICCV]], [[Barron et al. 2022 Mip-NeRF-360 CVPR]], [[Chen et al. 2022 TensoRF ECCV]], [[Schönberger & Frahm 2016 COLMAP CVPR]], [[Schönberger et al. 2016 COLMAP MVS ECCV]], [[Lorensen & Cline 1987 Marching Cubes SIGGRAPH]], [[Wu et al. 2024 4DGS CVPR]], [[Wang et al. 2024 DUSt3R CVPR]], [[Leroy et al. 2024 MASt3R ECCV]], [[Kerr et al. 2023 LERF ICCV]], [[Sucar et al. 2021 iMAP ICCV]], [[Keetha et al. 2024 SplaTAM CVPR]], [[Tancik et al. 2023 NeRFstudio SIGGRAPH]], [[Kerbl 2023 RealityCapture Epic Games]], [[Luma AI 2024 Genie]], [[Salas-Moreno et al. 2013 SLAM++ CVPR]], [[Newcombe et al. 2011 KinectFusion ISMAR]], [[Xie et al. 2024 PhysGaussian CVPR]], [[Gao et al. 2024 NeRF Survey IEEE TPAMI]], [[Fei et al. 2024 3DGS Survey IEEE TVCG]], [[ISO 19157 Geographic Information Data Quality]]
  - research-cache:: _enrich/research-cache/Scene Capture and Reconstruction.json
