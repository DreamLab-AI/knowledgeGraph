```json-ld
{
  ...
  "@id": "urn:visionflow:page:fsb-cross-border-payments-roadmap",
  "@type": "Page",
  "vc:slug": "fsb-cross-border-payments-roadmap",
...
- ### Content
  - The roadmap sets targets for cost, speed, access, and transparency, and organises action across payment system interoperability, data standards (e.g. ISO 20022), and legal frameworks. It explicitly considers how multi-CBDC arrangements and new infrastructures [private] reduce friction. Progress is tracked through periodic FSB monitoring reports.
