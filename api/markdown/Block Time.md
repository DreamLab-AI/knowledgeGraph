...
- Implementation Mechanisms
  ...
  - Hybrid consensus mechanisms may combine multiple approaches to optimise for specific performance and security characteristics.
...
- Real-World Implementation [Updated 2025]
  - Current block time implementations across major protocols reflect ongoing optimization between security, decentralization, and performance:
    ...
    - Solana: ~400 milliseconds (optimised for high throughput with specialized hardware)
...
- Sompolinsky, Y., & Zohar, A. (2015). Secure High-Rate Transaction Processing in Bitcoin. Financial Cryptography and Data Security. https://doi.org/10.1007/978-3-662-47854-7_32
  - Analyses security implications of reduced block times and proposes the GHOST protocol for improved fork resolution.
...
- UK researchers and institutions have contributed significantly to the development of blockchain protocols with optimised block times.
...
- Development of application-specific blockchains with tailored block times optimised for particular use cases, from high-frequency trading to IoT data collection.
