schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#InstructionTuning
legacy_uri:: urn:visionclaw:concept:spatial-computing:instruction-tuning
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-d867fbe18703"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#InstructionTuning"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:instruction-tuning"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:4c1a4c6c799725e9e5c68e02ced20bcc05a235440ef25bd2cfc980cdcc09dce3@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
