...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:model-drift",
      "vc:label": "Model Drift"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:risk-appetite",
      "vc:label": "Risk Appetite"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:bias-detection-methods",
...
- ### Definition
  - An AI Risk Register is a structured governance artefact that systematically documents, tracks, and manages the full inventory of identified risks associated with [[AI Systems]] throughout their operational lifecycle, from initial design and training through deployment, monitoring, and eventual decommissioning. Derived from established [[Enterprise Risk Management]] practice codified in [[ISO 31000]] and specialised for AI-distinctive failure modes by [[ISO/IEC 23894:2023]], the register records for each risk: a unique identifier, a precise description of the failure mode and its causal pathway, the affected AI system components and impacted stakeholders, a likelihood rating (typically on a five-point scale from rare to almost certain) and a consequence rating (insignificant to catastrophic) spanning financial loss, physical harm, discriminatory outcome, reputational damage, and regulatory sanction, the combined risk level determining treatment priority, a named risk owner accountable for treatment, the current mitigation controls and their assessed effectiveness, the residual risk level after controls, and a dated review history capturing status changes, decision rationale, and accountability. The register sits at the centre of a broader [[AI Risk Management]] programme and is the primary instrument by which [[AI Governance]] structures operationalise [[Risk Assessment]] obligations imposed by the [[EU AI Act]] Article 9, the [[NIST AI Risk Management Framework]], and the [[ISO/IEC 42001]] management systems standard. It differs from a conventional IT risk register in that it must capture inherently dynamic risks: [[Model Drift]] as deployment distributions diverge from training data, feedback loop risks where model outputs influence future training, emergent capability risks as models are integrated into multi-component pipelines, and specification gaming risks where optimised proxies diverge from intended objectives. The register enables systematic prioritisation of mitigation effort, provides auditable evidence for [[Regulatory Compliance]] demonstrations, and feeds [[Compliance Monitoring]] dashboards with the authoritative risk inventory against which control effectiveness is continuously tracked. Related concepts include [[Fairness]] (whose violation constitutes a distinct ethical risk category), [[Bias]] (a primary technical and ethical risk driver requiring dedicated [[Bias Detection]] assessments), [[Explainability]] (both a mitigation tool and an independent risk dimension), and [[Accountability]] as the governance property that assigns and enforces risk ownership.

- ### Semantic Classification
  - owl-class:: ai-governance-and-ethics:AIRiskRegister
  - owl-role:: GovernanceArtefact | ComplianceInstrument | RiskDocument
  - owl-inferred:: ai-governance-and-ethics:RiskManagementTool, ai-governance-and-ethics:ComplianceDocument
  - belongs-to-domain:: [[AIEthicsDomain]]
  - implemented-in-layer:: [[ConceptualLayer]]

- ### Relationships
  - is-subclass-of:: [[AI Governance and Ethics]], [[AI Risk Management]]
  - has-part:: [[Audit Trail]], [[Risk Assessment]], [[Impact Assessment]], [[Risk Appetite]]
  - requires:: [[AI Governance]], [[Compliance Framework]], [[Accountability]], [[Data Governance]], [[Threat Modelling]]
  - enables:: [[Compliance Monitoring]], [[AI Safety]], [[Transparency]], [[Responsible AI]], [[Trustworthy AI]]
  - supports:: [[AI Governance Framework]], [[Regulatory Compliance]], [[Model Governance]]
  - uses:: [[Red Teaming]], [[Algorithmic Auditing]], [[Continuous Monitoring]], [[Bias Detection]]
  - implements:: [[ISO 31000]], [[ISO/IEC 23894:2023]], [[NIST AI Risk Management Framework]]
  - depends-on:: [[Incident Response]], [[AI Impact Assessment]]
  - related-to:: [[Fairness]], [[Bias]], [[Explainability]], [[Risk Management]], [[Enterprise Risk Management]], [[Model Drift]], [[EU AI Act]]
...
- ### Content
  ...
  3. ISO/IEC 23894:2023. *Information technology — Artificial intelligence — Guidance on risk management*. ISO/IEC.
  4. Amodei, D., Olah, C., Steinhardt, J., Christiano, P., Schulman, J. & Mané, D. (2016). "Concrete problems in AI safety." arXiv:1606.06565.
  5. Gebru, T., Morgenstern, J., Vecchione, B., Vaughan, J.W., Wallach, H., Daumé III, H. & Crawford, K. (2018). "Datasheets for datasets." arXiv:1803.09010.
  6. Mitchell, M., Wu, S., Zaldivar, A., Barnes, P., Vasserman, L., Hutchinson, B., Spitzer, E., Raji, I.D. & Gebru, T. (2019). "Model cards for model reporting." *Proceedings of FAccT 2019*, pp. 220-229.
  7. Raji, I.D., Smart, A., White, R.N., Mitchell, M., Gebru, T., Hutchinson, B., Smith-Loud, J., Theron, D. & Barnes, P. (2020). "Closing the AI accountability gap." *Proceedings of FAccT 2020*, pp. 33-44.
  8. Bommasani, R., Hudson, D.A., Adeli, E., et al. (2021). "On the opportunities and risks of foundation models." arXiv:2108.07258.
  9. Slattery, P., Saeri, A.K., Grundy, E.A.C., et al. (2024). "The AI Risk Repository: A comprehensive meta-review, database, and taxonomy of risks from artificial intelligence." arXiv:2408.12622. (MIT AI Risk Repository v4: April 2025, 1,612 risks.)
  10. NIST (2023). *Artificial Intelligence Risk Management Framework (AI RMF 1.0)*. National Institute of Standards and Technology. NIST AI 100-1.
  ...
  12. ICO (2023/2025). *Guidance on AI and Data Protection: AI and Data Protection Risk Toolkit*. UK Information Commissioner's Office.
  13. PRA/FCA (2023). *SS1/23: Model Risk Management Principles for Banks*. Prudential Regulation Authority / Financial Conduct Authority.
  14. DSIT (2023). *A pro-innovation approach to AI regulation*. UK Department for Science, Innovation and Technology. CP 815.
  15. ISO/IEC 42001:2023. *Information technology — Artificial intelligence — Management system*. ISO/IEC.
  16. EDPS (2025). *Guidance for risk management of artificial intelligence systems*. European Data Protection Supervisor.
  17. DeepInspect (2025). "AI Risk Register Template: What each row has to capture and where the evidence comes from." deepinspect.ai.
  18. LayerX (2025). "AI Risk Register Template & Best Practices." layerxsecurity.com.
  19. McKenna Consultants (2026). "EU AI Act High-Risk Compliance: A Technical Readiness Guide for August 2026." mckennaconsultants.com.
  20. Mindgard AI (2024). "ISO/IEC 23894: AI Risk Management Standard Explained." mindgard.ai/blog.
  21. LegalNodes (2026). "EU AI Act 2026 Updates: Compliance Requirements and Business Risks." legalnodes.com.
  22. AI Standards Hub (2023). "A new standard for AI risk management: ISO/IEC 23894." aistandardshub.org.
  23. Cyber Navigator (2024). "Risk Management as Part of the EU AI Act." cybernavigator.org.
  24. ElevatConsult (2025). "AI Risk Management Register: Categorization and Mitigation." elevateconsult.com.
  25. Cambridge Core (2024). "Risk Management in the Artificial Intelligence Act." *European Journal of Risk Regulation*. DOI:10.1017/err.2024.XX.
...
- ### Provenance
  - sources:: ISO 31000:2018, ISO/IEC 23894:2023, ISO/IEC 42001:2023, NIST AI RMF 1.0, EU AI Act 2024, ICO AI and Data Protection Risk Toolkit, PRA SS1/23, MIT AI Risk Repository v4 (2025), DSIT AI Regulation White Paper, EDPS AI Risk Management Guidance 2025
