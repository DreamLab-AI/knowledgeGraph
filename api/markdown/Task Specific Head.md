schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#TaskSpecificHead
legacy_uri:: urn:visionclaw:concept:spatial-computing:task-specific-head
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-76b1283d6976"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#TaskSpecificHead"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:task-specific-head"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:fb02d247e89d95bda3267c7e444555e443292166b834ee8ccc4cd66af3816c4d@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:task-specific-head",
  "@type": "OntologyClass",
  "label": "Task Specific Head",
  "subClassOf": [
    {
