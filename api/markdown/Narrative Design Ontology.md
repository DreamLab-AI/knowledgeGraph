...
- is-subclass-of:: [[Metaverse]]
	  ...
	  collapsed:: true
		...
		- has-part:: [[Story Event]]
		- has-part:: [[Narrative Theme]]
		- has-part:: [[Branching Path]]
		- has-part:: [[Plot Structure]]
		- has-part:: [[Character Relationship Graph]]
		- has-part:: [[Narrative Arc]]
		- has-part:: [[Story Node]]
		- requires:: [[Dialogue System]]
		- requires:: [[Event Sequencing]]
		- requires:: [[Plot Graph Database]]
		- requires:: [[Character Model]]
		- enables:: [[Interactive Fiction]]
		- enables:: [[Procedural Story Generation]]
		- enables:: [[Transmedia Storytelling]]
		- enables:: [[Game Narratives]]
		- depends-on:: [[Procedural Generation]]
		- depends-on:: [[Natural Language Processing]]
		- depends-on:: [[Graph Database]]
