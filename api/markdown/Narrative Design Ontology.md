schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#NarrativeDesignOntology
legacy_uri:: urn:visionclaw:concept:spatial-computing:narrative-design-ontology
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-2e769a54514d"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#NarrativeDesignOntology"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:narrative-design-ontology"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:8a64e635ed99ebd600e8927a656299afd39f107e0c5881ee1d278bb587d4e6a8@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
