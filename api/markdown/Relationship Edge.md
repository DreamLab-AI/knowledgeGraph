...
- ### Content
  - Edges may be directed (subject to object) or undirected, and carry labels such as "owns" or "knows" plus optional weights and timestamps. Graph databases [private] edges to support efficient traversal, pattern matching, and inference, making edge design central to query expressiveness and performance.
