schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#ALBERT
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:albert
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-734924c0d2c3"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#ALBERT"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:albert"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:595afd2e06469925462a4719f08966b5902a71ec46f29ec94f9402b34fb37341@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:albert",
  "@type": "OntologyClass",
  "label": "ALBERT",
  "subClassOf": [
    {
