- ### OntologyBlock
  id:: blockchain-core-concepts-ontology
  collapsed:: true
	- ontology:: true
...
- public-access:: true
	...
	- maturity:: draft
	- owl:class:: mv:blockchaincoreconcepts
...
(Declaration (Class :BlockchainCoreConcepts))

;; Annotations
(AnnotationAssertion rdfs:label :BlockchainCoreConcepts "blockchain core concepts"@en)
(AnnotationAssertion rdfs:comment :BlockchainCoreConcepts "A component of the metaverse ecosystem."@en)

;; Data Properties
(AnnotationAssertion dcterms:identifier :BlockchainCoreConcepts "mv-1761742247980"^^xsd:string)
```

- ## About blockchain core concepts
