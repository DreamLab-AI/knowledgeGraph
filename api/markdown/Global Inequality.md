schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/ethics-society#GlobalInequality
legacy_uri:: urn:visionclaw:concept:ethics-society:global-inequality
public:: true
...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:booth2020price",
      "vc:label": "booth2020price"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:digital-society-domain",
      "vc:label": "DigitalSocietyDomain"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:empirical-research-layer",
      "vc:label": "EmpiricalResearchLayer"
    },
    {
      "@id": "urn:visionflow:linked:ethics-and-society-domain",
      "vc:label": "EthicsAndSocietyDomain"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:world-employment-and-social-outlook",
      "vc:label": "World Employment and Social Outlook"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-gi20260517enrich"
    },
    {
      "vc:key": "context",
    ...
    },
    {
      ...
      "vc:value": "infrastructure -> ethics-society"
    },
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/ethics-society#GlobalInequality"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:ethics-society:global-inequality"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:global-inequality:776c802a9fc9",
  ...
  "vc:resolutions": [
    {
      "raw": "[[AI Labour Displacement]]",
      "resolved": "urn:visionflow:linked:ai-labour-displacement",
      "kind": "StubLink"
    },
    {
      "raw": "[[Atkinson Index]]",
      "resolved": "urn:visionflow:linked:atkinson-index",
      "kind": "StubLink"
    },
    {
      "raw": "[[Austerity]]",
      "resolved": "urn:visionflow:linked:austerity",
      "kind": "StubLink"
    },
    {
      "raw": "[[booth2020price]]",
      "resolved": "urn:visionflow:linked:booth2020price",
      "kind": "StubLink"
    },
    {
      "raw": "[[Climate Change]]",
      "resolved": "urn:visionflow:linked:climate-change",
      "kind": "StubLink"
    },
    {
      "raw": "[[Climate Justice]]",
      "resolved": "urn:visionflow:linked:climate-justice",
      "kind": "StubLink"
    },
    {
      "raw": "[[Compute Divide]]",
      "resolved": "urn:visionflow:linked:compute-divide",
      "kind": "StubLink"
    },
    {
      "raw": "[[Data Science]]",
    ...
    {
      "raw": "[[Development Economics]]",
      "resolved": "urn:visionflow:linked:development-economics",
      "kind": "StubLink"
    },
    {
      "raw": "[[Development Finance]]",
      "resolved": "urn:visionflow:linked:development-finance",
      "kind": "StubLink"
    },
    {
      "raw": "[[Digital Divide]]",
    ...
    {
      "raw": "[[Digital Infrastructure Investment]]",
      "resolved": "urn:visionflow:linked:digital-infrastructure-investment",
      "kind": "StubLink"
    },
    {
      "raw": "[[DigitalSocietyDomain]]",
      "resolved": "urn:visionflow:linked:digital-society-domain",
      "kind": "StubLink"
    },
    {
      "raw": "[[Distributional Data]]",
      "resolved": "urn:visionflow:linked:distributional-data",
      "kind": "StubLink"
    },
    {
      "raw": "[[Distributive Justice]]",
      "resolved": "urn:visionflow:linked:distributive-justice",
      "kind": "StubLink"
    },
    {
      "raw": "[[Economic Inequality]]",
      "resolved": "urn:visionflow:linked:economic-inequality",
      "kind": "StubLink"
    },
    {
      "raw": "[[EconomicsDomain]]",
    ...
    {
      "raw": "[[Efficient Market Hypothesis]]",
      "resolved": "urn:visionflow:linked:efficient-market-hypothesis",
      "kind": "StubLink"
    },
    {
      "raw": "[[EmpiricalResearchLayer]]",
      "resolved": "urn:visionflow:linked:empirical-research-layer",
      "kind": "StubLink"
    },
    {
      "raw": "[[EthicsAndSocietyDomain]]",
      "resolved": "urn:visionflow:linked:ethics-and-society-domain",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Financialisation]]",
      "resolved": "urn:visionflow:linked:financialisation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Gender Pay Gap]]",
      "resolved": "urn:visionflow:linked:gender-pay-gap",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Global Digital Compact]]",
      "resolved": "urn:visionflow:linked:global-digital-compact",
      "kind": "StubLink"
    },
    {
      "raw": "[[GovernanceLayer]]",
    ...
    },
    {
      ...
      "resolved": "urn:visionflow:linked:household-survey-data",
      "kind": "StubLink"
    },
    {
      "raw": "[[Human Development Index]]",
      "resolved": "urn:visionflow:linked:human-development-index",
      "kind": "StubLink"
    },
    {
      "raw": "[[ILO Decent Work Agenda]]",
      "resolved": "urn:visionflow:linked:ilo-decent-work-agenda",
      "kind": "StubLink"
    },
    {
      "raw": "[[ILO WESO]]",
      "resolved": "urn:visionflow:linked:ilo-weso",
      "kind": "StubLink"
    },
    {
      "raw": "[[IMF Article IV Consultations]]",
      "resolved": "urn:visionflow:linked:imf-article-iv-consultations",
      "kind": "StubLink"
    },
    {
      "raw": "[[Income Inequality]]",
      "resolved": "urn:visionflow:linked:income-inequality",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Intergenerational Mobility]]",
      "resolved": "urn:visionflow:linked:intergenerational-mobility",
      "kind": "StubLink"
    },
    {
      "raw": "[[Just Transition]]",
    ...
    {
      "raw": "[[Kuznets Curve Hypothesis]]",
      "resolved": "urn:visionflow:linked:kuznets-curve-hypothesis",
      "kind": "StubLink"
    },
    {
      "raw": "[[Labour Economics]]",
      "resolved": "urn:visionflow:linked:labour-economics",
      "kind": "StubLink"
    },
    {
      "raw": "[[Labour Income Share]]",
      "resolved": "urn:visionflow:linked:labour-income-share",
      "kind": "StubLink"
    },
    {
      "raw": "[[Macroeconomics]]",
    ...
    {
      "raw": "[[Meritocracy Thesis]]",
      "resolved": "urn:visionflow:linked:meritocracy-thesis",
      "kind": "StubLink"
    },
    {
      "raw": "[[Migration]]",
      "resolved": "urn:visionflow:linked:migration",
      "kind": "StubLink"
    },
    {
      "raw": "[[National Accounts]]",
      "resolved": "urn:visionflow:linked:national-accounts",
      "kind": "StubLink"
    },
    {
      "raw": "[[OECD Guidelines on Measuring Inequality]]",
      "resolved": "urn:visionflow:linked:oecd-guidelines-on-measuring-inequality",
      "kind": "StubLink"
    },
    {
      "raw": "[[OECD Income Distribution Database]]",
      "resolved": "urn:visionflow:linked:oecd-income-distribution-database",
      "kind": "StubLink"
    },
    {
      "raw": "[[Palma Ratio]]",
      "resolved": "urn:visionflow:linked:palma-ratio",
      "kind": "StubLink"
    },
    {
      "raw": "[[Policy Design]]",
      "resolved": "urn:visionflow:linked:policy-design",
      "kind": "StubLink"
    },
    {
      "raw": "[[PolicyLayer]]",
    ...
    },
    {
      ...
      "resolved": "urn:visionflow:linked:political-science",
      "kind": "StubLink"
    },
    {
      "raw": "[[Poverty]]",
      "resolved": "urn:visionflow:linked:poverty",
      "kind": "StubLink"
    },
    {
      "raw": "[[Progressive Wealth Tax]]",
      "resolved": "urn:visionflow:linked:progressive-wealth-tax",
      "kind": "StubLink"
    },
    {
      "raw": "[[Redistributive Taxation]]",
      "resolved": "urn:visionflow:linked:redistributive-taxation",
      "kind": "StubLink"
    },
    {
      "raw": "[[S80/S20 Ratio]]",
      "resolved": "urn:visionflow:linked:s80-s20-ratio",
      "kind": "StubLink"
    },
    {
      "raw": "[[Social Mobility]]",
      "resolved": "urn:visionflow:linked:social-mobility",
      "kind": "StubLink"
    },
    {
      "raw": "[[Social Protection]]",
      "resolved": "urn:visionflow:linked:social-protection",
      "kind": "StubLink"
    },
    {
      "raw": "[[Social Stratification]]",
      "resolved": "urn:visionflow:linked:social-stratification",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Tax Record Microdata]]",
      "resolved": "urn:visionflow:linked:tax-record-microdata",
      "kind": "StubLink"
    },
    {
      "raw": "[[Top Income Shares]]",
      "resolved": "urn:visionflow:linked:top-income-shares",
      "kind": "StubLink"
    },
    {
      "raw": "[[Trickle-Down Economics]]",
      "resolved": "urn:visionflow:linked:trickle-down-economics",
      "kind": "StubLink"
    },
    {
      "raw": "[[UNDP Human Development Index]]",
      "resolved": "urn:visionflow:linked:undp-human-development-index",
      "kind": "StubLink"
    },
    {
      "raw": "[[United Nations Sustainable Development Goals]]",
      "resolved": "urn:visionflow:linked:united-nations-sustainable-development-goals",
      "kind": "StubLink"
    },
    {
      "raw": "[[Universal Basic Income]]",
      "resolved": "urn:visionflow:linked:universal-basic-income",
      "kind": "StubLink"
    },
    {
      "raw": "[[Wealth Inequality]]",
      "resolved": "urn:visionflow:linked:wealth-inequality",
      "kind": "StubLink"
    },
    {
      "raw": "[[World Bank]]",
      "resolved": "urn:visionflow:linked:world-bank",
      "kind": "StubLink"
    },
    {
      "raw": "[[World Bank Findex]]",
      "resolved": "urn:visionflow:linked:world-bank-findex",
      "kind": "StubLink"
    },
    {
      "raw": "[[World Bank PovcalNet Standards]]",
      "resolved": "urn:visionflow:linked:world-bank-povcal-net-standards",
      "kind": "StubLink"
    },
    {
      "raw": "[[World Employment and Social Outlook]]",
      "resolved": "urn:visionflow:linked:world-employment-and-social-outlook",
      "kind": "StubLink"
    },
    {
      "raw": "[[World Inequality Database]]",
      "resolved": "urn:visionflow:linked:world-inequality-database",
      "kind": "StubLink"
    },
    {
      "raw": "[[AI Governance]]",
...
- ### Definition
  - Global Inequality is the systematic, multi-dimensional divergence in life chances, material resources, political power, and technological access experienced by individuals, households, communities, and nations across the world economic order — encompassing income inequality (the Gini coefficient measuring distributional spread from 0 perfect equality to 1 maximum concentration), wealth inequality (asset and capital ownership skewed far more steeply than income flows, with the top 10% of global households owning 76% of total household wealth while the bottom 50% holds 2%), digital and compute inequality (differential access to hardware, bandwidth, training data, and AI inference capacity), opportunity inequality (intergenerational mobility, educational attainment, access to health systems and legal protections), gender inequality (persistent labour market, pay, and asset gaps), and climate-inequality intersections (low-income populations bearing disproportionate exposure to environmental shocks they did not cause). The field integrates distributional economics, political economy, social stratification sociology, development economics, and computational social science to analyse how advantages and disadvantages reproduce across space, time, gender, race, and class.
  - The canonical empirical framework is the World Inequality Database (WID.world) coordinated by Lucas Chancel, Thomas Piketty, Emmanuel Saez, and Gabriel Zucman — now covering 216 countries with income and wealth series back to 1820 for some nations, extending to 2024. The 2022 World Inequality Report found that the richest 10% of humanity captures 52% of global income while the poorest 50% receives only 8.5%; for wealth the top 10% owns 76% while the bottom 50% owns 2%. The WID 2025 methodological update revised Latin America upward in inequality rankings — it now ranks as the most unequal income region globally, overtaking MENA, when measuring the top-10% versus bottom-50% income share ratio. This revision emerged because improved administrative-tax-record data for Brazil and Chile revealed previously underestimated concentration within the top 1% of earners. Europe remains the world's least unequal region. The forthcoming 2026 World Inequality Report (Chancel et al., December 2025 scheduled release) will incorporate the first comprehensive post-pandemic wealth dynamics panel covering 40+ countries, along with new gender-disaggregated wealth series.
  - The G20 Extraordinary Committee of Independent Experts on Global Inequality, chaired by Nobel Laureate Joseph Stiglitz with five co-experts and released at the South Africa G20 Presidency in November 2025, declared a formal "inequality emergency": between 2000 and 2024, the world's top 1% captured 41% of all new global wealth created, while only 1% flowed to the bottom 50%. The Committee projects that $70 trillion in inherited wealth will change hands in the coming decade — a generational transfer that structurally reinforces capital concentration and creates headwinds against social mobility on a historically unprecedented scale absent coordinated policy intervention. Its headline recommendation is the creation of an Intergovernmental Panel on Inequality (IPI), modelled on the IPCC, that would provide independent monitoring of inequality trends, causal attribution of policy effects, and evaluation of alternative redistribution mechanisms across the UN system.
  - The intersection of artificial intelligence with global inequality has become the field's fastest-growing research frontier since 2023. Goldman Sachs Research estimated that 300 million full-time-equivalent jobs globally are exposed to AI-driven automation — with computer programming, accountancy, legal and administrative assistance, and customer service most exposed in high-income economies. The specific mechanism is the task-substitution thesis: AI systems are designed to replace discrete cognitive tasks within occupations (document review, code generation, data entry, customer interaction routing), and those occupations with the highest share of substitutable tasks face the largest displacement risk. The 6–7% of workers expected to be displaced in Goldman's base-case 10-year transition represent a structural unemployment shock comparable in magnitude to the deindustrialisation waves of the 1980s–1990s. The IMF issued parallel findings: up to 40% of all global jobs will be materially impacted by AI — not necessarily eliminated but transformed such that wages, conditions, or skill requirements shift fundamentally.
  - Daron Acemoglu and Simon Johnson, in "Power and Progress: Our Thousand-Year Struggle over Technology and Prosperity" (Basic Books, 2023), provide the historical-economic intellectual framework for understanding why technology does not automatically deliver broad-based prosperity: their thousand-year review of technological transitions (printing press, agricultural revolution, industrial machinery, digital computing) demonstrates that distributional outcomes are determined by who makes the design choices about what tasks machines replace versus what capabilities they augment. Current AI development, they argue, is systematically biased toward labour displacement rather than labour augmentation — not because of technological necessity but because design choices are made by firms seeking to minimise headcount rather than maximise worker productivity. Their MIT Stone Center analysis with Pascual Restrepo (Econometrica, 2022) estimates that automation since 1987 explains 50–70% of the increase in US wage inequality for non-college workers, through both direct displacement and the wage-structure effects of reducing demand for routine cognitive middle-skill labour.
  - The compute divide represents a new dimension of global inequality overlaid on the older digital divide and compounding it. Over 80% of global AI research and development remains concentrated in the United States, China, and Western Europe. Sub-Saharan Africa, where approximately 80% of the population lacks reliable electricity access and only 36% have internet connectivity, faces structural barriers to AI adoption that compound existing income inequality. The concern is not merely that African nations cannot use AI consumer tools — it is that the economic productivity gains from AI deployment (estimated by Goldman Sachs at +7% global GDP) will be geographically concentrated in high-infrastructure economies, widening the absolute income gap even if relative Gini statistics show improvement. The Global Digital Compact (UN General Assembly, September 2024) acknowledges digital connectivity as foundational to sustainable development and calls for North-South technology transfer, but lacks binding enforcement mechanisms or financial commitments commensurate with the investment gap.
  - Financial inclusion via mobile money and crypto-adjacent payment rails represents a partial but genuine counter-trend. The World Bank Global Findex 2025 found that 79% of adults globally now hold a bank or mobile money account (up from 74% in 2021 and 51% in 2011); Sub-Saharan Africa leads the world in mobile money adoption with 40% of adults holding mobile money accounts (up from 27% in 2021), driven by M-Pesa in Kenya and Tanzania, MTN Mobile Money across West and Central Africa, and Airtel Money. Latin America has seen rapid expansion to 37% mobile money penetration. Yet 1.6 billion adults remain unbanked or severely underserved, with persistent gender gaps (5 percentage points in developing economies), rural-urban divides, and a transition problem: holding a mobile money account is not the same as accessing productive credit, savings products with meaningful returns, or insurance instruments.
  - Universal Basic Income (UBI) has re-emerged as the dominant policy response to AI-driven labour displacement, proposed across a wide spectrum from technology sector billionaires to progressive politicians. Sam Altman backed a three-year OpenAI-funded RCT providing $1,000/month to 1,000 low-income Americans in Texas and Illinois (versus $50/month control group) through OpenResearch; he has further proposed an "American Equity Fund" under which large AI companies and major landholders would contribute approximately 2.5% of their value annually to a citizen wealth fund distributed universally. Andrew Yang's 2020 "Freedom Dividend" ($1,000/month for every US adult over 18, financed by a value-added tax on automation) seeded mainstream US political discourse. Yang in 2026 characterised the emerging pattern of white-collar displacement as the "AI jobpocalypse." Critical scholarship (Frontiers in AI, 2025) challenges the tech-elite UBI narrative as "symbolic violence" — a framing that naturalises extreme wealth concentration while offering minimal structural redistribution, and which creates a tripartite hierarchy of AI owners, skilled AI users, and passive UBI recipients that entrenches rather than dissolves class divisions.
  - Climate-inequality intersections compound the distributional picture along a second axis. The WID Climate Inequality Report 2025 (Chancel et al.) documents that without coordinated mitigation, climate impacts will increase the global Gini coefficient by approximately 1.4 points by 2100, concentrated in tropical and subtropical low-income nations that contributed least to cumulative greenhouse gas emissions. Nature Climate Change (2025) multimodel analysis finds that the wealthiest 10% of the global population account for approximately 50% of all consumption-based emissions, yet face the smallest proportional climate risk due to geographic position, adaptation capacity, and asset wealth. The intersection of AI-driven labour displacement, climate-induced income shocks, and insufficient safety-net infrastructure creates compound inequality risks for low-income tropical nations — particularly in Sub-Saharan Africa, South Asia, and small island developing states.

- ### Semantic Classification
  - owl-class:: ethics-society:GlobalInequality
  - owl-role:: SocioeconomicConcept
  - owl-inferred:: es:DistributionalEconomics, es:PoliticalEconomy, es:DevelopmentEconomics, es:DigitalDivide, es:ClimateJustice
  - belongs-to-domain:: [[EthicsAndSocietyDomain]], [[EconomicsDomain]], [[DigitalSocietyDomain]]
  - implemented-in-layer:: [[PolicyLayer]], [[EmpiricalResearchLayer]], [[GovernanceLayer]]

- ### Relationships
  - is-subclass-of:: [[Distributive Justice]], [[Political Economy]], [[Development Economics]], [[Social Stratification]], [[Economic Inequality]]
  - has-part:: [[Gini Coefficient]], [[Income Inequality]], [[Wealth Inequality]], [[Digital Divide]], [[Compute Divide]], [[Gender Pay Gap]], [[Intergenerational Mobility]], [[Financial Inclusion]], [[Labour Income Share]]
  - requires:: [[Distributional Data]], [[National Accounts]], [[Household Survey Data]], [[Tax Record Microdata]], [[World Inequality Database]]
  - enables:: [[Policy Design]], [[Redistributive Taxation]], [[Social Protection]], [[Universal Basic Income]], [[Digital Infrastructure Investment]], [[Progressive Wealth Tax]]
  - implements:: [[Gini Coefficient]], [[Palma Ratio]], [[Atkinson Index]], [[Top Income Shares]], [[S80/S20 Ratio]], [[Human Development Index]]
  - depends-on:: [[Macroeconomics]], [[Political Science]], [[Data Science]], [[Labour Economics]], [[Development Finance]], [[Institutional Economics]]
  - supports:: [[Sustainable Development Goals]], [[Global Digital Compact]], [[Climate Justice]], [[Financial Inclusion]], [[AI Governance]], [[Just Transition]]
  - uses:: [[World Inequality Database]], [[ILO WESO]], [[World Bank Findex]], [[OECD Income Distribution Database]], [[IMF Article IV Consultations]], [[UNDP Human Development Index]]
  - contrasts-with:: [[Trickle-Down Economics]], [[Efficient Market Hypothesis]], [[Meritocracy Thesis]], [[Kuznets Curve Hypothesis]]
  - related-to:: [[AI Labour Displacement]], [[Universal Basic Income]], [[Austerity]], [[Financialisation]], [[Climate Change]], [[Migration]], [[Social Mobility]], [[Poverty]], [[Human Development Index]], [[CBDCs]], [[Financial Technology]]
  - standardized-by:: [[United Nations Sustainable Development Goals]], [[OECD Guidelines on Measuring Inequality]], [[World Bank PovcalNet Standards]], [[ILO Decent Work Agenda]]
