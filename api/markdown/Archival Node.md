schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#ArchivalNode
legacy_uri:: urn:visionclaw:concept:blockchain:archival-node
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-f2134d4ab89b"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#ArchivalNode"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:archival-node"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:b603e6f1694bf09b170bdc247d2e27061c8b329d518f34274ac0d7ce3c03f340@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:archival-node",
  "@type": "OntologyClass",
  "label": "Archival Node",
  "subClassOf": [
    {
