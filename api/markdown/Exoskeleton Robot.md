- ### OntologyBlock
  id:: rb-0019-exoskeleton-robot-ontology
  collapsed:: true
	- ontology:: true
	- term-id:: RB-0931
	- domain-prefix:: RB
	- sequence-number:: 0019
	- filename-history:: ["rb-0019-exoskeleton-robot.md"]
	- preferred-term:: Exoskeleton Robot
	- source-domain:: rb
	- status:: draft
    - public-access:: true
	- definition:: **Exoskeleton Robot** - Exoskeleton Robot in robotics systems
	- maturity:: draft
	- owl:class:: rb:ExoskeletonRobot
	- owl:role:: Concept
	- belongsToDomain:: [[RoboticsDomain]]
- ## About rb 0019 exoskeleton robot
	-
	-
	- ### Original Content
	  collapsed:: true
...
# RB-0019: Exoskeleton Robot
		  ...
		  ```clojure
		  (Declaration (Class :ExoskeletonRobot))
		  (SubClassOf :ExoskeletonRobot :ServiceRobot)
		  
		  (AnnotationAssertion rdfs:label :ExoskeletonRobot "Exoskeleton Robot"@en)
		  (AnnotationAssertion rdfs:comment :ExoskeletonRobot
		    "Exoskeleton Robot - Foundational robotics concept"@en)
		  (AnnotationAssertion :termID :ExoskeletonRobot "RB-0019"^^xsd:string)
		  
		  (Declaration (ObjectProperty :relates To))
		  (ObjectPropertyDomain :relatesTo :ExoskeletonRobot)
		  
		  (Declaration (DataProperty :hasProperty))
		  (DataPropertyDomain :hasProperty :ExoskeletonRobot)
