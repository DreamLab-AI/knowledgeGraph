...
- ### Content
  ...
  - ### Major Networks: Detailed Architecture
	  ...
	  **Single-Owner Chunks (SOC)**: Mutable references — content addressed by owner public key + [private]. Enables feeds, mutable state on top of immutable underlying chunks.
  ...
  - ### Academic Context: Foundational Research
	  ...
	  - Miller et al. (IEEE S&P 2014) **Permacoin**: academic precursor demonstrating Bitcoin work [private] fund data preservation, foreshadowing Arweave's design.
