schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/distributed-collaboration#RemoteCommunication
legacy_uri:: urn:visionclaw:concept:distributed-collaboration:remote-communication
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-eb42e60b30b8"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/distributed-collaboration#RemoteCommunication"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:distributed-collaboration:remote-communication"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:27eeddef6a8f9289971fc00f299c72200e35dfb9eaa1c5c85b2c860eaed96f19@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
```json-ld
{
  ...
  "definition": "Remote Communication is a concept within the telecollaboration domain. Further enrichment pending.",
  "vc:qualityScore": {
    "@value": "0.35",
    "@type": "xsd:float"
  },
