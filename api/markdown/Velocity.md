schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/robotics#Velocity
legacy_uri:: urn:visionclaw:concept:robotics:velocity
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-e04c7c2dcaec"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/robotics#Velocity"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:robotics:velocity"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:b8f3dfdc86320f8fdfefde117fa1e1b2f7cf661fdb624e325cb66466108948fe@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:velocity",
  "@type": "OntologyClass",
  "label": "Velocity",
  "subClassOf": [
    {
