...
# RB-0044: Velocity
		  ...
		  ```clojure
		  (Declaration (Class :Velocity))
		  (SubClassOf :Velocity :Robot)
		  
		  (AnnotationAssertion rdfs:label :Velocity "Velocity"@en)
		  (AnnotationAssertion rdfs:comment :Velocity
		    "Velocity - Foundational robotics concept"@en)
		  (AnnotationAssertion :termID :Velocity "RB-0044"^^xsd:string)
		  
		  (Declaration (ObjectProperty :relates To))
		  (ObjectPropertyDomain :relatesTo :Velocity)
		  
		  (Declaration (DataProperty :hasProperty))
		  (DataPropertyDomain :hasProperty :Velocity)
