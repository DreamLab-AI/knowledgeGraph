schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#SuggestedReadingOrder
legacy_uri:: urn:visionclaw:concept:infrastructure:suggested-reading-order
public:: true
...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "suggested-reading-order",
  ...
  "vc:outboundWikilinks": [
    ...
    },
    {
      ...
      "vc:label": "Definitions and frameworks for Metaverse"
    },
    {
    ...
    {
      "@id": "urn:visionflow:owl:class:octave-multi-model-laboratory",
      "vc:label": "Octave Multi Model Laboratory"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-c0ee5173749d"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#SuggestedReadingOrder"
    },
    {
      "vc:key": "maturity",
      "vc:value": "draft"
    ...
    },
    {
      ...
      "vc:value": "Suggested Reading Order"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:suggested-reading-order"
    },
    {
      "vc:key": "status",
      "vc:value": "stub"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:7501496bb3a2806743240201054a4d81486c216f470b828ba88290db0d918dc4@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:suggested-reading-order",
  "@type": "OntologyClass",
  ...
  "definition": "Suggested Reading Order is a concept within the ngm domain.",
  "vc:qualityScore": {
    "@value": "0.50",
    "@type": "xsd:float"
  },
