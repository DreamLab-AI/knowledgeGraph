...
```json-ld
{
  ...
  "relations": {
    ...
    "dependsOn": [
      {
        "@id": "urn:ngm:class:sequential-data",
...
- ### Semantic Classification
  - owl-class:: artificial-intelligence:RecurrentNeuralNetwork
  - owl-role:: Algorithm
...
- ### Content
  ...
  - NHS England digital teams (formerly [[NHS Digital]], which merged into NHS England in February 2023): Patient pathway optimization using RNN-based prediction
