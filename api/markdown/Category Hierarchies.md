schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#CategoryHierarchies
legacy_uri:: urn:visionclaw:concept:spatial-computing:category-hierarchies
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-2847af6be2a5"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#CategoryHierarchies"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:category-hierarchies"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
