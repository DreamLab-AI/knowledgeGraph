schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#Parametric
legacy_uri:: urn:visionclaw:concept:infrastructure:parametric
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-555c2b99b68b"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#Parametric"
    },
    {
      "vc:key": "maturity",
      "vc:value": "draft"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:parametric"
    },
    {
      "vc:key": "status",
      "vc:value": "stub"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:373ee02de64ace0d2596b5e0ad353da78b3dc743f3e8ffa061927a3915159b06@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:parametric",
  "@type": "OntologyClass",
  "label": "Parametric",
  "subClassOf": [
    {
  ...
  "definition": "Parametric is a concept within the ngm domain.",
  "vc:qualityScore": {
    "@value": "0.50",
    "@type": "xsd:float"
  },
