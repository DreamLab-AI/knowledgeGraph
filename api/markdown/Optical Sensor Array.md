schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/robotics#OpticalSensorArray
legacy_uri:: urn:visionclaw:concept:robotics:optical-sensor-array
public:: true
  ...
  "vc:legacyProperties": [
    {
      ...
      "vc:value": "image sensor array, focal-plane array, FPA, CCD array, CMOS image sensor, photodetector array, SPAD array, ToF sensor array"
    },
    {
    ...
    {
      "vc:key": "bridges-to",
      "vc:value": "[[Spatial Computing]], [[Computer Vision]], [[Depth Sensing]], [[Eye Tracking]], [[Lidar]]"
    },
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-977f7372c900"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/robotics#OpticalSensorArray"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:robotics:optical-sensor-array"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:optical-sensor-array:776c802a9fc9",
  ...
  "vc:resolutions": [
    {
      "raw": "[[2D LiDAR]]",
      "resolved": "urn:visionflow:owl:class:2-d-li-dar",
      "kind": "ResolvedLink"
    },
    {
      "raw": "[[3D LiDAR]]",
      "resolved": "urn:visionflow:owl:class:3-d-li-dar",
      "kind": "ResolvedLink"
    },
    {
      "raw": "[[AI Hardware]]",
    ...
    {
      "raw": "[[Infrared Sensor]]",
      "resolved": "urn:visionflow:owl:class:infrared-sensor",
      "kind": "ResolvedLink"
    },
    {
      "raw": "[[InfraredSensor]]",
    ...
    {
      "raw": "[[Real-Time Inference at Edge]]",
      "resolved": "urn:visionflow:owl:class:real-time-inference-at-edge",
      "kind": "ResolvedLink"
    },
    {
    ...
    {
      "raw": "[[RoboticsCoreConcepts]]",
      "resolved": "urn:visionflow:owl:class:robotics-core-concepts",
      "kind": "ResolvedLink"
    },
    {
...
- ### Definition
  - A multi-element optical sensing arrangement comprising spatially distributed photodetectors—including CCD (Charge-Coupled Device) arrays, CMOS (Complementary Metal-Oxide-Semiconductor) image sensors, SPAD (Single-Photon Avalanche Diode) arrays, InGaAs infrared arrays, avalanche photodiode (APD) arrays, photodiode arrays, and time-of-flight (ToF) array architectures—that collectively capture, detect, or spatially resolve light across a defined field of view for imaging, depth measurement, spectral analysis, or spatial sensing purposes, implemented as a two-dimensional (or one-dimensional) matrix of photodetector elements on a semiconductor substrate where each element converts incident photons to electrical charge via the photoelectric effect and reads that charge through an associated readout circuit chain.
  - Spatial computing deployments define the 2024–2026 frontier: Apple Vision Pro (launched January 2024, $3,499, ~350K units in year one) integrates a six-sensor optical array — dual 6.5 MP IR cameras at 90 Hz for eye tracking, four world-facing cameras for colour passthrough and inside-out SLAM, and dual LiDAR scanners — enabling gaze-driven foveated rendering that delivers full resolution only within 15° of gaze centre, saving 50–70% GPU compute and enabling the M2+R1 chip pair to sustain 8K-per-eye spatial video at 90 fps; Meta Quest 3 (October 2023, $499) uses a five-camera array achieving 10 PPD colour passthrough with mixed-reality depth mapping; PlayStation VR2 (2023, 4 million units shipped) deploys a four-camera inside-out array with per-eye SPAD-based eye tracking for foveated rendering on PlayStation 5.
  - Solid-state automotive LiDAR arrays displaced the spinning Velodyne HDL-64E ($75,000 in 2010): Luminar Iris SPAD-array 905 nm pulsed laser achieves 300 m range at 10 cm resolution under $1,000 BOM (OEM contracted to Volvo, Nissan, Polestar, Mercedes-Benz, Toyota); Innoviz InnovizTwo (2024) InGaAs SPAD with MEMS resonant mirror achieves 200×100° FOV, 0.05° angular resolution, 300 m range (deployed by BMW iSeries and Mobileye SuperVision, production exceeding 500,000 units/year from Rehovot, Israel); Aeye 4Sight M intelligent MEMS-steered SPAD array with adaptive ROI sampling at 500+ fps OEM-contracted to General Motors Ultra Cruise in 2024 vehicles.
  - Pixel architecture variants: global shutter (simultaneous exposure eliminating rolling-shutter artefacts at >500 fps for robotics and machine vision), rolling shutter (row-by-row readout standard in smartphone CMOS at 12 MP / 60 fps), and stacked sensor designs — Sony Exmor RS BSI-stacked separates pixel layer from DRAM+logic layers enabling 120 fps 4K with on-chip HDR; Sony IMX989 1-inch stacked CMOS achieves 50.3 MP at 8-stop dynamic range with 2.4 µm pixel pitch; Samsung ISOCELL HP9 200 MP sensor (2024) integrates on-chip AI accelerator at 10 TOPS for in-sensor neural inference reducing host SoC bandwidth by 80%.
  - Key performance parameters: pixel count spanning 1M (XR headset ToF arrays) through 200M (Samsung ISOCELL HP9); photodetector pitch from 0.56 µm (Samsung ISOCELL HP3) to 18 µm (scientific astronomy CCD); read noise from 0.15 e⁻ rms (Gpixel GSENSE6060 scientific sCMOS) to 10 e⁻ (consumer CMOS); peak quantum efficiency 95%+ at 550 nm for BSI CMOS and 98%+ at 800 nm for deep-depletion CCDs; frame rates from 1 fps (JWST NIRCam deep exposures) to 1 Mfps (ultrafast Kirana CMOS for shock physics).
  - Spectral coverage: deep-UV (200 nm silicon-enhanced CCD for semiconductor inspection), visible (400–700 nm standard CMOS), NIR (700–1000 nm Si CMOS with AR coating), SWIR (1000–2500 nm InGaAs arrays), MWIR (3–5 µm InSb/HgCdTe for thermal imaging), LWIR (8–14 µm bolometer arrays and HgCdTe FPAs for surveillance and astronomy).
  - Market context (Yole Développement 2025): global image sensor market $24.5 billion in 2024; Sony 44% share, Samsung 23%, OmniVision 11%, STMicroelectronics 8%; automotive sensor submarket $4.2 billion (+38% YoY); LiDAR market $2.8 billion in 2024 projected to $7.9 billion by 2028 at 29% CAGR (MarketsandMarkets 2025).

- ### Semantic Classification
  - owl-class:: robotics:OpticalSensorArray
  - owl-role:: SensingComponent
  - owl-inferred:: robotics:Sensor, robotics:PerceptionSystem, robotics:ImagingSystem, robotics:ExteroceptiveSensor
  - belongs-to-domain:: [[RoboticsCoreConcepts]], [[Spatial Computing System]], [[Computer Vision System]]
  - implemented-in-layer:: [[Hardware]], [[XR Hardware]], [[AI Hardware]], [[Edge Computing]]
...
- ### Content
  ...
  ## Compositional Relationships (Components)
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:hasPart rb:PhotodetectorElement))
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:hasPart rb:ReadoutIntegratedCircuit))
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:hasPart rb:MicrolensArray))
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:hasPart rb:ColorFilterArray))
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:hasPart rb:AnalogToDigitalConverter))
	    SubClassOf(rb:OpticalSensorArray
	    ...
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:requires rb:OpticalIlluminator))
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:requires rb:ReadoutCircuit))
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:requires rb:CalibratedLensOptics))
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:requires rb:TimingController))
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:requires rb:SignalProcessingPipeline))
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:dependsOn rb:SemiconductorFabrication))
	    SubClassOf(rb:OpticalSensorArray
	    ...
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:enables rb:DepthEstimation))
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:enables rb:EyeTracking))
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:enables rb:FoveatedRendering))
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:enables rb:LiDARPointCloudGeneration))
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:enables rb:SLAMPerception))
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:enables rb:HyperspectralImaging))
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:enables rb:MedicalRetinalScanning))
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:supports rb:AutonomousVehicleNavigation))
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:supports rb:SpatialComputingInteraction))
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:supports rb:RoboticObjectDetection))

	    ## Implementation Relationships
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:implements rb:GlobalShutterArchitecture))
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:implements rb:RollingShutterArchitecture))
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:implements rb:BackIlluminatedCMOS))
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:implements rb:StackedSensorDesign))
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:implements rb:TimeOfFlightMeasurement))
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:implements rb:CorrelatedDoubleSampling))
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:implements rb:HighDynamicRangeCapture))
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:uses rb:SPADDetector))
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:uses rb:InGaAsInfraredDetector))
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:uses rb:CCDReadoutChain))

	    ## Reduction Relationships
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:reduces rb:RenderingComputationalLoad))
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:reduces rb:SensorDarkCurrent))
	    SubClassOf(rb:OpticalSensorArray
	      ObjectSomeValuesFrom(rb:reduces rb:DepthMeasurementLatency))
	    SubClassOf(rb:OpticalSensorArray
	  ...
	  FunctionalDataProperty(rb:maxPixelCount)
	  FunctionalDataProperty(rb:peakQuantumEfficiency)
	  ```
  ...
  - Luminar Iris: custom SPAD array with 905 nm pulsed laser and MEMS mirror achieves 300 m range at 10 cm resolution for automotive Level 3 autonomy; BOM cost trajectory toward $500 by 2026 (from $12,000 in 2020).
  ...
  - **Luminar Iris** (OEM volume from 2022): custom 905 nm SPAD array with MEMS galvo mirror; 300 m range, 10 cm range resolution, 120°×30° FOV at 10 Hz; BOM trajectory $12,000 (2020) → $2,000 (2023) → $500 (2026 target); OEM contracts with Volvo, Nissan, Polestar, Mercedes-Benz, Toyota; Luminar Technologies publicly traded (LAZR, NASDAQ) with $2.3B revenue backlog as of Q1 2025.
  ...
  - **Trend 2 — Solid-state LiDAR cost deflation**: BOM cost approaching consumer price points.
    - Luminar Iris cost trajectory: $12,000 (2020) → $2,000 (2023) → $500 (2026 target) driven by SPAD array yield improvements and OEM volume.
    ...
    - Total LiDAR market: $2.8 billion (2024) projected $7.9 billion by 2028 at 29% CAGR (MarketsandMarkets 2025).
  ...
  - Global image sensor market: $24.5 billion in 2024 (Yole Développement 2025); Sony 44%, Samsung 23%, OmniVision 11%, STMicroelectronics 8%; automotive sensor sub-market $4.2 billion, +38% YoY.
  ...
  - **Key performance trade-offs in multi-array fusion**:
    ...
    - Cost vs performance: InGaAs arrays cost $500–$50,000 per sensor (depending on format) vs Si CMOS at $1–$500; limits InGaAs to specialist and premium applications; QD-on-CMOS approaches targeting $20–$100 SWIR sensor by 2027.
  ...
  - MarketsandMarkets (2025) LiDAR Market by Technology, Application, Range and Geography — Forecast to 2030. Chicago: MarketsandMarkets Research. [$2.8B → $7.9B 2024–2028.]
  ...
  - ## Metadata
    ...
    - source-stub-lines:: 36
    - owl-axiom-count:: 42 SubClassOf axioms (Compositional 7, Dependency 8, Capability 10, Implementation 10, Reduction 5, Association 5 = 45; plus 4 DataSomeValuesFrom + 1 DataMinCardinality = 50 total property expressions)
    - relationship-count:: 78 wikilinks across 11 relationship types
    - reference-count:: 26 peer-reviewed and industry references
