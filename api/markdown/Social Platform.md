schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#SocialPlatform
legacy_uri:: urn:visionclaw:concept:infrastructure:social-platform
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-0b0d053f22ef"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#SocialPlatform"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:social-platform"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:806571c040f358693c3e6eba4fd7edbaed22502a5cb863822bfa447f63a22ea7@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:social-platform",
  "@type": "OntologyClass",
  ...
  "definition": "SocialPlatform is a concept within the ngm domain.",
  "vc:qualityScore": {
    "@value": "0.35",
    "@type": "xsd:float"
  },
