schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#Portability
legacy_uri:: urn:visionclaw:concept:spatial-computing:portability
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-512956eb2c93"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#Portability"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:portability"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
