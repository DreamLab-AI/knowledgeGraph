schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#ComputationalComponent
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:computational-component
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-dc6b757092eb"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#ComputationalComponent"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:computational-component"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:d93fa7e1b7bd2114c6bcba74f0802a47ff5a3c1177f63983c104cdedb15eb6e9@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:computational-component",
  "@type": "OntologyClass",
  ...
  "definition": "Computational Component is a concept within the ai domain.",
  "vc:qualityScore": {
    "@value": "0.35",
    "@type": "xsd:float"
  },
