schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#SpatialUserInterfaces
legacy_uri:: urn:visionclaw:concept:spatial-computing:spatial-user-interfaces
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-d451816461db"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#SpatialUserInterfaces"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:spatial-user-interfaces"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
