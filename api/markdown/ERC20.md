schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#ERC20
legacy_uri:: urn:visionclaw:concept:blockchain:erc20
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-5938e0455aaf"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#ERC20"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:erc20"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:a1a3628aa6ab646d05a4dccfd79ebfa48b50fa2590f074fdb4d4b843c38ed953@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:erc20",
  "@type": "OntologyClass",
  "label": "ERC20",
  "subClassOf": [
    {
