schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#ConversionPipeline
legacy_uri:: urn:visionclaw:concept:spatial-computing:conversion-pipeline
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-1993464a695a"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#ConversionPipeline"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:conversion-pipeline"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
