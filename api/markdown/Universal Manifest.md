- ### OntologyBlock
  ...
  collapsed:: true
	...
	- belongsToDomain:: [[Interoperability Domain]], [[DisruptiveTechDomain]], [[Trust And Governance Domain]]
...
- is-subclass-of:: [[Metaverse]]
	  ...
	  collapsed:: true
		...
		- has-part:: [[Relationship Graph]]
		- has-part:: [[Identity Credentials]]
		- has-part:: [[Provenance Record]]
		- has-part:: [[Permission Grants]]
		- has-part:: [[Asset Registry]]
		- requires:: [[Verifiable Credential]]
		- requires:: [[Decentralized Identifier]]
		- requires:: [[Cryptographic Signature]]
		- requires:: [[Metadata Schema]]
		- enables:: [[Permissioned Access]]
		- enables:: [[Asset Interoperability]]
		- enables:: [[Cross-Platform Identity]]
		- enables:: [[Avatar Portability]]
		- enables:: [[Decentralized Ownership]]
		- depends-on:: [[Data Format Standard]]
		- depends-on:: [[Identity Provider]]
		- depends-on:: [[Trust Registry]]
