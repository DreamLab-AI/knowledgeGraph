- ### OntologyBlock
  id:: velocity-control-ontology
  collapsed:: true
	- ontology:: true
	- term-id:: RB-0115
	- preferred-term:: VelocityControl
	- alternative-terms:: Speed Control, Angular Velocity Control, Linear Velocity Control, Rotational Speed Control, Motor Speed Control, Spindle Speed Control
	- source-domain:: rb
	...
	- source:: [[ISO 8373 Robotics Vocabulary]], [[IEC 61800 Adjustable Speed Electrical Power Drive Systems]], [[IEEE Std 1547 Distributed Energy Resources]], [[ANSI/RIA R15.06 Industrial Robot Safety]], [[Feedback Control of Dynamic Systems - Franklin et al.]]

- #### Relationships
  id:: velocity-control-relationships
	...
	- measured-by:: [[Tachometer]], [[Encoder]], [[Resolver]], [[IMU]], [[DopplerSensor]]
	- used-in:: [[CNCMachine]], [[ConveyorSystem]], [[MobileRobot]], [[PrintingPress]], [[VariableSpeedDrive]], [[WindTurbine]]
	- characterized-by:: [[SteadyStateError]], [[SettlingTime]], [[Bandwidth]], [[VelocityRipple]], [[ControllerGain]]
	- implements:: [[PIControl]], [[FeedforwardControl]], [[CascadeControl]], [[AdaptiveControl]], [[ObserverDesign]]

- #### OWL Formal Semantics
  id:: velocity-control-owl-axioms
  collapsed:: true
	- ```clojure
	  ...
	  Ontology(<http://purl.org/robotics/ontology/RB-0115>
