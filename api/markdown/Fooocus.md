schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#Fooocus
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:fooocus
public:: true
...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    {
      "@id": "urn:visionflow:linked:acm-chi-2024-generative-ai-interfaces-studies",
      "vc:label": "ACM CHI 2024 Generative AI Interfaces Studies"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:automatic1111-stable-diffusion-web-ui-repository",
      "vc:label": "AUTOMATIC1111 Stable Diffusion WebUI Repository"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:comfy-ui-repository",
      "vc:label": "ComfyUI Repository"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:fooocus-mre-repository",
      "vc:label": "Fooocus-MRE Repository"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:forge-web-ui-repository",
      "vc:label": "Forge WebUI Repository"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:invoke-ai-repository",
      "vc:label": "InvokeAI Repository"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:karras-et-al-2022-edm-sampler-design-space",
      "vc:label": "Karras et al. 2022 EDM Sampler Design Space"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:lin-yang-2024-sdxl-lightning",
      "vc:label": "Lin Yang 2024 SDXL-Lightning"
    },
    {
      "@id": "urn:visionflow:linked:lllyasviel-fooocus-readme",
      "vc:label": "lllyasviel Fooocus README"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:lu-et-al-2022-dpm-solver-plus-plus",
      "vc:label": "Lu et al. 2022 DPM-Solver Plus Plus"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:model-orchestration-layer",
      "vc:label": "ModelOrchestrationLayer"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:open-source-software-domain",
      "vc:label": "OpenSourceSoftwareDomain"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:ren-et-al-2024-hyper-sd",
      "vc:label": "Ren et al. 2024 Hyper-SD"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:ruined-fooocus-repository",
      "vc:label": "RuinedFooocus Repository"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:si-et-al-2023-free-u",
      "vc:label": "Si et al. 2023 FreeU"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:simple-sdxl2-repository",
      "vc:label": "SimpleSDXL2 Repository"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:stability-ai-sdxl-release",
      "vc:label": "Stability AI SDXL Release"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:swarm-ui-repository",
      "vc:label": "SwarmUI Repository"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:user-interface-domain",
      "vc:label": "UserInterfaceDomain"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:zhang-2024-frame-pack",
      "vc:label": "Zhang 2024 FramePack"
    },
    {
      "@id": "urn:visionflow:linked:zhang-2024-ic-light",
      "vc:label": "Zhang 2024 IC-Light"
    },
    {
      "@id": "urn:visionflow:linked:zhang-2024-paints-undo",
      "vc:label": "Zhang 2024 Paints-Undo"
    },
    {
  ...
  "vc:legacyProperties": [
    {
      ...
      "vc:value": "Fooocus-V2, lllyasviel/Fooocus, Fooocus SDXL Interface"
    },
    {
    ...
    {
      "vc:key": "bridges-to",
      "vc:value": "[[Stable Diffusion XL]], [[Generative AI]]"
    },
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-88b06194923d"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#Fooocus"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:fooocus"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:fooocus:776c802a9fc9",
  ...
  "vc:resolutions": [
    {
      "raw": "[[ACM CHI 2024 Generative AI Interfaces Studies]]",
      "resolved": "urn:visionflow:linked:acm-chi-2024-generative-ai-interfaces-studies",
      "kind": "StubLink"
    },
    {
      "raw": "[[Adobe Firefly]]",
    ...
    {
      "raw": "[[Automatic FreeU Module]]",
      "resolved": "urn:visionflow:linked:automatic-free-u-module",
      "kind": "StubLink"
    },
    {
      "raw": "[[Automatic Refiner Scheduler]]",
      "resolved": "urn:visionflow:linked:automatic-refiner-scheduler",
      "kind": "StubLink"
    },
    {
      "raw": "[[AUTOMATIC1111 Stable Diffusion WebUI Repository]]",
      "resolved": "urn:visionflow:linked:automatic1111-stable-diffusion-web-ui-repository",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[CLIP Skip]]",
      "resolved": "urn:visionflow:linked:clip-skip",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[ComfyUI Repository]]",
      "resolved": "urn:visionflow:linked:comfy-ui-repository",
      "kind": "StubLink"
    },
    {
      "raw": "[[Concept Art Workflows]]",
      "resolved": "urn:visionflow:linked:concept-art-workflows",
      "kind": "StubLink"
    },
    {
      "raw": "[[ControlNet]]",
    ...
    {
      "raw": "[[DPM Plus Plus 2M Karras Sampler]]",
      "resolved": "urn:visionflow:linked:dpm-plus-plus-2-m-karras-sampler",
      "kind": "StubLink"
    },
    {
      "raw": "[[Educational AI Demonstrations]]",
      "resolved": "urn:visionflow:linked:educational-ai-demonstrations",
      "kind": "StubLink"
    },
    {
      "raw": "[[Faceswap]]",
      "resolved": "urn:visionflow:linked:faceswap",
      "kind": "StubLink"
    },
    {
      "raw": "[[Faceswap Module]]",
      "resolved": "urn:visionflow:linked:faceswap-module",
      "kind": "StubLink"
    },
    {
      "raw": "[[Fooocus-MRE]]",
      "resolved": "urn:visionflow:linked:fooocus-mre",
      "kind": "StubLink"
    },
    {
      "raw": "[[Fooocus-MRE Repository]]",
      "resolved": "urn:visionflow:linked:fooocus-mre-repository",
      "kind": "StubLink"
    },
    {
      "raw": "[[Forge WebUI]]",
    ...
    {
      "raw": "[[Forge WebUI Repository]]",
      "resolved": "urn:visionflow:linked:forge-web-ui-repository",
      "kind": "StubLink"
    },
    {
      "raw": "[[FramePack]]",
      "resolved": "urn:visionflow:linked:frame-pack",
      "kind": "StubLink"
    },
    {
      "raw": "[[FreeU Free-Lunch Rebalancing]]",
      "resolved": "urn:visionflow:linked:free-u-free-lunch-rebalancing",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[GPLv3 Licence]]",
      "resolved": "urn:visionflow:linked:gplv3-licence",
      "kind": "StubLink"
    },
    {
      "raw": "[[GPT-2 Prompt Expansion]]",
      "resolved": "urn:visionflow:linked:gpt-2-prompt-expansion",
      "kind": "StubLink"
    },
    {
      "raw": "[[GPU with 4-8GB VRAM]]",
      "resolved": "urn:visionflow:linked:gpu-with-4-8-gb-vram",
      "kind": "StubLink"
    },
    {
      "raw": "[[Gradio Application]]",
      "resolved": "urn:visionflow:linked:gradio-application",
      "kind": "StubLink"
    },
    {
      "raw": "[[Gradio Framework]]",
      "resolved": "urn:visionflow:linked:gradio-framework",
      "kind": "StubLink"
    },
    {
      "raw": "[[Gradio Specification]]",
      "resolved": "urn:visionflow:linked:gradio-specification",
      "kind": "StubLink"
    },
    {
      "raw": "[[Gradio Web UI]]",
      "resolved": "urn:visionflow:linked:gradio-web-ui",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[IC-Light]]",
      "resolved": "urn:visionflow:linked:ic-light",
      "kind": "StubLink"
    },
    {
      "raw": "[[Image Prompt IP-Adapter Module]]",
      "resolved": "urn:visionflow:linked:image-prompt-ip-adapter-module",
      "kind": "StubLink"
    },
    {
      "raw": "[[Indie Game Asset Creation]]",
      "resolved": "urn:visionflow:linked:indie-game-asset-creation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Inpaint Pipeline]]",
      "resolved": "urn:visionflow:linked:inpaint-pipeline",
      "kind": "StubLink"
    },
    {
      "raw": "[[InvokeAI]]",
    ...
    {
      "raw": "[[InvokeAI Repository]]",
      "resolved": "urn:visionflow:linked:invoke-ai-repository",
      "kind": "StubLink"
    },
    {
      "raw": "[[IP-Adapter Image Conditioning]]",
      "resolved": "urn:visionflow:linked:ip-adapter-image-conditioning",
      "kind": "StubLink"
    },
    {
      "raw": "[[Karras et al. 2022 EDM Sampler Design Space]]",
      "resolved": "urn:visionflow:linked:karras-et-al-2022-edm-sampler-design-space",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[LCM Sampler]]",
      "resolved": "urn:visionflow:linked:lcm-sampler",
      "kind": "StubLink"
    },
    {
      "raw": "[[Lightning Sampler]]",
      "resolved": "urn:visionflow:linked:lightning-sampler",
      "kind": "StubLink"
    },
    {
      "raw": "[[Lin Yang 2024 SDXL-Lightning]]",
      "resolved": "urn:visionflow:linked:lin-yang-2024-sdxl-lightning",
      "kind": "StubLink"
    },
    {
      "raw": "[[lllyasviel Fooocus README]]",
      "resolved": "urn:visionflow:linked:lllyasviel-fooocus-readme",
      "kind": "StubLink"
    },
    {
      "raw": "[[LoRA Blending Module]]",
      "resolved": "urn:visionflow:linked:lo-ra-blending-module",
      "kind": "StubLink"
    },
    {
      "raw": "[[Local AI Art Creation]]",
      "resolved": "urn:visionflow:linked:local-ai-art-creation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Local Image Generation Interface]]",
      "resolved": "urn:visionflow:linked:local-image-generation-interface",
      "kind": "StubLink"
    },
    {
      "raw": "[[Local Privacy Workflows]]",
      "resolved": "urn:visionflow:linked:local-privacy-workflows",
      "kind": "StubLink"
    },
    {
      "raw": "[[Lu et al. 2022 DPM-Solver Plus Plus]]",
      "resolved": "urn:visionflow:linked:lu-et-al-2022-dpm-solver-plus-plus",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[ModelOrchestrationLayer]]",
      "resolved": "urn:visionflow:linked:model-orchestration-layer",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[OpenSourceSoftwareDomain]]",
      "resolved": "urn:visionflow:linked:open-source-software-domain",
      "kind": "StubLink"
    },
    {
      "raw": "[[Outpainting]]",
    ...
    {
      "raw": "[[Paints-Undo]]",
      "resolved": "urn:visionflow:linked:paints-undo",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Privacy-Preserving Image Generation]]",
      "resolved": "urn:visionflow:linked:privacy-preserving-image-generation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Prompt Expansion]]",
      "resolved": "urn:visionflow:linked:prompt-expansion",
      "kind": "StubLink"
    },
    {
      "raw": "[[Prompt Expansion Engine]]",
      "resolved": "urn:visionflow:linked:prompt-expansion-engine",
      "kind": "StubLink"
    },
    {
      "raw": "[[PyTorch]]",
    ...
    {
      "raw": "[[PyraCanny ControlNet]]",
      "resolved": "urn:visionflow:linked:pyra-canny-control-net",
      "kind": "StubLink"
    },
    {
      "raw": "[[Python Runtime]]",
    ...
    {
      "raw": "[[Ren et al. 2024 Hyper-SD]]",
      "resolved": "urn:visionflow:linked:ren-et-al-2024-hyper-sd",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[RuinedFooocus]]",
      "resolved": "urn:visionflow:linked:ruined-fooocus",
      "kind": "StubLink"
    },
    {
      "raw": "[[RuinedFooocus Repository]]",
      "resolved": "urn:visionflow:linked:ruined-fooocus-repository",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[SDXL Refiner Handoff]]",
      "resolved": "urn:visionflow:linked:sdxl-refiner-handoff",
      "kind": "StubLink"
    },
    {
      "raw": "[[SDXL VAE FP16 Fix]]",
      "resolved": "urn:visionflow:linked:sdxl-vae-fp16-fix",
      "kind": "StubLink"
    },
    {
      "raw": "[[Si et al. 2023 FreeU]]",
      "resolved": "urn:visionflow:linked:si-et-al-2023-free-u",
      "kind": "StubLink"
    },
    {
      "raw": "[[SimpleSDXL2]]",
      "resolved": "urn:visionflow:linked:simple-sdxl2",
      "kind": "StubLink"
    },
    {
      "raw": "[[SimpleSDXL2 Repository]]",
      "resolved": "urn:visionflow:linked:simple-sdxl2-repository",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Stability AI SDXL Release]]",
      "resolved": "urn:visionflow:linked:stability-ai-sdxl-release",
      "kind": "StubLink"
    },
    {
      "raw": "[[Stable Diffusion Frontend]]",
      "resolved": "urn:visionflow:linked:stable-diffusion-frontend",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Style Preset Library]]",
      "resolved": "urn:visionflow:linked:style-preset-library",
      "kind": "StubLink"
    },
    {
      "raw": "[[SwarmUI]]",
    ...
    {
      "raw": "[[SwarmUI Repository]]",
      "resolved": "urn:visionflow:linked:swarm-ui-repository",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[UserInterfaceDomain]]",
      "resolved": "urn:visionflow:linked:user-interface-domain",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Zhang 2024 FramePack]]",
      "resolved": "urn:visionflow:linked:zhang-2024-frame-pack",
      "kind": "StubLink"
    },
    {
      "raw": "[[Zhang 2024 IC-Light]]",
      "resolved": "urn:visionflow:linked:zhang-2024-ic-light",
      "kind": "StubLink"
    },
    {
      "raw": "[[Zhang 2024 Paints-Undo]]",
      "resolved": "urn:visionflow:linked:zhang-2024-paints-undo",
      "kind": "StubLink"
    },
    {
