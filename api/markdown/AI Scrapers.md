schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#AIScrapers
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:ai-scrapers
public:: true
...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:copyright-law-domain",
      "vc:label": "CopyrightLawDomain"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:data-acquisition-layer",
      "vc:label": "DataAcquisitionLayer"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:llm-friendly-crawler-libraries",
      "vc:label": "LLM-Friendly Crawler Libraries"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:web-scraping-tools",
  ...
  "vc:legacyProperties": [
    {
      ...
      "vc:value": "AI Crawlers, AI Training Crawlers, LLM Bots, Generative-AI Web Bots, Foundation-Model Scrapers, AI Web Harvesters"
    },
    {
    ...
    {
      "vc:key": "bridges-to",
      "vc:value": "[[Digital Twin]], [[Training Data]], [[Copyright]], [[Bot Management]]"
    },
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-7c41a2e0b8df"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#AIScrapers"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:ai-scrapers"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:ai-scrapers:776c802a9fc9",
  ...
  "vc:resolutions": [
    {
      "raw": "[[Academic Crawler]]",
      "resolved": "urn:visionflow:linked:academic-crawler",
      "kind": "StubLink"
    },
    {
      "raw": "[[Automated Agent]]",
      "resolved": "urn:visionflow:linked:automated-agent",
      "kind": "StubLink"
    },
    {
      "raw": "[[Bloom Filter]]",
    ...
    {
      "raw": "[[Bot Management]]",
      "resolved": "urn:visionflow:linked:bot-management",
      "kind": "StubLink"
    },
    {
      "raw": "[[CDN Layer]]",
      "resolved": "urn:visionflow:linked:cdn-layer",
      "kind": "StubLink"
    },
    {
      "raw": "[[Classic Search Crawler]]",
      "resolved": "urn:visionflow:linked:classic-search-crawler",
      "kind": "StubLink"
    },
    {
      "raw": "[[Common Crawl]]",
    ...
    {
      "raw": "[[Content Extraction Pipeline]]",
      "resolved": "urn:visionflow:linked:content-extraction-pipeline",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Content Type Negotiation]]",
      "resolved": "urn:visionflow:linked:content-type-negotiation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Copyright Law]]",
    ...
    {
      "raw": "[[CopyrightLawDomain]]",
      "resolved": "urn:visionflow:linked:copyright-law-domain",
      "kind": "StubLink"
    },
    {
      "raw": "[[Crawl Frontier]]",
      "resolved": "urn:visionflow:linked:crawl-frontier",
      "kind": "StubLink"
    },
    {
      "raw": "[[DataAcquisitionLayer]]",
      "resolved": "urn:visionflow:linked:data-acquisition-layer",
      "kind": "StubLink"
    },
    {
      "raw": "[[Data Acquisition Pipeline]]",
      "resolved": "urn:visionflow:linked:data-acquisition-pipeline",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[De-Duplication Hashing]]",
      "resolved": "urn:visionflow:linked:de-duplication-hashing",
      "kind": "StubLink"
    },
    {
      "raw": "[[Deduplication Filter]]",
      "resolved": "urn:visionflow:linked:deduplication-filter",
      "kind": "StubLink"
    },
    {
      "raw": "[[DNS]]",
    ...
    {
      "raw": "[[EU AI Act Article 53]]",
      "resolved": "urn:visionflow:linked:eu-ai-act-article-53",
      "kind": "StubLink"
    },
    {
      "raw": "[[Fine-Tuning Dataset Assembly]]",
      "resolved": "urn:visionflow:linked:fine-tuning-dataset-assembly",
      "kind": "StubLink"
    },
    {
      "raw": "[[Foundation Model Pre-Training]]",
      "resolved": "urn:visionflow:linked:foundation-model-pre-training",
      "kind": "StubLink"
    },
    {
    ...
    },
    {
      ...
      "resolved": "urn:visionflow:linked:headless-browser",
      "kind": "StubLink"
    },
    {
      "raw": "[[HTTP Client]]",
      "resolved": "urn:visionflow:linked:http-client",
      "kind": "StubLink"
    },
    {
      "raw": "[[HTTP Library]]",
      "resolved": "urn:visionflow:linked:http-library",
      "kind": "StubLink"
    },
    {
      "raw": "[[HTTP Protocol]]",
    ...
    {
      "raw": "[[IAB Tech Lab]]",
      "resolved": "urn:visionflow:linked:iab-tech-lab",
      "kind": "StubLink"
    },
    {
      "raw": "[[Identity Provenance]]",
      "resolved": "urn:visionflow:linked:identity-provenance",
      "kind": "StubLink"
    },
    {
      "raw": "[[IETF AIPREF Working Group]]",
      "resolved": "urn:visionflow:linked:ietf-aipref-working-group",
      "kind": "StubLink"
    },
    {
      "raw": "[[IETF RFC 9309]]",
      "resolved": "urn:visionflow:linked:ietf-rfc-9309",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Internet Bot]]",
      "resolved": "urn:visionflow:linked:internet-bot",
      "kind": "StubLink"
    },
    {
      "raw": "[[IP Range Manifest]]",
      "resolved": "urn:visionflow:linked:ip-range-manifest",
      "kind": "StubLink"
    },
    {
      "raw": "[[Knowledge Graph Extraction]]",
      "resolved": "urn:visionflow:linked:knowledge-graph-extraction",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[LLM-Friendly Crawler Libraries]]",
      "resolved": "urn:visionflow:linked:llm-friendly-crawler-libraries",
      "kind": "StubLink"
    },
    {
      "raw": "[[Multimodal Model Training]]",
      "resolved": "urn:visionflow:linked:multimodal-model-training",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Personal Web Scraper]]",
      "resolved": "urn:visionflow:linked:personal-web-scraper",
      "kind": "StubLink"
    },
    {
      "raw": "[[Playwright]]",
    ...
    {
      "raw": "[[Politeness Policy]]",
      "resolved": "urn:visionflow:linked:politeness-policy",
      "kind": "StubLink"
    },
    {
      "raw": "[[Politeness Throttling]]",
      "resolved": "urn:visionflow:linked:politeness-throttling",
      "kind": "StubLink"
    },
    {
      "raw": "[[Public Web Architecture]]",
      "resolved": "urn:visionflow:linked:public-web-architecture",
      "kind": "StubLink"
    },
    {
      "raw": "[[Public Web Content]]",
      "resolved": "urn:visionflow:linked:public-web-content",
      "kind": "StubLink"
    },
    {
      "raw": "[[RAG Pipelines]]",
      "resolved": "urn:visionflow:linked:rag-pipelines",
      "kind": "StubLink"
    },
    {
      "raw": "[[Regulated Data Processor]]",
      "resolved": "urn:visionflow:linked:regulated-data-processor",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Robots Exclusion Protocol]]",
      "resolved": "urn:visionflow:linked:robots-exclusion-protocol",
      "kind": "StubLink"
    },
    {
      "raw": "[[robots.txt Parser]]",
      "resolved": "urn:visionflow:linked:robots-txt-parser",
      "kind": "StubLink"
    },
    {
      "raw": "[[Search Index Construction]]",
      "resolved": "urn:visionflow:linked:search-index-construction",
      "kind": "StubLink"
    },
    {
      "raw": "[[Selenium]]",
    ...
    {
      "raw": "[[Sitemaps XML]]",
      "resolved": "urn:visionflow:linked:sitemaps-xml",
      "kind": "StubLink"
    },
    {
      "raw": "[[Storage Pipeline]]",
      "resolved": "urn:visionflow:linked:storage-pipeline",
      "kind": "StubLink"
    },
    {
      "raw": "[[Synthetic Data Curation]]",
      "resolved": "urn:visionflow:linked:synthetic-data-curation",
      "kind": "StubLink"
    },
    {
      "raw": "[[User-Agent String]]",
      "resolved": "urn:visionflow:linked:user-agent-string",
      "kind": "StubLink"
    },
    {
      "raw": "[[Web Archive Crawler]]",
      "resolved": "urn:visionflow:linked:web-archive-crawler",
      "kind": "StubLink"
    },
    {
      "raw": "[[Web Crawler]]",
    ...
    {
      "raw": "[[Web Scraping Tools]]",
      "resolved": "urn:visionflow:linked:web-scraping-tools",
      "kind": "StubLink"
    },
    {
...
- ### Definition
  - AI Scrapers are automated software agents (web crawlers, retrieval bots, and content-fetching pipelines) operated by foundation-model laboratories, AI search vendors, retrieval-augmented-generation services, dataset aggregators, and synthetic-media producers for the purpose of harvesting publicly accessible web content at scale to construct pre-training corpora, fine-tuning datasets, retrieval indexes, real-time grounding caches, and reinforcement-learning-from-human-feedback raw material, distinguished from classic search-engine crawlers (Googlebot, Bingbot) by the downstream use of harvested content as **training input to generative models** rather than indexing for link-based retrieval, comprising a well-documented census of named user-agents (OpenAI GPTBot, OAI-SearchBot, ChatGPT-User; Anthropic ClaudeBot, Claude-User, Claude-SearchBot; Google-Extended pseudo-token gating Gemini/Vertex training; Common Crawl CCBot underpinning GPT-3/LLaMA-1/Falcon/Mistral; Meta facebookexternalhit and meta-externalagent; ByteDance Bytespider feeding Doubao; Amazonbot feeding Alexa+/Olympus; Applebot-Extended gating Apple Intelligence training introduced June 2024; Diffbot commercial knowledge-graph extraction; PerplexityBot and the rotated UA-stripped variants exposed in the June 2024 Wired/Robb Knight investigation; Cohere-AI, YouBot, DuckAssistBot, ImagesiftBot/Hive Moderation), governed by the voluntary Robots Exclusion Protocol formalised as IETF RFC 9309 (September 2022) layered over Martijn Koster's 1994 ALIWEB-era robots.txt convention which provides only User-agent: */Disallow: directives unable to express per-purpose discrimination, monetary licence terms, or cryptographically-verified bot identity, prompting in 2024-2026 a wave of supplementary protocol proposals (IETF AIPREF Working Group chartered late 2024 for machine-readable AI-preference signals; IAB Tech Lab LLM Content Ingest API draft 2024; Cloudflare pay-per-crawl HTTP 402 proposal 2025; Spawning.ai ai.txt extending robots.txt grammar with model-and-use-case granularity; C2PA content-credentials binding upstream licence metadata; Microsoft NLWeb 2025 for site-level AI-agent disclosure), policed in practice by enterprise bot-management vendors (Cloudflare AI Audit/AI Labyrinth shipping July 2024 one-click block-all-AI-bots for 27M+ domains and March 2025 synthetic-content poisoning of non-compliant scrapers, default-block of unknown AI crawlers on the free tier July 2025; Akamai Bot Manager; Imperva Advanced Bot Protection whose 2024 Bad Bot Report measured **49.6 percent of all internet traffic as bots with 32 percent bad-bot share—the highest figure ever recorded—and LLM-training scrapers the fastest-growing bad-bot category**; DataDome; Kasada cryptographic proof-of-work challenges; HUMAN Security/PerimeterX/BotGuard), and confronted across an unprecedented litigation landscape including the **New York Times v. OpenAI/Microsoft** (SDNY, 27 December 2023, motion-to-dismiss largely denied March 2025, trial 2026), **Getty Images v. Stability AI** UK High Court trial June-July 2025 with the November 2025 judgment by Mrs Justice Joanna Smith ruling Stable Diffusion does not store or reproduce Getty's training works (training-infringement claim failing on territoriality grounds as model training occurred outside the UK) yet finding trademark infringement in watermark reproduction, **Authors Guild v. OpenAI** consolidated MDL (Sarah Silverman, Paul Tremblay, Michael Chabon, George RR Martin, Jodi Picoult), the **RIAA v. Suno/Udio** June 2024 action against Cambridge MA and Uncharted Labs music-generation startups with Suno admitting fair-use training on commercial recordings, **News Corp/Dow Jones v. Perplexity** October 2024, and pre-litigation pressure that produced commercial settlements including the **Reddit/Google 60M-USD/year deal February 2024**, Stack Overflow's OverflowAPI licensing pact May 2024, NYT/Apple, Associated Press/OpenAI, Financial Times/Anthropic, Le Monde/OpenAI and News Corp/OpenAI deals collectively constituting a **$1.2B 2025 training-data licensing market projected to $5.4B by 2030** (LSEG); subject in parallel to data-protection enforcement under GDPR with cumulative Clearview AI sanctions exceeding €100M (Italy Garante €20M Feb 2022; CNIL €20M Oct 2022; Hellenic DPA €20M July 2022; Dutch DPA €30.5M Sep 2024 with €5M per-officer penalties for non-cooperation; ICO £7.5M provisional Oct 2021 overturned 2023 on jurisdiction) and to forward-looking EU AI Act Article 53 GPAI obligations (Regulation 2024/1689 in force 1 August 2024, training-data summary disclosures applicable from 2 August 2025 with the GPAI Code of Practice signed July 2025 by OpenAI, Anthropic, Google, Microsoft, Mistral, Amazon and IBM with Meta's signature accompanied by reservations); contested by an emergent defensive-tooling ecosystem of artist-protection adversarial perturbations (Glaze, U Chicago SAND Lab Ben Zhao/Heather Zheng February 2023 with 4M+ downloads protecting style from mimicry fine-tuning; Nightshade October 2023 actively poisoning class associations in models trained on protected images), opt-out registries (Spawning AI's Have I Been Trained searching LAION-5B with 80M+ opted-out images and the Do-Not-Train HTTP header X-Robots-Tag: noai/noimageai honoured by Stability AI SD3), the community-maintained **ai.robots.txt** project (Robb Knight, Cory Doctorow) used by 50K+ websites, and Spawning's **Kudurru** real-time scrape-detection network; and shaped within the UK by the February 2024 collapse of the IPO AI/IP Code of Practice working group, the December 2024-February 2025 DSIT/IPO Copyright-and-AI consultation (11,500 responses with majority opposition and the cross-publisher 'Make It Fair' campaign by The Times/Telegraph/Guardian/Mirror/Daily Mail), Tony Blair Institute advocacy papers (Jess Northend, Jeegar Kakkad) arguing for permissive text-and-data-mining regime to retain AI-sector competitiveness against the EU AI Act and US fair-use ambiguity, Royal Society reports 'Science in the Age of AI' (May 2024) and the Copyright report (September 2024) recommending bounded TDM exception with transparency obligations, and active legal-and-technical research at Imperial College London, UCL, University of Edinburgh, Cambridge Leverhulme CFI, Oxford Internet Institute, QMUL Centre for Commercial Law Studies and the Newcastle/Edinburgh/Manchester technology-law triangle.

- ### Semantic Classification
  - owl-class:: artificial-intelligence:AIScrapers
  - owl-role:: TrainingDataAcquisitionAgent
  - owl-inferred:: ai:WebCrawler, ai:DataPipelineComponent, ai:RegulatedDataProcessor, ai:AutomatedAgent
  - belongs-to-domain:: [[AI-GroundedDomain]], [[InformationRetrievalDomain]], [[DataGovernanceDomain]], [[CopyrightLawDomain]]
  - implemented-in-layer:: [[InfrastructureLayer]], [[ApplicationLayer]], [[DataAcquisitionLayer]], [[ComplianceLayer]]

- ### Relationships
  - is-subclass-of:: [[Web Crawler]], [[Automated Agent]], [[Data Acquisition Pipeline]], [[Regulated Data Processor]], [[Internet Bot]]
  - has-part:: [[User-Agent String]], [[IP Range Manifest]], [[Crawl Frontier]], [[Politeness Policy]], [[robots.txt Parser]], [[Content Extraction Pipeline]], [[Deduplication Filter]]
  - requires:: [[Network Connectivity]], [[HTTP Client]], [[Public Web Content]], [[Compute Infrastructure]], [[Storage Pipeline]], [[Identity Provenance]]
  - enables:: [[Foundation Model Pre-Training]], [[Retrieval-Augmented Generation]], [[Search Index Construction]], [[Knowledge Graph Extraction]], [[Synthetic Data Curation]], [[Fine-Tuning Dataset Assembly]]
  - implements:: [[Robots Exclusion Protocol]], [[HTTP Protocol]], [[Politeness Throttling]], [[De-Duplication Hashing]], [[Content Type Negotiation]]
  - depends-on:: [[Common Crawl]], [[Internet Infrastructure]], [[DNS]], [[Public Web Architecture]], [[CDN Layer]]
  - supports:: [[Large Language Model Training]], [[Multimodal Model Training]], [[Generative AI]], [[AI Search]], [[RAG Pipelines]]
  - uses:: [[Headless Browser]], [[Playwright]], [[Selenium]], [[HTTP Library]], [[Sitemaps XML]], [[Bloom Filter]]
  - contrasts-with:: [[Classic Search Crawler]], [[Web Archive Crawler]], [[Academic Crawler]], [[Personal Web Scraper]]
  - related-to:: [[Bot Management]], [[Copyright Law]], [[Data Protection]], [[Training Data]], [[Web Scraping]], [[Content Licensing]]
  - standardized-by:: [[IETF RFC 9309]], [[IETF AIPREF Working Group]], [[IAB Tech Lab]], [[EU AI Act Article 53]], [[GPAI Code of Practice]]
...
- ### Content
  ...
  - ### Copyright Litigation: The Defining Lawsuits
	  ...
	  Combined, these deals constitute a **$1.2B 2025 training-data licensing market projected to $5.4B by 2030** (LSEG estimates).
...
- ### Provenance
  - sources:: IETF RFC 9309 (Robots Exclusion Protocol, 2022); OpenAI GPTBot platform documentation; Anthropic ClaudeBot documentation; Cloudflare AI Audit and AI Labyrinth product blog posts (2024-2025); Imperva Bad Bot Report 2024; Dark Visitors AI crawler registry; ai.robots.txt GitHub project (Knight, Doctorow); Spawning AI Have I Been Trained; Glaze and Nightshade research papers (Shan, Zhao et al. 2023); NYT v OpenAI/Microsoft S.D.N.Y. 1:23-cv-11195 docket; Getty v Stability AI UK High Court CL-2023-000080 judgment November 2025; Authors Guild v OpenAI consolidated MDL; UMG v Suno/Udio June 2024; News Corp v Perplexity October 2024; Garante, CNIL, Hellenic DPA, Dutch DPA Clearview AI decisions; UK ICO generative AI consultation response May 2025; UK DSIT/IPO Copyright and AI consultation December 2024; EU AI Act Regulation 2024/1689; GPAI Code of Practice July 2025; Royal Society Science in the Age of AI (May 2024) and Copyright report (September 2024); Tony Blair Institute UK AI policy papers (Northend, Kakkad); Wired and Robb Knight investigations into PerplexityBot June 2024; Shumailov et al. Nature 2024 on model collapse; Common Crawl Foundation public dumps and governance documentation; Samuelson, Sag, Edwards, Guadamuz, Wachter scholarly works.
