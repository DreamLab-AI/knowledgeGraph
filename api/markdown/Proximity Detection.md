schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#ProximityDetection
legacy_uri:: urn:visionclaw:concept:infrastructure:proximity-detection
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-525292582c6d"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#ProximityDetection"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:proximity-detection"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:f8925b1fcfa6b1d1670dc0d1877ae5c8e05c151548e6ba5eedb5bfc4b8ad0560@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:proximity-detection",
  "@type": "OntologyClass",
