- ### OntologyBlock
  ...
  collapsed:: true
	- ontology:: true
	- term-id:: BC-0504
	- preferred-term:: BlockchainEnvironmentalImpactAssessment
	- alternative-terms:: Blockchain Carbon Footprint Analysis, Crypto Environmental Audit, DLT Sustainability Assessment, Blockchain Life Cycle Assessment (LCA)
	- source-domain:: bc
	...
	- source:: [[Cambridge Centre for Alternative Finance (CCAF)]], [[ISO 14040 Life Cycle Assessment]], [[International Energy Agency (IEA)]], [[Ethereum Foundation]], [[Bitcoin Mining Council]]
	- owl:class:: bc:BlockchainEnvironmentalImpactAssessment
	...
	- belongsToDomain:: [[BlockchainDomain]], [[EnvironmentalDomain]], [[SustainabilityReporting]]
	- has-part:: [[EnergyConsumptionMeasurement]], [[CarbonEmissionsCalculation]], [[EWasteAnalysis]], [[WaterUsageTracking]], [[ScopeDefinition]]
	- measures:: [[ElectricityUsage]], [[CarbonFootprint]], [[HardwareWaste]], [[WaterConsumption]], [[LandUse]]
	...
	- related-to:: [[ProofOfWork]], [[ProofOfStake]], [[GreenBlockchain]], [[CarbonOffset]], [[EnergyEfficiency]]
...
(Declaration (Class :BlockchainEnvironmentalImpactAssessment))

;; Annotations
(AnnotationAssertion rdfs:label :BlockchainEnvironmentalImpactAssessment "BlockchainEnvironmentalImpactAssessment"@en)
(AnnotationAssertion rdfs:comment :BlockchainEnvironmentalImpactAssessment "A systematic evaluation methodology for measuring, analyzing, and reporting the environmental consequences of blockchain network operations, encompassing energy consumption, carbon emissions, e-waste generation, water consumption, and broader ecological impacts, with standardized frameworks including Life Cycle Assessment and Cambridge Centre for Alternative Finance methodologies."@en)

;; Data Properties
(AnnotationAssertion dcterms:identifier :BlockchainEnvironmentalImpactAssessment "BC-0504"^^xsd:string)

;; SubClass relationships
(SubClassOf :BlockchainEnvironmentalImpactAssessment :EnvironmentalAssessment)
(SubClassOf :BlockchainEnvironmentalImpactAssessment :SustainabilityMetric)
(SubClassOf :BlockchainEnvironmentalImpactAssessment :BlockchainGovernanceFramework)
(SubClassOf :BlockchainEnvironmentalImpactAssessment :LifeCycleAssessment)

;; Object properties
(SubClassOf :BlockchainEnvironmentalImpactAssessment
  (ObjectSomeValuesFrom :hasPart :EnergyConsumptionMeasurement))
(SubClassOf :BlockchainEnvironmentalImpactAssessment
  (ObjectSomeValuesFrom :hasPart :CarbonEmissionsCalculation))
(SubClassOf :BlockchainEnvironmentalImpactAssessment
  (ObjectSomeValuesFrom :measures :ElectricityUsage))
(SubClassOf :BlockchainEnvironmentalImpactAssessment
  (ObjectSomeValuesFrom :requires :NetworkHashRate))
(SubClassOf :BlockchainEnvironmentalImpactAssessment
  (ObjectSomeValuesFrom :enables :SustainabilityReporting))
```

- ## About BlockchainEnvironmentalImpactAssessment
