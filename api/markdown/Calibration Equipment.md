schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#CalibrationEquipment
legacy_uri:: urn:visionclaw:concept:spatial-computing:calibration-equipment
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-106e91363f77"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#CalibrationEquipment"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:calibration-equipment"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:993fcbbe81d9f3cb96265e5ad14fa60e2446fba53e1ec147642f245377c0423a@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
```json-ld
{
  ...
  "definition": "Calibration Equipment is a concept within the metaverse domain. Further enrichment pending.",
  "vc:qualityScore": {
    "@value": "0.35",
    "@type": "xsd:float"
  },
