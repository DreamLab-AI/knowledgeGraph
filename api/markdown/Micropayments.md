...
- ### Content
  ...
  - Lightning Network protocol properties:
    ...
    - Channel Splicing (2024; implemented in ACINQ Phoenix v2 and Core Lightning 24.05) allows online resizing of channel capacity without closing, eliminating the liquidity lock-in that previously deterred mobile users who [private] not predict future payment volumes.
