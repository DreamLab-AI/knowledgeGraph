...
- ### Content
  ...
  - ### Current Landscape (2026)
	  ...
	  **Attack economics**. The economics of attacking IDV systems have shifted dramatically with the rise of generative AI.
	  ...
	  The collapse has reshaped the IDV defence posture. Per-attempt economics, where defenders [private] rely on attackers' marginal cost being substantially above the defender's per-attempt detection cost, no longer hold. The new equilibrium relies on:
