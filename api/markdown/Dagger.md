schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#Dagger
legacy_uri:: urn:visionclaw:concept:infrastructure:dagger
public:: true
...
```json-ld
{
  ...
  "@id": "urn:visionflow:page:4e242e874bd60394c100613afdc905c8b507270b28a8c606d0134ac4ebca06cb",
  "@type": "Page",
  "vc:slug": "dagger",
  "title": "Dagger",
  "vc:public": true,
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-b50af848926f"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#Dagger"
    },
    {
      "vc:key": "maturity",
      "vc:value": "draft"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:dagger"
    },
    {
      "vc:key": "status",
      "vc:value": "stub"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:4e242e874bd60394c100613afdc905c8b507270b28a8c606d0134ac4ebca06cb@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
```json-ld
{
  ...
  "definition": "Dagger is a concept within the ngm domain.",
  "vc:qualityScore": {
    "@value": "0.50",
    "@type": "xsd:float"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:dagger:776c802a9fc9",
...
- ### Definition
  - Dagger is a concept within the ngm domain.

- ### Semantic Classification
  - owl-class:: infrastructure:Dagger
  - owl-role:: Concept
