schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/robotics#Rb0031Singularity
legacy_uri:: urn:visionclaw:concept:robotics:rb-0031-singularity
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-44a36ada802d"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/robotics#Rb0031Singularity"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:robotics:rb-0031-singularity"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:8cbaabc0e141534f79adfb6eef6ded8f8b09fa497151fe24f9b41282175f1257@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:rb-0031-singularity",
  "@type": "OntologyClass",
  ...
  "definition": "singularity is a robotics and autonomous systems concept and a type of Robot."
}
```
