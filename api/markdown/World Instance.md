schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#WorldInstance
legacy_uri:: urn:visionclaw:concept:spatial-computing:world-instance
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-d7313aca4d13"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#WorldInstance"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:world-instance"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:c5a87065f14f82af889f69dc75b8a3b0046f51d20be634532d45691cec7cf9a4@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:world-instance",
  "@type": "OntologyClass",
