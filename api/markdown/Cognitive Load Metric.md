schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#CognitiveLoadMetric
legacy_uri:: urn:visionclaw:concept:spatial-computing:cognitive-load-metric
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-7cc639e2fb35"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#CognitiveLoadMetric"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:cognitive-load-metric"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
