schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/distributed-collaboration#Tele050Neuralrenderingtelepresence
legacy_uri:: urn:visionclaw:concept:distributed-collaboration:tele-050-neuralrenderingtelepresence
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-eaf8c9303cde"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/distributed-collaboration#Tele050Neuralrenderingtelepresence"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:distributed-collaboration:tele-050-neuralrenderingtelepresence"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
