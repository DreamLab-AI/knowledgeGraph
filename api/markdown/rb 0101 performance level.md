schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/robotics#Rb0101PerformanceLevel
legacy_uri:: urn:visionclaw:concept:robotics:rb-0101-performance-level
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-7b3dc1060e38"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/robotics#Rb0101PerformanceLevel"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:robotics:rb-0101-performance-level"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:1e7480b0292a741283bf7ce99f00bcf103828f70325cda623a7a63912732f169@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:rb-0101-performance-level",
  "@type": "OntologyClass",
