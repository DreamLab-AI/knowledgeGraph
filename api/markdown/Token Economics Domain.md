schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#TokenEconomicsDomain
legacy_uri:: urn:visionclaw:concept:blockchain:token-economics-domain
public:: true
...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "token-economics-domain",
  "title": "Token Economics Domain",
  "vc:public": true,
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:ai-driven-market-making",
      "vc:label": "AI-Driven Market Making"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:automated-market-maker-amm",
      "vc:label": "Automated Market Maker (AMM)"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:carbon-credit-trading",
      "vc:label": "Carbon Credit Trading"
    },
    {
      "@id": "urn:visionflow:linked:collateralized-debt-positions",
      "vc:label": "Collateralized Debt Positions"
    },
    {
      "@id": "urn:visionflow:linked:community-currencies",
      "vc:label": "Community Currencies"
    },
    {
      "@id": "urn:visionflow:linked:constant-product-market-makers",
      "vc:label": "Constant Product Market Makers"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:decentralized-physical-infrastructure-networks-de-pin",
      "vc:label": "Decentralized Physical Infrastructure Networks (DePIN)"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:e-mode",
      "vc:label": "E-Mode"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:energy-trading-tokens",
      "vc:label": "Energy Trading Tokens"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:erc-6551",
      "vc:label": "ERC-6551"
    },
    {
      "@id": "urn:visionflow:linked:erc-721-c",
      "vc:label": "ERC-721C"
    },
    {
      "@id": "urn:visionflow:linked:ethereum-l2-rollups",
      "vc:label": "Ethereum L2 Rollups"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:fractionalized-nfts",
      "vc:label": "Fractionalized NFTs"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:gho-stablecoin",
      "vc:label": "GHO Stablecoin"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:intent-based-architectures",
      "vc:label": "Intent-Based Architectures"
    },
    {
      "@id": "urn:visionflow:linked:isolation-mode",
      "vc:label": "Isolation Mode"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:liquidity-as-a-service-laa-s",
      "vc:label": "Liquidity-as-a-Service (LaaS)"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:local-economic-tokens",
      "vc:label": "Local Economic Tokens"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:markets-in-crypto-assets-regulation-mi-ca",
      "vc:label": "Markets in Crypto-Assets Regulation (MiCA)"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:metcalfe-s-law",
      "vc:label": "Metcalfe's Law"
    },
    {
      "@id": "urn:visionflow:linked:mev-maximal-extractable-value",
      "vc:label": "MEV (Maximal Extractable Value)"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:nft-royalties",
      "vc:label": "NFT Royalties"
    },
    {
      "@id": "urn:visionflow:linked:non-fungible-tokens-nfts",
      "vc:label": "Non-Fungible Tokens (NFTs)"
    },
    {
      "@id": "urn:visionflow:linked:on-chain-royalty-enforcement",
      "vc:label": "On-Chain Royalty Enforcement"
    },
    {
      "@id": "urn:visionflow:linked:real-world-asset-rwa-nfts",
      "vc:label": "Real-World Asset (RWA) NFTs"
    },
    {
      "@id": "urn:visionflow:linked:real-world-asset-rwa-tokenization",
      "vc:label": "Real-World Asset (RWA) Tokenization"
    },
    {
      "@id": "urn:visionflow:linked:regenerative-finance-re-fi",
      "vc:label": "Regenerative Finance (ReFi)"
    },
    {
      "@id": "urn:visionflow:linked:reserve-treasury",
      "vc:label": "Reserve Treasury"
    },
    {
      "@id": "urn:visionflow:linked:slippage",
      "vc:label": "Slippage"
    },
    {
      "@id": "urn:visionflow:linked:soulbound-tokens-sbts",
      "vc:label": "Soulbound Tokens (SBTs)"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:supply-chain-tokens",
      "vc:label": "Supply Chain Tokens"
    },
    {
      "@id": "urn:visionflow:linked:sustainability-tokens",
      "vc:label": "Sustainability Tokens"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:token-taxonomy-framework-ttf",
      "vc:label": "Token Taxonomy Framework (TTF)"
    },
    {
      "@id": "urn:visionflow:linked:tokenized-securities",
      "vc:label": "Tokenized Securities"
    },
    {
      "@id": "urn:visionflow:linked:uk-treasury",
      "vc:label": "UK Treasury"
    },
    {
    ...
    },
    {
      ...
      "vc:label": "Central Bank Digital Currency (CBDC)"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-1341a22ea9a0"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#TokenEconomicsDomain"
    },
    {
      "vc:key": "maturity",
      "vc:value": "draft"
    ...
    },
    {
      ...
      "vc:value": "Token Economics Domain"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:token-economics-domain"
    },
    {
      "vc:key": "status",
      "vc:value": "stub"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:token-economics-domain:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[AI-Driven Market Making]]",
      "resolved": "urn:visionflow:linked:ai-driven-market-making",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Automated Market Maker (AMM)]]",
      "resolved": "urn:visionflow:linked:automated-market-maker-amm",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Carbon Credit Trading]]",
      "resolved": "urn:visionflow:linked:carbon-credit-trading",
      "kind": "StubLink"
    },
    {
      "raw": "[[Collateralized Debt Positions]]",
      "resolved": "urn:visionflow:linked:collateralized-debt-positions",
      "kind": "StubLink"
    },
    {
      "raw": "[[Community Currencies]]",
      "resolved": "urn:visionflow:linked:community-currencies",
      "kind": "StubLink"
    },
    {
      "raw": "[[Constant Product Market Makers]]",
      "resolved": "urn:visionflow:linked:constant-product-market-makers",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Decentralized Physical Infrastructure Networks (DePIN)]]",
      "resolved": "urn:visionflow:linked:decentralized-physical-infrastructure-networks-de-pin",
      "kind": "StubLink"
    },
    {
      "raw": "[[Dynamic NFTs]]",
    ...
    {
      "raw": "[[E-Mode]]",
      "resolved": "urn:visionflow:linked:e-mode",
      "kind": "StubLink"
    },
    {
      "raw": "[[EIP-1559]]",
    ...
    {
      "raw": "[[Energy Trading Tokens]]",
      "resolved": "urn:visionflow:linked:energy-trading-tokens",
      "kind": "StubLink"
    },
    {
      "raw": "[[ERC-4626]]",
    ...
    {
      "raw": "[[ERC-6551]]",
      "resolved": "urn:visionflow:linked:erc-6551",
      "kind": "StubLink"
    },
    {
      "raw": "[[ERC-721C]]",
      "resolved": "urn:visionflow:linked:erc-721-c",
      "kind": "StubLink"
    },
    {
      "raw": "[[Ethereum L2 Rollups]]",
      "resolved": "urn:visionflow:linked:ethereum-l2-rollups",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Fractionalized NFTs]]",
      "resolved": "urn:visionflow:linked:fractionalized-nfts",
      "kind": "StubLink"
    },
    {
      "raw": "[[Game Theory]]",
    ...
    {
      "raw": "[[GHO Stablecoin]]",
      "resolved": "urn:visionflow:linked:gho-stablecoin",
      "kind": "StubLink"
    },
    {
      "raw": "[[HM Treasury]]",
    ...
    {
      "raw": "[[Intent-Based Architectures]]",
      "resolved": "urn:visionflow:linked:intent-based-architectures",
      "kind": "StubLink"
    },
    {
      "raw": "[[Isolation Mode]]",
      "resolved": "urn:visionflow:linked:isolation-mode",
      "kind": "StubLink"
    },
    {
      "raw": "[[KYC/AML]]",
    ...
    {
      "raw": "[[Liquidity-as-a-Service (LaaS)]]",
      "resolved": "urn:visionflow:linked:liquidity-as-a-service-laa-s",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Local Economic Tokens]]",
      "resolved": "urn:visionflow:linked:local-economic-tokens",
      "kind": "StubLink"
    },
    {
      "raw": "[[MakerDAO]]",
    ...
    {
      "raw": "[[Markets in Crypto-Assets Regulation (MiCA)]]",
      "resolved": "urn:visionflow:linked:markets-in-crypto-assets-regulation-mi-ca",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Metcalfe's Law]]",
      "resolved": "urn:visionflow:linked:metcalfe-s-law",
      "kind": "StubLink"
    },
    {
      "raw": "[[MEV (Maximal Extractable Value)]]",
      "resolved": "urn:visionflow:linked:mev-maximal-extractable-value",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[NFT Royalties]]",
      "resolved": "urn:visionflow:linked:nft-royalties",
      "kind": "StubLink"
    },
    {
      "raw": "[[Non-Fungible Tokens (NFTs)]]",
      "resolved": "urn:visionflow:linked:non-fungible-tokens-nfts",
      "kind": "StubLink"
    },
    {
      "raw": "[[On-Chain Royalty Enforcement]]",
      "resolved": "urn:visionflow:linked:on-chain-royalty-enforcement",
      "kind": "StubLink"
    },
    {
      "raw": "[[Real-World Asset (RWA) NFTs]]",
      "resolved": "urn:visionflow:linked:real-world-asset-rwa-nfts",
      "kind": "StubLink"
    },
    {
      "raw": "[[Real-World Asset (RWA) Tokenization]]",
      "resolved": "urn:visionflow:linked:real-world-asset-rwa-tokenization",
      "kind": "StubLink"
    },
    {
      "raw": "[[Regenerative Finance (ReFi)]]",
      "resolved": "urn:visionflow:linked:regenerative-finance-re-fi",
      "kind": "StubLink"
    },
    {
      "raw": "[[Reserve Treasury]]",
      "resolved": "urn:visionflow:linked:reserve-treasury",
      "kind": "StubLink"
    },
    {
      "raw": "[[Slippage]]",
      "resolved": "urn:visionflow:linked:slippage",
      "kind": "StubLink"
    },
    {
      "raw": "[[Soulbound Tokens (SBTs)]]",
      "resolved": "urn:visionflow:linked:soulbound-tokens-sbts",
      "kind": "StubLink"
    },
    {
      "raw": "[[Stablecoins]]",
    ...
    {
      "raw": "[[Supply Chain Tokens]]",
      "resolved": "urn:visionflow:linked:supply-chain-tokens",
      "kind": "StubLink"
    },
    {
      "raw": "[[Sustainability Tokens]]",
      "resolved": "urn:visionflow:linked:sustainability-tokens",
      "kind": "StubLink"
    },
    {
      "raw": "[[Token Standards]]",
    ...
    {
      "raw": "[[Token Taxonomy Framework (TTF)]]",
      "resolved": "urn:visionflow:linked:token-taxonomy-framework-ttf",
      "kind": "StubLink"
    },
    {
      "raw": "[[Tokenized Securities]]",
      "resolved": "urn:visionflow:linked:tokenized-securities",
      "kind": "StubLink"
    },
    {
      "raw": "[[UK Treasury]]",
      "resolved": "urn:visionflow:linked:uk-treasury",
      "kind": "StubLink"
    },
    {
      "raw": "[[Uniswap v4]]",
    ...
    {
      "raw": "[[Real Estate Tokenization]]",
      "resolved": "urn:visionflow:owl:class:real-estate-tokenization",
      "kind": "ResolvedLink"
    },
    {
      "raw": "[[Solana]]",
