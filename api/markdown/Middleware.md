schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#Middleware
legacy_uri:: urn:visionclaw:concept:spatial-computing:middleware
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-0cdf546a3886"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#Middleware"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:middleware"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
