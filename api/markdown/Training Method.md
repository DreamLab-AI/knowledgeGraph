schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#TrainingMethod
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:training-method
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-8b1ddcff541b"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#TrainingMethod"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:training-method"
    },
    {
      "vc:key": "status",
      "vc:value": "active"
