schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#Mermaid
legacy_uri:: urn:visionclaw:concept:infrastructure:mermaid
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-98cee7204861"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#Mermaid"
    },
    {
      "vc:key": "maturity",
      "vc:value": "draft"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:mermaid"
    },
    {
      "vc:key": "status",
      "vc:value": "stub"
...
```json-ld
{
  ...
  "definition": "mermaid is a concept within the ngm domain.",
  "vc:qualityScore": {
    "@value": "0.35",
    "@type": "xsd:float"
  },
