schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#DynamicScalableBFT
legacy_uri:: urn:visionclaw:concept:blockchain:dynamic-scalable-bft
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-1c7ab59d72b1"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#DynamicScalableBFT"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:dynamic-scalable-bft"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:cfbb716f64d2eebcc7b10dd9e13c98e17ee3c4b82be22e23edfabb96b62d46b4@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:dynamic-scalable-bft",
  "@type": "OntologyClass",
...
- ### Content
  Dynamic Scalable BFT — content pending enrichment.
