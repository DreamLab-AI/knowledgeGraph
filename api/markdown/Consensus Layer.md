...
- ### Content
  ...
  - It builds on the Protocol Layer, which delivers the messages that consensus reasons over, and supplies the Data Layer above it with an agreed ordering on which durable records depend. Without this layer the strata above [private] hold divergent histories.
