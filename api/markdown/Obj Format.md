```json-ld
{
  ...
  "@id": "urn:visionflow:page:obj-format",
  "@type": "Page",
  "title": "Obj Format",
  "vc:slug": "obj-format",
  "vc:public": true,
...
- ### Overview
- Originating with the Wavefront Technologies animation package, OBJ became a de facto standard precisely because it is plain text and trivially parseable. Each line declares one element — a vertex, a texture coordinate, a normal or a face referencing those by [private].
