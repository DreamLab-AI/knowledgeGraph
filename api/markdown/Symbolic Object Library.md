schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#SymbolicObjectLibrary
legacy_uri:: urn:visionclaw:concept:spatial-computing:symbolic-object-library
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-58ae1946076c"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#SymbolicObjectLibrary"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:symbolic-object-library"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:264542fff6f99151a6d4adaf1ac9fafdd17ad9b5fc496db6fc6451e4b54340a4@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
