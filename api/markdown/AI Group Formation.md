...
- ### Definition
  - AI Group Formation is the computational discipline concerned with the automated, criteria-driven assignment of human participants into cohesive subgroups, deploying techniques from [[Clustering]], [[Combinatorial Optimisation]], [[Genetic Algorithm]], [[Reinforcement Learning]], and [[Recommender System]] research to produce group compositions that optimise for one or more objectives — including skill complementarity, knowledge-level heterogeneity, social diversity, prior-interaction diversity, topic affinity, language homogeneity, or explicit learning goals — surpassing the quality achievable through [[Manual Room Assignment]] or random [[Automatic Grouping]] at scale. Each participant is encoded as a feature vector drawn from rich [[Participant Profiling]] data (demographic attributes, declared expertise tags, assessed competency scores, personality inventories, prior meeting interaction histories, survey responses, or embedding representations of past textual contributions), and a solver or learned model assigns participants to groups so as to satisfy hard constraints (minimum and maximum group sizes, co-location requirements, exclusion pairs) while maximising a soft objective function over group composition quality. The technique is foundational to [[Breakout Room]] orchestration in [[Videoconferencing Platform]] products, to collaborative cohort management in [[Learning Management System]] deployments, and to team assembly in enterprise [[Distributed Team Collaboration]] and [[Corporate Training]] contexts. As a sub-discipline of [[Artificial Intelligence]] applied to human coordination, AI Group Formation draws on decades of [[Collaborative Learning]] pedagogy — particularly [[Cooperative Learning]], [[Peer Learning]], [[Active Learning]], and [[Problem-Based Learning]] — while contributing algorithmic rigour to what was previously an art-form dependent on facilitator intuition and manual effort. The field sits at the intersection of [[Machine Learning]], [[Social Network Analysis]], educational data mining, and [[Human-Computer Interaction]], generating group compositions whose quality can be measured against empirical outcomes including learning gains, participation equity indices, task completion rates, and self-reported group cohesion — enabling closed-loop improvement through [[Learning Analytics]] and [[Adaptive Learning]] feedback cycles.

- ### Semantic Classification
  - owl-class:: ai:AIGroupFormation
  - owl-role:: ExecutableProtocol | OptimisationAlgorithm | CollaborationEnablement
  - owl-inferred:: ai:GroupAssignmentSystem, ai:ConstrainedClustering, ai:CollaborativeOptimisation, ai:ParticipantOrchestration
  - belongs-to-domain:: [[Educational Technology]], [[Artificial Intelligence]]
  - implemented-in-layer:: [[Machine Learning]], [[Learning Analytics]]

- ### Relationships
  - is-subclass-of:: [[AI Application]], [[Combinatorial Optimisation]], [[Unsupervised Learning]]
  - has-part:: [[Participant Profiling]], [[Constraint Satisfaction]], [[Diversity Optimisation]], [[Skill Matching]], [[Distance Metric]]
  - requires:: [[Feature Engineering]], [[Data Pipeline]], [[Learning Analytics]]
  - enables:: [[Collaborative Learning]], [[Participation Equity]], [[Breakout Room]], [[Personalised Learning]], [[Scaled Workshop Facilitation]]
  - uses:: [[Clustering]], [[K-Means Clustering]], [[Genetic Algorithm]], [[Reinforcement Learning]], [[Embedding]], [[Natural Language Processing]], [[Recommender System]], [[Graph Analytics]]
  - supports:: [[Educational Technology]], [[Corporate Training]], [[Remote Education]], [[Conference Facilitation]], [[Virtual Workshop]], [[Active Learning]], [[Peer Learning]], [[Problem-Based Learning]]
  - depends-on:: [[Learning Analytics]], [[Learning Management System]], [[Participant Profiling]]
  - contrasts-with:: [[Manual Room Assignment]], [[Automatic Grouping]]
  - related-to:: [[Social Network Analysis]], [[Multi-Objective Optimisation]], [[Community Detection]], [[Adaptive Learning]], [[Meeting AI Assistant]], [[Team Communication Platform]], [[Human-Computer Interaction]], [[Collaborative Whiteboard]], [[Group Facilitation Tools]]

- ### Content
  ## Compositional Relationships (Components)
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:hasPart ai:ParticipantProfiling))
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:hasPart ai:ConstraintSatisfactionModule))
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:hasPart ai:DiversityOptimiser))
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:hasPart ai:SkillMatchingEngine))
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:hasPart ai:ObjectiveFunctionEvaluator))
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:hasPart ai:GroupAssignmentInterface))
  ...
  ## Dependency Relationships
      ...
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:dependsOn ai:LearningAnalytics))
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:dependsOn ai:LearningManagementSystem))

  ## Capability Relationships
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:enables ai:CollaborativeLearning))
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:enables ai:ParticipationEquity))
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:enables ai:BreakoutRoom))
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:enables ai:PersonalisedLearning))
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:supports ai:EducationalTechnology))
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:supports ai:CorporateTraining))
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:supports ai:ConferenceFacilitation))

  ## Implementation Relationships
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:uses ai:Clustering))
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:uses ai:GeneticAlgorithm))
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:uses ai:ReinforcementLearning))
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:uses ai:Embedding))
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:uses ai:NaturalLanguageProcessing))
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:uses ai:RecommenderSystem))
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:uses ai:GraphAnalytics))
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:implements ai:CooperativeLearning))
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:implements ai:ActiveLearning))

  ## Reduction Relationships
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:reducesTo ai:ConstrainedPartitionProblem))
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:reducesTo ai:MultiObjectiveAssignmentProblem))
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:reduces ai:ParticipationInequity))
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:reduces ai:FacilitatorCognitiveLoad))
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:reduces ai:GroupCompositionBias))
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:relatedTo ai:SocialNetworkAnalysis))
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:relatedTo ai:MultiObjectiveOptimisation))
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:relatedTo ai:CommunityDetection))
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:contrastsWith ai:ManualRoomAssignment))
      SubClassOf(ai:AIGroupFormation
        ObjectSomeValuesFrom(ai:contrastsWith ai:RandomGroupAssignment))
...
- ### Provenance
  - sources:: Springer CSCL group formation literature; ACM CHI/CSCW proceedings 2022–2023; Zoom Smart Groups product documentation Q3 2024; Microsoft Copilot Teams 2025 technical blog; arXiv:2304.04022 (RL-GP team formation); arXiv:2506.05265 (AI teaming survey); ScienceDirect systematic review 2025; Open University learning analytics reports; Pozos-Parra et al. Springer 2024; Johnson & Johnson cooperative learning meta-analysis 2014; Kaur & Sawhney CSCW 2023
