schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#Sampling
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:sampling
public:: true
...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:bayesian-neural-networks",
      "vc:label": "Bayesian Neural Networks"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:generation-layer",
      "vc:label": "GenerationLayer"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:simulation-based-inference",
      "vc:label": "Simulation-Based Inference"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:statistical-computing-domain",
      "vc:label": "StatisticalComputingDomain"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-a4f9b3e72c01"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#Sampling"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:sampling"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:sampling:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[Autoregressive Sampling]]",
      "resolved": "urn:visionflow:linked:autoregressive-sampling",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Bayesian Neural Networks]]",
      "resolved": "urn:visionflow:linked:bayesian-neural-networks",
      "kind": "StubLink"
    },
    {
      "raw": "[[Convergence Criterion]]",
      "resolved": "urn:visionflow:linked:convergence-criterion",
      "kind": "StubLink"
    },
    {
      "raw": "[[DDIM]]",
      "resolved": "urn:visionflow:linked:ddim",
      "kind": "StubLink"
    },
    {
      "raw": "[[Deterministic Integration]]",
      "resolved": "urn:visionflow:linked:deterministic-integration",
      "kind": "StubLink"
    },
    {
      "raw": "[[DPM-Solver]]",
      "resolved": "urn:visionflow:linked:dpm-solver",
      "kind": "StubLink"
    },
    {
      "raw": "[[Entropy]]",
    ...
    {
      "raw": "[[Ergodic Theory]]",
      "resolved": "urn:visionflow:linked:ergodic-theory",
      "kind": "StubLink"
    },
    {
      "raw": "[[GenerationLayer]]",
      "resolved": "urn:visionflow:linked:generation-layer",
      "kind": "StubLink"
    },
    {
      "raw": "[[Gibbs Sampling]]",
      "resolved": "urn:visionflow:linked:gibbs-sampling",
      "kind": "StubLink"
    },
    {
      "raw": "[[Gradient Information]]",
      "resolved": "urn:visionflow:linked:gradient-information",
      "kind": "StubLink"
    },
    {
      "raw": "[[Grid Approximation]]",
      "resolved": "urn:visionflow:linked:grid-approximation",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Laplace Approximation]]",
      "resolved": "urn:visionflow:linked:laplace-approximation",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Metropolis-Hastings Algorithm]]",
      "resolved": "urn:visionflow:linked:metropolis-hastings-algorithm",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Nested Sampling]]",
      "resolved": "urn:visionflow:linked:nested-sampling",
      "kind": "StubLink"
    },
    {
      "raw": "[[Noise Schedule]]",
    ...
    {
      "raw": "[[Nucleus Sampling]]",
      "resolved": "urn:visionflow:linked:nucleus-sampling",
      "kind": "StubLink"
    },
    {
      "raw": "[[NumPyro]]",
      "resolved": "urn:visionflow:linked:num-pyro",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[NUTS]]",
      "resolved": "urn:visionflow:linked:nuts",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[PyMC]]",
      "resolved": "urn:visionflow:linked:py-mc",
      "kind": "StubLink"
    },
    {
      "raw": "[[Quasi-Monte Carlo]]",
      "resolved": "urn:visionflow:linked:quasi-monte-carlo",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Robert-Casella Monte Carlo Statistical Methods]]",
      "resolved": "urn:visionflow:linked:robert-casella-monte-carlo-statistical-methods",
      "kind": "StubLink"
    },
    {
      "raw": "[[Score Function]]",
      "resolved": "urn:visionflow:linked:score-function",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Simulation-Based Inference]]",
      "resolved": "urn:visionflow:linked:simulation-based-inference",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Stan Probabilistic Programming]]",
      "resolved": "urn:visionflow:linked:stan-probabilistic-programming",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[StatisticalComputingDomain]]",
      "resolved": "urn:visionflow:linked:statistical-computing-domain",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Target Density]]",
      "resolved": "urn:visionflow:linked:target-density",
      "kind": "StubLink"
    },
    {
...
- ### Definition
  - Sampling is the family of computational and statistical procedures that draw representative or informative values from probability distributions — ranging from classical Markov chain Monte Carlo methods (Metropolis-Hastings, Gibbs, Hamiltonian Monte Carlo, NUTS) and sequential methods (Sequential Monte Carlo, particle filters) through information-geometric approaches (importance sampling, rejection sampling, nested sampling, quasi-Monte Carlo via Sobol sequences, Latin Hypercube sampling) to the domain-specific decoding strategies used in autoregressive language models (temperature scaling, top-k truncation, nucleus/top-p filtering, min-p dynamic thresholding, mirostat adaptive entropy control, eta sampling) and diffusion model schedulers (DDIM deterministic inversion, DPM-Solver fast ODE integrators, Euler/Euler-a, Heun second-order corrector, Karras EDM Restart sampler).
  - In machine learning contexts sampling governs how probability mass is converted into discrete outputs during inference, how posterior distributions are explored during Bayesian model fitting, how training data subsets are selected, and how generative model trajectories are numerically integrated.
  - The mathematical unification across all these regimes is the task of approximating intractable expectations E_{p(x)}[f(x)] ≈ (1/N) Σᵢ f(xᵢ) via strategically chosen sample points xᵢ drawn from or reweighted toward the target distribution p(x), subject to constraints of computational budget, variance minimisation, and the curse of dimensionality.
  - Three distinct regimes of sampling have each developed rich sub-literatures: **classical statistical sampling** (MCMC, importance sampling, rejection sampling, nested sampling) for Bayesian posterior computation and marginal likelihood estimation; **space-filling and quasi-random sampling** (Sobol sequences, Latin Hypercube) for numerical integration and design of experiments; and **model-native sampling** (autoregressive decoding strategies, diffusion schedulers) for how trained neural models convert learned probability representations into discrete or continuous output at inference time.

- ### Semantic Classification
  - owl-class:: artificial-intelligence:Sampling
  - owl-role:: InferenceMethod
  - owl-inferred:: ai:BayesianInference, ai:StochasticOptimisation, ai:GenerativeModelling, ai:NumericalMethods
  - belongs-to-domain:: [[AI-GroundedDomain]], [[StatisticalComputingDomain]], [[ProbabilisticModellingDomain]]
  - implemented-in-layer:: [[AlgorithmLayer]], [[InferenceLayer]], [[GenerationLayer]]
...
- ### Content
  ...
  - | Family | Representative Algorithm | Primary Domain | Key Scaling Property |
    |--------|-------------------------|----------------|----------------------|
    | MCMC | NUTS (Stan/PyMC) | Bayesian inference | O(d^{1/4}) mixing |
    | IS/SMC | Sequential MC² | State filtering | Unbiased log Z |
    | Nested | PolyChord | Cosmology/physics | Evidence estimation |
    | QMC | Sobol + RQMC | Numerical integration | O((log N)^d/N) error |
    | LLM decoding | Nucleus + min-p | Text generation | Token-adaptive thresholding |
    | Speculative | EAGLE-2 | LLM throughput | 2-4× speedup exact |
    | Diffusion ODE | DPM-Solver++(2M) | Image synthesis | 10-20 NFE |
    | Diffusion determ. | DDIM η=0 | Image editing/inversion | Invertible |
  ...
  - | Strategy | Vocabulary truncation | Adaptive to model confidence | Distribution-preserving | Main use case |
    |----------|----------------------|------------------------------|------------------------|---------------|
    | Greedy | Argmax (k=1) | N/A | No (deterministic) | Factual Q&A |
    | Beam search | Top-k beam | No | No (MAP approx) | Translation, summarisation |
    | Top-k | Fixed k | No | Yes (within truncation) | General generation |
    | Top-p (nucleus) | Dynamic p-nucleus | Partially | Yes | Most creative tasks |
    | Min-p | Dynamic min-p floor | Yes | Yes | Creative, instruction |
    | Temperature | None (redistributes) | No | Yes (at T=1) | Combined with above |
    | Mirostat | Dynamic k via feedback | Yes | Approx | Long-form generation |
    | Eta | Entropy-relative floor | Yes | Yes | Robust generation |
    | Speculative | None (exact) | N/A | Yes (exact match) | Throughput at scale |
