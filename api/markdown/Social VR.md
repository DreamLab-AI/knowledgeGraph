schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#SocialVr
legacy_uri:: urn:visionclaw:concept:spatial-computing:social-vr
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-9b24ccd95b52"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#SocialVr"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:social-vr"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
