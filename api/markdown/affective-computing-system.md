- ### Definition
  - An [[Affective Computing System]] is a concrete computational architecture that instantiates [[Affective Computing]] principles by integrating multi-layer [[Sensor Fusion]], real-time signal processing, and [[Machine Learning]] classification to detect, model, and respond to human emotional states as they unfold during interaction. The system operates across an input layer of physiological and behavioural modalities — including [[Facial Recognition]] for [[Facial Action Coding System]] unit detection, speech prosody extraction via [[Speech Recognition]], galvanic skin response and heart rate variability acquisition through [[Physiological Signal Processing]], [[EEG]] brainwave signals via headset sensors, and textual affect inference via [[Natural Language Processing]] and [[Sentiment Analysis]] — fusing these heterogeneous signals through [[Multimodal Fusion]] architectures to infer an affective state representation in either discrete categorical space (Ekman's six basic emotions: happiness, sadness, anger, fear, disgust, surprise) or in dimensional affect space, typically the two-dimensional valence–arousal plane or the three-dimensional valence–arousal–dominance cube. The output of the classification layer drives an affective response module that adapts interaction parameters: in an educational context this means adjusting task difficulty, scaffolding density, and pacing through [[Intelligent Tutoring]] system logic; in a vehicular context it means alerting drowsiness-detection safety systems via [[Autonomous Vehicle]] frameworks; in an agent-communication context it means modulating synthetic voice prosody and dialogue strategy through [[Empathetic AI]] mechanisms; and in a user interface context it means reshaping layout and content exposure density via [[Adaptive Interfaces]]. The sensing layer is increasingly implemented in [[Wearable Computing]] form factors — smartwatches, EEG headbands, and in-ear sensors — enabling ambient, continuous affect monitoring without the ecological validity constraints of laboratory camera setups. Contemporary architectures rely on [[Transformer Architecture]] cross-attention models for [[Multimodal AI]] late or hybrid fusion of text, audio, video, and physiological channels, achieving state-of-the-art performance on the DEAP benchmark (91.57% accuracy with Vision Transformers versus 83.52% with MLPs) and IEMOCAP speech emotion recognition benchmarks. The design and deployment of these systems requires [[Annotated Dataset]] corpora such as DEAP, RAVDESS, AffectNet, RAF-DB, and FER-2013 curated through expensive [[Data Labelling]] processes, and places significant demands on [[Explainable AI]] interpretability given the high-stakes contexts of deployment. From February 2025, EU AI Act Article 5(1)(f) prohibits Affective Computing Systems deployed to infer worker or learner emotions in workplace and educational settings (outside medical and safety exceptions), imposing fines up to EUR 35 million or 7% of global annual turnover for violations, making [[AI Regulation]] compliance a first-order architectural concern.

- ### Semantic Classification
  - owl-class:: ai:AffectiveComputingSystem
  - owl-role:: Concept | EmotionAISystem | HCIArchitecture | MultimodalSensingSystem
  - owl-inferred:: ai:EmotionRecognitionSystem, ai:AdaptiveHCISystem, ai:PhysiologicalSignalProcessor, ai:BehaviouralModellingSystem
  - belongs-to-domain:: [[Affective Computing]]
  - implemented-in-layer:: [[Human-Computer Interaction]]

- ### Relationships
  - is-subclass-of:: [[Affective Computing]], [[Human-Computer Interaction]], [[Cognitive AI]]
  - has-part:: [[Emotion Recognition]], [[Sensor Fusion]], [[Multimodal Fusion]], [[Cognitive Feedback Interface]], [[Emotional Analytics Engine]]
  - uses:: [[Natural Language Processing]], [[Facial Recognition]], [[Behavioral Modeling]], [[Computer Vision]], [[Deep Learning]], [[Speech Recognition]], [[Physiological Signal Processing]], [[Convolutional Neural Network]], [[Transformer Architecture]], [[Recurrent Neural Network]], [[Wearable Computing]], [[EEG]], [[Sentiment Analysis]]
  - enables:: [[Adaptive Interfaces]], [[Adaptive Learning]], [[Emotion Aware Interaction]], [[Emotional Analytics Engine]], [[Mental Health Monitoring]], [[Empathetic AI]], [[Intelligent Tutoring]]
  - requires:: [[Annotated Dataset]], [[Data Labelling]], [[Machine Learning]], [[Sensor Fusion]]
  - depends-on:: [[Machine Learning]], [[Data Labelling]], [[Physiological Signal Processing]]
  - supports:: [[Digital Health]], [[User Experience Design]], [[Social Robotics]], [[Autonomous Vehicle]]
  - contrasts-with:: [[Rational Agent]], [[Symbolic AI]]
  - bridges-to:: [[Extended Reality]], [[Digital Health]], [[Autonomous Vehicle]], [[Social Robotics]]
  - related-to:: [[Cognitive Science]], [[Emotional Intelligence]], [[AI Regulation]], [[Explainable AI]], [[Cognitive Load]], [[Federated Learning]], [[Transfer Learning]], [[Privacy by Design]], [[Edge Computing]]
...
- ### Content
  ...
  ## Comparative Technology Landscape
    ...
    ### Related Ontology Concepts Crosswalk
...
- ### Provenance
  - sources:: https://www.ucl.ac.uk/uclic/research/affective-computing, https://www.research.ed.ac.uk/en/publications/working-with-affective-computing-exploring-uk-public-perceptions-/, https://arxiv.org/html/2504.19423v2, https://arxiv.org/html/2507.15470v2, https://www.technologyslegaledge.com/2025/04/eu-ai-act-spotlight-on-emotional-recognition-systems-in-the-workplace/, https://nquiringminds.com/ai-legal-news/eu-ai-act-imposes-strict-regulations-on-emotion-recognition-ai/, https://www.sciencedirect.com/science/article/pii/S2667305326000177, https://pmc.ncbi.nlm.nih.gov/articles/PMC12292624/, https://public-pages-files-2025.frontiersin.org/journals/digital-health/articles/10.3389/fdgth.2025.1657031/pdf, https://arxiv.org/pdf/2510.00725
