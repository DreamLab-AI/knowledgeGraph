...
- ### Content
  ...
  - ### Bank of England and UK Financial Infrastructure
	  ...
	  **[[Bank of England]] Project Rosalind** (2022-2024): API-layer experiment in collaboration with BIS Innovation Hub London Centre exploring how a public-private CBDC payments architecture [private] work — a "platform model" where the BoE provides a core CBDC ledger with private sector firms building consumer-facing services. The technical layer used a Quorum/Besu permissioned EVM implementation. Phase 1 published June 2023 with 33 use cases from retail payments to micropayments demonstrated.
