...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:baird-2016-hashgraph-consensus",
      "vc:label": "Baird 2016 Hashgraph Consensus"
    },
    {
      "@id": "urn:visionflow:linked:bank-for-international-settlements",
      "vc:label": "Bank for International Settlements"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:bis-2023-annual-economic-report-unified-ledger",
      "vc:label": "BIS 2023 Annual Economic Report Unified Ledger"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:bo-e-bis-2023-project-rosalind-phase-1",
      "vc:label": "BoE BIS 2023 Project Rosalind Phase 1"
    },
    {
      "@id": "urn:visionflow:linked:bo-e-hmt-2023-digital-pound-consultation",
      "vc:label": "BoE HMT 2023 Digital Pound Consultation"
    },
    {
      "@id": "urn:visionflow:linked:brewer-2000-cap-theorem",
      "vc:label": "Brewer 2000 CAP Theorem"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:city-of-london-corporation",
      "vc:label": "City of London Corporation"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:cls-bank-international",
      "vc:label": "CLS Bank International"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:data-layer-domain",
      "vc:label": "DataLayerDomain"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:euroclear-uk-and-ireland",
      "vc:label": "Euroclear UK & Ireland"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:financial-market-infrastructure-sandbox",
      "vc:label": "Financial Market Infrastructure Sandbox"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:gilad-hemo-micali-2017-algorand",
      "vc:label": "Gilad Hemo Micali 2017 Algorand"
    },
    {
      "@id": "urn:visionflow:linked:gilbert-lynch-2002-cap-theorem-proof",
      "vc:label": "Gilbert Lynch 2002 CAP Theorem Proof"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:holochain",
      "vc:label": "Holochain"
    },
    {
      "@id": "urn:visionflow:linked:hsbc-fx-everywhere",
      "vc:label": "HSBC FX Everywhere"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:ice-bakkt",
      "vc:label": "ICE Bakkt"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:innovate-finance",
      "vc:label": "Innovate Finance"
    },
    {
      "@id": "urn:visionflow:linked:iota",
      "vc:label": "IOTA"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:isda-regnosys-2024-common-domain-model",
      "vc:label": "ISDA REGnosys 2024 Common Domain Model"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:iso-22739-2024-blockchain-dlt-vocabulary",
      "vc:label": "ISO 22739 2024 Blockchain DLT Vocabulary"
    },
    {
      "@id": "urn:visionflow:linked:iso-23257-2022-dlt-reference-architecture",
      "vc:label": "ISO 23257 2022 DLT Reference Architecture"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:kiayias-2017-ouroboros",
      "vc:label": "Kiayias 2017 Ouroboros"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:london-school-of-economics",
      "vc:label": "London School of Economics"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:mastercard-mtn",
      "vc:label": "Mastercard MTN"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:miller-xia-croman-2016-honey-badger-bft",
      "vc:label": "Miller Xia Croman 2016 HoneyBadgerBFT"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:pay-uk",
      "vc:label": "Pay.UK"
    },
    {
      "@id": "urn:visionflow:linked:popov-2018-iota-tangle-whitepaper",
      "vc:label": "Popov 2018 IOTA Tangle Whitepaper"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:sompolinsky-zohar-2015-ghost",
      "vc:label": "Sompolinsky Zohar 2015 GHOST"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:ucl-cbt-2024-dlt-industry-adoption-review",
      "vc:label": "UCL CBT 2024 DLT Industry Adoption Review"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:university-of-warwick",
      "vc:label": "University of Warwick"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:wef-2023-pathways-regulation-crypto-assets",
      "vc:label": "WEF 2023 Pathways Regulation Crypto Assets"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:yin-malkhi-reiter-2019-hot-stuff",
      "vc:label": "Yin Malkhi Reiter 2019 HotStuff"
    },
    {
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:distributed-ledger:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[Append-Only Log]]",
      "resolved": "urn:visionflow:linked:append-only-log",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Baird 2016 Hashgraph Consensus]]",
      "resolved": "urn:visionflow:linked:baird-2016-hashgraph-consensus",
      "kind": "StubLink"
    },
    {
      "raw": "[[Bank for International Settlements]]",
      "resolved": "urn:visionflow:linked:bank-for-international-settlements",
      "kind": "StubLink"
    },
    {
      "raw": "[[Bank of England]]",
    ...
    {
      "raw": "[[BIS 2023 Annual Economic Report Unified Ledger]]",
      "resolved": "urn:visionflow:linked:bis-2023-annual-economic-report-unified-ledger",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[BoE BIS 2023 Project Rosalind Phase 1]]",
      "resolved": "urn:visionflow:linked:bo-e-bis-2023-project-rosalind-phase-1",
      "kind": "StubLink"
    },
    {
      "raw": "[[BoE HMT 2023 Digital Pound Consultation]]",
      "resolved": "urn:visionflow:linked:bo-e-hmt-2023-digital-pound-consultation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Brewer 2000 CAP Theorem]]",
      "resolved": "urn:visionflow:linked:brewer-2000-cap-theorem",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Centralised Ledger]]",
      "resolved": "urn:visionflow:linked:centralised-ledger",
      "kind": "StubLink"
    },
    {
      "raw": "[[Channel Isolation Pattern]]",
      "resolved": "urn:visionflow:linked:channel-isolation-pattern",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[City of London Corporation]]",
      "resolved": "urn:visionflow:linked:city-of-london-corporation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Cloud Database]]",
      "resolved": "urn:visionflow:linked:cloud-database",
      "kind": "StubLink"
    },
    {
      "raw": "[[CLS Bank International]]",
      "resolved": "urn:visionflow:linked:cls-bank-international",
      "kind": "StubLink"
    },
    {
      "raw": "[[ConsensusLayer]]",
    ...
    {
      "raw": "[[DataLayerDomain]]",
      "resolved": "urn:visionflow:linked:data-layer-domain",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[EU DLT Pilot Regime]]",
      "resolved": "urn:visionflow:linked:eu-dlt-pilot-regime",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Euroclear UK & Ireland]]",
      "resolved": "urn:visionflow:linked:euroclear-uk-and-ireland",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Federated Database]]",
      "resolved": "urn:visionflow:linked:federated-database",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Financial Market Infrastructure Sandbox]]",
      "resolved": "urn:visionflow:linked:financial-market-infrastructure-sandbox",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Gilad Hemo Micali 2017 Algorand]]",
      "resolved": "urn:visionflow:linked:gilad-hemo-micali-2017-algorand",
      "kind": "StubLink"
    },
    {
      "raw": "[[Gilbert Lynch 2002 CAP Theorem Proof]]",
      "resolved": "urn:visionflow:linked:gilbert-lynch-2002-cap-theorem-proof",
      "kind": "StubLink"
    },
    {
      "raw": "[[Hash Pointers]]",
      "resolved": "urn:visionflow:linked:hash-pointers",
      "kind": "StubLink"
    },
    {
      "raw": "[[Hashgraph]]",
      "resolved": "urn:visionflow:linked:hashgraph",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Holochain]]",
      "resolved": "urn:visionflow:linked:holochain",
      "kind": "StubLink"
    },
    {
      "raw": "[[HSBC FX Everywhere]]",
      "resolved": "urn:visionflow:linked:hsbc-fx-everywhere",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[ICE Bakkt]]",
      "resolved": "urn:visionflow:linked:ice-bakkt",
      "kind": "StubLink"
    },
    {
      "raw": "[[IEEE P2418]]",
      "resolved": "urn:visionflow:linked:ieee-p2418",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Innovate Finance]]",
      "resolved": "urn:visionflow:linked:innovate-finance",
      "kind": "StubLink"
    },
    {
      "raw": "[[IOTA]]",
      "resolved": "urn:visionflow:linked:iota",
      "kind": "StubLink"
    },
    {
      "raw": "[[ISDA]]",
    ...
    {
      "raw": "[[ISDA REGnosys 2024 Common Domain Model]]",
      "resolved": "urn:visionflow:linked:isda-regnosys-2024-common-domain-model",
      "kind": "StubLink"
    },
    {
      "raw": "[[ISO 22739]]",
    ...
    {
      "raw": "[[ISO 22739 2024 Blockchain DLT Vocabulary]]",
      "resolved": "urn:visionflow:linked:iso-22739-2024-blockchain-dlt-vocabulary",
      "kind": "StubLink"
    },
    {
      "raw": "[[ISO 23257 2022 DLT Reference Architecture]]",
      "resolved": "urn:visionflow:linked:iso-23257-2022-dlt-reference-architecture",
      "kind": "StubLink"
    },
    {
      "raw": "[[ISO TC 307]]",
    ...
    {
      "raw": "[[ISO TR 23244]]",
      "resolved": "urn:visionflow:linked:iso-tr-23244",
      "kind": "StubLink"
    },
    {
      "raw": "[[ISO TS 23258]]",
      "resolved": "urn:visionflow:linked:iso-ts-23258",
      "kind": "StubLink"
    },
    {
      "raw": "[[JPMorgan Onyx]]",
    ...
    {
      "raw": "[[Kiayias 2017 Ouroboros]]",
      "resolved": "urn:visionflow:linked:kiayias-2017-ouroboros",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[London School of Economics]]",
      "resolved": "urn:visionflow:linked:london-school-of-economics",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Mastercard MTN]]",
      "resolved": "urn:visionflow:linked:mastercard-mtn",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Miller Xia Croman 2016 HoneyBadgerBFT]]",
      "resolved": "urn:visionflow:linked:miller-xia-croman-2016-honey-badger-bft",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Multi-Party Database]]",
      "resolved": "urn:visionflow:linked:multi-party-database",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Node Operators]]",
      "resolved": "urn:visionflow:linked:node-operators",
      "kind": "StubLink"
    },
    {
      "raw": "[[Node Software]]",
      "resolved": "urn:visionflow:linked:node-software",
      "kind": "StubLink"
    },
    {
      "raw": "[[Notary Service]]",
    ...
    {
      "raw": "[[Notary Validation Pattern]]",
      "resolved": "urn:visionflow:linked:notary-validation-pattern",
      "kind": "StubLink"
    },
    {
      "raw": "[[OECD]]",
    ...
    {
      "raw": "[[Pay.UK]]",
      "resolved": "urn:visionflow:linked:pay-uk",
      "kind": "StubLink"
    },
    {
      "raw": "[[Popov 2018 IOTA Tangle Whitepaper]]",
      "resolved": "urn:visionflow:linked:popov-2018-iota-tangle-whitepaper",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Real-Time Gross Settlement]]",
      "resolved": "urn:visionflow:linked:real-time-gross-settlement",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[SDX]]",
      "resolved": "urn:visionflow:linked:sdx",
      "kind": "StubLink"
    },
    {
      "raw": "[[Securities Settlement]]",
      "resolved": "urn:visionflow:linked:securities-settlement",
      "kind": "StubLink"
    },
    {
      "raw": "[[Securitize]]",
    ...
    {
      "raw": "[[Sompolinsky Zohar 2015 GHOST]]",
      "resolved": "urn:visionflow:linked:sompolinsky-zohar-2015-ghost",
      "kind": "StubLink"
    },
    {
      "raw": "[[State Replication Protocol]]",
      "resolved": "urn:visionflow:linked:state-replication-protocol",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Time Ordering]]",
      "resolved": "urn:visionflow:linked:time-ordering",
      "kind": "StubLink"
    },
    {
      "raw": "[[Tokenised Deposits]]",
      "resolved": "urn:visionflow:linked:tokenised-deposits",
      "kind": "StubLink"
    },
    {
      "raw": "[[Tokenised Real-World Assets]]",
      "resolved": "urn:visionflow:linked:tokenised-real-world-assets",
      "kind": "StubLink"
    },
    {
      "raw": "[[Trade Finance]]",
    ...
    {
      "raw": "[[Traditional Database]]",
      "resolved": "urn:visionflow:linked:traditional-database",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[UCL CBT 2024 DLT Industry Adoption Review]]",
      "resolved": "urn:visionflow:linked:ucl-cbt-2024-dlt-industry-adoption-review",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[University of Warwick]]",
      "resolved": "urn:visionflow:linked:university-of-warwick",
      "kind": "StubLink"
    },
    {
      "raw": "[[Validator Set]]",
    ...
    {
      "raw": "[[WEF 2023 Pathways Regulation Crypto Assets]]",
      "resolved": "urn:visionflow:linked:wef-2023-pathways-regulation-crypto-assets",
      "kind": "StubLink"
    },
    {
      "raw": "[[Wholesale CBDC]]",
    ...
    {
      "raw": "[[Yin Malkhi Reiter 2019 HotStuff]]",
      "resolved": "urn:visionflow:linked:yin-malkhi-reiter-2019-hot-stuff",
      "kind": "StubLink"
    },
    {
    ...
    },
    {
      ...
      "resolved": "urn:visionflow:owl:class:cryptographic-commitment",
      "kind": "ResolvedLink"
    },
    {
...
- ### Relationships
  ...
  - enables:: [[Transaction History]], [[State Synchronisation]], [[Immutable Record]], [[Neural Network Text Tokenisation]], [[CBDC]], [[Atomic Settlement]], [[Real-Time Gross Settlement]], [[Programmable Money]], [[Cross-Border Payments]]
  ...
  - related-to:: [[Smart Contract]], [[Neural Network Text Tokenisation]], [[CBDC]], [[Stablecoin]], [[Decentralised Finance]], [[Web3]], [[Atomic Swap]], [[Cross-Chain Bridge]]
...
- ### Content
  ...
  - ### Public Chain-of-Blocks (Permissionless)
	  ...
	  **[[Bitcoin Proof-of-Work Protocol]]** (2009): First DLT deployed at scale. UTXO model, ~10-minute block time, SHA-256 proof-of-work consensus, ~700K-1M active nodes globally, 21M fixed supply. Primary use case: censorship-resistant digital store of value. Approximately $1.5-2T market capitalisation by 2026. The defining DLT for monetary applications.

	  **[[Ethereum Smart Contract Platform]]** (2015): Account model, ~12-second block time post-Merge (September 2022) proof-of-stake. ~1M validators, ~10K full nodes. Primary use case: programmable smart contracts, DeFi infrastructure, tokenisation host (BlackRock BUIDL, Ondo, hundreds of stablecoins). Approximately $400-600B market capitalisation by 2026.
