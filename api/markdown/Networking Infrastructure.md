schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#NetworkingInfrastructure
legacy_uri:: urn:visionclaw:concept:infrastructure:networking-infrastructure
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-fa11d74097ed"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#NetworkingInfrastructure"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:networking-infrastructure"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:8f6afada0f9b97507bb091de02cadc3d0cd47d564d611ed9be90cc339e9e3eb8@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:networking-infrastructure",
  "@type": "OntologyClass",
  ...
  "definition": "NetworkingInfrastructure is a concept within the ngm domain.",
  "vc:qualityScore": {
    "@value": "0.35",
    "@type": "xsd:float"
  },
