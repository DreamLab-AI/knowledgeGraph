...
```json-ld
{
  ...
  "relations": {
    ...
    "enables": [
      ...
      {"@id": "urn:ngm:class:security-operations-center", "label": "Security Operations Center"},
    ...
    "contrastsWith": [
      {"@id": "urn:ngm:class:vulnerability-scanning", "label": "Vulnerability Scanning"}
    ],
    "bridgesTo": [
  ...
  "sameAs": [
    {"@id": "urn:ngm:class:cyber-threat-detection", "label": "Cyber Threat Detection"},
