schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#VirtualProductionPipeline
legacy_uri:: urn:visionclaw:concept:spatial-computing:virtual-production-pipeline
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-897a5aa3fa17"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#VirtualProductionPipeline"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:virtual-production-pipeline"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
