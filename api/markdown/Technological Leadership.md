...
```json-ld
{ "@context":"https://narrativegoldmine.com/ns/v1", "@id":"urn:visionflow:page:technological-leadership", "@type":"Page", "title":"Technological Leadership", "vc:slug":"technological-leadership", "vc:public":true, "vc:schemaVersion":2, "vc:outboundWikilinks":[] }
```
...
```json-ld
{
  ...
  "subClassOf":[{"@id":"urn:ngm:class:technology-race","label":"Technology Race"}],
  "relations":{}
}
```
