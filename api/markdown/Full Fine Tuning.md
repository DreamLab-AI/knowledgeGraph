schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#FullFineTuning
legacy_uri:: urn:visionclaw:concept:spatial-computing:full-fine-tuning
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-2be2e90a4c6e"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#FullFineTuning"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:full-fine-tuning"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:full-fine-tuning:776c802a9fc9",
...
- ### Semantic Classification
  - owl-class:: spatial-computing:FullFineTuning
  - owl-role:: Concept
