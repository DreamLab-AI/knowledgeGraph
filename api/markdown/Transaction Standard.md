schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#TransactionStandard
legacy_uri:: urn:visionclaw:concept:spatial-computing:transaction-standard
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-9a1dfb739680"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#TransactionStandard"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:transaction-standard"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
