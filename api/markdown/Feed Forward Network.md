schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#FeedForwardNetwork
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:feed-forward-network
public:: true
  ...
  "vc:legacyProperties": [
    {
      ...
      "vc:value": "FFN, Feedforward Neural Network, Multi-Layer Perceptron, MLP, Position-wise FFN, Dense Layer Network"
    },
    {
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-ffn0a1b2c3d4"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#FeedForwardNetwork"
    },
    {
    ...
    {
      "vc:key": "modified",
      "vc:value": "2026-05-17T08:00:00Z"
    },
    {
      "vc:key": "preferred-term",
      "vc:value": "Feed Forward Network"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:feed-forward-network"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:feed-forward-network:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[Bias Vector]]",
      "resolved": "urn:visionflow:linked:bias-vector",
      "kind": "StubLink"
    },
    {
      "raw": "[[Calculus]]",
      "resolved": "urn:visionflow:linked:calculus",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Feature Learning]]",
      "resolved": "urn:visionflow:linked:feature-learning",
      "kind": "StubLink"
    },
    {
      "raw": "[[GELU]]",
      "resolved": "urn:visionflow:linked:gelu",
      "kind": "StubLink"
    },
    {
      "raw": "[[Hidden Layer]]",
    ...
    {
      "raw": "[[Input Layer]]",
      "resolved": "urn:visionflow:linked:input-layer",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Multi-Layer Perceptron]]",
      "resolved": "urn:visionflow:linked:multi-layer-perceptron",
      "kind": "StubLink"
    },
    {
      "raw": "[[NeurIPS]]",
    ...
    {
      "raw": "[[Output Layer]]",
      "resolved": "urn:visionflow:linked:output-layer",
      "kind": "StubLink"
    },
    {
      "raw": "[[Parametric Model]]",
      "resolved": "urn:visionflow:linked:parametric-model",
      "kind": "StubLink"
    },
    {
      "raw": "[[Position-wise FFN]]",
      "resolved": "urn:visionflow:linked:position-wise-ffn",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[ReLU]]",
      "resolved": "urn:visionflow:linked:re-lu",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Universal Approximation]]",
      "resolved": "urn:visionflow:linked:universal-approximation",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Weight Initialisation]]",
      "resolved": "urn:visionflow:linked:weight-initialisation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Weight Matrix]]",
      "resolved": "urn:visionflow:linked:weight-matrix",
      "kind": "StubLink"
    },
    {
...
- ### Definition
  - A feed-forward network (FFN) is a class of artificial neural network in which information propagates strictly in one direction — from input nodes through one or more hidden layers to output nodes — with no feedback cycles, recurrent connections, or lateral synapses between units at the same layer. The defining structural constraint is acyclicity: the underlying directed graph contains no closed paths, meaning activations computed at layer l depend only on activations from layers 0 through l−1 and never on their own future outputs. This acyclicity renders the network a deterministic function f: ℝⁿ → ℝᵐ that maps an input vector x ∈ ℝⁿ to an output vector ŷ ∈ ℝᵐ through a composed sequence of affine transformations interleaved with element-wise non-linearities, expressible as ŷ = f_L(W_L f_{L-1}(W_{L-1} ··· f_1(W_1 x + b_1) ··· + b_{L-1}) + b_L) where W_l ∈ ℝ^{d_l × d_{l-1}} are weight matrices, b_l ∈ ℝ^{d_l} are bias vectors, and f_l are activation functions applied element-wise at each layer l ∈ {1, …, L}.
...
- ### Semantic Classification
  - owl-class:: artificial-intelligence:FeedForwardNetwork
  - owl-role:: FoundationalArchitecture
  - owl-inferred:: ai:NeuralNetwork, ai:ParametricModel, ai:UniversalApproximator, ai:DifferentiableFunction
  - belongs-to-domain:: [[AI-GroundedDomain]], [[MachineLearningDomain]], [[DeepLearningDomain]]
...
- ### Relationships
  ...
  - contrasts-with:: [[Recurrent Neural Network]], [[Convolutional Neural Network]], [[Graph Neural Network]], [[State Space Model]]
  - related-to:: [[Transformer]], [[Large Language Model]], [[Autoencoder]], [[Variational Autoencoder]], [[Diffusion Model]]
  - standardized-by:: [[IEEE]], [[NeurIPS]], [[ICML]], [[ICLR]]
...
- ### Content
  ...
  ## Compositional Relationships (Components)
	  ...
	  FunctionalDataProperty(ai:canonicalExpansionFactor)
	  FunctionalDataProperty(ai:isAcyclic)
	  ```
