schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#LowEnergyConsumption
legacy_uri:: urn:visionclaw:concept:blockchain:low-energy-consumption
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-738cc2eb42b1"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#LowEnergyConsumption"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:low-energy-consumption"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:37be8ac994f26f057f693f2f32327408af55c3e690f7f8c95716ad4a15888244@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:low-energy-consumption",
  "@type": "OntologyClass",
  "label": "Low Energy Consumption",
  "subClassOf": [
    {
      "@id": "urn:visionflow:owl:class:blockchain-energy-consumption",
      "vc:label": "Blockchain Energy Consumption"
    }
  ],
