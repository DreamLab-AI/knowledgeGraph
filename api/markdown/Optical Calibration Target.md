schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#OpticalCalibrationTarget
legacy_uri:: urn:visionclaw:concept:spatial-computing:optical-calibration-target
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-0e7db1678a3c"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#OpticalCalibrationTarget"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:optical-calibration-target"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
