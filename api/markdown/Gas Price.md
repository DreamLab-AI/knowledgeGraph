schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#GasPrice
legacy_uri:: urn:visionclaw:concept:blockchain:gas-price
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-083c27e576d2"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#GasPrice"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:gas-price"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:3425eaab98b977e46d7a19a817d7d245bf4efdc34b1bfe838d99f27d33bf74c5@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:gas-price",
  "@type": "OntologyClass",
  "label": "Gas Price",
  "subClassOf": [
    {
