schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/robotics#HydraulicActuator
legacy_uri:: urn:visionclaw:concept:robotics:hydraulic-actuator
public:: true
...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:control-architecture-layer",
    ...
    {
      "@id": "urn:visionflow:linked:mechanical-system-layer",
      "vc:label": "MechanicalSystemLayer"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:physical-actuation-layer",
      "vc:label": "PhysicalActuationLayer"
    },
    {
  ...
  "vc:legacyProperties": [
    {
      ...
      "vc:value": "Hydraulic Drive, Fluid Power Actuator, Electrohydraulic Actuator, EHA, Servo-Hydraulic Actuator"
    },
    {
    ...
    {
      "vc:key": "bridges-to",
      "vc:value": "[[Digital Twin]], [[AI Agent System]], [[Legged Robotics]], [[Industrial Automation]]"
    },
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-062676cf775d"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/robotics#HydraulicActuator"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:robotics:hydraulic-actuator"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
- ### Semantic Classification
  ...
  - owl-role:: ActuationMechanism
  - owl-inferred:: rb:FluidPowerDevice, rb:MotionActuator, rb:MechanicalTransducer, rb:ForceControlDevice, rb:ComplianceSource
  - belongs-to-domain:: [[RoboticsDomain]], [[MechanicalEngineeringDomain]], [[FluidPowerDomain]], [[ControlSystemsDomain]]
  - implemented-in-layer:: [[PhysicalActuationLayer]], [[MechanicalSystemLayer]], [[ControlArchitectureLayer]]

- ### Relationships
  - is-subclass-of:: [[Actuator]], [[Fluid Power System]], [[Mechanical Transducer]], [[Motion Control Device]], [[Force Control System]]
  - has-part:: [[Hydraulic Cylinder]], [[Servo Valve]], [[Proportional Valve]], [[Hydraulic Pump]], [[Accumulator]], [[Pressure Relief Valve]], [[Position Sensor]], [[Force Sensor]], [[Hydraulic Reservoir]], [[Hydraulic Manifold]]
  - requires:: [[Hydraulic Power Unit]], [[Pressurised Fluid Supply]], [[Servo Controller]], [[Feedback Sensor]], [[Hydraulic Fluid]], [[Seal System]], [[Return Filter]], [[Heat Exchanger]]
  - enables:: [[Legged Robot Locomotion]], [[Heavy Manipulation]], [[Flight Simulation]], [[Exoskeleton Actuation]], [[Compliant Force Control]], [[High-Force Industrial Automation]], [[Deep-Sea Robotics]], [[Teleoperation]], [[Haptic Interface]]
  - implements:: [[Pascal Law Actuation]], [[Closed-Loop Position Control]], [[Force Impedance Control]], [[Series Elastic Actuation]], [[Electrohydrostatic Drive]], [[Proportional Flow Control]]
  - depends-on:: [[Fluid Mechanics]], [[Control Theory]], [[Tribology]], [[Thermodynamics]], [[Bernoulli Equation]], [[Bulk Modulus]], [[Pascal Law]]
  - supports:: [[Boston Dynamics BigDog]], [[Boston Dynamics Atlas]], [[IIT HyQ Family]], [[Sarcos Guardian XO]], [[DARPA Robotics Challenge]], [[Legged Locomotion Research]], [[Nuclear Remote Handling]]
  - uses:: [[PID Control]], [[Model Predictive Control]], [[Impedance Control]], [[Proportional Valve]], [[Electrohydraulic Servo Valve]], [[Linear Variable Differential Transformer]], [[Differential Pressure Sensing]]
  - contrasts-with:: [[Electric BLDC Actuator]], [[Pneumatic Actuator]], [[Shape Memory Alloy Actuator]], [[Piezoelectric Actuator]], [[Series Elastic Actuator]], [[Quasi-Direct Drive Motor]]
  - related-to:: [[Legged Robotics]], [[Industrial Robotics]], [[Humanoid Robot]], [[Exoskeleton]], [[Construction Robotics]], [[Subsea Robotics]], [[Digital Twin]], [[AI Agent System]]
  - standardized-by:: [[ISO 4413 Hydraulics Safety]], [[NFPA T3 Fluid Power Standard]], [[DIN 24346 Hydraulic Components]], [[SAE J2048 Hydraulic Systems]], [[UK HSE HSG244]]
...
- ### Content
  ...
  ## Compositional Relationships (Components)
	  ...
	  FunctionalDataProperty(rb:operatingPressure)
	  FunctionalDataProperty(rb:powerDensityKWperKg)
	  FunctionalDataProperty(rb:bulkModulusMPa)
	  ```
  ...
  - ### Physical Foundations and Governing Equations
	  ...
	  **Extension force**: F_ext = P_s × A_1 − P_r × A_2
	  **Retraction force**: F_ret = P_s × A_2 − P_r × A_1

	  At 21 MPa supply and 1 MPa return with 50 mm bore (A_1 = 19.6 cm²) and 35 mm rod (A_2 = 9.9 cm²):
	  F_ext = 21 × 10⁶ × 19.6 × 10⁻⁴ − 1 × 10⁶ × 9.9 × 10⁻⁴ = 41.2 − 1.0 = 40.2 kN
	  F_ret = 21 × 10⁶ × 9.9 × 10⁻⁴ − 1 × 10⁶ × 19.6 × 10⁻⁴ = 20.8 − 2.0 = 18.8 kN
	  ...
	  The servo valve modulates actuator velocity by controlling volumetric flow:
	  Q = C_d × A_v(u) × √(2ΔP/ρ)
	  where C_d ≈ 0.64–0.70 (empirical discharge coefficient, unitless), A_v(u) is the metering edge area as a function of valve command signal u (typically ±10 V or ±10 mA), ΔP is the pressure drop across the valve land, and ρ is fluid density (855–870 kg/m³ for ISO VG 46 mineral oil at 40–60°C). Maximum spool-to-spool area A_v_max for a 40 L/min servo valve at 7 MPa drop is approximately 1.7 mm². The square-root pressure dependency means flow gain (∂Q/∂ΔP) halves as load pressure rises from zero to supply pressure—a significant nonlinearity that model-based feedforward controllers must compensate.

	  #### Hydraulic Natural Frequency and Compliance

	  The closed-loop hydraulic actuator behaves as a second-order system. The hydraulic natural frequency is:
	  ω_h = √(4 β_e A²) / √(V_t m)
  ...
  - ### Comparison to Electric BLDC and Pneumatic Actuators
	  ...
	  **Quasi-direct-drive (QDD)** motors (MIT Cheetah series, Unitree A1/Go1, ANYmal electric joints) reduce gear ratio to 6:1–10:1 using high-pole-count BLDC designs (6–36 pole pairs) with segment-wound stators. QDD achieves 0.5–2.5 kW/kg joint power density, dramatically improved backdrivability (reflected inertia 36–100× motor inertia vs. 2,500–25,000× for harmonic drives), sub-millisecond torque bandwidth from current-controlled inverters, and zero gear hysteresis. The MIT Cheetah 3 and Mini Cheetah demonstrated that electric QDD quadrupeds could match the running speed (3 m/s trot), jumping height (0.9 m), and rough-terrain performance of hydraulic counterparts in the <40 kg body mass class—the watershed result published in IEEE T-Robotics 2019 (Wensing et al.) that accelerated the electric transition for small-to-medium legged robots.
	  ...
	  | Metric | Hydraulic (valve) | EHA | BLDC+Harmonic | BLDC+QDD | Pneumatic |
	  |---|---|---|---|---|---|
	  | Power density joint (kW/kg) | 3–8 | 3–8 | 0.3–1.5 | 0.5–2.5 | 0.05–0.2 |
	  | Force density (N/cm²) | 50–200 | 50–150 | 8–40 | 5–30 | 1–15 |
	  | Bandwidth (–3 dB) Hz | 10–60 | 15–80 | 20–80 | 50–200 | 2–20 |
	  | Backdrivability | High | High | Low (harmonic) | High | High |
	  | Leakage risk | High | Low | None | None | Low (oil mist) |
	  | Peak noise dB | 70–90 | 50–70 | 45–65 | 40–60 | 55–75 |
	  | Round-trip efficiency | 40–70% | 65–85% | 60–80% | 75–95% | 15–40% |
	  | Deployment environment | Industrial/outdoor | Industrial/outdoor | Office/clean | Office/clean | Medical/agri |
  ...
  - ### Hydraulic Fluid Selection and System Chemistry
	  ...
	  The working fluid is the lifeblood of the hydraulic actuation system, transmitting force, lubricating moving components, dissipating heat, and protecting metal surfaces from corrosion.
	  Fluid selection is not merely a procurement decision but a systems-engineering choice that determines achievable performance, maintenance schedule, environmental liability, and seal material compatibility.
	  Poor fluid selection or inadequate fluid maintenance causes an estimated 70% of hydraulic system failures in industrial plant (Bosch Rexroth field study, 2019).
  ...
  - ### Risks, Limitations, and Failure Modes
	  ...
	  Hydraulic actuation carries a well-characterised and manageable set of failure modes.
	  Each failure mode has established detection and mitigation strategies; the risk profile is not prohibitive but does require engineering investment that electric systems avoid.
