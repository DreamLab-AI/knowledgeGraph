schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#PermissionlessNetwork
legacy_uri:: urn:visionclaw:concept:blockchain:permissionless-network
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-52a822226ec5"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#PermissionlessNetwork"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:permissionless-network"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:b2953b8c20793d8455f81f98063e49440020e809b75384b0e3e829f3ff6fc176@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:permissionless-network",
  "@type": "OntologyClass",
