schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/identity-governance#TrustFramework
legacy_uri:: urn:visionclaw:concept:identity-governance:trust-framework
public:: true
...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:digital-trust-domain",
      "vc:label": "DigitalTrustDomain"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:identity-governance-domain",
      "vc:label": "IdentityGovernanceDomain"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:standards-layer",
      "vc:label": "StandardsLayer"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-tf9a4b7c2d1e"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "domain",
      "vc:value": "identity-governance"
    },
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/identity-governance#TrustFramework"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:identity-governance:trust-framework"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:trust-framework:776c802a9fc9",
  ...
  "vc:resolutions": [
    {
      "raw": "[[Accreditation Body]]",
      "resolved": "urn:visionflow:linked:accreditation-body",
      "kind": "StubLink"
    },
    {
      "raw": "[[Ad Hoc Identity]]",
      "resolved": "urn:visionflow:linked:ad-hoc-identity",
      "kind": "StubLink"
    },
    {
      "raw": "[[Assurance Level]]",
      "resolved": "urn:visionflow:linked:assurance-level",
      "kind": "StubLink"
    },
    {
      "raw": "[[Authentication]]",
    ...
    {
      "raw": "[[Certification Scheme]]",
      "resolved": "urn:visionflow:linked:certification-scheme",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Credential Issuer]]",
      "resolved": "urn:visionflow:linked:credential-issuer",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Cross-Border Authentication]]",
      "resolved": "urn:visionflow:linked:cross-border-authentication",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Digital Credentials]]",
      "resolved": "urn:visionflow:linked:digital-credentials",
      "kind": "StubLink"
    },
    {
      "raw": "[[DigitalTrustDomain]]",
      "resolved": "urn:visionflow:linked:digital-trust-domain",
      "kind": "StubLink"
    },
    {
      "raw": "[[DSIT]]",
      "resolved": "urn:visionflow:linked:dsit",
      "kind": "StubLink"
    },
    {
      "raw": "[[eIDAS 2]]",
      "resolved": "urn:visionflow:linked:e-idas-2",
      "kind": "StubLink"
    },
    {
      "raw": "[[ETSI]]",
    ...
    {
      "raw": "[[Framework]]",
      "resolved": "urn:visionflow:linked:framework",
      "kind": "StubLink"
    },
    {
      "raw": "[[GovernanceLayer]]",
    ...
    {
      "raw": "[[IdentityGovernanceDomain]]",
      "resolved": "urn:visionflow:linked:identity-governance-domain",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[ISO/IEC 17065]]",
      "resolved": "urn:visionflow:linked:iso-iec-17065",
      "kind": "StubLink"
    },
    {
      "raw": "[[ISO/IEC 27001]]",
    ...
    {
      "raw": "[[OpenID Federation]]",
      "resolved": "urn:visionflow:linked:open-id-federation",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Relying Party]]",
      "resolved": "urn:visionflow:linked:relying-party",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Siloed Identity]]",
      "resolved": "urn:visionflow:linked:siloed-identity",
      "kind": "StubLink"
    },
    {
      "raw": "[[StandardsLayer]]",
      "resolved": "urn:visionflow:linked:standards-layer",
      "kind": "StubLink"
    },
    {
      "raw": "[[Trust Anchor]]",
    ...
    {
      "raw": "[[Trust List]]",
      "resolved": "urn:visionflow:linked:trust-list",
      "kind": "StubLink"
    },
    {
      "raw": "[[Trust Mark]]",
      "resolved": "urn:visionflow:linked:trust-mark",
      "kind": "StubLink"
    },
    {
      "raw": "[[Trust over IP]]",
      "resolved": "urn:visionflow:linked:trust-over-ip",
      "kind": "StubLink"
    },
    {
      "raw": "[[Trust Transitivity]]",
      "resolved": "urn:visionflow:linked:trust-transitivity",
      "kind": "StubLink"
    },
    {
      "raw": "[[W3C]]",
...
- ### Definition
  - Structured normative architecture that defines the policies, technical standards, legal rules, certification requirements, and governance mechanisms enabling organisations and individuals to establish, assert, verify, and maintain digital trust relationships across participating entities in an ecosystem. A trust framework specifies what constitutes acceptable identity evidence, which credential types are recognised, which assurance levels are required for given transaction risk profiles, how accreditation of service providers is achieved, and which revocation and audit obligations apply. Trust frameworks operate simultaneously as governance instruments (defining legal and contractual obligations), technical specifications (defining interoperable protocols and data formats), and certification schemes (mandating conformity assessment by accredited bodies). Modern trust frameworks address identity assurance across the full digital identity lifecycle — identity proofing (binding a claimed identity to a real-world person or entity), authenticator management (controlling the authentication mechanisms used subsequently), and federation (communicating verified identity assertions across organisational boundaries) — and are increasingly complemented by wallet architectures enabling holder-controlled selective disclosure of verified credentials. Dominant frameworks in the 2024–2026 period include the UK Digital Identity and Attributes Trust Framework v0.4/1.0 (DIATF/DVS), EU eIDAS 2 Regulation 2024/1183 with its Architecture Reference Framework (ARF), NIST Special Publication 800-63-4, the Pan-Canadian Trust Framework (PCTF), and the Trust over IP (ToIP) governance metamodel; cross-framework interoperability analysis by the Open Identity Exchange identified 15 policy areas, 75 policy characteristics, and 289 possible values spanning eight major frameworks globally.

- ### Semantic Classification
  - owl-class:: identity-governance:TrustFramework
  - owl-role:: GovernanceInstrument
  - owl-inferred:: ig:CertificationScheme, ig:PolicyFramework, ig:InteroperabilityArchitecture
  - belongs-to-domain:: [[IdentityGovernanceDomain]], [[DigitalTrustDomain]], [[RegulatoryComplianceDomain]]
  - implemented-in-layer:: [[GovernanceLayer]], [[PolicyLayer]], [[StandardsLayer]], [[CertificationLayer]]

- ### Relationships
  - is-subclass-of:: [[Framework]], [[Governance Framework]], [[Policy Framework]], [[Certification Scheme]]
  - has-part:: [[Trust Anchor]], [[Trust List]], [[Assurance Level]], [[Identity Proofing]], [[Authentication]], [[Federation]], [[Accreditation Body]], [[Conformity Assessment Body]], [[Credential Issuer]], [[Relying Party]], [[Revocation Mechanism]], [[Trust Mark]]
  - requires:: [[Identity Verification]], [[Digital Credentials]], [[Cryptographic Proof]], [[Conformity Assessment]], [[Audit Trail]], [[Policy Enforcement Point]]
  - enables:: [[Digital Identity]], [[Cross-Border Authentication]], [[Credential Portability]], [[Trust Transitivity]], [[Risk-Based Authentication]], [[Selective Disclosure]], [[Interoperability]]
  - implements:: [[NIST SP 800-63]], [[eIDAS 2]], [[OpenID Federation]], [[Verifiable Credentials]], [[OpenID Connect]], [[Trust over IP]]
  - depends-on:: [[Public Key Infrastructure]], [[Cryptography]], [[Decentralised Identifiers]], [[Identity Governance]], [[Data Protection Law]]
  - supports:: [[Access Control System]], [[AML KYC Compliance]], [[Digital Signatures]], [[Zero Trust Architecture]], [[Self-Sovereign Identity]]
  - uses:: [[JSON Web Token]], [[X.509 Certificate]], [[OpenID Connect]], [[SD-JWT]], [[ISO/IEC 27001]], [[ISO/IEC 17065]]
  - contrasts-with:: [[Web of Trust]], [[Ad Hoc Identity]], [[Siloed Identity]]
  - related-to:: [[Identity and Access Management]], [[Privacy Enhancing Technologies]], [[Regulatory Compliance]], [[Decentralised Identity]], [[Digital Wallet]]
  - standardized-by:: [[NIST]], [[ETSI]], [[W3C]], [[ISO]], [[DSIT]], [[European Commission]]
...
- ### Content
  ...
  - ## Metadata
    - Domain correction: `infrastructure` → `identity-governance`. The original frontmatter incorrectly classified this concept under `infrastructure`. Trust frameworks are fundamentally instruments of identity governance — covering certification, accreditation, policy, legal instruments, and assurance level architecture — not generic infrastructure components. IRI, URI, same-as, and owl-class corrected accordingly.
    - Legacy term ID assigned: `IF-0031` (Identity Frameworks ontology series)
...
- ### Provenance
  - sources::
    - 1. NIST SP 800-63-4, "Digital Identity Guidelines", NIST (final draft August 2024), https://pages.nist.gov/800-63-4/sp800-63.html
    - 2. European Commission, "Architecture and Reference Framework (ARF) v2.0", EU Digital Identity Wallet programme (2025), https://eu-digital-identity-wallet.github.io/eudi-doc-architecture-and-reference-framework/2.4.0/architecture-and-reference-framework-main/
    - 3. Regulation (EU) 2024/1183 of the European Parliament and of the Council (eIDAS 2), OJ L 1183, 20 May 2024
    - 4. UK Data (Use and Access) Act 2025, Part 2 (Digital Verification Services), UK Parliament, Royal Assent 19 June 2025, https://www.legislation.gov.uk/ukpga/2025/18/part/2
    - 5. DSIT/OfDIA, "UK Digital Verification Services Trust Framework 1.0" (March 2026), https://www.gov.uk/government/publications/uk-digital-verification-services-trust-framework-1-0/uk-digital-verification-services-trust-framework-1-0-pre-release
    - 6. DSIT/OfDIA, "Final Gamma (0.4) Trust Framework and Updated Supplementary Codes" (June 2025), https://enablingdigitalidentity.blog.gov.uk/2025/06/26/sharing-the-final-gamma-0-4-trust-framework-and-updated-supplementary-codes/
    - 7. UKAS, "UK Digital Identity and Attributes Trust Framework — Digital Sector Accreditation", https://www.ukas.com/accreditation/sectors/digital/
    - 8. Kantara Initiative, "Kantara Achieves Historic First: Accredited to Certify Against the UK DIATF" (November 2025), https://kantarainitiative.org/kantara-achieves-historic-first-accredited-to-certify/
    - 9. GOV.UK, "Certification Scheme for the UK Digital Identity and Attributes Trust Framework", https://www.gov.uk/guidance/certification-scheme-for-the-uk-digital-identity-and-attributes-trust-framework
    - 10. GOV.UK, "Digital Identity Services Register", https://www.digital-identity-services-register.service.gov.uk/
    - 11. ETSI TS 119 612 V2.4.1 (August 2025), "Electronic Signatures and Infrastructures (ESI); Trusted Lists", https://www.etsi.org/deliver/etsi_ts/119600_119699/119612/02.04.01_60/ts_119612v020401p.pdf
    - 12. OpenID Foundation, "OpenID Federation 1.0", https://openid.net/specs/openid-federation-1_0.html
    - 13. OpenID Foundation, "OpenID Federation 1.1 — draft 01", https://openid.net/specs/openid-federation-1_1-01.html
    - 14. OpenID Foundation, "OpenID Federation Wallet Architectures 1.0 — draft 04", https://openid.github.io/federation-wallet/main.html
    - 15. Trust over IP Foundation, "ToIP Technology Architecture Specification", https://trustoverip.github.io/TechArch/
    - 16. Trust over IP Foundation, "Governance Metamodel Specification Companion Guide V1.0" (December 2021), https://trustoverip.org/wp-content/uploads/ToIP-Governance-Metamodel-Specification-Companion-Guide-V1.0-2021-12-21.pdf
    - 17. Trust over IP Foundation, "Trust Spanning Protocol — First Implementers Draft" (April 2024), https://trustoverip.org/our-work/deliverables/
    - 18. DIACC, "Pan-Canadian Trust Framework — Authentication Final Recommendation V1.2" (July 2024), https://diacc.ca/wp-content/uploads/2024/10/PCTF-Authentication_Final-Rec-V1.2_Compressed_ENG.pdf
    - 19. DIACC, "Pan-Canadian Trust Framework — Verified Organization Final Recommendation V1.0" (October 2024), https://diacc.ca/wp-content/uploads/2024/10/PCTF-Verified-Organization_Final-Rec-V1.0_Comrpessed_ENG.pdf
    - 20. OIX, "Digital ID DNA — Interoperability Across Trust Frameworks" (October 2023), https://openidentityexchange.org/networks/87/item.html?id=708
    - 21. W3C Verifiable Credentials Working Group, "Verifiable Credentials Data Model v2.0" (W3C Recommendation, 15 May 2025), https://www.w3.org/TR/vc-data-model-2.0/
    - 22. Grassi P.A. et al., "NIST SP 800-63-3: Digital Identity Guidelines" (2017), National Institute of Standards and Technology
    - 23. Blaze M., Feigenbaum J., Lacy J., "Decentralized Trust Management", IEEE Symposium on Security and Privacy (1996)
    - 24. Cameron K., "The Laws of Identity", Microsoft (2005)
    - 25. Murdoch S.J., Drimer S. et al., "Chip and PIN is Broken", IEEE Symposium on Security and Privacy (2010), University of Cambridge Computer Laboratory
    - 26. Jøsang A., "Subjective Logic: A Formalism for Reasoning Under Uncertainty", Springer (2016)
    - 27. DSIT/HM Treasury, Joint Guidance on DIATF Certification and Money Laundering Regulations (2025), https://www.techuk.org/resource/digital-id-boost-for-aml-checks-dsit-and-hmt-issue-guidance-for-mlr-compliance.html
