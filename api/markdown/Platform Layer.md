schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#PlatformLayer
legacy_uri:: urn:visionclaw:concept:spatial-computing:platform-layer
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-0ace9656e815"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#PlatformLayer"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:platform-layer"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
