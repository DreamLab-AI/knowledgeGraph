schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#Public-keyCryptography
legacy_uri:: urn:visionclaw:concept:blockchain:public-key-cryptography
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-9f9028ff0dbf"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#Public-keyCryptography"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:public-key-cryptography"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:56688ddb1998eba7a63f6113d790f851a7ede9d4251e0a2be2f231f10647aa9f@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
