schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#TechnicalRobustnessAndSafety
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:technical-robustness-and-safety
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-67fad0a9b9fb"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#TechnicalRobustnessAndSafety"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:technical-robustness-and-safety"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:cb76e75faabd10424cbab73c1c86adcfe64a8f8f63c0eaba9e671493f5ee0845@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:technical-robustness-and-safety",
  "@type": "OntologyClass",
  "label": "Technical Robustness and Safety",
  "subClassOf": [
    {
      "@id": "urn:visionflow:owl:class:ai-trustworthiness-dimensions",
      "vc:label": "AI Trustworthiness Dimensions"
    }
  ],
...
- ### Content
  Technical Robustness and Safety — content pending enrichment.
