schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#ContextAwareComputing
legacy_uri:: urn:visionclaw:concept:spatial-computing:context-aware-computing
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-3dbced9389d9"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#ContextAwareComputing"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:context-aware-computing"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:5bd14843d9594fd5f8272fbb335d5c83b0e3357c8e6edd63c1e1eb4c8ee1f6c3@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
```json-ld
{
  ...
  "definition": "Context Aware Computing is a type of Spatial Computing in the spatial computing domain.",
