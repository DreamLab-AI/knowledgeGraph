schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#3dUserInterface
legacy_uri:: urn:visionclaw:concept:spatial-computing:3d-user-interface
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-628fe433ae7b"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#3dUserInterface"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:3d-user-interface"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
