...
```json-ld
{
  ...
  "relations": {
    "uses": [{"@id": "urn:ngm:class:embedding", "label": "Embedding"}],
    "enables": [{"@id": "urn:ngm:class:semantic-search", "label": "Semantic Search"}],
    "supports": [{"@id": "urn:ngm:class:vector-database", "label": "Vector Database"}],
    "relatedTo": [{"@id": "urn:ngm:class:cross-encoder-reranking", "label": "Cross-Encoder Reranking"}, {"@id": "urn:ngm:class:embedding-search", "label": "Embedding Search"}]
  },
  "quality": 0.8
}
```
