schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/robotics#RescueRobot
legacy_uri:: urn:visionclaw:concept:robotics:rescue-robot
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-a5a0e29ea349"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/robotics#RescueRobot"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:robotics:rescue-robot"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:c3b7a4108dbee3bbf37da3f92d7d65a71e716aec3de09004f600d5be9655435f@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:rescue-robot",
  "@type": "OntologyClass",
  "label": "Rescue Robot",
  "subClassOf": [
    {
