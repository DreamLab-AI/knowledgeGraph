schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#VesuvianScrolls
legacy_uri:: urn:visionclaw:concept:infrastructure:vesuvian-scrolls
public:: true
...
```json-ld
{
  ...
  "@id": "urn:visionflow:page:ca1ee3313fc7d8819aee242d6b6eae3050b0df9e0227efeb044ce718f579033f",
  "@type": "Page",
  "vc:slug": "vesuvian-scrolls",
  "title": "Vesuvian Scrolls",
  "vc:public": true,
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-02259a06521e"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#VesuvianScrolls"
    },
    {
      "vc:key": "maturity",
      "vc:value": "draft"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:vesuvian-scrolls"
    },
    {
      "vc:key": "status",
      "vc:value": "stub"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:ca1ee3313fc7d8819aee242d6b6eae3050b0df9e0227efeb044ce718f579033f@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:vesuvian-scrolls",
  "@type": "OntologyClass",
  ...
  "definition": "Vesuvian Scrolls is a technology infrastructure concept and a type of infrastructure.",
  "vc:qualityScore": {
    "@value": "0.35",
    "@type": "xsd:float"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:vesuvian-scrolls:776c802a9fc9",
...
- ### Definition
  - Vesuvian Scrolls is a concept within the ngm domain.

- ### Semantic Classification
  - owl-class:: infrastructure:VesuvianScrolls
  - owl-role:: Concept
