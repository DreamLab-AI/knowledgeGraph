...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "gan-virtual-landscape-art",
...
```json-ld
{
  ...
  "@id": "urn:ngm:class:gan-virtual-landscape-art",
  "@type": "Class",
  "label": "GAN Virtual Landscape Art",
...
- ### Relationships
  - **uses**: [[Generative AI]], [[Machine Learning Discipline]] — StyleGAN and related GAN architectures are the core generation technology
