schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#Chatbots
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:chatbots
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "bridges-to",
      "vc:value": "[[Large Language Models]], [[Natural Language Processing]], [[Dialogue Systems]]"
    },
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-cb9f3a4d72e1"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#Chatbots"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:chatbots"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:chatbots:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[BERTScore]]",
      "resolved": "urn:visionflow:linked:bertscore",
      "kind": "StubLink"
    },
    {
      "raw": "[[BLEU]]",
      "resolved": "urn:visionflow:linked:bleu",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Embedding Models]]",
      "resolved": "urn:visionflow:linked:embedding-models",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Form-Based Interfaces]]",
      "resolved": "urn:visionflow:linked:form-based-interfaces",
      "kind": "StubLink"
    },
    {
      "raw": "[[Healthcare AI]]",
    ...
    },
    {
      ...
      "resolved": "urn:visionflow:linked:human-evaluation",
      "kind": "StubLink"
    },
    {
    ...
    },
    {
      ...
      "resolved": "urn:visionflow:linked:intent-recognition",
      "kind": "StubLink"
    },
    {
      "raw": "[[InterfaceLayer]]",
    ...
    {
      "raw": "[[ISO 30401]]",
      "resolved": "urn:visionflow:linked:iso-30401",
      "kind": "StubLink"
    },
    {
      "raw": "[[Knowledge Base]]",
    ...
    {
      "raw": "[[Lead Generation]]",
      "resolved": "urn:visionflow:linked:lead-generation",
      "kind": "StubLink"
    },
    {
    ...
    },
    {
      ...
      "resolved": "urn:visionflow:linked:response-selection",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Search Engines]]",
      "resolved": "urn:visionflow:linked:search-engines",
      "kind": "StubLink"
    },
    {
      "raw": "[[Slot Filling]]",
    ...
    {
      "raw": "[[Voice Interfaces]]",
      "resolved": "urn:visionflow:linked:voice-interfaces",
      "kind": "StubLink"
    },
    {
      "raw": "[[W3C Voice Browser Working Group]]",
      "resolved": "urn:visionflow:linked:w3-c-voice-browser-working-group",
      "kind": "StubLink"
    },
    {
      "raw": "[[AI Agent System]]",
