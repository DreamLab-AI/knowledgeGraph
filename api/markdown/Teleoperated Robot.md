schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/robotics#TeleoperatedRobot
legacy_uri:: urn:visionclaw:concept:robotics:teleoperated-robot
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-09f852229e44"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/robotics#TeleoperatedRobot"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:robotics:teleoperated-robot"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:f6c83b5568ddfec1907d6fd0b2f3cb813f7378af9ca297362ed02a6bbecfd30a@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:teleoperated-robot",
  "@type": "OntologyClass",
...
- ### Content
  ...
  **Teleoperated Robot** - Teleoperated Robot in robotics systems
  ...
  ### Emerging Trends
		  ...
		  **License**: CC BY 4.0
		  **Namespace**: `https://metaverse-ontology.org/robotics/RB-0009`
