schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#MetaverseOntologySchema
legacy_uri:: urn:visionclaw:concept:spatial-computing:metaverse-ontology-schema
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-2b9d1b51809d"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#MetaverseOntologySchema"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:metaverse-ontology-schema"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
