schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#NFTWrapping
legacy_uri:: urn:visionclaw:concept:spatial-computing:nft-wrapping
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-eb542adeaaea"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#NFTWrapping"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:nft-wrapping"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
