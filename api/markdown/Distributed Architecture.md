schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#DistributedArchitecture
legacy_uri:: urn:visionclaw:concept:spatial-computing:distributed-architecture
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-90b0e12a7f94"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#DistributedArchitecture"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:distributed-architecture"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
