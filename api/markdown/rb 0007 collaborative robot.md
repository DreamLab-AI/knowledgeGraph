schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/robotics#Rb0007CollaborativeRobot
legacy_uri:: urn:visionclaw:concept:robotics:rb-0007-collaborative-robot
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-c78ee2c6f6cc"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/robotics#Rb0007CollaborativeRobot"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:robotics:rb-0007-collaborative-robot"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:1d5dc84ee93458abbae87d636969132d198aad2206b24ad0f2c1f94e5863be97@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:rb-0007-collaborative-robot",
  "@type": "OntologyClass",
  ...
  "definition": "collaborative robot is a robotics and autonomous systems concept and a type of Industrial Robot."
}
```
