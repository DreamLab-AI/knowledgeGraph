...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "multi-viewpoint-immersive-research-platform",
...
```json-ld
{
  ...
  "@id": "urn:ngm:class:multi-viewpoint-immersive-research-platform",
  "@type": "Class",
  "label": "Multi-Viewpoint Immersive Research Platform",
