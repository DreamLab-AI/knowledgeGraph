schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#VisualizationLayer
legacy_uri:: urn:visionclaw:concept:spatial-computing:visualization-layer
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-910c211d2403"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#VisualizationLayer"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:visualization-layer"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
