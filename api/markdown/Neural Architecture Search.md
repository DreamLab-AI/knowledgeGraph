...
```json-ld
{
  ...
  "relations": {
    ...
    "enables": [
      ...
      },
      {
        ...
        "label": "Hardware-Aware Inference"
      },
      {
        "@id": "urn:ngm:class:neural-network",
        "label": "Efficient Neural Network"
      }
    ],
    "requires": [
      {
      ...
      {
        "@id": "urn:ngm:class:performance-estimation-strategy",
        "label": "Performance Estimation Strategy"
      },
      {
    ...
    "contrastsWith": [
      {
        ...
        "label": "Hand-Crafted Architecture"
      },
      {
    ...
    "relatedTo": [
      ...
      {
        "@id": "urn:ngm:class:zero-cost-proxy",
        "label": "Zero-Cost Proxy"
      },
      {
  ...
  "sameAs": [
    {
      "@id": "urn:ngm:class:automated-architecture-design",
      "label": "Automated Architecture Design"
    },
    {
      "@id": "urn:ngm:class:architecture-search",
