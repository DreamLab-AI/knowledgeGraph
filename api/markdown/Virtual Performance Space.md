schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#VirtualPerformanceSpace
legacy_uri:: urn:visionclaw:concept:spatial-computing:virtual-performance-space
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-5b1b1a303c18"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#VirtualPerformanceSpace"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:virtual-performance-space"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
