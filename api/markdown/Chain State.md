schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#ChainState
legacy_uri:: urn:visionclaw:concept:blockchain:chain-state
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-91cddfd8833e"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#ChainState"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:chain-state"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:7786f71db88565e8307084bfc66bff070f0cf42ce304c62f58a4cce1955cb060@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:chain-state",
  "@type": "OntologyClass",
  "label": "Chain State",
  "subClassOf": [
    {
