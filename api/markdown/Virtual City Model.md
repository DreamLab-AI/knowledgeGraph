schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#VirtualCityModel
legacy_uri:: urn:visionclaw:concept:spatial-computing:virtual-city-model
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-42b4c57f9c5b"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#VirtualCityModel"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:virtual-city-model"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:819568b10862d9f5391d3cbeed3afc41c574469036aa04574820c39e694ff31b@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:virtual-city-model",
  "@type": "OntologyClass",
