...
```json-ld
{
  ...
  "relations": {
    ...
    "enables": [
      ...
      {"@id": "urn:ngm:class:data-collaboration", "label": "Data Collaboration"},
    ...
    "contrastsWith": [
      {"@id": "urn:ngm:class:plaintext-computation", "label": "Plaintext Computation"},
      {"@id": "urn:ngm:class:centralised-data-processing", "label": "Centralised Data Processing"}
    ],
    "bridgesTo": [
      {"@id": "urn:ngm:class:federated-learning", "label": "Federated Learning"},
