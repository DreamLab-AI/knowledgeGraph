schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#PhysicsBasedAnimation
legacy_uri:: urn:visionclaw:concept:spatial-computing:physics-based-animation
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-66f9061f0d85"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#PhysicsBasedAnimation"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:physics-based-animation"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
