schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#EdgeMeshNetwork
legacy_uri:: urn:visionclaw:concept:spatial-computing:edge-mesh-network
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-f398cde9f043"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#EdgeMeshNetwork"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:edge-mesh-network"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
