schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#BiometricBindingMechanism
legacy_uri:: urn:visionclaw:concept:spatial-computing:biometric-binding-mechanism
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-cdb6a258483e"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#BiometricBindingMechanism"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:biometric-binding-mechanism"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
