schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#XRMeetingSpace
legacy_uri:: urn:visionclaw:concept:spatial-computing:xr-meeting-space
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-cfeb071b37ee"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#XRMeetingSpace"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:xr-meeting-space"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
