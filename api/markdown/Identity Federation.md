schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#IdentityFederation
legacy_uri:: urn:visionclaw:concept:infrastructure:identity-federation
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-a4d0c172ef9c"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#IdentityFederation"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:identity-federation"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
