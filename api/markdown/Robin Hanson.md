schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#RobinHanson
legacy_uri:: urn:visionclaw:concept:infrastructure:robin-hanson
public:: true
...
```json-ld
{
  ...
  "@id": "urn:visionflow:page:ac563f01887867c292c6a942e50c297702a6e2783e40ac9c1190974c4b81bf13",
  "@type": "Page",
  "vc:slug": "robin-hanson",
  "title": "Robin Hanson",
  "vc:public": true,
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-7e3ebf632e91"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#RobinHanson"
    },
    {
      "vc:key": "maturity",
      "vc:value": "draft"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:robin-hanson"
    },
    {
      "vc:key": "status",
      "vc:value": "stub"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:ac563f01887867c292c6a942e50c297702a6e2783e40ac9c1190974c4b81bf13@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
```json-ld
{
  ...
  "definition": "Robin Hanson is a concept within the ngm domain.",
  "vc:qualityScore": {
    "@value": "0.35",
    "@type": "xsd:float"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:robin-hanson:776c802a9fc9",
