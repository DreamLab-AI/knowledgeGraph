schema_version:: 1
legacy_iri:: https://visionclaw.dreamlab-ai.systems/ns/v2/artificial-intelligence#StochasticProcess
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:stochastic-process
public:: true
...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:black-and-scholes-1973-option-pricing",
      "vc:label": "Black & Scholes 1973 Option Pricing"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:dalalyan-2017-ula-guarantees",
      "vc:label": "Dalalyan 2017 ULA Guarantees"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:doob-1953-stochastic-processes",
      "vc:label": "Doob 1953 Stochastic Processes"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:financial-mathematics-domain",
      "vc:label": "FinancialMathematicsDomain"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:gardner-et-al-2018-gpy-torch",
      "vc:label": "Gardner et al 2018 GPyTorch"
    },
    {
      "@id": "urn:visionflow:linked:gatheral-et-al-2018-volatility-is-rough",
      "vc:label": "Gatheral et al 2018 Volatility is Rough"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:geman-and-geman-1984-gibbs-sampler",
      "vc:label": "Geman & Geman 1984 Gibbs Sampler"
    },
    {
      "@id": "urn:visionflow:linked:hensman-et-al-2013-gp-big-data",
      "vc:label": "Hensman et al 2013 GP Big Data"
    },
    {
      "@id": "urn:visionflow:linked:heston-1993-stochastic-volatility",
      "vc:label": "Heston 1993 Stochastic Volatility"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:hoffman-and-gelman-2014-nuts",
      "vc:label": "Hoffman & Gelman 2014 NUTS"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:it-1944-stochastic-integral",
      "vc:label": "Itô 1944 Stochastic Integral"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:karatzas-and-shreve-1991-brownian-motion-and-stochastic-calculus",
      "vc:label": "Karatzas & Shreve 1991 Brownian Motion and Stochastic Calculus"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:kolmogorov-1933-grundbegriffe",
      "vc:label": "Kolmogorov 1933 Grundbegriffe"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:ksendal-2003-stochastic-differential-equations",
      "vc:label": "Øksendal 2003 Stochastic Differential Equations"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:merton-1976-jump-diffusion",
      "vc:label": "Merton 1976 Jump-Diffusion"
    },
    {
      "@id": "urn:visionflow:linked:metropolis-et-al-1953-equation-of-state",
      "vc:label": "Metropolis et al 1953 Equation of State"
    },
    {
      "@id": "urn:visionflow:linked:meyn-and-tweedie-2009-markov-chains-and-stochastic-stability",
      "vc:label": "Meyn & Tweedie 2009 Markov Chains and Stochastic Stability"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:norris-1997-markov-chains",
      "vc:label": "Norris 1997 Markov Chains"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:protter-2005-stochastic-integration-and-differential-equations",
      "vc:label": "Protter 2005 Stochastic Integration and Differential Equations"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:rasmussen-and-williams-2006-gaussian-processes-for-machine-learning",
      "vc:label": "Rasmussen & Williams 2006 Gaussian Processes for Machine Learning"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:revuz-and-yor-1999-continuous-martingales-and-brownian-motion",
      "vc:label": "Revuz & Yor 1999 Continuous Martingales and Brownian Motion"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:rogers-and-williams-2000-diffusions-markov-processes-martingales",
      "vc:label": "Rogers & Williams 2000 Diffusions Markov Processes Martingales"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:song-et-al-2020-ddim",
      "vc:label": "Song et al 2020 DDIM"
    },
    {
      "@id": "urn:visionflow:linked:song-et-al-2021-score-based-generative-modeling-sde",
      "vc:label": "Song et al 2021 Score-Based Generative Modeling SDE"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:statistics-and-probability-domain",
      "vc:label": "StatisticsAndProbabilityDomain"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:titsias-2009-variational-sparse-gp",
      "vc:label": "Titsias 2009 Variational Sparse GP"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:welling-and-teh-2011-sgld",
      "vc:label": "Welling & Teh 2011 SGLD"
    },
    {
  ...
  "vc:legacyProperties": [
    {
      ...
      "vc:value": "Random Process, Probabilistic Process, Stochastic System"
    },
    {
    ...
    {
      "vc:key": "bridges-to",
      "vc:value": "[[Machine Learning]], [[Diffusion Models]], [[Financial Mathematics]]"
    },
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-sp7f4c2d9b1e"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "https://visionclaw.dreamlab-ai.systems/ns/v2/artificial-intelligence#StochasticProcess"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:stochastic-process"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:stochastic-process:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[Annals of Probability]]",
      "resolved": "urn:visionflow:linked:annals-of-probability",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Black & Scholes 1973 Option Pricing]]",
      "resolved": "urn:visionflow:linked:black-and-scholes-1973-option-pricing",
      "kind": "StubLink"
    },
    {
      "raw": "[[Chapman-Kolmogorov Equation]]",
      "resolved": "urn:visionflow:linked:chapman-kolmogorov-equation",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Dalalyan 2017 ULA Guarantees]]",
      "resolved": "urn:visionflow:linked:dalalyan-2017-ula-guarantees",
      "kind": "StubLink"
    },
    {
      "raw": "[[Detailed Balance]]",
      "resolved": "urn:visionflow:linked:detailed-balance",
      "kind": "StubLink"
    },
    {
      "raw": "[[Deterministic Dynamical System]]",
      "resolved": "urn:visionflow:linked:deterministic-dynamical-system",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Doob 1953 Stochastic Processes]]",
      "resolved": "urn:visionflow:linked:doob-1953-stochastic-processes",
      "kind": "StubLink"
    },
    {
      "raw": "[[Dynamical System]]",
      "resolved": "urn:visionflow:linked:dynamical-system",
      "kind": "StubLink"
    },
    {
      "raw": "[[Epidemiology Modelling]]",
      "resolved": "urn:visionflow:linked:epidemiology-modelling",
      "kind": "StubLink"
    },
    {
      "raw": "[[Filtration]]",
      "resolved": "urn:visionflow:linked:filtration",
      "kind": "StubLink"
    },
    {
      "raw": "[[Financial Derivatives Pricing]]",
      "resolved": "urn:visionflow:linked:financial-derivatives-pricing",
      "kind": "StubLink"
    },
    {
      "raw": "[[FinancialMathematicsDomain]]",
      "resolved": "urn:visionflow:linked:financial-mathematics-domain",
      "kind": "StubLink"
    },
    {
      "raw": "[[Fokker-Planck Equation]]",
      "resolved": "urn:visionflow:linked:fokker-planck-equation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Frequentist Statistics]]",
      "resolved": "urn:visionflow:linked:frequentist-statistics",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Gardner et al 2018 GPyTorch]]",
      "resolved": "urn:visionflow:linked:gardner-et-al-2018-gpy-torch",
      "kind": "StubLink"
    },
    {
      "raw": "[[Gatheral et al 2018 Volatility is Rough]]",
      "resolved": "urn:visionflow:linked:gatheral-et-al-2018-volatility-is-rough",
      "kind": "StubLink"
    },
    {
      "raw": "[[Gaussian Process]]",
      "resolved": "urn:visionflow:linked:gaussian-process",
      "kind": "StubLink"
    },
    {
      "raw": "[[Gaussian Process Regression]]",
      "resolved": "urn:visionflow:linked:gaussian-process-regression",
      "kind": "StubLink"
    },
    {
      "raw": "[[Geman & Geman 1984 Gibbs Sampler]]",
      "resolved": "urn:visionflow:linked:geman-and-geman-1984-gibbs-sampler",
      "kind": "StubLink"
    },
    {
      "raw": "[[Hensman et al 2013 GP Big Data]]",
      "resolved": "urn:visionflow:linked:hensman-et-al-2013-gp-big-data",
      "kind": "StubLink"
    },
    {
      "raw": "[[Heston 1993 Stochastic Volatility]]",
      "resolved": "urn:visionflow:linked:heston-1993-stochastic-volatility",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Hoffman & Gelman 2014 NUTS]]",
      "resolved": "urn:visionflow:linked:hoffman-and-gelman-2014-nuts",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Itô 1944 Stochastic Integral]]",
      "resolved": "urn:visionflow:linked:it-1944-stochastic-integral",
      "kind": "StubLink"
    },
    {
      "raw": "[[Itô Calculus]]",
      "resolved": "urn:visionflow:linked:it-calculus",
      "kind": "StubLink"
    },
    {
      "raw": "[[Itô Integral]]",
      "resolved": "urn:visionflow:linked:it-integral",
      "kind": "StubLink"
    },
    {
      "raw": "[[Itô Lemma]]",
      "resolved": "urn:visionflow:linked:it-lemma",
      "kind": "StubLink"
    },
    {
      "raw": "[[Journal of the Royal Statistical Society]]",
      "resolved": "urn:visionflow:linked:journal-of-the-royal-statistical-society",
      "kind": "StubLink"
    },
    {
      "raw": "[[Karatzas & Shreve 1991 Brownian Motion and Stochastic Calculus]]",
      "resolved": "urn:visionflow:linked:karatzas-and-shreve-1991-brownian-motion-and-stochastic-calculus",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Kernel Methods]]",
      "resolved": "urn:visionflow:linked:kernel-methods",
      "kind": "StubLink"
    },
    {
      "raw": "[[Kolmogorov 1933 Grundbegriffe]]",
      "resolved": "urn:visionflow:linked:kolmogorov-1933-grundbegriffe",
      "kind": "StubLink"
    },
    {
      "raw": "[[Kolmogorov Backward Equation]]",
      "resolved": "urn:visionflow:linked:kolmogorov-backward-equation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Øksendal 2003 Stochastic Differential Equations]]",
      "resolved": "urn:visionflow:linked:ksendal-2003-stochastic-differential-equations",
      "kind": "StubLink"
    },
    {
      "raw": "[[Lévy Process]]",
      "resolved": "urn:visionflow:linked:l-vy-process",
      "kind": "StubLink"
    },
    {
      "raw": "[[Linear Algebra]]",
    ...
    {
      "raw": "[[Markov Property]]",
      "resolved": "urn:visionflow:linked:markov-property",
      "kind": "StubLink"
    },
    {
      "raw": "[[Martingale]]",
      "resolved": "urn:visionflow:linked:martingale",
      "kind": "StubLink"
    },
    {
      "raw": "[[Mathematical Statistics]]",
      "resolved": "urn:visionflow:linked:mathematical-statistics",
      "kind": "StubLink"
    },
    {
      "raw": "[[MCMC Sampling]]",
      "resolved": "urn:visionflow:linked:mcmc-sampling",
      "kind": "StubLink"
    },
    {
      "raw": "[[Measure Theory]]",
    ...
    {
      "raw": "[[Merton 1976 Jump-Diffusion]]",
      "resolved": "urn:visionflow:linked:merton-1976-jump-diffusion",
      "kind": "StubLink"
    },
    {
      "raw": "[[Metropolis et al 1953 Equation of State]]",
      "resolved": "urn:visionflow:linked:metropolis-et-al-1953-equation-of-state",
      "kind": "StubLink"
    },
    {
      "raw": "[[Meyn & Tweedie 2009 Markov Chains and Stochastic Stability]]",
      "resolved": "urn:visionflow:linked:meyn-and-tweedie-2009-markov-chains-and-stochastic-stability",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Neural SDE]]",
      "resolved": "urn:visionflow:linked:neural-sde",
      "kind": "StubLink"
    },
    {
      "raw": "[[Norris 1997 Markov Chains]]",
      "resolved": "urn:visionflow:linked:norris-1997-markov-chains",
      "kind": "StubLink"
    },
    {
      "raw": "[[Ordinary Differential Equation]]",
      "resolved": "urn:visionflow:linked:ordinary-differential-equation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Ornstein-Uhlenbeck Process]]",
      "resolved": "urn:visionflow:linked:ornstein-uhlenbeck-process",
      "kind": "StubLink"
    },
    {
      "raw": "[[Poisson Process]]",
      "resolved": "urn:visionflow:linked:poisson-process",
      "kind": "StubLink"
    },
    {
      "raw": "[[Probability Space]]",
      "resolved": "urn:visionflow:linked:probability-space",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Probability Theory and Related Fields]]",
      "resolved": "urn:visionflow:linked:probability-theory-and-related-fields",
      "kind": "StubLink"
    },
    {
      "raw": "[[Protter 2005 Stochastic Integration and Differential Equations]]",
      "resolved": "urn:visionflow:linked:protter-2005-stochastic-integration-and-differential-equations",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Rasmussen & Williams 2006 Gaussian Processes for Machine Learning]]",
      "resolved": "urn:visionflow:linked:rasmussen-and-williams-2006-gaussian-processes-for-machine-learning",
      "kind": "StubLink"
    },
    {
      "raw": "[[Real Analysis]]",
    ...
    {
      "raw": "[[Revuz & Yor 1999 Continuous Martingales and Brownian Motion]]",
      "resolved": "urn:visionflow:linked:revuz-and-yor-1999-continuous-martingales-and-brownian-motion",
      "kind": "StubLink"
    },
    {
      "raw": "[[Robotics State Estimation]]",
      "resolved": "urn:visionflow:linked:robotics-state-estimation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Rogers & Williams 2000 Diffusions Markov Processes Martingales]]",
      "resolved": "urn:visionflow:linked:rogers-and-williams-2000-diffusions-markov-processes-martingales",
      "kind": "StubLink"
    },
    {
      "raw": "[[Sample Path]]",
      "resolved": "urn:visionflow:linked:sample-path",
      "kind": "StubLink"
    },
    {
      "raw": "[[Score Matching]]",
    ...
    {
      "raw": "[[Song et al 2020 DDIM]]",
      "resolved": "urn:visionflow:linked:song-et-al-2020-ddim",
      "kind": "StubLink"
    },
    {
      "raw": "[[Song et al 2021 Score-Based Generative Modeling SDE]]",
      "resolved": "urn:visionflow:linked:song-et-al-2021-score-based-generative-modeling-sde",
      "kind": "StubLink"
    },
    {
      "raw": "[[Statistical Physics]]",
      "resolved": "urn:visionflow:linked:statistical-physics",
      "kind": "StubLink"
    },
    {
      "raw": "[[StatisticsAndProbabilityDomain]]",
      "resolved": "urn:visionflow:linked:statistics-and-probability-domain",
      "kind": "StubLink"
    },
    {
      "raw": "[[Stochastic Differential Equation]]",
      "resolved": "urn:visionflow:linked:stochastic-differential-equation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Stochastic Integration]]",
      "resolved": "urn:visionflow:linked:stochastic-integration",
      "kind": "StubLink"
    },
    {
      "raw": "[[Stochastic Processes and their Applications]]",
      "resolved": "urn:visionflow:linked:stochastic-processes-and-their-applications",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Titsias 2009 Variational Sparse GP]]",
      "resolved": "urn:visionflow:linked:titsias-2009-variational-sparse-gp",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Welling & Teh 2011 SGLD]]",
      "resolved": "urn:visionflow:linked:welling-and-teh-2011-sgld",
      "kind": "StubLink"
    },
    {
      "raw": "[[Wiener Process]]",
      "resolved": "urn:visionflow:linked:wiener-process",
      "kind": "StubLink"
    },
    {
...
- ### Definition
  - A stochastic process is a mathematically rigorous framework for describing the probabilistic evolution of a system over time (or another index set), defined formally as a collection of random variables {X_t : t ∈ T} all defined on a common probability space (Ω, ℱ, ℙ) and indexed by a parameter set T (commonly T = ℝ₊ for continuous time or T = ℕ for discrete time), where each X_t : Ω → S maps from the sample space Ω to the state space S (which may be discrete, continuous, finite, countable, or a function space), with the full collection encoding the joint probabilistic law of all time-marginals and their dependencies. The foundational taxonomy partitions processes by state space and time index: **discrete-time discrete-state** Markov chains governed by transition matrices P = [p_{ij}] where p_{ij} = ℙ(X_{n+1} = j | X_n = i) satisfying the Markov property ℙ(X_{n+1} = j | X_0,...,X_n) = ℙ(X_{n+1} = j | X_n); **continuous-time discrete-state** processes including the Poisson process N(t) ∼ Poisson(λt) with independent increments and rate parameter λ > 0, and continuous-time Markov chains with infinitesimal generator matrix Q = [q_{ij}] where q_{ij} ≥ 0 (i≠j) and ∑_j q_{ij} = 0; **continuous-time continuous-state** processes including Brownian motion/Wiener process W_t with W_0 = 0, independent increments W_t − W_s ∼ N(0, t−s) for 0 ≤ s < t, and almost-sure continuous sample paths; stochastic differential equations (SDEs) dX_t = μ(X_t, t)dt + σ(X_t, t)dW_t driven by Itô calculus with the non-anticipating integral ∫₀ᵀ f(t)dW_t defined as the L² limit of Riemann-Itô sums and obeying the Itô correction formula df(X_t) = (∂_t f + μ ∂_x f + ½σ² ∂_{xx} f)dt + σ ∂_x f dW_t (Itô's Lemma); **Gaussian processes** GP(μ(·), k(·,·)) characterised entirely by a mean function μ: 𝒳 → ℝ and positive-definite covariance kernel k: 𝒳 × 𝒳 → ℝ, such that every finite collection (X_{x₁},...,X_{xₙ}) is multivariate Gaussian, enabling nonparametric Bayesian inference via posterior updates GP posterior μ_n(x) = k(x,X)[K + σ²I]⁻¹y and k_n(x,x') = k(x,x') − k(x,X)[K+σ²I]⁻¹k(X,x') with O(n³) training complexity (Rasmussen and Williams 2006); **Lévy processes** L_t generalising Brownian motion to allow jumps via the Lévy-Khintchine representation 𝔼[e^{iuL_t}] = exp(t[ibu − ½σ²u² + ∫(e^{iux} − 1 − iux𝟏_{|x|<1}) ν(dx)]) characterised by the Lévy triplet (b, σ², ν) where ν is the Lévy measure satisfying ∫ min(1,x²) ν(dx) < ∞; **Ornstein-Uhlenbeck** mean-reverting process dX_t = θ(μ − X_t)dt + σ dW_t with stationary distribution N(μ, σ²/2θ) serving as the continuous analogue of AR(1); **jump-diffusion processes** combining continuous diffusion with compound Poisson jumps dX_t = μ X_t dt + σ X_t dW_t + X_{t⁻} dJ_t in the Merton (1976) model for option pricing; **branching processes** Z_n = ∑_{i=1}^{Z_{n-1}} ξᵢ with offspring distribution {p_k} and extinction probability given as the smallest fixed point of the generating function G(s) = ∑_k p_k sᵏ; **martingales** M_t satisfying 𝔼[M_t | ℱ_s] = M_s for s ≤ t forming the probabilistic backbone of fair games and fundamental to stochastic calculus (Doob's optional stopping theorem, Doob's L² martingale convergence); **point processes** and **spatial processes** extending the index set to higher dimensions; and modern **neural SDEs** (Chen et al. 2018, Kidger et al. 2021) compositing stochastic differential equations with neural network drift and diffusion coefficients for irregular time-series modelling, with the entire theoretical edifice underpinning diffusion model generative AI (Song et al. 2021 casting denoising score matching as the reverse-time SDE dX_t = [f(X_t,t) − g(t)² ∇_{X_t} log p_t(X_t)] dt + g(t) dW̄_t), Bayesian optimisation through Gaussian process surrogates, financial derivatives pricing via Black-Scholes-Merton PDE derivation (V_t + rS V_S + ½σ²S² V_{SS} − rV = 0 from geometric Brownian motion dS_t = μ S_t dt + σ S_t dW_t and Itô's Lemma), and MCMC theory through Markov chain convergence analysis with geometric ergodicity and spectral gap bounding mixing times.

- ### Semantic Classification
  - owl-class:: artificial-intelligence:StochasticProcess
  - owl-role:: MathematicalFoundation
  - owl-inferred:: ai:ProbabilisticModel, ai:RandomSystem, ai:TimeSeriesModel, ai:BayesianFramework, ai:StochasticCalculus
  - belongs-to-domain:: [[AI-GroundedDomain]], [[MachineLearningDomain]], [[StatisticsAndProbabilityDomain]], [[FinancialMathematicsDomain]]
  - implemented-in-layer:: [[AlgorithmLayer]], [[TheoreticalFoundationLayer]], [[ModelArchitectureLayer]]

- ### Relationships
  - is-subclass-of:: [[Probability Theory]], [[Mathematical Statistics]], [[Time Series Analysis]], [[Dynamical System]], [[Measure Theory]]
  - has-part:: [[Markov Chain]], [[Wiener Process]], [[Gaussian Process]], [[Poisson Process]], [[Lévy Process]], [[Ornstein-Uhlenbeck Process]], [[Martingale]], [[Stochastic Differential Equation]], [[Sample Path]], [[Filtration]]
  - requires:: [[Probability Space]], [[Measure Theory]], [[Sigma Algebra]], [[Filtration]], [[Itô Calculus]], [[Stochastic Integration]]
  - enables:: [[Diffusion Models]], [[Bayesian Optimisation]], [[MCMC Sampling]], [[Financial Derivatives Pricing]], [[Uncertainty Quantification]], [[Reinforcement Learning]], [[Gaussian Process Regression]], [[Neural SDE]]
  - implements:: [[Markov Property]], [[Chapman-Kolmogorov Equation]], [[Itô Lemma]], [[Fokker-Planck Equation]], [[Kolmogorov Backward Equation]], [[Score Matching]], [[Detailed Balance]]
  - depends-on:: [[Probability Theory]], [[Measure Theory]], [[Functional Analysis]], [[Differential Equations]], [[Linear Algebra]], [[Real Analysis]]
...
- ### Content
  ...
  ## Compositional Relationships (Components)
	  ...
	  FunctionalDataProperty(ai:hasStateSpaceDimension)
	  ```
  ...
  - ### Core Mathematical Framework
	  ...
	  **Itô's Lemma**: For a twice continuously differentiable function f(t, x) and an Itô process dX_t = μ_t dt + σ_t dW_t, the Itô formula gives:
	  df(t, X_t) = (∂_t f + μ_t ∂_x f + ½ σ_t² ∂_{xx} f) dt + σ_t ∂_x f dW_t
	  ...
	  **Fokker-Planck Equation**: For the SDE dX_t = μ(X_t, t) dt + σ(X_t, t) dW_t, the probability density p(x, t) of X_t satisfies the **Fokker-Planck (forward Kolmogorov) equation**:
	  ∂_t p = −∂_x [μ p] + ½ ∂_{xx} [σ² p]
  ...
  - ### Process Families: Taxonomy and Properties
	  ...
	  **Standard Brownian Motion (Wiener Process)** W_t is the canonical continuous-time process characterised by:
	  ...
	  Wiener (1923) proved such a process exists by constructing Wiener measure on C([0,∞)). Key properties: W_t is a martingale; W_t² − t is a martingale (quadratic variation [W]_t = t); W_t is nowhere differentiable a.s. (Hölder-continuous with exponent < ½ but not ½); the Lévy characterisation states any continuous local martingale with [M]_t = t is a Brownian motion. The **reflection principle** ℙ(max_{s≤t} W_s ≥ a) = 2ℙ(W_t ≥ a) enables analytic barrier-crossing probabilities. **d-dimensional Brownian motion** W_t = (W_t^{(1)},...,W_t^{(d)}) with independent components is the scaling limit of d-dimensional simple random walk and the driving noise for multivariate SDEs. **Geometric Brownian motion** (GBM) S_t = S_0 exp((μ−½σ²)t + σW_t) is the Black-Scholes stock price model — positive, log-Normally distributed, and obtained by applying Itô's Lemma to solve the linear SDE dS_t = μ S_t dt + σ S_t dW_t.
	  ...
	  **Jump-diffusion processes** combine continuous Brownian diffusion with Poisson-driven discrete jumps. The **Merton (1976) model** for asset prices:
	  dS_t = (μ − λk̄) S_t dt + σ S_t dW_t + S_{t⁻} dJ_t
	  ...
	  **Galton-Watson branching processes** Z_n model population size across discrete generations:
	  Z_{n+1} = ∑_{i=1}^{Z_n} ξ_i^{(n)}
  ...
  - ### Diffusion Models as SDEs: Song et al. (2021)
	  ...
	  **Forward SDE (Noising)**: The data distribution p_0(x) is gradually perturbed to a tractable prior p_T(x) ≈ N(0, I) via:
	  ...
	  **Reverse SDE (Denoising/Generation)**: Anderson's (1982) time-reversal theorem yields:
	  dX_t = [f(X_t,t) − g(t)² ∇_{X_t} log p_t(X_t)] dt + g(t) dW̄_t
  ...
  - ### Financial Mathematics: Black-Scholes and Beyond
	  ...
	  **Black-Scholes-Merton model** (1973) assumes the underlying asset follows GBM dS_t = μ S_t dt + σ S_t dW_t under the physical measure ℙ. Under the **risk-neutral (martingale) measure** ℚ (constructed via Girsanov's theorem changing drift from μ to r: W̃_t = W_t + (μ−r)/σ t is ℚ-Brownian), dS_t = r S_t dt + σ S_t dW̃_t and the no-arbitrage price of a European call is:
	  C(S, K, r, T, σ) = S Φ(d₁) − K e^{−rT} Φ(d₂)
	  d₁ = [log(S/K) + (r + ½σ²)T] / (σ√T), d₂ = d₁ − σ√T
	  where Φ is the standard normal CDF. This is derived by applying the Feynman-Kac formula to the BS PDE or directly computing the risk-neutral expectation e^{−rT}𝔼^ℚ[max(S_T − K, 0)].
  ...
  - ### Aggregate Impact and Market Statistics (2026)
	  ...
	  **Generative AI (SDE/diffusion models)**:
	  - Text-to-image: $12B market (2025), $52B projected 2030 (Midjourney, Stability AI, Adobe Firefly, DALL-E 3, Flux.1)
	  - Text-to-video: $3B market (2025), $25B projected 2030 (Sora, Runway, Kling, Pika)
	  - Protein/molecular: $4B market (2025), $22B projected 2030 (AlphaFold 3, Chroma, RFDiffusion)
  ...
  - ### Numerical Methods for SDEs
	  ...
	  The simplest discretisation of dX_t = μ(X_t, t) dt + σ(X_t, t) dW_t:
	  X_{k+1} = X_k + μ(X_k, t_k) h + σ(X_k, t_k) ΔW_k
	  where ΔW_k = W_{t_{k+1}} − W_{t_k} ∼ N(0, h) are i.i.d. Gaussian increments. **Strong order of convergence** ½ (pathwise): 𝔼[|X(T) − X_N|] = O(h^{1/2}). **Weak order** 1 (in distribution): |𝔼[f(X(T))] − 𝔼[f(X_N)]| = O(h) for smooth f. The Euler-Maruyama scheme is the SDE analogue of the Euler method for ODEs, implementable in 3 lines of NumPy/JAX. Used in all production diffusion model samplers (DDPM = EM applied to the reverse SDE with learned score).

	  #### Milstein Method

	  Adds a correction for the stochastic integral's second-order term via the Itô-Taylor expansion:
	  X_{k+1} = X_k + μ h + σ ΔW_k + ½ σ σ_x [(ΔW_k)² − h]
	  where σ_x = ∂σ/∂x. **Strong order 1** — a factor √h improvement over Euler-Maruyama for scalar SDEs. For multi-dimensional SDEs, Milstein requires **Lévy area** terms (double stochastic integrals ∫∫ dW_i dW_j for i≠j) that are expensive to simulate; the **commutative noise condition** ∑_j σ^i_j ∂_j σ^k_l = ∑_j σ^k_j ∂_j σ^i_l eliminates the need for Lévy areas and recovers strong order 1 without extra cost.
  ...
  - ### Research and Literature
	  ...
	  **Classical Stochastic Calculus Texts**:
	  1. Karatzas, I., & Shreve, S.E. (1988/1991). *Brownian Motion and Stochastic Calculus* (2nd ed.). Springer. [Graduate bible of Itô calculus, SDEs, martingales; 20,000+ citations]
	  2. Øksendal, B. (1985; 6th ed. 2003). *Stochastic Differential Equations: An Introduction with Applications*. Springer. [Most widely used SDE graduate text; 25,000+ citations]
	  3. Rogers, L.C.G., & Williams, D. (1994/2000). *Diffusions, Markov Processes, and Martingales* (Vols I-II, 2nd ed.). Cambridge University Press. [General Markov process theory and semimartingales]
	  4. Revuz, D., & Yor, M. (1991/1999). *Continuous Martingales and Brownian Motion* (3rd ed.). Springer. [Definitive French school treatment; Girsanov, local times, Bessel processes]
	  5. Protter, P.E. (1990/2005). *Stochastic Integration and Differential Equations* (2nd ed.). Springer. [Semimartingale calculus beyond Brownian motion]

	  **Probability and Markov Chains**:
	  6. Kolmogorov, A.N. (1933). *Grundbegriffe der Wahrscheinlichkeitsrechnung*. Springer. [Axiomatic measure-theoretic probability]
	  7. Norris, J.R. (1997). *Markov Chains*. Cambridge University Press. [Accessible rigorous discrete-time treatment]
	  8. Meyn, S.P., & Tweedie, R.L. (1993/2009). *Markov Chains and Stochastic Stability* (2nd ed.). Cambridge University Press. [Geometric ergodicity, Foster-Lyapunov criteria, mixing times]
	  9. Doob, J.L. (1953). *Stochastic Processes*. Wiley. [Martingale theory foundations]
	  10. Itô, K. (1944). Stochastic integral. *Proceedings of the Imperial Academy* 20(8), 519-524. [Defining the Itô integral; foundational paper]

	  **Gaussian Processes**:
	  11. Rasmussen, C.E., & Williams, C.K.I. (2006). *Gaussian Processes for Machine Learning*. MIT Press. [Canonical ML reference; freely available online; 28,000+ citations]
	  12. Titsias, M. (2009). Variational Learning of Inducing Variables in Sparse Gaussian Processes. *Proceedings of the 12th International Conference on Artificial Intelligence and Statistics (AISTATS 2009)*, 567-574. [VFE sparse GP approximation]
	  13. Hensman, J., Fusi, N., & Lawrence, N.D. (2013). Gaussian Processes for Big Data. *Uncertainty in Artificial Intelligence (UAI 2013)*. [Stochastic variational inference for GPs]
	  14. Gardner, J., Pleiss, G., Weinberger, K.Q., Bindel, D., & Wilson, A.G. (2018). GPyTorch: Blackbox Matrix-Matrix Gaussian Process Inference with GPU Acceleration. *Advances in Neural Information Processing Systems 31 (NeurIPS 2018)*. [Production GP library]

	  **Diffusion Models and Score-Based Generation**:
	  15. Song, Y., Sohl-Dickstein, J., Kingma, D.P., Kumar, A., Ermon, S., & Poole, B. (2021). Score-Based Generative Modeling through Stochastic Differential Equations. *International Conference on Learning Representations (ICLR 2021 — Outstanding Paper)*. arXiv:2011.13456 [Unified SDE framework for diffusion models; 8,000+ citations]
	  16. Ho, J., Jain, A., & Abbeel, P. (2020). Denoising Diffusion Probabilistic Models. *Advances in Neural Information Processing Systems 33 (NeurIPS 2020)*. arXiv:2006.11239 [DDPM; 15,000+ citations]
	  17. Song, J., Meng, C., & Ermon, S. (2020). Denoising Diffusion Implicit Models. *International Conference on Learning Representations (ICLR 2021)*. arXiv:2010.02502 [DDIM deterministic sampler]
	  18. Karras, T., Aittala, M., Aila, T., & Laine, S. (2022). Elucidating the Design Space of Diffusion-Based Generative Models. *Advances in Neural Information Processing Systems 35 (NeurIPS 2022)*. arXiv:2206.00364 [EDM unified analysis]
	  19. Lipman, Y., Chen, R.T.Q., Ben-Hamu, H., Nickel, M., & Le, M. (2022). Flow Matching for Generative Modeling. *International Conference on Learning Representations (ICLR 2023)*. arXiv:2210.02747 [Flow matching; optimal transport paths]

	  **MCMC and Sampling Theory**:
	  20. Metropolis, N., Rosenbluth, A.W., Rosenbluth, M.N., Teller, A.H., & Teller, E. (1953). Equation of State Calculations by Fast Computing Machines. *The Journal of Chemical Physics* 21(6), 1087-1092. [Original Metropolis algorithm]
	  21. Geman, S., & Geman, D. (1984). Stochastic Relaxation, Gibbs Distributions, and the Bayesian Restoration of Images. *IEEE Transactions on Pattern Analysis and Machine Intelligence* 6(6), 721-741. [Gibbs sampler]
	  22. Hoffman, M.D., & Gelman, A. (2014). The No-U-Turn Sampler: Adaptively Setting Path Lengths in Hamiltonian Monte Carlo. *Journal of Machine Learning Research* 15(47), 1593-1623. [NUTS; Stan basis]
	  23. Welling, M., & Teh, Y.W. (2011). Bayesian Learning via Stochastic Gradient Langevin Dynamics. *Proceedings of the 28th International Conference on Machine Learning (ICML 2011)*, 681-688. [SGLD; Bayesian DL basis]
	  24. Dalalyan, A.S. (2017). Theoretical Guarantees for Approximate Sampling from Smooth and Log-Concave Densities. *Journal of the Royal Statistical Society: Series B* 79(3), 651-676. [ULA convergence bounds]

	  **Financial Mathematics**:
	  25. Black, F., & Scholes, M. (1973). The Pricing of Options and Corporate Liabilities. *Journal of Political Economy* 81(3), 637-654. [Black-Scholes formula; Nobel basis]
	  26. Merton, R.C. (1976). Option Pricing When Underlying Stock Returns Are Discontinuous. *Journal of Financial Economics* 3(1-2), 125-144. [Jump-diffusion option pricing]
	  27. Heston, S.L. (1993). A Closed-Form Solution for Options with Stochastic Volatility with Applications to Bond and Currency Options. *Review of Financial Studies* 6(2), 327-343. [Stochastic volatility model; 15,000+ citations]
	  28. Gatheral, J., Jaisson, T., & Rosenbaum, M. (2018). Volatility is Rough. *Quantitative Finance* 18(6), 933-949. [Empirical evidence for H ≈ 0.1; rough volatility]
	  ...
	  - **Domain Correction**: None — original frontmatter `artificial-intelligence` domain retained; stochastic processes canonically spans AI/statistics/finance but artificial-intelligence is the correct classification given primary applications in ML theory, diffusion models, MCMC, and Bayesian inference; IRI/URI unchanged
...
- ### Provenance
  - sources:: [[Karatzas & Shreve 1991 Brownian Motion and Stochastic Calculus]], [[Øksendal 2003 Stochastic Differential Equations]], [[Rogers & Williams 2000 Diffusions Markov Processes Martingales]], [[Revuz & Yor 1999 Continuous Martingales and Brownian Motion]], [[Protter 2005 Stochastic Integration and Differential Equations]], [[Kolmogorov 1933 Grundbegriffe]], [[Norris 1997 Markov Chains]], [[Meyn & Tweedie 2009 Markov Chains and Stochastic Stability]], [[Doob 1953 Stochastic Processes]], [[Itô 1944 Stochastic Integral]], [[Rasmussen & Williams 2006 Gaussian Processes for Machine Learning]], [[Titsias 2009 Variational Sparse GP]], [[Hensman et al 2013 GP Big Data]], [[Gardner et al 2018 GPyTorch]], [[Song et al 2021 Score-Based Generative Modeling SDE]], [[Ho et al 2020 DDPM]], [[Song et al 2020 DDIM]], [[Karras et al 2022 EDM]], [[Lipman et al 2022 Flow Matching]], [[Metropolis et al 1953 Equation of State]], [[Geman & Geman 1984 Gibbs Sampler]], [[Hoffman & Gelman 2014 NUTS]], [[Welling & Teh 2011 SGLD]], [[Dalalyan 2017 ULA Guarantees]], [[Black & Scholes 1973 Option Pricing]], [[Merton 1976 Jump-Diffusion]], [[Heston 1993 Stochastic Volatility]], [[Gatheral et al 2018 Volatility is Rough]]
  - research-cache:: _enrich/research-cache/Stochastic Process.json
