schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#WearableDeviceIntegration
legacy_uri:: urn:visionclaw:concept:spatial-computing:wearable-device-integration
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-421c5c0806c0"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#WearableDeviceIntegration"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:wearable-device-integration"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
