schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#Minting
legacy_uri:: urn:visionclaw:concept:blockchain:minting
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-9df90dc00564"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#Minting"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:minting"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:71c84e50b6ac7c90d1f23797048c389ff0b8b70700c68719a42e89cdfcf38742@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:minting",
  "@type": "OntologyClass",
  "label": "Minting",
  "subClassOf": [
    {
