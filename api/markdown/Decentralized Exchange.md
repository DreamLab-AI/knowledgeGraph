schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#DecentralizedExchange
legacy_uri:: urn:visionclaw:concept:blockchain:decentralized-exchange
public:: true
...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "decentralized-exchange",
  "title": "Decentralized Exchange",
  "vc:public": true,
  "vc:outboundWikilinks": [
    {
      "@id": "urn:visionflow:linked:0x-protocol",
      "vc:label": "0x Protocol"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:1inch-fusion",
      "vc:label": "1inch Fusion"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:adams-2018-uniswap-v1",
      "vc:label": "Adams 2018 Uniswap V1"
    },
    {
      "@id": "urn:visionflow:linked:adams-zinsmeister-robinson-2020-uniswap-v2-whitepaper",
      "vc:label": "Adams Zinsmeister Robinson 2020 Uniswap V2 Whitepaper"
    },
    {
      "@id": "urn:visionflow:linked:adams-zinsmeister-salem-keefer-robinson-2021-uniswap-v3-core",
      "vc:label": "Adams Zinsmeister Salem Keefer Robinson 2021 Uniswap V3 Core"
    },
    {
      "@id": "urn:visionflow:linked:aevo",
      "vc:label": "Aevo"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:angeris-chitra-2020-improved-price-oracles-cfmm",
      "vc:label": "Angeris Chitra 2020 Improved Price Oracles CFMM"
    },
    {
      "@id": "urn:visionflow:linked:angeris-kao-chiang-noyes-chitra-2019-analysis-of-uniswap-markets",
      "vc:label": "Angeris Kao Chiang Noyes Chitra 2019 Analysis of Uniswap Markets"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:balancer-protocol",
      "vc:label": "Balancer Protocol"
    },
    {
      "@id": "urn:visionflow:linked:bancor-network",
      "vc:label": "Bancor Network"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:bis-aramonte-doerr-huang-schrimpf-2022-de-fi-decentralisation-illusion",
      "vc:label": "BIS Aramonte Doerr Huang Schrimpf 2022 DeFi Decentralisation Illusion"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:buterin-2017-on-chain-market-makers-reddit-post",
      "vc:label": "Buterin 2017 On-chain Market Makers Reddit Post"
    },
    {
      "@id": "urn:visionflow:linked:capponi-jia-yu-2023-evolution-blockchain-lit-to-dark",
      "vc:label": "Capponi Jia Yu 2023 Evolution Blockchain Lit to Dark"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:cftc-order-24-23-uniswap-labs-may-2024",
      "vc:label": "CFTC Order 24-23 Uniswap Labs May 2024"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:cow-swap-co-w-protocol-documentation",
      "vc:label": "CowSwap CoW Protocol Documentation"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:d-yd-x-v4-cosmos-appchain-migration-whitepaper",
      "vc:label": "dYdX V4 Cosmos Appchain Migration Whitepaper"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:drift-protocol",
      "vc:label": "Drift Protocol"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:egorov-2019-curve-stable-swap",
      "vc:label": "Egorov 2019 Curve StableSwap"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:eskandari-moosavi-clark-2019-so-k-transparent-dishonesty",
      "vc:label": "Eskandari Moosavi Clark 2019 SoK Transparent Dishonesty"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:fca-dp24-4-regulating-cryptoassets-2024",
      "vc:label": "FCA DP24-4 Regulating Cryptoassets 2024"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:financial-protocol-domain",
      "vc:label": "FinancialProtocolDomain"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:gmx-v2-documentation",
      "vc:label": "GMX V2 Documentation"
    },
    {
      "@id": "urn:visionflow:linked:heimbach-schertenleib-wattenhofer-2022-uniswap-v3-lp-risks",
      "vc:label": "Heimbach Schertenleib Wattenhofer 2022 Uniswap V3 LP Risks"
    },
    {
      "@id": "urn:visionflow:linked:hertzog-benartzi-2017-bancor-protocol",
      "vc:label": "Hertzog Benartzi 2017 Bancor Protocol"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:hype-token",
      "vc:label": "HYPE Token"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:hyperliquid-hyper-bft-documentation",
      "vc:label": "Hyperliquid HyperBFT Documentation"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:kyber-swap",
      "vc:label": "KyberSwap"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:lighter-network",
      "vc:label": "Lighter Network"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:martinelli-mc-donald-2019-balancer-whitepaper",
      "vc:label": "Martinelli McDonald 2019 Balancer Whitepaper"
    },
    {
      "@id": "urn:visionflow:linked:matcha",
      "vc:label": "Matcha"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:maya-protocol",
      "vc:label": "Maya Protocol"
    },
    {
      "@id": "urn:visionflow:linked:meteora",
      "vc:label": "Meteora"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:milionis-moallemi-roughgarden-zhang-2022-lvr",
      "vc:label": "Milionis Moallemi Roughgarden Zhang 2022 LVR"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:odos",
      "vc:label": "Odos"
    },
    {
      "@id": "urn:visionflow:linked:okx",
      "vc:label": "OKX"
    },
    {
      "@id": "urn:visionflow:linked:okx-dex",
      "vc:label": "OKX DEX"
    },
    {
      "@id": "urn:visionflow:linked:open-book",
      "vc:label": "OpenBook"
    },
    {
      "@id": "urn:visionflow:linked:open-ocean",
      "vc:label": "OpenOcean"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:para-swap",
      "vc:label": "ParaSwap"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:qin-zhou-gervais-2022-quantifying-bev",
      "vc:label": "Qin Zhou Gervais 2022 Quantifying BEV"
    },
    {
      "@id": "urn:visionflow:linked:raydium",
      "vc:label": "Raydium"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:symbiosis-finance",
      "vc:label": "Symbiosis Finance"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:uniswap-labs-2025-v4-pool-manager-architecture",
      "vc:label": "Uniswap Labs 2025 V4 PoolManager Architecture"
    },
    {
      "@id": "urn:visionflow:linked:uniswap-v2",
      "vc:label": "Uniswap V2"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:uniswap-v3",
      "vc:label": "Uniswap V3"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:uniswap-x",
      "vc:label": "UniswapX"
    },
    {
      "@id": "urn:visionflow:linked:uniswap-x-whitepaper-2023",
      "vc:label": "UniswapX Whitepaper 2023"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:zhou-xiong-bonneau-gervais-2023-so-k-de-fi-attacks",
      "vc:label": "Zhou Xiong Bonneau Gervais 2023 SoK DeFi Attacks"
    },
    {
  ...
  "vc:legacyProperties": [
    {
      ...
      "vc:value": "DEX, Decentralised Exchange, On-Chain Exchange, Non-Custodial Exchange, Automated Market Maker Exchange, AMM DEX, Order-Book DEX"
    },
    {
    ...
    {
      "vc:key": "bridges-to",
      "vc:value": "[[Centralized Exchange]], [[Financial Markets]], [[Decentralised Finance]]"
    },
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-21-7b3d9a4f1c2e"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#DecentralizedExchange"
    },
    {
    ...
    {
      "vc:key": "modified",
      "vc:value": "2026-05-16T13:45:00Z"
    },
    {
      "vc:key": "preferred-term",
      "vc:value": "Decentralized Exchange"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:decentralized-exchange"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:decentralized-exchange:776c802a9fc9",
  ...
  "vc:resolutions": [
    {
      "raw": "[[0x Protocol]]",
      "resolved": "urn:visionflow:linked:0x-protocol",
      "kind": "StubLink"
    },
    {
      "raw": "[[1inch]]",
    ...
    {
      "raw": "[[1inch Fusion]]",
      "resolved": "urn:visionflow:linked:1inch-fusion",
      "kind": "StubLink"
    },
    {
      "raw": "[[Aave]]",
    ...
    {
      "raw": "[[Adams 2018 Uniswap V1]]",
      "resolved": "urn:visionflow:linked:adams-2018-uniswap-v1",
      "kind": "StubLink"
    },
    {
      "raw": "[[Adams Zinsmeister Robinson 2020 Uniswap V2 Whitepaper]]",
      "resolved": "urn:visionflow:linked:adams-zinsmeister-robinson-2020-uniswap-v2-whitepaper",
      "kind": "StubLink"
    },
    {
      "raw": "[[Adams Zinsmeister Salem Keefer Robinson 2021 Uniswap V3 Core]]",
      "resolved": "urn:visionflow:linked:adams-zinsmeister-salem-keefer-robinson-2021-uniswap-v3-core",
      "kind": "StubLink"
    },
    {
      "raw": "[[Aevo]]",
      "resolved": "urn:visionflow:linked:aevo",
      "kind": "StubLink"
    },
    {
      "raw": "[[Aggregator]]",
      "resolved": "urn:visionflow:linked:aggregator",
      "kind": "StubLink"
    },
    {
      "raw": "[[Angeris Chitra 2020 Improved Price Oracles CFMM]]",
      "resolved": "urn:visionflow:linked:angeris-chitra-2020-improved-price-oracles-cfmm",
      "kind": "StubLink"
    },
    {
      "raw": "[[Angeris Kao Chiang Noyes Chitra 2019 Analysis of Uniswap Markets]]",
      "resolved": "urn:visionflow:linked:angeris-kao-chiang-noyes-chitra-2019-analysis-of-uniswap-markets",
      "kind": "StubLink"
    },
    {
      "raw": "[[Arbitrum]]",
    ...
    {
      "raw": "[[Balancer Protocol]]",
      "resolved": "urn:visionflow:linked:balancer-protocol",
      "kind": "StubLink"
    },
    {
      "raw": "[[Bancor Network]]",
      "resolved": "urn:visionflow:linked:bancor-network",
      "kind": "StubLink"
    },
    {
      "raw": "[[Base]]",
    ...
    {
      "raw": "[[Batch Auction Matching]]",
      "resolved": "urn:visionflow:linked:batch-auction-matching",
      "kind": "StubLink"
    },
    {
      "raw": "[[Binance]]",
    ...
    {
      "raw": "[[BIS Aramonte Doerr Huang Schrimpf 2022 DeFi Decentralisation Illusion]]",
      "resolved": "urn:visionflow:linked:bis-aramonte-doerr-huang-schrimpf-2022-de-fi-decentralisation-illusion",
      "kind": "StubLink"
    },
    {
      "raw": "[[Block Producer]]",
      "resolved": "urn:visionflow:linked:block-producer",
      "kind": "StubLink"
    },
    {
      "raw": "[[Block Production]]",
      "resolved": "urn:visionflow:linked:block-production",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Buterin 2017 On-chain Market Makers Reddit Post]]",
      "resolved": "urn:visionflow:linked:buterin-2017-on-chain-market-makers-reddit-post",
      "kind": "StubLink"
    },
    {
      "raw": "[[Capponi Jia Yu 2023 Evolution Blockchain Lit to Dark]]",
      "resolved": "urn:visionflow:linked:capponi-jia-yu-2023-evolution-blockchain-lit-to-dark",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Centralized Exchange]]",
      "resolved": "urn:visionflow:linked:centralized-exchange",
      "kind": "StubLink"
    },
    {
      "raw": "[[CFTC Order 24-23 Uniswap Labs May 2024]]",
      "resolved": "urn:visionflow:linked:cftc-order-24-23-uniswap-labs-may-2024",
      "kind": "StubLink"
    },
    {
      "raw": "[[Coinbase]]",
    ...
    {
      "raw": "[[Coincidence of Wants]]",
      "resolved": "urn:visionflow:linked:coincidence-of-wants",
      "kind": "StubLink"
    },
    {
      "raw": "[[Composability]]",
      "resolved": "urn:visionflow:linked:composability",
      "kind": "StubLink"
    },
    {
      "raw": "[[Composable Finance]]",
      "resolved": "urn:visionflow:linked:composable-finance",
      "kind": "StubLink"
    },
    {
      "raw": "[[Compound]]",
    ...
    {
      "raw": "[[Concentrated Liquidity Position]]",
      "resolved": "urn:visionflow:linked:concentrated-liquidity-position",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Constant Product Invariant]]",
      "resolved": "urn:visionflow:linked:constant-product-invariant",
      "kind": "StubLink"
    },
    {
      "raw": "[[Cosmos]]",
    ...
    {
      "raw": "[[CowSwap CoW Protocol Documentation]]",
      "resolved": "urn:visionflow:linked:cow-swap-co-w-protocol-documentation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Crypto Aggregation]]",
      "resolved": "urn:visionflow:linked:crypto-aggregation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Curve Finance]]",
    ...
    {
      "raw": "[[Curve StableSwap Paper]]",
      "resolved": "urn:visionflow:linked:curve-stable-swap-paper",
      "kind": "StubLink"
    },
    {
      "raw": "[[dYdX]]",
    ...
    {
      "raw": "[[dYdX V4 Cosmos Appchain Migration Whitepaper]]",
      "resolved": "urn:visionflow:linked:d-yd-x-v4-cosmos-appchain-migration-whitepaper",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Dark Pool]]",
      "resolved": "urn:visionflow:linked:dark-pool",
      "kind": "StubLink"
    },
    {
      "raw": "[[DeFiDomain]]",
    ...
    {
      "raw": "[[Decentralised Finance Primitive]]",
      "resolved": "urn:visionflow:linked:decentralised-finance-primitive",
      "kind": "StubLink"
    },
    {
      "raw": "[[Drift Protocol]]",
      "resolved": "urn:visionflow:linked:drift-protocol",
      "kind": "StubLink"
    },
    {
      "raw": "[[Dutch Auction]]",
      "resolved": "urn:visionflow:linked:dutch-auction",
      "kind": "StubLink"
    },
    {
      "raw": "[[Egorov 2019 Curve StableSwap]]",
      "resolved": "urn:visionflow:linked:egorov-2019-curve-stable-swap",
      "kind": "StubLink"
    },
    {
      "raw": "[[EIP-1153 Transient Storage]]",
      "resolved": "urn:visionflow:linked:eip-1153-transient-storage",
      "kind": "StubLink"
    },
    {
      "raw": "[[ERC-20]]",
    ...
    {
      "raw": "[[Eskandari Moosavi Clark 2019 SoK Transparent Dishonesty]]",
      "resolved": "urn:visionflow:linked:eskandari-moosavi-clark-2019-so-k-transparent-dishonesty",
      "kind": "StubLink"
    },
    {
      "raw": "[[EVM]]",
    ...
    {
      "raw": "[[FCA DP24-4 Regulating Cryptoassets 2024]]",
      "resolved": "urn:visionflow:linked:fca-dp24-4-regulating-cryptoassets-2024",
      "kind": "StubLink"
    },
    {
      "raw": "[[Fee Tier]]",
    ...
    {
      "raw": "[[Financial Protocol]]",
      "resolved": "urn:visionflow:linked:financial-protocol",
      "kind": "StubLink"
    },
    {
      "raw": "[[FinancialProtocolDomain]]",
      "resolved": "urn:visionflow:linked:financial-protocol-domain",
      "kind": "StubLink"
    },
    {
      "raw": "[[Flash Accounting]]",
      "resolved": "urn:visionflow:linked:flash-accounting",
      "kind": "StubLink"
    },
    {
      "raw": "[[Flash Loan]]",
    ...
    {
      "raw": "[[Geometric Mean Invariant]]",
      "resolved": "urn:visionflow:linked:geometric-mean-invariant",
      "kind": "StubLink"
    },
    {
      "raw": "[[GMX]]",
    ...
    {
      "raw": "[[GMX V2 Documentation]]",
      "resolved": "urn:visionflow:linked:gmx-v2-documentation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Heimbach Schertenleib Wattenhofer 2022 Uniswap V3 LP Risks]]",
      "resolved": "urn:visionflow:linked:heimbach-schertenleib-wattenhofer-2022-uniswap-v3-lp-risks",
      "kind": "StubLink"
    },
    {
      "raw": "[[Hertzog Benartzi 2017 Bancor Protocol]]",
      "resolved": "urn:visionflow:linked:hertzog-benartzi-2017-bancor-protocol",
      "kind": "StubLink"
    },
    {
      "raw": "[[Hooks Pattern]]",
      "resolved": "urn:visionflow:linked:hooks-pattern",
      "kind": "StubLink"
    },
    {
      "raw": "[[HYPE Token]]",
      "resolved": "urn:visionflow:linked:hype-token",
      "kind": "StubLink"
    },
    {
      "raw": "[[Hyperliquid]]",
    ...
    {
      "raw": "[[Hyperliquid HyperBFT Documentation]]",
      "resolved": "urn:visionflow:linked:hyperliquid-hyper-bft-documentation",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Intent-Based Execution]]",
      "resolved": "urn:visionflow:linked:intent-based-execution",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[KyberSwap]]",
      "resolved": "urn:visionflow:linked:kyber-swap",
      "kind": "StubLink"
    },
    {
      "raw": "[[Layer-2 Rollup]]",
      "resolved": "urn:visionflow:linked:layer-2-rollup",
      "kind": "StubLink"
    },
    {
      "raw": "[[Lighter Network]]",
      "resolved": "urn:visionflow:linked:lighter-network",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Liquidity Provider|liquidity providers]]",
      "resolved": "urn:visionflow:linked:liquidity-provider",
      "kind": "StubLink"
    },
    {
      "raw": "[[Liquidity Provider Token]]",
      "resolved": "urn:visionflow:linked:liquidity-provider-token",
      "kind": "StubLink"
    },
    {
      "raw": "[[Long-Tail Asset Listing]]",
      "resolved": "urn:visionflow:linked:long-tail-asset-listing",
      "kind": "StubLink"
    },
    {
      "raw": "[[MakerDAO]]",
    ...
    {
      "raw": "[[Market Maker Brokerage]]",
      "resolved": "urn:visionflow:linked:market-maker-brokerage",
      "kind": "StubLink"
    },
    {
      "raw": "[[Martinelli McDonald 2019 Balancer Whitepaper]]",
      "resolved": "urn:visionflow:linked:martinelli-mc-donald-2019-balancer-whitepaper",
      "kind": "StubLink"
    },
    {
      "raw": "[[Matcha]]",
      "resolved": "urn:visionflow:linked:matcha",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Maximal Extractable Value]]",
      "resolved": "urn:visionflow:linked:maximal-extractable-value",
      "kind": "StubLink"
    },
    {
      "raw": "[[Maya Protocol]]",
      "resolved": "urn:visionflow:linked:maya-protocol",
      "kind": "StubLink"
    },
    {
      "raw": "[[Meteora]]",
      "resolved": "urn:visionflow:linked:meteora",
      "kind": "StubLink"
    },
    {
      "raw": "[[MiCA]]",
    ...
    {
      "raw": "[[MiCA Regulation EU 2023-1114]]",
      "resolved": "urn:visionflow:linked:mi-ca-regulation-eu-2023-1114",
      "kind": "StubLink"
    },
    {
      "raw": "[[Milionis Moallemi Roughgarden Zhang 2022 LVR]]",
      "resolved": "urn:visionflow:linked:milionis-moallemi-roughgarden-zhang-2022-lvr",
      "kind": "StubLink"
    },
    {
      "raw": "[[Native Asset Cross-Chain Swap]]",
      "resolved": "urn:visionflow:linked:native-asset-cross-chain-swap",
      "kind": "StubLink"
    },
    {
      "raw": "[[Odos]]",
      "resolved": "urn:visionflow:linked:odos",
      "kind": "StubLink"
    },
    {
      "raw": "[[OKX]]",
      "resolved": "urn:visionflow:linked:okx",
      "kind": "StubLink"
    },
    {
      "raw": "[[OKX DEX]]",
      "resolved": "urn:visionflow:linked:okx-dex",
      "kind": "StubLink"
    },
    {
      "raw": "[[OpenBook]]",
      "resolved": "urn:visionflow:linked:open-book",
      "kind": "StubLink"
    },
    {
      "raw": "[[OpenOcean]]",
      "resolved": "urn:visionflow:linked:open-ocean",
      "kind": "StubLink"
    },
    {
      "raw": "[[Optimism]]",
    ...
    {
      "raw": "[[Orca]]",
      "resolved": "urn:visionflow:linked:orca",
      "kind": "StubLink"
    },
    {
      "raw": "[[Order Book]]",
    ...
    {
      "raw": "[[Over-the-Counter Trading]]",
      "resolved": "urn:visionflow:linked:over-the-counter-trading",
      "kind": "StubLink"
    },
    {
      "raw": "[[ParaSwap]]",
      "resolved": "urn:visionflow:linked:para-swap",
      "kind": "StubLink"
    },
    {
      "raw": "[[Pendle]]",
    ...
    {
      "raw": "[[Pool Manager]]",
      "resolved": "urn:visionflow:linked:pool-manager",
      "kind": "StubLink"
    },
    {
      "raw": "[[Qin Zhou Gervais 2022 Quantifying BEV]]",
      "resolved": "urn:visionflow:linked:qin-zhou-gervais-2022-quantifying-bev",
      "kind": "StubLink"
    },
    {
      "raw": "[[Raydium]]",
      "resolved": "urn:visionflow:linked:raydium",
      "kind": "StubLink"
    },
    {
      "raw": "[[Router Contract]]",
      "resolved": "urn:visionflow:linked:router-contract",
      "kind": "StubLink"
    },
    {
      "raw": "[[Self-Custody]]",
    ...
    {
      "raw": "[[Self-Custody Wallet]]",
      "resolved": "urn:visionflow:linked:self-custody-wallet",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Symbiosis Finance]]",
      "resolved": "urn:visionflow:linked:symbiosis-finance",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Tick-Based Liquidity]]",
      "resolved": "urn:visionflow:linked:tick-based-liquidity",
      "kind": "StubLink"
    },
    {
      "raw": "[[Token Economy]]",
    ...
    {
      "raw": "[[Traditional Stock Exchange]]",
      "resolved": "urn:visionflow:linked:traditional-stock-exchange",
      "kind": "StubLink"
    },
    {
      "raw": "[[Tron]]",
    ...
    {
      "raw": "[[Uniswap Labs 2025 V4 PoolManager Architecture]]",
      "resolved": "urn:visionflow:linked:uniswap-labs-2025-v4-pool-manager-architecture",
      "kind": "StubLink"
    },
    {
      "raw": "[[Uniswap V2]]",
      "resolved": "urn:visionflow:linked:uniswap-v2",
      "kind": "StubLink"
    },
    {
      "raw": "[[Uniswap V2 Whitepaper]]",
      "resolved": "urn:visionflow:linked:uniswap-v2-whitepaper",
      "kind": "StubLink"
    },
    {
      "raw": "[[Uniswap V3]]",
      "resolved": "urn:visionflow:linked:uniswap-v3",
      "kind": "StubLink"
    },
    {
      "raw": "[[Uniswap V3 Whitepaper]]",
      "resolved": "urn:visionflow:linked:uniswap-v3-whitepaper",
      "kind": "StubLink"
    },
    {
      "raw": "[[Uniswap V4]]",
    ...
    {
      "raw": "[[UniswapX]]",
      "resolved": "urn:visionflow:linked:uniswap-x",
      "kind": "StubLink"
    },
    {
      "raw": "[[UniswapX Whitepaper 2023]]",
      "resolved": "urn:visionflow:linked:uniswap-x-whitepaper-2023",
      "kind": "StubLink"
    },
    {
      "raw": "[[Vampire Attack]]",
      "resolved": "urn:visionflow:linked:vampire-attack",
      "kind": "StubLink"
    },
    {
      "raw": "[[Vertex Protocol]]",
    ...
    {
      "raw": "[[Zhou Xiong Bonneau Gervais 2023 SoK DeFi Attacks]]",
      "resolved": "urn:visionflow:linked:zhou-xiong-bonneau-gervais-2023-so-k-de-fi-attacks",
      "kind": "StubLink"
    },
    {
