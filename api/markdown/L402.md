...
```json-ld
{
  ...
  "relations": {
    "hasPart": [
      ...
      {
        "@id": "urn:ngm:class:http-402-status",
        "label": "HTTP 402 Status"
      }
    ],
    "partOf": [
      {
        "@id": "urn:ngm:class:api-access-control",
    ...
    "implements": [
      {
        "@id": "urn:ngm:class:bearer-token-authentication",
