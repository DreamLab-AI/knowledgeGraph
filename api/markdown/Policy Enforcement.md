schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#PolicyEnforcement
legacy_uri:: urn:visionclaw:concept:infrastructure:policy-enforcement
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-pe0000000000"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#PolicyEnforcement"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:policy-enforcement"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:policy-enforcement:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[AI Risk Register]]",
      "resolved": "urn:visionflow:owl:class:ai-risk-register",
      "kind": "ResolvedLink"
    },
    {
      "raw": "[[AI Trust Risk and Security Management]]",
      "resolved": "urn:visionflow:owl:class:ai-trust-risk-and-security-management",
      "kind": "ResolvedLink"
    },
    {
...
- ### Definition
  - Mechanisms, architectures, and toolchains that translate declarative security and governance rules into runtime decisions—permitting, denying, mutating, or auditing operations across compute, data, network, and AI systems. Policy enforcement separates rule authorship (Policy Administration Point, PAP), rule evaluation (Policy Decision Point, PDP), and rule application (Policy Enforcement Point, PEP) into loosely coupled tiers; a fifth actor—the Policy Information Point (PIP)—enriches evaluation requests with live attribute data. Modern enforcement spans four paradigms: Role-Based Access Control (RBAC) granting permissions via static role assignments and suited to organisations with bounded permission variance; Attribute-Based Access Control (ABAC) evaluating dynamic subject, resource, action, and environment attributes and suited to fine-grained contextual decisions; Relationship-Based Access Control (ReBAC) traversing entity-relationship graphs (e.g., a user who is an owner of a folder inherits owner rights on all nested files) and suited to collaborative document and object stores; and Policy-Based Access Control (PBAC) composing rules across RBAC/ABAC/ReBAC into a single declarative evaluation engine. Tooling ranges from general-purpose engines—OPA (Open Policy Agent, CNCF Graduated 2021) with its Rego language, and Cedar (AWS, open-sourced May 2023) with its formally verified Rust SDK—to platform-specific admission controllers (Kyverno for Kubernetes, OPA/Gatekeeper for Kubernetes), runtime threat-detection engines (Falco, CNCF Graduated February 2024), service-mesh L7 policy planes (Istio AuthorizationPolicy), and ReBAC engines (OpenFGA, CNCF Incubating November 2025; SpiceDB; Authzed). At scale, policy-as-code practice encodes rules in version-controlled repositories with CI gates, enabling auditability, rollback, and automated compliance testing against regulatory frameworks including GDPR Article 25, the EU AI Act (high-risk obligations enforceable August 2026), NCSC CAF v4.0 (August 2025), the UK Cyber Security and Resilience Bill (expected 2026), and NIST SP 800-53.

- ### Semantic Classification
  - owl-class:: infrastructure:PolicyEnforcement
  - owl-role:: GovernanceMechanism
  - owl-inferred:: infrastructure:AccessControl, infrastructure:SecurityGovernance, infrastructure:ComplianceAutomation
  - belongs-to-domain:: [[Narrative Gold Mine]], [[SecurityDomain]], [[InfrastructureDomain]]
  - implemented-in-layer:: [[ApplicationLayer]], [[NetworkLayer]], [[PlatformLayer]]
...
- ### Provenance
  - sources::
    - CNCF. "Cloud Native Computing Foundation Announces Open Policy Agent Graduation." CNCF Announcement, 4 February 2021. https://www.cncf.io/announcements/2021/02/04/cloud-native-computing-foundation-announces-open-policy-agent-graduation/
    - AWS. "Introducing Cedar, an open-source language for access control." AWS What's New, May 2023. https://aws.amazon.com/about-aws/whats-new/2023/05/cedar-open-source-language-access-control/
    - CNCF. "OpenFGA Becomes a CNCF Incubating Project." November 2025. https://www.cncf.io/blog/2025/11/11/openfga-becomes-a-cncf-incubating-project/
    - Kyverno. "Announcing Kyverno Release 1.16." November 2025. https://kyverno.io/blog/2025/11/10/announcing-kyverno-release-1.16/
    - CNCF. "Falco Links Real-Time Detection with Forensic-Level Analysis in the Cloud Native Stack." November 2025. https://www.cncf.io/announcements/2025/11/10/falco-links-real-time-detection-with-forensic-level-analysis-in-the-cloud-native-stack/
    - Istio. "Can Your Platform Do Policy?" October 2024. https://istio.io/latest/blog/2024/l7-policy-with-opa/
    - European Parliament. "Regulation (EU) 2024/1689 — AI Act." July 2024. https://artificialintelligenceact.eu/
    - NCSC. "Cyber Assessment Framework v4.0." August 2025. https://www.ncsc.gov.uk/collection/caf/
    - ICO. "Data Protection by Design and by Default." 2025. https://ico.org.uk/for-organisations/uk-gdpr-guidance-and-resources/accountability-and-governance/data-protection-by-design-and-by-default/
    - NIST. "SP 800-207: Zero Trust Architecture." August 2020.
    - Samuel Warema et al. "Zanzibar: Google's Consistent, Global Authorization System." USENIX ATC 2019.
    - Ananya Bhatt et al. "Cedar: A New Language for Expressive, Fast, Safe, and Analyzable Authorization." Amazon Science 2023. https://assets.amazon.science/96/a8/1b427993481cbdf0ef2c8ca6db85/cedar-a-new-language-for-expressive-fast-safe-and-analyzable-authorization.pdf
    - Open Policy Agent. GitHub Repository. https://github.com/open-policy-agent/opa
    - OpenFGA. Fine-Grained Authorization documentation. https://openfga.dev/
    - OASIS. "XACML 3.0 Standard." January 2013.
    ...
    - Ravi Sandhu et al. "Role-Based Access Control Models." IEEE Computer 29(2), 1996.
    - Vincent Hu et al. "NIST SP 800-162: ABAC Definition and Considerations." NIST, 2014.
    - European Council. "AI Omnibus Agreement." May 2026. https://www.consilium.europa.eu/en/press/press-releases/2026/05/07/artificial-intelligence-council-and-parliament-agree-to-simplify-and-streamline-rules/
    - Styra. "OPA CNCF Graduation Blog." 2021. https://www.styra.com/blog/open-policy-agent-graduating-in-the-cncf-proves-need-for-cloud-native-authz/
    - Solo.io. "Istio Authorization Policy in Ambient Mesh." 2025. https://www.solo.io/blog/a-guide-to-authorization-policy-in-ambient-mesh
    - Nirmata. "10 Reasons Why Kubernetes Users Choose Kyverno Over OPA Gatekeeper." April 2025. https://nirmata.com/2025/04/14/10-reasons-why-kubernetes-users-choose-kyverno-over-opa-gatekeeper/
    - Help Net Security. "OpenFGA: The open-source engine redefining access control." October 2025. https://www.helpnetsecurity.com/2025/10/22/openfga-open-source-access-control/
    - Osohq. "OPA vs Cedar vs Zanzibar: 2025 Policy Engine Guide." 2025. https://www.osohq.com/learn/opa-vs-cedar-vs-zanzibar
    - Legalnodes. "EU AI Act 2026 Updates: Compliance Requirements and Business Risks." 2026. https://www.legalnodes.com/article/eu-ai-act-2026-updates-compliance-requirements-and-business-risks
    - CNCF. "Kyverno vs Kubernetes policies." October 2025. https://www.cncf.io/blog/2025/10/16/kyverno-vs-kubernetes-policies-how-kyverno-complements-and-completes-kubernetes-policy-types/
