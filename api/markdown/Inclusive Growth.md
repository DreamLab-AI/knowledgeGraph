schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#InclusiveGrowth
legacy_uri:: urn:visionclaw:concept:spatial-computing:inclusive-growth
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-4072d8e46a2f"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#InclusiveGrowth"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:inclusive-growth"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
...
- ### Semantic Classification
  - owl-class:: spatial-computing:InclusiveGrowth
  - owl-role:: Concept
