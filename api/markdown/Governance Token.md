iri:: http://narrativegoldmine.com/blockchain#GovernanceToken
uri:: urn:visionclaw:concept:blockchain:governance-token
rdf-type:: owl:Class
same-as:: urn:visionclaw:concept:blockchain:governance-token
type:: owl:Class
context:: https://visionclaw.dreamlab-ai.systems/ns/v2
domain:: blockchain
preferred-term:: Governance Token
content-hash:: sha256-12-b39010e600fc
legacy-term-id:: BC-0463
...
- ### Definition
  - Cryptographic asset conferring voting rights and protocol decision-making authority to holders, enabling decentralised governance through blockchain-based tokens rather than traditional shareholder structures. Governance tokens implement [[ERC20Votes]] or similar mechanisms supporting delegation, historical balance snapshots, and preventing flash-loan manipulation, creating programmable governance with transparent, auditable voting processes. Tokens may accrue value through fee-sharing, buyback-and-burn mechanisms, staking yields, or governance premium on [[DecentralisedAutonomousOrganisation|DAOs]].
