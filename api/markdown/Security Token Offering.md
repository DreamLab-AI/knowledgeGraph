schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#SecurityTokenOffering
legacy_uri:: urn:visionclaw:concept:spatial-computing:security-token-offering
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-815aabf26d11"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#SecurityTokenOffering"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:security-token-offering"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:d7fac6d47bad7bc287a079ec79896bf3537dfbc8399c0b6624d1891023a4256f@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
```json-ld
{
  ...
  "definition": "Security Token Offering is a concept within the metaverse domain. Further enrichment pending.",
  "vc:qualityScore": {
    "@value": "0.35",
    "@type": "xsd:float"
  },
