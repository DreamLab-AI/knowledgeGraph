schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#TrustFrameworkPolicy
legacy_uri:: urn:visionclaw:concept:spatial-computing:trust-framework-policy
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-6a848ae7fe88"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#TrustFrameworkPolicy"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:trust-framework-policy"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
