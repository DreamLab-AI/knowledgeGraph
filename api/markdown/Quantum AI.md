schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#QuantumAI
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:quantum-ai
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-557ac40a1c03"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#QuantumAI"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:quantum-ai"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:610aee895823bdb547aeb4da2fcd447d6bf833d2973e058e7b7a61ede9051024@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:quantum-ai",
  "@type": "OntologyClass",
  "label": "Quantum AI",
  "subClassOf": [
    {
