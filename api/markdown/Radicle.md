schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/ontology#Radicle
legacy_uri:: urn:visionclaw:concept:blockchain:radicle
public:: true
...
```json-ld
{
  ...
  "@id": "urn:visionflow:page:1921fdf89adaed47eb0dc0300b4a4c31536cabf97acf218a396fb469847b4345",
  "@type": "Page",
  "vc:slug": "radicle",
  "title": "Radicle",
  "vc:public": true,
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-4d3bc4dd1557"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/ontology#Radicle"
    },
    {
      "vc:key": "maturity",
      "vc:value": "draft"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:radicle"
    },
    {
      "vc:key": "status",
      "vc:value": "stub"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:1921fdf89adaed47eb0dc0300b4a4c31536cabf97acf218a396fb469847b4345@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:radicle",
  "@type": "OntologyClass",
  "label": "Radicle",
  "subClassOf": [
    {
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:radicle:776c802a9fc9",
...
- ### Content
  ...
  - The term "content" can have multiple meanings depending on the context. Here are the primary interpretations:
	  1. **Content Creation**: In the context of marketing and media, content refers to the information, entertainment, or educational material that is created and disseminated through various channels such as blogs, videos, social media, podcasts, and more. This type of content is designed to engage and inform an audience, ultimately helping businesses attract and retain customers.
