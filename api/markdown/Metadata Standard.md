schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#MetadataStandard
legacy_uri:: urn:visionclaw:concept:spatial-computing:metadata-standard
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-982de29bfd57"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#MetadataStandard"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:metadata-standard"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
