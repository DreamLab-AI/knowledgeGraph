schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/robotics#RobotSingularity
legacy_uri:: urn:visionclaw:concept:robotics:robot-singularity
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-0c5688dad8ad"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/robotics#RobotSingularity"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:robotics:robot-singularity"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:96ecb3c05a1405eba266f9562932c3846fc083e825c104875dceaea1688f9994@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:robot-singularity",
  "@type": "OntologyClass",
