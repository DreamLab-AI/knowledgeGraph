```json-ld
{
  ...
  "@id": "urn:visionflow:page:data-availability-sampling",
  "@type": "Page",
  "title": "Data Availability Sampling",
  "vc:slug": "data-availability-sampling",
  "vc:public": true,
  "vc:schemaVersion": 2,
...
- ### Overview
- For a blockchain to be safely verified, the data behind each block must be available so that anyone can check its validity. A block producer who publishes a header but withholds the data [private] hide invalid state.
