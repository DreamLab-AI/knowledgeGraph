...
(Declaration (Class :MaximumSequenceLength))

;; Annotations
(AnnotationAssertion rdfs:label :MaximumSequenceLength "Maximum Sequence Length"@en)
(AnnotationAssertion rdfs:comment :MaximumSequenceLength "The longest sequence of tokens that a model can process in a single forward pass, constrained by positional encoding scheme and computational resources."@en)

;; Data Properties
(AnnotationAssertion dcterms:identifier :MaximumSequenceLength "AI-0239"^^xsd:string)
(DataPropertyAssertion :isAITechnology :MaximumSequenceLength "true"^^xsd:boolean)
```
