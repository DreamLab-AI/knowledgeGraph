schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#AssetRegistry
legacy_uri:: urn:visionclaw:concept:blockchain:asset-registry
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-asset-registry-production-001"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#AssetRegistry"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:asset-registry"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:asset-registry:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[CMTA Token Standard]]",
      "resolved": "urn:visionflow:linked:cmta-token-standard",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[ERC-3643 Standard]]",
      "resolved": "urn:visionflow:linked:erc-3643-standard",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Ownership System]]",
      "resolved": "urn:visionflow:linked:ownership-system",
      "kind": "StubLink"
    },
    {
      "raw": "[[Paper-Based Land Registry]]",
      "resolved": "urn:visionflow:linked:paper-based-land-registry",
      "kind": "StubLink"
    },
    {
      "raw": "[[Polymesh Protocol]]",
      "resolved": "urn:visionflow:linked:polymesh-protocol",
      "kind": "StubLink"
    },
    {
      "raw": "[[Real Estate Registry]]",
      "resolved": "urn:visionflow:linked:real-estate-registry",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Secondary Market Liquidity]]",
      "resolved": "urn:visionflow:linked:secondary-market-liquidity",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Traditional Title Systems]]",
      "resolved": "urn:visionflow:linked:traditional-title-systems",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Enterprise Smart Contracts]]",
      "resolved": "urn:visionflow:owl:class:enterprise-smart-contracts",
      "kind": "ResolvedLink"
    },
    {
      "raw": "[[Enterprise Token Standards]]",
      "resolved": "urn:visionflow:owl:class:enterprise-token-standards",
      "kind": "ResolvedLink"
    },
    {
      "raw": "[[ESG Reporting]]",
    ...
    {
      "raw": "[[Ethical Sourcing]]",
      "resolved": "urn:visionflow:owl:class:ethical-sourcing",
      "kind": "ResolvedLink"
    },
    {
...
- ### Definition
  - An [[Asset Registry]] is a cryptographically-secured, on-chain or hybrid on/off-chain system for recording, authenticating, and transferring legal ownership rights and provenance metadata for real-world or digital assets, implemented through [[Smart Contracts]], [[Distributed Ledger]] infrastructure, and regulated identity layers — enabling immutable, auditable ownership histories, programmable compliance enforcement (KYC/AML, transfer restrictions), fractional ownership via [[Asset Tokenisation]], and elimination of trusted intermediary bottlenecks prevalent in traditional title, securities, and provenance systems. Governed examples span securities registries enforcing ERC-3643 (T-REX) identity-gating, real-property title ledgers piloted by HM Land Registry (Digital Street) and Sweden's Lantmäteriet, real-world asset (RWA) tokenization platforms (Centrifuge, Maple Finance) targeting a BCG/ADDX-projected $16T tokenizable asset market by 2030, securities registries (Polymesh for regulated equities), and art provenance chains (Artory, Verisart). UK deployments concentrate at HM Land Registry Plymouth, with PropTech research at Manchester and Imperial College London blockchain labs.

- ### Semantic Classification
  - owl-class:: blockchain:AssetRegistry
  - owl-role:: InfrastructureObject
  - owl-inferred:: blockchain:TokenizationSystem, blockchain:ProvenanceSystem, blockchain:ComplianceRegistry
  - belongs-to-domain:: [[BlockchainDomain]], [[FinancialInfrastructureDomain]], [[LegalTechDomain]]
  - implemented-in-layer:: [[ApplicationLayer]], [[ProtocolLayer]]

- ### Relationships
  - is-subclass-of:: [[Distributed Ledger]], [[Ownership System]], [[Blockchain Application]], [[Financial Infrastructure]]
  - has-part:: [[Smart Contract]], [[Asset Tokenisation]], [[Digital Identity Wallet]], [[Digital Signature]], [[Compliance Monitoring]], [[Merkle Tree]], [[Access Control System]]
  - requires:: [[Distributed Ledger]], [[Digital Identity Wallet]], [[Smart Contract]], [[Digital Signature]], [[Cryptography Security and Privacy]], [[Identity Verification]]
  - enables:: [[Fractional Ownership]], [[Real World Asset Tokenisation]], [[Provenance Tracking]], [[Automated Compliance]], [[Secondary Market Liquidity]], [[Cross-Border Settlement]]
  - implements:: [[ERC-3643 Standard]], [[Enterprise Token Standards]], [[Distributed Identity]], [[AML KYC Compliance]], [[ESG Reporting]]
  - depends-on:: [[Blockchain Network]], [[Cryptography Security and Privacy]], [[Distributed Identity]], [[Smart Contract]], [[Hash Function]]
  - supports:: [[Decentralised Finance]], [[Securities Settlement]], [[Supply Chain Tracking]], [[Carbon Credit Tracking]], [[Real Estate Registry]]
  - uses:: [[Enterprise Smart Contracts]], [[Digital Signature]], [[Hash Function]], [[Access Control System]], [[Graph Database]]
  - contrasts-with:: [[Traditional Title Systems]], [[Centralised Database]], [[Paper-Based Land Registry]]
  - related-to:: [[Asset Tokenisation]], [[Blockchain Interoperability]], [[Enterprise Token Standards]], [[Carbon Credit Tracking]], [[Ethical Sourcing]], [[CBDCs]]
  - standardized-by:: [[ERC-3643 Standard]], [[Hyperledger Indy]], [[ISO 24165]], [[CMTA Token Standard]], [[Polymesh Protocol]]

- ### Content

  ## Compositional Relationships (Components)
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:hasPart bc:SmartContract))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:hasPart bc:AssetTokenisationLayer))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:hasPart bc:DigitalIdentityWallet))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:hasPart bc:DigitalSignature))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:hasPart bc:ComplianceEnforcementModule))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:hasPart bc:ProvenanceChain))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:hasPart bc:AccessControlLayer))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:hasPart bc:MerkleTree))

    ## Dependency Relationships
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:requires bc:DistributedLedger))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:requires bc:DigitalIdentityWallet))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:requires bc:SmartContract))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:requires bc:DigitalSignature))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:requires bc:CryptographySecurityPrivacy))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:dependsOn bc:BlockchainNetwork))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:dependsOn bc:IdentityVerification))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:dependsOn bc:HashFunction))

    ## Capability Relationships
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:enables bc:FractionalOwnership))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:enables bc:RealWorldAssetTokenisation))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:enables bc:ProvenanceTracking))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:enables bc:AutomatedCompliance))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:enables bc:SecondaryMarketLiquidity))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:supports bc:DecentralisedFinance))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:supports bc:SecuritiesSettlement))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:supports bc:SupplyChainTracking))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:supports bc:CarbonCreditTracking))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:supports bc:RealEstateRegistry))

    ## Implementation Relationships
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:implements bc:ERC3643Standard))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:implements bc:EnterpriseTokenStandards))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:implements bc:DistributedIdentity))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:implements bc:AMLKYCCompliance))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:implements bc:ESGReporting))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:uses bc:EnterpriseSmartContracts))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:uses bc:DigitalSignature))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:uses bc:HashFunction))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:uses bc:AccessControlSystem))
    ...
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:reduces bc:CounterfeitingRisk))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:reduces bc:TransactionCost))
    SubClassOf(bc:AssetRegistry
      ObjectSomeValuesFrom(bc:reduces bc:ReconciliationBurden))

    ## Annotations
    AnnotationAssertion(rdfs:label bc:AssetRegistry "Asset Registry"@en)
    AnnotationAssertion(rdfs:comment bc:AssetRegistry "Cryptographically-secured on-chain or hybrid system for recording, authenticating, and transferring legal ownership of real-world or digital assets using smart contracts, distributed ledgers, and regulated identity layers; enabling immutable provenance chains, programmable compliance, and fractional ownership across securities (ERC-3643/T-REX, Polymesh), real property (HM Land Registry Digital Street, Sweden Lantmäteriet), RWA tokenization (Centrifuge, Maple Finance), and art provenance (Artory, Verisart) domains targeting BCG/ADDX $16T tokenizable asset market by 2030."@en)
    AnnotationAssertion(dcterms:identifier bc:AssetRegistry "BC-0042"^^xsd:string)
    AnnotationAssertion(dcterms:subject bc:AssetRegistry "Blockchain, Tokenization, Real-World Assets, Securities, Property Registry, Provenance"@en)
    ```
  ...
  - The **$16 trillion** figure cited by BCG/ADDX (2030 projection) represents the estimated total value of assets whose ownership records could plausibly migrate to or interact with tokenized registries: real estate ($5.4T), private equity ($3.5T), private credit ($2.8T), infrastructure ($1T), commodities ($1T), and art/collectibles ($0.5T). As of 2026, on-chain registered assets under management across all RWA platforms (Centrifuge, Maple Finance, Ondo Finance, Franklin Templeton, BlackRock BUIDL) had surpassed $12B TVL, representing early-stage proof-of-concept deployment of registry infrastructure at institutional scale.
  ...
  - **Market size**: The RWA tokenization market (the most measurable segment of blockchain asset registries) reached approximately $15-17B in on-chain AUM by Q1 2026, up from $8B in 2024 and less than $1B in 2022. BlackRock BUIDL ($1.8B+), Franklin Templeton FOBXX ($450M+), Ondo Finance ($1.2B+), Centrifuge ($800M+), and Maple Finance ($650M active loans) represent the largest institutional deployments. US Treasury tokenization (Ondo, BlackRock, Franklin Templeton) dominates current AUM, but private credit (Centrifuge, Maple) and real estate (RealT, Lofty) represent faster growth segments.
  ...
  - ### Metadata
  - domain-correction:: null (domain correctly set as blockchain)
  - legacy-term-id:: BC-0042
  - enriched-by:: claude-sonnet-4-6
  - enrichment-date:: 2026-05-17T10:00:00Z
  - key-concepts:: ERC-3643, T-REX, Polymesh, Centrifuge, Maple Finance, HM Land Registry Digital Street, Lantmäteriet, RWA tokenization, CMTA, Artory, Verisart, Everledger, LVMH Aura, IBM Food Trust, BlackRock BUIDL, Ondo Finance, Franklin Templeton BENJI

- ### Provenance
  - sources:: [[Smart Contract]], [[Distributed Ledger]], [[Asset Tokenisation]], [[Blockchain Network]], [[Digital Identity Wallet]], [[Compliance Monitoring]], [[Enterprise Token Standards]], [[AML KYC Compliance]], [[Carbon Credit Tracking]], [[Ethical Sourcing]], [[CBDCs]], [[Blockchain Interoperability]], [[Hyperledger Indy]]
  - key-references:: EIP-3643 (T-REX standard), Polymesh whitepaper (2021), BCG/ADDX tokenization report (2022), HM Land Registry Digital Street programme reports (2019-2023), Law Commission Digital Assets report (2023), WEF Tokenization Unlocking Financial Markets (2024), GFMA Digital Asset Markets Blueprint (2024), FCA Digital Securities Sandbox First Cohort Report (2024), ESMA DLT Pilot Regime Guidelines (2024)
