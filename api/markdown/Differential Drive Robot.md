schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/robotics#DifferentialDriveRobot
legacy_uri:: urn:visionclaw:concept:robotics:differential-drive-robot
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-94a33bbe4b6c"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/robotics#DifferentialDriveRobot"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:robotics:differential-drive-robot"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
