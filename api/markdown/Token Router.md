...
```json-ld
{
  ...
  "@id": "urn:visionflow:page:token-router",
  "@type": "Page",
  "vc:slug": "token-router",
  "title": "Token Router",
  "vc:public": true,
  "vc:outboundWikilinks": ["AI Cost Optimization", "Market Data Bias", "Token Routers"],
  "vc:schemaVersion": 2
}
```
...
```json-ld
{
  ...
  "relations": {
    "relatedTo": [{"@id": "urn:ngm:class:artificial-intelligence", "label": "Artificial Intelligence"}, {"@id": "urn:ngm:class:data", "label": "Data"}]
  },
  "provenance": {
