schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#OptimizationAlgorithm
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:optimization-algorithm
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-128a9fb0f27f"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#OptimizationAlgorithm"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:optimization-algorithm"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:0d31b31d04e86740a7ff361ac75c846631be641be96c26c93f4db702938b4000@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
