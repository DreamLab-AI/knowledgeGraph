...
(Declaration (Class :Completehritermsreference))

;; Annotations
(AnnotationAssertion rdfs:label :Completehritermsreference "COMPLETE_HRI_TERMS_REFERENCE"@en)
(AnnotationAssertion rdfs:comment :Completehritermsreference "A component of the metaverse ecosystem."@en)

;; Data Properties
(AnnotationAssertion dcterms:identifier :Completehritermsreference "mv-1761742247902"^^xsd:string)
```

- ## About COMPLETE_HRI_TERMS_REFERENCE
