schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#Virscapes
legacy_uri:: urn:visionclaw:concept:infrastructure:virscapes
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-8b7a4a176f16"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#Virscapes"
    },
    {
      "vc:key": "maturity",
      "vc:value": "draft"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:virscapes"
    },
    {
      "vc:key": "status",
      "vc:value": "stub"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:465ac8a91e0d124833f008965565e5f46f8686117b49aa168245075929766f66@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:virscapes",
  "@type": "OntologyClass",
  "label": "Virscapes",
  "subClassOf": [
    {
  ...
  "definition": "Virscapes is a concept within the ngm domain.",
  "vc:qualityScore": {
    "@value": "0.50",
    "@type": "xsd:float"
  },
...
- ### Content
  ...
  - Methodology
	 ...
	 - HalfLife callback? Cohesion was maintained.
				- Challenges in viewing the images.
					- Print format
