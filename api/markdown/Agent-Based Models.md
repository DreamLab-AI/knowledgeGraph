...
```json-ld
{
  ...
  "sameAs": [
    ...
    {
      "@id": "urn:ngm:class:individual-based-models",
      "label": "Individual-Based Models"
    }
  ],
  "relations": {
    "hasPart": [
