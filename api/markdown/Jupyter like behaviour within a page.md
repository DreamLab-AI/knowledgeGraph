schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#JupyterLikeBehaviourWithinAPage
legacy_uri:: urn:visionclaw:concept:infrastructure:jupyter-like-behaviour-within-a-page
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-c30cead8ef87"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#JupyterLikeBehaviourWithinAPage"
    },
    {
      "vc:key": "maturity",
      "vc:value": "draft"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:jupyter-like-behaviour-within-a-page"
    },
    {
      "vc:key": "status",
      "vc:value": "stub"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:3a67b6249fbf7b58fb3ed263275af3f1a91636b6e081e18d608b7b4eadd73b6b@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:jupyter-like-behaviour-within-a-page",
  "@type": "OntologyClass",
