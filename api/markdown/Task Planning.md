schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#TaskPlanning
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:task-planning
public:: true
...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:automated-reasoning-domain",
      "vc:label": "AutomatedReasoningDomain"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-95433c1b00e6"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#TaskPlanning"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:task-planning"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:task-planning:776c802a9fc9",
  ...
  "vc:resolutions": [
    {
      "raw": "[[Action Model]]",
      "resolved": "urn:visionflow:linked:action-model",
      "kind": "StubLink"
    },
    {
      "raw": "[[Action Schema]]",
      "resolved": "urn:visionflow:linked:action-schema",
      "kind": "StubLink"
    },
    {
      "raw": "[[AlgorithmLayer]]",
    ...
    {
      "raw": "[[AutomatedReasoningDomain]]",
      "resolved": "urn:visionflow:linked:automated-reasoning-domain",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Behaviour Tree Execution]]",
      "resolved": "urn:visionflow:linked:behaviour-tree-execution",
      "kind": "StubLink"
    },
    {
      "raw": "[[Behaviour Trees]]",
    ...
    {
      "raw": "[[Feasibility Checker]]",
      "resolved": "urn:visionflow:linked:feasibility-checker",
      "kind": "StubLink"
    },
    {
      "raw": "[[Formal Logic]]",
    ...
    {
      "raw": "[[Goal-Oriented Action Planning]]",
      "resolved": "urn:visionflow:linked:goal-oriented-action-planning",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[HTN Decomposition]]",
      "resolved": "urn:visionflow:linked:htn-decomposition",
      "kind": "StubLink"
    },
    {
      "raw": "[[HTN Planning]]",
    ...
    {
      "raw": "[[Intelligent Agent]]",
      "resolved": "urn:visionflow:linked:intelligent-agent",
      "kind": "StubLink"
    },
    {
      "raw": "[[IPC Benchmark]]",
      "resolved": "urn:visionflow:linked:ipc-benchmark",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[MCTS]]",
      "resolved": "urn:visionflow:linked:mcts",
      "kind": "StubLink"
    },
    {
      "raw": "[[MCTS Rollout]]",
      "resolved": "urn:visionflow:linked:mcts-rollout",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Open-X-Embodiment Dataset]]",
      "resolved": "urn:visionflow:linked:open-x-embodiment-dataset",
      "kind": "StubLink"
    },
    {
      "raw": "[[PDDL]]",
      "resolved": "urn:visionflow:linked:pddl",
      "kind": "StubLink"
    },
    {
      "raw": "[[PDDL Standard]]",
      "resolved": "urn:visionflow:linked:pddl-standard",
      "kind": "StubLink"
    },
    {
      "raw": "[[Plan Library]]",
      "resolved": "urn:visionflow:linked:plan-library",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Robot Autonomy]]",
      "resolved": "urn:visionflow:linked:robot-autonomy",
      "kind": "StubLink"
    },
    {
      "raw": "[[ROS 2 Navigation]]",
      "resolved": "urn:visionflow:linked:ros-2-navigation",
      "kind": "StubLink"
    },
    {
      "raw": "[[SAT Solving]]",
    ...
    {
      "raw": "[[Search Theory]]",
      "resolved": "urn:visionflow:linked:search-theory",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Video Game AI]]",
      "resolved": "urn:visionflow:linked:video-game-ai",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[World State Representation]]",
      "resolved": "urn:visionflow:linked:world-state-representation",
      "kind": "StubLink"
    },
    {
...
- ### Definition
  - Task Planning is the computational sub-field of artificial intelligence and robotics concerned with automatically synthesising finite sequences of discrete actions — called plans — that transform a given initial world state into a state satisfying a specified goal condition, subject to action preconditions, effects, resource constraints, and temporal or probabilistic uncertainty. A planner accepts a formal problem description (initial state I, goal condition G, action schema set A), searches over the space of reachable states or action sequences, and returns either a complete plan π = ⟨a₁, a₂, …, aₙ⟩ such that executing π from I guarantees (or probabilistically approaches) G, or a proof of unsolvability. The field spans five decades of research from the foundational STRIPS formalism (Fikes & Nilsson, Stanford Research Institute 1971) through modern neural–symbolic hybrid planners that couple large language models with classical planning engines (Liu LLM+P 2023, Wang Voyager 2023), foundation model end-to-end visuomotor planners (Black et al. π0 Physical Intelligence Mar 2024), and Monte Carlo Tree Search-guided deliberative reasoning architectures (Silver AlphaGo/AlphaZero 2016–2018 adapted to task-level planning by Hao et al. RAP 2023).
...
- ### Semantic Classification
  - owl-class:: artificial-intelligence:TaskPlanning
  - owl-role:: PlanningParadigm
  - owl-inferred:: ai:SymbolicPlanning, ai:NeuralPlanning, ai:HybridPlanning, ai:RoboticPlanning
  - belongs-to-domain:: [[AI-GroundedDomain]], [[RoboticsDomain]], [[AutomatedReasoningDomain]]
  - implemented-in-layer:: [[AlgorithmLayer]], [[ApplicationLayer]], [[SystemsLayer]]
...
- ### Relationships
  ...
  - uses:: [[Large Language Models]], [[Reinforcement Learning]], [[Graph Search]], [[SAT Solving]], [[Monte Carlo Methods]], [[Neural Networks]]
  - contrasts-with:: [[Reactive Control]], [[Behaviour-Based Robotics]], [[End-to-End Learning]], [[Model-Free Reinforcement Learning]]
  - related-to:: [[Motion Planning]], [[Knowledge Representation]], [[Constraint Satisfaction]], [[Multi-Agent Systems]], [[Explainable AI]]
  - standardized-by:: [[PDDL Standard]], [[IPC Benchmark]], [[Open-X-Embodiment Dataset]], [[ROS 2 Navigation]]
