schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#AIUpscalingAndSuperResolution
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:ai-upscaling-and-super-resolution
public:: true
...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "ai-upscaling-and-super-resolution",
  "title": "AI Upscaling and Super-Resolution",
  "vc:public": true,
  "vc:outboundWikilinks": [
    {
      "@id": "urn:visionflow:linked:akt",
      "vc:label": "AKT"
    },
    {
      "@id": "urn:visionflow:linked:alex-net",
      "vc:label": "AlexNet"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:esrgan",
      "vc:label": "ESRGAN"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:gimp",
      "vc:label": "GIMP"
    },
    {
      "@id": "urn:visionflow:linked:google-photos",
      "vc:label": "Google Photos"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:lightroom",
      "vc:label": "Lightroom"
    },
    {
      "@id": "urn:visionflow:linked:mpv",
      "vc:label": "MPV"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:nvidia-shield",
      "vc:label": "NVIDIA Shield"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:remini",
      "vc:label": "Remini"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:sd-1-5",
      "vc:label": "SD 1.5"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:srgan",
      "vc:label": "SRGAN"
    },
    {
      "@id": "urn:visionflow:linked:supir",
      "vc:label": "SUPIR"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:topaz-gigapixel-ai",
      "vc:label": "Topaz Gigapixel AI"
    },
    {
      "@id": "urn:visionflow:linked:unet",
      "vc:label": "UNet"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:vgg",
      "vc:label": "VGG"
    },
    {
      "@id": "urn:visionflow:linked:vgg19",
      "vc:label": "VGG19"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-27f07b6a4440"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#AIUpscalingAndSuperResolution"
    },
    {
      "vc:key": "legacy-term-id",
      "vc:value": "AI-UPSCALE-001"
    },
    {
      "vc:key": "maturity",
      "vc:value": "mature"
    ...
    },
    {
      ...
      "vc:value": "AI Upscaling and Super-Resolution"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:ai-upscaling-and-super-resolution"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
...
- ### Semantic Classification
  - owl-class:: artificial-intelligence:AIUpscalingAndSuperResolution
  - owl-role:: Concept
  - belongs-to-domain:: [[AIDomain]], [[ComputerVisionDomain]]
