...
- ### Content
  ...
  - A canonical feedback loop has six functional roles, which may be physically distinct or collapsed into one device:
    ...
    - **Feedback path** — the wire, optical fibre, hormone diffusion, social broadcast, retrieval [private], gradient signal — over which sensed output returns to the comparator. Delays here are first-order determinants of loop stability.
  ...
  - ### Research and Literature
	  ...
	  **Climate and Earth System**:
	  ...
	  30. Armstrong McKay, D.I., Staal, A., Abrams, J.F., Winkelmann, R., Sakschewski, B., Loriani, S., Fetzer, I., Cornell, S.E., Rockström, J. & Lenton, T.M. (2022). Exceeding 1.5°C global warming [private] trigger multiple climate tipping points. *Science*, 377, eabn7950. DOI: 10.1126/science.abn7950 [Updated tipping points]
