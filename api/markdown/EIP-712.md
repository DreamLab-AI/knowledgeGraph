...
```json-ld
{
  ...
  "sameAs": [
    {
      "@id": "urn:ngm:class:typed-structured-data-signing",
      "label": "Typed Structured Data Signing"
    }
  ],
  "provenance": {
