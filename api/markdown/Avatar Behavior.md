schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#AvatarBehavior
legacy_uri:: urn:visionclaw:concept:spatial-computing:avatar-behavior
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-9996e206c0f9"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#AvatarBehavior"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:avatar-behavior"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:99626c93d48c3ba3faa565fc06934712730b59b6c64140dfa980e37f2e7c9b5b@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:avatar-behavior",
  "@type": "OntologyClass",
