...
- ### Content
  ...
  - **Characteristics of [[Digital Money]]**: Nwosu, cofounder of [[Coinfloor]] exchange in the UK and cofounder of [[Fedimint]], identifies four essential characteristics for [[digital money]]:
		...
		- Ascribing [[monetary value]] to those [[database entries]] is a [[social consensus]] problem, and this itself is a contested topic. The most useful 'hot take' here is that [[Bitcoin]] behaves most like [digital property according to Michael Saylor](https://twitter.com/saylor/status/1395788419301773312), while its [[network]] behaves far more like a [[monetary network]] which is created and supported by the [value of the Bitcoin tokens as analyzed in this Keynesian perspective](https://saito.tech/an-response-to-paul-krugman-from-a-keynesian-bitcoiner/).
		- **[[Jack Mallers]]** of [[Strike]], in his [presentation to the International Monetary Fund (IMF) on Bitcoin as global monetary infrastructure](https://www.youtube.com/watch?v=jb-45m9f76I), identified the following challenges which he claims are solved by the [[Bitcoin monetary network]]:
			- **[[Speed]]**: Traditional [[payment systems]] suffer from slow [[settlement]] times
			- **Limited [[Transparency]] and [[Dependability]]**: Opaque [[financial infrastructure]] and unreliable [[cross-border payments]]
			- **High [[Cost]]**: Excessive [[transaction fees]] and [[intermediary]] costs
			- **Lack of [[Interoperability]]**: Fragmented [[payment networks]] that don't communicate
			- **Limited [[Coverage]]**: Geographic restrictions in [[financial services]] access
			- **Limited [[Accessibility]]**: [[Banking]] barriers for [[unbanked]] populations
		- He further identifies the attributes of the ideal [[global money]]:
			- **[[Uncensorable]]**: Resistant to [[financial censorship]] and [[transaction blocking]]
			- **[[Unfreezable]]**: Assets cannot be [[frozen]] by third parties
			- **[[Permissionless]]**: Open [[access]] without [[gatekeepers]] or approval requirements
			- **[[Borderless]]**: Functions globally without [[geographic restrictions]] or [[capital controls]]
			- **[[Liquid]]**: Easy convertibility and deep [[market liquidity]]
			- **[[Digital]]**: Native to the [[internet]] for seamless [[digital commerce]]
		- **[[Strike]] [[Payment Infrastructure]] (Updated 2025)**: [[Mallers]] has announced USA-focused partnerships leveraging his [[Strike]] product to enable spending [[Bitcoin]], through [[Lightning Network]], as [[Dollars]] in much of the [point-of-sale (POS) systems from NCR and other providers](https://www.ncr.com/point-of-sale-pos-systems) infrastructure in the USA. This is a huge advance as it immediately enables [[vendors]] both online and at physical locations to either save 3% costs for [[card processors]], or else pass this on as a discount. Crucially for '[[Bitcoin as Money]]' it also allows the [[merchants]] to receive the [[payment]] **as [[Bitcoin]]**, not [[Dollars]]. A possible further and highly significant feature is that it might now be possible to divest of [[Bitcoin]] in the USA, buying goods, without a [[capital gains tax]] implication. [[Mallers]] claims to have [[legislative]] backing for this product, but the devil will likely be in the detail. The likely mechanism for this product is that the [[EPOS]] partner sends a [[Lightning]] request to [[Strike]], which liquidates some of their [[Bitcoin]] holding to a [[dollar-denominated]] [[stablecoin]], but in a tax-free jurisdiction such as [[El Salvador]]. This [[stablecoin]] will then be sent to the [[EPOS]] handling partner such as [[NCR]]. [[Stablecoin]] to [[Dollar]] transactions in the USA are much murkier and likely don't cost anything for these companies. This agent will then authorize the [[Dollar]]-denominated sale to the American [[digital till]]. Crucially nobody has a US [[capital gains tax]] exposure in this chain, and all of the [[settlements]] were near free, and instantaneous, with [[cash finality]] for everyone except the [[EPOS]] company. They are likely actually exposed to a small risk here because uptake will be very low level. The novelty opportunity will likely cover any potential exposure to [[stablecoin collapse]]. This is a radical upgrade on the normal flow of divesting [[Bitcoin]] for American users.
		- **[[Merchant Adoption]] (2025 Update)**: Using this open product to spend [[Bitcoin]] as [[Bitcoin]] to [[vendors]] is now available through [[Shopify]] globally and expanding rapidly. A [2025 Deloitte study on merchants preparing for cryptocurrency adoption](https://www2.deloitte.com/content/dam/Deloitte/us/Documents/technology/us-cons-merchant-getting-ready-for-crypto.pdf) found that 93% of businesses accepting [[Bitcoin]] have seen [[revenue]] and [[brand perception]] improve, and 75% of USA sales executives plan to accept [[digital assets]] at some point in the next 2 years. This ambition in the US markets is likely to benefit from the proposed $200 tax exempt law for purchasing goods and services with [[Bitcoin]]. As of 2025, [[Lightning Network]] payment volumes have exceeded $2 billion annually, with over 15,000 [[nodes]] routing [[transactions]] globally and [[channel capacity]] surpassing 5,000 BTC.{{[[cite]]}} [Lightning Network Statistics 2025, Bitcoin Visuals]
  ...
  - ##### [[Bitcoin-backed Fiat]] and [[Dollar-denominated Payments]]
		...
		- **[[Fiat Money]] vs [[Hard Money]]**: [[Fiat money]] is primarily not a long term [[store of value]], as [[Austrian economists]] perhaps believe it should be. This function is left to [[assets]]. The [[Austrian]] thesis of '[[hard money]]' (which cannot be '[[debased]]' by [[government]] action) seems somewhat naïve when one considers that [[credit]] exists anywhere in the world (ie, the creation of [[paper money]] through [[loans]]) then this would be used to buy up a [[hard money]] asset in the long run, causing a [[scarcity crisis]]. This is what happened to [[gold]] in the middle of the last century.
		...
		- **[[El Salvador Bitcoin Adoption]] Status (2025)**: [[El Salvador]] made history in September 2021 by becoming the first country to adopt [[Bitcoin]] as [[legal tender]] alongside the [[US Dollar]]. As of 2025, the experiment has evolved significantly:
			...
			- The government's [[Bitcoin treasury]] holds approximately 5,750 BTC accumulated through various purchases and [[mining]] operations
			- [[Volcano bonds]] and [[Bitcoin-backed securities]] have attracted international [[cryptocurrency]] investors, though adoption has been slower than initially projected
		- **[[Economic Impact]]**: [[Remittances]] constitute 24% of El Salvador's GDP, and [[Bitcoin]]-based [[remittance]] services have reduced [[transaction costs]] by an average of 3.5% compared to traditional [[Western Union]] and [[MoneyGram]] services. Approximately $400 million in annual [[remittances]] now flow through [[Lightning Network]] channels.{{[[cite]]}} [World Bank Remittance Prices Worldwide 2025]
		...
		- **[[L402 Protocol]] Architecture**: [[L402]] combines [[Lightning Network]] [[invoices]] with [[macaroon]]-based [[authentication tokens]] to enable [[pay-per-use]] [[APIs]], [[content]], and [[services]]. The protocol flow:
			...
			- Server responds with [[402 Payment Required]] and an [[L402 challenge]] containing a [[Lightning invoice]]
			- Client pays the [[invoice]] via [[Lightning Network]]
			- Server returns [[macaroon token]] with [[proof of payment]]
			- Client uses [[token]] for [[authenticated access]] to the [[resource]]
		- **[[X402 Protocol]] Enhancements (2025)**: [[X402]] extends [[L402]] with:
			- **[[Multi-payment channels]]**: Support for [[atomic multipath payments]] and [[payment streams]]
			- **[[Dynamic pricing]]**: [[Real-time]] [[pricing]] adjustments based on [[demand]], [[bandwidth]], or [[computational resources]]
			- **[[Denomination flexibility]]**: [[Satoshi]]-level [[micropayments]] for [[API calls]], [[data packets]], or [[milliseconds]] of [[video streaming]]
			- **[[Programmable payments]]**: [[Smart contract]]-like conditions for [[payment release]] and [[service delivery]]
		- **[[Use Cases]] for [[L402]]/[[X402]]**:
			- **[[API monetization]]**: [[Developers]] can charge per [[API call]] instead of [[subscription]] models, enabling [[pay-as-you-go]] [[services]]
			- **[[Content paywalls]]**: [[Publishers]] can charge [[micropayments]] for individual [[articles]], [[videos]], or [[podcasts]] without [[subscription]] barriers
			- **[[AI model access]]**: [[Machine learning]] [[APIs]] charge per [[inference]] or [[token]] generated
		...
		- **[[AI Agent]] [[Payment Architecture]]**:
			...
			- **[[L402]]/[[X402]] integration**: [[AI agents]] automatically pay for [[resources]], [[data]], and [[services]] using [[micropayment protocols]]
			- **[[Smart contracts]]** and [[DLCs]]**: [[Discreet Log Contracts]] enable [[AI agents]] to engage in [[conditional payments]] and [[trustless escrow]]
			- **[[Machine-readable invoices]]**: [[BOLT11]] [[invoices]] and [[BOLT12]] [[offers]] provide [[machine-parseable]] [[payment requests]]
		- **[[Use Cases]] for [[AI-Agent Payments]]**:
			- **[[Data markets]]**: [[AI models]] purchase [[training data]], [[real-time feeds]], or [[specialized datasets]] from other [[agents]] or [[data providers]]
			- **[[Compute marketplaces]]**: [[Agents]] pay for [[GPU time]], [[inference]] runs, or [[cloud compute]] resources on-demand
			- **[[Multi-agent collaboration]]**: [[AI agents]] hire other [[specialists]] for [[sub-tasks]], forming [[dynamic teams]] compensated via [[Bitcoin]]
			- **[[Reputation systems]]**: [[Payment history]] on [[Lightning Network]] serves as [[reputation score]] for [[AI agents]]
			- **[[Resource allocation]]**: [[Agents]] bid for scarce [[resources]] ([[API rate limits]], [[bandwidth]], [[priority queues]]) using [[Bitcoin auctions]]
		- **[[Economic Implications]]**: [[Bitcoin]]-native [[AI agents]] create truly [[autonomous economic actors]] that can:
			- Earn [[revenue]] by providing [[services]] ([[data analysis]], [[content generation]], [[API access]])
			- Pay [[expenses]] ([[electricity]], [[compute]], [[data subscriptions]])
			- Accumulate [[capital]] in [[Bitcoin]] for future [[investments]] or [[operations]]
			- Participate in [[markets]] without [[intermediaries]] or [[payment processors]]
		- **[[RGB Protocol]] and [[AI Assets]]**: [[RGB]] smart contracts on [[Bitcoin]] enable [[AI agents]] to issue and trade [[digital assets]], [[tokens]], or [[rights]] representing:
			- [[Intellectual property]] generated by [[AI models]]
			- [[Compute credits]] or [[resource allocations]]
			- [[Data licenses]] or [[API access rights]]
			- [[Stake]] in [[multi-agent systems]] or [[AI cooperatives]]{{[[cite]]}} [RGB Protocol Documentation 2025]
		- **[[Security Considerations]]**: [[AI agent payments]] introduce new challenges:
			- **[[Sybil attacks]]**: Preventing [[AI agents]] from creating [[fake identities]] to [[game]] [[reputation systems]]
			- **[[Payment verification]]**: Ensuring [[AI agents]] verify [[Lightning]] [[payment proofs]] correctly
			- **[[Resource exhaustion]]**: [[Rate limiting]] to prevent [[AI agents]] from overwhelming [[payment channels]]
			- **[[Privacy]]**: [[Blinded paths]] and [[onion routing]] protect [[AI agent]] [[transaction privacy]]
		- **[[Future Directions]] (2025+)**: Research focuses on:
			- **[[eCash]] for [[AI]]**: [[Cashu]] and [[Fedimint]] [[eCash]] providing [[privacy-preserving]] [[AI payments]]
		...
		- **[[Multi-faceted Monetary Role]]**: As of 2025, [[Bitcoin]] functions simultaneously as:
			...
			- **[[Legal tender]]**: Official [[currency]] in [[El Salvador]] and experimental [[adoption]] elsewhere
			- **[[Programmable money]]**: [[Infrastructure]] for [[AI agents]], [[IoT devices]], and [[machine commerce]]
		- **[[Network Effects]]**: [[Bitcoin]]'s [[monetary properties]] strengthen through:
			- Growing [[merchant acceptance]] and [[payment infrastructure]]
			- [[Regulatory clarity]] in major [[jurisdictions]]
			- [[Layer 2]] innovations ([[Lightning]], [[RGB]], [[Ark]], [[statechains]])
			- Integration with emerging [[technologies]] ([[AI]], [[IoT]], [[Web3]])
		- **[[Open Questions]]**: [[Bitcoin]]'s evolution as [[money]] depends on:
			- Resolution of [[scalability]] vs [[decentralization]] tradeoffs
			- [[Regulatory]] frameworks balancing [[innovation]] and [[consumer protection]]
			- [[Adoption]] curves among [[merchants]], [[consumers]], and [[institutions]]
