...
- is-part-of:: [[Physiological Computing System]]
- has-part:: [[Signal Processing Unit]]
- has-part:: [[Electroencephalography Sensor]]
- has-part:: [[Electrocardiogram Sensor]]
- has-part:: [[Galvanic Skin Response Sensor]]
- has-part:: [[Pulse Oximeter]]
- requires:: [[Skin Contact Electrodes]]
- requires:: [[Wireless Communication Module]]
- requires:: [[Power Supply]]
- requires:: [[Analog-to-Digital Converter]]
- enables:: [[Biofeedback Systems]]
- enables:: [[Stress Monitoring]]
- enables:: [[Emotional State Detection]]
- enables:: [[Adaptive Virtual Experience]]
- depends-on:: [[XR Headset]]
- depends-on:: [[Cloud Analytics Service]]
- depends-on:: [[Wearable Computing Platform]]
