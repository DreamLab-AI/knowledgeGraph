schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/robotics#BiosensingInterface
legacy_uri:: urn:visionclaw:concept:robotics:biosensing-interface
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-029c8a04c21e"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/robotics#BiosensingInterface"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:robotics:biosensing-interface"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
