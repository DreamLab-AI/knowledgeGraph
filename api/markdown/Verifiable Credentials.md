schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#VerifiableCredentials
legacy_uri:: urn:visionclaw:concept:blockchain:verifiable-credentials
public:: true
...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "verifiable-credentials",
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-78660106f6bd"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#VerifiableCredentials"
    },
    {
    ...
    },
    {
      ...
      "vc:value": "Verifiable Credentials"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:verifiable-credentials"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:verifiable-credentials:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[Centralised Identity Provider]]",
      "resolved": "urn:visionflow:linked:centralised-identity-provider",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Credential Status]]",
      "resolved": "urn:visionflow:linked:credential-status",
      "kind": "StubLink"
    },
    {
      "raw": "[[Credential Subject]]",
      "resolved": "urn:visionflow:linked:credential-subject",
      "kind": "StubLink"
    },
    {
      "raw": "[[Cross-Border Identity Recognition]]",
      "resolved": "urn:visionflow:linked:cross-border-identity-recognition",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[EUDI Wallet]]",
      "resolved": "urn:visionflow:linked:eudi-wallet",
      "kind": "StubLink"
    },
    {
      "raw": "[[European Commission eIDAS]]",
      "resolved": "urn:visionflow:linked:european-commission-e-idas",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Healthcare Data Interoperability]]",
      "resolved": "urn:visionflow:linked:healthcare-data-interoperability",
      "kind": "StubLink"
    },
    {
      "raw": "[[IdentityDomain]]",
    ...
    {
      "raw": "[[mDL ISO 18013-5]]",
      "resolved": "urn:visionflow:linked:m-dl-iso-18013-5",
      "kind": "StubLink"
    },
    {
      "raw": "[[OAuth2 Token]]",
      "resolved": "urn:visionflow:linked:oauth2-token",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Proof Method]]",
      "resolved": "urn:visionflow:linked:proof-method",
      "kind": "StubLink"
    },
    {
      "raw": "[[SAML Assertion]]",
      "resolved": "urn:visionflow:linked:saml-assertion",
      "kind": "StubLink"
    },
    {
      "raw": "[[SD-JWT]]",
    ...
    {
      "raw": "[[Verifiable Presentation]]",
      "resolved": "urn:visionflow:linked:verifiable-presentation",
      "kind": "StubLink"
    },
    {
      "raw": "[[W3C]]",
    ...
    {
      "raw": "[[W3C Data Integrity]]",
      "resolved": "urn:visionflow:linked:w3-c-data-integrity",
      "kind": "StubLink"
    },
    {
      "raw": "[[W3C Standard]]",
...
- ### Definition
  - Cryptographically secured, tamper-evident digital credentials standardised by the W3C Verifiable Credentials Data Model v2.0 (May 2025 REC) that encode machine-verifiable claims about subjects — enabling a holder/issuer/verifier triangle in which issuers sign claims with DIDs, holders selectively disclose attributes using BBS+ or SD-JWT techniques, and verifiers confirm authenticity offline without contacting the issuer. The ecosystem encompasses JSON-LD and JWT/SD-JWT serialisations, revocation via Bitstring Status List v1.0, mobile driving licences under ISO 18013-5/7, the EU Digital Identity (EUDI) Wallet Architecture Reference Framework (ARF 1.4, 2024–2026), and OpenID4VCI/OpenID4VP presentation protocols — collectively displacing paper and siloed digital credentials across government identity, healthcare, education, and supply-chain provenance domains.

- ### Semantic Classification
  - owl-class:: blockchain:VerifiableCredentials
  - owl-role:: IdentityCredentialProtocol
  - owl-inferred:: blockchain:DecentralisedIdentity, blockchain:CryptographicProofSystem, blockchain:SelectiveDisclosureMechanism
  - belongs-to-domain:: [[BlockchainDomain]], [[IdentityDomain]], [[CryptographyDomain]]
  - implemented-in-layer:: [[ProtocolLayer]], [[ApplicationLayer]], [[PolicyLayer]]

- ### Relationships
  - is-subclass-of:: [[Digital Identity]], [[Cryptographic Proof]], [[Distributed Identity]], [[Self-Sovereign Identity]], [[W3C Standard]]
  - has-part:: [[Verifiable Credential]], [[Verifiable Presentation]], [[Credential Schema]], [[Proof Method]], [[Credential Status]], [[Selective Disclosure], [[Credential Subject]]
  - requires:: [[Decentralised Identifiers]], [[Digital Signature]], [[Cryptography Security and Privacy]], [[Trust Framework]], [[DID Document]]
  - enables:: [[Self-Sovereign Identity]], [[Privacy-Preserving Identity]], [[Selective Disclosure]], [[Offline Verification]], [[Cross-Border Identity Recognition]]
  - implements:: [[BBS+ Signature]], [[SD-JWT]], [[JSON-LD]], [[JSON Web Token]], [[Bitstring Status List]], [[OpenID4VC]], [[mDL ISO 18013-5]]
  - depends-on:: [[Decentralised Identifiers]], [[Public Key Infrastructure]], [[Zero-Knowledge Proofs]], [[W3C Data Integrity]], [[CBOR]]
  - supports:: [[Digital Identity Wallet]], [[EUDI Wallet]], [[GOV.UK One Login]], [[AML KYC Compliance]], [[Healthcare Data Interoperability]]
  - uses:: [[Elliptic Curve Cryptography]], [[EdDSA]], [[ECDSA]], [[JSON-LD]], [[OpenID4VCI]], [[OpenID4VP]], [[DIDComm]]
  - contrasts-with:: [[X.509 Certificate]], [[SAML Assertion]], [[Federated Identity]], [[Centralised Identity Provider]], [[OAuth2 Token]]
  - related-to:: [[Digital Signature]], [[Hash Function]], [[Distributed Ledger]], [[Blockchain Network]], [[Access Control System]]
  - standardized-by:: [[W3C]], [[IETF]], [[ISO]], [[OpenID Foundation]], [[European Commission eIDAS]]
...
- ### Content
  ...
  ## Compositional Relationships (Components)
	  ...
	  FunctionalDataProperty(bc:w3cSpecVersion)
  ...
  - - David Chadwick and Stasinos Konstantopoulos. "A comparison of attribute certificates and XML/SOAP/WSDL-based approaches for access control in web services." 2003. (precursor work)
  - - Jan Camenisch and Anna Lysyanskaya. "Signature Schemes and Anonymous Credentials from Bilinear Maps." CRYPTO 2004.
  - - Dan Boneh, Xavier Boyen, and Hovav Shacham. "Short Group Signatures." CRYPTO 2004. (BBS+ foundation)
  - - Manu Sporny, Dave Longley, David Chadwick. "Verifiable Credentials Data Model v2.0." W3C Recommendation, May 2025. https://www.w3.org/TR/vc-data-model-2.0/
  - - Manu Sporny, Dave Longley, Markus Sabadello et al. "Decentralized Identifiers (DIDs) v1.0." W3C Recommendation, July 2022. https://www.w3.org/TR/did-core/
  - - European Commission. "Architecture Reference Framework 1.4 — European Digital Identity Wallet." 2024. https://github.com/eu-digital-identity-wallet/eudi-doc-architecture-and-reference-framework
  - - OpenID Foundation. "OpenID for Verifiable Credential Issuance — Final." 2024. https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html
  - - OpenID Foundation. "OpenID for Verifiable Presentations — Final." 2024. https://openid.net/specs/openid-4-verifiable-presentations-1_0.html
  - - Tobias Looker, John Bradley et al. "SD-JWT-based Verifiable Credentials (SD-JWT VC)." IETF draft-ietf-oauth-sd-jwt-vc-06. 2024.
  - - ISO/IEC 18013-5:2021. "Personal identification — ISO-compliant driving licence — Part 5: Mobile driving licence (mDL) application." ISO, 2021.
  - - ISO/IEC 18013-7:2024. "Personal identification — ISO-compliant driving licence — Part 7: Mobile driving licence (mDL) add-on functions." ISO, 2024.
  - - Tobias Looker, Vasilis Kalos, Andrew Whitehead. "BBS Signature Scheme." W3C Data Integrity BBS Cryptosuite v1 Working Draft. 2024. https://www.w3.org/TR/vc-di-bbs/
  - - W3C. "Bitstring Status List v1.0." W3C Working Group Note, May 2025. https://www.w3.org/TR/vc-bitstring-status-list/
  - - Drummond Reed, Markus Sabadello, Sam Curren. "did:peer Method Specification v2.0." DIF, 2024.
  - - Sam Goto, David Waite. "DID Web Method." DIF Specification, 2024. https://w3c-ccg.github.io/did-method-web/
  - - Darrell O'Donnell and Dan Burnett. "ToIP Technology Architecture Specification v2.0." Trust over IP Foundation, 2024.
  - - DSIT. "UK Digital Identity and Attributes Trust Framework v1.0." February 2026. https://www.gov.uk/government/publications/uk-digital-identity-and-attributes-trust-framework
  - - Daniel Fett, Brian Campbell et al. "FAPI 2.0 Security Profile." OpenID Foundation Final. 2024. https://openid.net/specs/fapi-2_0-security-profile.html
  - - Open Identity Exchange. "UK VC Interoperability Profile v1.0." OIX, 2025. https://openidentityexchange.org/
  - - GDS / Cabinet Office. "GOV.UK One Login Technical Specification." 2024. https://www.sign-in.service.gov.uk/documentation
  - - Emiliano De Cristofaro, Claude Castelluccia. "Privacy-Preserving Attribute-Based Credential Systems." ACM CCS 2022. (UCL contribution)
  - - Ross Anderson. "Security Engineering." 3rd ed., Chapter 21 (Identity Management). Wiley, 2020. (Cambridge contribution)
  - - University of Edinburgh, Informatics. "Formal Verification of DID Resolution Security." PETS 2025.
  - - NIST. "FIPS 204 ML-DSA (CRYSTALS-Dilithium) Standard." August 2024. https://csrc.nist.gov/pubs/fips/204/final
  - - Hyperledger Foundation. "AnonCreds Specification v2.0 — BBS+ Integration." 2025. https://hyperledger.github.io/anoncreds-spec/
  - - Fabian Vogelsteller and others. "W3C Verifiable Credentials Implementation Guide." 2024. https://www.w3.org/TR/vc-imp-guide/
...
- ### Provenance
  - primary-standard:: W3C Verifiable Credentials Data Model v2.0 (May 2025 REC)
  - secondary-standards::
