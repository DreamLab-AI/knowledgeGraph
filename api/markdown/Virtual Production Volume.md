schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#VirtualProductionVolume
legacy_uri:: urn:visionclaw:concept:spatial-computing:virtual-production-volume
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-a0b9da0aa9c3"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#VirtualProductionVolume"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:virtual-production-volume"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
