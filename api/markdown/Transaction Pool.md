schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#TransactionPool
legacy_uri:: urn:visionclaw:concept:blockchain:transaction-pool
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-5dffddda117e"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#TransactionPool"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:transaction-pool"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:142e26c735ce337e1a3e8974cf73a0b2dcb30c82d5287188b059676aba3cc870@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
