...
```json-ld
{ "@context":"https://narrativegoldmine.com/ns/v1", "@id":"urn:visionflow:page:proof-theory", "@type":"Page", "title":"Proof Theory", "vc:slug":"proof-theory", "vc:public":true, "vc:schemaVersion":2, "vc:outboundWikilinks":[] }
```
...
```json-ld
{
  ...
  "subClassOf":[{"@id":"urn:ngm:class:logic","label":"Logic"}],
  "relations":{
    "partOf":[{"@id":"urn:ngm:class:logic","label":"Logic"}]
  },
  "sameAs":[],
  "quality":0.6,
