schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#CentralBankDigitalCurrencyCBDC
legacy_uri:: urn:visionclaw:concept:infrastructure:central-bank-digital-currency-cbdc
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-a1ff31cbe48d"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#CentralBankDigitalCurrencyCBDC"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:central-bank-digital-currency-cbdc"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
