```json-ld
{
  ...
  "@id": "urn:visionflow:page:probabilistic-programming",
  "@type": "Page",
  "title": "Probabilistic Programming",
  "vc:slug": "probabilistic-programming",
  "vc:public": true,
  "vc:schemaVersion": 2,
...
- ### Overview
  - The central promise of probabilistic programming is to make Bayesian modelling as accessible as ordinary programming: the user writes down how data [private] have been generated, and the system infers the posterior distribution over unknown quantities given observations.
