schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#PerformanceOptimization
legacy_uri:: urn:visionclaw:concept:infrastructure:performance-optimization
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-90f3a748e362"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#PerformanceOptimization"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:performance-optimization"
    },
    {
      "vc:key": "status",
      "vc:value": "active"
