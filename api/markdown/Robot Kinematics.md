...
# RB-0021: Robot Kinematics
		  ...
		  **Robot Kinematics** - Study of robot motion without considering forces
		  ...
		  ```clojure
		  (Declaration (Class :RobotKinematics))
		  (SubClassOf :RobotKinematics :Robot)
		  
		  (AnnotationAssertion rdfs:label :RobotKinematics "Robot Kinematics"@en)
		  (AnnotationAssertion rdfs:comment :RobotKinematics
		    "Robot Kinematics - Foundational robotics concept"@en)
		  (AnnotationAssertion :termID :RobotKinematics "RB-0021"^^xsd:string)
		  
		  (Declaration (ObjectProperty :relates To))
		  (ObjectPropertyDomain :relatesTo :RobotKinematics)
		  
		  (Declaration (DataProperty :hasProperty))
		  (DataPropertyDomain :hasProperty :RobotKinematics)
