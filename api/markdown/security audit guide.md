schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#SecurityAuditGuide
legacy_uri:: urn:visionclaw:concept:spatial-computing:security-audit-guide
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-e99a90de1d3f"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#SecurityAuditGuide"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:security-audit-guide"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:3bc869e37c328b22479f949bccd62fde1d76176392152b8de20dd29ee5ce8612@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:security-audit-guide",
  "@type": "OntologyClass",
  ...
  "definition": "A comprehensive procedural guide establishing standards, methodologies, and frameworks for conducting security audits of [[Blockchain|blockchain systems]], [[SmartContract|smart contracts]], and [[Cryptography|cryptographic infrastructure]]. This guide enables systematic vulnerability assessment and security control evaluation.",
  "vc:qualityScore": {
    "@value": "0.50",
    "@type": "xsd:float"
  },
