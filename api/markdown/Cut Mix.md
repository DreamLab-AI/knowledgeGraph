schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#CutMix
legacy_uri:: urn:visionclaw:concept:spatial-computing:cut-mix
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-aea2c584fb6d"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#CutMix"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:cut-mix"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:33185f47a0142a3f4f35af878b569b8b3d5c3e03ab23fd9b509880b14cb312a4@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:cut-mix",
  "@type": "OntologyClass",
  "label": "Cut Mix",
  "subClassOf": [
    {
