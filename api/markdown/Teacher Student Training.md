schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#TeacherStudentTraining
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:teacher-student-training
public:: true
...
```json-ld
{
  ...
  "@id": "urn:visionflow:page:5a4db087da25c2a8c81ca4e9481bf4ea842598728bd41115c8a417da36e93553",
  "@type": "Page",
  "vc:slug": "teacher-student-training",
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-02a95a6d3c5d"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#TeacherStudentTraining"
    },
    {
    ...
    },
    {
      ...
      "vc:value": "Teacher Student Training"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:teacher-student-training"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:5a4db087da25c2a8c81ca4e9481bf4ea842598728bd41115c8a417da36e93553@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:teacher-student-training",
  "@type": "OntologyClass",
  "label": "Teacher Student Training",
  "subClassOf": [
    {
      "@id": "urn:visionflow:owl:class:training-method",
      "vc:label": "Training Method"
    }
  ],
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:teacher-student-training:776c802a9fc9",
...
- ### Content
  ...
  If you intended to query about **AI literacy and teacher training in UK schools**, I can readily provide that content using the supplied search results. Alternatively, if you require the machine learning ontology entry, please supply search results specific to knowledge distillation, model compression, or neural network training paradigms.
