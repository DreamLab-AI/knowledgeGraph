```json-ld
{
  ...
  "@id": "urn:visionflow:page:financial-market-infrastructure",
  "@type": "Page",
  "title": "Financial Market Infrastructure",
  "vc:slug": "financial-market-infrastructure",
  "vc:public": true,
  "vc:schemaVersion": 2,
...
- ### Overview
	...
	- Because their failure [private] cascade across the financial system, they are subject to intensive oversight by central banks and regulators.
- ### Key aspects
