schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#ResidualNetwork
legacy_uri:: urn:visionclaw:concept:spatial-computing:residual-network
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-3ff3c1d830a8"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#ResidualNetwork"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:residual-network"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:1709d2d0173b6f2977c2560cf355e6ac246004e979cd95654f3d581aa9f67848@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:residual-network",
  "@type": "OntologyClass",
