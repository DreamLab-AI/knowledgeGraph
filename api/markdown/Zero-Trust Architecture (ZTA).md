schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#ZeroTrustArchitectureZTA
legacy_uri:: urn:visionclaw:concept:spatial-computing:zero-trust-architecture-zta
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-7d3939d47fdf"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#ZeroTrustArchitectureZTA"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:zero-trust-architecture-zta"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
