schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#LiquidityProvision
legacy_uri:: urn:visionclaw:concept:blockchain:liquidity-provision
public:: true
...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:aave-protocol-whitepaper",
      "vc:label": "Aave Protocol Whitepaper"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:balancer-whitepaper",
      "vc:label": "Balancer Whitepaper"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:compound-finance-whitepaper",
      "vc:label": "Compound Finance Whitepaper"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:curve-finance-stable-swap-paper",
      "vc:label": "Curve Finance StableSwap Paper"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:flash-boys-2-0",
      "vc:label": "Flash Boys 2.0"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:incentive-layer",
      "vc:label": "IncentiveLayer"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:uniswap-foundation-v4-specification",
      "vc:label": "Uniswap Foundation V4 Specification"
    },
    {
  ...
  "vc:legacyProperties": [
    {
      ...
      "vc:value": "LP, Automated Market Making, DeFi Liquidity, Liquidity Mining, AMM Liquidity"
    },
    {
    ...
    {
      "vc:key": "bridges-to",
      "vc:value": "[[Decentralized Finance (DeFi)]], [[Automated Market Maker]], [[Market Making]]"
    },
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-lp9f4a2b7c8d"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#LiquidityProvision"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:liquidity-provision"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:liquidity-provision:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[Aave Protocol Whitepaper]]",
      "resolved": "urn:visionflow:linked:aave-protocol-whitepaper",
      "kind": "StubLink"
    },
    {
      "raw": "[[Arbitrum]]",
    ...
    {
      "raw": "[[Balancer Whitepaper]]",
      "resolved": "urn:visionflow:linked:balancer-whitepaper",
      "kind": "StubLink"
    },
    {
      "raw": "[[Block Proposer]]",
      "resolved": "urn:visionflow:linked:block-proposer",
      "kind": "StubLink"
    },
    {
      "raw": "[[Capital Deployment]]",
      "resolved": "urn:visionflow:linked:capital-deployment",
      "kind": "StubLink"
    },
    {
      "raw": "[[Capital Efficiency]]",
      "resolved": "urn:visionflow:linked:capital-efficiency",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Chainlink Oracle]]",
      "resolved": "urn:visionflow:linked:chainlink-oracle",
      "kind": "StubLink"
    },
    {
      "raw": "[[Compound]]",
    ...
    {
      "raw": "[[Compound Finance Whitepaper]]",
      "resolved": "urn:visionflow:linked:compound-finance-whitepaper",
      "kind": "StubLink"
    },
    {
      "raw": "[[Concentrated Liquidity]]",
      "resolved": "urn:visionflow:linked:concentrated-liquidity",
      "kind": "StubLink"
    },
    {
      "raw": "[[Constant Product Formula]]",
      "resolved": "urn:visionflow:linked:constant-product-formula",
      "kind": "StubLink"
    },
    {
      "raw": "[[Convex Finance]]",
    ...
    {
      "raw": "[[Curve Finance StableSwap Paper]]",
      "resolved": "urn:visionflow:linked:curve-finance-stable-swap-paper",
      "kind": "StubLink"
    },
    {
      "raw": "[[dYdX]]",
    ...
    {
      "raw": "[[Decentralised Lending]]",
      "resolved": "urn:visionflow:linked:decentralised-lending",
      "kind": "StubLink"
    },
    {
      "raw": "[[EIP-1559]]",
    ...
    {
      "raw": "[[FATF DeFi Guidance]]",
      "resolved": "urn:visionflow:linked:fatf-de-fi-guidance",
      "kind": "StubLink"
    },
    {
      "raw": "[[Fee Tier]]",
      "resolved": "urn:visionflow:linked:fee-tier",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Financial Mechanism]]",
      "resolved": "urn:visionflow:linked:financial-mechanism",
      "kind": "StubLink"
    },
    {
      "raw": "[[Flash Boys 2.0]]",
      "resolved": "urn:visionflow:linked:flash-boys-2-0",
      "kind": "StubLink"
    },
    {
      "raw": "[[Flash Loan]]",
    ...
    {
      "raw": "[[Gauge Weight]]",
      "resolved": "urn:visionflow:linked:gauge-weight",
      "kind": "StubLink"
    },
    {
      "raw": "[[GMX]]",
    ...
    {
      "raw": "[[GSR]]",
      "resolved": "urn:visionflow:linked:gsr",
      "kind": "StubLink"
    },
    {
      "raw": "[[Hooks Architecture]]",
      "resolved": "urn:visionflow:linked:hooks-architecture",
      "kind": "StubLink"
    },
    {
      "raw": "[[Hyperliquid]]",
      "resolved": "urn:visionflow:linked:hyperliquid",
      "kind": "StubLink"
    },
    {
      "raw": "[[Impermanent Loss]]",
      "resolved": "urn:visionflow:linked:impermanent-loss",
      "kind": "StubLink"
    },
    {
      "raw": "[[IncentiveLayer]]",
      "resolved": "urn:visionflow:linked:incentive-layer",
      "kind": "StubLink"
    },
    {
      "raw": "[[JIT Liquidity]]",
      "resolved": "urn:visionflow:linked:jit-liquidity",
      "kind": "StubLink"
    },
    {
      "raw": "[[Jump Crypto]]",
    ...
    {
      "raw": "[[Limit Order Protocol]]",
      "resolved": "urn:visionflow:linked:limit-order-protocol",
      "kind": "StubLink"
    },
    {
      "raw": "[[Liquid Staking]]",
    ...
    {
      "raw": "[[Liquidity Mining Reward]]",
      "resolved": "urn:visionflow:linked:liquidity-mining-reward",
      "kind": "StubLink"
    },
    {
      "raw": "[[LP Token]]",
    ...
    {
      "raw": "[[MEV-Boost]]",
      "resolved": "urn:visionflow:linked:mev-boost",
      "kind": "StubLink"
    },
    {
      "raw": "[[MEV Extraction]]",
      "resolved": "urn:visionflow:linked:mev-extraction",
      "kind": "StubLink"
    },
    {
      "raw": "[[MiCA Regulation]]",
    ...
    {
      "raw": "[[Order Book Exchange]]",
      "resolved": "urn:visionflow:linked:order-book-exchange",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Perpetual DEX]]",
      "resolved": "urn:visionflow:linked:perpetual-dex",
      "kind": "StubLink"
    },
    {
      "raw": "[[Price Oracle]]",
    ...
    {
      "raw": "[[Price Range]]",
      "resolved": "urn:visionflow:linked:price-range",
      "kind": "StubLink"
    },
    {
      "raw": "[[Protocol Revenue]]",
      "resolved": "urn:visionflow:linked:protocol-revenue",
      "kind": "StubLink"
    },
    {
      "raw": "[[Protocol Treasury]]",
      "resolved": "urn:visionflow:linked:protocol-treasury",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[StableSwap Invariant]]",
      "resolved": "urn:visionflow:linked:stable-swap-invariant",
      "kind": "StubLink"
    },
    {
      "raw": "[[Stablecoin Peg]]",
      "resolved": "urn:visionflow:linked:stablecoin-peg",
      "kind": "StubLink"
    },
    {
      "raw": "[[Tick]]",
      "resolved": "urn:visionflow:linked:tick",
      "kind": "StubLink"
    },
    {
      "raw": "[[Token Swap]]",
      "resolved": "urn:visionflow:linked:token-swap",
      "kind": "StubLink"
    },
    {
      "raw": "[[Traditional Market Maker]]",
      "resolved": "urn:visionflow:linked:traditional-market-maker",
      "kind": "StubLink"
    },
    {
      "raw": "[[TWAP Oracle]]",
      "resolved": "urn:visionflow:linked:twap-oracle",
      "kind": "StubLink"
    },
    {
      "raw": "[[Uniswap]]",
    ...
    {
      "raw": "[[Uniswap Foundation V4 Specification]]",
      "resolved": "urn:visionflow:linked:uniswap-foundation-v4-specification",
      "kind": "StubLink"
    },
    {
      "raw": "[[Uniswap V3 Core Whitepaper]]",
      "resolved": "urn:visionflow:linked:uniswap-v3-core-whitepaper",
      "kind": "StubLink"
    },
    {
      "raw": "[[Vote-Escrowed Token]]",
      "resolved": "urn:visionflow:linked:vote-escrowed-token",
      "kind": "StubLink"
    },
    {
      "raw": "[[Weighted Pool Invariant]]",
      "resolved": "urn:visionflow:linked:weighted-pool-invariant",
      "kind": "StubLink"
    },
    {
      "raw": "[[Wintermute]]",
      "resolved": "urn:visionflow:linked:wintermute",
      "kind": "StubLink"
    },
    {
      "raw": "[[Yield Farming]]",
...
- ### Definition
  - **Liquidity Provision** is the decentralised financial mechanism whereby cryptocurrency holders deposit paired or single-asset collateral into [[Automated Market Maker]] smart-contract pools to enable continuous permissionless [[Token Swap]] without traditional counterparties or order books, earning transaction fee revenue proportional to pool share in exchange for bearing [[Impermanent Loss]] risk arising from price divergence between held assets. The practice encompasses a spectrum of algorithmic pricing architectures beginning with Uniswap V2's constant-product invariant x·y = k (where x and y denote pool reserves of two [[ERC-20 Token]]s, the product k remains constant absent fee accrual, and marginal price equals -y/x²), advancing through Uniswap V3 concentrated liquidity (Adams, Zinsmeister et al. 2021) enabling providers to specify tick-bounded price ranges [p_a, p_b] and contribute virtual reserves x_virtual = L/√p_b − L/√p and y_virtual = L(√p − √p_a) where L denotes liquidity depth, achieving up to 4,000× capital efficiency on stable pairs versus V2, and culminating in [[Uniswap]] V4 launched January 2025 introducing singleton architecture with programmable hooks (arbitrary before/after-swap callbacks executing within the same transaction), flash accounting eliminating intermediate [[ERC-20 Token]] transfers, and native ETH support reducing gas costs by orders of magnitude. Beyond the Uniswap lineage, [[Curve Finance]] StableSwap employs the invariant Aₙⁿ·∑xᵢ + D = Aₙⁿ·D + Dⁿ⁺¹/(nⁿ·∏xᵢ) with amplification parameter A blending constant-sum and constant-product behaviour to minimise slippage near peg for stablecoins and correlated assets, while [[Balancer]] weighted pools generalise constant-product to N-asset portfolios with arbitrary weight vectors ∏ᵢ Bᵢ^wᵢ = k where wᵢ are normalised weights. The domain extends to perpetual [[Decentralized Exchange]] liquidity: [[dYdX]] operating as sovereign Cosmos app-chain, [[Hyperliquid]] on proprietary HyperBFT L1 with $3–8B daily volume by 2025–2026, and [[GMX]] employing oracle-priced GLP multi-asset pool counterparty provision on [[Arbitrum]]. Professional institutional market-makers including Wintermute, Jump Crypto, and GSR bridge centralised exchange ([[Centralised Exchange]]) and decentralised liquidity simultaneously. [[Liquidity Mining]] incentive programmes (Compound COMP distribution from June 2020, Aave safety module rewards, MakerDAO Peg Stability Module) shaped the yield-farming ecosystem underpinning combined DeFi TVL of $85–120B as of mid-2025. Impermanent loss is quantified IL = 2√r/(1+r) − 1 where r = P_final/P_initial denoting the price ratio change, ranging from negligible for stable pairs (r ≈ 1, IL < 0.1%) to severe for volatile pairs (r = 4×, IL ≈ 25%), partially offset by fee income; research by Capponi and Jia (2021) and Milionis et al. (2022) formalises the equivalent "loss-versus-rebalancing" (LVR) metric, proportional to σ²/8 per unit time where σ is asset volatility, providing path-independent LP cost measurement that supersedes IL for protocols and sophisticated analysis.

- ### Semantic Classification
  - owl-class:: blockchain:LiquidityProvision
  - owl-role:: DecentralisedMarketMechanism
  - owl-inferred:: blockchain:AutomatedMarketMaking, blockchain:YieldGeneration, blockchain:CapitalDeployment, blockchain:DecentralisedFinance
  - belongs-to-domain:: [[BlockchainDomain]], [[DecentralisedFinanceDomain]], [[FinancialMarketsDomain]], [[CryptographyDomain]]
  - implemented-in-layer:: [[SmartContractLayer]], [[ProtocolLayer]], [[ApplicationLayer]], [[IncentiveLayer]]

- ### Relationships
  - is-subclass-of:: [[Decentralized Finance (DeFi)]], [[Market Making]], [[Yield Generation]], [[Capital Deployment]], [[Financial Mechanism]]
  - has-part:: [[Liquidity Pool]], [[LP Token]], [[Fee Tier]], [[Price Range]], [[Tick]], [[Gauge Weight]], [[Impermanent Loss]], [[Liquidity Mining Reward]]
  ...
  - related-to:: [[Uniswap]], [[Curve Finance]], [[Balancer]], [[Aave]], [[Compound]], [[MakerDAO]], [[dYdX]], [[Hyperliquid]], [[GMX]], [[Wintermute]], [[Jump Crypto]], [[GSR]], [[Convex Finance]]
  - standardized-by:: [[ERC-20 Token Standard]], [[EIP-1559]], [[Uniswap V3 Core Whitepaper]], [[MiCA Regulation]], [[FATF DeFi Guidance]]
...
- ### Content
  ...
  ## Compositional Relationships (Components)
	  ...
	  FunctionalDataProperty(blockchain:globalTVLBillionsUSD)
	  FunctionalDataProperty(blockchain:uniswapV3CapitalEfficiencyGain)
	  ```
  ...
  - ### Core Pricing Mechanisms and Protocol Families
	  ...
	  **Uniswap V3** (deployed May 2021) represents the most consequential AMM innovation, introducing concentrated liquidity whereby providers specify a price range [p_a, p_b] within which their capital is active.
	  ...
	  V3 governance (operated by [[Governance Token]] UNI holders) can add new fee tiers via on-chain vote and activate/deactivate the protocol fee switch per pool. As of Q1 2026, Uniswap V3 commands approximately $3–6B TVL across Ethereum mainnet ($2–4B), [[Arbitrum]] ($500M–1B), [[Optimism]] ($200–400M), Base ($300–500M), Polygon ($100–200M), and 8+ additional EVM chains.
  ...
  - #### Curve Finance: StableSwap Invariant and the Gauge Wars
	  ...
	  **[[Curve Finance]]** (launched January 2020, founded by Michael Egorov, legal entity StableSwiss AG, Zug, Switzerland) pioneered stablecoin AMM liquidity with the **StableSwap invariant**:
	  ...
	  The Curve ecosystem introduces **veCRV** (vote-escrowed CRV): users lock CRV [[Governance Token]]s for 1 week to 4 years, receiving veCRV proportional to lock duration (1 CRV locked 4 years = 1 veCRV; 1 CRV locked 1 year = 0.25 veCRV).
	  ...
	  **[[Convex Finance]]** (launched May 2021 by pseudonymous team including 0xChad) built the dominant veCRV aggregator, holding approximately 47–52% of all outstanding veCRV by 2023–2024. **Votium** and **Hidden Hand** operate bribe markets where protocols pay weekly payments to veCRV/Convex delegates for gauge voting support. Bribe volumes peaked at $30–60M/month in the 2022–2023 DeFi bull market.
	  ...
	  Notable Curve Wars combatants: Frax Finance (accumulating $400M+ CRV 2021–2022), Abracadabra Money ($200M+ bribes paid 2021–2022), and Terra/Luna's $4B attempt to dominate the 4pool (the May 2022 Terra collapse destabilised multiple Curve pools).
  ...
  - #### Balancer: Generalised N-Asset Weighted Pools
	  ...
	  **Balancer V2** (May 2021) introduced the Vault architecture: all pool tokens custodied in a single central contract, with pool logic delegated to separate Pool contracts implementing specific invariants. This enables gas-efficient internal swaps (balance updates without ERC-20 transfers), [[Flash Loan]]s across all pools, and atomic multi-hop swaps through diverse pool types.
  ...
  - ### JIT Liquidity, MEV, and Advanced LP Strategies
	  ...
	  **Just-in-time (JIT) liquidity** emerged as a distinctive MEV strategy in Uniswap V3 exploiting concentrated liquidity NFT positions.
	  ...
	  Since the position exists only for the duration of a single block (~12 seconds on Ethereum), the attacker captures a disproportionate fee share without bearing long-term IL risk. JIT attacks peak on swap sizes above $500k–$1M in pools with concentrated existing liquidity.
	  ...
	  **Sandwich attacks** differ from JIT: the attacker front-runs a victim swap (buying the output token before the victim, raising its price), allows the victim swap to execute at degraded price, then back-runs (selling the token back at the elevated price).
	  ...
	  [[MEV-Boost]] (Ethereum Proof-of-Stake MEV relay network, launched September 2022 by Flashbots) separates block building from proposing: sophisticated block builders (Flashbots, BloXroute, Titan Builder, Beaver Build) aggregate MEV bundles from searchers, extracting $500M–$1.5B annually.
  ...
  - ### Perpetual DEX Liquidity Provision
	  ...
	  **[[Hyperliquid]]** (launched beta 2023, mainnet 2023; anonymous founding team with backgrounds reported as ex-Hudson River Trading; Hyper Foundation, Cayman Islands) operates the **HyperBFT consensus** L1 achieving 200,000 TPS (claimed), sub-1-second block finality, and EVM compatibility via HyperEVM (launched Q1 2025).
	  ...
	  The **HYPE token** airdrop (November 2024: 310M tokens to community, zero VC allocation, zero team cliff) distributed $7–12B FDV tokens to 94,000 eligible wallets, becoming the largest proportional DeFi airdrop by value. Subsequent HYPE market cap reached $5–15B by early 2026.
	  ...
	  **GMX V2** (August 2023) introduced isolated market pools (GM tokens per asset pair) with separate collateral and index tokens, configurable max utilisation, and synthetic market support. V2 daily volume: $200–500M; V2 TVL: $300–600M as of early 2026.
  - ### Professional Market Making: Bridging CEX and DEX
	  ...
	  **Wintermute** (founded 2017 by Evgeny Gaevoy, ex-Optiver Amsterdam; headquarters Spitalfields, London EC1; FCA registered Cryptoasset Business) is the leading algorithmic market-maker for digital assets, providing two-sided quotes on 50+ [[Centralised Exchange]]s and major DEXes including Uniswap V3/V4 concentrated positions, CoW Protocol RFQ, 1inch Fusion, and Paraswap Delta. Total capital under management estimated $5–10B by 2025.
	  ...
	  **[[Jump Crypto]]** (crypto division of Jump Trading LLC; Chicago headquarters; FCA registered) provides market-making and venture capital services. Jump's role in the Wormhole bridge hack (February 2022, $320M WETH stolen) demonstrated systemic importance: Jump self-funded the $320M replenishment within 24 hours.
	  ...
	  **CEX vs DEX market-making mechanics**: CEX market-making involves direct FIX/WebSocket API integration with exchange matching engines, resting limit orders at sub-millisecond update frequency, and tiered maker-rebate programmes (Binance makers: −0.005% to −0.02% fee rebate). Net margins: 0.5–5 bps round-trip for highly competitive markets (BTC/USDT), 5–50 bps for mid-cap assets.
	  ...
	  DEX market-making on Ethereum mainnet involves broadcasting transactions at 300–500ms settlement latency (12s block time), managing gas costs of $0.50–$10 per rebalance transaction, and competing with MEV bots in the mempool. Arbitrum/Optimism DEX market-making achieves 100–300ms effective latency at gas costs of $0.01–$0.50 per transaction.
  ...
  - ### Liquidity Mining and Protocol Incentive Architecture
	  ...
	  **[[Liquidity Mining]]** — distributing [[Governance Token]]s as rewards for providing on-chain liquidity — was launched by Compound Finance's COMP token distribution beginning June 2020, triggering "DeFi Summer" and unprecedented capital flow into DeFi.
	  ...
	  **[[Aave]]** (rebranded from ETHLend November 2020; Aave Companies founded by Stani Kulechov; London team at 22 Bishopsgate EC2) pioneered [[Flash Loan]]s (atomically borrowed and repaid within one transaction), aTokens (interest-bearing ERC-20 tokens representing deposits), and the Safety Module (stkAAVE: users stake AAVE tokens as last-resort shortfall insurance).
  ...
  - ### LP Economics: Quantitative Framework
	  ...
	  A $10M TVL pool with $5M/day volume at 0.30% fee generates $15,000/day for all LPs combined (0.15% daily, ~55% APY).

	  In practice, fee income concentrates in narrow price ranges for V3: a $1M concentrated position covering ±2% around current price might earn equivalent to a $10M V2 position if the pool's active tick range matches the concentrated position.
  ...
  - Gas costs represent a hidden return drag for LP strategies with frequent rebalancing. On Ethereum mainnet (2025 gas costs with EIP-4844 blob pricing): Uniswap V4 swap costs ~50,000-70,000 gas (~$0.50-$2.00 at 20-50 gwei base fee); V4 addLiquidity ~100,000-150,000 gas (~$1-$5); V4 removeLiquidity ~80,000-120,000 gas (~$0.80-$4). A V3/V4 active LP rebalancing twice daily on Ethereum mainnet incurs $2-$12/day in gas, requiring minimum $20,000-$50,000 position size to keep gas costs below 2% of fee income. Layer-2 chains dramatically improve economics: Arbitrum One gas for Uniswap V4 swap ~$0.002-$0.05; addLiquidity ~$0.01-$0.15. Positions as small as $1,000-$5,000 are economically viable for active LP management on Arbitrum.
  ...
  - V3 Wide Range ±20% (ETH/USDC) | ±20% | 0.30% | 15-50% | −8-20% | +7-30% | Quarterly | ~$20-$100
  - V3 Medium Range ±5% (ETH/USDC) | ±5% | 0.05% | 30-100% | −10-30% | +20-70% | Monthly | ~$60-$300
  - V3 Tight Range ±1% (ETH/USDC) | ±1% | 0.05% | 80-300% | −20-60% | +60-240% | Weekly | ~$200-$1000
  ...
  - Curve DAO operates with on-chain Aragon voting requiring 51% veCRV quorum for critical changes and 15% quorum for standard parameter updates. The June 2023 CRV collateral crisis revealed governance vulnerability: Michael Egorov held 40-50% of all veCRV through his personal CRV lock, giving him effective veto power over any unfavourable governance vote while his $100M+ on-chain CRV-backed debt positions created a conflict between personal financial interests and protocol governance. The crisis was resolved through OTC sales to Jump Crypto, Wintermute, and other institutional buyers at discounted prices ($0.40/CRV vs $0.70+ market), with Egorov reducing his debt to safe levels.
  ...
  - ### Current Landscape (2026)
	  ...
	  Curve Finance commands $1.5–3B TVL in stablecoin pools, with crvUSD at $500M–1B outstanding. Michael Egorov's June 2023 CRV collateralised position crisis (over $100M in on-chain CRV-backed loans across multiple protocols, unwound via bilateral OTC sales and protocol votes) demonstrated governance-adjacent systemic risks.

	  Hyperliquid has emerged as the dominant perpetuals DEX, achieving $4–8B daily perpetuals volume by early 2026, regularly exceeding dYdX, GMX, and Drift on Solana combined. HLP vault TVL: $300–600M. HyperEVM smart contracts (Q1 2025) enabled Hyperliquid-native DeFi: lending protocols, AMM DEXes, and structured products built natively on the HyperBFT L1.
...
- ### Provenance
  - sources:: [[Uniswap V3 Core Whitepaper]], [[Curve Finance StableSwap Paper]], [[Balancer Whitepaper]], [[Flash Boys 2.0]], [[Uniswap Foundation V4 Specification]], [[Aave Protocol Whitepaper]], [[Compound Finance Whitepaper]]
  ...
  - key-references:: Adams et al. (2021) Uniswap v3 Core; Angeris et al. (2019) AMM Analysis; Capponi and Jia (2021) LVR; Milionis et al. (2022) LVR V2; Egorov (2019) StableSwap; Lambert (2021) V3 Perpetual Options; Daian et al. (2020) Flash Boys 2.0
  ...
  - last-validated:: 2026-05-17T09:00:00Z
