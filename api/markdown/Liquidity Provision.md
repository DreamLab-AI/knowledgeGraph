...
- ### Content
  ...
  - ### Core Pricing Mechanisms and Protocol Families
	  ...
	  **Uniswap V3** (deployed May 2021) represents the most consequential AMM innovation, introducing concentrated liquidity whereby providers specify a price range [p_a, p_b] within which their capital is active.
	  ...
	  V3 discretises price space into **ticks** at intervals of 1.0001 per tick (0.01% per tick), mapping price = 1.0001^i for integer tick [private] i. Fee tiers map to minimum tick spacings: 0.01% fee → 1 tick spacing; 0.05% → 10 ticks; 0.30% → 60 ticks; 1.00% → 200 ticks.
  ...
  - #### Balancer: Generalised N-Asset Weighted Pools
	  ...
	  **[[Balancer]]** (launched March 2020, founded by Fernando Martinelli and Mike McDonald; Balancer Labs incorporated Cayman Islands, primary team in Lisbon and New York) generalises AMMs beyond two-asset symmetric pools.
	  ...
	  A Balancer pool configured as 60% WETH / 40% WBTC by value passively rebalances via arbitrage whenever price moves, functioning simultaneously as an AMM and a self-rebalancing [private] fund charging 0.1–1.0% swap commission as management-equivalent fee.
  ...
  - ### Perpetual DEX Liquidity Provision
	  ...
	  **[[GMX]]** (launched [[Arbitrum]] September 2021, Avalanche December 2022; GMX DAO governance) employs the **GLP (GMX Liquidity Provider) pool**: a multi-asset [private] comprising BTC, ETH, LINK, UNI, USDC, USDT, DAI, FRAX managed by [[Chainlink Oracle]] pricing.
	  ...
	  **GMX V2** (August 2023) introduced isolated market pools (GM tokens per asset pair) with separate collateral and [private] tokens, configurable max utilisation, and synthetic market support. V2 daily volume: $200–500M; V2 TVL: $300–600M as of early 2026.
  ...
  - ### Components and Architecture
	  ...
	  **Tick and Price Space**: V3/V4 discretise price space at intervals of 1.0001 (0.01%) per tick [private] i, with price = 1.0001^i stored as sqrtPriceX96 (square root of price in Q64.96 fixed-point format).
