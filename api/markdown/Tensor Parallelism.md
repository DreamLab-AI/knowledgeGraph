...
```json-ld
{
  ...
  "relations": {
    "hasPart": [
      {"@id": "urn:ngm:class:column-parallel-linear", "label": "Column-Parallel Linear Layer"},
      {"@id": "urn:ngm:class:row-parallel-linear", "label": "Row-Parallel Linear Layer"}
    ],
    "partOf": [
    ...
    "requires": [
      ...
      {"@id": "urn:ngm:class:all-reduce", "label": "All-Reduce Collective"}
    ],
    "enables": [
    ...
    "uses": [
      {"@id": "urn:ngm:class:all-gather", "label": "All-Gather Collective"},
    ...
    "relatedTo": [
      ...
      {"@id": "urn:ngm:class:sequence-parallelism", "label": "Sequence Parallelism"}
    ]
  },
  "sameAs": [
    {"@id": "urn:ngm:class:intra-layer-model-parallelism", "label": "Intra-Layer Model Parallelism"}
  ],
  "quality": 0.72,
  "provenance": {
