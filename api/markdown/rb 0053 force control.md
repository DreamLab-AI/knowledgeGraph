schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/robotics#Rb0053ForceControl
legacy_uri:: urn:visionclaw:concept:robotics:rb-0053-force-control
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-12065121956a"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/robotics#Rb0053ForceControl"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:robotics:rb-0053-force-control"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:c4341fd22fdf05c75002007772dfc944d34bdd49582193414a062c7080c46c4f@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:rb-0053-force-control",
  "@type": "OntologyClass",
  ...
  "definition": "force control is a robotics and autonomous systems concept and a type of Control System."
}
```
...
- ### Content
  ...
  **Force Control** - Force Control in robotics systems
  ...
  ### Emerging Trends
		  ...
		  **License**: CC BY 4.0
		  **Namespace**: `https://metaverse-ontology.org/robotics/RB-0053`
