...
(Declaration (Class :Summary))

;; Annotations
(AnnotationAssertion rdfs:label :Summary "SUMMARY"@en)
(AnnotationAssertion rdfs:comment :Summary "A component of the metaverse ecosystem."@en)

;; Data Properties
(AnnotationAssertion dcterms:identifier :Summary "mv-1761742247967"^^xsd:string)
```
