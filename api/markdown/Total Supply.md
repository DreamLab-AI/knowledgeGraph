schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#TotalSupply
legacy_uri:: urn:visionclaw:concept:blockchain:total-supply
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-44b7db677cba"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#TotalSupply"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:total-supply"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:b9e83ae5c69756956fe3d92801be0de151475636f906e25d0d1f8e0cb0d5232f@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:total-supply",
  "@type": "OntologyClass",
  "label": "Total Supply",
  "subClassOf": [
    {
