...
- **Prioritized**: Miners typically order transactions by fee rate (sat/vB) to maximise revenue
...
- Optimise for total fee revenue rather than simple per-transaction sorting
...
- Analyse the distribution of pending transactions and their fee rates
...
### Fee Rate Statistics
As of late 2025, Bitcoin transaction fees have normalised following the 2024 halving and Ordinals boom:
...
- **Miner behaviour**: Increased optimization of transaction selection algorithms
...
- **Batching incentives**: Layer-2 providers batch operations to minimise on-chain footprint
...
- **Target 1-5 UTXOs**: Minimises future transaction sizes while maintaining flexibility
...
- Analyses the transition from subsidy-dominated to fee-dominated miner revenue
...
- Analyses miner incentives and strategic behaviour
...
- Identifies trends in fee estimation accuracy and user behaviour
...
- Analyses network topology and its impact on transaction propagation
...
- Mathematical modelling of transaction confirmation as a queueing system
- Analyses relationship between fees and confirmation delay
...
- Analyses game-theoretic properties of time-locked contracts
...
- Analyses miner incentives to censor or prioritize transactions
