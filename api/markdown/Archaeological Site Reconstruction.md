schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#ArchaeologicalSiteReconstruction
legacy_uri:: urn:visionclaw:concept:spatial-computing:archaeological-site-reconstruction
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-89420ebe52af"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#ArchaeologicalSiteReconstruction"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:archaeological-site-reconstruction"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
