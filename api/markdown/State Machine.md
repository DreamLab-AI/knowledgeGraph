schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/computer-science#StateMachine
legacy_uri:: urn:visionclaw:concept:computer-science:state-machine
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-9f3a14e82c01"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/computer-science#StateMachine"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:computer-science:state-machine"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:state-machine:776c802a9fc9",
  ...
  "vc:resolutions": [
    {
      "raw": "[[Accepting State]]",
      "resolved": "urn:visionflow:linked:accepting-state",
      "kind": "StubLink"
    },
    {
      "raw": "[[Actor Model]]",
    ...
    },
    {
      ...
      "resolved": "urn:visionflow:linked:computational-model",
      "kind": "StubLink"
    },
    {
    ...
    },
    {
      ...
      "resolved": "urn:visionflow:linked:concurrency-theory",
      "kind": "StubLink"
    },
    {
      "raw": "[[Dataflow Model]]",
      "resolved": "urn:visionflow:linked:dataflow-model",
      "kind": "StubLink"
    },
    {
      "raw": "[[Determinism]]",
    ...
    {
      "raw": "[[Event Model]]",
      "resolved": "urn:visionflow:linked:event-model",
      "kind": "StubLink"
    },
    {
      "raw": "[[Finite Automaton]]",
      "resolved": "urn:visionflow:linked:finite-automaton",
      "kind": "StubLink"
    },
    {
      "raw": "[[Formal Language Theory]]",
      "resolved": "urn:visionflow:linked:formal-language-theory",
      "kind": "StubLink"
    },
    {
      "raw": "[[Formal Method]]",
      "resolved": "urn:visionflow:linked:formal-method",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[IEEE 802.X]]",
      "resolved": "urn:visionflow:linked:ieee-802-x",
      "kind": "StubLink"
    },
    {
      "raw": "[[IETF RFC 9562]]",
      "resolved": "urn:visionflow:linked:ietf-rfc-9562",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Input Alphabet]]",
      "resolved": "urn:visionflow:linked:input-alphabet",
      "kind": "StubLink"
    },
    {
      "raw": "[[ISO/IEC 10746 RM-ODP]]",
      "resolved": "urn:visionflow:linked:iso-iec-10746-rm-odp",
      "kind": "StubLink"
    },
    {
      "raw": "[[OMG UML 2.5.1]]",
      "resolved": "urn:visionflow:linked:omg-uml-2-5-1",
      "kind": "StubLink"
    },
    {
      "raw": "[[Output Function]]",
      "resolved": "urn:visionflow:linked:output-function",
      "kind": "StubLink"
    },
    {
      "raw": "[[Parser]]",
      "resolved": "urn:visionflow:linked:parser",
      "kind": "StubLink"
    },
    {
      "raw": "[[Paxos]]",
    ...
    {
      "raw": "[[Petri Net]]",
      "resolved": "urn:visionflow:linked:petri-net",
      "kind": "StubLink"
    },
    {
      "raw": "[[Protocol Verification]]",
      "resolved": "urn:visionflow:linked:protocol-verification",
      "kind": "StubLink"
    },
    {
      "raw": "[[Pushdown Automaton]]",
      "resolved": "urn:visionflow:linked:pushdown-automaton",
      "kind": "StubLink"
    },
    {
      "raw": "[[Raft]]",
    ...
    {
      "raw": "[[Reactive Programming]]",
      "resolved": "urn:visionflow:linked:reactive-programming",
      "kind": "StubLink"
    },
    {
      "raw": "[[Regular Expression]]",
      "resolved": "urn:visionflow:linked:regular-expression",
      "kind": "StubLink"
    },
    {
      "raw": "[[Replicated State Machine]]",
      "resolved": "urn:visionflow:linked:replicated-state-machine",
      "kind": "StubLink"
    },
    {
      "raw": "[[Replication Log]]",
      "resolved": "urn:visionflow:linked:replication-log",
      "kind": "StubLink"
    },
    {
      "raw": "[[SCXML]]",
      "resolved": "urn:visionflow:linked:scxml",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Spring State Machine]]",
      "resolved": "urn:visionflow:linked:spring-state-machine",
      "kind": "StubLink"
    },
    {
      "raw": "[[Stack]]",
      "resolved": "urn:visionflow:linked:stack",
      "kind": "StubLink"
    },
    {
      "raw": "[[Start State]]",
      "resolved": "urn:visionflow:linked:start-state",
      "kind": "StubLink"
    },
    {
      "raw": "[[State]]",
    ...
    {
      "raw": "[[State Space]]",
      "resolved": "urn:visionflow:linked:state-space",
      "kind": "StubLink"
    },
    {
      "raw": "[[Statecharts]]",
      "resolved": "urn:visionflow:linked:statecharts",
      "kind": "StubLink"
    },
    {
      "raw": "[[Tape]]",
      "resolved": "urn:visionflow:linked:tape",
      "kind": "StubLink"
    },
    {
      "raw": "[[Transition Function]]",
      "resolved": "urn:visionflow:linked:transition-function",
      "kind": "StubLink"
    },
    {
      "raw": "[[Turing Machine]]",
    ...
    {
      "raw": "[[UI State Management]]",
      "resolved": "urn:visionflow:linked:ui-state-management",
      "kind": "StubLink"
    },
    {
      "raw": "[[UML]]",
    ...
    {
      "raw": "[[W3C SCXML]]",
      "resolved": "urn:visionflow:linked:w3-c-scxml",
      "kind": "StubLink"
    },
    {
      "raw": "[[XState]]",
      "resolved": "urn:visionflow:linked:xstate",
      "kind": "StubLink"
    },
    {
...
- ### Definition
  - StateMachine is a computational abstraction — rooted in automata theory and formal language theory — representing a system whose behaviour is determined by a finite (or structured infinite) set of discrete states, a defined alphabet of inputs or events, a transition function mapping (state × input) → next-state, and optionally an output function. Formally, a deterministic finite automaton (DFA) is the quintuple M = (Q, Σ, δ, q₀, F) where Q is the finite non-empty set of states, Σ the input alphabet, δ: Q × Σ → Q the total transition function, q₀ ∈ Q the start state, and F ⊆ Q the set of accepting states; the machine accepts string w ∈ Σ* iff δ*(q₀, w) ∈ F where δ* is the extension of δ to strings. Moore machines extend this to a sextuple (Q, Σ, Δ, δ, λ, q₀) where Δ is the output alphabet and λ: Q → Δ the state-output function, so outputs depend only on current state; Mealy machines restructure as (Q, Σ, Δ, δ, λ, q₀) with λ: Q × Σ → Δ so outputs depend on both state and current input, giving strictly equivalent expressiveness to Moore machines under bisimulation but with more compact representations for many transducers. Nondeterministic finite automata (NFA) replace δ with Δ: Q × Σ → 2^Q admitting multiple next-states; the Rabin–Scott powerset construction converts any NFA to an equivalent DFA in O(2^|Q|) states (worst-case exponential, tight for certain languages). Pushdown automata (PDA) augment FSMs with an unbounded stack Γ*, extending recognition from regular languages (Chomsky Type-3) to context-free languages (Type-2), characterised by (Q, Σ, Γ, δ, q₀, Z₀, F) where Γ is the stack alphabet and Z₀ the bottom-of-stack symbol; PDAs are the computational model underlying parsing of programming language grammars (LL/LR parsers). Turing machines (TM) further add an unbounded read/write tape, computing all partial-recursive functions and characterising the recursively enumerable (Type-0) languages; Church–Turing thesis posits TMs capture all effective computability. Hierarchical state machines — formalised by David Harel's Statecharts (1987) — introduce state nesting (AND-states for true concurrency, OR-states for alternative refinement), history pseudo-states H and H* restoring shallow/deep histories on re-entry, inter-level transitions, and broadcast events, transforming the flat FSM state-explosion problem (exponential product in concurrent subsystems) into linear specification size; Statecharts underpin UML State Diagrams (OMG UML 2.5.1) and the SCXML standard (W3C 2015). Replicated state machines (RSM) — formulated by Fred Schneider's 1990 ACM Computing Surveys tutorial "Implementing Fault-Tolerant Services Using the State Machine Approach" — replicate a deterministic automaton across f+1 nodes tolerating f Byzantine (or 2f+1 for crash) faults; correctness requires (i) all non-faulty replicas receive the same sequence of commands (total order), (ii) each applies commands deterministically, yielding identical states. Lamport's Paxos (1989/1998) and Oki–Liskov Viewstamped Replication (1988) achieve consensus-driven total ordering for crash-fault tolerance; Raft (Ongaro & Ousterhout 2014) redesigns Paxos for understandability, electing a leader who sequences log entries and replicates them before committing. Byzantine fault-tolerant variants (pBFT, Tendermint, HotStuff) tolerate actively malicious replicas. Ethereum's EVM is an RSM: all validating nodes execute the same bytecode sequence against the same global state trie (modified Merkle–Patricia trie), with consensus (originally Ethash PoW, post-Merge Casper FFG/LMD-GHOST PoS) enforcing ordering; the Yellow Paper (Gavin Wood 2014, §9) defines EVM execution formally as a state-transition function Υ(σ, T) → σ'. Smart contract semantics are precisely FSM semantics: Solidity/Vyper/Fe contracts expose a set of callable functions that effect state transitions on storage variables, with events analogous to Moore outputs; the OpenZeppelin ReentrancyGuard and Checks-Effects-Interactions pattern are FSM-correctness invariants. Layer-2 rollups (Optimistic/ZK) are themselves state machines whose canonical state is committed to Ethereum L1, with fraud proofs (Optimistic) or validity proofs (ZK-SNARKs/STARKs) serving as correctness witnesses. XState (David Khourshid, 2019–) is the predominant TypeScript/JavaScript implementation of Statecharts and the actor model, offering JSON/TypeScript machine definitions, hierarchical and parallel state nodes, guards, actions, services/actors, and first-class visualisation; XState v5 (2024) introduces the actor model as a first-class concept with createActor(), input parameters, and machine snapshots enabling server-side persistence. Spring State Machine (Pivotal/VMware 2015–) provides a Java framework for building Statechart-compliant state machines within the Spring ecosystem, supporting hierarchical states, fork/join pseudo-states, guard conditions, and persistent state via Spring Data repositories. Behaviour Trees (BT) — standard in game AI and robotics since 2005 — organise behaviours in a tree of Sequence, Fallback, Parallel, Decorator, and Action nodes, returning Success/Failure/Running ticks; BTs subsume hierarchical FSMs (Millington & Funge 2009, Colledanchise & Ögren 2018) and admit formal verification via model-checking of safety and liveness properties.

- ### Semantic Classification
  - owl-class:: computer-science:StateMachine
  - owl-role:: ComputationalAbstraction
  - owl-inferred:: cs:AutomataTheory, cs:FormalLanguageTheory, cs:ConcurrencyTheory, cs:DistributedSystemsProtocol
  - belongs-to-domain:: [[ComputerScienceDomain]], [[FormalMethodsDomain]], [[DistributedSystemsDomain]], [[SoftwareEngineeringDomain]]
  - implemented-in-layer:: [[AlgorithmLayer]], [[ProtocolLayer]], [[ApplicationLayer]], [[InfrastructureLayer]]

- ### Relationships
  - is-subclass-of:: [[Automata Theory]], [[Computational Model]], [[Formal Method]], [[Concurrency Theory]], [[Distributed Computing]]
  - has-part:: [[State]], [[Transition Function]], [[Input Alphabet]], [[Output Function]], [[Start State]], [[Accepting State]], [[Stack]], [[Tape]]
  - requires:: [[Determinism]], [[State Space]], [[Event Model]], [[Consensus Protocol]], [[Replication Log]]
  - enables:: [[Protocol Verification]], [[Fault Tolerance]], [[Smart Contract]], [[Blockchain]], [[Behaviour Tree]], [[Parser]], [[Regular Expression]]
  - implements:: [[Finite Automaton]], [[Pushdown Automaton]], [[Turing Machine]], [[Statecharts]], [[Replicated State Machine]], [[XState]], [[Spring State Machine]]
  - depends-on:: [[Formal Language Theory]], [[Information Theory]], [[Consensus Algorithm]], [[Cryptography]], [[Type Theory]]
...
- ### Content
  ...
  ## Compositional Relationships (Components)
	  ...
	  AsymmetricObjectProperty(cs:requires)
	  AsymmetricObjectProperty(cs:enables)
	  AsymmetricObjectProperty(cs:implements)
	  TransitiveObjectProperty(cs:dependsOn)
	  FunctionalDataProperty(cs:authorityScore)
	  ```
  ...
  - **Smart contracts** as state machines: a deployed contract is a persistent state machine whose storage is the state, whose public/external functions are the input alphabet, and whose events are the output alphabet. The OpenZeppelin Finite State Machine library (OpenZeppelin Contracts ≥ v4.6) provides an explicit `StateMachine` base contract with `currentState`, `canTransitionTo(bytes32)`, and `_setupTransitions()` methods. The **Checks-Effects-Interactions (CEI) pattern** is an FSM invariant: within a single transition (transaction), first validate preconditions (checks), update internal state (effects), then call external contracts (interactions) — preventing reentrancy attacks (DAO hack 2016, $60M ETH).
  - **Layer-2 rollup protocols** — Optimistic Rollups (Arbitrum, Optimism) and ZK-Rollups (StarkNet, zkSync Era, Polygon zkEVM) — are state machines themselves, with the L1 serving as the canonical state source. Optimistic Rollups transition state off-chain and post state roots to L1 with a 7-day fraud-proof window; ZK-Rollups post validity proofs (SNARK/STARK) enabling near-immediate finality. The state transition validity is enforced either by a fraud proof (optimistic) or by a succinct cryptographic argument (ZK), both grounded in the RSM model.
  ...
  - Formal semantic frameworks for smart contracts include:
    ...
    - **Solidity FSM patterns**: `enum State { Created, Locked, Inactive }` with modifier `inState(State s) { require(currentState == s); _; }` is idiomatic Solidity FSM encoding. Truffle/Hardhat test suites model transition sequences.
    - **Temporal Logic of Actions (TLA+)** (Lamport 2002): used to specify and model-check distributed protocols (Paxos, Raft, 2PC) as state machines; Amazon Web Services has published TLA+ specs for S3, DynamoDB, and EC2 distributed algorithms.
  ...
  - **XState** (David Khourshid, developed at Microsoft 2018–, open-sourced v1 2019, v4 2020, v5 2024) is the leading implementation of the actor model and Statecharts in the JavaScript/TypeScript ecosystem. Key concepts:
    - **Machine**: defined by `createMachine({ id, initial, states: { ... } })` with typed context (extended state) and events; TypeScript generics ensure type-safe state and event discrimination.
    - **State nodes**: simple (leaf) states, compound states (hierarchical OR-state with `initial` pointer), parallel states (AND-state with `type: 'parallel'` and concurrent `states` children), history states (`type: 'history'`, `history: 'deep' | 'shallow'`), and final states.
    - **Guards and Actions**: transitions carry `guard` conditions (pure functions returning boolean) and `actions` (side-effect descriptions — `assign`, `sendTo`, `raise`, `log`); XState v5 uses explicit action objects enabling deterministic replay and time-travel debugging.
    - **Actors**: XState v5 elevates machines to first-class actors (Hewitt 1973 actor model) via `createActor(machine, { input })`. Actors communicate via `.send(event)`, can spawn child actors with `spawnChild()`, and expose `system` for actor registry. This enables hierarchical agent architectures.
    - **Persistence**: machine snapshots (serialisable JSON representations of current state + context) enable server-side state persistence, resumable workflows, and durable execution (analogous to Temporal.io workflow state).
    - **Visualisation**: Stately Studio (https://stately.ai) provides a visual designer and state machine registry; the `@xstate/inspect` package enables runtime inspection via browser devtools.
    - XState is used in production by Stripe (checkout flows), Sketch (canvas state), Atlassian (Jira workflow engine), and Microsoft (VS Code extension host). The npm package `xstate` has ~1.2M weekly downloads as of 2025.
  ...
  - **Spring State Machine** (Pivotal/VMware, initial release 1.0.0 in 2015, current 4.0.0) provides a Statechart-compliant framework in the Java/Spring ecosystem:
    ...
    - **StateMachineBuilder DSL**: fluent builder API `StateMachineBuilder.builder()` with `.configureStates()` (defining initial, final, and regular states, including hierarchical substates via `withStates().parent(ParentState)`) and `.configureTransitions()` (defining source, target, event, guard, action).
    - **Guards and Actions**: Spring beans implementing `Guard<S,E>` and `Action<S,E>` interfaces, enabling dependency injection into state machine logic — a key enterprise integration advantage.
    - **Persistence**: `StateMachinePersister<S, E, T>` serialises and restores machine state via Spring Data; out-of-the-box support for Redis, JDBC (PostgreSQL/MySQL), and MongoDB backends enables durable state across distributed services.
    - **Distributed state machines**: Spring State Machine integrates with Spring Session and Zookeeper/etcd for distributed state coordination, allowing state machine instances across cluster nodes to share state — effectively implementing RSM at the application layer.
  ...
  - **Core components of state machine architectures:**
    ...
    - **Output alphabet Δ / Actions**: Moore outputs (per state) or Mealy outputs (per transition); in Solidity, `emit` events; in XState, action descriptors executed by interpreters.
    - **Start state q₀**: initial configuration; in Statecharts, the default substate at each hierarchical level; in Spring State Machine, `.initial(State.IDLE)`.
    - **Accepting/final states F**: terminal configurations; in parser FSMs, accepted inputs; in Spring Batch, `BatchStatus.COMPLETED`; in Raft, `committed` log entries.
    - **Extended state (Context)**: finite-state machines augmented with typed data variables (counters, balances, parameters) without inflating the state count — XState's `context` object, Solidity's storage variables. Extended state machines are computationally equivalent to TMs (with appropriate data types) but remain tractable in practice for finite data domains.
    - **Guard conditions**: Boolean predicates over extended state and event payload that refine when a transition fires; prevent state explosion by factoring data conditions out of state topology.
