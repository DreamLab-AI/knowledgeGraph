schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#DocumentationGeneration
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:documentation-generation
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-5c4371261255"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#DocumentationGeneration"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:documentation-generation"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
...
```json-ld
{
  ...
  "definition": "Documentation Generation is a concept within the ai domain.",
  "vc:qualityScore": {
    "@value": "0.35",
    "@type": "xsd:float"
  },
