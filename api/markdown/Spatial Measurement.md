schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#SpatialMeasurement
legacy_uri:: urn:visionclaw:concept:spatial-computing:spatial-measurement
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-aba20ae4ba66"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#SpatialMeasurement"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:spatial-measurement"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
