iri:: http://narrativegoldmine.com/blockchain#QuadraticVoting
uri:: urn:visionclaw:concept:blockchain:quadratic-voting
rdf-type:: owl:Class
same-as:: urn:visionclaw:concept:blockchain:quadratic-voting
type:: owl:Class
context:: https://visionclaw.dreamlab-ai.systems/ns/v2
domain:: blockchain
preferred-term:: Quadratic Voting
content-hash:: sha256-12-10505807cf3c
legacy-term-id:: BC-0466
...
- ### Definition
  - Voting mechanism where the cost of votes increases quadratically—casting n votes requires n² voice credits—measuring preference intensity whilst preventing wealthy actors from dominating outcomes. Quadratic voting addresses plutocracy in token-weighted systems and indifference in one-person-one-vote by making large vote counts prohibitively expensive, encouraging honest preference revelation and broad-based support over concentrated wealth. [[Gitcoin]] deployed quadratic funding (dual mechanism) distributing £50M+ to public goods since 2019, facing persistent Sybil resistance challenges requiring identity verification and zero-knowledge proof innovations.
...
- ### Relationships
  - used-in:: [[GitcoinGrants]] (domain: blockchain→public-goods, type: allocation)
  - requires:: [[SybilResistance]] (domain: blockchain→identity, type: security)
...
- ### Content
  ...
  - ### Technical Implementation
		- Implementing quadratic voting in smart contracts requires careful attention to precision, gas efficiency, and attack prevention. The core challenge lies in computing square roots on-chain, as Solidity lacks native support for floating-point arithmetic.
