schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#MathLibrary
legacy_uri:: urn:visionclaw:concept:spatial-computing:math-library
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-6e2527f29640"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#MathLibrary"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:math-library"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:d499d89721389c320ab0d3087710b33741224addbe182a9046a9d95884dec8db@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
