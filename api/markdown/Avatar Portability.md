schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#AvatarPortability
legacy_uri:: urn:visionclaw:concept:spatial-computing:avatar-portability
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-a04d7631e9bc"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#AvatarPortability"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:avatar-portability"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
