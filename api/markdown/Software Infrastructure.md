schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#SoftwareInfrastructure
legacy_uri:: urn:visionclaw:concept:infrastructure:software-infrastructure
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-cbc003f92ba2"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#SoftwareInfrastructure"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:software-infrastructure"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:2f181e4507bbcd2ed8738b505304c44b7866d59fb83afc10056eb64a720b2813@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
