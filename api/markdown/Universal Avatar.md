schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#UniversalAvatar
legacy_uri:: urn:visionclaw:concept:spatial-computing:universal-avatar
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-f37c42b968a7"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#UniversalAvatar"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:universal-avatar"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
