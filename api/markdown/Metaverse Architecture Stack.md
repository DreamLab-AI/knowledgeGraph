schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#MetaverseArchitectureStack
legacy_uri:: urn:visionclaw:concept:spatial-computing:metaverse-architecture-stack
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-22f60ca898fa"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#MetaverseArchitectureStack"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:metaverse-architecture-stack"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
