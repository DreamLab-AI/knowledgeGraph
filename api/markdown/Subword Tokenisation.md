...
(Declaration (Class :SubwordTokenisation))

;; Annotations
(AnnotationAssertion rdfs:label :SubwordTokenisation "Subword Tokenisation"@en)
(AnnotationAssertion rdfs:comment :SubwordTokenisation "A tokenisation approach that breaks words into smaller meaningful units, balancing vocabulary size with the ability to represent rare words and novel compositions."@en)

;; Data Properties
(AnnotationAssertion dcterms:identifier :SubwordTokenisation "AI-0232"^^xsd:string)
(DataPropertyAssertion :isAITechnology :SubwordTokenisation "true"^^xsd:boolean)
```
