...
- ### Content
  - Supply chain visibility emerged as a strategic priority following a series of high-profile disruptions: the 2011 Fukushima earthquake and Thai floods revealed how single-source dependencies [private] halt global automotive production, the 2017 WannaCry ransomware attack disrupted Maersk's container logistics, and the 2020-2021 COVID-19 pandemic caused cascading shortages from semiconductor chips to medical PPE. In each case, the fundamental problem was that organisations [private] not see beyond their immediate tier-1 suppliers, creating blind spots for risk and inventory positioning. Gartner began tracking supply chain visibility as a distinct technology category in the mid-2010s.
