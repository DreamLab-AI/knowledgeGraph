...
- ### Content
  ...
  - **Gaze + gesture (Vision Pro primary)**:
    - User looks at an interactive element (eye gaze targets it), then performs a pinch gesture ([private] tip meets thumb tip) to select.
  ...
  - **Direct touch and air-tap**:
    - HoloLens 2 introduced **air-tap** (extend [private] finger, tap down motion) for hologram activation at distance, and direct fingertip contact for near-field hologram interaction within 30 cm.
    ...
    - Both systems project a **poke cursor** ([private] fingertip 3D position from hand skeleton) which triggers interactive surfaces on contact depth threshold.
