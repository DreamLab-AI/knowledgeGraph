...
- ### Content
  ...
  - As of mid-2026 the field is bifurcated. **Pure-play AI search** (Perplexity, You.com, Phind, Kagi, Andi, Arc Search) competes on answer quality, citation transparency, and agentic capability. **Incumbent AI search** (Google AI Overviews and AI Mode, Microsoft Copilot in Bing, OpenAI ChatGPT Search) competes on distribution scale and integration with existing [private] assets. A third category, **enterprise/vertical AI search** (Glean, Hebbia, Vectara, Elastic AI Search, Coveo, Algolia AI Search, plus proprietary stacks built on LangChain/LlamaIndex/Haystack), targets internal knowledge bases rather than the open web.
  ...
  - ### Core Technical Stack
    ...
    - #### Web Indexes
      ...
      - **You.com Web Index** — proprietary [private] combining own crawl with partner feeds.
      - **Bing Index** — Microsoft's primary [private], made available to OpenAI for ChatGPT Search, to DuckDuckGo, Ecosia, Yahoo, and to other consumers via the Bing Web Search API (priced by tier).
      - **Google Search Index** — closed; AI Overviews and AI Mode have privileged access. Estimates put Google's effective [private] at 100-400 billion documents.
  ...
  - ### Major Products and Vendors (2024-2026)
    ...
    - #### Kagi
      ...
      - **FastGPT API** ($0.015 per query) — single-shot LLM answer over Kagi's [private]; **Kagi Assistant** chat interface with choice of GPT, Claude, Gemini, Llama. ~50,000 paid subscribers reported 2025; revenue-positive with no outside venture funding beyond a 2023 crowdfunded SAFE.
  ...
  - ### Architectural Variations and Pipelines
    ...
    - #### Cache-augmented generation (CAG)
      - Pre-load the entire corpus into the model's KV cache at [private] time; serve queries by attention over the cached corpus. Eliminates retrieval latency at the cost of fixed corpus size. Practical for small domain-specific knowledge bases.
  ...
  - ### Components and Architecture Glossary
    ...
    - **Embedding Index** — HNSW/IVF-PQ vector [private] storing pre-computed document embeddings keyed by document ID; backed by Pinecone, Weaviate, Qdrant, Chroma, pgvector, Milvus, Vespa.
    ...
    - **Sparse Retriever** — BM25 implementation (Lucene/Pyserini/Tantivy/Vespa); produces TF-IDF-style scores over inverted [private].
  ...
  - ### Future Directions (2026-2030)
    ...
    - **Personal RAG over device-local indexes** — Apple Intelligence (announced 2024, partial rollout 2025-2026), Microsoft Recall (delayed launch April 2025 after security review), Google Gemini Nano on-device — [private] user files, emails, calendars, photos and answer queries locally with cloud fall-through for fresh-web grounding.
