schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#DataFabricArchitecture
legacy_uri:: urn:visionclaw:concept:infrastructure:data-fabric-architecture
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-a66e8a353eda"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#DataFabricArchitecture"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:data-fabric-architecture"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
