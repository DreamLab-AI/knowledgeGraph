schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#IdentityManagement
legacy_uri:: urn:visionclaw:concept:infrastructure:identity-management
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-254c5de7c963"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#IdentityManagement"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:identity-management"
    },
    {
      "vc:key": "status",
      "vc:value": "active"
