- ### OntologyBlock
  ...
  collapsed:: true
	...
	- source-domain:: ai
	- owl:class:: ai:NationalCompetentAuthority
	- status:: active
	- public-access:: true
...
National Competent Authority refers to a notifying authority, a market surveillance authority, or any other authority designated by a member state to supervise the application and implementation of the ai act, including national data protection authorities where relevant.
