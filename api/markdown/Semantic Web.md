schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#SemanticWeb
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:semantic-web
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-7d9e156372c2"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#SemanticWeb"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:semantic-web"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
