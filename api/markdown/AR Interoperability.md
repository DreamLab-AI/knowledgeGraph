...
```json-ld
{ "@context":"https://narrativegoldmine.com/ns/v1", "@id":"urn:visionflow:page:ar-interoperability", "@type":"Page", "title":"AR Interoperability", "vc:slug":"ar-interoperability", "vc:public":true, "vc:schemaVersion":2, "vc:outboundWikilinks":[] }
```
...
```json-ld
{
  ...
  "subClassOf":[{"@id":"urn:ngm:class:cross-platform-interoperability","label":"Cross-Platform Interoperability"}],
  "relations":{}
}
```
...
- ### Relationships
	- subClassOf:: [[Cross-Platform Interoperability]]
