...
- ### Relationships
  ...
  - has-part:: [[Behavioral Analytics]], [[Anomaly Detection]], [[Pattern Recognition]], [[Policy Learning]], [[State Space Representation]], [[Reward Modelling]], [[Behaviour Tree]], [[Value Function]], [[Imitation Learning]]
  ...
  - supports:: [[Robotics]], [[Human-Computer Interaction]], [[Game AI]], [[Cybersecurity]], [[Behavioral Analytics]], [[Extended Reality]], [[Simulation]]
  - contrasts-with:: [[Rule-Based System]], [[Expert System]], [[Scripted Behaviour]], [[Symbolic AI]]
  - related-to:: [[Reinforcement Learning]], [[Cognitive Architecture]], [[Agent-Based Simulation]], [[Digital Twin]], [[Behavioral Analytics]], [[Embodied AI]], [[Multi-Agent System]], [[Foundation Model]], [[Agentic AI]], [[Transfer Learning]], [[Meta-Learning]]
...
- ### Content
  ...
  ## See Also (Cross-References)
    ...
    - [[Behavioral Analytics]] — the observational counterpart to behavioural modelling; applies the learned behavioural models to detect deviations in production data streams
