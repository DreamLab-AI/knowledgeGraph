...
```json-ld
{
  ...
  "sameAs": [
    {
      "@id": "urn:ngm:class:threat-analysis",
      "label": "Threat Analysis"
    },
    {
      "@id": "urn:ngm:class:security-threat-modelling",
