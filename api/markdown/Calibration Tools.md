schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#CalibrationTools
legacy_uri:: urn:visionclaw:concept:spatial-computing:calibration-tools
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-d13dd1122069"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#CalibrationTools"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:calibration-tools"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:5e22a70ecee044334c527668764814cb7516dc7bfda4356b7f59e4ac9e10e6c3@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
