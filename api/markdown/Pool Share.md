schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#PoolShare
legacy_uri:: urn:visionclaw:concept:blockchain:pool-share
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-046063af28dd"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#PoolShare"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:pool-share"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:68db87bfbea2c0a482bfbeabf4fd559e2f45178c7fd48a4860aabaf8d5bd0a3a@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:pool-share",
  "@type": "OntologyClass",
  "label": "Pool Share",
  "subClassOf": [
    {
