schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#StateMachineReplication
legacy_uri:: urn:visionclaw:concept:blockchain:state-machine-replication
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-e72d01cea7fa"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#StateMachineReplication"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:state-machine-replication"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:4b2909df1d28d61e415bfcc60536bde215c504cc9a499b10e3cc88d2f86da722@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
```json-ld
{
  ...
  "definition": "State Machine Replication is a concept within the blockchain domain. Further enrichment pending.",
  "vc:qualityScore": {
    "@value": "0.35",
    "@type": "xsd:float"
  },
