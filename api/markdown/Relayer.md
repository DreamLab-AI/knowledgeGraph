schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#Relayer
legacy_uri:: urn:visionclaw:concept:blockchain:relayer
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-034286bfa38e"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#Relayer"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:relayer"
    },
    {
      "vc:key": "status",
      "vc:value": "active"
