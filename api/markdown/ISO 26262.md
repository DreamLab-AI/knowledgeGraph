  ...
  "relations": {
    ...
    "enables": [
      ...
      },
      {
        ...
        "label": "Automotive Embedded System"
      }
    ],
    "requires": [
      {
    ...
    "hasPart": [
      ...
      {
        "@id": "urn:ngm:class:functional-safety",
        "label": "Functional Safety Management"
      }
    ],
    "uses": [
      {
    ...
    "bridgesTo": [
      ...
      {
        "@id": "urn:ngm:class:automotive-cybersecurity",
        "label": "Automotive Cybersecurity"
      }
    ]
  },
  "sameAs": [
    {
      "@id": "urn:ngm:class:automotive-functional-safety-standard",
      "label": "Automotive Functional Safety Standard"
    }
  ],
  "quality": 0.76,
  "provenance": {
...
- ### Key Components
  ...
  - #### ASIL Classification
    - ASIL is determined by the HARA process using three parameters:
      ...
      - **Exposure (E0–E4)**: how frequently the vehicle is in a situation where the hazard [private] occur (E0 = incredible; E4 = high probability, e.g., highway driving).
