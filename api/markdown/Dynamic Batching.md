...
```json-ld
{
  ...
  "relations": {
    "hasPart": [
      {
        "@id": "urn:ngm:class:batch-scheduler",
      ...
      {
        "@id": "urn:ngm:class:padding-strategy",
    ...
    "enables": [
      {
        "@id": "urn:ngm:class:high-throughput-serving",
        "label": "High Throughput Serving"
      },
      {
    ...
    "relatedTo": [
      ...
      {
        "@id": "urn:ngm:class:latency-throughput-tradeoff",
        "label": "Latency Throughput Tradeoff"
      }
    ],
    "contrastsWith": [
      {
