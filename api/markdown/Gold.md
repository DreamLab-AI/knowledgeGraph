schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/economics#Gold
legacy_uri:: urn:visionclaw:concept:economics:gold
public:: true
...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:commodity-market-domain",
      "vc:label": "CommodityMarketDomain"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:physical-asset-layer",
      "vc:label": "PhysicalAssetLayer"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:reserve-asset-layer",
      "vc:label": "ReserveAssetLayer"
    },
    {
  ...
  "vc:legacyProperties": [
    {
      ...
      "vc:value": "Au, XAU, monetary gold, bullion gold, physical gold, gold commodity"
    },
    {
    ...
    {
      "vc:key": "bridges-to",
      "vc:value": "[[Bitcoin]], [[Digital Asset]], [[Stablecoin]], [[CBDCs]]"
    },
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-9f4d2b7c3a1e"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/economics#Gold"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:economics:gold"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:gold:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[Allocated Account]]",
      "resolved": "urn:visionflow:linked:allocated-account",
      "kind": "StubLink"
    },
    {
      "raw": "[[Assay Certificate]]",
      "resolved": "urn:visionflow:linked:assay-certificate",
      "kind": "StubLink"
    },
    {
      "raw": "[[BIS Basel III CRE20]]",
      "resolved": "urn:visionflow:linked:bis-basel-iii-cre20",
      "kind": "StubLink"
    },
    {
      "raw": "[[BIS Basel III HQLA Classification]]",
      "resolved": "urn:visionflow:linked:bis-basel-iii-hqla-classification",
      "kind": "StubLink"
    },
    {
      "raw": "[[Central Bank Gold Reserve]]",
      "resolved": "urn:visionflow:linked:central-bank-gold-reserve",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[COMEX Contract Specifications]]",
      "resolved": "urn:visionflow:linked:comex-contract-specifications",
      "kind": "StubLink"
    },
    {
      "raw": "[[COMEX Futures Contract Standard]]",
      "resolved": "urn:visionflow:linked:comex-futures-contract-standard",
      "kind": "StubLink"
    },
    {
      "raw": "[[COMEX Gold Futures]]",
      "resolved": "urn:visionflow:linked:comex-gold-futures",
      "kind": "StubLink"
    },
    {
      "raw": "[[Commodity]]",
      "resolved": "urn:visionflow:linked:commodity",
      "kind": "StubLink"
    },
    {
      "raw": "[[CommodityMarketDomain]]",
      "resolved": "urn:visionflow:linked:commodity-market-domain",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Currency Diversification]]",
      "resolved": "urn:visionflow:linked:currency-diversification",
      "kind": "StubLink"
    },
    {
      "raw": "[[Custodian Bank]]",
      "resolved": "urn:visionflow:linked:custodian-bank",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[FATF Precious Metals Guidance]]",
      "resolved": "urn:visionflow:linked:fatf-precious-metals-guidance",
      "kind": "StubLink"
    },
    {
      "raw": "[[Fiat Currency]]",
    ...
    {
      "raw": "[[Global Commodity Market]]",
      "resolved": "urn:visionflow:linked:global-commodity-market",
      "kind": "StubLink"
    },
    {
      "raw": "[[Gold-Backed Stablecoin]]",
      "resolved": "urn:visionflow:linked:gold-backed-stablecoin",
      "kind": "StubLink"
    },
    {
      "raw": "[[Gold-Backed Token]]",
      "resolved": "urn:visionflow:linked:gold-backed-token",
      "kind": "StubLink"
    },
    {
      "raw": "[[Gold ETF]]",
      "resolved": "urn:visionflow:linked:gold-etf",
      "kind": "StubLink"
    },
    {
      "raw": "[[Gold Recycling Stream]]",
      "resolved": "urn:visionflow:linked:gold-recycling-stream",
      "kind": "StubLink"
    },
    {
      "raw": "[[Gold Refinery]]",
      "resolved": "urn:visionflow:linked:gold-refinery",
      "kind": "StubLink"
    },
    {
      "raw": "[[Government Bond]]",
      "resolved": "urn:visionflow:linked:government-bond",
      "kind": "StubLink"
    },
    {
      "raw": "[[Hard Money]]",
      "resolved": "urn:visionflow:linked:hard-money",
      "kind": "StubLink"
    },
    {
      "raw": "[[ICE LBMA Gold Price Benchmark]]",
      "resolved": "urn:visionflow:linked:ice-lbma-gold-price-benchmark",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[ISO 4217 XAU Currency Code]]",
      "resolved": "urn:visionflow:linked:iso-4217-xau-currency-code",
      "kind": "StubLink"
    },
    {
      "raw": "[[LBMA Good Delivery Accreditation]]",
      "resolved": "urn:visionflow:linked:lbma-good-delivery-accreditation",
      "kind": "StubLink"
    },
    {
      "raw": "[[LBMA Good Delivery Bar]]",
      "resolved": "urn:visionflow:linked:lbma-good-delivery-bar",
      "kind": "StubLink"
    },
    {
      "raw": "[[LBMA Good Delivery Rules]]",
      "resolved": "urn:visionflow:linked:lbma-good-delivery-rules",
      "kind": "StubLink"
    },
    {
      "raw": "[[LBMA Responsible Gold Guidance]]",
      "resolved": "urn:visionflow:linked:lbma-responsible-gold-guidance",
      "kind": "StubLink"
    },
    {
      "raw": "[[Mining Production]]",
      "resolved": "urn:visionflow:linked:mining-production",
      "kind": "StubLink"
    },
    {
      "raw": "[[Monetary Metal]]",
      "resolved": "urn:visionflow:linked:monetary-metal",
      "kind": "StubLink"
    },
    {
      "raw": "[[Monetary Reserve Diversification]]",
      "resolved": "urn:visionflow:linked:monetary-reserve-diversification",
      "kind": "StubLink"
    },
    {
      "raw": "[[PhysicalAssetLayer]]",
      "resolved": "urn:visionflow:linked:physical-asset-layer",
      "kind": "StubLink"
    },
    {
      "raw": "[[Precious Metal Refining]]",
      "resolved": "urn:visionflow:linked:precious-metal-refining",
      "kind": "StubLink"
    },
    {
      "raw": "[[Reserve Asset]]",
    ...
    {
      "raw": "[[ReserveAssetLayer]]",
      "resolved": "urn:visionflow:linked:reserve-asset-layer",
      "kind": "StubLink"
    },
    {
      "raw": "[[SGE Trading Rules]]",
      "resolved": "urn:visionflow:linked:sge-trading-rules",
      "kind": "StubLink"
    },
    {
      "raw": "[[Silver]]",
      "resolved": "urn:visionflow:linked:silver",
      "kind": "StubLink"
    },
    {
      "raw": "[[Sovereign Reserve Policy]]",
      "resolved": "urn:visionflow:linked:sovereign-reserve-policy",
      "kind": "StubLink"
    },
    {
      "raw": "[[Stellar Network]]",
      "resolved": "urn:visionflow:linked:stellar-network",
      "kind": "StubLink"
    },
    {
      "raw": "[[Tangible Asset]]",
      "resolved": "urn:visionflow:linked:tangible-asset",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Tokenized Commodity]]",
      "resolved": "urn:visionflow:linked:tokenized-commodity",
      "kind": "StubLink"
    },
    {
      "raw": "[[Vault Infrastructure]]",
      "resolved": "urn:visionflow:linked:vault-infrastructure",
      "kind": "StubLink"
    },
    {
      "raw": "[[Vault Storage]]",
      "resolved": "urn:visionflow:linked:vault-storage",
      "kind": "StubLink"
    },
    {
...
- ### Definition
  - Gold (chemical symbol Au, atomic number 79, ISO currency code XAU) is a dense, corrosion-resistant transition metal that has served as the pre-eminent monetary commodity for at least 5,000 years and in 2024–2026 occupies a unique dual role as both the world's third-largest reserve asset by value (approximately $18–22 trillion in aggregate above-ground stock at $2,300–$3,200/oz 2024–2026 spot range) and the emerging ontological anchor for a new generation of gold-backed digital tokens, gold-collateralised stablecoins, and tokenised bullion products within the AI-blockchain convergence layer, functioning across five principal markets: (1) the London Bullion Market Association (LBMA) over-the-counter unallocated and allocated spot market centred on London Good Delivery bars (400 troy oz ±10%, minimum 99.5% fineness, assayer hallmark, chain-of-custody documentation per LBMA Responsible Gold Guidance 7th Ed. 2023) clearing approximately $35–50 billion per day through the London Gold Market Fixing mechanism now replaced by the ICE Benchmark Administration LBMA Gold Price twice-daily auction; (2) COMEX futures and options at the CME Group New York, the world's largest gold derivatives venue, trading 100 troy oz contracts (GC) and micro-contracts (MGC, 10 oz) with open interest regularly exceeding 400,000 contracts (~40M oz notional), functioning as the global price discovery benchmark for forward gold; (3) the Shanghai Gold Exchange (SGE) physical spot market and Shanghai International Gold Exchange (SGEI), which together processed 1,847 tonnes in 2024, positioning China as the world's largest gold exchange by physical delivery; (4) Exchange-Traded Products — primarily SPDR Gold Shares (GLD, NYSE Arca, ~900–1,000 tonnes AUM 2024–2026, expense ratio 0.40%) and iShares Gold Trust (IAU, ~500 tonnes AUM, 0.25% expense ratio), collectively holding ~1,600 tonnes ($140B+ at $3,000/oz) representing the single largest identifiable concentrated gold holding; and (5) Central Bank reserves, where World Gold Council data confirms central banks net-purchased a record 1,037 tonnes in 2023, 1,045 tonnes in 2024, and an estimated 950–1,100 tonnes in 2025, with the People's Bank of China (PBOC) adding ~490 tonnes across 2023–2024 raising reserves to 2,280 tonnes (4.9% of total reserves), the Reserve Bank of India (RBI) expanding to 876 tonnes by end-2024, the National Bank of Poland acquiring 130 tonnes in 2024 (largest single-year purchase globally), and the Central Bank of Turkey holding 592 tonnes, with BIS Basel III final rule CRE20 (effective January 2023 in EU, January 2025 globally) designating unencumbered allocated physical gold as a High Quality Liquid Asset (HQLA) Tier-1 asset at 0% risk-weight matching cash and sovereign bonds — a regulatory reclassification that materially increases bank incentives to hold physical gold; in the digital-asset ontology, gold is further instantiated as: (a) PAX Gold (PAXG, ERC-20, Paxos Trust Company, each token representing 1 fine troy oz of LBMA Good Delivery gold stored at Brink's vaulting London, audited monthly by Withum, market cap ~$700M 2024); (b) Tether Gold (XAUT, ERC-20 and TRC-20, Tether Limited BVI, 1 token = 1 troy oz allocated gold, vaulted in Switzerland, ~$600M market cap 2024); (c) Kinesis KAU (Kinesis Money, built on Stellar, 1 KAU = 1 gram fine gold stored in allocated vaults Singapore/Switzerland/Melbourne, yield-bearing through velocity yield mechanism distributing transaction fee revenue to holders); and (d) Perth Mint Gold Token (PMGT, Algorand, backed by Western Australian government guarantee, 1 PMGT = 1 fine troy oz); the gold-Bitcoin "digital gold" narrative — extensively documented in Saifedean Ammous *The Bitcoin Standard* (2018), Parker Lewis *Gradually Then Suddenly* essays (2019–2020), and Lyn Alden *Broken Money* (2023) — positions Bitcoin as a superior monetary asset on metrics of supply predictability (21M hard cap vs gold's ~1.5–2% annual supply growth from ~3,500 tonnes/year mining), divisibility (satoshi = 10⁻⁸ BTC vs LBMA minimum 0.001 oz settlement), portability (global settlement in ~10 minutes vs LBMA T+2 settlement), and confiscation-resistance (cryptographic key custody vs physical storage/transport risk), whilst gold proponents counter with 5,000-year stability track record, no counterparty/technical risk, Basel III Tier-1 status Bitcoin lacks, existing sovereign reserve acceptance, and performance across hyperinflation episodes (Weimar Germany 1923, Zimbabwe 2008, Venezuela 2017–2021, Turkey 2021–2022) where gold maintained purchasing power whilst both fiat and nascent digital assets collapsed; recycling contributes approximately 1,200–1,300 tonnes/year to supply (World Gold Council Q4 2024), representing ~27% of total supply, with London and Antwerp the primary refining/recycling hubs and the Royal Mint Llantrisant processing 50,000–100,000 kg of refined gold annually for UK Sovereign and Britannia coin manufacture alongside its DigiGold digital gold platform launched 2021; gold price reached successive record highs in 2024–2026 — $2,500/oz (August 2024), $2,800/oz (November 2024), $3,000/oz (March 2025), $3,200/oz (May 2025) — driven by sustained central bank purchasing, Federal Reserve rate-cut cycle beginning September 2024, ongoing geopolitical fragmentation and dollar-reserve diversification by BRICS+ nations, and speculative demand from retail through gold ETF net inflows reversing three-year outflow trend; the gold market sits at the intersection of the [[Blockchain Domain]], [[Digital Asset]] infrastructure, [[CBDCs]] experimentation (several central banks studying gold-backed CBDC designs including Russia's 2024 digital ruble discussion paper proposing partial gold-backing), and AI-driven commodities analytics, making it an essential node in the AI-blockchain ontology.

- ### Semantic Classification
  - owl-class:: economics:Gold
  - owl-role:: MonetaryCommodity
  - owl-inferred:: economics:ReserveAsset, economics:HardMoney, economics:CommodityMoney, economics:TangibleAsset
  - belongs-to-domain:: [[EconomicsDomain]], [[BlockchainDomain]], [[DigitalAssetDomain]], [[CommodityMarketDomain]]
  - implemented-in-layer:: [[PhysicalAssetLayer]], [[TokenisationLayer]], [[ReserveAssetLayer]]

- ### Relationships
  - is-subclass-of:: [[Digital Asset]], [[Commodity]], [[Reserve Asset]], [[Hard Money]], [[Tangible Asset]], [[Monetary Metal]]
  - has-part:: [[LBMA Good Delivery Bar]], [[Gold ETF]], [[Gold-Backed Token]], [[Central Bank Gold Reserve]], [[COMEX Gold Futures]], [[Gold Recycling Stream]], [[Gold Refinery]]
  - requires:: [[Vault Storage]], [[Chain of Custody]], [[Assay Certificate]], [[LBMA Good Delivery Accreditation]], [[Custodian Bank]], [[Allocated Account]]
...
- ### Content
  ...
  ## Compositional Relationships (Components)
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:hasPart ec:LBMAGoodDeliveryBar))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:hasPart ec:GoldETF))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:hasPart ec:GoldBackedToken))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:hasPart ec:CentralBankGoldReserve))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:hasPart ec:COMEXGoldFutures))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:hasPart ec:GoldRecyclingStream))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:hasPart ec:GoldRefinery))

	    ## Dependency Relationships
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:requires ec:VaultStorage))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:requires ec:ChainOfCustody))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:requires ec:AssayCertificate))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:requires ec:LBMAGoodDeliveryAccreditation))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:requires ec:CustodianBank))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:requires ec:AllocatedAccount))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:dependsOn ec:PreciousMetalRefining))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:dependsOn ec:VaultInfrastructure))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:dependsOn ec:GlobalCommodityMarket))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:dependsOn ec:SovereignReservePolicy))

	    ## Capability Relationships
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:enables ec:InflationHedging))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:enables ec:CurrencyDiversification))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:enables ec:TokenizedCommodity))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:enables ec:GoldBackedStablecoin))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:enables ec:MonetaryReserveDiversification))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:enables ec:CrossBorderSettlement))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:supports ec:BitcoinValueProposition))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:supports ec:StablecoinCollateral))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:supports ec:CBDCDesign))

	    ## Implementation Relationships
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:implements ec:LBMAResponsibleGoldGuidance))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:implements ec:BISBaselIIIHQLAClassification))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:implements ec:ICELBMAGoldPriceBenchmark))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:implements ec:ISO4217XAUCurrencyCode))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:implements ec:COMEXFuturesContractStandard))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:implements ec:SGETradingRules))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:uses ec:ERC20TokenStandard))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:uses ec:StellarNetwork))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:uses ec:Algorand))

	    ## Reduction Relationships
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:reduces ec:CurrencyRisk))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:reduces ec:InflationExposure))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:reduces ec:CounterpartyRisk))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:reduces ec:PortfolioVolatility))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:reduces ec:SettlementFriction))

	    ## Association Relationships
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:relatedTo ec:Bitcoin))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:relatedTo ec:Stablecoin))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:relatedTo ec:CBDCs))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:relatedTo ec:AssetTokenization))
	    SubClassOf(ec:Gold
	      ObjectSomeValuesFrom(ec:relatedTo ec:DecentralizedFinance))
	    ...
	    SubClassOf(ec:Gold
	      DataSomeValuesFrom(ec:fineness xsd:decimal))
	    SubClassOf(ec:Gold
	      DataMinCardinality(1 ec:hasVaultLocation xsd:string))
	    SubClassOf(ec:Gold
	      DataMinCardinality(1 ec:hasAssayDocument xsd:string))
	    ...
	    AnnotationAssertion(dcterms:identifier ec:Gold "EC-2201"^^xsd:string)
	    AnnotationAssertion(dcterms:subject ec:Gold "Commodity, Monetary Metal, Reserve Asset, Gold-Backed Token, Central Bank Reserve"@en)
	  )

	  ## Property Characteristics
	  AsymmetricObjectProperty(ec:requires)
	  AsymmetricObjectProperty(ec:enables)
	  AsymmetricObjectProperty(ec:implements)
	  AsymmetricObjectProperty(ec:reduces)
	  TransitiveObjectProperty(ec:dependsOn)
	  FunctionalDataProperty(ec:fineness)
	  FunctionalDataProperty(ec:spotPrice2025)
	  ```
  ...
  - **Divisibility**:
    ...
    - Bitcoin: divisible to 1 satoshi = 10⁻⁸ BTC (approximately $0.0003 at $30,000 BTC); Lightning enables millisatoshi (10⁻¹¹ BTC) micropayments
  - **Portability**:
    - 1 tonne of gold (~32,150 troy oz): ~$96M at $3,000/oz, but physically ~1 cubic meter, requires armoured transport
  ...
  - **Gold Counterarguments** — from proponents (Peter Schiff, Jim Rickards, Goldman Sachs Commodities Research):
    ...
    - Basel III Tier-1 status: Bitcoin carries 1,250% risk-weight (banks must hold $1.25 capital per $1 Bitcoin exposure); gold carries 0% as HQLA
    ...
    - US gold reserve: 8,133 tonnes (~$780B at $3,000/oz, 70% of official reserves), providing geopolitical backstop that no existing Bitcoin holder can match in scale
  ...
  - **SPDR Gold Shares (GLD)** — the flagship US vehicle:
    ...
    - Expense ratio: 0.40%
    - AUM: ~$70–80B (900–1,000 tonnes) at $3,000/oz; peak was $80B+ in 2020
  ...
  - **DeFi Collateral**:
    ...
    - Example: $1M PAXG → borrow ~$700,000 USDC on AAVE (65% LTV) while maintaining gold price exposure
  ...
  - **1. Record Price Levels**:
    - $2,500/oz — August 2024 (first close above $2,500)
  ...
  - **Bank of England Gold Vault**:
    ...
    - **Brown's Bottom controversy**: HM Treasury sold 401 tonnes in 1999–2002 at £256–$296/oz average (approximately £4.5B total proceeds); 2025 gold price of $3,200/oz implies that gold would now be worth ~$47B — opportunity cost widely debated
  ...
  - **London OTC Market (LBMA)**: The dominant price discovery venue for spot gold. Trading occurs bilaterally between ~50 active market-making members with the ICE LBMA Gold Price auction (10:30 AM and 3:00 PM London time) providing the global benchmark. The PM fix (3:00 PM) is particularly important as it coincides with the opening of New York markets. Daily OTC turnover of $35–50B in London is primarily unallocated (credit-based), with cleared trades processed through LMEClear (CME Group's clearing service for LBMA since 2014). The BIS Triennial Survey (2022) found gold to be the fifth most-traded OTC instrument globally after major FX pairs, with average daily global gold OTC turnover of $131B.
  - **COMEX New York (CME Group)**: The primary derivatives venue. The 100 troy oz Gold Futures contract (GC, symbol XAUUSD in FX markets) trades nearly 24 hours/day on CME Globex with physical delivery at COMEX-approved vaults in New York area (Brink's, HSBC, ICBC Standard Bank). Open interest regularly exceeds 400,000 contracts (~40M oz, ~$120B notional at $3,000/oz). The price relationship between COMEX futures and LBMA spot is maintained through exchange-for-physical (EFP) transactions — the spread normally reflects financing costs (interest rate differential) and typically runs ~$5–20/oz contango (COMEX above spot). During stress events (March 2020 COVID crisis, when 400 oz LBMA bars could not be physically delivered to COMEX vaults accepting only 100 oz bars), this spread widened to $70+/oz, exposing the mechanical fragility of the inter-market arbitrage.
  ...
  - **FATF Guidance**: The Financial Action Task Force (FATF) *Guidance for a Risk-Based Approach: Dealers in Precious Metals and Stones* (2013, revised 2021) requires dealers to apply customer due diligence (CDD), beneficial ownership identification, and suspicious transaction reporting. Gold's unique challenge: a 400 oz (~12.4 kg) LBMA bar has ~$1.2M value at $3,000/oz and is physically portable — making high-value cash-equivalent transactions possible with relatively small physical quantities.
  ...
  - **Central Bank Portfolio Management**: The IMF *Guidelines for Foreign Exchange Reserve Management* (2013) identifies gold as an acceptable reserve asset for central banks managing both liquidity and store-of-value objectives. The CBGA (Central Bank Gold Agreements) I–V (1999–2024), successive European central bank agreements limiting annual gold sales to prevent market disruption (post-1990s European CB sales that drove gold from $250 to $285/oz), have been progressively superseded by the current accumulation environment where European CBs are broadly neutral to small net buyers.
  - **VAR (Value at Risk) Gold Treatment**: Under Basel III Internal Models Approach (IMA), gold positions attract a market risk charge based on 10-day 99% confidence interval VaR. Historical VaR for gold (~15–20% annual volatility) implies 10-day 99% VaR of ~$150–200/oz at $3,000 price, meaning a 100 oz COMEX position requires ~$15,000–$20,000 in regulatory capital. Under the Basel III Fundamental Review of the Trading Book (FRTB) standardised approach, gold is treated as FX (since it is priced in USD) attracting a 20% risk weight — significantly more favourable than Bitcoin's 1250%.
  ...
  - **All-In Sustaining Cost (AISC)**: The World Gold Council developed the AISC metric (2013) as the most comprehensive measure of gold mining cash cost including production, sustaining capex, corporate overhead, and reclamation. Industry AISC averaged $1,200–$1,350/oz across major producers in 2024. At $3,000+/oz spot prices, the sector generates exceptional free cash flow (FCF margin ~55%), driving shareholder returns via buybacks (Newmont $1B buyback 2024), dividends (Barrick ~3% yield), and project development. Marginal cost (the cost of the highest-cost producing mine) typically approximates a long-run floor price — estimated at $1,400–$1,600/oz for current production levels.
...
- ### Provenance
  ...
  - note:: Domain corrected from `infrastructure` to `economics`; IRI, URI, owl-class, and same-as updated accordingly. Original stub contained uncritical promotional content from a YouTube video embed; replaced with comprehensive ontology reference meeting Phase 6 quality bar.

  - ## Metadata
    - **Legacy Term ID**: EC-2201 (assigned during enrichment; original stub had no legacy-term-id)
    - **Domain Correction**: `infrastructure` → `economics` — Gold is a monetary commodity and reserve asset concept belonging to the economics domain, not an infrastructure concept. Corrected IRI from `infrastructure#Gold` to `economics#Gold`, URI from `concept:infrastructure:gold` to `concept:economics:gold`, owl-class from `infrastructure:Gold` to `economics:Gold`.
    - **Version**: 2.0.0 → 2.1.0 (domain correction + full Phase 6 enrichment)
    ...
    - **Research Cache**: `_enrich/research-cache/Gold.json`
