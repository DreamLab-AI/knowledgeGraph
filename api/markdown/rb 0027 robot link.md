schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/robotics#Rb0027RobotLink
legacy_uri:: urn:visionclaw:concept:robotics:rb-0027-robot-link
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-a8965d7f4a9b"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/robotics#Rb0027RobotLink"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:robotics:rb-0027-robot-link"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:738d0a9073e8b7e14993cdec34bf1432068d7a51f31127f59cfd1fb605f14305@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:rb-0027-robot-link",
  "@type": "OntologyClass",
  ...
  "definition": "robot link is a robotics and autonomous systems concept and a type of Robot."
}
```
...
- ### Content
  ...
  **Robot Link** - Rigid body component of robot kinematic chain
  ...
  ### Emerging Trends
		  ...
		  **License**: CC BY 4.0
		  **Namespace**: `https://metaverse-ontology.org/robotics/RB-0027`
