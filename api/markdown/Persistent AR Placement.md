schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#PersistentARPlacement
legacy_uri:: urn:visionclaw:concept:spatial-computing:persistent-ar-placement
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-2c11c5c6f335"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#PersistentARPlacement"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:persistent-ar-placement"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
