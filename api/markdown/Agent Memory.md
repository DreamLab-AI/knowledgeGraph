...
```json-ld
{
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[Episodic Memory]]",
      "resolved": "urn:visionflow:linked:episodic-memory",
      "kind": "StubLink"
    },
    {
      "raw": "[[Semantic Memory]]",
      "resolved": "urn:visionflow:linked:semantic-memory",
      "kind": "StubLink"
    },
    {
    ...
    },
    {
      ...
      "resolved": "urn:visionflow:linked:long-term-memory",
      "kind": "StubLink"
    },
    {
      "raw": "[[Knowledge Graph]]",
    ...
    {
      "raw": "[[ReAct Pattern]]",
      "resolved": "urn:visionflow:linked:react-pattern",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Self-Reflection]]",
      "resolved": "urn:visionflow:linked:self-reflection",
      "kind": "StubLink"
    },
    {
      "raw": "[[Task Automation]]",
    ...
    {
      "raw": "[[Forgetting]]",
      "resolved": "urn:visionflow:linked:forgetting",
      "kind": "StubLink"
    },
    {
      "raw": "[[Consolidation]]",
      "resolved": "urn:visionflow:linked:consolidation",
      "kind": "StubLink"
    },
    {
      "raw": "[[ACT-R]]",
    ...
    {
      "raw": "[[CoALA]]",
      "resolved": "urn:visionflow:linked:coala",
      "kind": "StubLink"
    }
  ],
  "prov:wasAttributedTo": {
...
- ### Definition
  - Agent memory is the structured ensemble of mechanisms by which an autonomous [[AI Agent]] stores, indexes, consolidates, retrieves, and forgets information across steps, sessions, and lifetimes — enabling coherent, personalised, and long-horizon behaviour that transcends the hard capacity limit of any single [[Context Window]].
  - It encompasses four functionally distinct tiers grounded in cognitive science: [[Working Memory]] (the active context window holding the current observation, scratchpad, and retrieved fragments); [[Episodic Memory]] (timestamped, experience-indexed records of prior observations, tool outputs, decisions, and outcomes); [[Semantic Memory]] (declarative facts, entity relationships, user preferences, and structured world knowledge); and [[Procedural Memory]] (executable skill programs, tool-invocation templates, reusable plan fragments, and workflow patterns).
  - Each tier has a distinct storage substrate: in-context token buffer for [[Working Memory]]; [[Vector Database]] with dense [[Embeddings]] for [[Episodic Memory]]; [[Knowledge Graph]] with entity nodes and typed edges for [[Semantic Memory]]; or parametric weights via [[Fine-Tuning]] for [[Procedural Memory]].
  - Retrieval mechanisms differ accordingly: attention-based implicit recall operates within the [[Context Window]]; approximate nearest-neighbour search (HNSW, IVF) retrieves from episodic stores; graph traversal queries the semantic store; weight activation accesses parametric [[Procedural Memory]].
  - Decay and [[Consolidation]] dynamics also differ by tier: [[Working Memory]] is evicted by context overflow; episodic entries expire by TTL or importance weighting; semantic entities are deduplicated and updated; procedural knowledge is refined by weight updates or few-shot example curation.
  - Together these tiers allow an agent to reason as if it has persistent awareness across hours, days, and deployments rather than being amnesic at every session boundary.
  - The field draws directly from Endel Tulving's 1972 taxonomy of human [[Long-Term Memory]] and from cognitive architectures such as [[ACT-R]], Soar, and CLARION, but must translate these psychological models into practical engineering choices about storage engines, embedding models, retrieval strategies, [[Consolidation]] schedules, and [[Privacy]]-aware [[Forgetting]].
  - The [[CoALA]] (Cognitive Architectures for Language Agents) framework (Sumers et al., arXiv:2309.02427, 2023–2024) provided the most widely adopted formal taxonomy, defining [[Working Memory]] and long-term memory subdivided into episodic, semantic, and procedural components with internal actions (reasoning, retrieval, learning) and external actions (grounding in the environment).
  - By mid-2026 agent memory has undergone a rapid migration from academic concept to production infrastructure: four commercial frameworks (Letta, Zep, Mem0, LangMem) compete for the enterprise market, valued at USD 6.3 billion in 2025 and projected to reach USD 28.5 billion by 2030 at 35% CAGR.

- ### Semantic Classification
  - owl-class:: artificial-intelligence:AgentMemory
  - owl-role:: CognitiveInfrastructure | MemoryMechanism
  - owl-inferred:: artificial-intelligence:EpisodicStore, artificial-intelligence:SemanticStore, artificial-intelligence:ProceduralStore, artificial-intelligence:WorkingMemoryBuffer
  - belongs-to-domain:: [[AI-GroundedDomain]], [[ComputationAndIntelligenceDomain]]
  - implemented-in-layer:: [[ApplicationLayer]], [[AlgorithmLayer]]

- ### Relationships
  - is-subclass-of:: [[AI Agent]], [[Cognitive Architecture]], [[Memory Management]]
  - has-part:: [[Episodic Memory]], [[Semantic Memory]], [[Procedural Memory]], [[Working Memory]], [[Long-Term Memory]], [[Knowledge Graph]]
  - requires:: [[Vector Database]], [[Embeddings]], [[Retrieval-Augmented Generation]], [[Context Window]], [[Foundation Model]], [[Large Language Models]]
  - enables:: [[Agentic Workflow]], [[Personalisation]], [[Task Automation]], [[Planning and Scheduling]], [[Self-Reflection]], [[Continual Learning]], [[In-Context Learning]]
  - implements:: [[ReAct Pattern]], [[Reflexion Pattern]], [[Chain of Thought]]
  - depends-on:: [[Embeddings]], [[Vector Database]], [[Knowledge Graph]], [[Attention Mechanism]], [[Reasoning Engine]]
  - supports:: [[Multi-Agent System]], [[AI Safety]], [[Human-in-the-Loop]], [[Provenance]], [[Agent Identity]]
  - uses:: [[Pinecone]], [[pgvector]], [[Weaviate]], [[Information Retrieval]], [[Knowledge Representation]], [[Temporal Reasoning]]
  - contrasts-with:: [[In-Context Learning]], [[Fine-Tuning]], [[Context Window]]
  - related-to:: [[Agentic AI]], [[Hallucination]], [[Forgetting]], [[Compression]], [[Privacy]], [[GDPR]], [[Autonomous Agent]], [[Consolidation]]
  - bridges-to:: [[Agent Loop]], [[Tool Use]], [[Cognitive Architecture]]
...
- ### Content
  ...
  - ## Use Cases / Major Families
    ...
    - This information lives in user-scoped [[Semantic Memory]], enabling the assistant to [[Personalisation|personalise]] every response without the user re-explaining context at each session.
    - A 2025 Mem0 deployment case study showed 40% reduction in user re-orientation time and 67% improvement in [[Task Automation|task completion rate]] for an enterprise personal assistant agent.
    ...
    - Zep's HIPAA-certified temporal [[Knowledge Graph]] stores customer interaction histories in the healthcare sector, where [[Audit Trail|audit trails]] and data retention policies are regulatory requirements.
  ...
  - ## UK Context
    ...
    - Manchester's industrial ecosystem provides practical demand drivers: financial services firms (Manchester is the UK's second financial centre) deploying trading and compliance agents require persistent [[Audit Trail|audit-trail]] memory satisfying FCA record-keeping regulations.
    - Sheffield Robotics (joint University of Sheffield and Sheffield Hallam centre) works on embodied agent memory for robot navigation — maintaining persistent spatial maps (a form of [[Semantic Memory]]) and episode logs of prior [[Task Automation|task execution]].
  ...
  - ## Research & Literature
    ...
    - 2. Baddeley, A. & Hitch, G. (1974). Working Memory. Psychology of Learning and Motivation, 8, 47–89. [Multi-component working memory model mapping to agent context window architecture.]
    - 3. Anderson, J.R. (1983). The Architecture of Cognition. Harvard University Press. [ACT-R procedural + declarative memory — basis for agent procedural memory design.]
    - 4. Laird, J., Newell, A. & Rosenbloom, P. (1987). SOAR: An Architecture for General Intelligence. Artificial Intelligence, 33(1), 1–64. [Cognitive architecture with production memory — precursor to agent memory systems.]
    - 5. Sumers, T.R. et al. (2024). Cognitive Architectures for Language Agents. Transactions on Machine Learning Research. arXiv:2309.02427. [Canonical CoALA taxonomy: working, episodic, semantic, procedural memory for LLM agents.]
    - 6. Packer, C. et al. (2023). MemGPT: Towards LLMs as Operating Systems. arXiv:2310.08560. [OS-inspired virtual context management; Letta production evolution.]
    - 7. Shichun Liu et al. (2025). Memory in the Age of AI Agents: A Survey. GitHub. https://github.com/Shichun-Liu/Agent-Memory-Paper-List [200+ paper survey; canonical research map of agent memory space.]
    - 8. Mem0.ai. (2026). State of AI Agent Memory 2026: Benchmarks, Architectures & Production Gaps. https://mem0.ai/blog/state-of-ai-agent-memory-2026 [Industry benchmarking report; LoCoMo 92.5%, LongMemEval 94.4% for Mem0.]
    - 9. Shinn, N. et al. (2023). Reflexion: Language Agents with Verbal Reinforcement Learning. NeurIPS 2023. arXiv:2303.11366. [Episodic self-reflection stored as procedural memory; 20-30% improvement baseline.]
    - 10. Park, J.S. et al. (2023). Generative Agents: Interactive Simulacra of Human Behavior. UIST 2023. arXiv:2304.03442. [Seminal multi-agent memory architecture with reflection, retrieval, and planning streams.]
    - 11. Yao, S. et al. (2023). ReAct: Synergizing Reasoning and Acting in Language Models. ICLR 2023. arXiv:2210.03629. [ReAct pattern: working memory as interleaved reasoning-action-observation scratchpad.]
    - 12. Anatomy of Agentic Memory. (2025). Taxonomy and Empirical Analysis of Evaluation and System Limitations. arXiv:2602.19320. [First systematic empirical analysis across six evaluation dimensions; consolidation identified as key gap.]
    - 13. Rethinking Memory Mechanisms of Foundation Agents in the Second Half: A Survey. (2026). arXiv:2602.06052. [Survey identifying consolidation as most critical unsolved problem in production agent memory.]
    - 14. AMA-Bench. (2026). Evaluating Long-Horizon Memory for Agentic Applications. arXiv:2602.22769. [Benchmark specifically targeting long-horizon agentic memory across multi-session tasks.]
    - 15. Live-Evo. (2026). Online Evolution of Agentic Memory from Continuous Feedback. arXiv:2602.02369. [Online episodic-to-semantic consolidation without human curation.]
    - 16. Self-Consolidation for Self-Evolving Agents. (2026). arXiv:2602.01966. [Offline autonomous consolidation of episodic to procedural knowledge; lifelong agent learning.]
    - 17. ActMem. (2026). Bridging the Gap Between Memory Retrieval and Reasoning in LLM Agents. arXiv:2603.00026. [Adaptive procedure selection via memory-reasoning integration.]
    - 18. PlugMem. (2026). A Task-Agnostic Plugin Memory Module for LLM Agents. arXiv:2603.03296. [Cross-agent shared memory module; improved coordination on 17 multi-agent benchmarks.]
    - 19. Chain-of-Memory. (2026). Lightweight Memory Construction with Dynamic Evolution for LLM Agents. arXiv:2601.14287. [Efficient episodic chain construction with dynamic updating.]
    - 20. Vectorize.io. (2026). Best AI Agent Memory Systems in 2026: 8 Frameworks Compared. https://vectorize.io/articles/best-ai-agent-memory-systems [Independent comparative benchmark: Mem0 vs Zep vs Letta vs LangMem vs others.]
    - 21. Hintzman, D.L. (1988). Judgments of Frequency and Recognition Memory in a Multiple-Trace Memory Model. Psychological Review, 95(4), 528–551. [MINERVA-2: instance-based retrieval via activation-weighted similarity — ancestor of embedding retrieval.]
    - 22. McClelland, J.L. & Rumelhart, D.E. (1986). Parallel Distributed Processing (Vol. 2). MIT Press. [Complementary learning systems theory influencing hippocampal-neocortical consolidation models in AI.]
    - 23. Sun, R. (2006). The CLARION Cognitive Architecture. Cognition and Multi-Agent Interaction. Cambridge University Press. [Implicit/explicit learning distinction mapping to parametric vs. retrieval memory split.]
    - 24. Digital Applied. (2026). AI Agent Memory 2026: Vector, Graph, Episodic Update. https://www.digitalapplied.com/blog/ai-agent-memory-vector-graph-episodic-2026 [Industry analysis of hybrid vector-graph architectures in enterprise deployment.]
    - 25. UCL. (2025). UCL to Lead UK's Brain-Inspired Computing Push with New Innovation Centre. UCL News. https://www.ucl.ac.uk/news/2025/sep/ucl-lead-uks-brain-inspired-computing-push-new-innovation-centre [UK neuromorphic computing initiative with implications for persistent edge agent memory.]
    - 26. Atlan. (2026). Best AI Agent Memory Frameworks in 2026: Compared and Ranked. https://atlan.com/know/best-ai-agent-memory-frameworks-2026/ [Framework comparison; Mem0 as most widely deployed semantic memory layer mid-2026.]
    - 27. Introduction to Cognitive Artificial Intelligence. (2023). NCBI PMC. https://www.ncbi.nlm.nih.gov/pmc/articles/PMC10239676/ [Bridge between cognitive science memory models and AI agent design; taxonomy alignment.]
    - 28. Zylos Research. (2026). AI Agent Memory Architectures: From Context Windows to Persistent Knowledge. https://zylos.ai/research/2026-04-05-ai-agent-memory-architectures-persistent-knowledge/ [Production architecture patterns: pure vector vs. hybrid vector-graph vs. parametric for 2026 deployments.]

- ### Provenance
  - sources:: Tulving (1972) episodic/semantic; Baddeley & Hitch (1974) working memory; CoALA arXiv:2309.02427 (Sumers et al. 2024); MemGPT arXiv:2310.08560 (Packer et al. 2023); Reflexion arXiv:2303.11366 (Shinn et al. 2023); ReAct arXiv:2210.03629 (Yao et al. 2023); Park et al. Generative Agents arXiv:2304.03442 (2023); Mem0 State of Agent Memory 2026 report; Vectorize.io 8 frameworks benchmark 2026; arXiv:2602.19320 anatomy of agentic memory; arXiv:2602.06052 rethinking memory survey; arXiv:2602.22769 AMA-Bench; arXiv:2602.02369 Live-Evo; arXiv:2602.01966 Self-Consolidation; arXiv:2603.00026 ActMem; arXiv:2603.03296 PlugMem; arXiv:2601.14287 Chain-of-Memory; Atlan 2026 framework comparison; digitalapplied.com agent memory 2026; UCL neuromorphic computing initiative 2025; zylos.ai memory architectures 2026
