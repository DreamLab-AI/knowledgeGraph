...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "ensemble-collaborative-intelligence-principle",
...
```json-ld
{
  ...
  "@id": "urn:ngm:class:ensemble-collaborative-intelligence-principle",
  "@type": "Class",
  "label": "Ensemble Collaborative Intelligence Principle",
