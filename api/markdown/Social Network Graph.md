schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#SocialNetworkGraph
legacy_uri:: urn:visionclaw:concept:spatial-computing:social-network-graph
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-9db0df7fb91d"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#SocialNetworkGraph"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:social-network-graph"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:b0cc9968822c7a172d586ddda8588870f9cf0f0b6065d40f8f9443faf6d9b40a@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
