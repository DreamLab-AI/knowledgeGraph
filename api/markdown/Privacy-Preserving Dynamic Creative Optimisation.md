...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "privacy-preserving-dynamic-creative-optimisation",
...
```json-ld
{
  ...
  "@id": "urn:ngm:class:privacy-preserving-dynamic-creative-optimisation",
  "@type": "Class",
  "label": "Privacy-Preserving Dynamic Creative Optimisation",
