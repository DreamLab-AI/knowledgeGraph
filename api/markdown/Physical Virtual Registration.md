schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#PhysicalVirtualRegistration
legacy_uri:: urn:visionclaw:concept:spatial-computing:physical-virtual-registration
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-221de6865a24"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#PhysicalVirtualRegistration"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:physical-virtual-registration"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
