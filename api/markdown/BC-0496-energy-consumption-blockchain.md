- ### OntologyBlock
  ...
  collapsed:: true
	- ontology:: true
	- term-id:: BC-0496
	- preferred-term:: BlockchainEnergyConsumption
	- alternative-terms:: Blockchain Energy Usage, Crypto Energy Consumption, Proof-of-Work Energy Cost, Blockchain Carbon Footprint, Blockchain Sustainability
	- source-domain:: bc
	...
	- source:: [[Cambridge Centre for Alternative Finance]], [[International Energy Agency (IEA)]], [[Ethereum Foundation]], [[Bitcoin Mining Council]], [[IEEE Blockchain Standards]]
	- owl:class:: bc:BlockchainEnergyConsumption
	- owl:role:: PerformanceMetric
	- is-subclass-of:: [[EnvironmentalImpact]], [[BlockchainPerformance]], [[Sustainability]]
	- belongsToDomain:: [[BlockchainDomain]], [[EnvironmentalDomain]], [[EnergySector]]
	...
	- measured-by:: [[TotalEnergyUsage]], [[EnergyPerTransaction]], [[CarbonFootprint]], [[ElectricityIntensity]]
	- related-to:: [[ProofOfWork]], [[ProofOfStake]], [[MiningPool]], [[RenewableEnergy]], [[CarbonOffset]]
...
(Declaration (Class :BlockchainEnergyConsumption))

;; Annotations
(AnnotationAssertion rdfs:label :BlockchainEnergyConsumption "BlockchainEnergyConsumption"@en)
(AnnotationAssertion rdfs:comment :BlockchainEnergyConsumption "The electrical power and computational resources consumed by blockchain networks during transaction validation, block creation, and network security operations, varying significantly across consensus mechanisms from energy-intensive Proof-of-Work to energy-efficient Proof-of-Stake, with ongoing research into sustainable consensus algorithms and environmental impact measurement."@en)

;; Data Properties
(AnnotationAssertion dcterms:identifier :BlockchainEnergyConsumption "BC-0496"^^xsd:string)

;; SubClass relationships
(SubClassOf :BlockchainEnergyConsumption :EnvironmentalImpact)
(SubClassOf :BlockchainEnergyConsumption :BlockchainPerformanceMetric)
(SubClassOf :BlockchainEnergyConsumption :SustainabilityIndicator)

;; Object properties
(SubClassOf :BlockchainEnergyConsumption
  (ObjectSomeValuesFrom :hasPart :ElectricityConsumption))
(SubClassOf :BlockchainEnergyConsumption
  (ObjectSomeValuesFrom :dependsOn :ConsensusMechanism))
(SubClassOf :BlockchainEnergyConsumption
  (ObjectSomeValuesFrom :measuredBy :TotalEnergyUsage))
```

- ## About BlockchainEnergyConsumption
	...
	- ### References
	  ...
	  - **Review Status**: Comprehensive technical review
	  - **Verification**: Academic sources verified, 2026 data current, CBECI methodology
	  - **Regional Context**: UK/North England blockchain energy research
	  - **Authority Score**: 0.88 (Cambridge CCAF, IEA, peer-reviewed literature, industry standards)
