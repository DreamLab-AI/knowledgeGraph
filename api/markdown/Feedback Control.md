...
# RB-0047: Feedback Control
		  ...
		  ```clojure
		  (Declaration (Class :FeedbackControl))
		  (SubClassOf :FeedbackControl :Robot)
		  
		  (AnnotationAssertion rdfs:label :FeedbackControl "Feedback Control"@en)
		  (AnnotationAssertion rdfs:comment :FeedbackControl
		    "Feedback Control - Foundational robotics concept"@en)
		  (AnnotationAssertion :termID :FeedbackControl "RB-0047"^^xsd:string)
		  
		  (Declaration (ObjectProperty :relates To))
		  (ObjectPropertyDomain :relatesTo :FeedbackControl)
		  
		  (Declaration (DataProperty :hasProperty))
		  (DataPropertyDomain :hasProperty :FeedbackControl)
