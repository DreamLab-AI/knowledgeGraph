schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#PartitionAttack
legacy_uri:: urn:visionclaw:concept:blockchain:partition-attack
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-370a5e9c23e0"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#PartitionAttack"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:partition-attack"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:ea0602c7edd0ed7970fa40ab5016a7c3e2be6663691241509a0b32d1bd72a8e2@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
