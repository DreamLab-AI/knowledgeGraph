schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#StorageHardware
legacy_uri:: urn:visionclaw:concept:spatial-computing:storage-hardware
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-f51ec9d32a14"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#StorageHardware"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:storage-hardware"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:fa6ea870e942376ee4b0d335fbabdabf70e09e2b35211d56e7099ff7505625c7@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
