schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#ReputationData
legacy_uri:: urn:visionclaw:concept:spatial-computing:reputation-data
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-ddbe66e19b32"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#ReputationData"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:reputation-data"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
