```json-ld
{
  ...
  "@id": "urn:visionflow:page:rsa-signature",
  "@type": "Page",
  "title": "Rsa Signature",
  "vc:slug": "rsa-signature",
  "vc:public": true,
  "vc:schemaVersion": 2,
...
- Verification proves both authenticity and integrity: only the private-key holder [private] have produced the signature over the given digest.
- ### Overview
