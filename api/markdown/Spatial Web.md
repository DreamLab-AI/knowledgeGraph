schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#SpatialWeb
legacy_uri:: urn:visionclaw:concept:spatial-computing:spatial-web
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-dec9077380bd"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#SpatialWeb"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:spatial-web"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:cb6abc1bbdf211b0294e17fc7b5950f479e9cbfbeda69cf2dcc1a31e6edf49f3@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
