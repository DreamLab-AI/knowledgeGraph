schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#VerifiableCredentialStandard
legacy_uri:: urn:visionclaw:concept:spatial-computing:verifiable-credential-standard
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-285f283398ae"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#VerifiableCredentialStandard"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:verifiable-credential-standard"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:4c9e9ce7353e369aa20075224e67c5245d1ad0cf45d47f2ade2b574a856621c6@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
