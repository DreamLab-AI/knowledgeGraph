schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#VirtualLightingModel
legacy_uri:: urn:visionclaw:concept:spatial-computing:virtual-lighting-model
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-f362e839860b"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#VirtualLightingModel"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:virtual-lighting-model"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
