...
- is-subclass-of:: [[Metaverse]]
	  ...
	  collapsed:: true
		...
		- has-part:: [[Application API]]
		- has-part:: [[Service Interface]]
		- has-part:: [[User Interface Framework]]
		- has-part:: [[Business Logic Layer]]
		...
		- depends-on:: [[Content Delivery]]
		- depends-on:: [[Identity Services]]
