...
```json-ld
{
  ...
  "vc:public": true,
  "vc:outboundWikilinks": ["Software Commoditization", "Vendor-Customer Dynamics"],
  "vc:schemaVersion": 2
}
```
...
```json-ld
{
  ...
  "relations": {
    "relatedTo": [{"@id": "urn:ngm:class:ai-agent", "label": "AI Agent"}, {"@id": "urn:ngm:class:tool-use", "label": "Tool Use"}]
  },
  "provenance": {
