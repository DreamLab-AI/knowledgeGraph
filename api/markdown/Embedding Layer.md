...
- ### Content
  ...
  ## Components and Architecture
    ...
    - **Lookup Operation**: a forward pass selects matrix rows by integer [private], equivalent to multiplying E by a one-hot vector but implemented as O(1) indexing.
  ...
  ## Formal Algorithm
    ...
    - Forward pass: for input token [private] i, output e_i = E[i, :] (row selection)
  ...
  ## Future Directions (2026–2030)
    ...
    - **Continuous tokenisation and tokeniser-free models**: research into replacing the discrete vocabulary / embedding layer pair with continuous patch representations directly from raw bytes or audio samples (MegaByte, BYTELATENT) [private] fundamentally alter the embedding layer's role.
