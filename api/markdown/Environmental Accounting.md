schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#EnvironmentalAccounting
legacy_uri:: urn:visionclaw:concept:spatial-computing:environmental-accounting
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-ff72e60c2495"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#EnvironmentalAccounting"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:environmental-accounting"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:d166312d907e834e813de16b8cd276ef3cdd621fa30837c9a5b07401936670c6@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
```json-ld
{
  ...
  "definition": "Environmental Accounting is a concept within the metaverse domain. Further enrichment pending.",
  "vc:qualityScore": {
    "@value": "0.35",
    "@type": "xsd:float"
  },
