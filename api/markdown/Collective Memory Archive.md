schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#CollectiveMemoryArchive
legacy_uri:: urn:visionclaw:concept:spatial-computing:collective-memory-archive
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-11a2a7656e0a"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#CollectiveMemoryArchive"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:collective-memory-archive"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
