schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#TwoHeadsAreBetterThanOne
legacy_uri:: urn:visionclaw:concept:infrastructure:two-heads-are-better-than-one
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-712742507e50"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#TwoHeadsAreBetterThanOne"
    },
    {
      "vc:key": "maturity",
      "vc:value": "draft"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:two-heads-are-better-than-one"
    },
    {
      "vc:key": "status",
      "vc:value": "stub"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:a31d15f7bd3681c246b27cc34775dbfa59cdc2fed2615388c26ed96f9929652d@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:two-heads-are-better-than-one",
  "@type": "OntologyClass",
