schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#Halving
legacy_uri:: urn:visionclaw:concept:blockchain:halving
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-9e561be92b66"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#Halving"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:halving"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:0fffc68e65d7f0a98fa45763d384f060b81c381564f76e51e3091dcb1318007e@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
```json-ld
{
  ...
  "@type": "Class",
  "label": "Halving",
  "definition": "Periodic reward reduction within blockchain systems, providing essential functionality for distributed ledger technology operations and properties.",
  "domain": "blockchain",
