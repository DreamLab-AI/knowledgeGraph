schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/robotics#Robotics
legacy_uri:: urn:visionclaw:concept:robotics:robotics
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-4b9b6e6f8fa5"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/robotics#Robotics"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:robotics:robotics"
    },
    {
      "vc:key": "status",
      "vc:value": "active"
