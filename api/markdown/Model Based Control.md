...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:learned-dynamics-domain",
      "vc:label": "LearnedDynamicsDomain"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:optimisation-domain",
      "vc:label": "OptimisationDomain"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:planning-layer",
      "vc:label": "PlanningLayer"
    },
    {
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:model-based-control:776c802a9fc9",
  ...
  "vc:resolutions": [
    {
      "raw": "[[acados]]",
      "resolved": "urn:visionflow:linked:acados",
      "kind": "StubLink"
    },
    {
      "raw": "[[Aerial Robotics]]",
      "resolved": "urn:visionflow:linked:aerial-robotics",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Autonomous Vehicle Control]]",
      "resolved": "urn:visionflow:linked:autonomous-vehicle-control",
      "kind": "StubLink"
    },
    {
      "raw": "[[Behaviour Cloning]]",
      "resolved": "urn:visionflow:linked:behaviour-cloning",
      "kind": "StubLink"
    },
    {
      "raw": "[[CasADi]]",
      "resolved": "urn:visionflow:linked:cas-adi",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Constraint Set]]",
      "resolved": "urn:visionflow:linked:constraint-set",
      "kind": "StubLink"
    },
    {
      "raw": "[[Constraint Specification]]",
      "resolved": "urn:visionflow:linked:constraint-specification",
      "kind": "StubLink"
    },
    {
      "raw": "[[Contact Mechanics]]",
      "resolved": "urn:visionflow:linked:contact-mechanics",
      "kind": "StubLink"
    },
    {
      "raw": "[[Contact Model]]",
      "resolved": "urn:visionflow:linked:contact-model",
      "kind": "StubLink"
    },
    {
      "raw": "[[ControlLayer]]",
    ...
    {
      "raw": "[[Drake Toolbox]]",
      "resolved": "urn:visionflow:linked:drake-toolbox",
      "kind": "StubLink"
    },
    {
      "raw": "[[Dynamic Model]]",
    ...
    {
      "raw": "[[HPIPM]]",
      "resolved": "urn:visionflow:linked:hpipm",
      "kind": "StubLink"
    },
    {
      "raw": "[[iLQR]]",
      "resolved": "urn:visionflow:linked:i-lqr",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Inertia Tensor]]",
      "resolved": "urn:visionflow:linked:inertia-tensor",
      "kind": "StubLink"
    },
    {
      "raw": "[[Interior Point Methods]]",
      "resolved": "urn:visionflow:linked:interior-point-methods",
      "kind": "StubLink"
    },
    {
      "raw": "[[ISO 10218 Robot Safety]]",
      "resolved": "urn:visionflow:linked:iso-10218-robot-safety",
      "kind": "StubLink"
    },
    {
      "raw": "[[Jacobian Computation]]",
      "resolved": "urn:visionflow:linked:jacobian-computation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Koopman Operator Methods]]",
      "resolved": "urn:visionflow:linked:koopman-operator-methods",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[LearnedDynamicsDomain]]",
      "resolved": "urn:visionflow:linked:learned-dynamics-domain",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Model Free Reinforcement Learning]]",
      "resolved": "urn:visionflow:linked:model-free-reinforcement-learning",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Neural ODEs]]",
      "resolved": "urn:visionflow:linked:neural-odes",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[OptimisationDomain]]",
      "resolved": "urn:visionflow:linked:optimisation-domain",
      "kind": "StubLink"
    },
    {
      "raw": "[[Optimisation Solver]]",
      "resolved": "urn:visionflow:linked:optimisation-solver",
      "kind": "StubLink"
    },
    {
      "raw": "[[OSQP Solver]]",
      "resolved": "urn:visionflow:linked:osqp-solver",
      "kind": "StubLink"
    },
    {
      "raw": "[[PerceptionLayer]]",
    ...
    {
      "raw": "[[Pinocchio]]",
      "resolved": "urn:visionflow:linked:pinocchio",
      "kind": "StubLink"
    },
    {
      "raw": "[[PlanningLayer]]",
      "resolved": "urn:visionflow:linked:planning-layer",
      "kind": "StubLink"
    },
    {
      "raw": "[[Prediction Horizon]]",
      "resolved": "urn:visionflow:linked:prediction-horizon",
      "kind": "StubLink"
    },
    {
      "raw": "[[Predictive Control]]",
      "resolved": "urn:visionflow:linked:predictive-control",
      "kind": "StubLink"
    },
    {
      "raw": "[[Process Control]]",
    ...
    {
      "raw": "[[Real Time Motion Planning]]",
      "resolved": "urn:visionflow:linked:real-time-motion-planning",
      "kind": "StubLink"
    },
    {
      "raw": "[[Receding Horizon Control]]",
      "resolved": "urn:visionflow:linked:receding-horizon-control",
      "kind": "StubLink"
    },
    {
      "raw": "[[Robust Locomotion]]",
      "resolved": "urn:visionflow:linked:robust-locomotion",
      "kind": "StubLink"
    },
    {
      "raw": "[[Sample Efficient Learning]]",
      "resolved": "urn:visionflow:linked:sample-efficient-learning",
      "kind": "StubLink"
    },
    {
      "raw": "[[Sequential Quadratic Programming]]",
      "resolved": "urn:visionflow:linked:sequential-quadratic-programming",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[State Estimator]]",
      "resolved": "urn:visionflow:linked:state-estimator",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Whole Body Control]]",
      "resolved": "urn:visionflow:linked:whole-body-control",
      "kind": "StubLink"
    },
    {
      "raw": "[[Control Theory]]",
    ...
    {
      "raw": "[[Reactive Control]]",
      "resolved": "urn:visionflow:owl:class:reactive-control",
      "kind": "ResolvedLink"
    },
    {
...
- ### Definition
  - Model Based Control (MBC) is a class of control-system design paradigms in which an explicit mathematical model of the plant's dynamics — encoding kinematics, inertia tensors, contact forces, aerodynamics, or learned neural representations — is embedded within the controller to predict, plan, and optimise trajectories under physical and operational constraints. Rather than treating the mapping from sensor readings to actuator commands as a black-box function to be approximated by trial-and-error reinforcement, model-based approaches exploit known or identified structure to compute feedforward compensation, solve constrained optimisation problems over finite prediction horizons, propagate uncertainty through the dynamic model, and achieve real-time closed-loop operation on complex multi-body or hybrid systems. The result is dramatically improved sample efficiency, interpretable control policies, guaranteed constraint satisfaction (when combined with suitable optimisation formulations), and principled mechanisms for incorporating prior physical knowledge — advantages that are particularly compelling for safety-critical deployments such as legged locomotion, surgical robotics, aerospace flight control, and autonomous vehicle navigation.
  - The central abstraction is a dynamic model x_{t+1} = f(x_t, u_t) — or in continuous time ẋ = f(x, u) — where x ∈ ℝⁿ is the state vector, u ∈ ℝᵐ is the control input, and f encapsulates the system's physics. Controllers are synthesised with respect to this model, using techniques drawn from optimal control theory, constrained optimisation, differential geometry, and statistical learning. The accuracy of the model determines controller performance; uncertainty about f gives rise to robust MPC, tube MPC, and Bayesian/Gaussian-process variants that propagate confidence intervals through the prediction horizon to maintain safety guarantees even when the plant deviates from the nominal model.
  - **Model Predictive Control (MPC)** is the most industrially widespread MBC technique. At each sampling instant it solves a finite-horizon optimal control problem: minimise J = Σ_{k=0}^{N-1} l(x_k, u_k) + V_f(x_N) subject to x_{k+1} = f(x_k, u_k), x_k ∈ X, u_k ∈ U, only the first optimal input u*_0 is applied (receding-horizon principle), and the optimisation is repeated at the next step. This receding-horizon strategy confers robustness to disturbances and model mismatch by continuously re-solving the problem with fresh state measurements. The computational bottleneck historically confined MPC to slow chemical-process systems; embedded QP solvers (OSQP, HPIPM, acados) and warm-started sequential quadratic programming (SQP) now enable sub-millisecond solution times for linear MPC and tens-of-milliseconds for nonlinear MPC on robot hardware.
  - **Differential Dynamic Programming (DDP)** and its first-order variant **iterative Linear Quadratic Regulator (iLQR)** solve trajectory-optimisation problems by iteratively backward-sweeping a second-order expansion of the value function along a nominal trajectory, computing a locally optimal feedback gain and feedforward correction, then forward-integrating the improved control sequence. Tassa et al. (2012, 2014) demonstrated iLQR/DDP as the algorithmic core of real-time motion synthesis in MuJoCo, enabling the generation of physically plausible whole-body behaviours — swimming, cartwheel, manipulation — without hand-crafted motion primitives. The O(n³) backward pass scales with the number of degrees of freedom and is highly amenable to GPU parallelisation across multiple rollouts.
  - **Whole-Body Control (WBC)** extends inverse-dynamics ideas to floating-base robots (humanoids, quadrupeds) with full consideration of contact constraints, joint torque limits, and task hierarchies. A quadratic program is solved at 1 kHz to compute joint torques that simultaneously track Cartesian tasks (end-effector position, CoM acceleration, foot placement) while satisfying the rigid-body equations of motion, unilateral contact constraints (normal forces ≥ 0), friction cone membership, and joint velocity/torque limits. Boston Dynamics' Atlas and Spot controllers, the ETH Zurich ANYmal controller (Bellicoso et al. 2019), and IIT's HyQ MPC framework (Fahmi et al. 2020) all deploy WBC-MPC pipelines that couple a high-level trajectory planner (MPC or footstep planner) with a low-level WBC that maps desired accelerations to joint torques at kHz rates.
  - **Contact-implicit MPC** reformulates locomotion planning so that contact mode sequences — when and where each foot touches the ground — emerge as decisions within the optimisation rather than requiring pre-specified gait schedules. Mixed-integer formulations enumerate contact modes combinatorially (infeasible for long horizons), while complementarity-based relaxations smooth contact constraints into interior-point solvable form. Manchester et al. (2020) and Posa et al. (2016) demonstrated contact-implicit trajectory optimisation for Atlas and Cassie, enabling transitions between standing, walking, jumping, and falling without requiring mode enumeration.
  - **Robust and Tube MPC** explicitly model bounded uncertainty sets Δf around the nominal dynamics and compute control laws that maintain all possible disturbed trajectories within a constraint-satisfying "tube" around the nominal solution. Min-max MPC solves the worst-case problem; stochastic MPC minimises expected cost under distributional uncertainty. For legged robots operating on unknown terrain, tube MPC with friction-cone uncertainty provides formal fall-prevention guarantees even when ground reaction forces deviate from predicted values.
  - **Koopman Operator MPC** exploits the Koopman framework to "lift" nonlinear dynamics into a globally linear (but high-dimensional) space: z_{t+1} = K z_t, where z = Φ(x) is a vector of observable functions and K is the (infinite-dimensional in theory, finite-rank in practice) Koopman operator. Once K is identified from data via EDMD (Extended Dynamic Mode Decomposition), standard linear MPC tools apply directly to the lifted representation. Bruder et al. (2019) applied this to soft robot arms; more recently, Deep Koopman Networks learn Φ end-to-end from raw sensor streams, enabling linear MPC on systems with highly nonlinear and unmodelled dynamics.
  - **Learned Dynamics Models** integrate neural networks, Gaussian processes (GPs), or probabilistic ensembles into the f(x, u) component. Neural network dynamics models (Nagabandi et al. 2018, Chua et al. 2018 — PETS/PILCO) can be trained from hundreds to thousands of physical interactions and used within MPC planning loops. GPs provide calibrated posterior uncertainty estimates; ensemble models capture epistemic uncertainty through disagreement between network predictions. MBPO (Model-Based Policy Optimisation, Janner et al. 2019) uses a learned dynamics model to generate synthetic rollouts that augment a model-free SAC/TD3 policy, achieving order-of-magnitude sample efficiency gains on MuJoCo benchmark tasks.
  - **System Identification (SysID)** is the process of estimating the parameter vector θ of a parametric model structure f(x,u;θ) from input-output data. Classical SysID (prediction error methods, subspace methods, frequency-domain identification) assumes a known model structure; modern data-driven SysID uses neural ODEs, latent state-space models, or physics-informed neural networks that encode known conservation laws as hard constraints. Online SysID (recursive least squares, extended Kalman filtering) updates model parameters in real time to handle wear, load changes, and environmental variation.
  - The relationship to **model-free reinforcement learning (RL)** is complementary rather than adversarial. Model-free RL (PPO, SAC, TD3) excels at asymptotic task performance when abundant interaction data is available and when the reward function encodes all desiderata. Model-based methods excel at sample efficiency — reaching near-optimal performance with 10×–100× fewer environment interactions — and at hard constraint satisfaction, making them preferable in scenarios where physical trials are expensive, dangerous, or time-limited. Dyna-style architectures (Sutton 1991) and more recent algorithms such as DreamerV3 (Hafner et al. 2023) and TD-MPC2 (Hansen et al. 2023) hybridise both paradigms: a world model supports planning and imagination-based value estimation while a model-free critic corrects for model bias at the boundary of reliable prediction.
  - A principled **taxonomy of model-based methods** by modelling fidelity spans four tiers: (1) exact physics models (rigid-body dynamics with analytic parameter identification) providing near-zero modelling error but requiring detailed mechanical knowledge; (2) grey-box hybrid models (physics structure + neural residuals) balancing interpretability and expressiveness; (3) black-box neural dynamics models (neural ODEs, probabilistic ensembles) capturing arbitrary nonlinearity at the cost of interpretability and extrapolation guarantees; and (4) Koopman/spectral linearisations trading nonlinear accuracy for computational tractability in downstream linear MPC solvers. The choice of tier is determined by the accuracy requirements of the control task, the computational budget of the deployment platform, and the availability and volume of system interaction data.

- ### Semantic Classification
  - owl-class:: robotics:ModelBasedControl
  - owl-role:: ControlParadigm
  - owl-inferred:: robotics:OptimalControl, robotics:TrajectoryOptimisation, robotics:PredictiveControl
  - belongs-to-domain:: [[RoboticsDomain]], [[ControlSystemsDomain]], [[OptimisationDomain]], [[LearnedDynamicsDomain]]
  - implemented-in-layer:: [[PlanningLayer]], [[ControlLayer]], [[PerceptionLayer]]

- ### Relationships
  - is-subclass-of:: [[Control Theory]], [[Optimal Control]], [[Trajectory Optimisation]], [[Predictive Control]], [[Robot Control]]
  - has-part:: [[Model Predictive Control]], [[iLQR]], [[Differential Dynamic Programming]], [[Whole Body Control]], [[System Identification]], [[Contact Model]], [[Cost Function]], [[Prediction Horizon]], [[Constraint Set]]
  - requires:: [[Dynamic Model]], [[State Estimator]], [[Constraint Specification]], [[Optimisation Solver]], [[Jacobian Computation]], [[Inertia Tensor]]
  - enables:: [[Real Time Motion Planning]], [[Constraint Satisfaction]], [[Sample Efficient Learning]], [[Robust Locomotion]], [[Compliant Manipulation]], [[Autonomous Vehicle Control]]
  - implements:: [[Receding Horizon Control]], [[Quadratic Programming]], [[Sequential Quadratic Programming]], [[Interior Point Methods]], [[Differential Dynamic Programming]], [[Koopman Operator Methods]]
  - depends-on:: [[Lagrangian Mechanics]], [[Convex Optimisation]], [[Linear Algebra]], [[Numerical Integration]], [[Contact Mechanics]], [[State Estimation]]
  - supports:: [[Legged Locomotion]], [[Aerial Robotics]], [[Surgical Robotics]], [[Industrial Manipulation]], [[Autonomous Driving]], [[Process Control]]
  - uses:: [[MuJoCo]], [[Pinocchio]], [[Drake Toolbox]], [[OSQP Solver]], [[HPIPM]], [[CasADi]], [[acados]]
  - contrasts-with:: [[Model Free Reinforcement Learning]], [[Reactive Control]], [[Impedance Control]], [[Behaviour Cloning]]
  - related-to:: [[Reinforcement Learning]], [[Sim to Real Transfer]], [[Digital Twin]], [[Gaussian Processes]], [[Neural ODEs]], [[Kalman Filter]]
  - standardized-by:: [[IEEE Control Systems Society]], [[IFAC]], [[ISO 10218 Robot Safety]]
...
- ### Content
  ...
  - ### Core Algorithmic Families
	  ...
	  MPC is a receding-horizon optimal control scheme solving the finite-horizon problem:
	  minimise J = Σ_{k=0}^{N-1} [xᵀQx + uᵀRu] + x_NᵀP x_N
	  subject to x_{k+1} = Ax_k + Bu_k (linear model), x_k ∈ X, u_k ∈ U
	  at each sample time, applying only the first optimal input and repeating. For nonlinear systems, the dynamics are linearised at each step (linearisation-based NMPC) or handled directly by interior-point NLP solvers (full NMPC). Key solver technologies:
	  ...
	  **Backward pass**: Compute value function V(x_t) = min_{u_t} [l(x_t,u_t) + V(x_{t+1}(x_t,u_t))] via second-order Taylor expansion around the current nominal trajectory (x̄, ū). This yields quadratic local models Q_xx, Q_uu, Q_xu and linear feedback gains k_t, K_t.
	  **Forward pass**: Simulate the improved control u_t = ū_t + k_t + K_t(x_t - x̄_t) to obtain a new nominal trajectory with reduced cost; add line search for convergence.
	  iLQR (Todorov & Li 2004; Tassa et al. 2012) drops second-order dynamics terms (f_xx, f_xu, f_uu ≈ 0), reducing backward-pass complexity while maintaining super-linear convergence in practice. iLQR/DDP are the algorithmic backbone of:
	  ...
	  Whole-body control formulates robot motion as a hierarchical QP:
	  minimise Σᵢ wᵢ ‖Jᵢ q̈ + J̇ᵢ q̇ - ẍᵢ_d‖² + w_τ ‖τ‖²
	  subject to M(q)q̈ + C(q,q̇)q̇ + g(q) = τ + Jcᵀ λ (rigid-body dynamics)
	           Jc q̈ + J̇c q̇ = 0 (rigid contact: zero acceleration at contact)
	           λ ∈ FC (friction cone: Coulomb friction, normal force ≥ 0)
	           τ_min ≤ τ ≤ τ_max (actuator limits)
	  This resolved motion control framework (Kanoun et al. 2011; Escande et al. 2014) runs at 1 kHz on embedded RT-Linux or real-time Xenomai platforms. Key implementations:
  ...
  - Model-based control systems decompose into four architectural layers, each with well-defined interfaces and characteristic computational budgets:
	  ...
	  - **Proprioceptive forward kinematics**: Joint encoder readings q provide precise link positions; the Recursive Newton-Euler Algorithm (RNEA) and forward kinematic Jacobians map joint-space state to Cartesian-space tool and CoM positions. Model-based observers (Mistry et al. 2010) estimate contact forces from joint torque sensors without explicit FTS.
	  The state estimator outputs (x̂, P_x) — posterior mean and covariance — consumed by the MPC. Estimator frequency determines MPC feedback rate; 500 Hz is typical for legged robots.
	  ...
	  - **Hybrid residual models**: The rigid-body model handles known kinematics and inertia; a neural residual δf_θ(x, u) corrects for unmodelled effects (foot compliance, motor flexibility, aerodynamic drag, cable dynamics). This architecture (Lee et al. 2020, Learning-Based WBC) preserves the interpretability and physical constraints of the rigid-body model while adapting to real-world deviations.
	  The prediction model is evaluated N times (N=20–50 typical) at each MPC step to unroll the prediction horizon. GPU parallelism (Isaac Gym, MJX) allows 1,000–16,384 parallel rollouts simultaneously for sampling-based MPC variants.
	  ...
	  - **Sampling-based MPC (MPPI, CEM)**: Generate K=1,000–16,384 random control perturbations, roll out in parallel on GPU, compute importance-weighted cost average (MPPI) or select elite trajectories (CEM). No gradient required — applicable to non-differentiable dynamics. MJPC uses CEM + iLQR asynchronously.
	  Frameworks providing autodiff interfaces: CasADi (symbolic, C-code generation), JAX (functional autodiff, GPU-native), PyTorch (dynamic computation graph, CUDA), and Pinocchio's analytical derivatives (fastest, requires model specification in Pinocchio format).
  ...
  - ## Use Cases and Major Application Families
	  ...
	  **Boston Dynamics Spot and Atlas** (2018–2026):
	  The operational MBC stack combines four tightly coupled layers:
  ...
  - ## Metadata
    - **Term ID**: RB-9018
    - **Domain**: robotics
    - **Ontological domain confirmed**: `robotics` — correct; no domain correction required
    ...
    - **Domain corrections**: None required — `robotics` domain is correct for Model Based Control
    - **Wikilinks**: 71 cross-concept links covering control theory, robotics, optimisation, learning, and tools
