schema_version:: 1
legacy_iri:: https://visionclaw.dreamlab-ai.systems/ns/v2/artificial-intelligence#LearningAlgorithm
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:learning-algorithm
public:: true
...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:optimisation-layer",
      "vc:label": "OptimisationLayer"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-61a3946bd8bc"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "https://visionclaw.dreamlab-ai.systems/ns/v2/artificial-intelligence#LearningAlgorithm"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:learning-algorithm"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:learning-algorithm:776c802a9fc9",
  ...
  "vc:resolutions": [
    {
      "raw": "[[Actor Network]]",
      "resolved": "urn:visionflow:linked:actor-network",
      "kind": "StubLink"
    },
    {
      "raw": "[[Adam Optimiser]]",
    ...
    {
      "raw": "[[BYOL]]",
      "resolved": "urn:visionflow:linked:byol",
      "kind": "StubLink"
    },
    {
      "raw": "[[Calculus of Variations]]",
      "resolved": "urn:visionflow:linked:calculus-of-variations",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Continual Learner]]",
      "resolved": "urn:visionflow:linked:continual-learner",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Contrastive Loss]]",
      "resolved": "urn:visionflow:linked:contrastive-loss",
      "kind": "StubLink"
    },
    {
      "raw": "[[Critic Network]]",
      "resolved": "urn:visionflow:linked:critic-network",
      "kind": "StubLink"
    },
    {
      "raw": "[[DINO]]",
      "resolved": "urn:visionflow:linked:dino",
      "kind": "StubLink"
    },
    {
      "raw": "[[DQN]]",
      "resolved": "urn:visionflow:linked:dqn",
      "kind": "StubLink"
    },
    {
      "raw": "[[Drug Discovery]]",
    ...
    },
    {
      ...
      "resolved": "urn:visionflow:linked:evolutionary-algorithms",
      "kind": "StubLink"
    },
    {
      "raw": "[[EWC]]",
      "resolved": "urn:visionflow:linked:ewc",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[IEEE Transactions on Neural Networks]]",
      "resolved": "urn:visionflow:linked:ieee-transactions-on-neural-networks",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Journal of Machine Learning Research]]",
      "resolved": "urn:visionflow:linked:journal-of-machine-learning-research",
      "kind": "StubLink"
    },
    {
      "raw": "[[Linear Algebra]]",
    ...
    {
      "raw": "[[MAML]]",
      "resolved": "urn:visionflow:linked:maml",
      "kind": "StubLink"
    },
    {
      "raw": "[[Markov Decision Processes]]",
      "resolved": "urn:visionflow:linked:markov-decision-processes",
      "kind": "StubLink"
    },
    {
      "raw": "[[Meta-Learner]]",
      "resolved": "urn:visionflow:linked:meta-learner",
      "kind": "StubLink"
    },
    {
      "raw": "[[Meta-Learning]]",
    ...
    },
    {
      ...
      "resolved": "urn:visionflow:linked:objective-function",
      "kind": "StubLink"
    },
    {
      "raw": "[[Optimisation]]",
    ...
    {
      "raw": "[[OptimisationLayer]]",
      "resolved": "urn:visionflow:linked:optimisation-layer",
      "kind": "StubLink"
    },
    {
      "raw": "[[Policy Gradient]]",
    ...
    {
      "raw": "[[Replay Buffer]]",
      "resolved": "urn:visionflow:linked:replay-buffer",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[SAC]]",
      "resolved": "urn:visionflow:linked:sac",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[SimCLR]]",
      "resolved": "urn:visionflow:owl:class:sim-clr",
      "kind": "ResolvedLink"
    },
    {
...
- ### Definition
  - LearningAlgorithm is a computational procedure that enables a model or agent to improve task performance through exposure to data or environmental interaction, encompassing the full spectrum of paradigms — supervised learning (mapping labelled inputs to outputs via empirical risk minimisation over a hypothesis class, training neural networks, support vector machines, decision trees and gradient-boosted ensembles from labelled examples), unsupervised learning (discovering latent structure in unlabelled data via clustering, dimensionality reduction, and density estimation without supervisory signal), semi-supervised learning (combining sparse labelled examples with abundant unlabelled data through graph-based label propagation, pseudo-labelling, consistency regularisation, and MixMatch/FixMatch), self-supervised learning (constructing supervisory signals from data structure — masked language modelling for BERT, autoregressive next-token prediction for GPT, masked image modelling for MAE), reinforcement learning (optimising sequential decision-making via Bellman equations and reward signals within Markov Decision Processes), meta-learning (adapting rapidly across task distributions from few examples via MAML bilevel optimisation and Reptile first-order approximation), continual learning (acquiring new competencies without catastrophic forgetting of previous tasks via EWC Fisher-information regularisation, progressive networks, and replay), curriculum learning (ordering training examples from easy to hard in the spirit of Bengio et al. 2009 to accelerate convergence 2-5×), federated learning (training across distributed private data silos without raw-data centralisation via FedAvg aggregation and differential privacy), contrastive learning (shaping embedding geometry by attracting augmented positive pairs and repelling negatives via SimCLR NT-Xent, BYOL asymmetric predictor, and DINO self-distillation), together with their specific algorithmic instantiations across gradient descent variants (SGD with momentum achieving O(1/T) convergence for strongly convex objectives, Adam Kingma & Ba 2015 adaptive first and second moment estimation with canonical defaults β₁=0.9 β₂=0.999 ε=1e-8, AdamW Loshchilov & Hutter 2019 correctly decoupling weight decay λ from gradient moments, Lion Chen et al. 2023 sign-based memory-efficient update requiring only one moment at 1/3 Adam memory, Sophia Liu et al. 2023 second-order Hessian-diagonal-preconditioned clipped update converging 2× faster than AdamW on language models, Muon Jordan et al. 2024 Nesterov momentum in gradient space orthogonalised via Newton-Schulz iteration achieving superior loss curves for transformer weight matrices at scale), policy optimisation algorithms (REINFORCE Williams 1992 Monte Carlo score-function estimator ∇_θ J = E[∇_θ log π_θ(a|s) G_t], PPO Schulman et al. 2017 clipped surrogate objective L^CLIP = E[min(r_t A_t, clip(r_t, 1-ε, 1+ε) A_t)] with ε=0.2, SAC Haarnoja et al. 2018 maximum-entropy off-policy actor-critic with learnable temperature, DQN Mnih et al. 2015 experience replay + target network stabilisation, MuZero Schrittwieser et al. 2020 learned world model with MCTS planning achieving superhuman performance without rule access), and contrastive pre-training objectives (SimCLR NT-Xent loss, BYOL asymmetric self-distillation, DINO ViT self-distillation with centering and sharpening, CLIP cross-modal image-text contrastive at 400M pairs) — collectively constituting the computational foundation upon which virtually every modern AI system, from large language models and robotic controllers to scientific discovery platforms, is built.

- ### Semantic Classification
  - owl-class:: artificial-intelligence:LearningAlgorithm
  - owl-role:: FoundationalAlgorithmicPrimitive
  - owl-inferred:: ai:OptimisationAlgorithm, ai:StatisticalLearning, ai:ComputationalIntelligence, ai:PolicyGradient
...
- ### Relationships
  ...
  - uses:: [[Backpropagation]], [[Automatic Differentiation]], [[Monte Carlo Methods]], [[Markov Decision Processes]], [[Neural Networks]], [[Contrastive Loss]]
  - contrasts-with:: [[Rule-Based Systems]], [[Expert Systems]], [[Symbolic AI]], [[Evolutionary Algorithms]]
  - related-to:: [[Active Learning]], [[Semi-Supervised Learning]], [[Self-Supervised Learning]], [[Transfer Learning]], [[Federated Learning]], [[Continual Learning]], [[Meta-Learning]], [[Curriculum Learning]]
  - standardized-by:: [[NeurIPS]], [[ICML]], [[ICLR]], [[IEEE Transactions on Neural Networks]], [[Journal of Machine Learning Research]]
...
- ### Content
  ...
  - **EWC** (Elastic Weight Consolidation, Kirkpatrick et al. 2017, DeepMind): regularises parameters important for task A when learning task B. Defines parameter importance as the diagonal Fisher Information Matrix F_i = E_{x∼D_A}[(∂log p(x|θ)/∂θ_i)²] (second moment of gradient score with respect to task-A data). Adds quadratic penalty: L_{EWC}(θ) = L_B(θ) + (λ/2) ∑_i F_i (θ_i - θ*_{A,i})² anchoring task-A-critical parameters near θ*_A.
  ...
  - 1. Williams, R.J. (1992). Simple statistical gradient-following algorithms for connectionist reinforcement learning. Machine Learning, 8(3-4), 229-256. [REINFORCE foundation]
  ...
  - 4. Valiant, L.G. (1984). A theory of the learnable. Communications of the ACM, 27(11), 1134-1142. [PAC learning]
  - 5. Kingma, D.P. & Ba, J. (2015). Adam: A method for stochastic optimization. ICLR 2015. arXiv:1412.6980.
  - 6. Mnih, V. et al. (2015). Human-level control through deep reinforcement learning. Nature, 518, 529-533. [DQN, DeepMind]
  - 7. Schulman, J. et al. (2017). Proximal Policy Optimization Algorithms. arXiv:1707.06347. [PPO]
  - 8. Finn, C., Abbeel, P. & Levine, S. (2017). Model-Agnostic Meta-Learning for Fast Adaptation of Deep Networks. ICML 2017. [MAML]
  - 9. Kirkpatrick, J. et al. (2017). Overcoming catastrophic forgetting in neural networks. PNAS, 114(13), 3521-3526. [EWC, DeepMind]
  - 10. McMahan, B. et al. (2017). Communication-Efficient Learning of Deep Networks from Decentralized Data. AISTATS 2017. [FedAvg]
  - 11. Haarnoja, T. et al. (2018). Soft Actor-Critic: Off-Policy Maximum Entropy Deep Reinforcement Learning with a Stochastic Actor. ICML 2018. [SAC]
  - 12. Loshchilov, I. & Hutter, F. (2019). Decoupled Weight Decay Regularization. ICLR 2019. [AdamW]
  - 13. Schwarz, J. et al. (2018). Progress & Compress: A scalable framework for continual learning. ICML 2018. [EWC++, DeepMind]
  - 14. Chen, T. et al. (2020). A Simple Framework for Contrastive Self-Supervised Learning. ICML 2020. [SimCLR]
  - 15. Schrittwieser, J. et al. (2020). Mastering Atari, Go, Chess and Shogi by Planning with a Learned Model. Nature, 588, 604-609. [MuZero, DeepMind]
  - 16. Grill, J.B. et al. (2020). Bootstrap Your Own Latent - A New Approach to Self-Supervised Learning. NeurIPS 2020. [BYOL, DeepMind]
  - 17. Caron, M. et al. (2021). Emerging Properties in Self-Supervised Vision Transformers. ICCV 2021. [DINO]
  - 18. He, K. et al. (2022). Masked Autoencoders Are Scalable Vision Learners. CVPR 2022. [MAE]
  - 19. Hu, E.J. et al. (2022). LoRA: Low-Rank Adaptation of Large Language Models. ICLR 2022.
  - 20. Schwarz, J. et al. (2018). Progress & Compress: A scalable framework for continual learning. ICML 2018. [EWC++]
  - 21. Chen, X. et al. (2023). Symbolic Discovery of Optimization Algorithms. NeurIPS 2023. [Lion optimizer]
  - 22. Liu, H. et al. (2023). Sophia: A Scalable Stochastic Second-order Optimizer for Language Model Pre-training. arXiv:2305.14342. ICLR 2024.
  - 23. Jordan, K. et al. (2024). Muon: Momentum Orthogonalized by Newton-Schulz. Technical report, 2024.
  - 24. Ouyang, L. et al. (2022). Training language models to follow instructions with human feedback. NeurIPS 2022. [InstructGPT, RLHF]
  - 25. Rafailov, R. et al. (2023). Direct Preference Optimization: Your Language Model is Secretly a Reward Model. NeurIPS 2023. [DPO]
  - 26. Deisenroth, M. & Rasmussen, C.E. (2011). PILCO: A Model-Based and Data-Efficient Approach to Policy Search. ICML 2011. [Cambridge]
  - 27. Bengio, Y. et al. (2009). Curriculum Learning. ICML 2009.
  - 28. Abadi, M. et al. (2016). Deep Learning with Differential Privacy. ACM CCS 2016. [DP-SGD]
  - 29. Jumper, J. et al. (2021). Highly accurate protein structure prediction with AlphaFold. Nature, 596, 583-589. [DeepMind]
  - 30. Kaplan, J. et al. (2020). Scaling Laws for Neural Language Models. arXiv:2001.08361.
  - 31. Radford, A. et al. (2021). Learning Transferable Visual Models From Natural Language Supervision. ICML 2021. [CLIP, OpenAI]
  - 32. Snell, J. et al. (2017). Prototypical Networks for Few-shot Learning. NeurIPS 2017. [ProtoNets]
  - 33. Oquab, M. et al. (2023). DINOv2: Learning Robust Visual Features without Supervision. arXiv:2304.07193. [DINOv2]

  - ## Metadata
    - **Domain corrected**: No — source domain `artificial-intelligence` was correct; stub body carried `rb` (robotics) content-tag and `ngm` domain label as migration pipeline artefacts, superseded by enriched content.
    - **Lines**: 47 source → 693 target
...
- ### Provenance
  ...
  - enrichment-date:: 2026-05-17T00:10:00Z
