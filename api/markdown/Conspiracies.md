schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#Conspiracies
legacy_uri:: urn:visionclaw:concept:infrastructure:conspiracies
public:: true
...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "conspiracies",
  "title": "Conspiracies",
  "vc:public": true,
  "vc:outboundWikilinks": [
    {
      "@id": "urn:visionflow:linked:martin2022dark",
      "vc:label": "martin2022dark"
    },
    {
      "@id": "urn:visionflow:linked:va2010neoconservatism",
      "vc:label": "va2010neoconservatism"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-093f95c3163d"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#Conspiracies"
    },
    {
      "vc:key": "maturity",
      "vc:value": "draft"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:conspiracies"
    },
    {
      "vc:key": "status",
      "vc:value": "stub"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:779debe12e7ecd24d26a99a3a152714779076c50263d376190d533b1a3e9a609@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:conspiracies",
  "@type": "OntologyClass",
  "label": "Conspiracies",
  "subClassOf": [
    {
  ...
  "definition": "Conspiracies is a concept within the ngm domain.",
  "vc:qualityScore": {
    "@value": "0.50",
    "@type": "xsd:float"
  },
