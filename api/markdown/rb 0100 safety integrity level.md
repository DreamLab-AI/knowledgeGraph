schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/robotics#Rb0100SafetyIntegrityLevel
legacy_uri:: urn:visionclaw:concept:robotics:rb-0100-safety-integrity-level
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-100323676c94"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/robotics#Rb0100SafetyIntegrityLevel"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:robotics:rb-0100-safety-integrity-level"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
