schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#EncoderDecoderArchitecture
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:encoder-decoder-architecture
public:: true
...
```json-ld
{
  ...
  "@id": "urn:visionflow:page:839d54f15a89cbfd5f36b91c237f8220c66379b46e47f74be004207ac36206fa",
  "@type": "Page",
  "vc:slug": "encoder-decoder-architecture",
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-d20e0f3a47f0"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#EncoderDecoderArchitecture"
    },
    {
    ...
    },
    {
      ...
      "vc:value": "Encoder Decoder Architecture"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:encoder-decoder-architecture"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:839d54f15a89cbfd5f36b91c237f8220c66379b46e47f74be004207ac36206fa@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:encoder-decoder-architecture:776c802a9fc9",
