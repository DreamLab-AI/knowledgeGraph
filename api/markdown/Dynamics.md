...
```json-ld
{
  ...
  "relations": {
    "relatedTo": [{"@id": "urn:ngm:class:control-algorithm", "label": "Control Algorithm"}, {"@id": "urn:ngm:class:mechanical-engineering-domain", "label": "Mechanical Engineering Domain"}]
  },
  "quality": 0.72
}
```
