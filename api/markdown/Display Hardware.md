schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#DisplayHardware
legacy_uri:: urn:visionclaw:concept:spatial-computing:display-hardware
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-61df5c18ebf0"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#DisplayHardware"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:display-hardware"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
