schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/robotics#Rb0064ComputedTorqueControl
legacy_uri:: urn:visionclaw:concept:robotics:rb-0064-computed-torque-control
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-549347cbe0c8"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/robotics#Rb0064ComputedTorqueControl"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:robotics:rb-0064-computed-torque-control"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:9708e518dcc138af598723545bf079cc9982d2a06b05177b862b5efebf4d2f35@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:rb-0064-computed-torque-control",
  "@type": "OntologyClass",
  ...
  "definition": "computed torque control is a robotics and autonomous systems concept and a type of Model Based Control."
}
```
