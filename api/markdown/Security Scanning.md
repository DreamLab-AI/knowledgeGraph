...
```json-ld
{
  ...
  "vc:public": true,
  "vc:outboundWikilinks": ["Open Claw", "VirusTotal"],
  "vc:schemaVersion": 2
}
```
...
```json-ld
{
  ...
  "relations": {
    "relatedTo": [{"@id": "urn:ngm:class:vulnerability-management", "label": "Vulnerability Management"}, {"@id": "urn:ngm:class:intrusion-detection", "label": "Intrusion Detection"}]
  },
  "provenance": {
