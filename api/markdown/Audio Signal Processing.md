...
- ### Definition
  - [[Audio Signal Processing]] applies the mathematics of discrete-time signals — [[Fourier Transform]]s, [[Digital Filter]]s, [[Convolution]], and [[Psychoacoustics]] models — to manipulate sound in ways that serve perceptual, communicative, or creative goals. Operating across acoustic frequencies from approximately 20 Hz to 20 kHz, the discipline encompasses time-domain operations such as amplitude modulation, delay, echo, and [[Dynamic Range Compression]], and frequency-domain operations enabled by the [[Fast Fourier Transform]] (FFT) including [[Equalisation]], spectral subtraction, pitch shifting, and time-stretching. [[Digital Signal Processing]] (DSP) hardware and software implement these operations at sample rates ranging from 8 kHz for telephony to 192 kHz for professional mastering, with [[Audio Parameters]] such as sample depth (16-bit, 24-bit, 32-bit float) and channel count establishing fidelity constraints. [[Psychoacoustics]] — the scientific study of human auditory perception — underpins both perceptual coding systems that discard masked frequency content and spatial rendering algorithms that exploit head-related transfer functions (HRTFs) to create convincing three-dimensional sound fields. The convergence of classical DSP methods with [[Machine Learning]] has produced a new generation of data-driven approaches: [[Deep Learning]] models now perform [[Noise Suppression]], [[Source Separation]], [[Speech Synthesis]], and neural perceptual coding with capabilities that substantially exceed classical filter-design methods. As a foundational layer of the [[Audio Processing System]], [[Audio Signal Processing]] is an enabling substrate for [[Speech Recognition]], [[Spatial Audio]], [[Audio Synthesis]], [[Audio Compression]], and [[Binaural Audio]] throughout the multimedia, telecommunications, medical devices, and spatial computing industry verticals.

- ### Semantic Classification
  - owl-class:: ai:AudioSignalProcessing
  - owl-role:: Concept | TechnicalDiscipline | AlgorithmicSubfield
  - owl-inferred:: ai:SignalProcessing, ai:AudioProcessing, ai:DigitalSignalProcessing
  - belongs-to-domain:: [[ComputationAndIntelligenceDomain]]
  - implemented-in-layer:: [[AlgorithmLayer]]

- ### Relationships
  - is-subclass-of:: [[Signal Processing]], [[Audio Processing]]
  - has-part:: [[Digital Filter]], [[Fast Fourier Transform]], [[Equalisation]], [[Dynamic Range Compression]], [[Echo Cancellation]], [[Beamforming]], [[Noise Cancellation]], [[Source Separation]]
  - requires:: [[Real-Time Computing]], [[Digital Signal Processor]], [[Pulse-Code Modulation]], [[Fourier Analysis]]
  - enables:: [[Spatial Audio]], [[Speech Recognition]], [[Speech Synthesis]], [[Audio Compression]], [[Noise Suppression]], [[Binaural Audio]], [[Audio Spatialization]], [[Music Information Retrieval]], [[Automatic Speech Recognition]]
  - implements:: [[Convolution]], [[Fourier Transform]], [[Psychoacoustics]]
  - depends-on:: [[Digital Signal Processing]], [[Audio Parameters]], [[GPU Acceleration]], [[Embedded Systems]]
  - supports:: [[Telecommunications]], [[Audio Engine]], [[Audio System]], [[Adaptive Music]], [[Hearing Aids]], [[WebRTC]]
  - uses:: [[MFCC]], [[Mel-Spectrogram]], [[Feature Extraction]], [[Deep Learning]], [[Convolutional Neural Network]], [[Recurrent Neural Network]], [[Transformer]], [[Diffusion Model]]
  - contrasts-with:: [[Audio Synthesis]]
  - related-to:: [[Audio Processing System]], [[Neural Audio Codec]], [[Audio Codec]], [[Audio Generation]], [[Audio Technology]], [[Generative AI]]
  - standardized-by:: [[Telecommunications]]
...
- ### Content
  ...
  - ## Research & Literature
    ...
    - 4. Oppenheim, A. V., & Schafer, R. W. (1989). *Discrete-Time Signal Processing*. Prentice Hall. (3rd ed. 2010)
    - 5. Smith, J. O. (2011). *Spectral Audio Signal Processing*. W3K Publishing / CCRMA Stanford. (Online edition)
    - 6. Zwicker, E., & Fastl, H. (1990). *Psychoacoustics: Facts and Models*. Springer.
    - 7. Painter, T., & Spanias, A. (2000). "Perceptual coding of digital audio." *Proceedings of the IEEE*, 88(4), 451-515.
    - 8. Brandenburg, K. (1999). "MP3 and AAC explained." *Proceedings of the 17th AES International Conference*, San Francisco.
    - 9. Valin, J.-M., et al. (2012). "Definition of the Opus Audio Codec." IETF RFC 6716.
    - 10. Benesty, J., Sondhi, M. M., & Huang, Y. (Eds.) (2008). *Springer Handbook of Speech Processing*. Springer.
    - 11. Sainath, T. N., et al. (2015). "Learning the speech front-end with raw waveform CLDNNs." *INTERSPEECH 2015*, 1-5.
    - 12. Davis, S. B., & Mermelstein, P. (1980). "Comparison of parametric representations for monosyllabic word recognition." *IEEE Trans. ASSP*, 28(4), 357-366. [MFCC origins]
    - 13. Hinton, G., et al. (2012). "Deep neural networks for acoustic modeling in speech recognition." *IEEE Signal Processing Magazine*, 29(6), 82-97.
    - 14. Défossez, A., et al. (2022). "High Fidelity Neural Audio Compression." *TMLR*, 2023. [EnCodec]
    - 15. Zeghidour, N., et al. (2021). "SoundStream: An end-to-end neural audio codec." *IEEE/ACM TASLP*, 30, 495-507.
    - 16. Kumar, R., et al. (2023). "High-Fidelity Audio Compression with Improved RVQGAN." *NeurIPS 2023*. [Descript Audio Codec]
    - 17. Luo, Y., & Mesgarani, N. (2019). "Conv-TasNet: Surpassing ideal time-frequency magnitude masking for speech separation." *IEEE/ACM TASLP*, 27(8), 1256-1266.
    - 18. Défossez, A. (2021). "Hybrid Spectrogram and Waveform Source Separation." *ISMIR 2021 Workshop*. [Demucs]
    - 19. Baevski, A., et al. (2020). "wav2vec 2.0: A framework for self-supervised learning of speech representations." *NeurIPS 2020*, 12449-12460.
    - 20. Hsu, W.-N., et al. (2021). "HuBERT: Self-supervised speech representation learning by masked prediction of hidden units." *IEEE/ACM TASLP*, 29, 3451-3460.
    - 21. Hayes, B., et al. (2023). "A review of differentiable digital signal processing for music and speech synthesis." *Frontiers in Signal Processing*, 3, 1284100. [QMUL C4DM]
    - 22. Hafezi, S., et al. (2023). "Subspace Hybrid MVDR Beamforming for Augmented Hearing." *arXiv*:2311.18689. [Imperial College London]
    - 23. Yamamoto, R., Song, E., & Kim, J.-M. (2020). "Parallel WaveGAN: A fast waveform generation model based on generative adversarial networks with multi-resolution spectrogram." *ICASSP 2020*.
    - 24. Purwins, H., et al. (2019). "Deep Learning for Audio Signal Processing." *IEEE J. Selected Topics in Signal Processing*, 13(2), 206-219. [Overview survey]
    - 25. Rafii, Z., et al. (2017). "An overview of lead and accompaniment separation in music." *IEEE/ACM TASLP*, 26(8), 1307-1335.
    - 26. Bengio, Y., et al. (2023). "Advances in Intelligent Hearing Aids: Deep Learning Approaches." *arXiv*:2507.07043. (Preprint)
    - 27. Bogaert, T., Doclo, S., & Wouters, J. (2009). "Speech enhancement with multichannel Wiener filter techniques in multimicrophone binaural hearing aids." *J. Acoust. Soc. Am.*, 125(1), 360-371.
    - 28. European Broadcasting Union (2011). "Loudness Normalisation and Permitted Maximum Level of Audio Signals." EBU R128.

- ### Provenance
  - sources:: https://arxiv.org/abs/1905.00078, https://www.c4dm.eecs.qmul.ac.uk/, https://arxiv.org/pdf/2507.07043, https://arxiv.org/html/2510.23312, https://qmro.qmul.ac.uk/xmlui/bitstream/handle/123456789/93966/frsip-03-1284100.pdf, https://arxiv.org/pdf/2603.24283, https://pmc.ncbi.nlm.nih.gov/articles/PMC12647563/
