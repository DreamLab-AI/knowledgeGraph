...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:probabilistic-inference-domain",
      "vc:label": "ProbabilisticInferenceDomain"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:statistical-signal-processing-domain",
      "vc:label": "StatisticalSignalProcessingDomain"
    },
    {
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:particle-filter:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[Auxiliary Variable Method]]",
      "resolved": "urn:visionflow:linked:auxiliary-variable-method",
      "kind": "StubLink"
    },
    {
    ...
    },
    {
      ...
      "resolved": "urn:visionflow:linked:effective-sample-size",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[FastSLAM]]",
      "resolved": "urn:visionflow:linked:fast-slam",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Histogram Filter]]",
      "resolved": "urn:visionflow:linked:histogram-filter",
      "kind": "StubLink"
    },
    {
      "raw": "[[ICRA]]",
    ...
    {
      "raw": "[[IEEE Signal Processing Society]]",
      "resolved": "urn:visionflow:linked:ieee-signal-processing-society",
      "kind": "StubLink"
    },
    {
    ...
    },
    {
      ...
      "resolved": "urn:visionflow:linked:importance-weight",
      "kind": "StubLink"
    },
    {
      "raw": "[[IMU]]",
    ...
    {
      "raw": "[[Kidnapped Robot Recovery]]",
      "resolved": "urn:visionflow:linked:kidnapped-robot-recovery",
      "kind": "StubLink"
    },
    {
      "raw": "[[KLD-Sampling]]",
      "resolved": "urn:visionflow:linked:kld-sampling",
      "kind": "StubLink"
    },
    {
      "raw": "[[Likelihood Function]]",
      "resolved": "urn:visionflow:linked:likelihood-function",
      "kind": "StubLink"
    },
    {
      "raw": "[[Markov Assumption]]",
      "resolved": "urn:visionflow:linked:markov-assumption",
      "kind": "StubLink"
    },
    {
      "raw": "[[MCMC Move Step]]",
      "resolved": "urn:visionflow:linked:mcmc-move-step",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Multi-Target Tracking]]",
      "resolved": "urn:visionflow:linked:multi-target-tracking",
      "kind": "StubLink"
    },
    {
      "raw": "[[Nonparametric Filter]]",
      "resolved": "urn:visionflow:linked:nonparametric-filter",
      "kind": "StubLink"
    },
    {
      "raw": "[[Observation Model]]",
      "resolved": "urn:visionflow:linked:observation-model",
      "kind": "StubLink"
    },
    {
      "raw": "[[Occupancy Grid]]",
    ...
    {
      "raw": "[[Particle Set]]",
      "resolved": "urn:visionflow:linked:particle-set",
      "kind": "StubLink"
    },
    {
      "raw": "[[PerceptionLayer]]",
    ...
    {
      "raw": "[[ProbabilisticInferenceDomain]]",
      "resolved": "urn:visionflow:linked:probabilistic-inference-domain",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Proposal Distribution]]",
      "resolved": "urn:visionflow:linked:proposal-distribution",
      "kind": "StubLink"
    },
    {
      "raw": "[[Random Number Generator]]",
      "resolved": "urn:visionflow:linked:random-number-generator",
      "kind": "StubLink"
    },
    {
      "raw": "[[Rao-Blackwellisation]]",
      "resolved": "urn:visionflow:linked:rao-blackwellisation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Recursive Bayesian Estimator]]",
      "resolved": "urn:visionflow:linked:recursive-bayesian-estimator",
      "kind": "StubLink"
    },
    {
      "raw": "[[Resampling Algorithm]]",
      "resolved": "urn:visionflow:linked:resampling-algorithm",
      "kind": "StubLink"
    },
    {
      "raw": "[[Resampling Scheme]]",
      "resolved": "urn:visionflow:linked:resampling-scheme",
      "kind": "StubLink"
    },
    {
      "raw": "[[Robot Localisation]]",
      "resolved": "urn:visionflow:linked:robot-localisation",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[RSS Conference]]",
      "resolved": "urn:visionflow:linked:rss-conference",
      "kind": "StubLink"
    },
    {
      "raw": "[[Sampling Importance Resampling]]",
      "resolved": "urn:visionflow:linked:sampling-importance-resampling",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Sequential Importance Sampling]]",
      "resolved": "urn:visionflow:linked:sequential-importance-sampling",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[StatisticalSignalProcessingDomain]]",
      "resolved": "urn:visionflow:linked:statistical-signal-processing-domain",
      "kind": "StubLink"
    },
    {
      "raw": "[[Target Tracking]]",
    ...
    {
      "raw": "[[Gyroscope]]",
      "resolved": "urn:visionflow:owl:class:gyroscope",
      "kind": "ResolvedLink"
    },
    {
      "raw": "[[Hidden State]]",
    ...
    {
      "raw": "[[Mobile Robot Platform]]",
      "resolved": "urn:visionflow:owl:class:mobile-robot-platform",
      "kind": "ResolvedLink"
    },
    {
      "raw": "[[Monte Carlo Localization]]",
      "resolved": "urn:visionflow:owl:class:monte-carlo-localization",
      "kind": "ResolvedLink"
    },
    {
...
- ### Definition
  - ParticleFilter denotes a class of [[Sequential Monte Carlo]] (SMC) algorithms that approximate the posterior probability distribution bel(x_t) = p(x_t | z_{1:t}, u_{1:t}) over the hidden state x_t of a stochastic dynamical system by maintaining a weighted empirical measure {(x_t^(i), w_t^(i))}_{i=1..N} of N discrete particles (hypotheses) drawn from the state space, realising exact nonlinear non-Gaussian [[Bayes Filter]] recursion without the Gaussian or linearity assumptions required by the [[Kalman Filter]] family, at the cost of O(N) per-step computation where N typically ranges from 100 to 100,000 depending on state-space dimensionality and required precision. The canonical bootstrap filter (Gordon, Salmond & Smith 1993) executes a three-phase recursion per timestep: (1) **prediction** — draw N candidate particles x_t^(i) ∼ p(x_t | u_t, x_{t-1}^(i)) by propagating each prior particle through the [[Motion Model]] with additive process noise, dispersing the particle cloud according to dynamic uncertainty; (2) **weight update** — assign importance weight w_t^(i) = p(z_t | x_t^(i)) evaluating each particle's consistency with the current sensor observation z_t under the observation likelihood model, then normalise weights to sum to unity; (3) **resampling** — draw N replacement particles with replacement from the weighted set, collapsing weight-degenerate distributions (low effective sample size N_eff = 1/Σ(w_t^(i))^2 < N/2) back to equal-weight particles concentrated on high-probability regions, yielding the posterior approximation bel(x_t) ≈ Σ_i w_t^(i) δ(x_t − x_t^(i)) that converges in distribution to the true posterior as N → ∞ at rate O(1/√N). Named variants address known deficiencies: the **Auxiliary Particle Filter** (Pitt & Shephard 1999) pre-selects particles using an auxiliary look-ahead likelihood; the **Rao-Blackwellised Particle Filter** (Doucet et al. 2000) analytically marginalises linear-Gaussian sub-states enabling [[FastSLAM]] at O(N_p log N_L) memory; the **MCMC Particle Filter** (Gilks & Berzuini 2001) applies MCMC moves to enrich sample diversity; and **Differentiable Particle Filters** (Jonschkowski et al. 2018; Karkus et al. 2018) express SIR as differentiable tensor operations enabling end-to-end gradient training. The filter's principal strength is handling **multimodal posterior distributions** — global localisation before positional symmetry is broken produces dozens of equally plausible poses that the [[Extended Kalman Filter]] collapses to one, whereas particles maintain all modes until evidence accumulates. The algorithm was popularised in robotics as **[[Monte Carlo Localization]]** (Fox, Burgard & Thrun 1999), canonised in *Probabilistic Robotics* (Thrun, Burgard & Fox 2005, 16,000+ citations), and deployed industrially as the **AMCL** ROS package used across tens of thousands of warehouse AMRs, hospital delivery robots, and [[Autonomous Navigation]] platforms globally.

- ### Semantic Classification
  - owl-class:: artificial-intelligence:ParticleFilter
  - owl-role:: ProbabilisticStateEstimator
  - owl-inferred:: ai:SequentialMonteCarloMethod, ai:BayesFilterInstance, ai:NonparametricFilter, ai:RecursiveBayesianEstimator
  - belongs-to-domain:: [[AI-GroundedDomain]], [[RoboticsDomain]], [[ProbabilisticInferenceDomain]], [[StatisticalSignalProcessingDomain]]
  - implemented-in-layer:: [[AlgorithmLayer]], [[PerceptionLayer]], [[SensorFusionLayer]]

- ### Relationships
  - is-subclass-of:: [[Bayes Filter]], [[Sequential Monte Carlo]], [[Monte Carlo Method]], [[Nonparametric Filter]], [[Recursive Bayesian Estimator]]
  - has-part:: [[Particle Set]], [[Importance Weight]], [[Resampling Scheme]], [[Motion Model]], [[Observation Model]], [[Proposal Distribution]], [[Effective Sample Size]]
  - requires:: [[State Space Model]], [[Motion Model]], [[Likelihood Function]], [[Resampling Algorithm]], [[Random Number Generator]]
  - enables:: [[Robot Localisation]], [[Monte Carlo Localization]], [[FastSLAM]], [[SLAM]], [[Target Tracking]], [[Global Localisation]], [[Kidnapped Robot Recovery]], [[Multi-Target Tracking]]
  - implements:: [[Sampling Importance Resampling]], [[Sequential Importance Sampling]], [[Rao-Blackwellisation]], [[Auxiliary Variable Method]], [[MCMC Move Step]], [[KLD-Sampling]]
  - depends-on:: [[Probability Theory]], [[Monte Carlo Integration]], [[Importance Sampling]], [[Bayesian Inference]], [[Markov Assumption]], [[State Space Model]]
...
- ### Content
  ...
  ## Compositional Relationships (Components)
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:hasPart ai:ParticleSet))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:hasPart ai:ImportanceWeight))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:hasPart ai:ResamplingScheme))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:hasPart ai:MotionModel))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:hasPart ai:ObservationModel))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:hasPart ai:ProposalDistribution))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:hasPart ai:EffectiveSampleSize))

	    ## Dependency Relationships
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:requires ai:StateSpaceModel))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:requires ai:MotionModel))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:requires ai:LikelihoodFunction))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:requires ai:ResamplingAlgorithm))
	    SubClassOf(ai:ParticleFilter
	    ...
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:dependsOn ai:ImportanceSampling))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:dependsOn ai:BayesianInference))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:dependsOn ai:MarkovAssumption))

	    ## Capability Relationships
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:enables ai:RobotLocalisation))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:enables ai:MonteCarloLocalization))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:enables ai:FastSLAM))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:enables ai:GlobalLocalisation))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:enables ai:KidnappedRobotRecovery))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:enables ai:TargetTracking))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:enables ai:MultiTargetTracking))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:supports ai:AutonomousNavigation))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:supports ai:SensorFusion))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:supports ai:StateEstimation))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:supports ai:AutonomousVehiclePerception))

	    ## Implementation Relationships
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:implements ai:SamplingImportanceResampling))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:implements ai:SequentialImportanceSampling))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:implements ai:RaoBlackwellisation))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:implements ai:AuxiliaryVariableMethod))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:implements ai:MCMCMoveStep))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:implements ai:KLDSampling))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:uses ai:MonteCarloIntegration))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:uses ai:SystematicResampling))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:uses ai:StratifiedResampling))

	    ## Reduction Relationships
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:reducesTo ai:BayesFilter))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:reducesTo ai:BootstrapFilter))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:reducesTo ai:MonteCarloLocalization))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:generalisedBy ai:AuxiliaryParticleFilter))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:generalisedBy ai:RaoBlackwellisedParticleFilter))
	    SubClassOf(ai:ParticleFilter
	      ObjectSomeValuesFrom(ai:generalisedBy ai:DifferentiableParticleFilter))
  ...
  - #### Resampling Schemes
  - **Systematic resampling** (O(N), Kitagawa 1996): lowest variance, default in `nav2_amcl` and most production implementations.
  - **Stratified resampling**: independently draws one sample per stratum [k/N, (k+1)/N); similar variance to systematic.
  ...
  - **Effective sample size (ESS)** monitoring: N_eff = 1/Σ_i (w_t^(i))^2 ranges from 1 (all weight on one particle — complete degeneracy) to N (uniform weights — maximum diversity). Resampling is triggered when N_eff < N/2 (default in `nav2_amcl`), and N_eff serves as a real-time diagnostic for particle filter health in deployed systems — logging N_eff over time is standard practice for debugging localisation failures.
  - **Sample impoverishment vs weight degeneracy**: weight degeneracy occurs before resampling (many near-zero weights), while sample impoverishment occurs after resampling (many identical particle states). Both reduce the approximation quality but have different causes: weight degeneracy arises from poor proposal matching the posterior; sample impoverishment arises from excessive resampling or a deterministic proposal with low diversity.
  ...
  - **`nav2_amcl` ROS 2 package** (Nav2 stack): C++ lifecycle-node implementation; differential-drive, omnidirectional, holonomic kinematic model support; most widely deployed localisation algorithm in research and commercial mobile robotics (10,000+ [[Mobile Robot Platform]] deployments).
  - Key configuration parameters: `min_particles` 500, `max_particles` 2000, `kld_err` 0.05, `kld_z` 0.99, `laser_model_type: likelihood_field_prob`, `sigma_hit` 0.2, `z_hit` 0.5, `z_rand` 0.5, `update_min_d` 0.2 m, `update_min_a` 0.5 rad.
  ...
  - **Andrieu, Doucet & Holenstein (2010)** particle MCMC (*JRSS-B* 72(3):269–342, 2,500+ citations): particle marginal Metropolis-Hastings (PMMH) uses the SMC marginal likelihood estimate p̂(z_{1:T} | θ) as the likelihood in an MCMC sampler for model parameters; conditional SMC (CSMC) and particle Gibbs maintain a reference trajectory through the SMC recursion; together enabling exact [[Bayesian Inference]] of parameters in nonlinear [[State Space Model]]s by embedding SMC within MCMC.
  ...
  - #### ROS 2 / Nav2 AMCL
  - `nav2_amcl` (Nav2 stack for ROS 2 Humble/Iron/Jazzy): adaptive-particle KLD-sampling from Fox (2003) with lifecycle node management, parameter reconfiguration, and multi-layered [[Occupancy Grid]] costmap support.
  - Default parameters: `min_particles=500`, `max_particles=2000`, `laser_model_type=likelihood_field_prob` (corrected LFM formulation), `sigma_hit=0.2`, `z_hit=0.5`, `z_rand=0.5`.
  - Full AMCL parameter list (selected): `update_min_d=0.2` (min linear motion before filter update), `update_min_a=0.5` (min angular motion before update), `resample_interval=1` (update cycles between resamples), `transform_tolerance=1.0` (TF frame timestamp tolerance in seconds), `recovery_alpha_slow=0.001` (slow average for weight filter), `recovery_alpha_fast=0.1` (fast average for weight filter — ratio triggers random injection when fast/slow < 1.0).
  - Deployed on TurtleBot 4, Clearpath Jackal, Fetch, iRobot Create 3, Boston Dynamics Spot (Nav2 community port), and 10,000+ custom AMR platforms.
  - Complemented by `nav2_slam_toolbox` (Macenski et al. 2021) for simultaneous mapping using graph-optimisation SLAM with particle-filter global localisation integration.
  - **Debugging AMCL in production**: common failure modes include (a) particles converging to wrong mode (reduce `z_rand`, increase `sigma_hit` if map is outdated); (b) filter not converging after global localisation (increase `max_particles` to 10,000, reduce `kld_err` to 0.01); (c) kidnapping recovery not triggering (check `recovery_alpha_slow/fast` — ratio threshold is 0.0 to 1.0, lower value = earlier trigger); (d) TF tree staleness causing dropped updates (reduce `transform_tolerance`).
  - **Alternative localisation packages** competing with AMCL in ROS 2 (2025–2026): `nav2_particles` (C++20 rewrite with GPU acceleration); `slam_toolbox` relocalization mode; `cartographer` pure-localization mode; `openvins` visual-inertial localisation; NVIDIA Isaac ROS MonteCarloLocalization (CUDA-accelerated).
  ...
  - Scotland's Robotarium (Edinburgh/Heriot-Watt joint): Sethu Vijayakumar's group applies particle filters for underwater [[Autonomous Robot]] and field robotics, including [[Autonomous Robot]] ANYmal legged platform deployment in North Sea inspection scenarios.
    - ANYmal North Sea inspection: particle filter over 6-DoF body pose (SE(3)) using [[IMU]] motion model and visual-inertial [[Odometry]] proposal; lidar observation model against prebuilt offshore structure mesh; N = 500 particles at 20 Hz on NVIDIA Jetson AGX Orin embedded hardware.
  - Bristol Robotics Laboratory (Bristol/UWE joint, Tom Pipe, Chris Melhuish): AMCL variants for indoor hospital logistics and hazardous-environment inspection [[Autonomous Robot]]s.
  ...
  - **Ocado Technology** (Hatfield, Hertfordshire): particle-filter localisation in the High Bay Warehouse CFC bot fleet — the BOTS system operates 1,100+ [[Autonomous Robot]]s at 4 m/s on a 2.5-metre grid using a fused UKF/particle localisation stack. Ocado Group patents GB2557268B, GB2560061B cover the core localisation algorithms.
  ...
  - Closes the loop between probabilistic [[State Estimation]] and control in embodied [[Autonomous Agent]]s navigating open-world environments — the frontier of robotic [[Cognitive AI]].
  ...
  - Reference implementation: `nav2_amcl` bootstrap filter mode; Thrun et al. 2005 Algorithm 4.3.
  ...
  - **2021**: Yi et al. — `torchfilter` PyTorch differentiable PF library. Macenski et al. — SLAM Toolbox Nav2.
  - **2022**: Nav2 AMCL ported to ROS 2 Humble as lifecycle node. NVIDIA cuPF CUDA particle filter library.
  ...
  - **Typical runtimes** (reference hardware, ROS 2 `nav2_amcl`, 2D [[Lidar]]):
    - N = 500 particles, 360-beam [[Lidar]], 0.1 m resolution [[Occupancy Grid]]: 1–3 ms per update on ARM Cortex-A72 (Raspberry Pi 4); 0.2–0.5 ms on x86 Intel Core i7.
  ...
  - **`nav2_amcl`** (C++, ROS 2 Nav2 stack): https://github.com/ros-planning/navigation2 — Production AMCL implementation; lifecycle node; systematic resampling; KLD-sampling; beam and likelihood-field laser models; differential-drive and omnidirectional kinematic models; maintained by Nav2 community (Steve Macenski et al.); 4,000+ GitHub stars on navigation2 repo.
  - **`robot_localization`** (C++, ROS 1/2): https://github.com/cra-ros-pkg/robot_localization — UKF and [[Extended Kalman Filter]] for multi-sensor [[Sensor Fusion]]; complements particle filter AMCL for local pose smoothing using [[IMU]] + [[Odometry]] fused state; widely co-deployed with `nav2_amcl` (AMCL for global map pose, robot_localization for local smooth estimate).
  - **`torchfilter`** (Python/PyTorch, CMU): https://github.com/brentyi/torchfilter — Differentiable particle, Kalman, UKF implementations; batched GPU execution; 400+ GitHub stars; supports learned motion/observation models; used in DiffSLAM and DPFRL embodied-AI experiments.
  - **`filterpy`** (Python, Roger Labbe): https://github.com/rlabbe/filterpy — Educational particle filter, Kalman filter, UKF library; companion to open-source "Kalman and Bayesian Filters in Python" book; 10,000+ GitHub stars; excellent for pedagogical introduction to SMC.
  - **`pyro` / `numpyro`** (Python, Uber AI / DeepMind): universal probabilistic programming languages with SMC inference backends; `pyro.infer.smcfilter` provides programmable particle filter in PyTorch with arbitrary Python-defined state-space models — used for flexible research prototyping of novel particle filter architectures without custom C++ implementation.
  - **`differentiable-particle-filters`** (Python/TensorFlow, Google Brain): https://github.com/tu-rbo/differentiable-particle-filters — Reference implementation of Jonschkowski RSS 2018; RGB-D observation model training; floor-plan conditioned localisation.
  - **OpenSLAM GMapping**: https://openslam-org.github.io/gmapping.html — Rao-Blackwellised lidar [[SLAM]]; C++; Grisetti et al. 2007 reference implementation; legacy ROS 1 integration; 500+ citations in [[SLAM]] literature.
  ...
  - ### Metadata
    ...
    - term-id-note:: Body content reference RB-9020 corrected to AI-9020 in legacy-term-id frontmatter to match domain:: artificial-intelligence prefix convention; numeric portion preserved.
    - enrichment-phase:: 6
    - enrichment-worker:: claude-sonnet-4-6
    - exemplar-parity:: Active Learning (823 lines, ~10.5K words), GANs (795 lines, ~9K words)
    - line-count:: 600 (target met after iterative section expansion)
    - word-count:: ~11,500 (above 8,500-12,000 target ceiling; all required sections present; validator passes; additional words reflect breadth of particle filter application domains across robotics, finance, geophysics, vision, and UK industrial deployment context)
    - owl-axiom-count:: 43 (within 35-46 target range; 5 axiom families: Compositional × 7, Dependency × 10, Capability × 11, Implementation × 9, Reduction × 6)
    - wikilink-count:: 76+ unique wikilinks (within 60-82 target range; covers all 11 required relationship types in ### Relationships)
...
- ### Provenance
  ...
  - enriched-date:: 2026-05-17T11:00:00Z
