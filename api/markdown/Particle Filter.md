...
- ### Content
  ...
  - Introduces auxiliary [private] variable k ∼ p(k | z_t) ∝ p(z_t | μ_{t|t-1}^(k)) w_{t-1}^(k), where μ_{t|t-1}^(k) is the predicted state mean for particle k.
