- ### OntologyBlock
  ...
  collapsed:: true
	...
	- status:: draft
    - public-access:: true
	- definition:: **Gyroscope** - Gyroscope in robotics systems
	- maturity:: draft
...
# RB-0081: Gyroscope
		  ...
		  ```clojure
		  (Declaration (Class :Gyroscope))
		  (SubClassOf :Gyroscope :Robot)
		  
		  (AnnotationAssertion rdfs:label :Gyroscope "Gyroscope"@en)
		  (AnnotationAssertion rdfs:comment :Gyroscope
		    "Gyroscope - Foundational robotics concept"@en)
		  (AnnotationAssertion :termID :Gyroscope "RB-0081"^^xsd:string)
		  
		  (Declaration (ObjectProperty :relates To))
		  (ObjectPropertyDomain :relatesTo :Gyroscope)
		  
		  (Declaration (DataProperty :hasProperty))
		  (DataPropertyDomain :hasProperty :Gyroscope)
