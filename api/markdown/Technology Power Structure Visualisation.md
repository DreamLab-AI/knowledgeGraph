...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "technology-power-structure-visualisation",
...
```json-ld
{
  ...
  "@id": "urn:ngm:class:technology-power-structure-visualisation",
  "@type": "Class",
  "label": "Technology Power Structure Visualisation",
...
- ### Relationships
  - related-to:: [[Artificial Intelligence]], [[AI Governance Law and Privacy]]
