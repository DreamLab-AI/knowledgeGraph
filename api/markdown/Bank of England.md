...
```json-ld
{
  ...
  "relations": {
    "hasPart": [
      {"@id": "urn:ngm:class:monetary-policy-committee", "label": "Monetary Policy Committee"},
      {"@id": "urn:ngm:class:financial-policy-committee", "label": "Financial Policy Committee"},
      {"@id": "urn:ngm:class:prudential-regulation-authority", "label": "Prudential Regulation Authority"}
    ],
    "partOf": [
      {"@id": "urn:ngm:class:uk-financial-regulatory-framework", "label": "UK Financial Regulatory Framework"}
    ],
    "requires": [
    ...
    "contrastsWith": [
      ...
      {"@id": "urn:ngm:class:federal-reserve", "label": "Federal Reserve"}
    ],
    "bridgesTo": [
  ...
  "sameAs": [
    {"@id": "urn:ngm:class:boe", "label": "BoE"}
  ],
  "quality": 0.74,
  "provenance": {
