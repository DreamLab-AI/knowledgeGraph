schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#GreenBlockchainInitiatives
legacy_uri:: urn:visionclaw:concept:blockchain:green-blockchain-initiatives
public:: true
...
```json-ld
{
  ...
  "@id": "urn:visionflow:page:1cc7e94b92b26143daf8ae3ecc2252be6082a8fbfec5e43a2f8ad406097274d7",
  "@type": "Page",
  "vc:slug": "green-blockchain-initiatives",
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:base-carbon-tonne-standard",
      "vc:label": "Base Carbon Tonne Standard"
    },
    {
      "@id": "urn:visionflow:linked:biodiversity-credit-markets",
      "vc:label": "Biodiversity Credit Markets"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:carbon-accounting-standards",
      "vc:label": "Carbon Accounting Standards"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:carbon-token-standard",
      "vc:label": "Carbon Token Standard"
    },
    {
      "@id": "urn:visionflow:linked:ccri-methodology",
      "vc:label": "CCRI Methodology"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:climate-finance-innovation",
      "vc:label": "Climate Finance Innovation"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:core-carbon-principles",
      "vc:label": "Core Carbon Principles"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:d-climate-network",
      "vc:label": "dClimate Network"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:energy-attribute-certificates",
      "vc:label": "Energy Attribute Certificates"
    },
    {
      "@id": "urn:visionflow:linked:energy-intensive-consensus",
      "vc:label": "Energy-Intensive Consensus"
    },
    {
      "@id": "urn:visionflow:linked:energy-monitoring-infrastructure",
      "vc:label": "Energy Monitoring Infrastructure"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:esg-compliant-de-fi",
      "vc:label": "ESG-Compliant DeFi"
    },
    {
      "@id": "urn:visionflow:linked:esg-reporting-standards",
      "vc:label": "ESG Reporting Standards"
    },
    {
      "@id": "urn:visionflow:linked:financial-layer",
      "vc:label": "FinancialLayer"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:gold-standard-digital-assets",
      "vc:label": "Gold Standard Digital Assets"
    },
    {
      "@id": "urn:visionflow:linked:gold-standard-foundation",
      "vc:label": "Gold Standard Foundation"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:green-bond-tokenisation",
      "vc:label": "Green Bond Tokenisation"
    },
    {
      "@id": "urn:visionflow:linked:green-mining-pool",
      "vc:label": "Green Mining Pool"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:icvcm-framework",
      "vc:label": "ICVCM Framework"
    },
    {
      "@id": "urn:visionflow:linked:independent-verification",
      "vc:label": "Independent Verification"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:kunming-montreal-gbf",
      "vc:label": "Kunming-Montreal GBF"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:legacy-credit-markets",
      "vc:label": "Legacy Credit Markets"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:multi-sig-wallets",
      "vc:label": "Multi-Sig Wallets"
    },
    {
      "@id": "urn:visionflow:linked:net-zero-digital-assets",
      "vc:label": "Net-Zero Digital Assets"
    },
    {
      "@id": "urn:visionflow:linked:on-chain-mrv",
      "vc:label": "On-Chain MRV"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:otc-carbon-trading",
      "vc:label": "OTC Carbon Trading"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:re-fi-protocol",
      "vc:label": "ReFi Protocol"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:renewable-energy-mining",
      "vc:label": "Renewable Energy Mining"
    },
    {
      "@id": "urn:visionflow:linked:renewable-energy-supply",
      "vc:label": "Renewable Energy Supply"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:sfdr",
      "vc:label": "SFDR"
    },
    {
      "@id": "urn:visionflow:linked:sfdr-disclosure",
    ...
    {
      "@id": "urn:visionflow:linked:tcfd-reporting",
      "vc:label": "TCFD Reporting"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:tokenised-carbon-markets",
      "vc:label": "Tokenised Carbon Markets"
    },
    {
  ...
  "vc:legacyProperties": [
    {
      ...
      "vc:value": "Sustainable Blockchain, ESG Blockchain, Climate-Positive DLT, Low-Carbon Crypto, Green DeFi, ReFi Infrastructure, Climate Blockchain"
    },
    {
    ...
    {
      "vc:key": "bridges-to",
      "vc:value": "[[Carbon Credits]], [[ESG]], [[Renewable Energy]], [[DeFi]], [[Tokenisation]], [[Voluntary Carbon Market]]"
    },
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-3b8682b4ba59"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#GreenBlockchainInitiatives"
    },
    {
    ...
    },
    {
      ...
      "vc:value": "Green Blockchain Initiatives"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:green-blockchain-initiatives"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:1cc7e94b92b26143daf8ae3ecc2252be6082a8fbfec5e43a2f8ad406097274d7@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:green-blockchain-initiatives:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[Base Carbon Tonne Standard]]",
      "resolved": "urn:visionflow:linked:base-carbon-tonne-standard",
      "kind": "StubLink"
    },
    {
      "raw": "[[Biodiversity Credit Markets]]",
      "resolved": "urn:visionflow:linked:biodiversity-credit-markets",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Carbon Accounting Standards]]",
      "resolved": "urn:visionflow:linked:carbon-accounting-standards",
      "kind": "StubLink"
    },
    {
      "raw": "[[Carbon Credits]]",
    ...
    {
      "raw": "[[Carbon Token Standard]]",
      "resolved": "urn:visionflow:linked:carbon-token-standard",
      "kind": "StubLink"
    },
    {
      "raw": "[[CCRI Methodology]]",
      "resolved": "urn:visionflow:linked:ccri-methodology",
      "kind": "StubLink"
    },
    {
      "raw": "[[Celo]]",
    ...
    {
      "raw": "[[Climate Finance Innovation]]",
      "resolved": "urn:visionflow:linked:climate-finance-innovation",
      "kind": "StubLink"
    },
    {
      "raw": "[[ConsensusLayer]]",
    ...
    {
      "raw": "[[Core Carbon Principles]]",
      "resolved": "urn:visionflow:linked:core-carbon-principles",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[dClimate Network]]",
      "resolved": "urn:visionflow:linked:d-climate-network",
      "kind": "StubLink"
    },
    {
      "raw": "[[DeFi]]",
    ...
    {
      "raw": "[[Energy Attribute Certificates]]",
      "resolved": "urn:visionflow:linked:energy-attribute-certificates",
      "kind": "StubLink"
    },
    {
      "raw": "[[Energy-Intensive Consensus]]",
      "resolved": "urn:visionflow:linked:energy-intensive-consensus",
      "kind": "StubLink"
    },
    {
      "raw": "[[Energy Monitoring Infrastructure]]",
      "resolved": "urn:visionflow:linked:energy-monitoring-infrastructure",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Environmental Technology]]",
      "resolved": "urn:visionflow:linked:environmental-technology",
      "kind": "StubLink"
    },
    {
      "raw": "[[ESG]]",
    ...
    {
      "raw": "[[ESG-Compliant DeFi]]",
      "resolved": "urn:visionflow:linked:esg-compliant-de-fi",
      "kind": "StubLink"
    },
    {
      "raw": "[[ESG Reporting Standards]]",
      "resolved": "urn:visionflow:linked:esg-reporting-standards",
      "kind": "StubLink"
    },
    {
      "raw": "[[FinancialLayer]]",
      "resolved": "urn:visionflow:linked:financial-layer",
      "kind": "StubLink"
    },
    {
      "raw": "[[GHG Protocol]]",
    ...
    {
      "raw": "[[Gold Standard Digital Assets]]",
      "resolved": "urn:visionflow:linked:gold-standard-digital-assets",
      "kind": "StubLink"
    },
    {
      "raw": "[[Gold Standard Foundation]]",
      "resolved": "urn:visionflow:linked:gold-standard-foundation",
      "kind": "StubLink"
    },
    {
      "raw": "[[GovernanceLayer]]",
    ...
    {
      "raw": "[[Green Bond Tokenisation]]",
      "resolved": "urn:visionflow:linked:green-bond-tokenisation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Green Mining Pool]]",
      "resolved": "urn:visionflow:linked:green-mining-pool",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[ICVCM Framework]]",
      "resolved": "urn:visionflow:linked:icvcm-framework",
      "kind": "StubLink"
    },
    {
      "raw": "[[Independent Verification]]",
      "resolved": "urn:visionflow:linked:independent-verification",
      "kind": "StubLink"
    },
    {
      "raw": "[[Iris Energy]]",
    ...
    {
      "raw": "[[Kunming-Montreal GBF]]",
      "resolved": "urn:visionflow:linked:kunming-montreal-gbf",
      "kind": "StubLink"
    },
    {
      "raw": "[[Layer 2 Scaling]]",
    ...
    {
      "raw": "[[Legacy Credit Markets]]",
      "resolved": "urn:visionflow:linked:legacy-credit-markets",
      "kind": "StubLink"
    },
    {
      "raw": "[[MiCA]]",
    ...
    {
      "raw": "[[Multi-Sig Wallets]]",
      "resolved": "urn:visionflow:linked:multi-sig-wallets",
      "kind": "StubLink"
    },
    {
      "raw": "[[Net-Zero Digital Assets]]",
      "resolved": "urn:visionflow:linked:net-zero-digital-assets",
      "kind": "StubLink"
    },
    {
      "raw": "[[On-Chain MRV]]",
      "resolved": "urn:visionflow:linked:on-chain-mrv",
      "kind": "StubLink"
    },
    {
      "raw": "[[Oracle Network]]",
    ...
    {
      "raw": "[[OTC Carbon Trading]]",
      "resolved": "urn:visionflow:linked:otc-carbon-trading",
      "kind": "StubLink"
    },
    {
      "raw": "[[Paris Agreement]]",
    ...
    {
      "raw": "[[ReFi Protocol]]",
      "resolved": "urn:visionflow:linked:re-fi-protocol",
      "kind": "StubLink"
    },
    {
      "raw": "[[Regen Network]]",
    ...
    {
      "raw": "[[Renewable Energy Mining]]",
      "resolved": "urn:visionflow:linked:renewable-energy-mining",
      "kind": "StubLink"
    },
    {
      "raw": "[[Renewable Energy Supply]]",
      "resolved": "urn:visionflow:linked:renewable-energy-supply",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[SFDR]]",
      "resolved": "urn:visionflow:linked:sfdr",
      "kind": "StubLink"
    },
    {
      "raw": "[[SFDR Disclosure]]",
      "resolved": "urn:visionflow:linked:sfdr-disclosure",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[TCFD Reporting]]",
      "resolved": "urn:visionflow:linked:tcfd-reporting",
      "kind": "StubLink"
    },
    {
      "raw": "[[TNFD]]",
    ...
    {
      "raw": "[[Tokenised Carbon Markets]]",
      "resolved": "urn:visionflow:linked:tokenised-carbon-markets",
      "kind": "StubLink"
    },
    {
      "raw": "[[Toucan Protocol]]",
