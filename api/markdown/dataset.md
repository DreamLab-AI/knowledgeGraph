- ### Definition
  - A Dataset is a purposefully assembled, schema-coherent collection of data records—spanning modalities including text, imagery, tabular measurements, audio, video, time series, and graph structures—gathered and curated to serve a defined analytical, scientific, or [[Machine Learning]] objective. Every dataset is characterised by a constellation of properties: its size and dimensionality, the modality or combination of modalities it contains, its provenance and collection methodology, the licensing terms governing redistribution and derivative use, and the quality profile encompassing completeness, consistency, accuracy, and representational balance across the populations it purports to represent. In the context of [[Machine Learning]], datasets are the fundamental raw material from which statistical patterns are extracted during [[Supervised Learning]], [[Unsupervised Learning]], and [[Reinforcement Learning]]; their properties directly determine the upper bound on model capability and constrain the degree to which a trained model can be applied via [[Transfer Learning]] to novel domains. [[Data Quality]] and [[Data Curation]] are not peripheral concerns: labelling errors pervade even canonical [[Benchmark Dataset]] collections—error rate estimates range from 3% to 50% across commonly used benchmarks according to studies published in 2021–2024—while systematic [[Bias]] in collection or annotation propagates through the full ML pipeline and can cause discriminatory outcomes at inference time that are difficult to detect post-deployment. Documentation practices such as Datasheets for Datasets (Gebru et al., 2021) and Dataset Nutrition Labels formalise the metadata contract between dataset creators and consumers, supporting [[Fairness]] assessment and regulatory compliance auditing. [[Data Governance]] frameworks establish accountability over dataset lifecycle events—acquisition, versioning, access control, lineage tracking, and deprecation—and are increasingly mandated by legislation including the EU AI Act (2024, Article 10 on data and data governance) and the UK Data (Use and Access) Act (2025). Modern [[Foundation Model]] training has escalated dataset scale to trillions of tokens drawn from sources such as Common Crawl, with ongoing tension between the breadth required for generalisation and the curation depth needed to remove harmful, legally contested, or low-quality content. The [[Benchmark Dataset]] sub-class provides fixed evaluation corpora against which model progress is measured, while [[Synthetic Data]] generation and [[Data Augmentation]] techniques are increasingly used to supplement scarce real-world data, reduce collection cost, and address [[Privacy]] constraints in medical or financial domains. The data-centric AI movement, championed by Andrew Ng and formalised through the NeurIPS Datasets and Benchmarks track inaugurated in 2021, has elevated dataset engineering to a discipline with its own methodological standards, tooling ecosystems, and academic venues.

- ### Semantic Classification
  - owl-class:: ai:Dataset
  - owl-role:: DataResource | TrainingArtifact | EvaluationArtifact | KnowledgeAsset
  - owl-inferred:: ai:LabelledDataset, ai:BenchmarkDataset, ai:SyntheticDataset, ai:MultimodalDataset, ai:TrainingDataset
  - belongs-to-domain:: [[AI-GroundedDomain]]
  - implemented-in-layer:: [[DataLayer]]

- ### Relationships
  - is-subclass-of:: [[AI Infrastructure]], [[Data Architecture]], [[Computational Modelling]]
  - has-part:: [[Ground Truth Labels]], [[Metadata]], [[Data Split]], [[Evaluation Metric]], [[Data Schema]], [[Data Versioning]]
  - requires:: [[Data Collection]], [[Data Cleaning]], [[Data Annotation]], [[Data Labelling]], [[Data Governance]], [[Data Lineage]], [[Data Provenance]]
  - enables:: [[Machine Learning]], [[Supervised Learning]], [[Unsupervised Learning]], [[Reinforcement Learning]], [[Model Evaluation]], [[Benchmarking]], [[Data Analysis]], [[Deep Learning]], [[Transfer Learning]], [[Active Learning]]
  - implements:: [[Data Governance Framework]], [[Reproducibility]], [[Open Data]], [[Data Ethics]]
  - depends-on:: [[Data Quality]], [[Data Curation]], [[Data Catalogue]], [[Data Pipeline]], [[Data Management]], [[Data Management System]]
  - supports:: [[Natural Language Processing]], [[Computer Vision]], [[Large Language Models]], [[Foundation Model]], [[Explainable AI]], [[Feature Engineering]]
  - uses:: [[Data Augmentation]], [[Data Augmentation Strategies]], [[Synthetic Data]], [[Active Learning]], [[Cross-Validation]], [[Federated Learning]], [[Differential Privacy]]
  - contrasts-with:: [[Benchmark Dataset]], [[Knowledge Graph]], [[Data Lake]], [[Data Management System]]
  - related-to:: [[Bias]], [[Fairness]], [[Privacy]], [[Overfitting]], [[Imbalanced Data]], [[Regulation]], [[AI Act]], [[Data-Centric AI]], [[Data Ethics]]
  - standardized-by:: [[Data Governance]], [[Data Governance Framework]], [[AI Act]]
...
- ### Provenance
  - sources:: https://arxiv.org/abs/2410.22473, https://arxiv.org/abs/2406.07275, https://arxiv.org/abs/2403.19546, https://arxiv.org/abs/2210.08402, https://arxiv.org/abs/2103.14749, https://dl.acm.org/doi/10.1016/j.infsof.2023.107268, https://arxiv.org/pdf/2410.05057, https://facctconference.org/static/papers24/facct24-70.pdf, https://www.turing.ac.uk/research/research-programmes/data-centric-engineering, https://arxiv.org/abs/2310.16787, https://arxiv.org/abs/2304.14108
