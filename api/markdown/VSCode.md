schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#VSCode
legacy_uri:: urn:visionclaw:concept:infrastructure:vscode
public:: true
...
```json-ld
{
  ...
  "@id": "urn:visionflow:page:388a9cce8df31f3575ca97469dc125c20e6ab9349af348e80211533780654e36",
  "@type": "Page",
  "vc:slug": "vscode",
  "title": "VSCode",
  "vc:public": true,
  "vc:outboundWikilinks": [
    {
      "@id": "urn:visionflow:linked:i",
      "vc:label": "$- =~ i"
    },
    {
      "@id": "urn:visionflow:linked:n-ssh-tty",
      "vc:label": "-n \"$SSH_TTY\""
    },
    {
      "@id": "urn:visionflow:linked:z-tmux",
      "vc:label": "-z \"$TMUX\""
    }
  ],
  "vc:schemaVersion": 1,
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-57723ecbbe18"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#VSCode"
    },
    {
      "vc:key": "maturity",
      "vc:value": "draft"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:vscode"
    },
    {
      "vc:key": "status",
      "vc:value": "stub"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:388a9cce8df31f3575ca97469dc125c20e6ab9349af348e80211533780654e36@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:vscode",
  "@type": "OntologyClass",
  "label": "VSCode",
  "subClassOf": [
    {
  ...
  "definition": "VSCode is a concept within the ngm domain.",
  "vc:qualityScore": {
    "@value": "0.50",
    "@type": "xsd:float"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:vscode:776c802a9fc9",
  ...
  "vc:resolutions": [
    {
      "raw": "[[ $- =~ i ]]",
      "resolved": "urn:visionflow:linked:i",
      "kind": "StubLink"
    },
    {
      "raw": "[[ -n \"$SSH_TTY\" ]]",
      "resolved": "urn:visionflow:linked:n-ssh-tty",
      "kind": "StubLink"
    },
    {
      "raw": "[[ -z \"$TMUX\" ]]",
      "resolved": "urn:visionflow:linked:z-tmux",
      "kind": "StubLink"
    }
  ],
  "prov:wasAttributedTo": {
