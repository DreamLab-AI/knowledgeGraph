schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#PsychologicalResearch
legacy_uri:: urn:visionclaw:concept:spatial-computing:psychological-research
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-9ba08818322f"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#PsychologicalResearch"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:psychological-research"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
