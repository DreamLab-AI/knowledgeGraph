schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#ImplementationExamples
legacy_uri:: urn:visionclaw:concept:spatial-computing:implementation-examples
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-d823fd176d92"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#ImplementationExamples"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:implementation-examples"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
