schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#ReflectionProbe
legacy_uri:: urn:visionclaw:concept:spatial-computing:reflection-probe
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-d0b18a3f10b7"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#ReflectionProbe"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:reflection-probe"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:0b4bdc619f112151c400ce944d01923cab52205c9c72d36a3f6a0862c337e9ac@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:reflection-probe",
  "@type": "OntologyClass",
