- ### Definition
  - An Attention Weight is a scalar coefficient produced by an [[Attention Mechanism]] that encodes the degree of relevance — or focus — that one position in a sequence (or across modalities) should assign to another when constructing an output representation. In the canonical [[Transformer Architecture]] formulation introduced by Vaswani et al. (2017), attention weights emerge from the scaled dot-product operation: the query vector Q for a target position is compared with each key vector K drawn from the source positions by computing the dot product Q·Kᵀ, scaling the result by the square root of the key dimension (√d_k) to moderate the magnitude of gradients, and then normalising the resulting score vector through a [[Softmax Function]] to yield a probability distribution that sums to one. These normalised scalars — the attention weights — are then used as convex combination coefficients to form the weighted sum of value vectors V, producing the context-aware output for the target position. Within [[Self Attention]], query, key, and value projections all derive from the same input sequence, enabling each token to attend to every other token in parallel and capture long-range syntactic and semantic dependencies that sequential models such as [[Recurrent Neural Network]] and [[Long Short Term Memory]] architectures struggled to retain over many time-steps. In [[Multi-Head Attention]], this process is replicated h times in parallel using separately learned linear projections into lower-dimensional subspaces, allowing the model to simultaneously attend to information from multiple representational subspaces; the h output vectors are concatenated and linearly projected back to the model dimension. In [[Cross Attention]], queries originate from the decoder or target modality while keys and values come from the encoder output or a separate source, linking the [[Encoder Decoder Architecture]] during generation tasks such as [[Machine Translation]] or [[Image Captioning]]. Attention weights are the primary learned routing mechanism through which [[Large Language Models]] such as [[GPT]] and [[BERT]] distribute computational focus across context windows now exceeding one million tokens in production settings. Their dual role — as both a computational routing device and a potential window into model behaviour — makes them central to ongoing research in [[Explainable AI]] and mechanistic interpretability.

- ### Semantic Classification
  - owl-class:: artificial-intelligence:AttentionWeight
  - owl-role:: Concept
  - owl-inferred:: artificial-intelligence:NeuralNetworkPrimitive, artificial-intelligence:ComputationalCoefficient, artificial-intelligence:LearntParameter
  - belongs-to-domain:: [[Artificial Intelligence]]
  - implemented-in-layer:: [[AI Model Architecture]]

- ### Relationships
  - is-subclass-of:: [[AI Model Architecture]], [[Neural Network]]
  - part-of:: [[Attention Mechanism]], [[Transformer Architecture]], [[Multi-Head Attention]], [[Self Attention]], [[Cross Attention]], [[Encoder Decoder Architecture]]
  - has-part:: [[Softmax Function]], [[Query Key Value]], [[Layer Normalisation]]
  - requires:: [[Matrix Multiplication]], [[Embedding]], [[Positional Encoding]], [[GPU Computing]]
  - enables:: [[Large Language Models]], [[Explainable AI]], [[Machine Translation]], [[Image Captioning]], [[Speech Recognition]], [[Natural Language Processing]], [[Sequence-to-Sequence Learning]], [[Computer Vision]], [[Multimodal AI]]
  - implements:: [[Sequence-to-Sequence Learning]], [[Scaled Dot-Product Attention]], [[Token Alignment]]
  - depends-on:: [[Backpropagation]], [[Gradient Descent]], [[Automatic Differentiation]]
  - uses:: [[Transformer Architecture]], [[Neural Network]], [[Encoder Decoder Architecture]], [[Feed Forward Network]], [[Layer Normalisation]]
  - supports:: [[Computer Vision]], [[Multimodal AI]], [[Graph Neural Network]], [[Protein Structure Prediction]], [[Speech Recognition]]
  - contrasts-with:: [[Recurrent Neural Network]], [[Long Short Term Memory]], [[State Space Model]], [[Convolutional Neural Network]]
  - related-to:: [[BERT]], [[GPT]], [[Layer Normalisation]], [[Mixture of Experts]], [[Telecollaboration]], [[Transfer Learning]], [[Self-Supervised Learning]], [[Retrieval-Augmented Generation]], [[Dropout]], [[Batch Normalisation]], [[Masked Language Modelling]], [[Causal Language Modelling]], [[Vision Transformer]], [[AlphaFold]], [[Tokenisation]], [[Fine-Tuning]], [[Prompt Engineering]], [[Chain-of-Thought Reasoning]]
  - standardized-by:: [[ISO/IEC 22989:2022]], [[NIST AI RMF]]
  - bridges-to:: [[Telecollaboration]], [[Graph Neural Network]], [[Protein Structure Prediction]], [[Autonomous Agent]], [[AI Agent]], [[Knowledge Graph]], [[Sparse Autoencoder]]
  - uses:: [[Transformer Architecture]], [[Neural Network]], [[Encoder Decoder Architecture]], [[Feed Forward Network]], [[Layer Normalisation]], [[Automatic Differentiation]], [[GPU Computing]]
...
- ### Content
  ...
  **[[Multimodal AI]] and [[Image Captioning]]**: Cross-attention between visual and linguistic representations is the key mechanism enabling models to generate captions for images ([[Image Captioning]]), answer questions about photographs (visual QA), generate images from text descriptions (text-to-image generation via diffusion transformers), and integrate speech, vision, and text in unified multimodal systems. In image captioning, attention weights over visual patch representations determine which visual regions contribute to each generated caption word — providing a natural alignment between linguistic and visual content that can be visualised and evaluated for correctness. The [[Cross Attention]] weight matrices in these systems are increasingly used as visual grounding evidence in explainability contexts.
  ...
  2. Luong, M.-T., Pham, H., & Manning, C. D. (2015). Effective Approaches to Attention-based Neural Machine Translation. *EMNLP 2015*. arXiv:1508.04025.
  3. Vaswani, A., Shazeer, N., Parmar, N., Uszkoreit, J., Jones, L., Gomez, A. N., Kaiser, L., & Polosukhin, I. (2017). Attention Is All You Need. *NeurIPS 2017*, 30, 5998–6008. arXiv:1706.03762.
  4. Devlin, J., Chang, M.-W., Lee, K., & Toutanova, K. (2019). BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding. *NAACL-HLT 2019*. arXiv:1810.04805.
  5. Jain, S., & Wallace, B. C. (2019). Attention is not Explanation. *NAACL-HLT 2019*. arXiv:1902.10186. https://aclanthology.org/N19-1357/
  6. Wiegreffe, S., & Pinter, Y. (2019). Attention is not not Explanation. *EMNLP 2019*. arXiv:1908.04626. https://aclanthology.org/D19-1002/
  7. Serrano, S., & Smith, N. A. (2019). Is Attention Interpretable? *ACL 2019*. arXiv:1906.03731.
  8. Clark, K., Khandelwal, U., Levy, O., & Manning, C. D. (2019). What Does BERT Look at? An Analysis of BERT's Attention. *BlackboxNLP 2019*. arXiv:1906.04341.
  ...
  10. Raffel, C., et al. (2020). Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer. *JMLR*, 21(140), 1–67. arXiv:1910.10683.
  ...
  12. Elhage, N., et al. (2021). A Mathematical Framework for Transformer Circuits. *Transformer Circuits Thread*. https://transformer-circuits.pub/2021/framework/
  13. Conmy, A., Mavor-Parker, A., Lynch, A., Heimersheim, S., & Garriga-Alonso, A. (2023). Towards Automated Circuit Discovery for Mechanistic Interpretability. *NeurIPS 2023*. arXiv:2304.14997.
  14. Dosovitskiy, A., et al. (2021). An Image is Worth 16x16 Words: Transformers for Image Recognition at Scale. *ICLR 2021*. arXiv:2010.11929.
  15. Ainslie, J., et al. (2023). GQA: Training Generalised Multi-Query Transformer Models from Multi-Head Checkpoints. *EMNLP 2023*. arXiv:2305.13245.
  16. Su, J., et al. (2024). RoFormer: Enhanced Transformer with Rotary Position Embedding. *Neurocomputing*, 568. arXiv:2104.09864.
  17. Gu, A., & Dao, T. (2023). Mamba: Linear-Time Sequence Modelling with Selective State Spaces. *arXiv*:2312.00752.
  18. Sharkey, L., et al. (2025). Open Problems in Mechanistic Interpretability. *arXiv*:2501.16496.
  19. Kamath, A., et al. (2025). Weight-Sparse Transformers have Interpretable Circuits. *arXiv*:2511.13653.
  20. Conmy, A., et al. (2024). Sparse Attention Post-Training for Mechanistic Interpretability. *arXiv*:2512.05865.
  21. Basile, V., et al. (2026). Interpreting Transformers Through Attention Head Intervention. *arXiv*:2601.04398.
  22. Dao, T. (2024). FlashAttention-3: Fast and Accurate Attention with Asynchrony and Low-precision. *arXiv*:2407.08608.
  23. Pruthi, D., Gupta, M., Dhingra, B., Neubig, G., & Lipton, Z. C. (2020). Learning to Deceive with Attention-Based Explanations. *ACL 2020*. arXiv:1909.07913.
  24. Choromanski, K., et al. (2021). Rethinking Attention with Performers. *ICLR 2021*. arXiv:2009.14794.
...
- ### Provenance
  - sources:: arXiv:1409.0473, arXiv:1706.03762, arXiv:1902.10186, arXiv:1908.04626, arXiv:2205.14135, arXiv:2601.04398, arXiv:2512.05865, arXiv:2511.13653, https://arxiv.org/abs/2601.10266, https://aclanthology.org/N19-1357/, https://aclanthology.org/D19-1002/, https://apxml.com/courses/foundations-transformers-architecture/chapter-2-attention-mechanism-core-concepts/scaled-dot-product-attention, https://huggingface.co/blog/royswastik/is-attention-interpretable
