schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#CrossPlatformComplianceHub
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:cross-platform-compliance-hub
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-e6d95a158afd"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#CrossPlatformComplianceHub"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:cross-platform-compliance-hub"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
