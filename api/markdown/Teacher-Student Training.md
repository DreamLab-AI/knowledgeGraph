- ### OntologyBlock
  id:: teacher-student-training-ontology
  collapsed:: true
	- ontology:: true
	- term-id:: AI-0280
	- preferred-term:: Teacher Student Training
	- source-domain:: mv
	- status:: draft
...
(Declaration (Class :TeacherStudentTraining))

;; Annotations
(AnnotationAssertion rdfs:label :TeacherStudentTraining "Teacher Student Training"@en)
(AnnotationAssertion rdfs:comment :TeacherStudentTraining "A training paradigm where a larger, more capable \"teacher\" model guides the training of a smaller \"student\" model. Teacher-student training transfers knowledge from the teacher's learned representations or predictions to improve student model performance."@en)

;; Data Properties
(AnnotationAssertion dcterms:identifier :TeacherStudentTraining "AI-0280"^^xsd:string)
(DataPropertyAssertion :isAITechnology :TeacherStudentTraining "true"^^xsd:boolean)
```
