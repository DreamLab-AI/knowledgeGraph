...
```json-ld
{
  ...
  "relations": {
    "partOf": [
      {"@id": "urn:ngm:class:iso-14000-series", "label": "ISO 14000 Series"},
      {"@id": "urn:ngm:class:climate-governance-frameworks", "label": "Climate Governance Frameworks"}
    ],
    "hasPart": [
      {"@id": "urn:ngm:class:ghg-inventory-management", "label": "GHG Inventory Management"},
      {"@id": "urn:ngm:class:carbon-project-accounting", "label": "Carbon Project Accounting"},
      {"@id": "urn:ngm:class:ghg-verification-bodies", "label": "GHG Verification Bodies"}
    ],
    "standardizedBy": [
      {"@id": "urn:ngm:class:international-organisation-for-standardisation", "label": "International Organisation for Standardisation"},
    ...
    "enables": [
      ...
      {"@id": "urn:ngm:class:voluntary-carbon-markets", "label": "Voluntary Carbon Markets"}
    ],
    "requires": [
    ...
    "bridgesTo": [
      {"@id": "urn:ngm:class:carbon-tokenisation", "label": "Carbon Tokenisation"},
      {"@id": "urn:ngm:class:smart-contracts", "label": "Smart Contracts"}
    ]
  },
  "sameAs": [
    {"@id": "urn:ngm:class:iso-14064-1", "label": "ISO 14064-1"},
    {"@id": "urn:ngm:class:ghg-accounting-standard", "label": "GHG Accounting Standard"}
  ],
  "quality": 0.72,
  "provenance": {
