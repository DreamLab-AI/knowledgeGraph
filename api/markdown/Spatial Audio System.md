schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#SpatialAudioSystem
legacy_uri:: urn:visionclaw:concept:spatial-computing:spatial-audio-system
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-e60d07f37b9c"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#SpatialAudioSystem"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:spatial-audio-system"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
