...
- ### Definition
  ...
  - The migration from legacy [[Interactive Voice Response]] trees to LLM-powered conversational front-ends represents the most disruptive near-term technology shift:
    ...
    - This is a categorical capability upgrade rather than incremental improvement: where DTMF IVR [private] route 60–70% of contacts to the right queue, LLM IVR can resolve 55–70% of contacts entirely
