schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#SoloMining
legacy_uri:: urn:visionclaw:concept:blockchain:solo-mining
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-8c678256dcf8"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#SoloMining"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:solo-mining"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:435472e808009ca0599b756c47c641cef66178eb4e9372962e030dfcf4a9d0c8@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:solo-mining",
  "@type": "OntologyClass",
  "label": "Solo Mining",
  "subClassOf": [
    {
