schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#Predictions
legacy_uri:: urn:visionclaw:concept:infrastructure:predictions
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-1b3fc4232d68"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#Predictions"
    },
    {
      "vc:key": "maturity",
      "vc:value": "draft"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:predictions"
    },
    {
      "vc:key": "status",
      "vc:value": "stub"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:ff7d77d095e18002d5b1f96339f1d4f84078188e736b5448490fc0b2d62c3d37@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:predictions",
  "@type": "OntologyClass",
  "label": "Predictions",
  "subClassOf": [
    {
  ...
  "definition": "Predictions is a concept within the ngm domain.",
  "vc:qualityScore": {
    "@value": "0.50",
    "@type": "xsd:float"
  },
