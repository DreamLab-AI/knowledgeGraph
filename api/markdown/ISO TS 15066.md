...
```json-ld
{
  ...
  "relations": {
    ...
    "requires": [
      ...
      {"@id": "urn:ngm:class:biomechanical-data", "label": "Biomechanical Data"}
    ],
    "enables": [
      {"@id": "urn:ngm:class:human-robot-collaboration", "label": "Human-Robot Collaboration"},
      {"@id": "urn:ngm:class:ce-marking", "label": "CE Marking"},
      {"@id": "urn:ngm:class:cobot-deployment", "label": "Cobot Deployment"}
    ],
    "implements": [
      {"@id": "urn:ngm:class:power-and-force-limiting", "label": "Power and Force Limiting"},
      {"@id": "urn:ngm:class:speed-and-separation-monitoring", "label": "Speed and Separation Monitoring"},
      {"@id": "urn:ngm:class:safety-rated-monitored-stop", "label": "Safety-Rated Monitored Stop"},
      {"@id": "urn:ngm:class:hand-guiding", "label": "Hand Guiding"}
    ],
    "uses": [
      {"@id": "urn:ngm:class:force-control", "label": "Force Control"},
      {"@id": "urn:ngm:class:proximity-sensing", "label": "Proximity Sensing"},
      {"@id": "urn:ngm:class:torque-sensing", "label": "Torque Sensing"}
    ],
    "supports": [
      {"@id": "urn:ngm:class:human-robot-interaction", "label": "Human Robot Interaction"},
      {"@id": "urn:ngm:class:occupational-safety", "label": "Occupational Safety"},
      {"@id": "urn:ngm:class:functional-safety", "label": "Functional Safety"}
    ],
    "standardizedBy": [
      {"@id": "urn:ngm:class:iso-tc-299", "label": "ISO/TC 299"},
  ...
  "sameAs": [
    {"@id": "urn:ngm:class:iso-ts-15066-2016", "label": "ISO/TS 15066:2016"},
    {"@id": "urn:ngm:class:cobot-safety-specification", "label": "Cobot Safety Specification"}
  ],
  "quality": 0.73,
  "provenance": {
