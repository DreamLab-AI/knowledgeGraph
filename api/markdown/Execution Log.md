schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#ExecutionLog
legacy_uri:: urn:visionclaw:concept:infrastructure:execution-log
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-69854d36e344"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#ExecutionLog"
    },
    {
      "vc:key": "maturity",
      "vc:value": "draft"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:execution-log"
    },
    {
      "vc:key": "status",
      "vc:value": "stub"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:execution-log:776c802a9fc9",
...
- ### Definition
  - Execution Log is a concept within the ngm domain.

- ### Semantic Classification
  - owl-class:: infrastructure:ExecutionLog
  - owl-role:: Concept
