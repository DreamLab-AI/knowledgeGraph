schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#Infrastructure
legacy_uri:: urn:visionclaw:concept:infrastructure:infrastructure
public:: true
...
```json-ld
{
  ...
  "@id": "urn:visionflow:page:7a296227bf6d94fea14b3d170d1cb5478dc7e95ddec94ef0c01cc613c49f7a5a",
  "@type": "Page",
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-7e24e85a5185"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#Infrastructure"
    },
    {
      "vc:key": "maturity",
      "vc:value": "draft"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:infrastructure"
    },
    {
      "vc:key": "status",
      "vc:value": "stub"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:7a296227bf6d94fea14b3d170d1cb5478dc7e95ddec94ef0c01cc613c49f7a5a@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
```json-ld
{
  ...
  "definition": "infrastructure is a technology infrastructure concept and a type of owl:Thing.",
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:infrastructure:776c802a9fc9",
...
- ### Definition
  - infrastructure is a concept within the ngm domain.

- ### Semantic Classification
  - owl-class:: infrastructure:Infrastructure
  - owl-role:: Concept
