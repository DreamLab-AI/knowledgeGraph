schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#SeparationOfPowers
legacy_uri:: urn:visionclaw:concept:spatial-computing:separation-of-powers
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-ba5ca0fa55dc"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#SeparationOfPowers"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:separation-of-powers"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
