schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#CryptographicPrimitive
legacy_uri:: urn:visionclaw:concept:blockchain:cryptographic-primitive
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-050f770fd6d2"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#CryptographicPrimitive"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:cryptographic-primitive"
    },
    {
      "vc:key": "status",
      "vc:value": "active"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:07d395b56a94e66166db3b8d0bf2f58eb81ae1a600bf107b343a1f724a323276@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
