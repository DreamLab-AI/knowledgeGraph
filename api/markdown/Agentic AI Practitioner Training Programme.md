...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "agentic-ai-practitioner-training-programme",
...
```json-ld
{
  ...
  "@id": "urn:ngm:class:agentic-ai-practitioner-training-programme",
  "@type": "Class",
  "label": "Agentic AI Practitioner Training Programme",
...
- ### Relationships
  ...
  - relatedTo:: [[Agent Frameworks]], [[Generative AI Development Methodology]]
