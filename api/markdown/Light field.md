...
- ### Content
  ...
  - **Real-time 6-DoF capture for consumer devices**: Smartphone-integrated multi-camera arrays (6-8 cameras) with on-device 3DGS optimisation (targeting 30-second training on mobile NPU) [private] enable casual LF capture by 2028. Apple has filed patents on multi-camera LF synthesis for post-capture refocusing and viewpoint interpolation beyond current spatial video.
