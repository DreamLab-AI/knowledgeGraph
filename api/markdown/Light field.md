schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/graphics-computer-vision#LightField
legacy_uri:: urn:visionclaw:concept:graphics-computer-vision:light-field
public:: true
...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:computational-imaging-domain",
      "vc:label": "ComputationalImagingDomain"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:graphics-computer-vision-domain",
      "vc:label": "Graphics-ComputerVisionDomain"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:optics-and-photonicse-domain",
      "vc:label": "OpticsAndPhotonicseDomain"
    },
    {
  ...
  "vc:legacyProperties": [
    {
      ...
      "vc:value": "Lumigraph, Plenoptic Function, 4D Light Field, Radiance Field"
    },
    {
    ...
    {
      "vc:key": "bridges-to",
      "vc:value": "[[Neural Radiance Fields]], [[Holography]], [[Virtual Reality]], [[Spatial Computing]]"
    },
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-lf7c3b9a2e41"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "domain",
      "vc:value": "graphics-computer-vision"
    },
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/graphics-computer-vision#LightField"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:graphics-computer-vision:light-field"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
```json-ld
{
  ...
  "vc:sourceDomain": "graphics-computer-vision",
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:light-field:776c802a9fc9",
  ...
  "vc:resolutions": [
    {
      "raw": "[[2D Display]]",
      "resolved": "urn:visionflow:linked:2-d-display",
      "kind": "StubLink"
    },
    {
      "raw": "[[4D Parameterisation]]",
      "resolved": "urn:visionflow:linked:4-d-parameterisation",
      "kind": "StubLink"
    },
    {
      "raw": "[[6-DoF VR]]",
      "resolved": "urn:visionflow:linked:6-do-f-vr",
      "kind": "StubLink"
    },
    {
      "raw": "[[ACM TOG]]",
      "resolved": "urn:visionflow:linked:acm-tog",
      "kind": "StubLink"
    },
    {
      "raw": "[[AlgorithmLayer]]",
    ...
    {
      "raw": "[[Camera Array]]",
      "resolved": "urn:visionflow:linked:camera-array",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Computational Holography]]",
      "resolved": "urn:visionflow:linked:computational-holography",
      "kind": "StubLink"
    },
    {
      "raw": "[[ComputationalImagingDomain]]",
      "resolved": "urn:visionflow:linked:computational-imaging-domain",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Epipolar Plane Image]]",
      "resolved": "urn:visionflow:linked:epipolar-plane-image",
      "kind": "StubLink"
    },
    {
      "raw": "[[Fourier Analysis]]",
      "resolved": "urn:visionflow:linked:fourier-analysis",
      "kind": "StubLink"
    },
    {
      "raw": "[[Fourier Slice Theorem]]",
      "resolved": "urn:visionflow:linked:fourier-slice-theorem",
      "kind": "StubLink"
    },
    {
      "raw": "[[GPU Compute]]",
    ...
    {
      "raw": "[[Graphics-ComputerVisionDomain]]",
      "resolved": "urn:visionflow:linked:graphics-computer-vision-domain",
      "kind": "StubLink"
    },
    {
      "raw": "[[HardwareLayer]]",
    ...
    {
      "raw": "[[Hogel]]",
      "resolved": "urn:visionflow:linked:hogel",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[IEEE TVCG]]",
      "resolved": "urn:visionflow:linked:ieee-tvcg",
      "kind": "StubLink"
    },
    {
      "raw": "[[Image Based Rendering]]",
      "resolved": "urn:visionflow:linked:image-based-rendering",
      "kind": "StubLink"
    },
    {
      "raw": "[[Industrial Metrology]]",
      "resolved": "urn:visionflow:linked:industrial-metrology",
      "kind": "StubLink"
    },
    {
      "raw": "[[Integral Imaging]]",
      "resolved": "urn:visionflow:linked:integral-imaging",
      "kind": "StubLink"
    },
    {
      "raw": "[[Lenticular Lens]]",
      "resolved": "urn:visionflow:linked:lenticular-lens",
      "kind": "StubLink"
    },
    {
      "raw": "[[Light Field Camera]]",
      "resolved": "urn:visionflow:linked:light-field-camera",
      "kind": "StubLink"
    },
    {
      "raw": "[[Light Field Display]]",
      "resolved": "urn:visionflow:linked:light-field-display",
      "kind": "StubLink"
    },
    {
      "raw": "[[Medical Imaging]]",
    ...
    {
      "raw": "[[Microlens Array]]",
      "resolved": "urn:visionflow:linked:microlens-array",
      "kind": "StubLink"
    },
    {
      "raw": "[[Microlens Multiplexing]]",
      "resolved": "urn:visionflow:linked:microlens-multiplexing",
      "kind": "StubLink"
    },
    {
      "raw": "[[Monocular Depth Estimation]]",
      "resolved": "urn:visionflow:linked:monocular-depth-estimation",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Museum Digitalisation]]",
      "resolved": "urn:visionflow:linked:museum-digitalisation",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Optical Representation]]",
      "resolved": "urn:visionflow:linked:optical-representation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Optics]]",
      "resolved": "urn:visionflow:linked:optics",
      "kind": "StubLink"
    },
    {
      "raw": "[[OpticsAndPhotonicseDomain]]",
      "resolved": "urn:visionflow:linked:optics-and-photonicse-domain",
      "kind": "StubLink"
    },
    {
      "raw": "[[Parallax Rendering]]",
      "resolved": "urn:visionflow:linked:parallax-rendering",
      "kind": "StubLink"
    },
    {
      "raw": "[[Plenoptic Camera]]",
      "resolved": "urn:visionflow:linked:plenoptic-camera",
      "kind": "StubLink"
    },
    {
      "raw": "[[Plenoptic Function]]",
      "resolved": "urn:visionflow:linked:plenoptic-function",
      "kind": "StubLink"
    },
    {
      "raw": "[[Radiance Field]]",
      "resolved": "urn:visionflow:linked:radiance-field",
      "kind": "StubLink"
    },
    {
      "raw": "[[Ray Parameterisation]]",
      "resolved": "urn:visionflow:linked:ray-parameterisation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Ray-plane Intersection]]",
      "resolved": "urn:visionflow:linked:ray-plane-intersection",
      "kind": "StubLink"
    },
    {
      "raw": "[[Refocusing Post-capture]]",
      "resolved": "urn:visionflow:linked:refocusing-post-capture",
      "kind": "StubLink"
    },
    {
      "raw": "[[Sampling Theory]]",
      "resolved": "urn:visionflow:linked:sampling-theory",
      "kind": "StubLink"
    },
    {
      "raw": "[[SIGGRAPH]]",
    ...
    {
      "raw": "[[Sub-aperture Image]]",
      "resolved": "urn:visionflow:linked:sub-aperture-image",
      "kind": "StubLink"
    },
    {
      "raw": "[[Traditional Photography]]",
      "resolved": "urn:visionflow:linked:traditional-photography",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Volumetric Display]]",
      "resolved": "urn:visionflow:linked:volumetric-display",
      "kind": "StubLink"
    },
    {
      "raw": "[[Wave Optics]]",
      "resolved": "urn:visionflow:linked:wave-optics",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Lens and Camera Calibration]]",
      "resolved": "urn:visionflow:owl:class:lens-and-camera-calibration",
      "kind": "ResolvedLink"
    },
    {
...
- ### Definition
  - Light field is a foundational concept in computational optics and computer graphics describing the complete distribution of light rays travelling through free space in all directions at all points, formalised by Adelson and Bergen (1991) as the 7-dimensional plenoptic function P(Vx, Vy, Vz, θ, φ, λ, t) specifying the luminance of light rays as a function of 3D position (Vx, Vy, Vz), viewing direction (θ, φ), wavelength λ, and time t — subsequently reduced by Marc Levoy and Pat Hanrahan in their landmark SIGGRAPH 1996 paper "Light Field Rendering" to a tractable 4D parameterisation L(s,t,u,v) on two parallel planes (the st-plane and uv-plane) by exploiting the fact that radiance is constant along rays in free space absent occluders, enabling the first practical algorithms for image-based rendering from dense light field samples (100×100 camera arrays producing 10,000 images rendered to novel viewpoints by ray-plane intersection at interactive rates on 1996-era workstations); simultaneously Gortler et al. (1996) introduced the equivalent "Lumigraph" parameterisation with a non-uniform sampling correction factor accounting for camera distance variation, establishing the foundational acquisition-compression-rendering pipeline that now underpins 30 years of plenoptic imaging research; the 4D light field L(s,t,u,v) supports multiple complementary interpretations — each fixed (s,t) defines an "epipolar plane image" (EPI) capturing disparity structure as diagonal line patterns whose slope directly encodes depth, each fixed (u,v) defines a "sub-aperture image" equivalent to a pinhole photograph taken from position (u,v), and the full dataset parameterises a 4D hypercube from which any viewpoint within the camera baseline can be reconstructed without geometric modelling through integral or Fourier-domain rendering; practical light field acquisition has evolved from the Levoy-Hanrahan gantry (camera translated over 2D grid) through plenoptic cameras (Lytro 2011-2018 using Keplerian microlens array MLA in front of sensor to multiplex 378 sub-aperture views per exposure at reduced spatial resolution, Raytrix R42 industrial plenoptic 3.0 camera for metrology and focus post-selection, Pelican Imaging consumer mobile arrays, and AWARE Mosaic array camera with 98 sub-aperture lenses for wide-angle gigapixel capture) to unstructured multi-camera rig acquisition (Google Jump 16-camera circular array, Facebook Surround 360 17-camera spherical rig, Lytro Immerge 94-camera VR light field camera 2016-2018, Nokia OZO ambisonic+camera hybrid) providing sufficient parallax for 6-DoF viewpoint synthesis; light field displays extend the acquisition concept to autostereoscopic output, projecting distinct light rays to each viewing zone without glasses (Looking Glass Factory holographic displays 2018-present using lenticular lens array over high-resolution LCD/OLED panel, displaying 45-100 distinct views in a 50° viewing cone at 7.9-inch through 65-inch diagonal scales including Looking Glass Go, Portrait, 16-inch, 32-inch, and 65-inch Pro; Light Field Lab SolidLight panels tiling 28-inch modular units to build arbitrary-scale holographic surfaces achieving 2.5 billion pixels per square metre ray density at 60 Hz with claimed human-eye-resolution holographic depth at 2026 commercial deployment; Sony SRD-1 spatial reality display 15.6-inch lenticular with eye-tracking updating 120 Hz to deliver correct parallax cues to a single tracked viewer; HoloPlayer One developer kit; and research displays achieving 100+ views through directional backlight+LCD stack or computational holographic diffuser approaches); Neural Radiance Fields (NeRF, Mildenhall et al. 2020) and 3D Gaussian Splatting (3DGS, Kerbl et al. 2023) function as learned implicit and explicit light field representations respectively — NeRF encodes the light field as a continuous volumetric function mapping (x,y,z,θ,φ) to (colour, density) via MLP, enabling novel view synthesis from 20-200 calibrated photos with photorealistic results that generalise beyond the input camera baseline, whilst 3DGS represents the scene as 3-5 million 3D Gaussian primitives with learnable colour, opacity, and anisotropy achieving real-time (30-120 fps) rendering on consumer GPUs — both paradigms unifying the classical light field rendering problem with data-driven scene representation and prompting extensive debate at SIGGRAPH 2024 over whether implicit/explicit neural representations have superseded or merely extended the classical 4D LF formalism; holographic stereograms (hogels) implement discretised light field output as interference patterns computed from the LF dataset, with Zebra Imaging printing flat-panel "zScape" holoprints for US military terrain visualisation and Holoxica (Edinburgh) producing digital holographic displays for medical volumetric data, museum specimens, and industrial part inspection; applications span entertainment (Looking Glass displays in museum kiosks at Natural History Museum London, Smithsonian, MoMA), medical imaging (volumetric holographic display of CT/MRI allowing surgeons to inspect anatomy without 2D projection loss), industrial metrology (Raytrix plenoptic cameras measuring 3D surface profiles of semiconductor wafers and automotive parts), virtual/augmented reality (Google "Welcome to Light Fields" app (2018) pioneering 6-DoF LF VR experiences from 16-camera Jump rigs at selected real-world sites, Meta Quest spatial video as compressed light field approximation, Apple Vision Pro spatial photos and videos), remote collaboration (Looking Glass Spatial OS platform 2025-2026 enabling real-time transmission of holographic avatars across network), scientific visualisation (flow field volumetric rendering, microscopy light-sheet imaging), and education (Imperial College London plenoptic imaging lab, Edinburgh Informatics holographic interface research, BBC R&D 3D capture production tools for broadcast), with the 2024-2026 landscape shaped by convergence between classical discrete LF arrays, neural implicit representations, and purpose-built holographic hardware that collectively bring the full plenoptic function within engineering reach for the first time since Adelson and Bergen named it in 1991.

- ### Semantic Classification
  - owl-class:: graphics-computer-vision:LightField
  - owl-role:: OpticalRepresentationFramework
  - owl-inferred:: gcv:ImageBasedRendering, gcv:PlenopticImaging, gcv:RadianceField, gcv:HolographicDisplay, gcv:ComputationalPhotography
  - belongs-to-domain:: [[Graphics-ComputerVisionDomain]], [[SpatialComputingDomain]], [[OpticsAndPhotonicseDomain]], [[ComputationalImagingDomain]]
  - implemented-in-layer:: [[AlgorithmLayer]], [[HardwareLayer]], [[ApplicationLayer]]
...
- ### Content
  ...
  ## Compositional Relationships (Components)
	  ...
	  AsymmetricObjectProperty(gcv:requires)
	  AsymmetricObjectProperty(gcv:enables)
	  AsymmetricObjectProperty(gcv:implements)
	  AsymmetricObjectProperty(gcv:reduces)
	  TransitiveObjectProperty(gcv:dependsOn)
	  FunctionalDataProperty(gcv:parameterisationDimension)
	  FunctionalDataProperty(gcv:authorityScore)
  ...
  - At the display layer, the trajectory is toward higher ray density and lower cost. Looking Glass Go ($100 at launch in 2024) represents the first sub-$200 light field display, extending the addressable market beyond professionals. Light Field Lab SolidLight is positioned as a premium large-format holographic display for cinema and enterprise, with claimed human-eye-resolution achieved at 60 Hz — a milestone that would mark the first practical "holographic" display meeting the physical requirement for perceptual transparency. Sony SRD-1 continues to dominate single-viewer professional design applications.
  ...
  - 2. Levoy, M., & Hanrahan, P. (1996). Light field rendering. *Proceedings of SIGGRAPH 1996*, 31-42. ACM. DOI: 10.1145/237170.237199 [4D LF parameterisation, image-based rendering, 4200+ citations]
  - 3. Gortler, S.J., Grzeszczuk, R., Szeliski, R., & Cohen, M.F. (1996). The lumigraph. *Proceedings of SIGGRAPH 1996*, 43-54. ACM. DOI: 10.1145/237170.237200 [Lumigraph equivalent parameterisation]
  - 4. Ng, R. (2005). Fourier slice photography. *Proceedings of SIGGRAPH 2005*, 735-744. ACM. DOI: 10.1145/1186822.1073256 [Frequency domain refocusing theory]
  - 5. Ng, R., Levoy, M., Brédif, M., Duval, G., Horowitz, M., & Hanrahan, P. (2005). *Light field photography with a hand-held plenoptic camera*. Stanford Computer Science Technical Report CSTR 2005-02. [Lytro basis — Ren Ng PhD]
  - 6. Isaksen, A., McMillan, L., & Gortler, S.J. (2000). Dynamically reparameterized light fields. *Proceedings of SIGGRAPH 2000*, 297-306. ACM. DOI: 10.1145/344779.344929 [EPI analysis, depth from LF]

  - **Plenoptic Camera Research**:
  - 7. Georgiev, T., & Lumsdaine, A. (2006). Spatio-angular resolution tradeoff in integral photography. *Proceedings of Eurographics*, 263-270. [Resolution tradeoff theory]
  - 8. Lytro Inc. (2011-2016). Lytro Illum and Immerge system documentation. Technical whitepapers. https://lytro.com [Commercial plenoptic camera archive]
  - 9. Perwass, C., & Wietzke, L. (2012). Single lens 3D-camera with extended depth-of-field. *Proceedings of SPIE*, 8291, 829108. DOI: 10.1117/12.909882 [Raytrix multi-focus MLA theory]

  - **Neural Rendering**:
  - 10. Mildenhall, B., Srinivasan, P.P., Tancik, M., Barron, J.T., Ramamoorthi, R., & Ng, R. (2020). NeRF: Representing scenes as neural radiance fields for view synthesis. *Proceedings of ECCV 2020*. arXiv:2003.08934. [NeRF — 20,000+ citations]
  - 11. Kerbl, B., Kopanas, G., Leimkühler, T., & Drettakis, G. (2023). 3D Gaussian splatting for real-time novel view synthesis. *ACM Transactions on Graphics*, 42(4), 139:1-139:14. DOI: 10.1145/3592433 [3DGS — SIGGRAPH 2023 Best Paper]
  - 12. Müller, T., Evans, A., Schied, C., & Keller, A. (2022). Instant neural graphics primitives with a multiresolution hash encoding. *ACM TOG*, 41(4). DOI: 10.1145/3528223.3530127 [Instant-NGP — fast NeRF training]
  - 13. Attal, B., Huang, J., Richardt, C., Zollhöfer, M., Kopf, J., O'Toole, M., & Kim, C. (2022). Neural light fields. *Proceedings of CVPR 2022*, 19156-19165. DOI: 10.1109/CVPR52688.2022.01856 [Direct neural 4D LF regression, 250 fps rendering]

  - **Light Field Displays**:
  - 14. Wetzstein, G., Lanman, D., Hirsch, M., & Raskar, R. (2012). Tensor displays: Compressive light field synthesis using multilayer displays with directional backlighting. *ACM TOG*, 31(4), 80:1-80:11. DOI: 10.1145/2185520.2185576 [Directional backlight LF display theory]
  - 15. Looking Glass Factory. (2024). Looking Glass 65-inch Pro technical specifications and Spatial OS documentation. https://lookingglassfactory.com [Commercial LF display — enterprise tier]
  - 16. Looking Glass Factory. (2024). Looking Glass Go product release. https://lookingglassfactory.com/go [Consumer sub-$100 LF display milestone]
  - 17. Light Field Lab. (2024). SolidLight holographic display — CES 2024 demonstration and commercial deployment announcement. https://lightfieldlab.com [Highest ray-density commercial LF display]
  - 18. Lanman, D., & Luebke, D. (2013). Near-eye light field displays. *ACM TOG*, 32(6), 220:1-220:10. DOI: 10.1145/2508363.2508366 [AR near-eye LF display principles]

  - **VR Light Field**:
  - 19. Anderson, R., Gallup, D., Barron, J.T., Kontkanen, J., Snavely, N., Hernández, C., Agarwal, S., & Seitz, S.M. (2016). Jump: Virtual reality video. *ACM TOG*, 35(6), 198:1-198:13. DOI: 10.1145/2980179.2980257 [Google Jump 16-camera VR LF]
  - 20. Google LLC. (2018). Welcome to Light Fields — SteamVR application. https://store.steampowered.com/app/771670/ [Pioneer 6-DoF LF VR experience]

  - **Holographic Stereograms**:
  - 21. Zebra Imaging. (2008-2015). zScape holographic terrain visualisation system for US Army. Technical reports, DARPA archive. [Military terrain hologram application]
  - 22. Holoxica Ltd. (2023). Digital holographic displays for NHS Scotland anatomy teaching. Project report, Innovate UK grant 10060542. [UK medical holography application]
  - 23. Holoxica Ltd. (2024). Rolls-Royce turbine blade holographic inspection case study. Technical application note. https://holoxica.com [UK industrial holographic metrology]

  - **Standards and Codecs**:
  - 24. ISO/IEC 23090-12:2021 — MPEG Immersive Video (MIV). International Organisation for Standardisation, Geneva. [Multi-view plus depth LF video standard]
  - 25. BBC Research & Development. (2024). Light field video for broadcast: An evaluation of multi-view plus depth approaches for studio production. *BBC White Paper WHP 408*. [BBC R&D LF broadcast standard recommendation]
  - 26. Sony Corporation. (2020). Spatial Reality Display ELF-SR1 technical specification. Sony Professional Solutions. https://pro.sony.com [Eye-tracking single-viewer LF display]
  - 27. SIGGRAPH 2024 Technical Programme. Neural Rendering and Light Fields session proceedings. ACM Digital Library. DOI: 10.1145/3641519 [SIGGRAPH 2024 — LF/neural rendering state of field]
...
- ### Provenance
  - sources:: Levoy-Hanrahan SIGGRAPH 1996; Gortler et al. SIGGRAPH 1996; Ng 2005 Stanford PhD; Mildenhall et al. NeRF ECCV 2020; Kerbl et al. 3DGS SIGGRAPH 2023; Looking Glass Factory product documentation 2024-2026; Light Field Lab SolidLight CES 2024; BBC R&D White Paper WHP 408 2024; ISO/IEC 23090-12 MIV standard; Holoxica Innovate UK grant report 2023; Google Welcome to Light Fields 2018
  ...
  - quality-gate:: Phase 6 bulk run — enriched from stub (39 lines, 1 URL) to production-ready (39 OWL axioms, 66 wikilinks, 27 references)
