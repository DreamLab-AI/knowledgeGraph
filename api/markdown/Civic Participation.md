schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#CivicParticipation
legacy_uri:: urn:visionclaw:concept:spatial-computing:civic-participation
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-b00f06ed123b"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#CivicParticipation"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:civic-participation"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
