schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#ProprietaryAIVideo
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:proprietary-ai-video
public:: true
...
```json-ld
{
  ...
  "@id": "urn:visionflow:page:8717a0b9181ac4a1574a693ab8b946cbd0cce8b284c0692133874fc5b7f88376",
  "@type": "Page",
  "vc:slug": "proprietary-ai-video",
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:apiservice-layer",
      "vc:label": "APIServiceLayer"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-7964f3205b31"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#ProprietaryAIVideo"
    },
    {
    ...
    {
      "vc:key": "modified",
      "vc:value": "2026-05-17T14:00:00Z"
    },
    {
      "vc:key": "preferred-term",
      "vc:value": "Proprietary AI Video"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:proprietary-ai-video"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:8717a0b9181ac4a1574a693ab8b946cbd0cce8b284c0692133874fc5b7f88376@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
```json-ld
{
  ...
  "definition": "Proprietary AI Video denotes the class of closed-source, commercially operated [[Generative AI]] systems that synthesise temporally-coherent moving imagery conditioned on text prompts, reference images, existing video clips, audio signals, or structured control inputs (depth maps, pose skeletons, motion vectors), developed and served by corporations retaining exclusive access to model weights, training data compositions, and inference infrastructure, encompassing five dominant commercial families — (1) foundation text-to-video generators with physics-aware spatiotemporal modelling (OpenAI Sora Feb 2024 preview / Dec 2024 Turbo launch / Sep 2025 Sora 2 with synchronised audio, [[Google DeepMind]] Veo 2 Dec 2024 / Veo 3 May 2025 with native joint audio, Kuaishou Kling 1.0 Jun 2024 / 2.0 Apr 2025 120-second clips / 2.1 Aug 2025 multi-shot consistency, [[Runway]] Gen-3 Alpha Jun 2024 / Gen-3 Alpha Turbo Jul 2024 $0.05/sec / Gen-4 Mar 2025 character consistency); (2) prosumer creative tools optimised for short-form social content (Pika 1.5 Oct 2024 Pikaffects / 2.0 Dec 2024 Scene Ingredients / 2.2 Feb 2025 Pikaframes-Pikaswaps-Pikadditions, Luma Dream Machine Jun 2024 / Ray2 Jan 2025, M",
  "vc:qualityScore": {
    "@value": "0.52",
    "@type": "xsd:float"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:proprietary-ai-video:776c802a9fc9",
  ...
  "vc:resolutions": [
    {
      "raw": "[[Advertising and Marketing]]",
      "resolved": "urn:visionflow:linked:advertising-and-marketing",
      "kind": "StubLink"
    },
    {
      "raw": "[[APIServiceLayer]]",
      "resolved": "urn:visionflow:linked:apiservice-layer",
      "kind": "StubLink"
    },
    {
...
- ### Definition
  - Proprietary AI Video denotes the class of closed-source, commercially operated [[Generative AI]] systems that synthesise temporally-coherent moving imagery conditioned on text prompts, reference images, existing video clips, audio signals, or structured control inputs (depth maps, pose skeletons, motion vectors), developed and served by corporations retaining exclusive access to model weights, training data compositions, and inference infrastructure, encompassing five dominant commercial families — (1) foundation text-to-video generators with physics-aware spatiotemporal modelling (OpenAI Sora Feb 2024 preview / Dec 2024 Turbo launch / Sep 2025 Sora 2 with synchronised audio, [[Google DeepMind]] Veo 2 Dec 2024 / Veo 3 May 2025 with native joint audio, Kuaishou Kling 1.0 Jun 2024 / 2.0 Apr 2025 120-second clips / 2.1 Aug 2025 multi-shot consistency, [[Runway]] Gen-3 Alpha Jun 2024 / Gen-3 Alpha Turbo Jul 2024 $0.05/sec / Gen-4 Mar 2025 character consistency); (2) prosumer creative tools optimised for short-form social content (Pika 1.5 Oct 2024 Pikaffects / 2.0 Dec 2024 Scene Ingredients / 2.2 Feb 2025 Pikaframes-Pikaswaps-Pikadditions, Luma Dream Machine Jun 2024 / Ray2 Jan 2025, MiniMax Hailuo video-01 Aug 2024 / i2v-live Q1 2025 real-time inference); (3) enterprise avatar-and-talking-head systems (Synthesia London $1B+ unicorn 200+ AI avatars 50K+ enterprise users, HeyGen $500M valuation, Captions.ai $25M Series B 2024); (4) commercially-safe creative suites (Adobe Firefly Video Beta Oct 2024 rights-cleared training corpus Premiere Pro integration); (5) professional post-production enhancement (Topaz Video AI upscaling denoising frame-interpolation via supervised discriminative networks rather than generative [[Diffusion Models]]) — operating collectively in a market valued at $1.3-1.6 billion in 2025 (Grand View Research; MarketsandMarkets) projected to reach $14-17 billion by 2030 at CAGR 41-44 percent, driven by advertising automation (30-40% reduction in early-pipeline concept artist roles, Concept Art Association 2024 survey), film pre-visualisation (Lionsgate-Runway $300M Sep 2024 deal granting access to 20,000+ film titles for training), social content creation (TikTok / Instagram Reels / YouTube Shorts saturated with AI short-form by 2025), enterprise training video, and synthetic-media fraud generating £2.6 billion in global losses in 2025 (Sumsub 2025 Identity Fraud Report; prototype incident: Hong Kong CFO deepfake $25M heist Feb 2024), with core technical architecture across proprietary systems converging on [[Diffusion Transformer]] DiT (Peebles & Xie 2023 ICCV) backbones operating in spatiotemporal latent spaces via 3D causal variational autoencoders (4× spatial + 4× temporal compression yielding 64× latent reduction; MAGVIT-v2 Yu et al. 2024 ICLR lookup-free quantisation achieving PSNR >32dB), extending [[Classifier Free Guidance]] (Ho & Salimans 2022 guidance scale w = 7-15 typical for video) and [[Attention]] to temporal dimensions via full 3D attention or factored spatial-temporal blocks, with Veo 3 (May 2025) and Sora 2 (Sep 2025) advancing the field to joint video-audio synthesis via multimodal [[Transformers]] (MMDiT per Esser & Rombach 2024 rectified flow lineage), while technical limitations persist — multi-shot character identity consistency requires Tier 1 frontier models (Sora 2, Veo 3/3.1, Kling 2.1, Gen-4); causal physics fidelity remains probabilistically plausible but unreliable (glass-shattering before impact, water flowing uphill acknowledged in Sora technical report Brooks et al. 2024); text rendering embedded in video scenes is unreliable below frontier; audio-video synchronisation was absent industry-wide before Veo 3 (May 2025); single-pass coherent generation above 120 seconds (Kling 2.0 commercial frontier) remains architecturally unsolved for mainstream systems; per-clip inference pricing spans $0.05-$0.50 per second across platforms with training compute estimated at 10,000-30,000 H100-equivalent GPU-weeks for Sora-class systems (Epoch AI 2024 estimates), and consumer access to OpenAI Sora was withdrawn April 2026 following litigation over the Sora 2 cameo likeness feature, establishing the first major proprietary video withdrawal driven by legal rather than technical factors.

- ### Semantic Classification
  - owl-class:: artificial-intelligence:ProprietaryAIVideo
  - owl-role:: GenerativeAISystem
  - owl-inferred:: ai:TextToVideo, ai:ImageToVideo, ai:VideoSynthesis, ai:LatentDiffusion, ai:ClosedSourceAI
  - belongs-to-domain:: [[AI-GroundedDomain]], [[GenerativeAIDomain]], [[ComputerVisionDomain]], [[CreativeAIDomain]]
  - implemented-in-layer:: [[ApplicationLayer]], [[APIServiceLayer]], [[FoundationModelLayer]]

- ### Relationships
  - is-subclass-of:: [[AI Video]], [[Generative AI]], [[Foundation Models]], [[Diffusion Models]], [[Computer Vision]], [[Model Training]]
  - has-part:: [[Diffusion Transformer]], [[Latent Space]], [[Attention]], [[Transformers]], [[Checkpoints]], [[Model Optimisation and Performance]], [[Text-to-Video Generation]], [[Stable Diffusion]]
  - requires:: [[Compute Infrastructure]], [[Training Data]], [[Latent Space]], [[Diffusion Models]], [[Foundation Models]], [[Model Training]], [[Hardware and Edge]]
  - enables:: [[AI Video]], [[Deepfakes and fraudulent content]], [[AI companions]], [[Agentic Internet]], [[Hyper personalisation]], [[Education and AI]], [[Call Centres]], [[AI Adoption]]
  - implements:: [[Diffusion Models]], [[Transformers]], [[Attention]], [[Latent Space]], [[LoRA DoRA etc]], [[Checkpoints]], [[ControlNet and Similar Spatial Conditioning Systems]], [[Function Calling]]
  - depends-on:: [[Foundation Models]], [[Model Training]], [[Compute Infrastructure]], [[Training Data]], [[Model Optimisation and Performance]], [[Hardware and Edge]], [[Stable Diffusion]]
  - supports:: [[AI Video]], [[Advertising and Marketing]], [[Film Production]], [[Social Media]], [[Education and AI]], [[Chatbots]], [[Agentic Internet]], [[Competition in AI]]
  - uses:: [[Diffusion Models]], [[Attention]], [[Transformers]], [[Latent Space]], [[Stable Diffusion]], [[ComfyUI]], [[ComfyUI Workflows]], [[AnimateDiff]], [[Stable Diffusion Training]]
  - contrasts-with:: [[AnimateDiff]], [[Stable Diffusion]], [[Generative Adversarial Networks]], [[ComfyUI]], [[Open Source AI]], [[Gaussian Splatting]]
  - related-to:: [[AI Video]], [[Google DeepMind]], [[Anthropic Claude]], [[AI Risks]], [[Deepfakes and fraudulent content]], [[AI Liability]], [[Competition in AI]], [[AI Adoption]], [[Foundation Models]], [[Reasoning]]
  - standardized-by:: [[EU AI Act]], [[California AI bill]], [[AI Safety]], [[Safety and alignment]]

- ### Content

  ## Compositional Relationships (Components)
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:hasPart ai:TextToVideoGenerator))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:hasPart ai:ImageToVideoAdapter))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:hasPart ai:SpatiotemporalAutoencoder))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:hasPart ai:DiffusionTransformerBackbone))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:hasPart ai:VideoCompressionNetwork))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:hasPart ai:TextEncoder))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:hasPart ai:ClassifierFreeGuidanceModule))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:hasPart ai:APIServiceLayer))

    ## Dependency Relationships
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:requires ai:GPUCluster))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:requires ai:LargeScaleVideoTextTrainingData))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:requires ai:SpatiotemporalLatentSpace))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:requires ai:VideoTokeniser))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:requires ai:DiffusionProcess))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:dependsOn ai:DiffusionTransformerArchitecture))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:dependsOn ai:FoundationModel))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:dependsOn ai:ComputeInfrastructure))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:dependsOn ai:RectifiedFlowTransformer))

    ## Capability Relationships
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:enables ai:TextConditionedVideoSynthesis))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:enables ai:ImageAnimationAndExtension))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:enables ai:FilmPrevisualization))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:enables ai:AdvertisingAutomation))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:enables ai:SyntheticMediaFraud))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:enables ai:SocialContentCreation))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:supports ai:CreativeIndustries))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:supports ai:EnterpriseTrainingContent))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:supports ai:AvatarVideoGeneration))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:supports ai:PostProductionEnhancement))
    ...
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:implements ai:RectifiedFlowTransformer))
    SubClassOf(ai:ProprietaryAIVideo
    ...
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:implements ai:TemporalAttention))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:implements ai:VideoVAE3DCausal))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:uses ai:SyntheticMediaWatermarking))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:uses ai:ContentProvenance))
    ...
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:reduces ai:StoryboardingTime))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:reduces ai:CGIPipelineCost))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:reduces ai:PostProductionTime))

    ## Association Relationships
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:relatedTo ai:OpenSourceVideoGeneration))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:relatedTo ai:DeepfakeDetection))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:relatedTo ai:SyntheticMediaRegulation))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:relatedTo ai:DigitalWatermarking))
    SubClassOf(ai:ProprietaryAIVideo
      ObjectSomeValuesFrom(ai:relatedTo ai:WorldModelSimulation))

    ## Data Properties
    DataPropertyAssertion(ai:hasIdentifier ai:ProprietaryAIVideo "AI-0640"^^xsd:string)
    DataPropertyAssertion(ai:authorityScore ai:ProprietaryAIVideo "0.87"^^xsd:decimal)
    DataPropertyAssertion(ai:marketSize2025USD ai:ProprietaryAIVideo "1500000000"^^xsd:integer)
    DataPropertyAssertion(ai:marketProjection2030USD ai:ProprietaryAIVideo "15500000000"^^xsd:integer)
    DataPropertyAssertion(ai:deepfakeFraudLosses2025GBP ai:ProprietaryAIVideo "2600000000"^^xsd:integer)
    DataPropertyAssertion(ai:dominantArchitecture ai:ProprietaryAIVideo "DiffusionTransformer-SpacetimePatches"^^xsd:string)
    DataPropertyAssertion(ai:soraTrainingComputeH100Weeks ai:ProprietaryAIVideo "10000"^^xsd:integer)
    DataPropertyAssertion(ai:perClipPricingUSDPerSecMin ai:ProprietaryAIVideo "0.05"^^xsd:decimal)
    DataPropertyAssertion(ai:perClipPricingUSDPerSecMax ai:ProprietaryAIVideo "0.50"^^xsd:decimal)

    ## Property Constraints
    SubClassOf(ai:ProprietaryAIVideo
      DataAllValuesFrom(ai:isClosedSource xsd:boolean))
    SubClassOf(ai:ProprietaryAIVideo
      DataSomeValuesFrom(ai:maximumClipDurationSeconds xsd:integer))
    SubClassOf(ai:ProprietaryAIVideo
      DataMinCardinality(1 ai:hasTextConditioningInput xsd:string))

    ## Annotations
    AnnotationAssertion(rdfs:label ai:ProprietaryAIVideo "Proprietary AI Video"@en)
    AnnotationAssertion(rdfs:comment ai:ProprietaryAIVideo "Closed-source commercially operated deep generative systems for video synthesis from text, image, audio or control conditioning; 2024-2026 landscape: OpenAI Sora (Feb 2024 preview, Dec 2024 Turbo, Sep 2025 Sora 2 with audio, Apr 2026 consumer withdrawal), Google Veo 2/3 (Dec 2024/May 2025 native audio), Runway Gen-3/Gen-4, Pika 2.x, Luma Ray2, Kling 2.x (120s clips), Hailuo, Adobe Firefly Video, Topaz Video AI, Meta Movie Gen (30B); market $1.5B (2025) projected $14-17B (2030 CAGR 41-44%); deepfake fraud £2.6B (Sumsub 2025); EU AI Act Article 50 enforcement Aug 2026."@en)
    AnnotationAssertion(dcterms:identifier ai:ProprietaryAIVideo "AI-0640"^^xsd:string)
    AnnotationAssertion(dcterms:subject ai:ProprietaryAIVideo "Generative AI, Video Synthesis, Diffusion Models, Text-to-Video, Computer Vision, Proprietary AI"@en)
    ```

  - ## About Proprietary AI Video
  - **Proprietary AI Video** is a strategically consequential sub-class of [[Generative AI]] encompassing commercially closed [[Foundation Models]] and associated inference services that translate natural-language or multimodal conditioning signals into temporally coherent video sequences, distinguished from [[Open Source AI]] alternatives (Stability AI Stable Video Diffusion 2023, Tencent HunyuanVideo 13B Dec 2024, Alibaba Wan 2.1 Feb 2025, Genmo Mochi 1 Apache-2.0 Oct 2024, Lightricks LTX-Video real-time consumer-GPU Nov 2024) by the closure of model weights, training data composition, and internal architecture details that enables monetisation through inference-time compute sold as API credits or subscriptions without granting licensable model access. The closure imposes distinctive constraints on research reproducibility, regulatory auditability, third-party safety evaluation, and competitive barrier formation that distinguish proprietary video from both the open-weight ecosystem and from earlier commercial [[Generative Adversarial Networks]]-based video systems that preceded the diffusion era.
  ...
  - **Sora Turbo (December 2024)**: Distilled faster-inference model deployed in [[ChatGPT]] Plus ($20/month: 20-second maximum 1080p watermarked via SynthID) and Pro ($200/month: 60-second maximum 1080p). Content policy enforced via classifier gating: no real-person likeness without consent, no violent or sexual content. The simultaneous public launch in the same week as Pika 2.0 (December 2024) forced direct consumer comparison that shaped early market positioning for both systems.
  ...
  - **Enterprise training video**: Synthesia (London, $1B+ unicorn) with 50,000+ enterprise users (Reuters, BBC, Vodafone, Tiffany) represents the dominant enterprise avatar-video segment; corporate training and internal communications localised to 120+ languages without live-action reshoots. HeyGen ($500M) and Captions.ai ($25M Series B 2024) compete in this segment with differentiations on voice cloning quality and CMS integration.
  ...
  - **Imagen Video (Ho et al. 2022, Google)**: Cascaded video diffusion achieving 1280×768 through a hierarchy of temporal and spatial super-resolution [[Foundation Models]], demonstrating quality scaling through cascades.
  ...
  - **Movie Gen (Polyak et al. 2024, Meta)**: 30B joint video-audio [[Foundation Models]]; joint multimodal training superior to sequential audio overlay; establishes parameter-count scaling for video generation; Movie Gen benchmark provides independent evaluation metrics for commercial systems.
  ...
  - Guo, Yuwei, et al. "AnimateDiff: Animate Your Personalized Text-to-Image Diffusion Models without Specific Tuning." ICLR 2024. arXiv:2307.04725. Plug-in temporal motion module for [[Stable Diffusion]] ecosystem.
  ...
  - Esser, Patrick, Robin Rombach, et al. "Scaling Rectified Flow Transformers for High-Resolution Image Synthesis." ICML 2024. arXiv:2403.03206. MMDiT and rectified flow for [[Stable Diffusion]] 3.
  ...
  - Polyak, Adam, et al. "Movie Gen: A Cast of Media Foundation Models." Meta AI, October 2024. https://ai.meta.com/research/movie-gen/. 30B joint video-audio [[Foundation Models]]; Movie Gen benchmark.
  ...
  - OpenAI. "Sora System Card and Sora Turbo launch." OpenAI, December 2024. https://openai.com/sora. Safety evaluation, content policy, SynthID watermarking for [[ChatGPT]] integration.
  - OpenAI. "Sora 2 announcement and cameo feature." OpenAI, September 2025. Consumer access withdrawal April 2026.
  - Google DeepMind. "Veo 3 announcement at Google I/O 2025." May 2025. Native synchronised audio; [[Gemini]] AI Studio integration.
  ...
  - Grand View Research. "Generative AI Video Market Analysis 2025-2030." GVR-4-68039-749-8, 2025. $1.3-1.6B 2025 market; $14-17B 2030 projection; CAGR 41-44%.
...
- ### Provenance
  - sources:: Brooks et al. 2024 (Sora); Polyak et al. 2024 (Movie Gen); Yu et al. 2024 ICLR (MAGVIT-v2); Peebles & Xie 2023 ICCV (DiT); Esser & Rombach 2024 (MMDiT/SD3); Ho et al. 2022 NeurIPS (Video Diffusion); Huang et al. 2024 CVPR (VBench); BBC R&D 2024; Grand View Research 2025; Sumsub 2025 Identity Fraud Report; Kuaishou engineering blog July 2024; OpenAI Sora system card December 2024; Google DeepMind Veo 3 May 2025; Runway Gen-4 March 2025; Bloomberg Lionsgate-Runway September 2024; SAG-AFTRA November 2023; Concept Art Association 2024 survey; Fortune October 2025 (Pika user metrics)
  - migration-date:: 2026-04-26T00:00:00Z
  - enriched-date:: 2026-05-17T14:00:00Z
  ...
  - legacy-term-id-assigned:: AI-0640
  - ## Metadata
