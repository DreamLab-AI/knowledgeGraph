...
```json-ld
{
  ...
  "relations": {
    ...
    "uses": [
      ...
      {"@id": "urn:ngm:class:sampling-strategy", "label": "Sampling Strategy"},
    ...
    "hasPart": [
      {"@id": "urn:ngm:class:logit-computation", "label": "Logit Computation"},
      {"@id": "urn:ngm:class:decoding-algorithm", "label": "Decoding Algorithm"}
    ],
    "enables": [
    ...
    "contrastsWith": [
      {"@id": "urn:ngm:class:encoder-model", "label": "Encoder Model"}
    ]
  },
  "sameAs": [],
  "quality": 0.62,
