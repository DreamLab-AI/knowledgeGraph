schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#ModelTraining
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:model-training
public:: true
...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:aisi-2024-approach-to-evaluations",
      "vc:label": "AISI 2024 Approach to Evaluations"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:alignment-layer",
      "vc:label": "AlignmentLayer"
    },
    {
      "@id": "urn:visionflow:linked:bai-et-al-2022-anthropic-rlhf-helpful-harmless",
      "vc:label": "Bai et al. 2022 Anthropic RLHF Helpful Harmless"
    },
    {
      "@id": "urn:visionflow:linked:bai-et-al-2022-constitutional-ai-rlaif",
      "vc:label": "Bai et al. 2022 Constitutional AI RLAIF"
    },
    {
      "@id": "urn:visionflow:linked:bommasani-et-al-2021-foundation-models-opportunities-and-risks",
      "vc:label": "Bommasani et al. 2021 Foundation Models Opportunities and Risks"
    },
    {
      "@id": "urn:visionflow:linked:brown-et-al-2020-gpt-3-few-shot-learners",
      "vc:label": "Brown et al. 2020 GPT-3 Few-Shot Learners"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:dao-et-al-2022-flash-attention-io-aware",
      "vc:label": "Dao et al. 2022 FlashAttention IO-Aware"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:deep-seek-ai-2024-deep-seek-v3-technical-report",
      "vc:label": "DeepSeek-AI 2024 DeepSeek-V3 Technical Report"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:dettmers-et-al-2024-qlo-ra",
    ...
    {
      "@id": "urn:visionflow:linked:ethayarajh-et-al-2024-kto-prospect-theoretic-optimisation",
      "vc:label": "Ethayarajh et al. 2024 KTO Prospect Theoretic Optimisation"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:hoffmann-et-al-2022-chinchilla-compute-optimal-training",
      "vc:label": "Hoffmann et al. 2022 Chinchilla Compute-Optimal Training"
    },
    {
      "@id": "urn:visionflow:linked:hu-et-al-2022-lo-ra-low-rank-adaptation",
      "vc:label": "Hu et al. 2022 LoRA Low-Rank Adaptation"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:kaplan-et-al-2020-scaling-laws-for-neural-language-models",
      "vc:label": "Kaplan et al. 2020 Scaling Laws for Neural Language Models"
    },
    {
      "@id": "urn:visionflow:linked:kirkpatrick-et-al-2017-ewc-overcoming-catastrophic-forgetting",
      "vc:label": "Kirkpatrick et al. 2017 EWC Overcoming Catastrophic Forgetting"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:liu-et-al-2024-do-ra-weight-decomposed-low-rank-adaptation",
      "vc:label": "Liu et al. 2024 DoRA Weight-Decomposed Low-Rank Adaptation"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:narayanan-et-al-2021-efficient-large-scale-lm-training-3-d-parallelism",
      "vc:label": "Narayanan et al. 2021 Efficient Large-Scale LM Training 3D Parallelism"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:penedo-et-al-2024-fine-web",
      "vc:label": "Penedo et al. 2024 FineWeb"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:rafailov-et-al-2023-dpo-direct-preference-optimisation",
      "vc:label": "Rafailov et al. 2023 DPO Direct Preference Optimisation"
    },
    {
      "@id": "urn:visionflow:linked:rajbhandari-et-al-2020-ze-ro-deep-speed",
      "vc:label": "Rajbhandari et al. 2020 ZeRO DeepSpeed"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:schwarz-et-al-2018-ewc-progress-and-compress",
      "vc:label": "Schwarz et al. 2018 EWC++ Progress and Compress"
    },
    {
      "@id": "urn:visionflow:linked:shoeybi-et-al-2019-megatron-lm-tensor-parallelism",
      "vc:label": "Shoeybi et al. 2019 Megatron-LM Tensor Parallelism"
    },
    {
      "@id": "urn:visionflow:linked:soldaini-et-al-2024-dolma",
      "vc:label": "Soldaini et al. 2024 Dolma"
    },
    {
      "@id": "urn:visionflow:linked:stiennon-et-al-2020-learning-to-summarise-with-human-feedback",
      "vc:label": "Stiennon et al. 2020 Learning to Summarise with Human Feedback"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:together-ai-2023-red-pajama",
      "vc:label": "Together AI 2023 RedPajama"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:zhao-et-al-2023-py-torch-fsdp",
      "vc:label": "Zhao et al. 2023 PyTorch FSDP"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-24c01ed7581a"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#ModelTraining"
    },
    {
    ...
    {
      "vc:key": "owl-class",
      "vc:value": "artificial-intelligence:ModelTraining"
    },
    {
      "vc:key": "preferred-term",
      "vc:value": "Model Training"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:model-training"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:model-training:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[AISI 2024 Approach to Evaluations]]",
      "resolved": "urn:visionflow:linked:aisi-2024-approach-to-evaluations",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[AlignmentLayer]]",
      "resolved": "urn:visionflow:linked:alignment-layer",
      "kind": "StubLink"
    },
    {
      "raw": "[[Bai et al. 2022 Anthropic RLHF Helpful Harmless]]",
      "resolved": "urn:visionflow:linked:bai-et-al-2022-anthropic-rlhf-helpful-harmless",
      "kind": "StubLink"
    },
    {
      "raw": "[[Bai et al. 2022 Constitutional AI RLAIF]]",
      "resolved": "urn:visionflow:linked:bai-et-al-2022-constitutional-ai-rlaif",
      "kind": "StubLink"
    },
    {
      "raw": "[[Bommasani et al. 2021 Foundation Models Opportunities and Risks]]",
      "resolved": "urn:visionflow:linked:bommasani-et-al-2021-foundation-models-opportunities-and-risks",
      "kind": "StubLink"
    },
    {
      "raw": "[[Brown et al. 2020 GPT-3 Few-Shot Learners]]",
      "resolved": "urn:visionflow:linked:brown-et-al-2020-gpt-3-few-shot-learners",
      "kind": "StubLink"
    },
    {
      "raw": "[[Causal Language Modelling]]",
      "resolved": "urn:visionflow:linked:causal-language-modelling",
      "kind": "StubLink"
    },
    {
      "raw": "[[Chinchilla Scaling Laws]]",
      "resolved": "urn:visionflow:linked:chinchilla-scaling-laws",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Dao et al. 2022 FlashAttention IO-Aware]]",
      "resolved": "urn:visionflow:linked:dao-et-al-2022-flash-attention-io-aware",
      "kind": "StubLink"
    },
    {
      "raw": "[[Data Curation]]",
    ...
    {
      "raw": "[[DeepSeek-AI 2024 DeepSeek-V3 Technical Report]]",
      "resolved": "urn:visionflow:linked:deep-seek-ai-2024-deep-seek-v3-technical-report",
      "kind": "StubLink"
    },
    {
      "raw": "[[DeepSpeed]]",
      "resolved": "urn:visionflow:linked:deep-speed",
      "kind": "StubLink"
    },
    {
      "raw": "[[Dettmers et al. 2024 QLoRA]]",
      "resolved": "urn:visionflow:linked:dettmers-et-al-2024-qlo-ra",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Emergent Capabilities]]",
      "resolved": "urn:visionflow:linked:emergent-capabilities",
      "kind": "StubLink"
    },
    {
      "raw": "[[Ethayarajh et al. 2024 KTO Prospect Theoretic Optimisation]]",
      "resolved": "urn:visionflow:linked:ethayarajh-et-al-2024-kto-prospect-theoretic-optimisation",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[GPU Clusters]]",
      "resolved": "urn:visionflow:linked:gpu-clusters",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Hoffmann et al. 2022 Chinchilla Compute-Optimal Training]]",
      "resolved": "urn:visionflow:linked:hoffmann-et-al-2022-chinchilla-compute-optimal-training",
      "kind": "StubLink"
    },
    {
      "raw": "[[Hu et al. 2022 LoRA Low-Rank Adaptation]]",
      "resolved": "urn:visionflow:linked:hu-et-al-2022-lo-ra-low-rank-adaptation",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Kaplan et al. 2020 Scaling Laws for Neural Language Models]]",
      "resolved": "urn:visionflow:linked:kaplan-et-al-2020-scaling-laws-for-neural-language-models",
      "kind": "StubLink"
    },
    {
      "raw": "[[Kirkpatrick et al. 2017 EWC Overcoming Catastrophic Forgetting]]",
      "resolved": "urn:visionflow:linked:kirkpatrick-et-al-2017-ewc-overcoming-catastrophic-forgetting",
      "kind": "StubLink"
    },
    {
      "raw": "[[KTO]]",
    ...
    {
      "raw": "[[Liu et al. 2024 DoRA Weight-Decomposed Low-Rank Adaptation]]",
      "resolved": "urn:visionflow:linked:liu-et-al-2024-do-ra-weight-decomposed-low-rank-adaptation",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Megatron-LM]]",
      "resolved": "urn:visionflow:linked:megatron-lm",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Narayanan et al. 2021 Efficient Large-Scale LM Training 3D Parallelism]]",
      "resolved": "urn:visionflow:linked:narayanan-et-al-2021-efficient-large-scale-lm-training-3-d-parallelism",
      "kind": "StubLink"
    },
    {
      "raw": "[[Neural Networks]]",
    ...
    },
    {
      ...
      "resolved": "urn:visionflow:linked:numerical-computation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Optimisation]]",
    ...
    {
      "raw": "[[Penedo et al. 2024 FineWeb]]",
      "resolved": "urn:visionflow:linked:penedo-et-al-2024-fine-web",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Policy Optimisation]]",
      "resolved": "urn:visionflow:linked:policy-optimisation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Probabilistic Graphical Models]]",
      "resolved": "urn:visionflow:linked:probabilistic-graphical-models",
      "kind": "StubLink"
    },
    {
      "raw": "[[PyTorch]]",
    ...
    {
      "raw": "[[Rafailov et al. 2023 DPO Direct Preference Optimisation]]",
      "resolved": "urn:visionflow:linked:rafailov-et-al-2023-dpo-direct-preference-optimisation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Rajbhandari et al. 2020 ZeRO DeepSpeed]]",
      "resolved": "urn:visionflow:linked:rajbhandari-et-al-2020-ze-ro-deep-speed",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Schwarz et al. 2018 EWC++ Progress and Compress]]",
      "resolved": "urn:visionflow:linked:schwarz-et-al-2018-ewc-progress-and-compress",
      "kind": "StubLink"
    },
    {
      "raw": "[[Shoeybi et al. 2019 Megatron-LM Tensor Parallelism]]",
      "resolved": "urn:visionflow:linked:shoeybi-et-al-2019-megatron-lm-tensor-parallelism",
      "kind": "StubLink"
    },
    {
      "raw": "[[Soldaini et al. 2024 Dolma]]",
      "resolved": "urn:visionflow:linked:soldaini-et-al-2024-dolma",
      "kind": "StubLink"
    },
    {
      "raw": "[[Stiennon et al. 2020 Learning to Summarise with Human Feedback]]",
      "resolved": "urn:visionflow:linked:stiennon-et-al-2020-learning-to-summarise-with-human-feedback",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Together AI 2023 RedPajama]]",
      "resolved": "urn:visionflow:linked:together-ai-2023-red-pajama",
      "kind": "StubLink"
    },
    {
      "raw": "[[Tokeniser]]",
    ...
    {
      "raw": "[[ZeRO Optimisation]]",
      "resolved": "urn:visionflow:linked:ze-ro-optimisation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Zhao et al. 2023 PyTorch FSDP]]",
      "resolved": "urn:visionflow:linked:zhao-et-al-2023-py-torch-fsdp",
      "kind": "StubLink"
    },
    {
      "raw": "[[Active Learning]]",
...
- ### Definition
  - Model Training is the end-to-end computational process by which a neural network's parameters are iteratively adjusted through gradient-based optimisation over large corpora so that the network acquires generalisable representations, task-specific capabilities, and aligned behavioural policies suitable for deployment. For contemporary foundation models — autoregressive transformer decoders ranging from 1B to 671B parameters — the process is stratified into four principal phases: (1) pre-training on self-supervised objectives across 8T–15T tokens of curated web, code, and document data using the causal language modelling (CLM) loss L = −(1/T) Σₜ log P_θ(xₜ|x₁,...,xₜ₋₁); (2) supervised fine-tuning (SFT) on 10K–1M high-quality instruction–response pairs applying the CLM loss only over response tokens; (3) preference alignment via reinforcement learning from human feedback (RLHF) with proximal policy optimisation (PPO) maximising a scalar reward model while penalising KL-divergence from the SFT reference policy J(θ) = E[R_φ(x,y)] − β·KL(π_θ‖π_ref), or via the simpler direct preference optimisation (DPO, Rafailov et al. 2023) which elides the explicit reward model by re-parameterising the optimal policy in closed form as a contrastive cross-entropy loss over (prompt, chosen, rejected) triplets; and (4) iterative self-improvement via reinforcement learning from AI feedback (RLAIF) and Constitutional AI (Bai et al. 2022) generating synthetic preference data at scale. Scaling behaviour is governed by the Chinchilla compute-optimal allocation (Hoffmann et al. 2022) establishing N* ≈ D*/20 — approximately 20 training tokens per parameter — overturning earlier heuristics that over-parameterised models relative to their datasets. Distributed training co-ordinates three parallelism axes across 1K–16K accelerators: data parallelism with ZeRO-1/2/3 gradient and parameter sharding (DeepSpeed), tensor/model parallelism via intra-layer matrix column/row splitting (Megatron-LM), and pipeline parallelism via 1F1B scheduling across transformer layer stages. Data quality has become the dominant training variable: pipelines such as FineWeb (15T tokens, 2024), Dolma v1.7 (3T tokens), and RedPajama-V2 (30T raw, 52B filtered) apply multi-stage MinHash deduplication, neural quality classifiers, perplexity filtering, and domain upsampling. Advanced training regimes address catastrophic forgetting via Elastic Weight Consolidation (EWC++, Fisher information regularisation) and curriculum learning schedules sequencing data by difficulty or domain. The 2025–2026 frontier includes Llama 3.1 405B (15T tokens, 16,384 H100s), DeepSeek-V3 (671B MoE, 14.8T tokens, $5.576M compute), and Mistral Large 2 (123B), with post-training alignment stacks combining SFT, DPO, rejection sampling fine-tuning, and RLAIF achieving MMLU 88%+, MATH 71%+, and HumanEval 90%+ benchmark performance.

- ### Semantic Classification
  - owl-class:: artificial-intelligence:ModelTraining
  - owl-role:: ComputationalProcess
  - owl-inferred:: ai:MachineLearning, ai:DeepLearning, ai:FoundationModelDevelopment, ai:AlignmentResearch
  - belongs-to-domain:: [[AI-GroundedDomain]], [[MachineLearningDomain]], [[ComputationAndIntelligenceDomain]], [[DistributedSystemsDomain]]
...
- ### Content
  ...
  ## Compositional Relationships (Components)
	  ...
	  FunctionalDataProperty(ai:chinchillaOptimalTokensPerParam)
  ...
  - ### Research and Literature
	  ...
	  **Foundational Architecture and Objectives**:
	  ...
	  1. Vaswani, A., Shazeer, N., Parmar, N., Uszkoreit, J., Jones, L., Gomez, A. N., Kaiser, L., & Polosukhin, I. (2017). Attention is all you need. *Advances in Neural Information Processing Systems*, 30, 5998–6008. arXiv:1706.03762. [Transformer architecture enabling scalable parallelisable training]

	  2. Brown, T. B., Mann, B., Ryder, N., Subbiah, M., Kaplan, J., Dhariwal, P., Neelakantan, A., Shyam, P., Sastry, G., Askell, A., ... & Amodei, D. (2020). Language models are few-shot learners. *NeurIPS 2020*, 33, 1877–1901. arXiv:2005.14165. [GPT-3; emergent in-context learning; scaling baseline]

	  3. Kaplan, J., McCandlish, S., Henighan, T., Brown, T. B., Chess, B., Child, R., Gray, S., Radford, A., Wu, J., & Amodei, D. (2020). Scaling laws for neural language models. arXiv:2001.08361. [Power-law scaling; optimal allocation heuristics preceding Chinchilla]

	  4. Hoffmann, J., Borgeaud, S., Mensch, A., Buchatskaya, E., Cai, T., Rutherford, E., de las Casas, D., Hendricks, L. A., Welbl, J., Clark, A., ... & Sifre, L. (2022). Training compute-optimal large language models (Chinchilla). *NeurIPS 2022*, 35, 30016–30030. arXiv:2203.15556. [Chinchilla: N* ≈ D*/20; compute-optimal allocation; overturns GPT-3 scaling practices]

	  **Alignment — RLHF, DPO, RLAIF**:

	  5. Stiennon, N., Ouyang, L., Wu, J., Ziegler, D. M., Lowe, R., Voss, C., Radford, A., Amodei, D., & Christiano, P. (2020). Learning to summarise with human feedback. *NeurIPS 2020*. arXiv:2009.01325. [First RLHF at scale; PPO reward model training]

	  6. Ouyang, L., Wu, J., Jiang, X., Almeida, D., Wainwright, C. L., Mishkin, P., Zhang, C., Agarwal, S., Slama, K., Ray, A., ... & Lowe, R. (2022). Training language models to follow instructions with human feedback. *NeurIPS 2022*. arXiv:2203.02155. [InstructGPT; RLHF with PPO; KL-penalised objective; annotation protocol]

	  7. Bai, Y., Jones, A., Ndousse, K., Askell, A., Chen, A., DasSarma, N., Drain, D., Fort, S., Ganguli, D., Henighan, T., ... & Kaplan, J. (2022). Training a helpful and harmless assistant with reinforcement learning from human feedback. arXiv:2204.05862. [Anthropic RLHF; helpfulness vs harmlessness tradeoff]

	  8. Bai, Y., Kadavath, S., Kundu, S., Askell, A., Kernion, J., Jones, A., Chen, A., Goldie, A., Mirhoseini, A., McKinnon, C., ... & Clark, J. (2022). Constitutional AI: Harmlessness from AI feedback. arXiv:2212.08073. [RLAIF; Constitutional AI; synthetic preference data; scalable alignment]

	  9. Rafailov, R., Sharma, A., Mitchell, E., Manning, C. D., Ermon, S., & Finn, C. (2023). Direct preference optimization: Your language model is secretly a reward model. *NeurIPS 2023*. arXiv:2305.18290. [DPO closed-form RLHF; Bradley-Terry reparameterisation; eliminates reward model]

	  10. Ethayarajh, K., Xu, W., Muennighoff, N., Jurafsky, D., & Kiela, D. (2024). KTO: Model alignment as prospect theoretic optimization. *ICML 2024*. arXiv:2402.01306. [KTO; binary feedback; loss-aversion objective; cheaper preference annotation]

	  **Distributed Training**:

	  11. Shoeybi, M., Patwary, M., Puri, R., LeGresley, P., Casper, J., & Catanzaro, B. (2019). Megatron-LM: Training multi-billion parameter language models using model parallelism. arXiv:1909.08053. [Tensor parallelism; column/row-wise MLP and attention splitting]

	  12. Rajbhandari, S., Rasley, J., Ruwase, O., & He, Y. (2020). ZeRO: Memory optimizations toward training trillion parameter models. *SC 2020*. arXiv:2003.03514. [ZeRO-1/2/3 sharding; DeepSpeed; per-device memory reduction N_d×]
	  ...
	  14. Zhao, Y., Gu, A., Varma, R., Luo, L., Huang, C.-C., Xu, M., Wright, L., Shojanazeri, H., Ott, M., Shleifer, S., ... & Chintala, S. (2023). PyTorch FSDP: Experiences on scaling fully sharded data parallel. *VLDB 2023*. arXiv:2304.11277. [FSDP; PyTorch-native ZeRO-3; async checkpointing; activation offloading]

	  **Flash Attention**:

	  15. Dao, T., Fu, D. Y., Ermon, S., Rudra, A., & Ré, C. (2022). FlashAttention: Fast and memory-efficient exact attention with IO-awareness. *NeurIPS 2022*. arXiv:2205.14135. [O(N) memory attention via tiled SRAM; 2–4× training speedup]

	  16. Dao, T. (2023). FlashAttention-2: Faster attention with better parallelism and work partitioning. *ICLR 2024*. arXiv:2307.08691. [2× throughput over FA1; improved causal masking; MFU 72% on A100]

	  **Data Curation**:

	  17. Penedo, G., Kydlíček, H., allal, L. B., Lozhkov, A., Mitchell, M., Raffel, C., Perez, L., & Wolf, T. (2024). FineWeb: Decanting the web for the finest text data at scale. arXiv:2406.17557. [FineWeb 15T tokens; FineWeb-Edu 1.3T; educational quality classifier; MMLU gains]

	  18. Soldaini, L., Kinney, R., Bhagia, A., Schwenk, D., Atkinson, D., Authur, R., Chandu, K., Magnusson, I., Morrison, J., Li, D., ... & Smith, N. A. (2024). Dolma: An open corpus of three trillion tokens for language model pretraining research. arXiv:2402.00159. [Dolma v1.7; open pipeline; OLMo training; fully reproducible]

	  19. Together AI (2023). RedPajama: An open dataset for training large language models. https://github.com/togethercomputer/RedPajama-Data. GitHub repository. [RedPajama-V2; 30T raw; 46 quality signals; configurable curation]

	  **Parameter-Efficient Fine-Tuning**:

	  20. Hu, E. J., Shen, Y., Wallis, P., Allen-Zhu, Z., Li, Y., Wang, S., Wang, L., & Chen, W. (2022). LoRA: Low-rank adaptation of large language models. *ICLR 2022*. arXiv:2106.09685. [LoRA; ΔW=BA rank-r decomposition; 10,000× parameter reduction; weight merging]

	  21. Dettmers, T., Pagnoni, A., Holtzman, A., & Zettlemoyer, L. (2024). QLoRA: Efficient finetuning of quantised LLMs. *NeurIPS 2023*. arXiv:2305.14314. [QLoRA; NF4 4-bit quantisation + LoRA; single-GPU 70B fine-tuning]

	  22. Liu, S., Wang, H., Yin, W., Molchanov, P., Wang, Z., Cheng, Y., & Kautz, J. (2024). DoRA: Weight-decomposed low-rank adaptation. *ICML 2024*. arXiv:2402.09353. [DoRA; magnitude + direction decomposition; consistently outperforms LoRA]

	  **Frontier Model Technical Reports**:

	  23. Meta AI (2024). The Llama 3 herd of models. arXiv:2407.21783. [405B dense; 15T tokens; 16,384 H100s; SFT+DPO+RLHF+rejection sampling post-training pipeline]

	  24. DeepSeek-AI (2024). DeepSeek-V3 technical report. arXiv:2412.19437. [671B MoE/37B active; 14.8T tokens; $5.576M training; multi-head latent attention; multi-token prediction]

	  **Continual Learning and Forgetting**:

	  25. Kirkpatrick, J., Pascanu, R., Rabinowitz, N., Veness, J., Desjardins, G., Rusu, A. A., Milan, K., Quan, J., Ramalho, T., Grabska-Barwinska, A., ... & Hadsell, R. (2017). Overcoming catastrophic forgetting in neural networks. *PNAS*, 114(13), 3521–3526. DOI:10.1073/pnas.1611835114. [EWC; Fisher information regularisation]

	  26. Schwarz, J., Czarnecki, W., Luketina, J., Grabska-Barwinska, A., Teh, Y. W., Pascanu, R., & Hadsell, R. (2018). Progress and compress: A scalable framework for continual learning. *ICML 2018*. arXiv:1805.06370. [EWC++; online Fisher approximation; multi-task continual learning]

	  **Safety and Governance**:

	  27. AISI (2024). AISI approach to evaluations. AI Safety Institute, UK DSIT. https://www.gov.uk/government/organisations/ai-safety-institute. [Pre-deployment dangerous capability evaluations; frontier AI safety framework]

	  28. Bommasani, R., Hudson, D. A., Aditi, E., Altman, R., Arora, S., Bernstein, S., Bohg, J., Bosselut, A., Brunskill, E., Brynjolfsson, E., ... & Liang, P. (2021). On the opportunities and risks of foundation models. arXiv:2108.07258. [Foundation model training risks; emergent capabilities taxonomy; homogenisation]
...
- ### Provenance
  - sources:: [[Vaswani et al. 2017 Attention is All You Need]], [[Brown et al. 2020 GPT-3 Few-Shot Learners]], [[Kaplan et al. 2020 Scaling Laws for Neural Language Models]], [[Hoffmann et al. 2022 Chinchilla Compute-Optimal Training]], [[Stiennon et al. 2020 Learning to Summarise with Human Feedback]], [[Ouyang et al. 2022 InstructGPT RLHF]], [[Bai et al. 2022 Anthropic RLHF Helpful Harmless]], [[Bai et al. 2022 Constitutional AI RLAIF]], [[Rafailov et al. 2023 DPO Direct Preference Optimisation]], [[Ethayarajh et al. 2024 KTO Prospect Theoretic Optimisation]], [[Shoeybi et al. 2019 Megatron-LM Tensor Parallelism]], [[Rajbhandari et al. 2020 ZeRO DeepSpeed]], [[Narayanan et al. 2021 Efficient Large-Scale LM Training 3D Parallelism]], [[Zhao et al. 2023 PyTorch FSDP]], [[Dao et al. 2022 FlashAttention IO-Aware]], [[Dao 2023 FlashAttention-2]], [[Penedo et al. 2024 FineWeb]], [[Soldaini et al. 2024 Dolma]], [[Together AI 2023 RedPajama]], [[Hu et al. 2022 LoRA Low-Rank Adaptation]], [[Dettmers et al. 2024 QLoRA]], [[Liu et al. 2024 DoRA Weight-Decomposed Low-Rank Adaptation]], [[Meta AI 2024 Llama 3 Herd of Models]], [[DeepSeek-AI 2024 DeepSeek-V3 Technical Report]], [[Kirkpatrick et al. 2017 EWC Overcoming Catastrophic Forgetting]], [[Schwarz et al. 2018 EWC++ Progress and Compress]], [[AISI 2024 Approach to Evaluations]], [[Bommasani et al. 2021 Foundation Models Opportunities and Risks]]
