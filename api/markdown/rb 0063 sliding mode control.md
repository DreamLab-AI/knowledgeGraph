schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/robotics#Rb0063SlidingModeControl
legacy_uri:: urn:visionclaw:concept:robotics:rb-0063-sliding-mode-control
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-f44713affef2"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/robotics#Rb0063SlidingModeControl"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:robotics:rb-0063-sliding-mode-control"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
