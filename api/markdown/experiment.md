schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#Experiment
legacy_uri:: urn:visionclaw:concept:infrastructure:experiment
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-1821c2e70bd0"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#Experiment"
    },
    {
      "vc:key": "maturity",
      "vc:value": "draft"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:experiment"
    },
    {
      "vc:key": "status",
      "vc:value": "stub"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:9d0d02f40c51decd1b3aca829eaf592949ff7d69e99f0348aafdbcbb96528d69@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:experiment",
  "@type": "OntologyClass",
  "label": "experiment",
  "subClassOf": [
    {
