schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#EdgeAIAccelerator
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:edge-ai-accelerator
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-09612ff8218d"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#EdgeAIAccelerator"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:edge-ai-accelerator"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
