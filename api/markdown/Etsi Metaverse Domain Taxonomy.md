schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#EtsiMetaverseDomainTaxonomy
legacy_uri:: urn:visionclaw:concept:spatial-computing:etsi-metaverse-domain-taxonomy
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-bf1fd3f1c4fa"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#EtsiMetaverseDomainTaxonomy"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:etsi-metaverse-domain-taxonomy"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
