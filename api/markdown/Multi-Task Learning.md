- ### OntologyBlock
  ...
  collapsed:: true
	...
	- source-domain:: ai
	- owl:class:: ai:MultiTaskLearning
	- status:: draft
	- public-access:: true
...
Multi Task Learning refers to a machine learning paradigm where a model is trained simultaneously on multiple related tasks, sharing representations across tasks to improve generalization and efficiency. multi-task learning leverages task relatedness to learn better features than training on each task independently.
