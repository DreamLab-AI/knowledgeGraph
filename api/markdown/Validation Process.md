schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#ValidationProcess
legacy_uri:: urn:visionclaw:concept:spatial-computing:validation-process
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-252f3afee2f0"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#ValidationProcess"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:validation-process"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
