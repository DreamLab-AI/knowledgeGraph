schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#StateSynchronization
legacy_uri:: urn:visionclaw:concept:spatial-computing:state-synchronization
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-7f55dd8ecd01"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#StateSynchronization"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:state-synchronization"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
