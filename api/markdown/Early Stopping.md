...
```clojure
(Declaration (Class :EarlyStopping))
(AnnotationAssertion rdfs:label :EarlyStopping "Early Stopping"@en)
(AnnotationAssertion rdfs:comment :EarlyStopping
  "Regularisation technique that terminates training when validation performance stops improving to prevent overfitting."@en)

;; Taxonomic relationships
(SubClassOf :EarlyStopping :RegularisationTechnique)
(SubClassOf :EarlyStopping :TrainingStrategy)

;; Monitoring
(SubClassOf :EarlyStopping
  (ObjectSomeValuesFrom :monitors :ValidationPerformance))
(SubClassOf :EarlyStopping
  (ObjectSomeValuesFrom :requires :ValidationSet))

;; Prevention target
(SubClassOf :EarlyStopping
  (ObjectSomeValuesFrom :prevents :Overfitting))
(SubClassOf :EarlyStopping
  (ObjectSomeValuesFrom :prevents :Overtraining))

;; Balances
(SubClassOf :EarlyStopping
  (ObjectSomeValuesFrom :balances :TrainingProgress))
(SubClassOf :EarlyStopping
  (ObjectSomeValuesFrom :balances :Generalisation))

;; Properties
(DataPropertyAssertion :isSimple :EarlyStopping "true"^^xsd:boolean)
(DataPropertyAssertion :isEffective :EarlyStopping "true"^^xsd:boolean)
(DataPropertyAssertion :requiresValidationSet :EarlyStopping "true"^^xsd:boolean)
(DataPropertyAssertion :usesPatienceParameter :EarlyStopping "often"^^xsd:string)
(DataPropertyAssertion :restoresBestCheckpoint :EarlyStopping "true"^^xsd:boolean)
```
