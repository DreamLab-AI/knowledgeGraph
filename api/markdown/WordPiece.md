schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#Wordpiece
legacy_uri:: urn:visionclaw:concept:spatial-computing:wordpiece
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-db326effa3e8"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#Wordpiece"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:wordpiece"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:a691504c2243eb11afd12fa69ef514eda658373823208bc72d45b18472cefa39@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:word-piece",
  "@type": "OntologyClass",
  "label": "WordPiece",
  "subClassOf": [
    {
