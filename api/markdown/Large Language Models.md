schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#LargeLanguageModels
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:large-language-models
public:: true
...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:open-ai-research",
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-14bfda39bb61"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#LargeLanguageModels"
    },
    {
    ...
    },
    {
      ...
      "vc:value": "Large Language Models"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:large-language-models"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:large-language-models:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[L402 Payment Protocol]]",
      "resolved": "urn:visionflow:linked:l402-payment-protocol",
      "kind": "StubLink"
    },
    {
      "raw": "[[Large-Scale Datasets]]",
      "resolved": "urn:visionflow:linked:large-scale-datasets",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[OpenAI Research]]",
      "resolved": "urn:visionflow:linked:open-ai-research",
      "kind": "StubLink"
    },
    {
    ...
    },
    {
      ...
      "resolved": "urn:visionflow:owl:class:model-parameters",
      "kind": "ResolvedLink"
    },
    {
...
- ### Relationships
  ...
  - bridges-to:: [[L402 Payment Protocol]] (domain: bitcoin - for AI service micropayments), [[Lightning Network]] (domain: bitcoin - for LLM API payment channels), [[Autonomous Economic Agents]] (domain: bitcoin - for AI-powered bitcoin agents), [[Smart Contract]] (domain: blockchain - for AI model governance)

- ### Content
  Large Language Models — content pending enrichment.

- ### Provenance
  - sources:: [[OpenAI Research]], [[Google DeepMind]], [[Anthropic]], [[Meta AI Research]], [[NIST AI Standards]]
