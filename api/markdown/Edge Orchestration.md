schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#EdgeOrchestration
legacy_uri:: urn:visionclaw:concept:spatial-computing:edge-orchestration
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-c591bf73f605"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#EdgeOrchestration"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:edge-orchestration"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:ac869f46b9747cb7a1bb8a8f3ca061b1234488c858288aae963e3e0693245e5a@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
