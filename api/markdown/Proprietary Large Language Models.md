schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#ProprietaryLargeLanguageModels
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:proprietary-large-language-models
public:: true
...
```json-ld
{
  ...
  "@id": "urn:visionflow:page:4b098d935b6429a80bc28a867810b83990a70d80d3cd80d2d5d71e9ba03441f3",
  "@type": "Page",
  "vc:slug": "proprietary-large-language-models",
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:enterprise-integration-layer",
      "vc:label": "EnterpriseIntegrationLayer"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:human-feedback-data",
      "vc:label": "Human Feedback Data"
    },
    {
      "@id": "urn:visionflow:linked:inference-apilayer",
      "vc:label": "InferenceAPILayer"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:product-layer",
      "vc:label": "ProductLayer"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:safety-testing",
      "vc:label": "Safety Testing"
    },
    {
      "@id": "urn:visionflow:linked:self-hosted-ai",
      "vc:label": "Self Hosted AI"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-e802007b6db9"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#ProprietaryLargeLanguageModels"
    },
    {
    ...
    },
    {
      ...
      "vc:value": "Proprietary Large Language Models"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:proprietary-large-language-models"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:4b098d935b6429a80bc28a867810b83990a70d80d3cd80d2d5d71e9ba03441f3@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:proprietary-large-language-models:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[EnterpriseIntegrationLayer]]",
      "resolved": "urn:visionflow:linked:enterprise-integration-layer",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Human Feedback Data]]",
      "resolved": "urn:visionflow:linked:human-feedback-data",
      "kind": "StubLink"
    },
    {
      "raw": "[[InferenceAPILayer]]",
      "resolved": "urn:visionflow:linked:inference-apilayer",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[ProductLayer]]",
      "resolved": "urn:visionflow:linked:product-layer",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Safety Testing]]",
      "resolved": "urn:visionflow:linked:safety-testing",
      "kind": "StubLink"
    },
    {
      "raw": "[[Self Hosted AI]]",
      "resolved": "urn:visionflow:linked:self-hosted-ai",
      "kind": "StubLink"
    },
    {
      "raw": "[[System Prompt]]",
...
- ### Semantic Classification
  - owl-class:: artificial-intelligence:ProprietaryLargeLanguageModels
  - owl-role:: FoundationModelCategory
  - owl-inferred:: ai:LanguageModel, ai:CommercialAIProduct, ai:ClosedWeightModel, ai:TransformerModel, ai:AlignedAISystem
  - belongs-to-domain:: [[AI-GroundedDomain]], [[NaturalLanguageProcessingDomain]], [[CommercialAIDomain]], [[FoundationModelDomain]]
...
- ### Content
  ...
  ## Compositional Relationships (Components)
    SubClassOf(ai:ProprietaryLargeLanguageModels
      ObjectSomeValuesFrom(ai:hasPart ai:TransformerArchitecture))
    SubClassOf(ai:ProprietaryLargeLanguageModels
      ObjectSomeValuesFrom(ai:hasPart ai:RLHFPipeline))
    SubClassOf(ai:ProprietaryLargeLanguageModels
      ObjectSomeValuesFrom(ai:hasPart ai:ConstitutionalAILayer))
    SubClassOf(ai:ProprietaryLargeLanguageModels
      ObjectSomeValuesFrom(ai:hasPart ai:SafetyEvaluationSuite))
    SubClassOf(ai:ProprietaryLargeLanguageModels
    ...
    SubClassOf(ai:ProprietaryLargeLanguageModels
      ObjectSomeValuesFrom(ai:enables ai:LongContextProcessing))
    SubClassOf(ai:ProprietaryLargeLanguageModels
      ObjectSomeValuesFrom(ai:supports ai:CustomerServiceAutomation))
    SubClassOf(ai:ProprietaryLargeLanguageModels
      ObjectSomeValuesFrom(ai:supports ai:CodeGeneration))
    SubClassOf(ai:ProprietaryLargeLanguageModels
      ObjectSomeValuesFrom(ai:supports ai:ScientificResearchAssistance))
    SubClassOf(ai:ProprietaryLargeLanguageModels
      ObjectSomeValuesFrom(ai:supports ai:LegalDocumentAnalysis))
    SubClassOf(ai:ProprietaryLargeLanguageModels
      ObjectSomeValuesFrom(ai:supports ai:FinancialRegulatoryCompliance))
    ...
    SubClassOf(ai:ProprietaryLargeLanguageModels
      ObjectSomeValuesFrom(ai:uses ai:ScaledDotProductAttention))
    SubClassOf(ai:ProprietaryLargeLanguageModels
      ObjectSomeValuesFrom(ai:uses ai:BPETokenisation))
    SubClassOf(ai:ProprietaryLargeLanguageModels
    ...
    SubClassOf(ai:ProprietaryLargeLanguageModels
      ObjectSomeValuesFrom(ai:reduces ai:KnowledgeWorkerLatency))
    SubClassOf(ai:ProprietaryLargeLanguageModels
      ObjectSomeValuesFrom(ai:reduces ai:SoftwareDevelopmentCycle))
    SubClassOf(ai:ProprietaryLargeLanguageModels
      ObjectSomeValuesFrom(ai:reduces ai:ContentProductionCost))
    SubClassOf(ai:ProprietaryLargeLanguageModels
      ObjectSomeValuesFrom(ai:reduces ai:CustomerSupportHeadcount))
    SubClassOf(ai:ProprietaryLargeLanguageModels
      ObjectSomeValuesFrom(ai:reduces ai:ResearchIterationTime))
  ...
  - The total addressable market for PLLM API services was estimated at $28B in 2025, projected to $105B by 2030 (Stanford HAI AI Index 2026), though deflationary pricing pressure from open-weight competition may compress these projections substantially.
  ...
  - **GPT-4o (May 2024)**: Natively multimodal with real-time audio — processes and generates text, audio, images simultaneously. Achieves GPT-4-class text performance at 2× speed and 50% cost reduction ($5/1M input vs $10). Mean latency 320ms. Real-time audio I/O enables emotionally aware voice interaction with interruption handling. Context 128K. Powers ChatGPT's paid tier (estimated 175M weekly active users, Q4 2025).
  ...
  - Four tiers: **Nova Micro** (text-only, ultra-low latency, 128K context, $0.035/1M input); **Nova Lite** (multimodal text+image, 300K context, $0.06/1M); **Nova Pro** (frontier multimodal with video understanding, 300K context, $0.80/1M); **Nova Premier** (frontier reasoning with extended thinking, announced Q1 2025).
  ...
  - **API pricing (input/output per 1M tokens, USD, Q2 2026 approximate)**: GPT-4.1 $2/$8; Claude 4 Sonnet $3/$15; Claude 4 Opus $15/$75; Gemini 2.5 Pro $1.25/$10; Gemini 2.0 Flash $0.10/$0.40; Grok 3 $3/$15; Mistral Large 2 $2/$6; Command R+ $1/$2; Nova Pro $0.80/$3.20; GPT-4o-mini $0.15/$0.60; Claude Haiku $0.25/$1.25.
  ...
  - **The API pricing deflation curve**: From GPT-3's original $0.02/1K tokens (June 2020) to GPT-4-Turbo's $0.01/1K input (November 2023) to GPT-4o's $0.005/1K input (May 2024) to GPT-4.1's $0.002/1K input (April 2025) — a 10× price reduction over 5 years at the frontier tier whilst capability increased by a factor estimated at 100–1000× on coding and reasoning benchmarks. The average PLLM API price deflated 65% between 2023 and 2025 (Stanford HAI AI Index 2025).
  - **Unit economics**: The cost of a GPT-4o-class query in 2026 ($0.000005 for a 1K token prompt) has fallen below the unit economics of many traditional software operations, enabling economic viability of AI-augmented workflows that would have been cost-prohibitive in 2023. For context, 1M GPT-4o queries cost approximately $5K in 2026, equivalent to 2 hours of a skilled knowledge worker's time.
  ...
  - **Venture and strategic investment landscape**: Total investment in PLLM companies through 2025 — OpenAI $16B+ (Microsoft $13B, SoftBank $1.5B, Thrive Capital $1B+); Anthropic $12B+ (Amazon $4B, Google $3B+, Spark Capital, General Catalyst); xAI $6B Series B (May 2024); Mistral €1.1B total across rounds; Cohere $450M. The aggregate capital invested in frontier PLLM companies exceeds $40B USD, representing the largest concentration of private equity in any single technology category in history. Return profiles remain uncertain given the structural difficulty of sustainable margins in an increasingly commoditised API market.
  ...
  - ## Metadata
  - **domain-correction**: None required. Frontmatter `domain:: artificial-intelligence` is correct; `iri::` namespace updated from generic `ontology#` to `artificial-intelligence#` for consistency with Active Learning.md, GANs.md, Llama 3.md precedent.
  - **legacy-term-id assigned**: AI-2055 (sequential from Llama 3 AI-2031).
...
- ### Provenance
  - sources:: GPT-4 Technical Report (OpenAI 2023, arXiv:2303.08774); Claude 3 Model Card (Anthropic March 2024); Claude 4 Model Card (Anthropic May 2025); Gemini Technical Report (Team Google 2023/2024, arXiv:2312.11805); Gemini 1.5 Report (Reid et al. 2024, arXiv:2403.05530); o1 System Card (OpenAI Sept 2024); o3 Technical Briefing (OpenAI Dec 2024); Constitutional AI (Bai et al. 2022, arXiv:2212.08073); RLHF Constitutional AI (Bai et al. 2023, arXiv:2204.05862); Sleeper Agents (Hubinger et al. 2024, arXiv:2401.05566); LMSYS Chatbot Arena (Zheng et al. 2023; ongoing 2024-2026); Stanford HAI AI Index 2024/2025/2026; UK AISI Frontier Model Evaluations TR-2024-003/007/012; Scaling Laws (Kaplan et al. 2020, arXiv:2001.08361); Chinchilla Scaling (Hoffmann et al. 2022, arXiv:2203.15556); InstructGPT/RLHF (Ouyang et al. 2022, arXiv:2203.02155); DPO (Rafailov et al. 2023, arXiv:2305.18290); Foundation Models (Bommasani et al. 2021, arXiv:2108.07258); DeepSeek-V3/R1 (2025); Command R+ (Cohere 2024); Grok-1 (xAI 2024); Lost in the Middle (Liu et al. 2023, arXiv:2307.03172); Stratechery analysis (Thompson 2024); CMA Foundation Models Report (2024); The Coming Wave (Suleyman 2023).
