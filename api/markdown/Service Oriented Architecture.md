schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#ServiceOrientedArchitecture
legacy_uri:: urn:visionclaw:concept:spatial-computing:service-oriented-architecture
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-af813ee6a5e9"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#ServiceOrientedArchitecture"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:service-oriented-architecture"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:d2c50d9841a2e89d04a783705f5fe0901190e2de32e207602d36fc0ef5168cd6@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
