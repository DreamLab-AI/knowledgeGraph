...
- ### Content
  ...
  - **University of Cambridge / Machine Intelligence Lab**: Cambridge MIL (Prof. Roberto Cipolla) contributed early work on real-time semantic segmentation for autonomous vehicles (SegNet, Badrinarayanan et al. TPAMI 2017) and continues work on uncertainty quantification in dense prediction for safety-critical applications. SegNet's encoder-decoder architecture with max-pooling [private] reuse remains a lightweight baseline.
  ...
  - Badrinarayanan, V., Kendall, A., Cipolla, R. (2017). **SegNet: A Deep Convolutional Encoder-Decoder Architecture for Image Segmentation**. TPAMI. Lightweight architecture with max-pooling [private] reuse; Cambridge MIL contribution.
