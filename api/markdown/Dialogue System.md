schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#DialogueSystem
legacy_uri:: urn:visionclaw:concept:spatial-computing:dialogue-system
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-cf29e75509c0"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#DialogueSystem"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:dialogue-system"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
