...
```json-ld
{
  ...
  "relations": {
    "hasPart": [
      ...
      {
        "@id": "urn:ngm:class:task-allocation-mechanism",
        "label": "Task Allocation Mechanism"
      },
      {
  ...
  "sameAs": [
    {
      "@id": "urn:ngm:class:multi-agent-robotics",
      "label": "Multi-Agent Robotics"
    },
    {
      "@id": "urn:ngm:class:robot-team",
      "label": "Robot Team"
    }
  ],
  "provenance": {
