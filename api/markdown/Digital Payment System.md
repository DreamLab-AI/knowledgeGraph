schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#DigitalPaymentSystem
legacy_uri:: urn:visionclaw:concept:spatial-computing:digital-payment-system
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-110a6592a9e9"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#DigitalPaymentSystem"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:digital-payment-system"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
