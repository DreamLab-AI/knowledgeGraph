  ...
  collapsed:: true
	...
	- #### Relationships
	  ...
	  collapsed:: true
		...
		- is-part-of:: [[Knowledge Management System]]
		- is-part-of:: [[Semantic Web Infrastructure]]
		- has-part:: [[Semantic Property]]
		- has-part:: [[Entity Node]]
		- has-part:: [[Relationship Edge]]
		- has-part:: [[Inference Engine]]
		- has-part:: [[Ontology Schema]]
		- requires:: [[Schema Definition]]
		- requires:: [[Ontology]]
		- requires:: [[Graph Database]]
		- requires:: [[Triple Store]]
		...
		- depends-on:: [[SPARQL Query Engine]]
		- depends-on:: [[Reasoning Service]]
		- depends-on:: [[RDF Framework]]
