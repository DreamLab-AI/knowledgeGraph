...
```json-ld
{
  ...
  "relations": {
    "hasPart": [
      {"@id": "urn:ngm:class:h-264", "label": "H.264"},
      {"@id": "urn:ngm:class:h-265", "label": "H.265"},
      {"@id": "urn:ngm:class:x-509", "label": "X.509"},
      {"@id": "urn:ngm:class:g-711", "label": "G.711"}
    ],
    "implements": [
      {"@id": "urn:ngm:class:telecommunications-standard", "label": "Telecommunications Standard"},
    ...
    "requires": [
      {"@id": "urn:ngm:class:member-state-consensus", "label": "Member State Consensus"},
      {"@id": "urn:ngm:class:study-group", "label": "Study Group"}
    ],
    "enables": [
      {"@id": "urn:ngm:class:telecommunications-interoperability", "label": "Telecommunications Interoperability"},
    ...
    "supports": [
      ...
      {"@id": "urn:ngm:class:iptv", "label": "IPTV"}
    ],
    "contrastsWith": [
  ...
  "sameAs": [
    {"@id": "urn:ngm:class:international-telecommunication-union-t", "label": "International Telecommunication Union - Telecommunication Standardization Sector"}
  ],
  "quality": 0.72,
  "provenance": {
