schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#ProceduralContentGeneration
legacy_uri:: urn:visionclaw:concept:spatial-computing:procedural-content-generation
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-256093530d76"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#ProceduralContentGeneration"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:procedural-content-generation"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
