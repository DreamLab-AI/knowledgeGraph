...
(SubClassOf :AiOperator
  (ObjectSomeValuesFrom :relatedTo :AiMonitoring))
(SubClassOf :AiOperator
  (ObjectSomeValuesFrom :relatedTo :Humanintheloop))

;; Data Properties
(AnnotationAssertion dcterms:identifier :AiOperator "AI-0098"^^xsd:string)
(DataPropertyAssertion :isAITechnology :AiOperator "true"^^xsd:boolean)
```
