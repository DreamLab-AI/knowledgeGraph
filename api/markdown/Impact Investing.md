...
```json-ld
{
  ...
  "@id": "urn:visionflow:page:impact-investing",
  "@type": "Page",
  "vc:slug": "impact-investing",
...
```json-ld
{
  ...
  "relations": {
    "relatedTo": [
      ...
      {"@id": "urn:ngm:class:social-return-on-investment", "label": "Social Return on Investment"},
      {"@id": "urn:ngm:class:blended-finance", "label": "Blended Finance"},
      {"@id": "urn:ngm:class:development-finance", "label": "Development Finance"}
    ],
    "supports": [
    ...
    "requires": [
      ...
      {"@id": "urn:ngm:class:theory-of-change", "label": "Theory of Change"},
      {"@id": "urn:ngm:class:impact-reporting", "label": "Impact Reporting"}
    ],
    "uses": [
      {"@id": "urn:ngm:class:iris-plus", "label": "IRIS+"},
      {"@id": "urn:ngm:class:impact-management-project", "label": "Impact Management Project"},
      {"@id": "urn:ngm:class:green-bond", "label": "Green Bond"},
      {"@id": "urn:ngm:class:social-impact-bond", "label": "Social Impact Bond"}
    ],
    "contrastsWith": [
      {"@id": "urn:ngm:class:conventional-investing", "label": "Conventional Investing"},
      {"@id": "urn:ngm:class:impact-washing", "label": "Impact Washing"}
    ],
    "enables": [
      {"@id": "urn:ngm:class:additionality", "label": "Additionality"},
      {"@id": "urn:ngm:class:private-sector-development", "label": "Private Sector Development"}
    ],
    "bridgesTo": [
  ...
  "sameAs": [
    ...
    {"@id": "urn:ngm:class:mission-related-investing", "label": "Mission-Related Investing"}
  ],
  "quality": 0.72,
  "provenance": {
