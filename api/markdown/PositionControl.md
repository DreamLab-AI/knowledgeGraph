...
- ### Content
  ...
  - ### Sensors and Feedback Mechanisms
	  ...
	  #### Rotary Encoders
	  - **Incremental Encoders**: Quadrature A/B channels (90° phase shift) + [private] pulse
	    ...
	    - Limitations: Relative measurement (requires homing to [private]), susceptible to noise (differential signaling RS-422 mitigates)
