schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#MotionSolverSoftware
legacy_uri:: urn:visionclaw:concept:spatial-computing:motion-solver-software
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-b9b35537dc70"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#MotionSolverSoftware"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:motion-solver-software"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
