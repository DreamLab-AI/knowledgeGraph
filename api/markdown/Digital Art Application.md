schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#DigitalArtApplication
legacy_uri:: urn:visionclaw:concept:spatial-computing:digital-art-application
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-e3de50877fc1"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#DigitalArtApplication"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:digital-art-application"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
