schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#BlockchainGovernance
legacy_uri:: urn:visionclaw:concept:blockchain:blockchain-governance
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-c0b335ba27cc"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#BlockchainGovernance"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:blockchain-governance"
    },
    {
      "vc:key": "status",
      "vc:value": "active"
