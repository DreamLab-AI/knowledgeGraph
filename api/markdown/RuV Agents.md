schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#RuvAgents
legacy_uri:: urn:visionclaw:concept:infrastructure:ruv-agents
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-82277e7d58ca"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#RuvAgents"
    },
    {
      "vc:key": "maturity",
      "vc:value": "draft"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:ruv-agents"
    },
    {
      "vc:key": "status",
      "vc:value": "stub"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:018b5355546ca4a0dfc0d49df7d08a368de09744a2a20f6d11d5742b511c44e3@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:ru-v-agents",
  "@type": "OntologyClass",
  "label": "RuV Agents",
  "subClassOf": [
    {
