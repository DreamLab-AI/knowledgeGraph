schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#NeuromorphicChip
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:neuromorphic-chip
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-59b58d1f4a18"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#NeuromorphicChip"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:neuromorphic-chip"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
