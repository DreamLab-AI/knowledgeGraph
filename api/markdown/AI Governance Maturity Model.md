schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#AiGovernanceMaturityModel
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:ai-governance-maturity-model
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-86d9a7ebc830"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#AiGovernanceMaturityModel"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:ai-governance-maturity-model"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
