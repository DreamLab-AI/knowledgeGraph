schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#VirtualCommunityPlatform
legacy_uri:: urn:visionclaw:concept:spatial-computing:virtual-community-platform
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-af83a198b673"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#VirtualCommunityPlatform"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:virtual-community-platform"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:01d84d09ec02f82d4726c044ee04e2550533dbd6e7afd04d8ec9f26c086a8bd6@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
