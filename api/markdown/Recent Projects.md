schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#RecentProjects
legacy_uri:: urn:visionclaw:concept:infrastructure:recent-projects
public:: true
...
```json-ld
{
  ...
  "@id": "urn:visionflow:page:a5aaea4fea1863711995698c3a7a15a1bc807ceeabb8c0a6b5bdbefa284f4634",
  "@type": "Page",
  "vc:slug": "recent-projects",
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-15d4f8fcd412"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#RecentProjects"
    },
    {
      "vc:key": "maturity",
      "vc:value": "draft"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:recent-projects"
    },
    {
      "vc:key": "status",
      "vc:value": "stub"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:a5aaea4fea1863711995698c3a7a15a1bc807ceeabb8c0a6b5bdbefa284f4634@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:recent-projects",
  "@type": "OntologyClass",
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:recent-projects:776c802a9fc9",
