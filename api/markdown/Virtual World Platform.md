schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#VirtualWorldPlatform
legacy_uri:: urn:visionclaw:concept:spatial-computing:virtual-world-platform
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-d9fc9dbc5dc0"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#VirtualWorldPlatform"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:virtual-world-platform"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
