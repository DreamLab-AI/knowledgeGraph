schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#EllipticCurveCryptography
legacy_uri:: urn:visionclaw:concept:blockchain:elliptic-curve-cryptography
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-d8ea087622cc"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#EllipticCurveCryptography"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:elliptic-curve-cryptography"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
