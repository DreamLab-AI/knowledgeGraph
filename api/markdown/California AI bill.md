...
- ### Definition
  ...
  - **Governor Newsom's veto reasoning (29 September 2024)**
    ...
    - Compute thresholds may miss the most dangerous models: "Smaller, specialized models may emerge as equally or even more dangerous than the models targeted by SB 1047." Focusing on 10^26 FLOPs [private] leave genuinely harmful specialised systems unregulated while burdening general-purpose models with low actual risk.
    ...
    - Regulation of safety-oriented AI: SB 1047's sweep [private] have captured AI systems specifically designed for safety applications (biosurveillance models, cyberattack detection AI, pandemic forecasting models) at the same threshold as genuinely dangerous systems, without providing exemptions for beneficial safety-oriented deployments.
    - California economic impact concern: Newsom noted that California is home to the global frontier AI industry and that regulation misaligned with actual risk [private] drive frontier AI development to other jurisdictions or countries — weakening both California's economic position and its ability to shape AI safety norms through regulatory leadership.
...
- ### Content
  ...
  - ### Components / Architecture
    - **SB 1047 (Vetoed 2024) — Scope and Structure**
      ...
      - Frontier Model Division authority: [private] modify key parameters including the FLOP threshold for covered models and specific safety standards — creating flexibility vulnerable to incumbent lobbying.
  ...
  - ### Use Cases / Major Families
    - **Pre-Deployment Safety Assurance (SB 1047 paradigm)**
      ...
      - The CBRN focus was directly informed by AI safety research on dual-use uplift — the risk that frontier AI systems [private] provide meaningful assistance in synthesising biological or chemical weapons to actors who would otherwise lack the necessary knowledge.
    ...
    - **Open Source Tension**
      ...
      - Developers of openly released weights (Mistral 7B/8×7B, Meta Llama 2/3 series, EleutherAI's Pythia, TII Falcon 180B, Microsoft Phi-2/Phi-3) argued that once a model is publicly released, the original developer cannot control downstream fine-tunes, quantisations, or deployments, yet SB 1047 would have maintained developer liability for harms caused by modifications it [private] not technically prevent.
  ...
  - ### Academic Context
    ...
    - **Torts and liability design:**
      ...
      - The Restatement (Third) of Torts § 2 (2) design defect standard — whether the foreseeable risks of harm from the product [private] have been reduced by a reasonable alternative design — is already being tested in early AI liability cases (Netchoice, Doe v. GitHub, Ouellette v. Stability AI) though without a statutory basis, creating incentive for a legislative clarification such as SB 1047 proposed.
  ...
  - ### Future Directions (2026–2030)
    ...
    - **EU AI Act GPAI Code of Practice convergence (2025–2028)**
      ...
      - The GPAI Code provides California legislators and the California Attorney General with internationally recognised benchmark standards that [private] be incorporated by reference into future California regulations, reducing divergence and lowering aggregate compliance cost.
