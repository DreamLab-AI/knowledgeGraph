schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#CaliforniaAIBill
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:california-ai-bill
public:: true
...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:ai-alliance",
      "vc:label": "AI Alliance"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:center-for-ai-safety",
      "vc:label": "Center for AI Safety"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:dan-hendrycks",
      "vc:label": "Dan Hendrycks"
    },
    {
      "@id": "urn:visionflow:linked:dario-amodei",
      "vc:label": "Dario Amodei"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:kill-switch",
      "vc:label": "Kill Switch"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:legal-regulatory-domain",
      "vc:label": "LegalRegulatoryDomain"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:marc-andreessen",
      "vc:label": "Marc Andreessen"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:technology-policy-domain",
      "vc:label": "TechnologyPolicyDomain"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:training-data-transparency",
      "vc:label": "Training Data Transparency"
    },
    {
  ...
  "vc:legacyProperties": [
    {
      ...
      "vc:value": "SB 1047, Safe and Secure Innovation for Frontier Artificial Intelligence Models Act, SB 53, Transparency in Frontier Artificial Intelligence Act, TFAIA, California frontier AI regulation, California AI safety legislation"
    },
    {
    ...
    {
      "vc:key": "bridges-to",
      "vc:value": "[[AI Regulation]], [[Technology Policy]], [[EU AI Act]]"
    },
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-8140ae02d519"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#CaliforniaAIBill"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:california-ai-bill"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:california-ai-bill:776c802a9fc9",
  ...
  "vc:resolutions": [
    {
      "raw": "[[AB 1008]]",
      "resolved": "urn:visionflow:linked:ab-1008",
      "kind": "StubLink"
    },
    {
      "raw": "[[AB 2013]]",
      "resolved": "urn:visionflow:linked:ab-2013",
      "kind": "StubLink"
    },
    {
      "raw": "[[AB 489]]",
      "resolved": "urn:visionflow:linked:ab-489",
      "kind": "StubLink"
    },
    {
      "raw": "[[AI Alliance]]",
      "resolved": "urn:visionflow:linked:ai-alliance",
      "kind": "StubLink"
    },
    {
      "raw": "[[AI Regulation]]",
    ...
    {
      "raw": "[[AI Safety Transparency]]",
      "resolved": "urn:visionflow:linked:ai-safety-transparency",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Attorney General Enforcement]]",
      "resolved": "urn:visionflow:linked:attorney-general-enforcement",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[California Attorney General]]",
      "resolved": "urn:visionflow:linked:california-attorney-general",
      "kind": "StubLink"
    },
    {
      "raw": "[[California Department of Justice]]",
      "resolved": "urn:visionflow:linked:california-department-of-justice",
      "kind": "StubLink"
    },
    {
      "raw": "[[California Effect]]",
      "resolved": "urn:visionflow:linked:california-effect",
      "kind": "StubLink"
    },
    {
      "raw": "[[California Legislature]]",
      "resolved": "urn:visionflow:linked:california-legislature",
      "kind": "StubLink"
    },
    {
      "raw": "[[California Office of Emergency Services]]",
      "resolved": "urn:visionflow:linked:california-office-of-emergency-services",
      "kind": "StubLink"
    },
    {
      "raw": "[[Catastrophic Risk Assessment]]",
      "resolved": "urn:visionflow:linked:catastrophic-risk-assessment",
      "kind": "StubLink"
    },
    {
      "raw": "[[CCPA]]",
    ...
    {
      "raw": "[[Center for AI Safety]]",
      "resolved": "urn:visionflow:linked:center-for-ai-safety",
      "kind": "StubLink"
    },
    {
      "raw": "[[Compliance Statement]]",
      "resolved": "urn:visionflow:linked:compliance-statement",
      "kind": "StubLink"
    },
    {
      "raw": "[[Compute Threshold]]",
      "resolved": "urn:visionflow:linked:compute-threshold",
      "kind": "StubLink"
    },
    {
      "raw": "[[Consumer Privacy in AI]]",
      "resolved": "urn:visionflow:linked:consumer-privacy-in-ai",
      "kind": "StubLink"
    },
    {
      "raw": "[[Critical Harm Framework]]",
      "resolved": "urn:visionflow:linked:critical-harm-framework",
      "kind": "StubLink"
    },
    {
      "raw": "[[Critical Safety Incident Reporting]]",
      "resolved": "urn:visionflow:linked:critical-safety-incident-reporting",
      "kind": "StubLink"
    },
    {
      "raw": "[[Dan Hendrycks]]",
      "resolved": "urn:visionflow:linked:dan-hendrycks",
      "kind": "StubLink"
    },
    {
      "raw": "[[Dario Amodei]]",
      "resolved": "urn:visionflow:linked:dario-amodei",
      "kind": "StubLink"
    },
    {
      "raw": "[[Dual Threshold Regulation]]",
      "resolved": "urn:visionflow:linked:dual-threshold-regulation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Elon Musk]]",
    ...
    {
      "raw": "[[Federal AI Policy]]",
      "resolved": "urn:visionflow:linked:federal-ai-policy",
      "kind": "StubLink"
    },
    {
      "raw": "[[Federal Preemption]]",
      "resolved": "urn:visionflow:linked:federal-preemption",
      "kind": "StubLink"
    },
    {
      "raw": "[[Federal Preemption Debate]]",
      "resolved": "urn:visionflow:linked:federal-preemption-debate",
      "kind": "StubLink"
    },
    {
      "raw": "[[FLOP Threshold]]",
      "resolved": "urn:visionflow:linked:flop-threshold",
      "kind": "StubLink"
    },
    {
      "raw": "[[Frontier AI Framework]]",
      "resolved": "urn:visionflow:linked:frontier-ai-framework",
      "kind": "StubLink"
    },
    {
      "raw": "[[Frontier Model Division]]",
      "resolved": "urn:visionflow:linked:frontier-model-division",
      "kind": "StubLink"
    },
    {
      "raw": "[[Frontier Model Governance]]",
      "resolved": "urn:visionflow:linked:frontier-model-governance",
      "kind": "StubLink"
    },
    {
      "raw": "[[Frontier Models]]",
      "resolved": "urn:visionflow:linked:frontier-models",
      "kind": "StubLink"
    },
    {
      "raw": "[[Gavin Newsom]]",
      "resolved": "urn:visionflow:linked:gavin-newsom",
      "kind": "StubLink"
    },
    {
      "raw": "[[GDPR]]",
    ...
    {
      "raw": "[[Governor of California]]",
      "resolved": "urn:visionflow:linked:governor-of-california",
      "kind": "StubLink"
    },
    {
      "raw": "[[Healthcare AI Accountability]]",
      "resolved": "urn:visionflow:linked:healthcare-ai-accountability",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Kill Switch]]",
      "resolved": "urn:visionflow:linked:kill-switch",
      "kind": "StubLink"
    },
    {
      "raw": "[[Kill Switch Mandate]]",
      "resolved": "urn:visionflow:linked:kill-switch-mandate",
      "kind": "StubLink"
    },
    {
      "raw": "[[LegalLayer]]",
    ...
    {
      "raw": "[[LegalRegulatoryDomain]]",
      "resolved": "urn:visionflow:linked:legal-regulatory-domain",
      "kind": "StubLink"
    },
    {
      "raw": "[[Legislative Instrument]]",
      "resolved": "urn:visionflow:linked:legislative-instrument",
      "kind": "StubLink"
    },
    {
      "raw": "[[Liability]]",
    ...
    {
      "raw": "[[Liability Framework]]",
      "resolved": "urn:visionflow:linked:liability-framework",
      "kind": "StubLink"
    },
    {
      "raw": "[[Machine Unlearning]]",
      "resolved": "urn:visionflow:linked:machine-unlearning",
      "kind": "StubLink"
    },
    {
      "raw": "[[Marc Andreessen]]",
      "resolved": "urn:visionflow:linked:marc-andreessen",
      "kind": "StubLink"
    },
    {
      "raw": "[[Meta AI]]",
    ...
    {
      "raw": "[[NIST SP 800 Series]]",
      "resolved": "urn:visionflow:linked:nist-sp-800-series",
      "kind": "StubLink"
    },
    {
      "raw": "[[Open Source AI]]",
    ...
    {
      "raw": "[[Pre-Deployment Safety Checks]]",
      "resolved": "urn:visionflow:linked:pre-deployment-safety-checks",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Revenue Threshold]]",
      "resolved": "urn:visionflow:linked:revenue-threshold",
      "kind": "StubLink"
    },
    {
      "raw": "[[Risk-Based AI Governance]]",
      "resolved": "urn:visionflow:linked:risk-based-ai-governance",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Safety Evaluation]]",
      "resolved": "urn:visionflow:linked:safety-evaluation",
      "kind": "StubLink"
    },
    {
      "raw": "[[SB 1047]]",
      "resolved": "urn:visionflow:linked:sb-1047",
      "kind": "StubLink"
    },
    {
      "raw": "[[SB 53]]",
      "resolved": "urn:visionflow:linked:sb-53",
      "kind": "StubLink"
    },
    {
      "raw": "[[SB 942]]",
      "resolved": "urn:visionflow:linked:sb-942",
      "kind": "StubLink"
    },
    {
      "raw": "[[Scaling Laws]]",
    ...
    {
      "raw": "[[Scott Wiener]]",
      "resolved": "urn:visionflow:linked:scott-wiener",
      "kind": "StubLink"
    },
    {
      "raw": "[[Self-Regulation]]",
    ...
    {
      "raw": "[[Startup Ecosystem]]",
      "resolved": "urn:visionflow:linked:startup-ecosystem",
      "kind": "StubLink"
    },
    {
      "raw": "[[State Law]]",
      "resolved": "urn:visionflow:linked:state-law",
      "kind": "StubLink"
    },
    {
      "raw": "[[Technology Policy]]",
      "resolved": "urn:visionflow:linked:technology-policy",
      "kind": "StubLink"
    },
    {
      "raw": "[[TechnologyPolicyDomain]]",
      "resolved": "urn:visionflow:linked:technology-policy-domain",
      "kind": "StubLink"
    },
    {
      "raw": "[[Third-Party Safety Audit]]",
      "resolved": "urn:visionflow:linked:third-party-safety-audit",
      "kind": "StubLink"
    },
    {
      "raw": "[[Training Data Disclosure]]",
      "resolved": "urn:visionflow:linked:training-data-disclosure",
      "kind": "StubLink"
    },
    {
      "raw": "[[Training Data Documentation]]",
      "resolved": "urn:visionflow:linked:training-data-documentation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Training Data Transparency]]",
      "resolved": "urn:visionflow:linked:training-data-transparency",
      "kind": "StubLink"
    },
    {
      "raw": "[[Transparency Mandate]]",
      "resolved": "urn:visionflow:linked:transparency-mandate",
      "kind": "StubLink"
    },
    {
      "raw": "[[Voluntary AI Commitments]]",
      "resolved": "urn:visionflow:linked:voluntary-ai-commitments",
      "kind": "StubLink"
    },
    {
      "raw": "[[Whistleblower Mechanism]]",
      "resolved": "urn:visionflow:linked:whistleblower-mechanism",
      "kind": "StubLink"
    },
    {
...
- ### Definition
  - California AI bill is the collective designation for a sequence of California state legislative instruments enacted or proposed between 2023 and 2026 to regulate the development, deployment, and disclosure obligations of large-scale [[Frontier Models]] — most prominently Senate Bill 1047 (SB 1047, 2024, vetoed) and its successor Senate Bill 53 (SB 53, 2025, signed), together with associated transparency and data-governance instruments such as AB 2013 (2024, signed).
  - The corpus sits at the intersection of [[AI Safety]], [[Liability]], [[Algorithmic Accountability]], and [[Technology Policy]], establishing California as the primary sub-national jurisdiction attempting to regulate frontier AI development in the United States and, by the California-effect spillover dynamic historically observed in vehicle emissions and consumer-privacy regulation, potentially shaping norms globally.
  - **SB 1047 — Safe and Secure Innovation for Frontier Artificial Intelligence Models Act (vetoed 2024)**
    - Introduced by State Senator Scott Wiener on 7 February 2024. Passed both chambers of the California legislature before being vetoed by Governor Gavin Newsom on 29 September 2024.
    - Defined "covered models" as AI systems either (a) trained at a cost exceeding $100 million using more than 10^26 floating-point operations (FLOPs), or (b) fine-tuned from a covered model at a cost exceeding $10 million using more than 3×10^25 FLOPs — thresholds calibrated to capture the highest-capability foundation model tier as of 2024 (GPT-4, Claude 3 Opus, Gemini Ultra).
    - Pre-training obligations under SB 1047 required developers to:
      - Implement a documented safety and security protocol addressing catastrophic harm scenarios before training commenced.
      - The safety protocol required: written articulation of foreseeable catastrophic harm scenarios; planned mitigations; internal audit procedures; incident response playbook; post-incident review and disclosure process.
      - Install a "full shutdown capability" enabling the developer to halt the model and all derivative deployments — the kill-switch mandate.
      - Kill-switch scope: the shutdown capability must reach not only the primary deployed model but all derivative models created from it — including fine-tunes, distillations, and any other derivative that the original developer had knowledge of.
      - Conduct or commission third-party safety evaluations assessing CBRN (chemical, biological, radiological, nuclear) uplift risk, autonomous cyberattack potential, and mass-casualty enabling capabilities.
      - Third-party evaluation: must be conducted by an independent evaluator with relevant expertise; the developer may not self-certify on CBRN or critical infrastructure attack risk.
      - Submit a Statement of Compliance to the California Attorney General before public deployment.
      - Statement of Compliance: a sworn document affirming the developer had conducted required evaluations, implemented a safety protocol, and taken reasonable care to prevent unreasonable risk of critical harms.
    - Extended regulation upstream: cloud computing providers supplying training infrastructure would have been obligated to ensure customers possessed valid compliance documentation, effectively pulling hyperscalers (Google Cloud, AWS, Azure, Oracle Cloud) into the regulatory chain.
    - Cloud provider obligation detail: any cloud computing provider knowing it was providing compute for covered model training would have committed a violation if it failed to verify the developer's Statement of Compliance before making infrastructure available.
    - This upstream obligation was particularly controversial: it would have extended California's AI regulation from software developers to infrastructure providers, restructuring the AI supply chain's liability architecture and creating compliance obligations for companies with no direct role in model design.
    - Post-deployment liability: developers would have remained liable if they failed to take "reasonable care" to prevent critical harms — defined as: creation or facilitation of a CBRN weapon capable of mass casualties; cyberattack on critical infrastructure causing at least $500 million in damage or mass casualties; autonomous crimes causing equivalent damage or mass casualties; or other events causing mass casualties.
    - Institutional design: proposed a Frontier Model Division within the California Department of Technology, funded through fines on the industry it regulated — a structure critics identified as structurally vulnerable to [[Regulatory Capture]].
  - **Governor Newsom's veto reasoning (29 September 2024)**
    - SB 1047 applied uniform obligations across all covered models regardless of deployment context: a customer-service chatbot and an autonomous infrastructure-control system attracted identical pre-deployment burdens, with no differentiation by risk, application domain, or deployment environment.
    - Newsom's exact veto language on context: "While well-intentioned, SB 1047 does not take into account whether an AI system is deployed in high-risk environments, involves critical decision-making or the use of sensitive data. Instead, the bill applies stringent standards to even the most basic functions."
    - Compute thresholds may miss the most dangerous models: "Smaller, specialized models may emerge as equally or even more dangerous than the models targeted by SB 1047." Focusing on 10^26 FLOPs could leave genuinely harmful specialised systems unregulated while burdening general-purpose models with low actual risk.
    - Kill-switch incompatibility with open-source distribution: once a model is open-sourced and downloaded by third parties, its developer loses technical control over derivative copies yet SB 1047 would have maintained liability for harms caused by those derivatives — a structural impossibility the bill did not resolve.
    - Regulation of safety-oriented AI: SB 1047's sweep could have captured AI systems specifically designed for safety applications (biosurveillance models, cyberattack detection AI, pandemic forecasting models) at the same threshold as genuinely dangerous systems, without providing exemptions for beneficial safety-oriented deployments.
    - California economic impact concern: Newsom noted that California is home to the global frontier AI industry and that regulation misaligned with actual risk could drive frontier AI development to other jurisdictions or countries — weakening both California's economic position and its ability to shape AI safety norms through regulatory leadership.
    - Newsom signalled openness to narrower, harm-specific, deployment-context-sensitive regulation and commissioned California's frontier AI advisory council to develop alternative frameworks that would address identified risks without the structural problems that led to the veto.
    - The veto was not a rejection of AI regulation as a concept: Newsom signed 17 other AI bills in September 2024 (including AB 2013, AB 1008, and numerous sector-specific AI bills on deepfakes in elections, sexual imagery, healthcare, and court proceedings) — signalling that his objection was to SB 1047's specific design, not to AI governance generally.
  - **SB 53 — Transparency in Frontier Artificial Intelligence Act / TFAIA (signed 2025, effective 2026)**
    - Newsom signed SB 53 on 29 September 2025 — exactly one year after the SB 1047 veto — making California the first US state to directly regulate frontier AI developers through enforceable law.
    - SB 53 is substantially narrower: it imposes transparency and incident-reporting obligations rather than pre-training safety mandates, resolving the open-source kill-switch problem because disclosure obligations do not require technical control over derivative copies.
    - Scope: "large frontier developers" — companies with annual gross revenues exceeding $500 million that develop foundation models trained with more than 10^26 FLOPs.
    - Key obligations:
      - Publish a publicly accessible Frontier AI Framework on the company website, describing how national and international standards (NIST AI RMF, ISO/IEC 42001, industry consensus frameworks) are incorporated into risk assessment and mitigation activities.
      - The Frontier AI Framework must address: catastrophic risk identification methodology; risk mitigation measures deployed or planned; cybersecurity practices protecting model weights, training data, and inference infrastructure; and internal governance controls (board oversight, safety review processes, escalation procedures for safety concerns).
      - Review and update the Frontier AI Framework at least annually; material changes must be published promptly without waiting for the annual review cycle.
      - Provide a mechanism for covered employees and the public to report potential critical safety incidents to the California Governor's Office of Emergency Services (CalOES), within 15 days of the developer becoming aware, or 24 hours if there is imminent risk of death or serious physical injury.
      - Critical safety incident categories: AI-enabled cyberattack on critical infrastructure; AI-enabled crime causing mass casualties; deceptive AI behaviour designed to undermine its own safety controls; AI-autonomous actions outside intended operational parameters causing substantial harm.
      - Establish a reasonable anonymous internal whistleblower process allowing covered employees to file safety reports alleging substantial danger to public health or safety resulting from catastrophic risk or TFAIA violation.
      - Provide whistleblowers with monthly status updates on investigation progress and actions taken; employers cannot require disclosure of whistleblower identity to the reporting committee or management as a condition of investigation.
      - Extraterritorial application: applies to large frontier developers wherever headquartered, as long as they make AI products or services available to California users or develop frontier models using California-located facilities or employees.
    - Civil penalties: up to $1 million per violation, each failure constituting a separate violation, enforceable by the California Attorney General in civil actions. No private right of action; penalties flow to the state General Fund, not to a regulator-financed division.
    - Effective date: 1 January 2026. Applies to entities subject to California jurisdiction regardless of headquarter location.
  - **Companion legislation (2024–2025 package)**
    - AB 2013 (Generative AI Training Data Transparency Act, signed 28 September 2024, effective 1 January 2026):
      - Requires all generative AI developers making systems available to Californians to publish documentation on training data sources, data licensing status, CCPA-covered personal-information inclusion, synthetic data use, time window of data collection, and IP implications (copyright, trademark, patent, public domain).
      - Retroactive: applies to systems made available to Californians since January 2022, not only new deployments.
      - Each violation (each required disclosure item omitted) constitutes a separate violation; enforced by Attorney General.
      - Implementation challenge: internet-scale training datasets (Common Crawl, The Pile) cannot be enumerated at source level; California AG guidance on acceptable summary-level compliance is expected in 2026.
    - AB 1008 (signed 28 September 2024, effective 1 January 2025):
      - Clarifies that the California Consumer Privacy Act (CCPA) applies to personal information held in "abstract digital formats" including model weights, tokens, embeddings, or other outputs derived from consumer data and capable of outputting information linked to identifiable individuals.
      - Paired with SB 1223 as a conditioned two-bill package — neither enacts unless both enact.
      - Practical consequence: consumers whose personal information was used to train a California-accessible AI system may exercise CCPA access and deletion rights against the model itself, not only against underlying data stores.
      - Technical implementation of "deletion from model weights" is an active research problem (machine unlearning); the AG has not yet issued guidance on what technical standard satisfies the deletion right.
    - SB 942 / AB 853 (California AI Transparency Act, effective August 2026):
      - Scope: platforms with >1 million monthly active users offering AI-generated content to California users.
      - Key obligations: provide free AI-content detection tools; implement watermarking capability that embeds provenance signals in AI-generated images, audio, and video; disclose AI provenance on request by users.
      - Technical standard references: C2PA (Coalition for Content Provenance and Authenticity) content credentials and SynthID watermarking developed by Google DeepMind are candidate compliance approaches.
      - Enforcement: California AG; no private right of action specified.
    - AB 489 (Healthcare AI Act, effective 2026):
      - Prohibits AI systems from representing that users are in communication with licensed healthcare professionals where no genuine human clinical oversight exists.
      - Applies to: any AI system providing responses to questions about symptoms, diagnoses, treatments, medications, or clinical recommendations in a context that a reasonable person would associate with clinical advice.
      - Exemptions: AI systems that clearly and prominently disclose at the outset that they are AI, not licensed professionals.
      - Concurrent with FTC guidance on AI endorsement deception, creating parallel federal and state enforcement coverage.

- ### Semantic Classification
  - owl-class:: artificial-intelligence:CaliforniaAIBill
  - owl-role:: RegulatoryInstrument
  - owl-inferred:: ai:FrontierModelGovernance, ai:AILegislation, ai:TechnologyPolicy, ai:AlgorithmicAccountability
  - belongs-to-domain:: [[AIGovernanceDomain]], [[TechnologyPolicyDomain]], [[LegalRegulatoryDomain]]
  - implemented-in-layer:: [[PolicyLayer]], [[InstitutionalLayer]], [[LegalLayer]]
  ...
  - threshold-type:: dual (compute 10^26 FLOPs AND revenue >$500M for SB 53); single compute (10^26 FLOPs AND cost >$100M for SB 1047)
  - enforcement-mechanism:: California Attorney General civil actions; no private right of action
...
- ### Relationships
  - is-subclass-of:: [[AI Regulation]], [[Technology Policy]], [[Legislative Instrument]], [[State Law]], [[Frontier Model Governance]]
  - has-part:: [[SB 1047]], [[SB 53]], [[AB 2013]], [[AB 1008]], [[AB 489]], [[SB 942]], [[Frontier AI Framework]], [[Kill Switch Mandate]], [[Whistleblower Protection]], [[Critical Safety Incident Reporting]], [[Compliance Statement]], [[Frontier Model Division]]
  - requires:: [[Frontier Models]], [[Compute Threshold]], [[Safety Evaluation]], [[Training Data Documentation]], [[Attorney General Enforcement]], [[Liability Framework]], [[Revenue Threshold]]
  - enables:: [[AI Safety Transparency]], [[Algorithmic Accountability]], [[Whistleblower Protection]], [[Incident Reporting]], [[Training Data Disclosure]], [[Consumer Privacy in AI]], [[Healthcare AI Accountability]]
  - implements:: [[Risk-Based AI Governance]], [[Transparency Mandate]], [[Pre-Deployment Safety Checks]], [[Whistleblower Mechanism]], [[Critical Harm Framework]], [[Dual Threshold Regulation]]
...
- ### Content
  ...
  - ### About
    ...
    - Compliance with SB 53 for large frontier developers:
      - Estimated initial implementation cost: $500K–$2M for large organisations (primarily legal and governance costs, per Nelson Mullins and WilmerHale assessments).
      - Ongoing annual update costs: $200K–$500K per year.
      - Modest relative to covered companies' frontier development budgets: OpenAI's 2025 operating expenses exceeded $5 billion; Google DeepMind's annual AI research budget exceeds $2 billion.
    ...
    - **SB 1047 vs SB 53 — structural comparison:**
      - Scope trigger: SB 1047 — $100M training cost AND 10^26 FLOPs; SB 53 — 10^26 FLOPs AND $500M annual revenue.
      ...
      - Compliance cost: SB 1047 estimated $10M–$50M+ per developer (evaluation, protocol, compliance infrastructure); SB 53 estimated $500K–$2M (documentation and governance).
  ...
  - ### Components / Architecture
    - **SB 1047 (Vetoed 2024) — Scope and Structure**
      - Covered models: training cost >$100M, training compute >10^26 FLOPs, plus fine-tuned derivatives ($10M+, >3×10^25 FLOPs).
      ...
      - Critical harm categories defined: (1) creation/facilitation of a CBRN weapon capable of mass casualties; (2) cyberattack on critical infrastructure causing >$500M damage or mass casualties; (3) autonomous crime causing >$500M damage or mass casualties; (4) other events causing mass casualties.
  ...
  - ### Use Cases / Major Families
    ...
    - **Compute Governance and Threshold Design**
      ...
      - The dual SB 53 criterion (10^26 FLOPs AND >$500M revenue) partially addresses the "small dangerous model" criticism: even if a malicious actor trained a dangerous specialised model at 10^26 FLOPs, they would need $500M+ annual revenue to be caught by SB 53 — effectively excluding state-level threat actors and most non-state adversaries from the regulatory scope, though this is arguably appropriate since such actors are beyond California's jurisdictional reach regardless.
...
- ### Provenance
  ...
  - enriched-by:: claude-sonnet-4-6 (enrichment worker, Phase 6)
