schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#RegulatoryStandards
legacy_uri:: urn:visionclaw:concept:spatial-computing:regulatory-standards
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-207c49431bf8"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#RegulatoryStandards"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:regulatory-standards"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
