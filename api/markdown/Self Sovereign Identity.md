schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/identity#SelfSovereignIdentity
legacy_uri:: urn:visionclaw:concept:identity:self-sovereign-identity
public:: true
...
```json-ld
{
  ...
  "@id": "urn:visionflow:page:a0d3752e394e49c8c0b47f62b852d32a0b68ddf3c8fa7b35501f5da38622c1d7",
  "@type": "Page",
  "vc:slug": "self-sovereign-identity",
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:camenisch-lysyanskaya-signatures",
      "vc:label": "Camenisch-Lysyanskaya Signatures"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:correlation-resistance",
      "vc:label": "Correlation Resistance"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:cross-border-identity",
    ...
    {
      "@id": "urn:visionflow:linked:digital-government",
      "vc:label": "Digital Government"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:ecdh-1-pu",
      "vc:label": "ECDH-1PU"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:healthcare-identity",
      "vc:label": "Healthcare Identity"
    },
    {
      "@id": "urn:visionflow:linked:holder-binding",
      "vc:label": "Holder Binding"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:io-t-security",
      "vc:label": "IoT Security"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:iso-18013-5",
      "vc:label": "ISO 18013-5"
    },
    {
      "@id": "urn:visionflow:linked:issuer-agent",
      "vc:label": "Issuer Agent"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:link-secret",
      "vc:label": "Link Secret"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:privacy-enhancing-technology",
      "vc:label": "Privacy-Enhancing Technology"
    },
    {
      "@id": "urn:visionflow:linked:privacy-preserving-kyc",
      "vc:label": "Privacy-Preserving KYC"
    },
    {
      "@id": "urn:visionflow:linked:reusable-identity-verification",
      "vc:label": "Reusable Identity Verification"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:sidetree-protocol",
      "vc:label": "Sidetree Protocol"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:verifier-agent",
      "vc:label": "Verifier Agent"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:wallet-software",
      "vc:label": "Wallet Software"
    },
    {
      "@id": "urn:visionflow:linked:x-509-pki",
      "vc:label": "X.509 PKI"
    },
    {
      "@id": "urn:visionflow:linked:xchacha20-poly1305",
      "vc:label": "XChacha20Poly1305"
    },
    {
      "@id": "urn:visionflow:linked:zero-knowledge-predicate-proof",
      "vc:label": "Zero-Knowledge Predicate Proof"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-3064504b5c29"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/identity#SelfSovereignIdentity"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:identity:self-sovereign-identity"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:a0d3752e394e49c8c0b47f62b852d32a0b68ddf3c8fa7b35501f5da38622c1d7@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
```json-ld
{
  ...
  "definition": "Self-Sovereign Identity (SSI) is an identity management paradigm — first articulated as a systematic framework by Christopher Allen in \"The Path to Self-Sovereign Identity\" (April 2016) — where individuals hold and control cryptographically verifiable credentials in their own [[Digital Wallet]] rather than depending on [[Centralised Identity]] providers or [[Federated Identity]] intermediaries such as corporate identity providers, national databases, or single-sign-on brokers. SSI rests on three interdependent W3C open standards: [[Decentralized Identifiers]] (DID Core 1.0 became a W3C Recommendation in July 2022; v1.1 in Working Draft as of 2026), [[Verifiable Credentials]] (VC Data Model v2.0 became a W3C Recommendation in May 2025), and the DIDComm v2 secure messaging protocol maintained by the [[Decentralized Identity Foundation]]; these three layers together enable cryptographic proof of identity claims without requiring centralised databases or online validation calls to the issuing authority. Trust roots are anchored to [[Verifiable Data Registry]] infrastructure spanning permissioned ledgers ([[Hyperledger Indy]] underlying the [[Sovrin Network]]), public blockchains ([[Bit",
  "vc:qualityScore": {
    "@value": "0.52",
    "@type": "xsd:float"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:self-sovereign-identity:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[Bitstring Status List]]",
      "resolved": "urn:visionflow:linked:bitstring-status-list",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Camenisch-Lysyanskaya Signatures]]",
      "resolved": "urn:visionflow:linked:camenisch-lysyanskaya-signatures",
      "kind": "StubLink"
    },
    {
      "raw": "[[CBOR]]",
    ...
    {
      "raw": "[[Centralised Identity]]",
      "resolved": "urn:visionflow:linked:centralised-identity",
      "kind": "StubLink"
    },
    {
      "raw": "[[Correlation Resistance]]",
      "resolved": "urn:visionflow:linked:correlation-resistance",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Cross-Border Identity]]",
      "resolved": "urn:visionflow:linked:cross-border-identity",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Digital Government]]",
      "resolved": "urn:visionflow:linked:digital-government",
      "kind": "StubLink"
    },
    {
      "raw": "[[eIDAS]]",
    ...
    {
      "raw": "[[ECDH-1PU]]",
      "resolved": "urn:visionflow:linked:ecdh-1-pu",
      "kind": "StubLink"
    },
    {
      "raw": "[[EdDSA]]",
    ...
    {
      "raw": "[[Healthcare Identity]]",
      "resolved": "urn:visionflow:linked:healthcare-identity",
      "kind": "StubLink"
    },
    {
      "raw": "[[Holder Binding]]",
      "resolved": "urn:visionflow:linked:holder-binding",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[IoT Security]]",
      "resolved": "urn:visionflow:linked:io-t-security",
      "kind": "StubLink"
    },
    {
      "raw": "[[IPFS]]",
    ...
    {
      "raw": "[[ISO 18013-5]]",
      "resolved": "urn:visionflow:linked:iso-18013-5",
      "kind": "StubLink"
    },
    {
      "raw": "[[Issuer Agent]]",
      "resolved": "urn:visionflow:linked:issuer-agent",
      "kind": "StubLink"
    },
    {
      "raw": "[[JSON-LD]]",
    ...
    {
      "raw": "[[Link Secret]]",
      "resolved": "urn:visionflow:linked:link-secret",
      "kind": "StubLink"
    },
    {
      "raw": "[[OAuth]]",
    ...
    {
      "raw": "[[Offline Verification]]",
      "resolved": "urn:visionflow:linked:offline-verification",
      "kind": "StubLink"
    },
    {
      "raw": "[[OpenID Connect]]",
    ...
    {
      "raw": "[[Privacy-Enhancing Technology]]",
      "resolved": "urn:visionflow:linked:privacy-enhancing-technology",
      "kind": "StubLink"
    },
    {
      "raw": "[[Privacy-Preserving KYC]]",
      "resolved": "urn:visionflow:linked:privacy-preserving-kyc",
      "kind": "StubLink"
    },
    {
      "raw": "[[Reusable Identity Verification]]",
      "resolved": "urn:visionflow:linked:reusable-identity-verification",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Sidetree Protocol]]",
      "resolved": "urn:visionflow:linked:sidetree-protocol",
      "kind": "StubLink"
    },
    {
      "raw": "[[Sovrin Network]]",
    ...
    {
      "raw": "[[User-Centric Identity]]",
      "resolved": "urn:visionflow:linked:user-centric-identity",
      "kind": "StubLink"
    },
    {
      "raw": "[[Verifier Agent]]",
      "resolved": "urn:visionflow:linked:verifier-agent",
      "kind": "StubLink"
    },
    {
      "raw": "[[W3C]]",
    ...
    {
      "raw": "[[Wallet Software]]",
      "resolved": "urn:visionflow:linked:wallet-software",
      "kind": "StubLink"
    },
    {
      "raw": "[[X.509 PKI]]",
      "resolved": "urn:visionflow:linked:x-509-pki",
      "kind": "StubLink"
    },
    {
      "raw": "[[XChacha20Poly1305]]",
      "resolved": "urn:visionflow:linked:xchacha20-poly1305",
      "kind": "StubLink"
    },
    {
      "raw": "[[Zero-Knowledge Predicate Proof]]",
      "resolved": "urn:visionflow:linked:zero-knowledge-predicate-proof",
      "kind": "StubLink"
    },
    {
...
- ### Definition
  - Self-Sovereign Identity (SSI) is an identity management paradigm — first articulated as a systematic framework by Christopher Allen in "The Path to Self-Sovereign Identity" (April 2016) — where individuals hold and control cryptographically verifiable credentials in their own [[Digital Wallet]] rather than depending on [[Centralised Identity]] providers or [[Federated Identity]] intermediaries such as corporate identity providers, national databases, or single-sign-on brokers. SSI rests on three interdependent W3C open standards: [[Decentralized Identifiers]] (DID Core 1.0 became a W3C Recommendation in July 2022; v1.1 in Working Draft as of 2026), [[Verifiable Credentials]] (VC Data Model v2.0 became a W3C Recommendation in May 2025), and the DIDComm v2 secure messaging protocol maintained by the [[Decentralized Identity Foundation]]; these three layers together enable cryptographic proof of identity claims without requiring centralised databases or online validation calls to the issuing authority. Trust roots are anchored to [[Verifiable Data Registry]] infrastructure spanning permissioned ledgers ([[Hyperledger Indy]] underlying the [[Sovrin Network]]), public blockchains ([[Bitcoin]] via the ION Sidetree protocol developed by Microsoft, [[Ethereum]] via did:ethr and Ceramic), and web-hosted DID documents (did:web) — providing implementation flexibility whilst maintaining verifiability. Allen's ten core principles — Existence, Control, Access, Transparency, Persistence, Portability, Interoperability, Consent, Minimisation, and Protection — establish SSI as a rights-based framework rather than a purely technical specification, distinguishing it from earlier user-centric identity proposals that improved user experience within existing institutional trust structures without fundamentally reallocating control. Deployment is accelerating dramatically: the EU eIDAS 2.0 Regulation (EU 2024/1183, entering into force May 2024) mandates European Digital Identity Wallets (EUDI Wallets) for 80% of EU citizens by 2030, with the Architecture and Reference Framework (ARF) v1.4 (November 2024) specifying [[OpenID for Verifiable Credentials]] (OID4VCI/OID4VP) and SD-JWT as primary protocols; the UK DSIT Digital Identity and Attributes Trust Framework (DIATF, 2024) creates the certification regime underpinning GOV.UK One Login's 25+ million user rollout; and Microsoft Entra Verified ID, British Columbia OrgBook, and EBSI educational credentials demonstrate production-scale deployment on three continents. The cryptographic toolbox includes Camenisch-Lysyanskaya (CL) signatures for zero-knowledge predicates (AnonCreds), BBS+ Signatures (IETF draft 2024) for selective disclosure from W3C VCs, EdDSA and ECDSA for standard signatures, SD-JWT (IETF RFC 9891, 2024) for EUDI Wallet credential format, and ECDH-1PU / XChacha20Poly1305 for DIDComm message encryption — establishing SSI as one of the most cryptographically rich deployed identity architectures in existence.

- ### Semantic Classification
  - owl-class:: identity:SelfSovereignIdentity
  - owl-role:: IdentityParadigm
  - owl-inferred:: identity:DecentralisedIdentity, identity:UserCentricIdentity, identity:PrivacyEnhancingTechnology
  - belongs-to-domain:: [[IdentityDomain]], [[BlockchainDomain]], [[PrivacyDomain]], [[CryptographyDomain]]
  - implemented-in-layer:: [[ProtocolLayer]], [[ApplicationLayer]], [[GovernanceLayer]]

- ### Relationships
  - is-subclass-of:: [[Decentralised Identity]], [[Privacy-Enhancing Technology]], [[Digital Identity]], [[User-Centric Identity]], [[Cryptographic Protocol]], [[Trust Framework]]
  - has-part:: [[Decentralized Identifiers]], [[Verifiable Credentials]], [[Digital Wallet]], [[DIDComm]], [[Verifiable Data Registry]], [[Credential Schema]], [[Revocation Registry]], [[Selective Disclosure]], [[Zero-Knowledge Proof]], [[DID Document]], [[Credential Definition]], [[Link Secret]]
  - requires:: [[Public Key Cryptography]], [[Decentralized Identifiers]], [[Verifiable Data Registry]], [[Trust Framework]], [[Governance Framework]], [[Key Management]], [[Wallet Software]], [[Blockchain Oracle]], [[Issuer Agent]], [[Verifier Agent]]
  - enables:: [[Selective Disclosure]], [[Correlation Resistance]], [[Portable Identity]], [[Privacy-Preserving KYC]], [[Cross-Border Identity]], [[Reusable Identity Verification]], [[Offline Verification]], [[Zero-Knowledge Predicate Proof]], [[Holder Binding]]
  - implements:: [[W3C DID Core]], [[W3C Verifiable Credentials]], [[DIDComm v2]], [[OpenID for Verifiable Credentials]], [[AnonCreds]], [[Trust Over IP Stack]], [[ISO 18013-5]], [[SD-JWT]], [[BBS+ Signatures]]
  - depends-on:: [[Cryptography]], [[Blockchain Technology]], [[Zero-Knowledge Proofs]], [[Public Key Infrastructure]], [[eIDAS]], [[GDPR]], [[W3C Standards]], [[JSON-LD]], [[CBOR]]
  - supports:: [[AML KYC Compliance]], [[GDPR]], [[eIDAS]], [[Digital Government]], [[Healthcare Identity]], [[Educational Credentials]], [[Supply Chain Provenance]], [[IoT Security]], [[Agent Frameworks]]
  - uses:: [[Camenisch-Lysyanskaya Signatures]], [[BBS+ Signatures]], [[EdDSA]], [[JSON-LD]], [[CBOR]], [[Sidetree Protocol]], [[IPFS]], [[ECDH-1PU]], [[XChacha20Poly1305]], [[Bitstring Status List]]
  - contrasts-with:: [[Centralised Identity]], [[Federated Identity]], [[OAuth]], [[SAML]], [[OpenID Connect]], [[LDAP]], [[X.509 PKI]]
  - related-to:: [[Access Control System]], [[Blockchain Network]], [[CBDC Frameworks]], [[AI Risks]], [[Algorithmic Bias and Variance]], [[Brain Computer Interfaces]], [[API Gateway]], [[Agents]], [[Blockchain Interoperability]]
  - standardized-by:: [[W3C]], [[Decentralized Identity Foundation]], [[OpenID Foundation]], [[Trust Over IP Foundation]], [[ISO]], [[ETSI]], [[IETF]], [[Hyperledger Foundation]]
...
- ### Provenance
  - sources:: Allen 2016 SSI Path; W3C DID Core REC July 2022; W3C VC Data Model v2.0 REC May 2025; EU eIDAS 2.0 Regulation 2024/1183; EUDI ARF v1.4 November 2024; Sovrin Governance Framework v4 2021; Trust Over IP Technology Architecture Specification v2.0 2024; AnonCreds Specification v1.0 Hyperledger 2023; DIDComm Messaging v2.0 DIF 2022; OID4VCI/OID4VP OpenID Foundation v1.0 2024; SD-JWT IETF RFC 9891 2024; DSIT DIATF September 2024; OIX Reusable Digital Identity 2024; GOV.UK One Login Technical Docs GDS 2024; Preukschat-Reed Self-Sovereign Identity Manning 2021; Windley Learning Digital Identity O'Reilly 2023; IBM Cost of Data Breach 2023; GAIN POC Report 2022; Edinburgh BLT PQ-AnonCreds Research 2025; Newcastle TrustEd UKRI Report 2024; Cameron Laws of Identity Microsoft 2005; Camenisch-Lysyanskaya EUROCRYPT 2001; Camenisch-Lysyanskaya SCN 2002; Brands MIT Press 2000; Muhle SSI Survey Computer Science Review 2018; Bernabe Privacy Blockchain IEEE Access 2019; EPRS Blockchain GDPR 2019; World Bank Global Findex 2023
