schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/robotics#SwarmRobot
legacy_uri:: urn:visionclaw:concept:robotics:swarm-robot
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-837a2866a079"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/robotics#SwarmRobot"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:robotics:swarm-robot"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:eae19c1ba05cd32a9ffc5c323b2ec12bc9c3981f5bd08e29f8a065fd6bb091ae@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:swarm-robot",
  "@type": "OntologyClass",
  "label": "Swarm Robot",
  "subClassOf": [
    {
