...
```json-ld
{
  ...
  "relations": {
    "uses": [
      ...
      {"@id": "urn:ngm:class:differential-flatness", "label": "Differential Flatness"}
    ],
    "dependsOn": [
    ...
    "enables": [
      ...
      {"@id": "urn:ngm:class:drone-flight-control", "label": "Drone Flight Control"}
    ],
    "requires": [
      {"@id": "urn:ngm:class:reference-trajectory", "label": "Reference Trajectory"},
      {"@id": "urn:ngm:class:error-dynamics", "label": "Error Dynamics"}
    ],
    "hasPart": [
      {"@id": "urn:ngm:class:feedforward-control", "label": "Feedforward Control"},
      {"@id": "urn:ngm:class:tracking-error-metric", "label": "Tracking Error Metric"}
    ],
    "contrastsWith": [
      {"@id": "urn:ngm:class:path-following-control", "label": "Path Following Control"},
      {"@id": "urn:ngm:class:setpoint-regulation", "label": "Setpoint Regulation"}
    ],
    "relatedTo": [
  ...
  "sameAs": [
    {"@id": "urn:ngm:class:reference-tracking-control", "label": "Reference Tracking Control"}
  ],
  "provenance": {
