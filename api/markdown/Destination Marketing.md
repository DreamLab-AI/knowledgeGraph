schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#DestinationMarketing
legacy_uri:: urn:visionclaw:concept:spatial-computing:destination-marketing
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-68502a303f6e"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#DestinationMarketing"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:destination-marketing"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
