...
```json-ld
{
  ...
  "@id": "urn:visionflow:page:autonomous-proof-generation",
  "@type": "Page",
  "vc:slug": "autonomous-proof-generation",
  "title": "Autonomous Proof Generation",
  "vc:public": true,
  "vc:outboundWikilinks": ["Alethea Agent", "Deep Think"],
  "vc:schemaVersion": 2
}
```
...
```json-ld
{
  ...
  "@id": "urn:ngm:class:autonomous-proof-generation",
  "@type": "Class",
  "label": "Autonomous Proof Generation",
  ...
  "relations": {
    "relatedTo": [{"@id": "urn:ngm:class:model", "label": "Model"}, {"@id": "urn:ngm:class:alethea-agent", "label": "Alethea Agent"}]
  },
  "provenance": {
