...
```json-ld
{
  ...
  "relations": {
    ...
    "enables": [
      ...
      {"@id": "urn:ngm:class:digital-asset-marketplace", "label": "Digital Asset Marketplace"}
    ],
    "requires": [
    ...
    "implements": [
      ...
      {"@id": "urn:ngm:class:eip-1155", "label": "EIP-1155"}
    ],
    "contrastsWith": [
      {"@id": "urn:ngm:class:erc-20", "label": "ERC-20"},
      {"@id": "urn:ngm:class:erc-721", "label": "ERC-721"},
      {"@id": "urn:ngm:class:erc-4626", "label": "ERC-4626"}
    ],
    "relatedTo": [
      {"@id": "urn:ngm:class:token-metadata-uri", "label": "Token Metadata URI"},
      {"@id": "urn:ngm:class:openzeppelin", "label": "OpenZeppelin"},
      {"@id": "urn:ngm:class:opensea", "label": "OpenSea"},
  ...
  "sameAs": [
    {"@id": "urn:ngm:class:eip-1155", "label": "EIP-1155"},
    {"@id": "urn:ngm:class:multi-token-standard", "label": "Multi-Token Standard"}
  ],
  "quality": 0.74,
  "provenance": {
