schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#ControlAlgorithm
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:control-algorithm
public:: true
...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:embedded-system-layer",
      "vc:label": "EmbeddedSystemLayer"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-ca9f3e8b1044"
    },
    {
      "vc:key": "context",
    ...
    },
    {
      ...
      "vc:value": "robotics -> artificial-intelligence"
    },
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#ControlAlgorithm"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:control-algorithm"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:control-algorithm:776c802a9fc9",
  ...
  "vc:resolutions": [
    {
      "raw": "[[Actuator Model]]",
      "resolved": "urn:visionflow:linked:actuator-model",
      "kind": "StubLink"
    },
    {
      "raw": "[[Adaptation Law]]",
      "resolved": "urn:visionflow:linked:adaptation-law",
      "kind": "StubLink"
    },
    {
      "raw": "[[Aerospace]]",
      "resolved": "urn:visionflow:linked:aerospace",
      "kind": "StubLink"
    },
    {
      "raw": "[[AlgorithmLayer]]",
    ...
    {
      "raw": "[[Chemical Process Control]]",
      "resolved": "urn:visionflow:linked:chemical-process-control",
      "kind": "StubLink"
    },
    {
      "raw": "[[Computational Intelligence]]",
      "resolved": "urn:visionflow:linked:computational-intelligence",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[EmbeddedSystemLayer]]",
      "resolved": "urn:visionflow:linked:embedded-system-layer",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Fault-Tolerant Control]]",
      "resolved": "urn:visionflow:linked:fault-tolerant-control",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[H-Infinity Control]]",
      "resolved": "urn:visionflow:linked:h-infinity-control",
      "kind": "StubLink"
    },
    {
      "raw": "[[Hardware-in-the-Loop Testing]]",
      "resolved": "urn:visionflow:linked:hardware-in-the-loop-testing",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[IEC 61511]]",
      "resolved": "urn:visionflow:linked:iec-61511",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Iterative Learning Control]]",
      "resolved": "urn:visionflow:linked:iterative-learning-control",
      "kind": "StubLink"
    },
    {
      "raw": "[[Linear Algebra]]",
    ...
    {
      "raw": "[[Receding Horizon]]",
      "resolved": "urn:visionflow:linked:receding-horizon",
      "kind": "StubLink"
    },
    {
      "raw": "[[Reference Model]]",
    ...
    {
      "raw": "[[Reward Signal]]",
      "resolved": "urn:visionflow:linked:reward-signal",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Safety Constraint]]",
      "resolved": "urn:visionflow:linked:safety-constraint",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Sensor Feedback]]",
      "resolved": "urn:visionflow:linked:sensor-feedback",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Switching Surface]]",
      "resolved": "urn:visionflow:linked:switching-surface",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[PID Controller]]",
      "resolved": "urn:visionflow:owl:class:pid-controller",
      "kind": "ResolvedLink"
    },
    {
...
- ### Definition
  - ControlAlgorithm is a formalised mathematical and computational procedure that generates actuator commands to drive a dynamic system from its current state toward a desired target state, exploiting feedback from sensors, an internal model of the plant, or learned approximations of system dynamics, and spanning a hierarchy of algorithmic families: classical proportional–integral–derivative (PID) control achieving steady-state error cancellation via u(t) = K_p·e(t) + K_i·∫e dt + K_d·(de/dt); Linear Quadratic Regulator (LQR) minimising the infinite-horizon quadratic cost J = ∫₀^∞(x^T·Q·x + u^T·R·u)dt by solving the algebraic Riccati equation P·A + A^T·P − P·B·R⁻¹·B^T·P + Q = 0 to obtain optimal gain K* = R⁻¹·B^T·P; Model Predictive Control (MPC) solving a receding-horizon finite-time constrained optimisation min_{u} Σ_{k=0}^{N−1}[x_k^T·Q·x_k + u_k^T·R·u_k] + x_N^T·P_f·x_N subject to state and input constraint polytopes at each sample step; H-infinity (H∞) robust control minimising the L₂-induced gain from disturbance w to performance output z (‖T_{zw}‖_∞ < γ) via two-Riccati or LMI synthesis; sliding mode control (SMC) driving trajectories onto a switching surface s(x) = 0 in finite time via u = u_eq − K·sign(s), then maintaining invariance where reduced-order dynamics are robust to matched disturbances; adaptive control including MRAS and L1 adaptive control updating parameters online via Lyapunov-stable laws θ̇ = −Γ·φ·e; iterative learning control (ILC) refining feedforward commands across trials as u_{k+1}(t) = u_k(t) + L·e_k(t); and reinforcement learning (RL)-based policies π: S → A learned via PPO, TD3, SAC, or physics-informed PI-DDPG — collectively enabling industrial process control, autonomous vehicles, aerospace, surgical robotics, soft robotics, power grid frequency regulation, and humanoid locomotion, with 2024–2026 advances centred on data-driven adaptive MPC, physics-informed neural controllers, safe RL with Control Barrier Functions, and embedded deployment on NVIDIA Jetson Orin achieving sub-20 ms solve cycles.

- ### Semantic Classification
  - owl-class:: artificial-intelligence:ControlAlgorithm
  - owl-role:: ComputationalProcedure
  - owl-inferred:: ai:OptimisationMethod, ai:FeedbackMechanism, ai:LearnedPolicy, ai:RobustMethod
  - belongs-to-domain:: [[AI-GroundedDomain]], [[ControlEngineeringDomain]], [[RoboticsDomain]], [[AutomationDomain]]
  - implemented-in-layer:: [[AlgorithmLayer]], [[EmbeddedSystemLayer]], [[ApplicationLayer]]

- ### Relationships
  - is-subclass-of:: [[Control Theory]], [[Feedback Control]], [[Optimal Control]], [[Computational Intelligence]], [[Dynamical Systems]]
  - has-part:: [[PID Controller]], [[Cost Function]], [[State Observer]], [[Kalman Filter]], [[Receding Horizon]], [[Switching Surface]], [[Adaptation Law]], [[Reward Signal]], [[Safety Constraint]], [[Reference Model]]
  - requires:: [[State Space]], [[Plant Model]], [[Sensor Feedback]], [[Actuator Model]], [[Stability Analysis]], [[Constraint Specification]]
  - enables:: [[Autonomous Systems]], [[Robotics]], [[Process Automation]], [[Force Control]], [[Motion Planning]], [[Energy Management]], [[Fault-Tolerant Control]]
  - implements:: [[PID Controller]], [[Model Predictive Control]], [[Reinforcement Learning]], [[Adaptive Control]], [[Sliding Mode Control]], [[Iterative Learning Control]], [[H-Infinity Control]], [[Linear Quadratic Regulator]]
  - depends-on:: [[Linear Algebra]], [[Optimisation]], [[Probability Theory]], [[Differential Equations]], [[Lyapunov Stability]], [[Convex Optimisation]], [[Neural Networks]]
...
- ### Content
  ...
  ## Compositional Relationships (Components)
	  ...
	  FunctionalDataProperty(ai:pidDeploymentShare)
	  FunctionalDataProperty(ai:mpcSolveTimeMs)
	  ```
  ...
  - **H∞ control** minimises the H∞-norm of the closed-loop transfer matrix T_{zw} from disturbance input w to performance output z: ‖T_{zw}‖_∞ = sup_{ω≥0} σ_max(T_{zw}(jω)) < γ, bounding the maximum energy amplification from disturbance to performance across all frequencies and all bounded disturbance inputs, providing deterministic worst-case robustness guarantees.
  ...
  - **ILC convergence speed and practical considerations**: the convergence rate of P-type ILC is bounded by ‖I − L·G‖_∞ < 1, with ρ = ‖I − L·G‖_∞ ∈ (0,1) determining the contraction factor per trial. For ρ = 0.5, error halves each trial; for ρ = 0.9, 22 trials are needed to reduce error by 90%. Norm-optimal ILC achieves the minimum ρ for a given trial cost, but requires accurate plant model G. In practice, model uncertainty increases ρ above its nominal value and can cause divergence if ‖ΔG‖ is too large. Robust ILC designs (Q-filter ILC) insert a low-pass Q-filter into the learning operator: u_{k+1} = Q·(u_k + L·e_k), accepting slower convergence in exchange for robustness to high-frequency model uncertainty.
  ...
  - **RL-based control** formulates controller synthesis as a sequential decision problem: an agent observing state s_t ∈ S selects action a_t ∈ A (the control input u), receives reward r_t = −(‖x_t − x_ref‖_Q² + ‖u_t‖_R²) encoding tracking and effort objectives (plus a large penalty for constraint violation), and transitions to s_{t+1} according to plant dynamics. The goal is π*(s) = argmax_π E[Σ_{t=0}^∞ γ^t·r_t | π] without explicit plant model knowledge.
  ...
  - **RL reward shaping for control**: reward design is as important as algorithm choice. Tracking reward r_track = −‖x − x_ref‖_Q² provides the primary signal; regularisation reward r_reg = −‖u‖_R² discourages excessive control effort; smoothness reward r_smooth = −‖u_t − u_{t-1}‖² penalises jerky commands; contact reward r_contact = +δ for desired contact events in locomotion; safety penalty r_safety = −M·1[constraint violated] for large penalty M during training. **Curriculum learning** progressively increases task difficulty — starting with simple flat terrain and gradually introducing steps, slopes, and debris for locomotion training — reducing training time 3–5× compared to full-difficulty training from scratch.
  ...
  - **Performance comparison across algorithm families**:
	  ...
	  PID: 3 parameters, microsecond compute, no formal constraint handling, 90% of deployed loops.
	  Serves: SISO loops, temperature/pressure/flow, motor speed, simple position.
	  Weakness: no constraint handling beyond saturation; no multi-variable coupling; manual tuning burdensome.

	  LQR / LQG: minutes to hours for design, microsecond compute, no constraint handling, optimal for nominal model.
	  Serves: aerospace attitude control, hard disk drives, active noise cancellation, satellite stabilisation.
	  Weakness: fragile to unmodelled dynamics; no input/state constraints; requires full state measurement or observer.

	  Linear MPC: hours for design + offline QP matrices, 1–50 ms per step QP solve, full hard/soft constraint handling.
	  Serves: refinery columns, HVAC multi-zone, autonomous vehicle lane-keeping, battery energy storage frequency regulation.
	  Weakness: loses stability guarantees for strongly nonlinear plants; QP solve can miss deadline on slow hardware.

	  NMPC: days for design + NLP setup, 5–100 ms per step, full constraint handling, nonlinear model accuracy.
	  Serves: aggressive drone racing, chemical reactor, underwater vehicles, spacecraft proximity operations.
	  Weakness: computationally intensive; real-time guarantee harder; requires accurate nonlinear model.

	  H-infinity: weeks for design + LMI/Riccati solve, microsecond runtime, no explicit constraint handling, worst-case robustness.
	  Serves: flexible aerospace structures, robust autopilots, active vibration control, chemical plants with model uncertainty.
	  Weakness: can be overly conservative; no constraint handling; requires uncertainty model specification.

	  Sliding Mode: hours for design, microseconds runtime, surface defines constraints, robust to matched disturbances.
	  Serves: power converters, motor drives, UAV attitude, robot force control, underwater vehicles.
	  Weakness: chattering; matched disturbance restriction; non-smooth control signal may excite flexible modes.

	  Adaptive (MRAS/L1): days for design + stability proof, microseconds + integration overhead, no explicit constraints, handles parameter drift.
	  Serves: aircraft with fuel burn mass change, robots with varying payloads, soft robots, wind turbine pitch control.
	  Weakness: requires persistent excitation; transient instability risk; no constraint handling.

	  ILC: hours for design, batch update (offline between trials), constraint encoded in cost, zero error for periodic tasks.
	  Serves: wafer scanners, robotic welding, injection moulding, AFM scanning, repetitive industrial processes.
	  Weakness: cannot reject non-repetitive disturbances; requires task repetition; sensitive to model uncertainty.

	  DRL + CBF: weeks/months for training, 0.1–5 ms inference + 0.1–1 ms CBF QP, formal safety via CBF, task-flexible.
	  Serves: complex manipulation, legged locomotion, autonomous racing, multi-robot coordination.
	  Weakness: sample-hungry training; sim-to-real gap; not yet certifiable for safety-critical aerospace/automotive.
  ...
  - ## Metadata
  - **Domain correction**: original stub `domain:: robotics` corrected to `domain:: artificial-intelligence` because control algorithms are foundational computational methods within the AI and computational-intelligence ontological hierarchy. Robotics is a downstream application domain. IRI, URI, same-as, and owl-class prefix all updated from `robotics:` to `artificial-intelligence:` namespace, documented per Phase 6 enrichment protocol.
  - **Term ID**: assigned `AI-2041` in the AI-XXXX four-digit sequence per validator format rule.
  - **Version**: bumped to `2.1.0` from `2.0.0` reflecting substantial content enrichment with full 5-section structure, 8 algorithm family deep-dives, and 2024–2026 research integration.
  - **Quality score**: raised to `0.52` reflecting research-backed multi-family coverage with validated 2024–2026 findings across 27 references.
  - **Authority score**: `0.87` reflecting comprehensive academic, industry, and UK context.
  - **Enrichment date**: 2026-05-16. Worker model: claude-sonnet-4-6.
