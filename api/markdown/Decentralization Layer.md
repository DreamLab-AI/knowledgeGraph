schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#DecentralizationLayer
legacy_uri:: urn:visionclaw:concept:spatial-computing:decentralization-layer
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-86cff08592eb"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#DecentralizationLayer"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:decentralization-layer"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:aa094da312b653c1057214524edaaa4048dfb0aceb5c828b0e8197a2dc63113a@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
