schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#EContractArbitration
legacy_uri:: urn:visionclaw:concept:spatial-computing:e-contract-arbitration
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-b1c25f268619"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#EContractArbitration"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:e-contract-arbitration"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
