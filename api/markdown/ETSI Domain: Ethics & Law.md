schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#ETSIDomainEthicsLaw
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:etsi-domain-ethics-law
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-6de595581e7a"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#ETSIDomainEthicsLaw"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:etsi-domain-ethics-law"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
...
- ### Definition
  - Domain marker for ETSI metaverse categorisation covering ethical frameworks, legal compliance, regulatory requirements, and responsible governance structures for virtual environments.
...
- ### Content
  ETSI Domain: Ethics & Law — content pending enrichment.
