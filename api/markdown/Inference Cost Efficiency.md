...
```json-ld
{
  ...
  "vc:public": true,
  "vc:outboundWikilinks": ["Bridgebench", "GLM 5.2"],
  "vc:schemaVersion": 2
}
```
...
```json-ld
{
  ...
  "relations": {
    "relatedTo": [{"@id": "urn:ngm:class:model", "label": "Model"}, {"@id": "urn:ngm:class:inference", "label": "Inference"}, {"@id": "urn:ngm:class:model-performance", "label": "Model Performance"}]
  },
  "provenance": {
