schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#Recall
legacy_uri:: urn:visionclaw:concept:spatial-computing:recall
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-fe3016490030"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#Recall"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:recall"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
