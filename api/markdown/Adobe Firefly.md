...
```json-ld
{
  ...
  "relations": {
    "hasPart": [
      ...
      {
        "@id": "urn:ngm:class:text-effects-generation",
        "label": "Text Effects Generation"
      },
      {
        "@id": "urn:ngm:class:firefly-video-model",
        "label": "Firefly Video Model"
      },
      {
        "@id": "urn:ngm:class:firefly-custom-models",
        "label": "Firefly Custom Models"
      }
    ],
    "partOf": [
      {
    ...
    "enables": [
      ...
      {
        "@id": "urn:ngm:class:creative-workflow-automation",
