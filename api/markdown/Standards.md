schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#Standards
legacy_uri:: urn:visionclaw:concept:spatial-computing:standards
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-4e85c2854bdb"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#Standards"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:standards"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
