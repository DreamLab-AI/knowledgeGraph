schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#StandardizedAssetClassification
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:standardized-asset-classification
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-91d3d2f8cf7f"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#StandardizedAssetClassification"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:standardized-asset-classification"
    },
    {
      "vc:key": "status",
      "vc:value": "active"
