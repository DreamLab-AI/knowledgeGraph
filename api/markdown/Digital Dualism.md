schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#DigitalDualism
legacy_uri:: urn:visionclaw:concept:spatial-computing:digital-dualism
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-800d8383fdbe"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#DigitalDualism"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:digital-dualism"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:eddecfa06478b1c60af9fdc5a2d788effa50f884f647325d3b75147c27841ec9@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:digital-dualism",
  "@type": "OntologyClass",
  ...
  "definition": "Digital Dualism is a concept within the mv domain. bridges-to:: [[Telecollaboration]]",
  "vc:qualityScore": {
    "@value": "0.50",
    "@type": "xsd:float"
  },
