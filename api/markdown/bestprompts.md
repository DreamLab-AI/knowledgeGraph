schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#Bestprompts
legacy_uri:: urn:visionclaw:concept:infrastructure:bestprompts
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-f7dcb14ce5a8"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#Bestprompts"
    },
    {
      "vc:key": "maturity",
      "vc:value": "draft"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:bestprompts"
    },
    {
      "vc:key": "status",
      "vc:value": "stub"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:187f8b1dbe9077d32efa568393441b9e1bff10e948b7771c04d1b4849d14d1c6@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:bestprompts",
  "@type": "OntologyClass",
  "label": "bestprompts",
  "subClassOf": [
    {
  ...
  "definition": "bestprompts is a concept within the ngm domain.",
  "vc:qualityScore": {
    "@value": "0.50",
    "@type": "xsd:float"
  },
