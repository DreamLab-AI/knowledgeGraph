schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#DisputeResolutionMechanism
legacy_uri:: urn:visionclaw:concept:spatial-computing:dispute-resolution-mechanism
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-d5c6a2bccac9"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#DisputeResolutionMechanism"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:dispute-resolution-mechanism"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
