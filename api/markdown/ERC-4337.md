...
```json-ld
{
  ...
  "relations": {
    "hasPart": [
      {"@id": "urn:ngm:class:useroperation", "label": "UserOperation"},
      {"@id": "urn:ngm:class:bundler", "label": "Bundler"},
      {"@id": "urn:ngm:class:entrypoint-contract", "label": "EntryPoint Contract"},
      {"@id": "urn:ngm:class:paymaster", "label": "Paymaster"}
    ],
    "requires": [
      {"@id": "urn:ngm:class:user-operation-mempool", "label": "User Operation Mempool"},
    ...
    "contrastsWith": [
      ...
      {"@id": "urn:ngm:class:eip-2938", "label": "EIP-2938"}
    ],
    "relatedTo": [
      ...
      {"@id": "urn:ngm:class:erc-7579", "label": "ERC-7579"},
      {"@id": "urn:ngm:class:eip-7702", "label": "EIP-7702"},
  ...
  "sameAs": [
    {"@id": "urn:ngm:class:eip-4337", "label": "EIP-4337"}
  ],
  "quality": 0.72,
  "provenance": {
