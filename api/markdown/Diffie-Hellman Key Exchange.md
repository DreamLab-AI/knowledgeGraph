```json-ld
{
  ...
  "@id": "urn:visionflow:page:diffie-hellman-key-exchange",
  "@type": "Page",
  "title": "Diffie-Hellman Key Exchange",
  "vc:slug": "diffie-hellman-key-exchange",
  "vc:public": true,
  "vc:schemaVersion": 2,
...
```json-ld
{
  ...
  "relations": {
    ...
    "enables": [
      {
        "@id": "urn:ngm:class:perfect-forward-secrecy",
  ...
  "sameAs": [
    {
      "@id": "urn:ngm:class:dh-key-exchange",
