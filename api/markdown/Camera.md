- ### OntologyBlock
  ...
  collapsed:: true
	...
	- source:: [[IEEE]], [[ISO/IEC]], [[Robotics Research]], [[Computer Vision Standards]]
	- owl:class:: rb:Camera
	- owl:role:: SensorDevice
	- is-subclass-of:: [[Sensor]], [[VisualPerception]]
	- belongsToDomain:: [[RoboticsDomain]], [[ComputerVisionDomain]]
	...
	- related-to:: [[DepthCamera]], [[RGBCamera]], [[ThermalCamera]], [[EventCamera]], [[StereoVision]]
...
(AnnotationAssertion rdfs:comment :Camera "An imaging sensor device that captures visual information in robotics systems, enabling computer vision applications including object detection, SLAM, 3D reconstruction, visual servoing, and semantic scene understanding through various modalities (RGB, depth, thermal, event-based) and technologies (CCD, CMOS, ToF, structured light)."@en)

;; Data Properties
(AnnotationAssertion dcterms:identifier :Camera "RB-0076"^^xsd:string)

;; SubClass relationships
(SubClassOf :Camera :Sensor)
(SubClassOf :Camera :VisualPerceptionDevice)

;; Object properties
(SubClassOf :Camera
  (ObjectSomeValuesFrom :hasPart :ImageSensor))
(SubClassOf :Camera
  (ObjectSomeValuesFrom :hasPart :Lens))
(SubClassOf :Camera
  (ObjectSomeValuesFrom :enables :ComputerVision))
```
...
- ## About Camera
	...
	- ### References
	  ...
	  - **Verification**: Academic sources verified, specifications current as of 2026
	  - **Regional Context**: UK/North England robotics ecosystem
	  - **Authority Score**: 0.91 (based on IEEE, ISO/IEC standards, peer-reviewed literature)