...
```json-ld
{
  ...
  "relations": {
    "partOf": [
      ...
      {"@id": "urn:ngm:class:machinery-safety", "label": "Machinery Safety"}
    ],
    "requires": [
      {"@id": "urn:ngm:class:hazard-and-risk-assessment", "label": "Hazard and Risk Assessment"},
      {"@id": "urn:ngm:class:safety-integrity-level", "label": "Safety Integrity Level"},
      {"@id": "urn:ngm:class:safety-lifecycle", "label": "Safety Lifecycle"}
    ],
    "implements": [
      {"@id": "urn:ngm:class:iec-61508", "label": "IEC 61508"},
      {"@id": "urn:ngm:class:risk-reduction", "label": "Risk Reduction"}
    ],
    "enables": [
      {"@id": "urn:ngm:class:ce-marking", "label": "CE Marking"},
      {"@id": "urn:ngm:class:machinery-directive", "label": "Machinery Directive"},
      {"@id": "urn:ngm:class:safety-validation", "label": "Safety Validation"}
    ],
    "dependsOn": [
      {"@id": "urn:ngm:class:failure-mode-and-effects-analysis", "label": "Failure Mode and Effects Analysis"},
      {"@id": "urn:ngm:class:diagnostic-coverage", "label": "Diagnostic Coverage"}
    ],
    "uses": [
      {"@id": "urn:ngm:class:programmable-electronic-system", "label": "Programmable Electronic System"},
      {"@id": "urn:ngm:class:safety-related-control-system", "label": "Safety-Related Control System"},
      {"@id": "urn:ngm:class:probability-of-failure-on-demand", "label": "Probability of Failure on Demand"}
    ],
    "contrastsWith": [
    ...
    "relatedTo": [
      ...
      {"@id": "urn:ngm:class:hardware-fault-tolerance", "label": "Hardware Fault Tolerance"},
      {"@id": "urn:ngm:class:safety-instrumented-system", "label": "Safety Instrumented System"}
    ],
    "bridgesTo": [
  ...
  "sameAs": [
    {"@id": "urn:ngm:class:srecs-standard", "label": "SRECS Standard"}
  ],
  "provenance": {
