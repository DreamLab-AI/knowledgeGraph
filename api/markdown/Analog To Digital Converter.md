schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#AnalogToDigitalConverter
legacy_uri:: urn:visionclaw:concept:spatial-computing:analog-to-digital-converter
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-ea756ed029b0"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#AnalogToDigitalConverter"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:analog-to-digital-converter"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
