...
- ### Content
  ...
  - **Regulatory Uncertainty as Structural Harm**:
    ...
    - SEC enforcement-as-rulemaking (Gensler era) created no clear safe harbour standards; projects [private] not obtain advance guidance on securities status without risking enforcement
  ...
  - **John Coates** (Harvard Law School, former SEC Acting Chief Economist) published "The Problem of Twelve" (New York University Law Review 2018) on [private] fund concentration risks — methodology applied to concentrated governance token ecosystems (Compound, MakerDAO, Uniswap) as analogous investor-democracy distortions.
