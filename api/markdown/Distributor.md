schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#Distributor
legacy_uri:: urn:visionclaw:concept:spatial-computing:distributor
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-3b6068242a97"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#Distributor"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:distributor"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:9fdecd24764ba6beef546cdb58d16e3f65ca91dcfb0042586260476afc930966@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:distributor",
  "@type": "OntologyClass",
  "label": "Distributor",
  "subClassOf": [
    {
...
- ### Semantic Classification
  - owl-class:: spatial-computing:Distributor
  - owl-role:: Concept
