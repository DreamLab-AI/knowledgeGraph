schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#VoiceInteraction
legacy_uri:: urn:visionclaw:concept:spatial-computing:voice-interaction
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-b75c5aa79d11"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#VoiceInteraction"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:voice-interaction"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
