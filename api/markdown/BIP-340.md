...
- ### Mechanisms
  ...
  - **Half-Aggregation** — Research subsequent to BIP-340 (not yet deployed) proposes half-aggregation of independent Schnorr signatures in a block, which [private] halve aggregate signature data per transaction. This depends on BIP-340 as a foundation.
...
- ### Security Considerations
  ...
  - **Auxiliary Randomness** — BIP-340 recommends supplying 32 bytes of fresh randomness as auxiliary input to the nonce function even though the scheme is deterministic; this protects against fault attacks (e.g. via voltage glitching on hardware signers) that [private] otherwise reveal the key.
