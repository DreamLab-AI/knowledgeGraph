...
```json-ld
{
  ...
  "sameAs": [
    {"@id": "urn:ngm:class:bitcoin-schnorr-signatures", "label": "Bitcoin Schnorr Signatures"}
  ],
  "relations": {
    "relatedTo": [
    ...
    "uses": [
      ...
      {"@id": "urn:ngm:class:bip32-hierarchical-deterministic-wallets", "label": "BIP-32 HD Wallets"}
    ],
    "partOf": [
      {"@id": "urn:ngm:class:taproot-soft-fork", "label": "Taproot Soft Fork"}
    ],
    "supports": [
      {"@id": "urn:ngm:class:bitcoin-privacy", "label": "Bitcoin Privacy"},
