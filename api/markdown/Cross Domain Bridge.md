schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#CrossDomainBridge
legacy_uri:: urn:visionclaw:concept:infrastructure:cross-domain-bridge
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-b0e372c212de"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#CrossDomainBridge"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:cross-domain-bridge"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:4ba643dbe185b863492c9690cf7badb5fac0b0fc9ddee61bb0322110421be6ea@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:cross-domain-bridge",
  "@type": "OntologyClass",
