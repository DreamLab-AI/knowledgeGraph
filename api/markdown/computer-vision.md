...
- ### Semantic Classification
  - owl-class:: artificial-intelligence:ComputerVision
  - owl-role:: Concept
  - belongs-to-domain:: [[ArtificialIntelligenceDomain]]

- ### Relationships
  - depends-on:: [[Convolutional Neural Network]], [[Deep Learning]], [[Neural Networks]]
  - has-part:: [[Image Classification]], [[Object Detection]], [[Semantic Segmentation]], [[3D Reconstruction]], [[Motion Tracking]]
  - enables:: [[Medical Imaging AI]], [[Autonomous Vehicle Navigation]], [[Robotics Perception]], [[Quality Control]], [[Surveillance Systems]]
  - bridges-to:: [[Robotics]] (domain: rb), [[Digital Twin]] (domain: ngm), [[Artificial Intelligence]] (domain: ai), [[IoT Sensors]] (domain: iot)
  - requires:: [[Image Processing]], [[Feature Extraction]], [[Pattern Recognition]]
