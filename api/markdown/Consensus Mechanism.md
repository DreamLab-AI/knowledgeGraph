schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#ConsensusMechanism
legacy_uri:: urn:visionclaw:concept:blockchain:consensus-mechanism
public:: true
...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "consensus-mechanism",
  "title": "Consensus Mechanism",
  "vc:public": true,
  "vc:outboundWikilinks": [
    {
      "@id": "urn:visionflow:linked:aleph-zero",
      "vc:label": "Aleph Zero"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:aptos-bft",
      "vc:label": "AptosBFT"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:babe",
      "vc:label": "BABE"
    },
    {
      "@id": "urn:visionflow:linked:babel-et-al-2024-mysticeti",
      "vc:label": "Babel et al 2024 Mysticeti"
    },
    {
      "@id": "urn:visionflow:linked:baird-2016-hashgraph-swirlds",
      "vc:label": "Baird 2016 Hashgraph Swirlds"
    },
    {
      "@id": "urn:visionflow:linked:bft",
      "vc:label": "BFT"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:bullshark",
      "vc:label": "Bullshark"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:cambridge-computer-laboratory-distributed-systems",
      "vc:label": "Cambridge Computer Laboratory Distributed Systems"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:carnot",
      "vc:label": "Carnot"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:cft",
      "vc:label": "CFT"
    },
    {
      "@id": "urn:visionflow:linked:conflict-free-replicated-data-type",
      "vc:label": "Conflict-free Replicated Data Type"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:coordination-domain",
      "vc:label": "CoordinationDomain"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:diem-bft",
      "vc:label": "DiemBFT"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:dwork-lynch-stockmeyer-1988-partial-synchrony",
      "vc:label": "Dwork Lynch Stockmeyer 1988 Partial Synchrony"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:edinburgh-blockchain-technology-laboratory",
      "vc:label": "Edinburgh Blockchain Technology Laboratory"
    },
    {
      "@id": "urn:visionflow:linked:epaxos",
      "vc:label": "EPaxos"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:ghost",
      "vc:label": "GHOST"
    },
    {
      "@id": "urn:visionflow:linked:ghost-dag",
      "vc:label": "GhostDAG"
    },
    {
      "@id": "urn:visionflow:linked:gilad-et-al-2017-algorand-sosp",
      "vc:label": "Gilad et al 2017 Algorand SOSP"
    },
    {
      "@id": "urn:visionflow:linked:grandpa",
      "vc:label": "GRANDPA"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:hot-stuff-2",
      "vc:label": "HotStuff-2"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:iohk-cardano-research",
      "vc:label": "IOHK Cardano Research"
    },
    {
      "@id": "urn:visionflow:linked:iota-2-0",
      "vc:label": "IOTA 2.0"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:junqueira-reed-serafini-2011-zab",
      "vc:label": "Junqueira Reed Serafini 2011 Zab"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:malkhi-naor-wong-2023-hot-stuff-2",
      "vc:label": "Malkhi Naor Wong 2023 HotStuff-2"
    },
    {
      "@id": "urn:visionflow:linked:moraru-andersen-kaminsky-2013-epaxos",
      "vc:label": "Moraru Andersen Kaminsky 2013 EPaxos"
    },
    {
      "@id": "urn:visionflow:linked:multi-paxos",
      "vc:label": "Multi-Paxos"
    },
    {
      "@id": "urn:visionflow:linked:mysticeti",
      "vc:label": "Mysticeti"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:narwhal",
      "vc:label": "Narwhal"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:nist-fips-204-crystals-dilithium-2024",
      "vc:label": "NIST FIPS 204 CRYSTALS-Dilithium 2024"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:oki-liskov-1988-viewstamped-replication",
      "vc:label": "Oki Liskov 1988 Viewstamped Replication"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:pease-shostak-lamport-1980-reaching-agreement-faults",
      "vc:label": "Pease Shostak Lamport 1980 Reaching Agreement Faults"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:rocket-et-al-2019-avalanche-snow",
      "vc:label": "Rocket et al 2019 Avalanche Snow"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:sompolinsky-lewenberg-zohar-2021-ghost-dag-phantom",
      "vc:label": "Sompolinsky Lewenberg Zohar 2021 GhostDAG PHANTOM"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:spiegelman-et-al-2022-bullshark-narwhal",
      "vc:label": "Spiegelman et al 2022 Bullshark Narwhal"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:sybil",
      "vc:label": "Sybil"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:viewstamped-replication",
      "vc:label": "Viewstamped Replication"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "bridges-to",
      "vc:value": "[[Distributed Systems Theory]], [[Game Theory]]"
    },
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-14-consensus-prod"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#ConsensusMechanism"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:consensus-mechanism"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:consensus-mechanism:776c802a9fc9",
  ...
  "vc:resolutions": [
    {
      "raw": "[[Aleph Zero]]",
      "resolved": "urn:visionflow:linked:aleph-zero",
      "kind": "StubLink"
    },
    {
      "raw": "[[Algorand]]",
    ...
    {
      "raw": "[[AptosBFT]]",
      "resolved": "urn:visionflow:linked:aptos-bft",
      "kind": "StubLink"
    },
    {
      "raw": "[[Atomic Broadcast]]",
      "resolved": "urn:visionflow:linked:atomic-broadcast",
      "kind": "StubLink"
    },
    {
      "raw": "[[Avalanche]]",
    ...
    {
      "raw": "[[BABE]]",
      "resolved": "urn:visionflow:linked:babe",
      "kind": "StubLink"
    },
    {
      "raw": "[[Babel et al 2024 Mysticeti]]",
      "resolved": "urn:visionflow:linked:babel-et-al-2024-mysticeti",
      "kind": "StubLink"
    },
    {
      "raw": "[[Baird 2016 Hashgraph Swirlds]]",
      "resolved": "urn:visionflow:linked:baird-2016-hashgraph-swirlds",
      "kind": "StubLink"
    },
    {
      "raw": "[[BFT]]",
      "resolved": "urn:visionflow:linked:bft",
      "kind": "StubLink"
    },
    {
      "raw": "[[Bitcoin BIPs]]",
      "resolved": "urn:visionflow:linked:bitcoin-bips",
      "kind": "StubLink"
    },
    {
      "raw": "[[Block Proposal]]",
      "resolved": "urn:visionflow:linked:block-proposal",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Bullshark]]",
      "resolved": "urn:visionflow:linked:bullshark",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Byzantine Quorum Without Total Order]]",
      "resolved": "urn:visionflow:linked:byzantine-quorum-without-total-order",
      "kind": "StubLink"
    },
    {
      "raw": "[[Cambridge Computer Laboratory Distributed Systems]]",
      "resolved": "urn:visionflow:linked:cambridge-computer-laboratory-distributed-systems",
      "kind": "StubLink"
    },
    {
      "raw": "[[CAP Theorem]]",
    ...
    {
      "raw": "[[Carnot]]",
      "resolved": "urn:visionflow:linked:carnot",
      "kind": "StubLink"
    },
    {
      "raw": "[[Casper FFG]]",
    ...
    {
      "raw": "[[Centralised Consensus]]",
      "resolved": "urn:visionflow:linked:centralised-consensus",
      "kind": "StubLink"
    },
    {
      "raw": "[[CFT]]",
      "resolved": "urn:visionflow:linked:cft",
      "kind": "StubLink"
    },
    {
      "raw": "[[Conflict-free Replicated Data Type]]",
      "resolved": "urn:visionflow:linked:conflict-free-replicated-data-type",
      "kind": "StubLink"
    },
    {
      "raw": "[[ConsensusLayer]]",
    ...
    {
      "raw": "[[CoordinationDomain]]",
      "resolved": "urn:visionflow:linked:coordination-domain",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Coordinator-Based Tangle]]",
      "resolved": "urn:visionflow:linked:coordinator-based-tangle",
      "kind": "StubLink"
    },
    {
      "raw": "[[Cosmos]]",
    ...
    {
      "raw": "[[Cosmos ICS Standards]]",
      "resolved": "urn:visionflow:linked:cosmos-ics-standards",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[DiemBFT]]",
      "resolved": "urn:visionflow:linked:diem-bft",
      "kind": "StubLink"
    },
    {
      "raw": "[[Distributed Algorithm]]",
      "resolved": "urn:visionflow:linked:distributed-algorithm",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Dwork Lynch Stockmeyer 1988 Partial Synchrony]]",
      "resolved": "urn:visionflow:linked:dwork-lynch-stockmeyer-1988-partial-synchrony",
      "kind": "StubLink"
    },
    {
      "raw": "[[Economic Incentive]]",
      "resolved": "urn:visionflow:linked:economic-incentive",
      "kind": "StubLink"
    },
    {
      "raw": "[[Edinburgh Blockchain Technology Laboratory]]",
      "resolved": "urn:visionflow:linked:edinburgh-blockchain-technology-laboratory",
      "kind": "StubLink"
    },
    {
      "raw": "[[EPaxos]]",
      "resolved": "urn:visionflow:linked:epaxos",
      "kind": "StubLink"
    },
    {
      "raw": "[[Erasure Coding]]",
    ...
    {
      "raw": "[[Ethereum EIPs]]",
      "resolved": "urn:visionflow:linked:ethereum-eips",
      "kind": "StubLink"
    },
    {
      "raw": "[[Eventually Consistent System]]",
      "resolved": "urn:visionflow:linked:eventually-consistent-system",
      "kind": "StubLink"
    },
    {
      "raw": "[[Finality Gadget]]",
    ...
    {
      "raw": "[[GHOST]]",
      "resolved": "urn:visionflow:linked:ghost",
      "kind": "StubLink"
    },
    {
      "raw": "[[GhostDAG]]",
      "resolved": "urn:visionflow:linked:ghost-dag",
      "kind": "StubLink"
    },
    {
      "raw": "[[Gilad et al 2017 Algorand SOSP]]",
      "resolved": "urn:visionflow:linked:gilad-et-al-2017-algorand-sosp",
      "kind": "StubLink"
    },
    {
      "raw": "[[GRANDPA]]",
      "resolved": "urn:visionflow:linked:grandpa",
      "kind": "StubLink"
    },
    {
      "raw": "[[Hashgraph]]",
    ...
    {
      "raw": "[[HotStuff-2]]",
      "resolved": "urn:visionflow:linked:hot-stuff-2",
      "kind": "StubLink"
    },
    {
      "raw": "[[IETF RFC 7574 BitTorrent-like Gossip]]",
      "resolved": "urn:visionflow:linked:ietf-rfc-7574-bit-torrent-like-gossip",
      "kind": "StubLink"
    },
    {
      "raw": "[[IOHK Cardano Research]]",
      "resolved": "urn:visionflow:linked:iohk-cardano-research",
      "kind": "StubLink"
    },
    {
      "raw": "[[IOTA 2.0]]",
      "resolved": "urn:visionflow:linked:iota-2-0",
      "kind": "StubLink"
    },
    {
      "raw": "[[ISO TC 307 Blockchain]]",
      "resolved": "urn:visionflow:linked:iso-tc-307-blockchain",
      "kind": "StubLink"
    },
    {
      "raw": "[[Junqueira Reed Serafini 2011 Zab]]",
      "resolved": "urn:visionflow:linked:junqueira-reed-serafini-2011-zab",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Malkhi Naor Wong 2023 HotStuff-2]]",
      "resolved": "urn:visionflow:linked:malkhi-naor-wong-2023-hot-stuff-2",
      "kind": "StubLink"
    },
    {
      "raw": "[[Moraru Andersen Kaminsky 2013 EPaxos]]",
      "resolved": "urn:visionflow:linked:moraru-andersen-kaminsky-2013-epaxos",
      "kind": "StubLink"
    },
    {
      "raw": "[[Multi-Paxos]]",
      "resolved": "urn:visionflow:linked:multi-paxos",
      "kind": "StubLink"
    },
    {
      "raw": "[[Mysticeti]]",
      "resolved": "urn:visionflow:linked:mysticeti",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Narwhal]]",
      "resolved": "urn:visionflow:linked:narwhal",
      "kind": "StubLink"
    },
    {
      "raw": "[[Network Synchrony Model]]",
      "resolved": "urn:visionflow:linked:network-synchrony-model",
      "kind": "StubLink"
    },
    {
      "raw": "[[NIST FIPS 204 CRYSTALS-Dilithium 2024]]",
      "resolved": "urn:visionflow:linked:nist-fips-204-crystals-dilithium-2024",
      "kind": "StubLink"
    },
    {
      "raw": "[[NIST FIPS 204 Post-Quantum]]",
      "resolved": "urn:visionflow:linked:nist-fips-204-post-quantum",
      "kind": "StubLink"
    },
    {
      "raw": "[[Oki Liskov 1988 Viewstamped Replication]]",
      "resolved": "urn:visionflow:linked:oki-liskov-1988-viewstamped-replication",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Pease Shostak Lamport 1980 Reaching Agreement Faults]]",
      "resolved": "urn:visionflow:linked:pease-shostak-lamport-1980-reaching-agreement-faults",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Quorum Certificate]]",
      "resolved": "urn:visionflow:linked:quorum-certificate",
      "kind": "StubLink"
    },
    {
      "raw": "[[Quorum Intersection]]",
      "resolved": "urn:visionflow:linked:quorum-intersection",
      "kind": "StubLink"
    },
    {
      "raw": "[[Raft]]",
    ...
    {
      "raw": "[[Rocket et al 2019 Avalanche Snow]]",
      "resolved": "urn:visionflow:linked:rocket-et-al-2019-avalanche-snow",
      "kind": "StubLink"
    },
    {
      "raw": "[[Single-Source-of-Truth Database]]",
      "resolved": "urn:visionflow:linked:single-source-of-truth-database",
      "kind": "StubLink"
    },
    {
      "raw": "[[Slashing]]",
    ...
    {
      "raw": "[[Sompolinsky Lewenberg Zohar 2021 GhostDAG PHANTOM]]",
      "resolved": "urn:visionflow:linked:sompolinsky-lewenberg-zohar-2021-ghost-dag-phantom",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Spiegelman et al 2022 Bullshark Narwhal]]",
      "resolved": "urn:visionflow:linked:spiegelman-et-al-2022-bullshark-narwhal",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Sybil]]",
      "resolved": "urn:visionflow:linked:sybil",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Synchronised Clock]]",
      "resolved": "urn:visionflow:linked:synchronised-clock",
      "kind": "StubLink"
    },
    {
      "raw": "[[Tendermint]]",
    ...
    {
      "raw": "[[Throughput Scalability]]",
      "resolved": "urn:visionflow:linked:throughput-scalability",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Validator Registry]]",
      "resolved": "urn:visionflow:linked:validator-registry",
      "kind": "StubLink"
    },
    {
      "raw": "[[Validator Set]]",
    ...
    {
      "raw": "[[View Change]]",
      "resolved": "urn:visionflow:linked:view-change",
      "kind": "StubLink"
    },
    {
      "raw": "[[Viewstamped Replication]]",
      "resolved": "urn:visionflow:linked:viewstamped-replication",
      "kind": "StubLink"
    },
    {
      "raw": "[[Voting Round]]",
    ...
    {
      "raw": "[[Zab]]",
      "resolved": "urn:visionflow:linked:zab",
      "kind": "StubLink"
    },
    {
      "raw": "[[Bitcoin]]",
