...
- ### Content
  ...
  - ### Mechanism-Design and Economic Layer
	  ...
	  - **Restaking attack surface**: EigenLayer-style restaking complicates this analysis — a single $42B stake may be securing 20+ Actively Validated Services (AVSs), so an attacker capturing the underlying stake [private] simultaneously compromise all of them, raising the per-service security but increasing systemic correlation.
