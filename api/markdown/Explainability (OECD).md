...
(Declaration (Class :ExplainabilityOecd))

;; Annotations
(AnnotationAssertion rdfs:label :ExplainabilityOecd "Explainability (OECD)"@en)
(AnnotationAssertion rdfs:comment :ExplainabilityOecd "People affected by AI-based outcomes should be able to understand how and why particular decisions or recommendations were reached, with explanations provided in ways appropriate to the context and enabling meaningful contestation of AI-influenced decisions."@en)

;; Data Properties
(AnnotationAssertion dcterms:identifier :ExplainabilityOecd "AI-0162"^^xsd:string)
(DataPropertyAssertion :isAITechnology :ExplainabilityOecd "true"^^xsd:boolean)
```
