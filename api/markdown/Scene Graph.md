schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#SceneGraph
legacy_uri:: urn:visionclaw:concept:spatial-computing:scene-graph
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-a6c965d50139"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#SceneGraph"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:scene-graph"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
