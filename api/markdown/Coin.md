schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#Coin
legacy_uri:: urn:visionclaw:concept:blockchain:coin
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-c230a4b9f659"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#Coin"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:coin"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:ad4792ac12011d1a37c5d86616f148b92baa3c7a59f0a354a2e927f451e5ca40@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:coin",
  "@type": "OntologyClass",
  "label": "Coin",
  "subClassOf": [
    {
