schema_version:: 1
legacy_iri:: https://visionclaw.dreamlab-ai.systems/ns/v2/artificial-intelligence#ImitationLearning
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:imitation-learning
public:: true
...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "imitation-learning",
  "title": "Imitation Learning",
  "vc:public": true,
  "vc:outboundWikilinks": [
    {
      "@id": "urn:visionflow:linked:abbeel-ng-2004-apprenticeship-learning",
      "vc:label": "Abbeel Ng 2004 Apprenticeship Learning"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:argall-chernova-veloso-browning-2009-lf-d-survey",
      "vc:label": "Argall Chernova Veloso Browning 2009 LfD Survey"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:bain-sammut-1995-behavioural-cloning",
      "vc:label": "Bain Sammut 1995 Behavioural Cloning"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:brohan-et-al-2022-rt-1",
      "vc:label": "Brohan et al 2022 RT-1"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:finn-levine-abbeel-2016-guided-cost-learning",
      "vc:label": "Finn Levine Abbeel 2016 Guided Cost Learning"
    },
    {
      "@id": "urn:visionflow:linked:florence-et-al-2021-implicit-bc",
      "vc:label": "Florence et al 2021 Implicit BC"
    },
    {
      "@id": "urn:visionflow:linked:fu-luo-levine-2018-airl",
      "vc:label": "Fu Luo Levine 2018 AIRL"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:garg-et-al-2021-iq-learn",
      "vc:label": "Garg et al 2021 IQ-Learn"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:ho-ermon-2016-gail",
      "vc:label": "Ho Ermon 2016 GAIL"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:khazatsky-et-al-2024-droid",
      "vc:label": "Khazatsky et al 2024 DROID"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:kostrikov-nachum-tompson-2020-value-dice",
      "vc:label": "Kostrikov Nachum Tompson 2020 ValueDICE"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:mandlekar-et-al-2021-robomimic",
      "vc:label": "Mandlekar et al 2021 Robomimic"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:ng-russell-2000-algorithms-for-inverse-reinforcement-learning",
      "vc:label": "Ng Russell 2000 Algorithms for Inverse Reinforcement Learning"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:nvidia-gr00-t-n1-2025",
      "vc:label": "NVIDIA GR00T-N1 2025"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:octo-model-team-2024",
      "vc:label": "Octo Model Team 2024"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:open-x-embodiment-collaboration-2023",
      "vc:label": "Open X-Embodiment Collaboration 2023"
    },
    {
      "@id": "urn:visionflow:linked:physical-intelligence-pi0-2024",
      "vc:label": "Physical Intelligence pi0 2024"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:pomerleau-1989-alvinn",
      "vc:label": "Pomerleau 1989 ALVINN"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:ratliff-bagnell-zinkevich-2006-maximum-margin-planning",
      "vc:label": "Ratliff Bagnell Zinkevich 2006 Maximum Margin Planning"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:ross-gordon-bagnell-2011-dagger-aistats",
      "vc:label": "Ross Gordon Bagnell 2011 DAgger AISTATS"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:schaal-1997-learning-from-demonstration",
      "vc:label": "Schaal 1997 Learning from Demonstration"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:torabi-warnell-stone-2018-bco",
      "vc:label": "Torabi Warnell Stone 2018 BCO"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:wayve-gaia-1-2023",
      "vc:label": "Wayve GAIA-1 2023"
    },
    {
      "@id": "urn:visionflow:linked:zhao-et-al-2023-aloha-act",
      "vc:label": "Zhao et al 2023 ALOHA ACT"
    },
    {
      "@id": "urn:visionflow:linked:ziebart-2008-maximum-entropy-irl",
      "vc:label": "Ziebart 2008 Maximum Entropy IRL"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "bridges-to",
      "vc:value": "[[Reinforcement Learning]], [[Robotics]], [[Foundation Models]]"
    },
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-e4fcca1e4dcb"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "https://visionclaw.dreamlab-ai.systems/ns/v2/artificial-intelligence#ImitationLearning"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:imitation-learning"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:imitation-learning:776c802a9fc9",
  ...
  "vc:resolutions": [
    {
      "raw": "[[Abbeel Ng 2004 Apprenticeship Learning]]",
      "resolved": "urn:visionflow:linked:abbeel-ng-2004-apprenticeship-learning",
      "kind": "StubLink"
    },
    {
      "raw": "[[Action Chunking Transformer]]",
      "resolved": "urn:visionflow:linked:action-chunking-transformer",
      "kind": "StubLink"
    },
    {
      "raw": "[[Action Decoder]]",
      "resolved": "urn:visionflow:linked:action-decoder",
      "kind": "StubLink"
    },
    {
      "raw": "[[Action Space]]",
    ...
    {
      "raw": "[[AIRL]]",
      "resolved": "urn:visionflow:linked:airl",
      "kind": "StubLink"
    },
    {
      "raw": "[[AlgorithmLayer]]",
    ...
    {
      "raw": "[[Apprenticeship Learning]]",
      "resolved": "urn:visionflow:linked:apprenticeship-learning",
      "kind": "StubLink"
    },
    {
      "raw": "[[Argall Chernova Veloso Browning 2009 LfD Survey]]",
      "resolved": "urn:visionflow:linked:argall-chernova-veloso-browning-2009-lf-d-survey",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Bain Sammut 1995 Behavioural Cloning]]",
      "resolved": "urn:visionflow:linked:bain-sammut-1995-behavioural-cloning",
      "kind": "StubLink"
    },
    {
      "raw": "[[Behavioural Cloning]]",
      "resolved": "urn:visionflow:linked:behavioural-cloning",
      "kind": "StubLink"
    },
    {
      "raw": "[[Brohan et al 2022 RT-1]]",
      "resolved": "urn:visionflow:linked:brohan-et-al-2022-rt-1",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[CALVIN]]",
      "resolved": "urn:visionflow:linked:calvin",
      "kind": "StubLink"
    },
    {
    ...
    },
    {
      ...
      "resolved": "urn:visionflow:linked:classical-control",
      "kind": "StubLink"
    },
    {
      "raw": "[[ControlLayer]]",
    ...
    {
      "raw": "[[Cross-Embodiment Transfer]]",
      "resolved": "urn:visionflow:linked:cross-embodiment-transfer",
      "kind": "StubLink"
    },
    {
      "raw": "[[Demonstration Dataset]]",
      "resolved": "urn:visionflow:linked:demonstration-dataset",
      "kind": "StubLink"
    },
    {
      "raw": "[[Demonstrator]]",
      "resolved": "urn:visionflow:linked:demonstrator",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Discriminator]]",
      "resolved": "urn:visionflow:linked:discriminator",
      "kind": "StubLink"
    },
    {
      "raw": "[[DROID Dataset]]",
      "resolved": "urn:visionflow:linked:droid-dataset",
      "kind": "StubLink"
    },
    {
      "raw": "[[Drone Acrobatics]]",
      "resolved": "urn:visionflow:linked:drone-acrobatics",
      "kind": "StubLink"
    },
    {
      "raw": "[[Expert Demonstration]]",
      "resolved": "urn:visionflow:linked:expert-demonstration",
      "kind": "StubLink"
    },
    {
      "raw": "[[Expert Trajectories]]",
      "resolved": "urn:visionflow:linked:expert-trajectories",
      "kind": "StubLink"
    },
    {
      "raw": "[[Finn Levine Abbeel 2016 Guided Cost Learning]]",
      "resolved": "urn:visionflow:linked:finn-levine-abbeel-2016-guided-cost-learning",
      "kind": "StubLink"
    },
    {
      "raw": "[[Florence et al 2021 Implicit BC]]",
      "resolved": "urn:visionflow:linked:florence-et-al-2021-implicit-bc",
      "kind": "StubLink"
    },
    {
      "raw": "[[Fu Luo Levine 2018 AIRL]]",
      "resolved": "urn:visionflow:linked:fu-luo-levine-2018-airl",
      "kind": "StubLink"
    },
    {
      "raw": "[[Function Approximator]]",
      "resolved": "urn:visionflow:linked:function-approximator",
      "kind": "StubLink"
    },
    {
      "raw": "[[GAIL]]",
      "resolved": "urn:visionflow:linked:gail",
      "kind": "StubLink"
    },
    {
      "raw": "[[Garg et al 2021 IQ-Learn]]",
      "resolved": "urn:visionflow:linked:garg-et-al-2021-iq-learn",
      "kind": "StubLink"
    },
    {
      "raw": "[[Generalist Robot Policies]]",
      "resolved": "urn:visionflow:linked:generalist-robot-policies",
      "kind": "StubLink"
    },
    {
      "raw": "[[Goal Conditioned Behaviour Cloning]]",
      "resolved": "urn:visionflow:linked:goal-conditioned-behaviour-cloning",
      "kind": "StubLink"
    },
    {
      "raw": "[[Ho Ermon 2016 GAIL]]",
      "resolved": "urn:visionflow:linked:ho-ermon-2016-gail",
      "kind": "StubLink"
    },
    {
      "raw": "[[Humanoid Control]]",
      "resolved": "urn:visionflow:linked:humanoid-control",
      "kind": "StubLink"
    },
    {
      "raw": "[[Inverse Dynamics Model]]",
      "resolved": "urn:visionflow:linked:inverse-dynamics-model",
      "kind": "StubLink"
    },
    {
      "raw": "[[Inverse Reinforcement Learning]]",
      "resolved": "urn:visionflow:linked:inverse-reinforcement-learning",
      "kind": "StubLink"
    },
    {
      "raw": "[[Khazatsky et al 2024 DROID]]",
      "resolved": "urn:visionflow:linked:khazatsky-et-al-2024-droid",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Kostrikov Nachum Tompson 2020 ValueDICE]]",
      "resolved": "urn:visionflow:linked:kostrikov-nachum-tompson-2020-value-dice",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[LIBERO]]",
      "resolved": "urn:visionflow:linked:libero",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Mandlekar et al 2021 Robomimic]]",
      "resolved": "urn:visionflow:linked:mandlekar-et-al-2021-robomimic",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Maximum Entropy Principle]]",
      "resolved": "urn:visionflow:linked:maximum-entropy-principle",
      "kind": "StubLink"
    },
    {
      "raw": "[[Meta-Learning]]",
    ...
    {
      "raw": "[[Ng Russell 2000 Algorithms for Inverse Reinforcement Learning]]",
      "resolved": "urn:visionflow:linked:ng-russell-2000-algorithms-for-inverse-reinforcement-learning",
      "kind": "StubLink"
    },
    {
      "raw": "[[No-Regret Online Learning]]",
      "resolved": "urn:visionflow:linked:no-regret-online-learning",
      "kind": "StubLink"
    },
    {
      "raw": "[[NVIDIA GR00T-N1 2025]]",
      "resolved": "urn:visionflow:linked:nvidia-gr00-t-n1-2025",
      "kind": "StubLink"
    },
    {
      "raw": "[[Observation Encoder]]",
      "resolved": "urn:visionflow:linked:observation-encoder",
      "kind": "StubLink"
    },
    {
      "raw": "[[Observation Space]]",
      "resolved": "urn:visionflow:linked:observation-space",
      "kind": "StubLink"
    },
    {
      "raw": "[[Octo Model Team 2024]]",
      "resolved": "urn:visionflow:linked:octo-model-team-2024",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Open X-Embodiment Collaboration 2023]]",
      "resolved": "urn:visionflow:linked:open-x-embodiment-collaboration-2023",
      "kind": "StubLink"
    },
    {
      "raw": "[[Physical Intelligence pi0 2024]]",
      "resolved": "urn:visionflow:linked:physical-intelligence-pi0-2024",
      "kind": "StubLink"
    },
    {
      "raw": "[[Policy Learning]]",
      "resolved": "urn:visionflow:linked:policy-learning",
      "kind": "StubLink"
    },
    {
      "raw": "[[Policy Network]]",
      "resolved": "urn:visionflow:linked:policy-network",
      "kind": "StubLink"
    },
    {
      "raw": "[[Pomerleau 1989 ALVINN]]",
      "resolved": "urn:visionflow:linked:pomerleau-1989-alvinn",
      "kind": "StubLink"
    },
    {
      "raw": "[[Rapid Task Specification]]",
      "resolved": "urn:visionflow:linked:rapid-task-specification",
      "kind": "StubLink"
    },
    {
      "raw": "[[Ratliff Bagnell Zinkevich 2006 Maximum Margin Planning]]",
      "resolved": "urn:visionflow:linked:ratliff-bagnell-zinkevich-2006-maximum-margin-planning",
      "kind": "StubLink"
    },
    {
      "raw": "[[Reward-Free Learning]]",
      "resolved": "urn:visionflow:linked:reward-free-learning",
      "kind": "StubLink"
    },
    {
      "raw": "[[RLBench]]",
      "resolved": "urn:visionflow:linked:rlbench",
      "kind": "StubLink"
    },
    {
      "raw": "[[Robomimic Benchmark]]",
      "resolved": "urn:visionflow:linked:robomimic-benchmark",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Ross Gordon Bagnell 2011 DAgger AISTATS]]",
      "resolved": "urn:visionflow:linked:ross-gordon-bagnell-2011-dagger-aistats",
      "kind": "StubLink"
    },
    {
      "raw": "[[Sample-Efficient Robotics]]",
      "resolved": "urn:visionflow:linked:sample-efficient-robotics",
      "kind": "StubLink"
    },
    {
      "raw": "[[Schaal 1997 Learning from Demonstration]]",
      "resolved": "urn:visionflow:linked:schaal-1997-learning-from-demonstration",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Sequential Decision Making]]",
      "resolved": "urn:visionflow:linked:sequential-decision-making",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Skill Transfer]]",
      "resolved": "urn:visionflow:linked:skill-transfer",
      "kind": "StubLink"
    },
    {
      "raw": "[[State Action Pairs]]",
      "resolved": "urn:visionflow:linked:state-action-pairs",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Teleoperation Interface]]",
      "resolved": "urn:visionflow:linked:teleoperation-interface",
      "kind": "StubLink"
    },
    {
      "raw": "[[Torabi Warnell Stone 2018 BCO]]",
      "resolved": "urn:visionflow:linked:torabi-warnell-stone-2018-bco",
      "kind": "StubLink"
    },
    {
      "raw": "[[Transformer Policies]]",
      "resolved": "urn:visionflow:linked:transformer-policies",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Wayve GAIA-1 2023]]",
      "resolved": "urn:visionflow:linked:wayve-gaia-1-2023",
      "kind": "StubLink"
    },
    {
      "raw": "[[Zhao et al 2023 ALOHA ACT]]",
      "resolved": "urn:visionflow:linked:zhao-et-al-2023-aloha-act",
      "kind": "StubLink"
    },
    {
      "raw": "[[Ziebart 2008 Maximum Entropy IRL]]",
      "resolved": "urn:visionflow:linked:ziebart-2008-maximum-entropy-irl",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[DAgger]]",
      "resolved": "urn:visionflow:owl:class:dagger",
      "kind": "ResolvedLink"
    },
    {
