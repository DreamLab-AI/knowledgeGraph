schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#HardwareAcceleration
legacy_uri:: urn:visionclaw:concept:spatial-computing:hardware-acceleration
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-28f5b0e55049"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#HardwareAcceleration"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:hardware-acceleration"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:1b50d4c8c9f4753b80de9b14b86bbbe8ef2e637a8d902b1a0474490f1600dd6e@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
