schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#SupplyChainManagement
legacy_uri:: urn:visionclaw:concept:blockchain:supply-chain-management
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-1daf9398f0cb"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#SupplyChainManagement"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:supply-chain-management"
    },
    {
      "vc:key": "status",
      "vc:value": "active"
