schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#LightningNetwork
legacy_uri:: urn:visionclaw:concept:blockchain:lightning-network
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-ln-enriched-2026"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#LightningNetwork"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:lightning-network"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:lightning-network:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[BOLT Specifications]]",
      "resolved": "urn:visionflow:linked:bolt-specifications",
      "kind": "StubLink"
    },
    {
      "raw": "[[BOLT12 Offers]]",
      "resolved": "urn:visionflow:linked:bolt12-offers",
      "kind": "StubLink"
    },
    {
      "raw": "[[Channel Factory]]",
      "resolved": "urn:visionflow:linked:channel-factory",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Instant Transactions]]",
      "resolved": "urn:visionflow:linked:instant-transactions",
      "kind": "StubLink"
    },
    {
      "raw": "[[Layer 2 Scaling]]",
    ...
    {
      "raw": "[[Lightning Service Providers]]",
      "resolved": "urn:visionflow:linked:lightning-service-providers",
      "kind": "StubLink"
    },
    {
      "raw": "[[LNURL Protocol]]",
      "resolved": "urn:visionflow:linked:lnurl-protocol",
      "kind": "StubLink"
    },
    {
      "raw": "[[Machine Payments]]",
      "resolved": "urn:visionflow:linked:machine-payments",
      "kind": "StubLink"
    },
    {
      "raw": "[[MuSig2]]",
    ...
    {
      "raw": "[[Payment Channel Network]]",
      "resolved": "urn:visionflow:linked:payment-channel-network",
      "kind": "StubLink"
    },
    {
      "raw": "[[Routing Algorithm]]",
      "resolved": "urn:visionflow:linked:routing-algorithm",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Sphinx Protocol]]",
      "resolved": "urn:visionflow:linked:sphinx-protocol",
      "kind": "StubLink"
    },
    {
      "raw": "[[Spiral]]",
      "resolved": "urn:visionflow:linked:spiral",
      "kind": "StubLink"
    },
    {
      "raw": "[[Splicing]]",
      "resolved": "urn:visionflow:linked:splicing",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Traditional Payment Systems]]",
      "resolved": "urn:visionflow:linked:traditional-payment-systems",
      "kind": "StubLink"
    },
    {
      "raw": "[[Watchtower]]",
...
- ### Semantic Classification
  ...
  - owl-role:: PaymentProtocol
  - owl-inferred:: blockchain:Layer2Protocol, blockchain:PaymentChannelNetwork, blockchain:OffChainScaling
  - belongs-to-domain:: [[BlockchainDomain]], [[FinancialInfrastructureDomain]], [[CryptographyDomain]]
  - implemented-in-layer:: [[Layer 2 Scaling]], [[ApplicationLayer]]

- ### Relationships
  - is-subclass-of:: [[Layer 2 Scaling]], [[Payment Channel Network]], [[Bitcoin Technical Overview]], [[Blockchain Scalability]], [[Distributed Ledger]]
  - has-part:: [[Payment Channel]], [[Hash Time-Locked Contracts]], [[Routing Algorithm]], [[Watchtower]], [[Channel Factory]], [[Lightning Service Providers]], [[Onion Routing]], [[BOLT Specifications]], [[BOLT12 Offers]]
  - requires:: [[Bitcoin Technical Overview]], [[Cryptographic Commitment]], [[Multisignature]], [[Timelock]], [[Blockchain Network]], [[Hash Function]]
  - enables:: [[Micropayments]], [[Instant Transactions]], [[Cross Border Compliance]], [[Financial Infrastructure]], [[Stable Coins]], [[Taproot Assets]], [[Streaming Payments]], [[Machine Payments]]
  - implements:: [[BOLT Specifications]], [[Hash Time-Locked Contracts]], [[Onion Routing]], [[Multi-Path Payments]], [[LNURL Protocol]], [[BOLT12 Offers]], [[Splicing]], [[Channel Factory]]
...
- ### Content
  ...
  ## Compositional Relationships (Components)
	  ...
	  FunctionalDataProperty(bc:networkCapacityBTC)
	  FunctionalDataProperty(bc:monthlyTransactions)
	  ```
  ...
  - **Lightspark** (cofounded by David Marcus, former PayPal and Libra/Diem president) launched commercial Lightning infrastructure for financial institutions and payment processors in 2024, processing over $1 billion in annualised Lightning volume by 2025. Lightspark's **Universal Money Address (UMA)** extends LNURL-pay with Travel Rule-compliant metadata fields (originator and beneficiary KYC identifiers), enabling banks, payment processors, and fintechs to send Lightning payments with [[AML KYC Compliance]] compliance metadata, addressing the regulatory barrier that prevented institutional Lightning adoption. Lightspark positions Lightning as an inter-bank settlement rail competitive with SWIFT on cost ($0.001 vs $25-$50 per SWIFT message) and latency (seconds vs 1-3 business days).
  ...
  - Poon, J. & Dryja, T. (2016). "The Bitcoin Lightning Network: Scalable Off-Chain Instant Payments." Lightning Network white paper. https://lightning.network/lightning-network-paper.pdf
  - Decker, C. & Wattenhofer, R. (2015). "A Fast and Scalable Payment Network with Bitcoin Duplex Micropayment Channels." Symposium on Stabilization, Safety, and Security of Distributed Systems (SSS 2015).
  - Burchert, C., Decker, C. & Wattenhofer, R. (2018). "Scalable Funding of Bitcoin Micropayment Channel Networks." Royal Society Open Science 5(8).
  - Malavolta, G., Moreno-Sanchez, P., Kate, A. & Maffei, M. (2017). "Concurrency and Privacy with Payment-Channel Networks." ACM CCS 2017.
  - Kappos, G. et al. (2021). "An Empirical Analysis of Privacy in the Lightning Network." Financial Cryptography 2021.
  - Pickhardt, R. & Richter, S. (2021). "Optimally Reliable and Cheap Payment Flows on the Lightning Network." arXiv:2107.05322. https://arxiv.org/abs/2107.05322
  - Sivaraman, V. et al. (2020). "High Throughput Cryptocurrency Routing in Payment Channel Networks." NSDI 2020.
  - Avarikioti, G. et al. (2019). "Ride the Lightning: The Game Theory of Payment Channels." MARBLE 2019.
  - Dziembowski, S. et al. (2019). "PERUN: Virtual Payment Hubs over Cryptocurrencies." IEEE S&P 2019.
  - Martinazzi, S. & Flori, A. (2020). "The evolving topology of the Lightning Network: Centralization, robustness and efficiency." PLoS ONE 15(6).
  - Beres, F. et al. (2021). "A Cryptoeconomic Traffic Analysis of Bitcoin's Lightning Network." Financial Cryptography 2021.
  - Tikhomirov, S. et al. (2020). "A Quantitative Analysis of Security, Anonymity and Scalability for the Lightning Network." arXiv:2003.02891.
  - Russell, R. et al. (2016-2024). BOLT Specifications (BOLT 0-12). https://github.com/lightning/bolts
  - Lightning Labs. (2024). "BOLT12 Offers Officially Merged into Lightning Specification." https://www.nobsbitcoin.com/bolt12-offers-officially-merged-into-lightning-spec/
  - Blockstream. (2024). "Core Lightning v24.11: BOLT12 by Default, XPAY, Gossip Enhancements." https://blog.blockstream.com/core-lightning-v24-11-the-lightning-dev-mailing-list/
  - Lightning Labs. (2025). "Announcing Taproot Assets v0.6: Bitcoin's Decentralised FX Network Has Arrived." https://lightning.engineering/posts/2025-6-24-tapd-v0.6-launch/
  - Lightning Labs. (2025). "A New Era for Stablecoins: Tether Is Coming to Bitcoin and Lightning." https://lightning.engineering/posts/2025-01-30-Tether-on-Lightning/
  - Tether. (2025). "Tether Brings USDt to Bitcoin's Lightning Network." https://tether.io/news/tether-brings-usdt-to-bitcoins-lightning-network-ushering-in-a-new-era-of-unstoppable-technology/
  - ACINQ. (2024). "Phoenix Wallet announces support for new LSP protocol (bLIP-35)." https://stacker.news/items/717162
  - Strike. (2024). "Bitcoin-Focused Payments App Strike Rolls Out Services to Africa." CoinDesk. https://www.coindesk.com/business/2024/02/27/bitcoin-focused-payments-app-strike-rolls-out-services-to-africa
  - Voltage. (2025). "Lightning Network Service Provider (LSP)." https://www.voltage.cloud/blog/lightning-network-service-provider-lsp
  - Aurpay. (2025). "Lightning Network 2025: Enterprise Adoption Cuts Fees 50%." https://aurpay.net/aurspace/lightning-network-enterprise-adoption-2025/
  - CoinLaw. (2026). "Bitcoin Lightning Network Usage Statistics 2026." https://coinlaw.io/bitcoin-lightning-network-usage-statistics/
  - 1ML.com. (2026). Lightning Network Statistics. https://1ml.com/statistics
  - Cambridge Centre for Alternative Finance. (2024). "2nd Global Cryptoasset Regulatory Landscape Study." Judge Business School, Cambridge.
  - Danezis, G. & Goldberg, I. (2009). "Sphinx: A Compact and Provably Secure Mix Format." IEEE S&P 2009.
...
- ### Provenance
  ...
  - implementation-source:: LND releases (Lightning Labs v0.17-0.18); Core Lightning v24.08, v24.11 (Blockstream); Eclair releases (ACINQ); LDK v0.0.120+ (Spiral)
  - taproot-assets-source:: Lightning Labs (2025) Taproot Assets v0.6 announcement; Tether (2025) USDT on Lightning launch (San Salvador, January 2025)
  - adoption-source:: Strike Africa expansion (CoinDesk 2024); El Salvador Chivo wallet statistics; 1ML.com network statistics (2026)
  - academic-source:: Pickhardt & Richter (2021) min-cost flow routing arXiv:2107.05322; Kappos et al. (2021) FC 2021 privacy analysis; Sivaraman et al. (2020) NSDI routing; Martinazzi & Flori (2020) PLoS ONE topology
  - uk-context-source:: Cambridge CCAF Cryptoasset Benchmarking Studies; Imperial College Centre for Cryptocurrency Research; UCL Centre for Blockchain Technologies; FinTech North network (Leeds/Sheffield/Newcastle)
  - regulatory-source:: FCA Cryptoassets Registration Regime (2024); UK Cryptoasset Travel Rule (Amendment) Regulations 2023; FATF Recommendation 16 Travel Rule
  - migration-date:: 2026-05-17T09:00:00Z
  - enriched-by:: claude-sonnet-4-6 (Phase 6 bulk enrichment run)
