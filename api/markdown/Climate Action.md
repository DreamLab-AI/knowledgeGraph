...
# Climate Action
```json-ld
{ "@context":"https://narrativegoldmine.com/ns/v1", "@id":"urn:visionflow:page:climate-action", "@type":"Page", "title":"Climate Action", "vc:slug":"climate-action", "vc:public":true, "vc:schemaVersion":2, "vc:outboundWikilinks":[] }
```
```json-ld
{
  ...
  "relations":{
    ...
    "partOf":[{"@id":"urn:ngm:class:sustainable-development","label":"Sustainable Development"}],
    "requires":[
      {"@id":"urn:ngm:class:decarbonisation","label":"Decarbonisation"},
