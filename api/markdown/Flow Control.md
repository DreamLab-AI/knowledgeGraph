```json-ld
{
  ...
  "@id": "urn:visionflow:page:flow-control",
  "@type": "Page",
  "title": "Flow Control",
  "vc:slug": "flow-control",
  "vc:public": true,
  "vc:schemaVersion": 2,
...
- ### Overview
	- Without flow control, a sender [private] discard a receiver's data simply by transmitting faster than it can be consumed.
