schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#RevenueSharing
legacy_uri:: urn:visionclaw:concept:spatial-computing:revenue-sharing
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-fe11dc7ff0e2"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#RevenueSharing"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:revenue-sharing"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
