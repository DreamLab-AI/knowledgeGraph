schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#HistoryAndPathToAGI
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:history-and-path-to-agi
public:: true
...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "history-and-path-to-agi",
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:science-and-technology-studies-domain",
      "vc:label": "ScienceAndTechnologyStudiesDomain"
    },
    {
  ...
  "vc:legacyProperties": [
    {
      ...
      "vc:value": "AI History, History of Artificial Intelligence, Road to AGI, AGI Timeline, Path to General AI"
    },
    {
    ...
    {
      "vc:key": "bridges-to",
      "vc:value": "[[Artificial General Intelligence]], [[Machine Learning]], [[Deep Learning]]"
    },
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-9d4f2a871b3c"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#HistoryAndPathToAGI"
    },
    {
    ...
    },
    {
      ...
      "vc:value": "History and Path to AGI"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:history-and-path-to-agi"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
- ### Semantic Classification
  ...
  - owl-role:: HistoricalChronicle
  - owl-inferred:: ai:ArtificialIntelligenceHistory, ai:ComputationalParadigmEvolution, ai:AGIResearchTrajectory, ai:TechnologicalHistory
  - belongs-to-domain:: [[AI-GroundedDomain]], [[MachineLearningDomain]], [[ComputationAndIntelligenceDomain]], [[ScienceAndTechnologyStudiesDomain]]
  - implemented-in-layer:: [[ConceptualLayer]], [[ResearchLayer]], [[PolicyLayer]]

- ### Relationships
  - is-subclass-of:: [[Artificial General Intelligence]], [[AI Research]], [[Technology History]], [[Cognitive Science]], [[Scientific Paradigm]]
...
- ### Content
  ...
  ## Compositional Relationships (Components)
	    SubClassOf(ai:HistoryAndPathToAGI
	      ObjectSomeValuesFrom(ai:hasPart ai:SymbolicAIEra))
	    SubClassOf(ai:HistoryAndPathToAGI
	      ObjectSomeValuesFrom(ai:hasPart ai:ConnectionistRevival))
	    SubClassOf(ai:HistoryAndPathToAGI
	      ObjectSomeValuesFrom(ai:hasPart ai:DeepLearningRevolution))
	    SubClassOf(ai:HistoryAndPathToAGI
	      ObjectSomeValuesFrom(ai:hasPart ai:TransformerEra))
	    SubClassOf(ai:HistoryAndPathToAGI
	      ObjectSomeValuesFrom(ai:hasPart ai:ScalingLawsRegime))
	    SubClassOf(ai:HistoryAndPathToAGI
	      ObjectSomeValuesFrom(ai:hasPart ai:RLHFAlignment))
	    SubClassOf(ai:HistoryAndPathToAGI
	      ObjectSomeValuesFrom(ai:hasPart ai:FrontierEvaluationEcosystem))
	    SubClassOf(ai:HistoryAndPathToAGI
	      ObjectSomeValuesFrom(ai:hasPart ai:AIWinter))

	    ## Dependency Relationships
	    SubClassOf(ai:HistoryAndPathToAGI
	      ObjectSomeValuesFrom(ai:requires ai:ComputationalSubstrate))
	    SubClassOf(ai:HistoryAndPathToAGI
	      ObjectSomeValuesFrom(ai:requires ai:TrainingData))
	    SubClassOf(ai:HistoryAndPathToAGI
	      ObjectSomeValuesFrom(ai:requires ai:MathematicalFoundations))
	    SubClassOf(ai:HistoryAndPathToAGI
	      ObjectSomeValuesFrom(ai:requires ai:InstitutionalFunding))
	    SubClassOf(ai:HistoryAndPathToAGI
	      ObjectSomeValuesFrom(ai:requires ai:ScientificMethod))
	    SubClassOf(ai:HistoryAndPathToAGI
	      ObjectSomeValuesFrom(ai:dependsOn ai:Mathematics))
	    SubClassOf(ai:HistoryAndPathToAGI
	      ObjectSomeValuesFrom(ai:dependsOn ai:Neuroscience))
	    SubClassOf(ai:HistoryAndPathToAGI
	      ObjectSomeValuesFrom(ai:dependsOn ai:CognitivePsychology))
	    SubClassOf(ai:HistoryAndPathToAGI
	      ObjectSomeValuesFrom(ai:dependsOn ai:Statistics))
	    SubClassOf(ai:HistoryAndPathToAGI
	      ObjectSomeValuesFrom(ai:dependsOn ai:PhilosophyOfMind))

	    ## Capability Relationships
	    SubClassOf(ai:HistoryAndPathToAGI
	      ObjectSomeValuesFrom(ai:enables ai:ArtificialGeneralIntelligence))
	    SubClassOf(ai:HistoryAndPathToAGI
	      ObjectSomeValuesFrom(ai:enables ai:FrontierAIEvaluation))
	    SubClassOf(ai:HistoryAndPathToAGI
	    ...
	    SubClassOf(ai:HistoryAndPathToAGI
	      ObjectSomeValuesFrom(ai:implements ai:TuringTest))
	    SubClassOf(ai:HistoryAndPathToAGI
	    ...
	    SubClassOf(ai:HistoryAndPathToAGI
	      ObjectSomeValuesFrom(ai:uses ai:ProbabilisticInference))

	    ## Reduction Relationships
	    SubClassOf(ai:HistoryAndPathToAGI
	      ObjectSomeValuesFrom(ai:reduces ai:HumanCognitiveBottleneck))
	    SubClassOf(ai:HistoryAndPathToAGI
	      ObjectSomeValuesFrom(ai:reduces ai:AIParadigmUncertainty))
	    SubClassOf(ai:HistoryAndPathToAGI
	      ObjectSomeValuesFrom(ai:reduces ai:TaskSpecificRetraining))
	    SubClassOf(ai:HistoryAndPathToAGI
	      ObjectSomeValuesFrom(ai:reduces ai:ExpertKnowledgeAcquisitionBottleneck))
	    SubClassOf(ai:HistoryAndPathToAGI
	      ObjectSomeValuesFrom(ai:reduces ai:ComputationalCostPerCapability))
	    ...
	    DataPropertyAssertion(ai:hasIdentifier ai:HistoryAndPathToAGI "AI-2001"^^xsd:string)
	    DataPropertyAssertion(ai:authorityScore ai:HistoryAndPathToAGI "0.87"^^xsd:decimal)
	    DataPropertyAssertion(ai:foundationalYear ai:HistoryAndPathToAGI "1950"^^xsd:integer)
	    DataPropertyAssertion(ai:dartmouthYear ai:HistoryAndPathToAGI "1956"^^xsd:integer)
	    DataPropertyAssertion(ai:imageNetBreakthroughYear ai:HistoryAndPathToAGI "2012"^^xsd:integer)
	    DataPropertyAssertion(ai:alphaGoYear ai:HistoryAndPathToAGI "2016"^^xsd:integer)
	    DataPropertyAssertion(ai:transformerYear ai:HistoryAndPathToAGI "2017"^^xsd:integer)

	    ## Property Constraints
	    SubClassOf(ai:HistoryAndPathToAGI
	      DataMinCardinality(1 ai:hasParadigmEra xsd:string))
	    SubClassOf(ai:HistoryAndPathToAGI
	      DataAllValuesFrom(ai:isProgressingTowardAGI xsd:boolean))
	    SubClassOf(ai:HistoryAndPathToAGI
	      DataSomeValuesFrom(ai:yearEstablished xsd:integer))

	    ## Annotations
	    AnnotationAssertion(rdfs:label ai:HistoryAndPathToAGI "History and Path to AGI"@en)
	    AnnotationAssertion(rdfs:comment ai:HistoryAndPathToAGI "Intellectual and institutional chronicle of artificial intelligence from Turing 1950 through contemporary frontier AI, tracing symbolic/GOFAI, two AI winters, connectionist revival, deep learning revolution (AlexNet 2012), reinforcement learning milestones (AlphaGo 2016), transformer architecture (Attention Is All You Need 2017), GPT scaling series, Chinchilla scaling laws, RLHF alignment, frontier evaluations, and contested AGI timelines from Hassabis (5-10 years), Sutton's Bitter Lesson, Yudkowsky existential risk, Bostrom superintelligence, Aschenbrenner Situational Awareness (AGI 2027), and Kurzweil (AGI 2029); with distinctive UK contributions via Turing/Bletchley, Edinburgh, Cambridge, DeepMind London, Alan Turing Institute, and AISI."@en)
	    AnnotationAssertion(dcterms:identifier ai:HistoryAndPathToAGI "AI-2001"^^xsd:string)
	    AnnotationAssertion(dcterms:subject ai:HistoryAndPathToAGI "AI History, AGI, Deep Learning, Scaling Laws, RLHF, Frontier AI, UK AI"@en)
	  )
	  ...
	  FunctionalDataProperty(ai:dartmouthYear)
	  ```

  - ## About History and Path to AGI
  ...
  - ### Era V: The Transformer and Language Model Scaling (2017–2023)
	  ...
	  - **GPT-5** (OpenAI May 2025): unified instruct and reasoning model, reported 60%+ improvement on complex reasoning over GPT-4o, scoring in the 99th percentile on the Bar Exam simulation
  ...
  - ### The AGI Debate: Six Positions
	  ...
	  **3. Eliezer Yudkowsky — Existential Risk Minimalist**
  ...
  - ### Research and Literature
	  ...
	  1. Turing, A.M. (1950). "Computing Machinery and Intelligence." *Mind*, 59(236), 433-460. The foundational paper.
	  2. McCarthy, J., Minsky, M., Rochester, N., Shannon, C. (1955). "A Proposal for the Dartmouth Summer Research Project on Artificial Intelligence." Reprinted in *AI Magazine* 27(4), 2006.
	  ...
	  4. Lighthill, J. (1973). "Artificial Intelligence: A General Survey." *AI: A Paper Symposium*. Science Research Council.
	  ...
	  9. Mnih, V. et al. (2015). "Human-level control through deep reinforcement learning." *Nature*, 518, 529-533. (DQN)
	  10. Silver, D. et al. (2016). "Mastering the game of Go with deep neural networks and tree search." *Nature*, 529, 484-489. (AlphaGo)
	  11. Silver, D. et al. (2017). "Mastering Chess and Shogi by Self-Play with a General Reinforcement Learning Algorithm." *arXiv:1712.01815*. (AlphaZero)
	  12. Vaswani, A. et al. (2017). "Attention Is All You Need." *NeurIPS 2017*. (Transformer)
	  13. Devlin, J., Chang, M.W., Lee, K., Toutanova, K. (2018). "BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding." *NAACL 2019*.
	  14. Brown, T. et al. (2020). "Language Models are Few-Shot Learners." *NeurIPS 2020*. (GPT-3)
	  15. Hoffmann, J. et al. (2022). "Training Compute-Optimal Large Language Models." *NeurIPS 2022*. (Chinchilla)
	  16. Ouyang, L. et al. (2022). "Training language models to follow instructions with human feedback." *NeurIPS 2022*. (InstructGPT)
	  17. Bai, Y. et al. (2022). "Constitutional AI: Harmlessness from AI Feedback." *arXiv:2212.06560*. (Anthropic)
	  ...
	  20. Rafailov, R. et al. (2023). "Direct Preference Optimization: Your Language Model is Secretly a Reward Model." *NeurIPS 2023*.
	  21. Chollet, F. (2019). "On the Measure of Intelligence." *arXiv:1911.01547*. (ARC-AGI)
	  22. Bostrom, N. (2014). *Superintelligence: Paths, Dangers, Strategies*. Oxford University Press.
	  23. Sutton, R. (2019). "The Bitter Lesson." *incompleteideas.net blog post*, March 13.
	  24. Aschenbrenner, L. (2024). "Situational Awareness: The Decade Ahead." Self-published, June 2024.
	  25. Kurzweil, R. (2024). *The Singularity Is Nearer*. Viking Press.
	  26. UK AISI. (2025). "Advanced AI Evaluations at AISI: November 2024 Update." AI Safety Institute, Department for Science, Innovation and Technology.
	  27. Hendrycks, D. et al. (2020). "Measuring Massive Multitask Language Understanding." *ICLR 2021*. (MMLU)
	  28. Scale AI / CAIS. (2025). "Humanity's Last Exam." *arXiv:2501.14249*.

  - ### Metadata
    - legacy-term-id:: AI-2001
    - domain:: artificial-intelligence
    - iri:: http://narrativegoldmine.com/artificial-intelligence#HistoryAndPathToAGI
    - uri:: urn:visionclaw:concept:artificial-intelligence:history-and-path-to-agi
    - owl-class:: artificial-intelligence:HistoryAndPathToAGI
    - same-as:: urn:visionclaw:concept:artificial-intelligence:history-and-path-to-agi
