schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#DecentralizedIdentityDID
legacy_uri:: urn:visionclaw:concept:infrastructure:decentralized-identity-did
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-04ace518330b"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#DecentralizedIdentityDID"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:decentralized-identity-did"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
