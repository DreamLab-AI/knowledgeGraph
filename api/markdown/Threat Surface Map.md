schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#ThreatSurfaceMap
legacy_uri:: urn:visionclaw:concept:spatial-computing:threat-surface-map
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-d689621946f8"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#ThreatSurfaceMap"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:threat-surface-map"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
