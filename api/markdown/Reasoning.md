schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#Reasoning
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:reasoning
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-a4f7b3d9e2c1"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#Reasoning"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:reasoning"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:reasoning:776c802a9fc9",
  ...
  "vc:resolutions": [
    {
      "raw": "[[AIME Benchmark]]",
      "resolved": "urn:visionflow:linked:aime-benchmark",
      "kind": "StubLink"
    },
    {
      "raw": "[[AlgorithmLayer]]",
    ...
    {
      "raw": "[[Formal Logic]]",
      "resolved": "urn:visionflow:linked:formal-logic",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[GPQA Benchmark]]",
      "resolved": "urn:visionflow:linked:gpqa-benchmark",
      "kind": "StubLink"
    },
    {
      "raw": "[[Hallucination]]",
    ...
    {
      "raw": "[[Lean]]",
      "resolved": "urn:visionflow:linked:lean",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Neuro-Symbolic AI]]",
      "resolved": "urn:visionflow:linked:neuro-symbolic-ai",
      "kind": "StubLink"
    },
    {
      "raw": "[[Outcome Reward Model]]",
      "resolved": "urn:visionflow:linked:outcome-reward-model",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Process Reward Model]]",
      "resolved": "urn:visionflow:linked:process-reward-model",
      "kind": "StubLink"
    },
    {
      "raw": "[[ReAct]]",
    ...
    {
      "raw": "[[Scratchpad Computation]]",
      "resolved": "urn:visionflow:linked:scratchpad-computation",
      "kind": "StubLink"
    },
    {
...
- ### Definition
  - Reasoning in artificial intelligence encompasses the computational processes by which systems derive conclusions, formulate plans, solve problems, and generate explanations from knowledge, data, and prior context.
  - The field spans the full spectrum from fast, pattern-driven inference (System 1 in dual-process cognitive theory, Stanovich & West 2000; Kahneman 2011) through slow, deliberate, step-by-step logical analysis (System 2).
  - A now-dominant class of test-time compute scaling methods allocates additional compute budget at inference for models to search, verify, and self-correct intermediate steps before emitting a final answer.
  - Modern AI reasoning research covers five interlocking sub-fields:
    - (1) **Prompting-level interventions** — chain-of-thought (CoT) eliciting intermediate reasoning steps in natural language (Wei et al., Google Brain, NeurIPS 2022) across both few-shot exemplar mode and zero-shot mode (Kojima et al. NeurIPS 2022); self-consistency sampling k independent CoT paths and selecting majority-vote answers (Wang et al., Google Brain, ICLR 2023); Tree-of-Thoughts (ToT) exploring branching deliberation trees with BFS/DFS backtracking (Yao et al., Princeton/DeepMind, NeurIPS 2023); Graph-of-Thoughts (GoT) generalising to DAGs permitting branch merging (Besta et al., ETH Zurich, 2023); and ReAct interleaving reasoning traces with executable tool-call actions (Yao et al., Princeton/Google, ICLR 2023).
    - (2) **Architecture-level reasoning training** — Reinforcement Learning from Verifiable Rewards (RLVR) using rule-based outcome signals (exact-match answers, pass/fail on test cases, formal proof checker certificates) to train extended thinking scratchpads without human-annotated reasoning traces, exemplified by OpenAI o1 (September 2024), o3 (December 2024), and DeepSeek-R1 (January 2025).
    - (3) **Process and outcome reward modelling** — step-level Process Reward Models (PRM, Lightman et al. OpenAI NeurIPS 2023) outperforming final-answer Outcome Reward Models (ORM) at equal inference budgets; Math-Shepherd (Wang et al. ACL 2024) automating PRM labels via execution feedback.
    - (4) **Neuro-symbolic integration** — combining neural pattern recognition with classical symbolic rule systems, satisfiability solvers, ontology reasoners (OWL-DL, SPARQL), and first-order logic provers (Evans & Grefenstette, Neural Theorem Prover, JAIR 2018; Selsam et al., NeuroSAT, ICLR 2019).
    - (5) **Formal mathematical proof** — large-scale theorem-proving assistants targeting Lean 4 and Isabelle proof systems, culminating in DeepMind AlphaProof (July 2024, Nature 2024) achieving silver-medal equivalent performance on IMO 2024 problems.
  - Benchmark evaluation spans AIME (competition-level algebraic/combinatoric reasoning, 15 problems per competition), MATH (curriculum-level, 12,500 problems across 7 subjects, Hendrycks et al. NeurIPS 2021), GPQA (Graduate-level Google-Proof Q&A, 448 expert-validated questions in chemistry, physics, and biology, Rein et al. NeurIPS 2023), and ARC-AGI (Chollet 2019; ARC-AGI-2, 2025).
  - Models trained with RLVR to reason explicitly routinely surpass human expert performance on AIME (97% for o3 vs approximately 15% average human contestant) and GPQA (80% vs 65% human PhD) while remaining brittle on novel compositional inductive tasks like ARC-AGI-2 (below 15% for all publicly disclosed systems as of May 2026).
  - This capability contrast — superhuman on human-grade structured problem solving, subhuman on simple inductive extrapolation — defines the current research frontier and is central to ongoing debates about what genuine reasoning requires.

- ### Semantic Classification
  - owl-class:: artificial-intelligence:Reasoning
  - owl-role:: CognitiveCapability
  - owl-inferred:: ai:Cognition, ai:ProblemSolving, ai:InferenceMechanism, ai:KnowledgeRepresentation, ai:PlanningCapability
  - belongs-to-domain:: [[AI-GroundedDomain]], [[CognitiveScienceDomain]], [[FormalMethodsDomain]], [[ComputationAndIntelligenceDomain]]
...
- ### Relationships
  ...
  - implements:: [[Chain-of-Thought Prompting]], [[Reinforcement Learning]], [[Neuro-Symbolic AI]], [[Test-Time Compute]], [[Self-Consistency]], [[Tree of Thoughts]], [[ReAct]], [[Monte Carlo Tree Search]]
  - depends-on:: [[Attention]], [[Transformers]], [[Reinforcement Learning]], [[Formal Logic]], [[Information Theory]], [[Benchmarks]], [[Large Language Models]]
...
- ### Content
  ...
  - ### Components / Architecture
    ...
    - **Claude 3.7 Extended Thinking**
      ...
      - API interface exposes `thinking: {type: "enabled", budget_tokens: N}` allowing downstream engineers to balance cost versus accuracy by tuning the thinking budget per request class.
    - **Process Reward Models (PRM) versus Outcome Reward Models (ORM)**
      ...
      - Step-level human annotation is expensive: 800,000 annotations required approximately 2,000 person-hours of expert mathematical annotation at estimated cost of $200,000-$500,000.
  ...
  - ### Metadata
    - domain-correction:: none — domain `artificial-intelligence` confirmed correct; iri, uri, same-as, owl-class all aligned with artificial-intelligence namespace
    - owl-class:: artificial-intelligence:Reasoning
    - iri:: http://narrativegoldmine.com/artificial-intelligence#Reasoning
    - uri:: urn:visionclaw:concept:artificial-intelligence:reasoning
    - same-as:: urn:visionclaw:concept:artificial-intelligence:reasoning
    - legacy-term-id:: AI-0201
    - enrichment-worker:: claude-sonnet-4-6
    - enrichment-phase:: 6
    - enrichment-date:: 2026-05-17T10:00:00Z
    - note:: Original stub contained fragmentary NLEP/DeepSeek-R1 Twitter/X content without ontological structure; full replacement with Phase 6 pattern applied
