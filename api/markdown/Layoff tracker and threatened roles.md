schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#LayoffTrackerAndThreatenedRoles
legacy_uri:: urn:visionclaw:concept:infrastructure:layoff-tracker-and-threatened-roles
public:: true
...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "layoff-tracker-and-threatened-roles",
  "title": "Layoff tracker and threatened roles",
  "vc:public": true,
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-d561dbef3ee3"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#LayoffTrackerAndThreatenedRoles"
    },
    {
      "vc:key": "maturity",
      "vc:value": "draft"
    ...
    },
    {
      ...
      "vc:value": "Layoff tracker and threatened roles"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:layoff-tracker-and-threatened-roles"
    },
    {
      "vc:key": "status",
      "vc:value": "stub"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:3b4516c8f4d86c6300b4674f79d89c17224fec7b3a4370f577c3fb33a870de12@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
```json-ld
{
  ...
  "definition": "Layoff tracker and threatened roles is a concept within the ngm domain.",
  "vc:qualityScore": {
    "@value": "0.50",
    "@type": "xsd:float"
  },
