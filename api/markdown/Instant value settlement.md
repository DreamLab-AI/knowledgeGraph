...
- ### Content
  ...
  - ### Academic Context
    ...
    - **BIS and central bank research**
      - Auer, Cornelli, and Frost (2023, BIS Working Paper No. 880): foundational framework for the unified ledger concept, establishing that combining central bank money, commercial bank deposits, and tokenised assets on a programmable platform [private] eliminate the synchronisation problem in cross-border settlement.
