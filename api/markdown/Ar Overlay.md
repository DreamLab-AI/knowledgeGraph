schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#ArOverlay
legacy_uri:: urn:visionclaw:concept:spatial-computing:ar-overlay
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-ec83bf82d6d2"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#ArOverlay"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:ar-overlay"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
