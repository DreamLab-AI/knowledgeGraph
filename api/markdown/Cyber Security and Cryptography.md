schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#CyberSecurityAndCryptography
legacy_uri:: urn:visionclaw:concept:infrastructure:cyber-security-and-cryptography
public:: true
...
```json-ld
{
  ...
  "@id": "urn:visionflow:page:a2ba57912d41f3643b9a483e86dfd43ee3998fa0cbabbea4286f228f8d764800",
  "@type": "Page",
  "vc:slug": "cyber-security-and-cryptography",
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:ca-browser-forum",
      "vc:label": "CA/Browser Forum"
    },
    {
      "@id": "urn:visionflow:linked:castle-and-moat-architecture",
      "vc:label": "Castle-and-Moat Architecture"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:defence-and-intelligence",
      "vc:label": "Defence and Intelligence"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:healthcare-data-security",
      "vc:label": "Healthcare Data Security"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:intrusion-detection-system",
    ...
    {
      "@id": "urn:visionflow:linked:obscurity-based-security",
      "vc:label": "Obscurity-Based Security"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:password-authentication",
      "vc:label": "Password Authentication"
    },
    {
      "@id": "urn:visionflow:linked:pci-ssc",
      "vc:label": "PCI SSC"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:symmetric-only-cryptography",
      "vc:label": "Symmetric-Only Cryptography"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-31b2949cd492"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#CyberSecurityAndCryptography"
    },
    {
    ...
    },
    {
      ...
      "vc:value": "Cyber Security and Cryptography"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:cyber-security-and-cryptography"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:a2ba57912d41f3643b9a483e86dfd43ee3998fa0cbabbea4286f228f8d764800@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
```json-ld
{
  ...
  "definition": "Cyber Security and Cryptography is the integrated discipline governing the confidentiality, integrity, availability, and authenticity of digital information systems through mathematical cryptographic primitives, protocol engineering, and systemic security architecture. The field bifurcates into two tightly coupled branches: **applied cryptography** — providing provably secure mathematical constructions formalised via indistinguishability (IND-CPA, IND-CCA2), existential unforgeability (EUF-CMA), and authenticated key exchange (Bellare-Rogaway model); and **operational cybersecurity** — addressing the adversarial environment in which cryptographic systems are deployed. Symmetric cryptography furnishes the data-plane protection layer: AES-256-GCM (NIST FIPS 197, AEAD, 10-40 Gbps with AES-NI hardware acceleration; ARMv8 Crypto Extension achieving 2-8 Gbps on Cortex-A55/A78 SoC); ChaCha20-Poly1305 (RFC 8439, TLS 1.3 and WireGuard, preferred where AES hardware is absent); AES-256-XTS (IEEE Std 1619-2007, full-disk encryption at 4-7 GB/s inline on NVMe TCG Opal 2.0 drives); BLAKE3 (2020, 14 GB/s x86, tree-structured parallelism).",
  "vc:qualityScore": {
    "@value": "0.52",
    "@type": "xsd:float"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:cyber-security-and-cryptography:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[CA/Browser Forum]]",
      "resolved": "urn:visionflow:linked:ca-browser-forum",
      "kind": "StubLink"
    },
    {
      "raw": "[[Castle-and-Moat Architecture]]",
      "resolved": "urn:visionflow:linked:castle-and-moat-architecture",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Defence and Intelligence]]",
      "resolved": "urn:visionflow:linked:defence-and-intelligence",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Formal Methods]]",
      "resolved": "urn:visionflow:linked:formal-methods",
      "kind": "StubLink"
    },
    {
      "raw": "[[GDPR]]",
    ...
    {
      "raw": "[[Healthcare Data Security]]",
      "resolved": "urn:visionflow:linked:healthcare-data-security",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Intrusion Detection System]]",
      "resolved": "urn:visionflow:linked:intrusion-detection-system",
      "kind": "StubLink"
    },
    {
      "raw": "[[ISO/IEC 27001]]",
    ...
    {
      "raw": "[[NSA]]",
      "resolved": "urn:visionflow:linked:nsa",
      "kind": "StubLink"
    },
    {
      "raw": "[[Number Theory]]",
    ...
    {
      "raw": "[[Obscurity-Based Security]]",
      "resolved": "urn:visionflow:linked:obscurity-based-security",
      "kind": "StubLink"
    },
    {
    ...
    },
    {
      ...
      "resolved": "urn:visionflow:linked:password-authentication",
      "kind": "StubLink"
    },
    {
      "raw": "[[PCI SSC]]",
      "resolved": "urn:visionflow:linked:pci-ssc",
      "kind": "StubLink"
    },
    {
      "raw": "[[Perimeter Security]]",
      "resolved": "urn:visionflow:linked:perimeter-security",
      "kind": "StubLink"
    },
    {
      "raw": "[[PolicyLayer]]",
    ...
    {
      "raw": "[[Security Operations Centre]]",
      "resolved": "urn:visionflow:linked:security-operations-centre",
      "kind": "StubLink"
    },
    {
      "raw": "[[SIEM]]",
    ...
    {
      "raw": "[[Symmetric-Only Cryptography]]",
      "resolved": "urn:visionflow:linked:symmetric-only-cryptography",
      "kind": "StubLink"
    },
    {
...
- ### Definition
  ...
  - The field bifurcates into two tightly coupled branches: **applied cryptography** — providing provably secure mathematical constructions formalised via indistinguishability (IND-CPA, IND-CCA2), existential unforgeability (EUF-CMA), and authenticated key exchange (Bellare-Rogaway model); and **operational cybersecurity** — addressing the adversarial environment in which cryptographic systems are deployed.
  - Symmetric cryptography furnishes the data-plane protection layer: AES-256-GCM (NIST FIPS 197, AEAD, 10-40 Gbps with AES-NI hardware acceleration; ARMv8 Crypto Extension achieving 2-8 Gbps on Cortex-A55/A78 SoC); ChaCha20-Poly1305 (RFC 8439, TLS 1.3 and WireGuard, preferred where AES hardware is absent); AES-256-XTS (IEEE Std 1619-2007, full-disk encryption at 4-7 GB/s inline on NVMe TCG Opal 2.0 drives); BLAKE3 (2020, 14 GB/s x86, tree-structured parallelism).
  - Asymmetric cryptography enables key exchange and digital signatures: RSA-4096 (NIST SP 800-57 Rev.5, 2048-bit minimum until 2030); ECDSA P-256/P-384/P-521 (FIPS 186-5, 2023); X25519 Diffie-Hellman (RFC 7748, dominant TLS 1.3 key share, 500K ops/sec); Ed25519 signatures (RFC 8032, 64-byte, 100K sign/sec); Schnorr/MuSig2 (BIP-340, Bitcoin Taproot, key aggregation).
  - The **post-quantum cryptography (PQC) transition** — catalysed by NIST finalising FIPS 203 (ML-KEM/Kyber lattice KEM), FIPS 204 (ML-DSA/Dilithium lattice signatures), and FIPS 205 (SLH-DSA/SPHINCS+ hash-based signatures) in August 2024 — represents the largest cryptographic migration since RSA/ECC displaced symmetric-only key exchange in the 1990s.
  - Organisations must achieve hybrid classical-PQC cryptographic readiness by 2030 to protect against **harvest-now-decrypt-later (HNDL) adversaries** assumed to be capturing TLS sessions since 2020, targeting CRQC availability estimated 2030-2035 (Webber et al. Nature Quantum Information 2022: RSA-2048 break requires ~4,000 logical / 4 million physical qubits under surface code error correction).
  - Operational cybersecurity extends cryptographic primitives into systemic defence: zero-trust network architecture (NIST SP 800-207); SOC tooling with SIEM (100K-10M events/sec correlated against MITRE ATT&CK v14), EDR/XDR, and SOAR; threat intelligence via STIX 2.1/TAXII 2.1; vulnerability management (CVE/NVD, CVSS 4.0, EPSS); supply-chain security (SLSA v1.0, SBOM via SPDX/CycloneDX, Sigstore keyless signing, in-toto attestation).
  - The UK **National Cyber Security Centre (NCSC)** — technical authority arm of GCHQ, headquartered London with Manchester/Salford operations — issued PQC migration guidance (NCSC-T-PQC-001, 2024) mandating a five-phase model: cryptographic asset inventory by 2025, hybrid X25519+ML-KEM deployment 2025-2027, full primary PQC with classical fallback 2027-2030, for CNI sectors aligned with the UK National Cyber Strategy 2022-2030.

- ### Semantic Classification
  - owl-class:: infrastructure:CyberSecurityAndCryptography
  - owl-role:: SecurityDiscipline
  - owl-inferred:: infrastructure:NetworkSecurity, infrastructure:DataProtection, infrastructure:CryptographicProtocol, infrastructure:IdentityManagement, infrastructure:ThreatManagement
  - belongs-to-domain:: [[InfrastructureDomain]], [[SecurityDomain]], [[CryptographyDomain]], [[RiskManagementDomain]]
  - implemented-in-layer:: [[ProtocolLayer]], [[ApplicationLayer]], [[HardwareLayer]], [[PolicyLayer]], [[OperationalLayer]]

- ### Relationships
  - is-subclass-of:: [[Information Security]], [[Applied Mathematics]], [[Network Security]], [[Systems Engineering]], [[Risk Management]]
  - has-part:: [[Public Key Infrastructure]], [[Transport Layer Security]], [[Post-Quantum Cryptography]], [[Zero Trust Architecture]], [[Key Management]], [[Hardware Security Module]], [[Security Operations Centre]], [[Threat Intelligence]], [[Identity and Access Management]], [[Secure Enclave]], [[Certificate Authority]], [[Digital Signature]], [[Homomorphic Encryption]], [[Secure Multi-Party Computation]]
  - requires:: [[Cryptographic Primitives]], [[Certificate Authority]], [[Entropy]], [[Hardware Security Module]], [[Threat Model]], [[Vulnerability Management]], [[Trusted Execution Environment]]
  - enables:: [[Secure Communication]], [[Data Confidentiality]], [[Data Integrity]], [[Non-Repudiation]], [[Authentication]], [[Privacy Engineering]], [[Digital Sovereignty]], [[Regulatory Compliance]], [[Supply Chain Security]]
  - implements:: [[TLS 1.3]], [[Signal Protocol]], [[Post-Quantum Cryptography]], [[Zero Trust Architecture]], [[FIDO2]], [[AES-GCM]], [[ChaCha20-Poly1305]], [[Homomorphic Encryption]], [[Secure Multi-Party Computation]], [[Threshold Signatures]], [[Zero-Knowledge Proofs]]
  - depends-on:: [[Number Theory]], [[Elliptic Curve Cryptography]], [[Lattice Cryptography]], [[Computational Complexity Theory]], [[Entropy]], [[Public Key Infrastructure]], [[Formal Methods]]
...
- ### Content
  ...
  - The global cost of data breaches reached a record **$4.88 million average** in 2024 (IBM/Ponemon); ransomware payments exceeded **$1.1 billion** in 2023 (Chainalysis); ENISA Cyber Threat Landscape 2024 identifies AI-enhanced attacks, quantum migration risk, and cloud provider concentration as the three leading systemic emerging risks.
  ...
  - **Institutional MPC custody**: Fireblocks (MPC-CMP protocol, $1T+ assets under custody 2024, Fortune 500 banks); Qredo ($50B+ TVL, decentralised MPC network); Copper ClearLoop (institutional settlement, MPC key management).
  ...
  - **Ransomware-as-a-Service (RaaS) economics**: LockBit 3.0 (75/25 affiliate revenue share, $91M paid by US victims 2023 per FBI; Operation Cronos NCA/FBI/Europol/Interpol February 2024 takedown, decryptors for 7,000+ victims; LockBit 4.0 relaunched May 2024); ALPHV/BlackCat (Rust cross-platform, FBI disruption December 2023; Change Healthcare $22M ransom paid February 2024, 100M+ patient records 4TB exfiltrated).
  ...
  - **IBM Cost of a Data Breach 2024**: $4.88M global average (record); $9.77M US average; healthcare $9.77M highest industry; organisations using AI+automation saved $2.2M per breach vs those without; 70% of breaches involved third-party component.
...
- ### Provenance
  - **Primary standards and guidance**:
    - NIST (2024) FIPS 203 ML-KEM — https://doi.org/10.6028/NIST.FIPS.203
    - NIST (2024) FIPS 204 ML-DSA — https://doi.org/10.6028/NIST.FIPS.204
    - NIST (2024) FIPS 205 SLH-DSA — https://doi.org/10.6028/NIST.FIPS.205
    - NCSC (2024) Post-Quantum Cryptography Migration Guidance NCSC-T-PQC-001 — https://www.ncsc.gov.uk/guidance/post-quantum-cryptography
    - RFC 8446 (2018) TLS 1.3 — Rescorla E, IETF
    - RFC 9420 (2023) MLS Messaging Layer Security — IETF
    - RFC 9591 (2024) FROST Threshold Schnorr — IETF
    - NIST SP 800-207 (2020) Zero Trust Architecture
    - NSA CNSA 2.0 (September 2022) — Advisory U/OO/194427-22
    - ENISA Threat Landscape 2024 (November 2024)
    - ISO/IEC 27001:2022; FIPS 140-3 (2019); NIST SP 800-57 Part 1 Rev.5
  ...
  - **Standards bodies**: [[NIST]], [[IETF]], [[ISO/IEC 27001]], [[ETSI]], [[NCSC]], [[ENISA]], [[NSA]], [[OASIS]], [[CA/Browser Forum]], [[FIDO Alliance]], [[PCI SSC]]
