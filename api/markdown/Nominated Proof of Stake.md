schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#NominatedProofOfStake
legacy_uri:: urn:visionclaw:concept:blockchain:nominated-proof-of-stake
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-2c09a4a4e81a"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#NominatedProofOfStake"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:nominated-proof-of-stake"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
