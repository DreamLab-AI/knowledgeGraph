...
- Intersectional fairness extends traditional fairness concepts by recognising that individuals' experiences of discrimination arise from overlapping social identities, such as race, gender, class, and more.
  - This challenges fairness assessments that consider protected groups independently, highlighting that fairness at the intersection of multiple identities may reveal disparities hidden by single-axis analyses.
  - Key academic foundations trace back to Kimberlé Crenshaw’s seminal work on intersectionality in legal studies, which has since informed fairness in machine learning and AI ethics.
  - Contemporary research identifies multiple formal notions of intersectional fairness, including subgroup fairness, max-min fairness, metric-based fairness, calibration, probabilistic fairness, and differential fairness, each addressing different computational and ethical challenges[1].
