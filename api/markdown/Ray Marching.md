schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#RayMarching
legacy_uri:: urn:visionclaw:concept:spatial-computing:ray-marching
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-44f5bc175e00"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#RayMarching"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:ray-marching"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:b2912f8a2e0cf8ca72da18ea14bfa855484e4435053cd3d6dd979b4b865812e3@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:ray-marching",
  "@type": "OntologyClass",
  "label": "Ray Marching",
  "subClassOf": [
    {
