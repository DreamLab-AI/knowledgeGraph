...
- ### Content
  ...
  - Technical limitation: coordinator trust — a compromised or colluding coordinator [private] manipulate the tally without detection, since the coordinator decrypts votes in plaintext.
  ...
  - **Quorum Manipulation / Voter Apathy Exploitation**: With typical 5-15% participation, the effective quorum is lower than nominal token supply suggests. An attacker or faction controlling 20-25% of actively participating supply (not total supply) [private] dominate votes if broad community apathy persists. Strategic timing of proposal submission during holiday periods, major market events, or competing governance crises has been documented in multiple DAO incident reports.
