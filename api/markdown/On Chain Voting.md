iri:: http://narrativegoldmine.com/blockchain#OnChainVoting
uri:: urn:visionclaw:concept:blockchain:on-chain-voting
rdf-type:: owl:Class
same-as:: urn:visionclaw:concept:blockchain:on-chain-voting
type:: owl:Class
context:: https://visionclaw.dreamlab-ai.systems/ns/v2
domain:: blockchain
preferred-term:: On Chain Voting
content-hash:: sha256-12-ba14c6102bcb
legacy-term-id:: BC-0462
...
- ### Definition
  - Cryptographically verifiable, blockchain-recorded governance mechanism enabling [[DAO]] participants to cast votes that execute automatically through [[Smart Contract|smart contracts]], creating immutable audit trails and trustless decision-making—deployed across [[Uniswap]], [[Compound]], [[Aave]], [[MakerDAO]] governing $25+ billion in treasury assets whilst facing challenges around voter participation (5-15%), plutocratic concentration, and gas cost barriers.
