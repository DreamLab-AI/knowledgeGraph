schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#AIModelCard
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:ai-model-card
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-25b37f5588ca"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#AIModelCard"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:ai-model-card"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
...
- ### Content
  AI Model Card — content pending enrichment.

- ### Provenance
  - sources:: [[Google Model Cards for Model Reporting]] (https://modelcards.withgoogle.com/), [[Mitchell et al. 2019]] (https://arxiv.org/abs/1810.03993), [[ISO/IEC 42001]] (https://www.iso.org/standard/81230.html)
