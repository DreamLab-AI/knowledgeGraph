schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#ComputingPlatform
legacy_uri:: urn:visionclaw:concept:infrastructure:computing-platform
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-bf538f8f050d"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#ComputingPlatform"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:computing-platform"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:d48dec94d04c44678492db1d1d7df1ff66ed80097538cd030011a0a2e77b2976@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
