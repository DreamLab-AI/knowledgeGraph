schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#3DDesign
legacy_uri:: urn:visionclaw:concept:infrastructure:3ddesign
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-61a4187c2556"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#3DDesign"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:3ddesign"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:8b5f26e1526d95a377b2fcfc06fb7875aaa0de259d2a6433c75c59194143993b@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:3-ddesign",
  "@type": "OntologyClass",
  "label": "3DDesign",
  "subClassOf": [
    {
  ...
  "definition": "3DDesign is a concept within the ngm domain.",
  "vc:qualityScore": {
    "@value": "0.35",
    "@type": "xsd:float"
  },
