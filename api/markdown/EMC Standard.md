schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/robotics#EMCStandard
legacy_uri:: urn:visionclaw:concept:robotics:emc-standard
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-fed0d5160992"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/robotics#EMCStandard"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:robotics:emc-standard"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
