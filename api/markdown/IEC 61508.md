...
```json-ld
{
  ...
  "relations": {
    ...
    "requires": [
      ...
      {"@id": "urn:ngm:class:independent-safety-assessment", "label": "Independent Safety Assessment"},
    ...
    "standardizedBy": [
      {"@id": "urn:ngm:class:international-electrotechnical-commission", "label": "International Electrotechnical Commission"}
    ],
    "relatedTo": [
    ...
    "contrastsWith": [
      ...
      {"@id": "urn:ngm:class:iso-25119", "label": "ISO 25119"}
    ],
    "bridgesTo": [
  ...
  "sameAs": [
    {"@id": "urn:ngm:class:functional-safety-standard", "label": "Functional Safety Standard"}
  ],
  "quality": 0.74,
  "provenance": {
