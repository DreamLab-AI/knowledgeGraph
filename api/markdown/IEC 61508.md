...
```json-ld
{
  ...
  "relations": {
    ...
    "requires": [
      ...
      },
      {
        ...
        "label": "Independent Safety Assessment"
      },
      {
    ...
    "standardizedBy": [
      {
        "@id": "urn:ngm:class:international-electrotechnical-commission",
  ...
  "sameAs": [
    {
      "@id": "urn:ngm:class:functional-safety-standard",
      "label": "Functional Safety Standard"
    }
  ],
  "quality": 0.74,
  "provenance": {
...
- ### Applications and Use Cases
  ...
  - #### Industrial Cybersecurity (Bridge)
    ...
    - Security vulnerabilities that [private] compromise safety functions require analysis under both frameworks
...
- ### Standards and Context
  ...
  - **Relationship to [[Cybersecurity Standard]]s**: IEC 62443 security levels do not directly map to SIL; joint analysis is required when cybersecurity threats [private] compromise [[Safety Function]]s — a recognised gap addressed by the IEC 65A/WG12 working group.
