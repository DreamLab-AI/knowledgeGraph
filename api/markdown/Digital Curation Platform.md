schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#DigitalCurationPlatform
legacy_uri:: urn:visionclaw:concept:spatial-computing:digital-curation-platform
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-1c2d9f775efa"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#DigitalCurationPlatform"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:digital-curation-platform"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
