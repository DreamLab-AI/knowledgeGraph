schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/artificial-intelligence#GPTsAndCustomAssistants
legacy_uri:: urn:visionclaw:concept:artificial-intelligence:gpts-and-custom-assistants
public:: true
...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "gpts-and-custom-assistants",
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:anthropic-agent-skills-october-2025",
      "vc:label": "Anthropic Agent Skills October 2025"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:anthropic-claude-projects-june-2024",
      "vc:label": "Anthropic Claude Projects June 2024"
    },
    {
      "@id": "urn:visionflow:linked:application-layer-domain",
      "vc:label": "ApplicationLayerDomain"
    },
    {
      "@id": "urn:visionflow:linked:asai-et-al-2023-self-rag",
      "vc:label": "Asai et al. 2023 Self-RAG"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:google-gemini-gems-august-2024",
      "vc:label": "Google Gemini Gems August 2024"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:guu-et-al-2020-realm",
      "vc:label": "Guu et al. 2020 REALM"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:hsieh-et-al-2024-ruler-long-context-evaluation",
      "vc:label": "Hsieh et al. 2024 RULER Long-Context Evaluation"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:izacard-and-grave-2021-fusion-in-decoder",
      "vc:label": "Izacard & Grave 2021 Fusion-in-Decoder"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:karpukhin-et-al-2020-dense-passage-retrieval",
      "vc:label": "Karpukhin et al. 2020 Dense Passage Retrieval"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:lewis-et-al-2020-retrieval-augmented-generation",
      "vc:label": "Lewis et al. 2020 Retrieval-Augmented Generation"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:liu-et-al-2023-lost-in-the-middle",
      "vc:label": "Liu et al. 2023 Lost in the Middle"
    },
    {
      "@id": "urn:visionflow:linked:liu-et-al-2024-prompt-injection-against-llm-applications",
      "vc:label": "Liu et al. 2024 Prompt Injection against LLM Applications"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:microsoft-copilot-studio-build-2024",
      "vc:label": "Microsoft Copilot Studio Build 2024"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:open-ai-apps-sdk-october-2025",
      "vc:label": "OpenAI Apps SDK October 2025"
    },
    {
      "@id": "urn:visionflow:linked:open-ai-assistants-api-v2-april-2024",
      "vc:label": "OpenAI Assistants API v2 April 2024"
    },
    {
      "@id": "urn:visionflow:linked:open-ai-chat-gpt-app-directory-december-2025",
      "vc:label": "OpenAI ChatGPT App Directory December 2025"
    },
    {
      "@id": "urn:visionflow:linked:open-ai-introducing-gpts-dev-day-2023",
      "vc:label": "OpenAI Introducing GPTs DevDay 2023"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:perez-and-ribeiro-2022-ignore-previous-prompt",
    ...
    {
      "@id": "urn:visionflow:linked:productivity-domain",
      "vc:label": "ProductivityDomain"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:qin-et-al-2023-tool-llm",
      "vc:label": "Qin et al. 2023 ToolLLM"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:yu-et-al-2024-prompt-injection-risks-in-custom-gpts",
      "vc:label": "Yu et al. 2024 Prompt Injection Risks in Custom GPTs"
    },
    {
      "@id": "urn:visionflow:linked:zamfirescu-pereira-et-al-2023-why-johnny-can-t-prompt",
      "vc:label": "Zamfirescu-Pereira et al. 2023 Why Johnny Can't Prompt"
    },
    {
    ...
    {
      "@id": "urn:visionflow:linked:zou-et-al-2023-universal-adversarial-attacks-on-aligned-llms",
      "vc:label": "Zou et al. 2023 Universal Adversarial Attacks on Aligned LLMs"
    },
    {
  ...
  "vc:legacyProperties": [
    {
      ...
      "vc:value": "Custom GPTs, Custom AI Assistants, Custom Assistants, Claude Projects, Gemini Gems, Copilot Agents"
    },
    {
    ...
    {
      "vc:key": "bridges-to",
      "vc:value": "[[Agents]], [[Agent Frameworks]], [[Large Language Models]]"
    },
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-42ed1d69a9c1"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/artificial-intelligence#GPTsAndCustomAssistants"
    },
    {
    ...
    },
    {
      ...
      "vc:value": "GPTs and Custom Assistants"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:artificial-intelligence:gpts-and-custom-assistants"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:gpts-and-custom-assistants:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[Anthropic Agent Skills October 2025]]",
      "resolved": "urn:visionflow:linked:anthropic-agent-skills-october-2025",
      "kind": "StubLink"
    },
    {
      "raw": "[[Anthropic Agent Skills Open Standard]]",
      "resolved": "urn:visionflow:linked:anthropic-agent-skills-open-standard",
      "kind": "StubLink"
    },
    {
      "raw": "[[Anthropic Claude Projects June 2024]]",
      "resolved": "urn:visionflow:linked:anthropic-claude-projects-june-2024",
      "kind": "StubLink"
    },
    {
      "raw": "[[ApplicationLayerDomain]]",
      "resolved": "urn:visionflow:linked:application-layer-domain",
      "kind": "StubLink"
    },
    {
      "raw": "[[Asai et al. 2023 Self-RAG]]",
      "resolved": "urn:visionflow:linked:asai-et-al-2023-self-rag",
      "kind": "StubLink"
    },
    {
      "raw": "[[Authentication]]",
    ...
    {
      "raw": "[[Bot Marketplaces]]",
      "resolved": "urn:visionflow:linked:bot-marketplaces",
      "kind": "StubLink"
    },
    {
      "raw": "[[Chunking]]",
      "resolved": "urn:visionflow:linked:chunking",
      "kind": "StubLink"
    },
    {
      "raw": "[[Conversation Memory]]",
      "resolved": "urn:visionflow:linked:conversation-memory",
      "kind": "StubLink"
    },
    {
      "raw": "[[Conversation Starter]]",
      "resolved": "urn:visionflow:linked:conversation-starter",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Document Q&A]]",
      "resolved": "urn:visionflow:linked:document-q-and-a",
      "kind": "StubLink"
    },
    {
      "raw": "[[Education]]",
    ...
    {
      "raw": "[[Enterprise Knowledge Surfacing]]",
      "resolved": "urn:visionflow:linked:enterprise-knowledge-surfacing",
      "kind": "StubLink"
    },
    {
      "raw": "[[Fine-Tuned Models]]",
      "resolved": "urn:visionflow:linked:fine-tuned-models",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Google Gemini Gems August 2024]]",
      "resolved": "urn:visionflow:linked:google-gemini-gems-august-2024",
      "kind": "StubLink"
    },
    {
      "raw": "[[GPT-5]]",
      "resolved": "urn:visionflow:linked:gpt-5",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Guu et al. 2020 REALM]]",
      "resolved": "urn:visionflow:linked:guu-et-al-2020-realm",
      "kind": "StubLink"
    },
    {
      "raw": "[[Healthcare Triage]]",
      "resolved": "urn:visionflow:linked:healthcare-triage",
      "kind": "StubLink"
    },
    {
      "raw": "[[Hsieh et al. 2024 RULER Long-Context Evaluation]]",
      "resolved": "urn:visionflow:linked:hsieh-et-al-2024-ruler-long-context-evaluation",
      "kind": "StubLink"
    },
    {
      "raw": "[[Hybrid Search]]",
      "resolved": "urn:visionflow:linked:hybrid-search",
      "kind": "StubLink"
    },
    {
      "raw": "[[InterfaceLayer]]",
    ...
    {
      "raw": "[[Izacard & Grave 2021 Fusion-in-Decoder]]",
      "resolved": "urn:visionflow:linked:izacard-and-grave-2021-fusion-in-decoder",
      "kind": "StubLink"
    },
    {
      "raw": "[[JSON Schema]]",
    ...
    {
      "raw": "[[Karpukhin et al. 2020 Dense Passage Retrieval]]",
      "resolved": "urn:visionflow:linked:karpukhin-et-al-2020-dense-passage-retrieval",
      "kind": "StubLink"
    },
    {
      "raw": "[[Knowledge Base]]",
    ...
    {
      "raw": "[[Lewis et al. 2020 Retrieval-Augmented Generation]]",
      "resolved": "urn:visionflow:linked:lewis-et-al-2020-retrieval-augmented-generation",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Liu et al. 2023 Lost in the Middle]]",
      "resolved": "urn:visionflow:linked:liu-et-al-2023-lost-in-the-middle",
      "kind": "StubLink"
    },
    {
      "raw": "[[Liu et al. 2024 Prompt Injection against LLM Applications]]",
      "resolved": "urn:visionflow:linked:liu-et-al-2024-prompt-injection-against-llm-applications",
      "kind": "StubLink"
    },
    {
      "raw": "[[LLM Application]]",
      "resolved": "urn:visionflow:linked:llm-application",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Microsoft Copilot Studio Build 2024]]",
      "resolved": "urn:visionflow:linked:microsoft-copilot-studio-build-2024",
      "kind": "StubLink"
    },
    {
      "raw": "[[Model Configuration]]",
      "resolved": "urn:visionflow:linked:model-configuration",
      "kind": "StubLink"
    },
    {
      "raw": "[[Newsroom Workflows]]",
      "resolved": "urn:visionflow:linked:newsroom-workflows",
      "kind": "StubLink"
    },
    {
      "raw": "[[No-Code Platform]]",
      "resolved": "urn:visionflow:linked:no-code-platform",
      "kind": "StubLink"
    },
    {
      "raw": "[[OAuth 2.0]]",
    ...
    {
      "raw": "[[OpenAI Apps SDK October 2025]]",
      "resolved": "urn:visionflow:linked:open-ai-apps-sdk-october-2025",
      "kind": "StubLink"
    },
    {
      "raw": "[[OpenAI Assistants API v2 April 2024]]",
      "resolved": "urn:visionflow:linked:open-ai-assistants-api-v2-april-2024",
      "kind": "StubLink"
    },
    {
      "raw": "[[OpenAI ChatGPT App Directory December 2025]]",
      "resolved": "urn:visionflow:linked:open-ai-chat-gpt-app-directory-december-2025",
      "kind": "StubLink"
    },
    {
      "raw": "[[OpenAI Introducing GPTs DevDay 2023]]",
      "resolved": "urn:visionflow:linked:open-ai-introducing-gpts-dev-day-2023",
      "kind": "StubLink"
    },
    {
      "raw": "[[OpenAPI 3.0]]",
      "resolved": "urn:visionflow:linked:open-api-3-0",
      "kind": "StubLink"
    },
    {
      "raw": "[[OpenAPI Schema]]",
      "resolved": "urn:visionflow:linked:open-api-schema",
      "kind": "StubLink"
    },
    {
    ...
    },
    {
      ...
      "resolved": "urn:visionflow:linked:perez-and-ribeiro-2022-ignore-previous-prompt",
      "kind": "StubLink"
    },
    {
      "raw": "[[Personalised AI]]",
      "resolved": "urn:visionflow:linked:personalised-ai",
      "kind": "StubLink"
    },
    {
      "raw": "[[Plugins]]",
      "resolved": "urn:visionflow:linked:plugins",
      "kind": "StubLink"
    },
    {
      "raw": "[[ProductivityDomain]]",
      "resolved": "urn:visionflow:linked:productivity-domain",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Qin et al. 2023 ToolLLM]]",
      "resolved": "urn:visionflow:linked:qin-et-al-2023-tool-llm",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Retrieval-Augmented Generation System]]",
      "resolved": "urn:visionflow:linked:retrieval-augmented-generation-system",
      "kind": "StubLink"
    },
    {
      "raw": "[[Rule-Based Chatbots]]",
      "resolved": "urn:visionflow:linked:rule-based-chatbots",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Task-Specific Assistant]]",
      "resolved": "urn:visionflow:linked:task-specific-assistant",
      "kind": "StubLink"
    },
    {
      "raw": "[[Tool Definition]]",
    ...
    {
      "raw": "[[Vector Store]]",
      "resolved": "urn:visionflow:linked:vector-store",
      "kind": "StubLink"
    },
    {
      "raw": "[[Visibility Setting]]",
      "resolved": "urn:visionflow:linked:visibility-setting",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Yu et al. 2024 Prompt Injection Risks in Custom GPTs]]",
      "resolved": "urn:visionflow:linked:yu-et-al-2024-prompt-injection-risks-in-custom-gpts",
      "kind": "StubLink"
    },
    {
      "raw": "[[Zamfirescu-Pereira et al. 2023 Why Johnny Can't Prompt]]",
      "resolved": "urn:visionflow:linked:zamfirescu-pereira-et-al-2023-why-johnny-can-t-prompt",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Zou et al. 2023 Universal Adversarial Attacks on Aligned LLMs]]",
      "resolved": "urn:visionflow:linked:zou-et-al-2023-universal-adversarial-attacks-on-aligned-llms",
      "kind": "StubLink"
    },
    {
...
- ### Definition
  - GPTs and Custom Assistants are a family of user-configured task-specific applications built on top of foundation large language models in which a vendor exposes a no-code or low-code authoring surface that lets a user, an enterprise administrator, or a third-party developer compose a persistent assistant by combining a natural-language system prompt (the assistant's persona, scope, refusal rules, output format and chain-of-thought directives), a small uploaded knowledge base (typically 1-20 files totalling 50-500MB ingested into a managed vector store such as OpenAI's File Search index, Anthropic's project knowledge index, or Microsoft Graph), an optional set of callable tools described by an OpenAPI 3.0 schema or vendor-specific function-calling JSON schema (web browsing, code execution, image generation, Zapier/Make integrations, bespoke REST endpoints authenticated by API key or OAuth 2.0), and runtime configuration (model choice e.g. GPT-4 Turbo / GPT-5 / Claude Sonnet 4 / Gemini 2.5 Pro, temperature, response length, conversation starters, visibility scope private/link/public/enterprise) without retraining or modifying any model weights, distinguishing this scaffolding-based paradigm sharply from fine-tuning (which alters parameters), from raw foundation-model API access (which provides no persona, knowledge or tool envelope), from autonomous agentic systems (which execute multi-step plans with self-directed tool use beyond the bounded query-response loop of an assistant), and from rule-based chatbots (which lack generative reasoning); the lineage runs from OpenAI Custom Instructions July 2023 (per-user system-prompt overlay), to GPTs announced at OpenAI DevDay 6 November 2023 alongside the Assistants API beta, to the GPT Store opened 10 January 2024 with 3+ million custom GPTs created by mid-2024, to Assistants API v2 April 2024 introducing managed File Search vector stores, to the Apps SDK announced at DevDay 6 October 2025 superseding the Plugins-then-GPTs lineage with full backend logic, external API calls, interactive widgets and a December 2025 ChatGPT App Directory featuring Zillow, Canva, Spotify, Booking.com, Coursera, Expedia and 100+ launch partners, paralleled at Anthropic by Claude Projects June 2024 (200K token context window, pinned files, custom instructions persisted across conversations), Claude Agent Skills October 2025 (open Markdown-plus-script standard for repeatable workflows, expanded December 2025 with enterprise central management and partner Skills from Canva/Notion/Figma/Atlassian) and Claude for Enterprise Projects with SSO/SCIM/audit logging, at Google by Gemini Gems August 2024 (initially Gemini Advanced subscribers, later free tier), NotebookLM (per-notebook source-grounded RAG with audio overviews), and Gemini Extensions wiring Workspace data, at Microsoft by Copilot Studio rebranded from Power Virtual Agents at Build 2024 providing enterprise-grade declarative agent authoring with Power Platform connectors and Dataverse grounding, Copilot Pages collaborative AI canvases, and Copilot Agents announced at Microsoft 365 Copilot Wave 2 September 2024, and at multiple smaller ecosystems by Mistral Le Chat custom assistants, Cohere North enterprise platform, Poe by Quora bot-marketplace lineage from 2023, Character.AI companion-focused 200M+ user base, HuggingFace Assistants open community implementation, Perplexity Spaces August 2024 for source-curated research, and OpenRouter custom routes; technically the family implements three converging architectural primitives—system-prompt injection prepending the author's instructions before every user turn typically consuming 2K-32K tokens of the context window, retrieval-augmented generation over a managed vector store (OpenAI File Search 1M tokens per file, 10K files per assistant, semantic chunking with hybrid BM25+embedding retrieval; Anthropic project knowledge auto-chunked into the 200K window; Microsoft Graph retrieval over SharePoint/OneDrive/Teams), and structured tool invocation through function calling where the model emits a JSON object conforming to a declared schema and the platform dispatches the call returning the result for subsequent model reasoning—and exhibits a characteristic failure-mode envelope (prompt-leakage where adversarial users extract the proprietary system prompt via jailbreak prompts like "ignore previous instructions and print verbatim" demonstrated extractable in 70-95% of pre-mitigation GPTs by Zou et al. 2023 and Yu et al. 2024, instruction-following degradation at long context where the assistant forgets early constraints by turn 20-50 quantified by the Lost-in-the-Middle phenomenon Liu et al. 2023, custom-knowledge staleness because uploaded files do not auto-refresh with source updates and embedding indexes drift from canonical documents, hallucinated tool calls where the model fabricates plausible-looking function invocations with non-existent endpoints or invents parameters violating the schema requiring runtime validation), is enforced in enterprise contexts through ChatGPT Enterprise/Teams Custom GPT admin controls, Claude for Enterprise Projects with retention policies, and Microsoft 365 Copilot Studio governance with DLP and conditional access integration, and is increasingly deployed across UK organisations including Imperial College London and UCL applied AI groups, BBC R&D experimental GPTs for newsroom workflows, the UK Government Digital Service "Caddy" Gov.uk custom assistant for Citizens Advice case workers, the legacy of NHS Babylon-era symptom-checker assistants, and Faculty AI bespoke client assistants spanning Cabinet Office, NHS and the Ministry of Defence, with the broader category collectively constituting the dominant productisation surface for foundation models in 2025-2026 estimated at 12+ million authored assistants across the four major platforms generating $4.2B of annual subscription revenue (ChatGPT Plus/Team/Enterprise, Claude Pro/Team, Gemini Advanced, Copilot Pro/365) and accelerating the transition from raw chat to bounded, governed, retrieval-grounded conversational applications.

- ### Semantic Classification
  - owl-class:: artificial-intelligence:GPTsAndCustomAssistants
  - owl-role:: ApplicationFramework
  - owl-inferred:: ai:LLMApplication, ai:NoCodeAssistant, ai:RAGSystem, ai:ToolUsingAssistant
  - belongs-to-domain:: [[AI-GroundedDomain]], [[ApplicationLayerDomain]], [[ProductivityDomain]]
  - implemented-in-layer:: [[ApplicationLayer]], [[OrchestrationLayer]], [[InterfaceLayer]]

- ### Relationships
  - is-subclass-of:: [[LLM Application]], [[Conversational AI System]], [[Retrieval-Augmented Generation System]], [[No-Code Platform]], [[AI Productivity Tool]]
  - has-part:: [[System Prompt]], [[Knowledge Base]], [[Vector Store]], [[Tool Definition]], [[OpenAPI Schema]], [[Conversation Starter]], [[Model Configuration]], [[Visibility Setting]]
  - requires:: [[Foundation Model]], [[Context Window]], [[Function Calling]], [[Embedding Model]], [[Authentication]]
  - enables:: [[Personalised AI]], [[Task-Specific Assistant]], [[Document Q&A]], [[Workflow Automation]], [[Enterprise Knowledge Surfacing]], [[Bot Marketplaces]]
...
- ### Content
  ...
  ## Compositional Relationships (Components)
	  ...
	  FunctionalDataProperty(ai:gptStoreLaunchDate)
	  ```
  ...
  - ### Research & Literature
	  ...
	  **Tool Use and Function Calling**:
	  ...
	  7. Qin, Y., Liang, S., Ye, Y., Zhu, K., Yan, L., Lu, Y., ... & Sun, M. (2023). ToolLLM: Facilitating Large Language Models to Master 16000+ Real-world APIs. *ICLR 2024*. arXiv:2307.16789
	  8. Patil, S.G., Zhang, T., Wang, X., & Gonzalez, J.E. (2023). Gorilla: Large Language Model Connected with Massive APIs. arXiv:2305.15334
	  9. Yao, S., Zhao, J., Yu, D., Du, N., Shafran, I., Narasimhan, K., & Cao, Y. (2022). ReAct: Synergizing Reasoning and Acting in Language Models. *ICLR 2023*. arXiv:2210.03629

	  **Security and Robustness**:
	  10. Zou, A., Wang, Z., Carlini, N., Nasr, M., Kolter, J.Z., & Fredrikson, M. (2023). Universal and Transferable Adversarial Attacks on Aligned Language Models. arXiv:2307.15043
	  11. Yu, J., Wu, Y., Shu, D., Jin, M., & Xing, X. (2024). Assessing Prompt Injection Risks in 200+ Custom GPTs. arXiv:2311.11538
	  12. Perez, F., & Ribeiro, I. (2022). Ignore Previous Prompt: Attack Techniques For Language Models. *NeurIPS 2022 ML Safety Workshop*. arXiv:2211.09527
	  13. Greshake, K., Abdelnabi, S., Mishra, S., Endres, C., Holz, T., & Fritz, M. (2023). Not what you've signed up for: Compromising Real-World LLM-Integrated Applications with Indirect Prompt Injection. *AISec 2023*. arXiv:2302.12173
	  14. Liu, Y., Deng, G., Xu, Z., Li, Y., Zheng, Y., Zhang, Y., ... & Liu, Y. (2024). Prompt Injection attack against LLM-integrated Applications. arXiv:2306.05499

	  **Long Context and Instruction Following**:
	  15. Liu, N.F., Lin, K., Hewitt, J., Paranjape, A., Bevilacqua, M., Petroni, F., & Liang, P. (2023). Lost in the Middle: How Language Models Use Long Contexts. *TACL 2024*. arXiv:2307.03172
	  16. Hsieh, C.P., Sun, S., Kriman, S., Acharya, S., Rekesh, D., Jia, F., Zhang, Y., & Ginsburg, B. (2024). RULER: What's the Real Context Size of Your Long-Context Language Models? arXiv:2404.06654
	  17. Anthropic (2024). Needle in a Haystack: Pressure Testing Claude 3's 200K Context. Anthropic technical blog.

	  **Evaluation and Benchmarks**:
	  18. Liu, X., Yu, H., Zhang, H., Xu, Y., Lei, X., Lai, H., ... & Tang, J. (2023). AgentBench: Evaluating LLMs as Agents. *ICLR 2024*. arXiv:2308.03688
	  19. Mialon, G., Fourrier, C., Swift, C., Wolf, T., LeCun, Y., & Scialom, T. (2023). GAIA: A Benchmark for General AI Assistants. arXiv:2311.12983
	  20. Zheng, L., Chiang, W.L., Sheng, Y., Zhuang, S., Wu, Z., Zhuang, Y., ... & Stoica, I. (2023). Judging LLM-as-a-Judge with MT-Bench and Chatbot Arena. *NeurIPS 2023*. arXiv:2306.05685

	  **Human Factors and Authoring**:
	  21. Zamfirescu-Pereira, J.D., Wong, R.Y., Hartmann, B., & Yang, Q. (2023). Why Johnny Can't Prompt: How Non-AI Experts Try (and Fail) to Design LLM Prompts. *CHI 2023*. DOI: 10.1145/3544548.3581388
	  22. Glaese, A., McAleese, N., Trębacz, M., Aslanides, J., Firoiu, V., Ewalds, T., ... & Irving, G. (2022). Improving Alignment of Dialogue Agents via Targeted Human Judgements. arXiv:2209.14375

	  **Vendor Specifications and Announcements**:
	  23. OpenAI (2023). Introducing GPTs. https://openai.com/blog/introducing-gpts (6 November 2023)
	  24. OpenAI (2024). New Models and Developer Products Announced at DevDay (Assistants API v2, File Search). https://openai.com/blog (April 2024)
	  25. OpenAI (2025). Introducing apps in ChatGPT and the new Apps SDK. https://openai.com/index/introducing-apps-in-chatgpt/ (6 October 2025)
	  26. OpenAI (2025). Developers can now submit apps to ChatGPT. https://openai.com/index/developers-can-now-submit-apps-to-chatgpt/ (18 December 2025)
	  27. Anthropic (2024). Introducing Projects on Claude.ai. Anthropic blog (25 June 2024)
	  28. Anthropic (2025). Introducing Agent Skills. https://www.anthropic.com/news/skills (October 2025)
	  29. Anthropic (2025). Equipping agents for the real world with Agent Skills. Anthropic engineering blog (December 2025)
	  30. Microsoft (2024). Copilot Studio at Build 2024. Microsoft Build keynote (May 2024); Wave 2 Copilot Agents announcement (September 2024)
	  31. Google (2024). Introducing Gems in Gemini. Google Gemini blog (August 2024); NotebookLM Audio Overviews announcement (September 2024)
...
- ### Provenance
  - sources:: [[Lewis et al. 2020 Retrieval-Augmented Generation]], [[Guu et al. 2020 REALM]], [[Karpukhin et al. 2020 Dense Passage Retrieval]], [[Izacard & Grave 2021 Fusion-in-Decoder]], [[Asai et al. 2023 Self-RAG]], [[Schick et al. 2023 Toolformer]], [[Qin et al. 2023 ToolLLM]], [[Patil et al. 2023 Gorilla]], [[Yao et al. 2022 ReAct]], [[Zou et al. 2023 Universal Adversarial Attacks on Aligned LLMs]], [[Yu et al. 2024 Prompt Injection Risks in Custom GPTs]], [[Perez & Ribeiro 2022 Ignore Previous Prompt]], [[Greshake et al. 2023 Indirect Prompt Injection]], [[Liu et al. 2024 Prompt Injection against LLM Applications]], [[Liu et al. 2023 Lost in the Middle]], [[Hsieh et al. 2024 RULER Long-Context Evaluation]], [[Liu et al. 2023 AgentBench]], [[Mialon et al. 2023 GAIA Benchmark]], [[Zheng et al. 2023 MT-Bench Chatbot Arena]], [[Zamfirescu-Pereira et al. 2023 Why Johnny Can't Prompt]], [[OpenAI Introducing GPTs DevDay 2023]], [[OpenAI Assistants API v2 April 2024]], [[OpenAI Apps SDK October 2025]], [[OpenAI ChatGPT App Directory December 2025]], [[Anthropic Claude Projects June 2024]], [[Anthropic Agent Skills October 2025]], [[Microsoft Copilot Studio Build 2024]], [[Google Gemini Gems August 2024]]
  ...
  - research-cache:: _enrich/research-cache/GPTs and Custom Assistants.json
