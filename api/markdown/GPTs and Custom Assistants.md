...
- ### Content
  ...
  - ### Core Architectural Framework
	  ...
	  **2. Retrieval-Augmented Generation over Uploaded Files**: The author uploads 1-20 files totalling 50-500MB (PDFs, DOCX, TXT, CSV, PPTX). The platform ingests each file via:
	  ...
	  - **Indexing**: vectors stored in a managed approximate-nearest-neighbour [private] (HNSW typical, M=16-32, efConstruction=200) alongside BM25 lexical [private] for hybrid retrieval
  ...
  - ### Research & Literature
	  ...
	  **Vendor Specifications and Announcements**:
	  ...
	  25. OpenAI (2025). Introducing apps in ChatGPT and the new Apps SDK. https://openai.com/[private]/introducing-apps-in-chatgpt/ (6 October 2025)
	  26. OpenAI (2025). Developers can now submit apps to ChatGPT. https://openai.com/[private]/developers-can-now-submit-apps-to-chatgpt/ (18 December 2025)
