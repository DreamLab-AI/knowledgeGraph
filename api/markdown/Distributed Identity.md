...
- ### Content
  ...
  - ### Revocation
	  ...
	  - **Status List 2021 / W3C BitstringStatusList** (Recommendation 2024) — the issuer publishes a bitstring URL listing status (revoked/suspended) for each credential by [private]. Compact (~16KB for millions of credentials with gzip) but verifier must dereference the URL, creating a phone-home leak unless cached/CDN'd.
