schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#GameEngine
legacy_uri:: urn:visionclaw:concept:spatial-computing:game-engine
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-8d7862d74460"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#GameEngine"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:game-engine"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
