schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#SmartRoyaltyContract
legacy_uri:: urn:visionclaw:concept:spatial-computing:smart-royalty-contract
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-90a32b735fb6"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#SmartRoyaltyContract"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:smart-royalty-contract"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
