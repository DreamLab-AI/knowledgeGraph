schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#NFTSwapping
legacy_uri:: urn:visionclaw:concept:spatial-computing:nft-swapping
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-e5b4b5288542"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#NFTSwapping"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:nft-swapping"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
