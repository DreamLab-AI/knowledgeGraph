schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#InflationControl
legacy_uri:: urn:visionclaw:concept:spatial-computing:inflation-control
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-9481edc18334"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#InflationControl"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:inflation-control"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:eadd5d31f9b7d6f06e6a8a9eef8cc6c792dbefeb950996e2feb25910010f3c22@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
