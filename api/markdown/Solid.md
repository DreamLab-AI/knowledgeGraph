schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/protocol#Solid
legacy_uri:: urn:visionclaw:concept:protocol:solid
public:: true
...
```json-ld
{
  ...
  "vc:outboundWikilinks": [
    ...
    {
      "@id": "urn:visionflow:linked:decentralised-web-domain",
      "vc:label": "DecentralisedWebDomain"
    },
    {
  ...
  "vc:legacyProperties": [
    {
      ...
      "vc:value": "Social Linked Data, Solid Protocol, Solid Project, SoLiD, Personal Online Data Store"
    },
    {
    ...
    {
      "vc:key": "bridges-to",
      "vc:value": "[[Linked Data]], [[Decentralized Web]], [[Privacy]]"
    },
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-solid-enriched-2026"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/protocol#Solid"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:protocol:solid"
    },
    {
      "vc:key": "status",
      "vc:value": "production-ready"
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:annotation:link-resolutions:solid:776c802a9fc9",
  ...
  "vc:resolutions": [
    ...
    {
      "raw": "[[AT Protocol]]",
      "resolved": "urn:visionflow:linked:at-protocol",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Centralised Data Silo]]",
      "resolved": "urn:visionflow:linked:centralised-data-silo",
      "kind": "StubLink"
    },
    {
      "raw": "[[Data Portability]]",
      "resolved": "urn:visionflow:linked:data-portability",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Decentralised Protocol]]",
      "resolved": "urn:visionflow:linked:decentralised-protocol",
      "kind": "StubLink"
    },
    {
      "raw": "[[DecentralisedWebDomain]]",
      "resolved": "urn:visionflow:linked:decentralised-web-domain",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[DPoP Authentication]]",
      "resolved": "urn:visionflow:linked:dpo-p-authentication",
      "kind": "StubLink"
    },
    {
      "raw": "[[DPoP Token]]",
      "resolved": "urn:visionflow:linked:dpo-p-token",
      "kind": "StubLink"
    },
    {
      "raw": "[[Financial Data Portability]]",
      "resolved": "urn:visionflow:linked:financial-data-portability",
      "kind": "StubLink"
    },
    {
      "raw": "[[FOAF]]",
      "resolved": "urn:visionflow:linked:foaf",
      "kind": "StubLink"
    },
    {
      "raw": "[[GDPR]]",
    ...
    {
      "raw": "[[Government Open Data]]",
      "resolved": "urn:visionflow:linked:government-open-data",
      "kind": "StubLink"
    },
    {
      "raw": "[[Health Data Management]]",
      "resolved": "urn:visionflow:linked:health-data-management",
      "kind": "StubLink"
    },
    {
      "raw": "[[HTTP]]",
    ...
    {
      "raw": "[[HTTP REST]]",
      "resolved": "urn:visionflow:linked:http-rest",
      "kind": "StubLink"
    },
    {
      "raw": "[[IETF]]",
    ...
    {
      "raw": "[[Linked Data Principles]]",
      "resolved": "urn:visionflow:linked:linked-data-principles",
      "kind": "StubLink"
    },
    {
      "raw": "[[Linked Web Storage Working Group]]",
      "resolved": "urn:visionflow:linked:linked-web-storage-working-group",
      "kind": "StubLink"
    },
    {
      "raw": "[[N-Triples]]",
      "resolved": "urn:visionflow:linked:n-triples",
      "kind": "StubLink"
    },
    {
      "raw": "[[NHS Data Strategy]]",
      "resolved": "urn:visionflow:linked:nhs-data-strategy",
      "kind": "StubLink"
    },
    {
      "raw": "[[OAuth 2.0]]",
    ...
    {
      "raw": "[[OAuth Data Sharing]]",
      "resolved": "urn:visionflow:linked:oauth-data-sharing",
      "kind": "StubLink"
    },
    {
      "raw": "[[Open Data]]",
    ...
    {
      "raw": "[[Open Data Institute]]",
      "resolved": "urn:visionflow:linked:open-data-institute",
      "kind": "StubLink"
    },
    {
      "raw": "[[OpenID Connect]]",
    ...
    {
      "raw": "[[Personal Data Management]]",
      "resolved": "urn:visionflow:linked:personal-data-management",
      "kind": "StubLink"
    },
    {
      "raw": "[[Pod]]",
      "resolved": "urn:visionflow:linked:pod",
      "kind": "StubLink"
    },
    {
      "raw": "[[PrivacyDomain]]",
    ...
    {
      "raw": "[[REST Architecture]]",
      "resolved": "urn:visionflow:linked:rest-architecture",
      "kind": "StubLink"
    },
    {
    ...
    {
      "raw": "[[Shape Trees]]",
      "resolved": "urn:visionflow:linked:shape-trees",
      "kind": "StubLink"
    },
    {
      "raw": "[[Smart Data Schemes]]",
      "resolved": "urn:visionflow:linked:smart-data-schemes",
      "kind": "StubLink"
    },
    {
      "raw": "[[Solid-OIDC]]",
    ...
    {
      "raw": "[[Solid Protocol Specification]]",
      "resolved": "urn:visionflow:linked:solid-protocol-specification",
      "kind": "StubLink"
    },
    {
      "raw": "[[SPARQL]]",
    ...
    {
      "raw": "[[Turtle]]",
      "resolved": "urn:visionflow:linked:turtle",
      "kind": "StubLink"
    },
    {
      "raw": "[[URI]]",
      "resolved": "urn:visionflow:linked:uri",
      "kind": "StubLink"
    },
    {
      "raw": "[[W3C]]",
    ...
    {
      "raw": "[[W3C Solid Community Group]]",
      "resolved": "urn:visionflow:linked:w3-c-solid-community-group",
      "kind": "StubLink"
    },
    {
      "raw": "[[W3C Standards]]",
      "resolved": "urn:visionflow:linked:w3-c-standards",
      "kind": "StubLink"
    },
    {
...
- ### Definition
  - Solid (Social Linked Data) is an open-source, W3C-specification-grounded decentralised web architecture conceived by Sir Tim Berners-Lee at MIT CSAIL (Massachusetts Institute of Technology Computer Science and Artificial Intelligence Laboratory) in 2015, commercialised through the startup Inrupt (co-founded 2018 by Berners-Lee and John Bruce), and steered from October 2024 by the Open Data Institute (ODI) as an open-standard ecosystem initiative. The protocol inverts the dominant application-centric model of the web—in which user data is captured and silo'd within application provider databases (Meta, Google, Amazon, healthcare records systems)—by mandating that data sovereignty resides with the user. Each person, organisation, or automated agent is assigned one or more **Pods** (Personal Online Data Stores): tamper-evident, standards-compliant storage vaults that can be hosted anywhere on the web (self-hosted, third-party provider, enterprise deployment) while remaining interoperable with any Solid-compliant application. Applications access Pod data through fine-grained, consent-driven permissions rather than owning data outright, enabling a person to simultaneously share health records with a GP practice, financial history with a bank, and dietary preferences with a meal-planning app—all from the same Pod—without granting any single provider holistic data ownership.
  - Architecturally, Solid specifies four interlocking layers: (1) **Identity** — WebID URIs uniquely identifying agents across the distributed web using RDF-based profile documents; (2) **Authentication** — Solid-OIDC (OpenID Connect extensions) enabling cryptographically-verified, decentralised login without centralized identity providers; (3) **Storage** — LDP (Linked Data Platform) RESTful resource containers storing RDF data (Turtle, JSON-LD, N-Triples serialisations) and arbitrary binary files alongside semantic metadata; (4) **Access Control** — WAC (Web Access Control, version 1.0.0 published May 2024) providing ACL-based per-resource permissions, with ACP (Access Control Policy) as an expressive alternative supporting fine-grained, policy-language access descriptions. The protocol stack sits atop foundational Semantic Web technologies: RDF (Resource Description Framework) as the universal data model expressing subject-predicate-object triples, SPARQL for graph query, OWL for ontological reasoning, and the Linked Data Principles (Berners-Lee 2006) establishing URI-dereferenceable, interlinked knowledge graphs.
  - The Solid Protocol specification version 0.11.0 (May 2024) was published by the W3C Solid Community Group, with the Linked Web Storage Working Group (LWS WG) chartered by W3C in September 2024 to produce formal Recommendations superseding the Community Group drafts. The ODI took stewardship of the Solid Project in October 2024, positioning Solid as foundational infrastructure for the 21st-century data economy alongside GDPR compliance, AI governance, and open data frameworks. Enterprise adoption reached critical scale by 2025-2026: the Flemish Government (Belgium) established Athumi—Europe's first data utility company—in spring 2023 to implement Solid-based governmental data Pods, with a full-platform government data integration system scheduled for 2026; the NHS piloted Solid Pods in Greater Manchester to give dementia patients control over their health records; NatWest Bank explored Solid-based data wallets for financial consent management (SIBOS 2024); the BBC trialled user-controlled media preference Pods; and Inrupt signed government contracts with Sweden, Argentina, and the Basque Country while running pilots in Singapore, Japan, and Helsinki.
  - Inrupt's Enterprise Solid Server (ESS) provides the commercial-grade Pod infrastructure, complemented by the open-source Community Solid Server (CSS, published by imec-IDLab and Ghent University) which deprecated the earlier Node Solid Server (NSS) by 2022-2024 and now provides the primary reference implementation for researchers and developers. The July 2024 Data Wallet product launch by Inrupt—a React-Native application connecting to the ESS Wallet API—operationalised user-controlled data portability for enterprise-grade deployments, fully GDPR-compliant through consent-coupled data access architecture, with data sharing events cryptographically linked to consent records enabling auditable purpose-limited access flows required under GDPR Article 20 and emerging national smart-data regulations including the UK Data (Use and Access) Act 2025.

- ### Semantic Classification
  - owl-class:: protocol:Solid
  - owl-role:: DecentralisedWebProtocol
  - owl-inferred:: protocol:LinkedDataProtocol, web:DataOwnershipFramework, privacy:ConsentManagementSystem
  - belongs-to-domain:: [[ProtocolDomain]], [[SemanticWebDomain]], [[PrivacyDomain]], [[DecentralisedWebDomain]]
...
- ### Content
  ...
  ## Compositional Relationships (Components)
	  ...
	  AsymmetricObjectProperty(prot:requires)
	  AsymmetricObjectProperty(prot:enables)
	  AsymmetricObjectProperty(prot:implements)
	  AsymmetricObjectProperty(prot:reduces)
	  TransitiveObjectProperty(prot:dependsOn)
	  FunctionalDataProperty(prot:authorityScore)
	  FunctionalDataProperty(prot:specVersion)
	  ```
  ...
  - Solid's original motivation was reshaping social media by decentralising data from platforms like Facebook and Twitter. LDP Inboxes (defined in the LDP Notifications specification) provide a standardised notification mechanism: an LDP Inbox is an LDP Container at a known URI (typically `</inbox/>`) where any authorised agent can POST a notification message (using the ActivityStreams 2.0 or custom RDF vocabularies). Social interactions—follows, friend requests, messages, event invitations, article reactions—can flow between different Solid Pod providers via these Inboxes, analogous to email across different mail servers. This creates a federated social graph where users choose their own Pod provider but can interact with users on any other provider—similar to ActivityPub (the W3C Recommendation underpinning Mastodon and the Fediverse) but with richer data sovereignty semantics: WAC/ACP governs exactly who can read the social graph, whereas ActivityPub's security model is coarser-grained. Solid Lite—referenced in the original stub—is a proposed simplified profile of the Solid protocol targeting lower-resource environments and simpler use cases, potentially addressing the developer adoption barrier posed by the full Solid stack.
  ...
  - Shape Trees (combining ShEx or SHACL constraints with LDP container hierarchy templates) will enable application interoperability at the data-model level—not merely API-level Solid compliance. When a healthcare application stores a `Patient` resource conforming to a standardised Shape Tree (mapping to HL7 FHIR R4 SMART-on-FHIR profiles, expressed in ShEx), a second application from a different vendor can discover that resource by following the Shape Tree index in the Pod and parse it without bespoke integration code. The Solid Application Interoperability (SAI) specification (Justin Bingham et al.) defines authorisation agent patterns: a user appoints an authorisation agent (a trusted service or application) to manage access grants on their behalf, with fine-grained access to specific Shape Trees rather than entire Pod subtrees. SAI and Shape Trees together form the interoperability layer that transforms Solid from "apps can share a Pod" to "apps can understand each other's data."
  ...
  - ## Metadata
  - domain-correction:: infrastructure → protocol (Solid is a web protocol/standard rather than infrastructure tooling; IRI updated from `infrastructure#Solid` to `protocol#Solid`; URI namespace updated from `infrastructure:solid` to `protocol:solid`; owl-class updated accordingly; iri/uri/same-as corrected in frontmatter)
  - enrichment-worker:: claude-sonnet-4-6
  - enrichment-date:: 2026-05-17T09:00:00Z
  - source-stub-lines:: 39
  - research-queries:: ["Solid protocol Inrupt Tim Berners-Lee 2024 2025 enterprise deployment", "Flemish Government Solid Pods deployment 2023 2025 rollout status", "NHS Solid Pod pilot UK health data 2024 2025", "Solid protocol specification W3C 2024 WebID OIDC WAC ACP", "Community Solid Server CSS Node Solid Server NSS 2024 comparison", "ODI Open Data Institute Solid stewardship 2024 2025 future directions", "Inrupt Data Wallet 2024 personal data management Solid GDPR", "Inrupt Enterprise Solid Server BBC NatWest deployment 2024", "Solid linked data RDF Turtle JSON-LD SPARQL decentralized web academic research 2024"]

- ### Provenance
  - sources::
    - 1. Mansour, E., Sambra, A.V., Hawke, S., Zereba, M., Capadisli, S., Ghanem, A., Aboulnaga, A., Berners-Lee, T. (2016). "Solid: A Platform for Decentralized Social Applications Based on Linked Data." Proceedings of the 25th International Conference Companion on World Wide Web (WWW '16 Companion). ACM.
    - 2. Berners-Lee, T. (2009). "Linked Data Design Issues." W3C Design Issues. https://www.w3.org/DesignIssues/LinkedData.html
    - 3. Berners-Lee, T., Hendler, J., Lassila, O. (2001). "The Semantic Web." Scientific American, 284(5), 28-37.
    - 4. Capadisli, S., Berners-Lee, T., Kjernsmo, K. (Eds.) (2024). "Solid Protocol 0.11.0." W3C Draft Community Group Report, 12 May 2024. https://solidproject.org/TR/protocol
    - 5. Coburn, A., Pavlik, elf, Zagidulin, D. (2022). "Solid OIDC, Version 0.1.0." W3C Solid Community Group Report, 28 March 2022.
    - 6. Capadisli, S. (Ed.) (2024). "Web Access Control, Version 1.0.0." W3C Solid Community Group Report, 12 May 2024. https://solidproject.org/TR/wac
    - 7. Van Herwegen, J., Verborgh, R. (2024). "The Community Solid Server: Supporting Research & Development in an Evolving Ecosystem." Semantic Web (IOS Press). doi:10.3233/SW-243726. https://content.iospress.com/articles/semantic-web/sw243726
    - 8. W3C (2024). "Linked Web Storage Working Group Charter." September 2024. https://www.w3.org/2024/09/linked-web-storage-wg-charter.html
    - 9. Inrupt (2024). "Universal Data Wallet Infrastructure." Inrupt Release, July 2024. https://www.inrupt.com/release/data-wallet
    - 10. Open Data Institute (2024). "ODI and Solid Come Together to Give Individuals Greater Control Over Personal Data." ODI News, October 2024. https://theodi.org/news-and-events/news/odi-and-solid-come-together-to-give-individuals-greater-control-over-personal-data/
    - 11. Open Data Institute (2024). "ODI and Solid: Building a Future Where Data Works for Everyone." ODI Insights. https://theodi.org/insights/projects/odi-and-solid-building-a-future-where-data-works-for-everyone/
    - 12. Inrupt (2023). "Tim Berners-Lee, Solid and the Flemish Government." Inrupt Blog. https://www.inrupt.com/blog/flanders-solid
    - 13. SolidLab / Flanders Investment and Trade (2023). "SolidLab Flanders Helps Set New Data Safety Standard." https://www.flandersinvestmentandtrade.com/invest/en/news/solidlab-flanders-helps-set-new-data-safety-standard-0
    - 14. CIMAR UK (2019). "NHS Personal Online Data Store Pilot Begins." https://www.cimar.co.uk/nhs-personal-online-data-store-pilot-begins/
    - 15. NatWest (2024). "How Might Data Wallets Affect Financial Services?" NatWest SIBOS 2024 Analysis. https://www.natwest.com/corporates/sibos-2024/data-wallets-article.html
    - 16. Silicon Republic (2020). "Big Names Have Signed Up to Tim Berners-Lee's New Data Pod Platform." https://www.siliconrepublic.com/enterprise/tim-berners-lees-inrupt-solid-server-nhs-bbc
    - 17. Computing (2020). "Berners-Lee's Inrupt Releases First Commercial Offering, the Privacy-Preserving Enterprise Solid Server." https://www.computing.co.uk/news/4022941/berners-lee-inrupt-releases-commercial-offering-privacy-preserving-enterprise-solid-server
    - 18. TechCrunch (2020). "Tim Berners-Lee's Startup Inrupt Releases Solid Privacy Platform for Enterprises." https://techcrunch.com/2020/11/08/tim-berners-lees-startup-inrupt-releases-solid-privacy-platform-for-enterprises/
    - 19. Tech.eu (2024). "Inrupt's Data Wallet Realises Sir Berners-Lee's Data Ownership Dream." 23 July 2024. https://tech.eu/2024/07/23/inrupt-s-data-wallet-realises-sir-berners-lee-s-data-ownership-dream
    - 20. Solid Community Group (2024). "WebID Profile Specification." https://solid.github.io/webid-profile/
    - 21. W3C Solid Community Group (2024). "Web Access Control Specification." https://solid.github.io/web-access-control-spec/
    - 22. Community Solid Server Documentation (2024). "Authorization Methods." v7.x. https://communitysolidserver.github.io/CommunitySolidServer/7.x/usage/authorization-methods/
    - 23. Solid Specification GitHub (2024). "Proposal: WAC MUST baseline, ACP MAY optional (Issue #787)." https://github.com/solid/specification/issues/787
    - 24. EWADA / Oxford Internet Institute (2024). "ODI and Solid — Building a Future Data Autonomy for Everyone." https://ewada.ox.ac.uk/news/2024/10/17/solid.html
    - 25. Dodds, L. (2024). "Confused by Solid." Lost Boy blog, March 2024. https://blog.ldodds.com/2024/03/12/baffled-by-solid/
    - 26. Open Data Institute (2025). "Solid World: February 2025." https://theodi.org/news-and-events/events/solid-world-february-2025/
    - 27. W3C (2015). "Linked Data Platform 1.0." W3C Recommendation, 26 February 2015. https://www.w3.org/TR/ldp/
    - 28. UK Data Protection Act 2018 / UK GDPR, Article 20 (Data Portability Right); Data (Use and Access) Act 2025.
