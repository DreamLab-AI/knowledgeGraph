schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#DigitalAssetStandards
legacy_uri:: urn:visionclaw:concept:spatial-computing:digital-asset-standards
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-b78a6a619d57"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#DigitalAssetStandards"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:digital-asset-standards"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:f6ac8428e4a51ff4a7b4bed1f9305f6644002856c2be1b8a8505a93f7080c487@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
```json-ld
{
  ...
  "definition": "Digital Asset Standards is a concept within the metaverse domain. Further enrichment pending. bridges-to:: [[Blockchain]]",
  "vc:qualityScore": {
    "@value": "0.35",
    "@type": "xsd:float"
  },
