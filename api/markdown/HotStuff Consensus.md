schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/blockchain#HotStuffConsensus
legacy_uri:: urn:visionclaw:concept:blockchain:hotstuff-consensus
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-090be3b766ab"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/blockchain#HotStuffConsensus"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:blockchain:hotstuff-consensus"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
