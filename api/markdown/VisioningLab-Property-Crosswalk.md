schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#VisioninglabPropertyCrosswalk
legacy_uri:: urn:visionclaw:concept:spatial-computing:visioninglab-property-crosswalk
public:: true
...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "visioning-lab-property-crosswalk",
  "title": "VisioningLab-Property-Crosswalk",
  "vc:public": true,
  "vc:outboundWikilinks": [
    {
      "@id": "urn:visionflow:linked:aliases",
      "vc:label": "Aliases"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-ebf9ba597efd"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#VisioninglabPropertyCrosswalk"
    },
    {
      "vc:key": "legacy-term-id",
      "vc:value": "→ dcterms:identifier"
    },
    {
      "vc:key": "maturity",
      "vc:value": "→ ai:maturity"
    },
    {
      "vc:key": "modified",
    ...
    },
    {
      ...
      "vc:value": "VisioningLab-Property-Crosswalk"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:visioninglab-property-crosswalk"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
