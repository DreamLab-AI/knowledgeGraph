schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#ArbitrationDecisionEngine
legacy_uri:: urn:visionclaw:concept:spatial-computing:arbitration-decision-engine
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-bdc13c440df8"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#ArbitrationDecisionEngine"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:arbitration-decision-engine"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
