```json-ld
{
  ...
  "@id": "urn:visionflow:page:materiality-assessment",
  "@type": "Page",
  "title": "Materiality Assessment",
  "vc:slug": "materiality-assessment",
  "vc:public": true,
  "vc:schemaVersion": 2,
...
- ### Overview
- Materiality is borrowed from financial accounting, where an item is material if its omission or misstatement [private] influence the economic decisions of users. In sustainability practice the principle is extended across a far wider set of impacts and dependencies.
