schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#NotificationSystem
legacy_uri:: urn:visionclaw:concept:infrastructure:notification-system
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-ad17495d41cb"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#NotificationSystem"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:notification-system"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:0a69ab42d903224d31f92e4e1cf4787a6b790d0cb44fadae75e240a40415f29e@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:notification-system",
  "@type": "OntologyClass",
