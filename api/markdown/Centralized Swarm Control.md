schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/robotics#CentralizedSwarmControl
legacy_uri:: urn:visionclaw:concept:robotics:centralized-swarm-control
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-709af1f01894"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/robotics#CentralizedSwarmControl"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:robotics:centralized-swarm-control"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
