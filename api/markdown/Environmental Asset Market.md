schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#EnvironmentalAssetMarket
legacy_uri:: urn:visionclaw:concept:spatial-computing:environmental-asset-market
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-6a10aa20407e"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#EnvironmentalAssetMarket"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:environmental-asset-market"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
