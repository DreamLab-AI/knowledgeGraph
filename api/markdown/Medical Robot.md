schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/robotics#MedicalRobot
legacy_uri:: urn:visionclaw:concept:robotics:medical-robot
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-a923daaca83c"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/robotics#MedicalRobot"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:robotics:medical-robot"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
  ...
  "prov:wasDerivedFrom": {
    "@id": "urn:visionflow:page:ebfb7a2fb5ff2ca47269c1712779e029a95864fa2185fbb040584a5009a43119@776c802a9fc9058c7e99ea02bf84643a0b6cd2be"
  },
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionflow:owl:class:medical-robot",
  "@type": "OntologyClass",
  "label": "Medical Robot",
  "subClassOf": [
    {
