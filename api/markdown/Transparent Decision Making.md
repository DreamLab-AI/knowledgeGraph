schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/spatial-computing#TransparentDecisionMaking
legacy_uri:: urn:visionclaw:concept:spatial-computing:transparent-decision-making
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-3607a1d2f267"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/spatial-computing#TransparentDecisionMaking"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:spatial-computing:transparent-decision-making"
    },
    {
      "vc:key": "signature",
      "vc:value": ""
