schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/robotics#RoboticsApplication
legacy_uri:: urn:visionclaw:concept:robotics:robotics-application
public:: true
...
```json-ld
{
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-2cf0e132b0c0"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/robotics#RoboticsApplication"
    },
    {
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:robotics:robotics-application"
    },
    {
      "vc:key": "status",
      "vc:value": "draft"
