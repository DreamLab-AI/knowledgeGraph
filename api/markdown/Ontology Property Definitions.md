schema_version:: 1
legacy_iri:: http://narrativegoldmine.com/infrastructure#OntologyPropertyDefinitions
legacy_uri:: urn:visionclaw:concept:infrastructure:ontology-property-definitions
public:: true
...
```json-ld
{
  ...
  "@type": "Page",
  "vc:slug": "ontology-property-definitions",
  "title": "Ontology Property Definitions",
  "vc:public": true,
  "vc:outboundWikilinks": [
    {
      "@id": "urn:visionflow:linked:dublin-core-metadata-initiative",
      "vc:label": "Dublin Core Metadata Initiative"
    },
    {
      "@id": "urn:visionflow:linked:ontology-domain",
      "vc:label": "OntologyDomain"
    },
    {
  ...
  "vc:legacyProperties": [
    ...
    {
      "vc:key": "content-hash",
      "vc:value": "sha256-12-a558a8404452"
    },
    {
      "vc:key": "context",
    ...
    {
      "vc:key": "iri",
      "vc:value": "http://narrativegoldmine.com/infrastructure#OntologyPropertyDefinitions"
    },
    {
    ...
    },
    {
      ...
      "vc:value": "Ontology Property Definitions"
    },
    {
      "vc:key": "public",
      "vc:value": "true"
    ...
    {
      "vc:key": "same-as",
      "vc:value": "urn:visionclaw:concept:infrastructure:ontology-property-definitions"
    },
    {
      "vc:key": "status",
      "vc:value": "complete"
...
- ### Semantic Classification
  ...
  - owl-role:: Concept
  - belongs-to-domain:: [[OntologyDomain]]
