...
resource: urn:ngm:class:semantic-reasoning
domain: artificial-intelligence
description: Semantic reasoning is the process of deriving new facts or checking consistency by applying logical inference rules to formally represented knowledge, such as an ontology or knowledge graph, rather than to raw text or numeric data. It exploits explicit semantics, including class hierarchies and property definitions, to infer relationships not directly asserted, for example that an individual belon
maturity: mature
quality: 0.55
is-a:
