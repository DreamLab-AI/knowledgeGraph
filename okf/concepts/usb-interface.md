...
type: Class
title: USB Interface
resource: urn:ngm:class:usb-interface
domain: infrastructure
description: A USB interface is a standardised serial connection point implementing the Universal Serial Bus specification for data transfer and power delivery between a host and a peripheral device. It provides a common physical and protocol layer that hardware wallets, storage devices, and countless other peripherals use to communicate with host computers. USB interfaces are widely chosen for security-sensit
maturity: draft
quality: 0.55
is-a:
