...
type: Class
title: Soft Shadows
resource: urn:ngm:class:soft-shadows
domain: spatial-computing
description: Soft shadows are shadows with a graduated penumbra rather than a single hard edge, produced when a light source has physical area rather than being an idealised point. Rendering them requires sampling multiple points across the light's surface, or approximating the effect with techniques such as percentage-closer soft shadows, variance shadow maps, or area-light ray tracing. They are a significant
